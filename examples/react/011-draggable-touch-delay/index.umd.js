(function(factory) {
	...
	const e$6 = typeof window < `u` && window.document !== void 0, t$10 = e$6 && `ontouchstart` in window, n$8 = e$6 && !!window.PointerEvent;
	...
	function c$3(n) {
		return n === `auto` || n === void 0 ? n$8 ? `pointer` : t$10 ? `touch` : `mouse` : n;
	}
	const l$1 = {
		pointer: {
			start: `pointerdown`,
	...
	function r$4(r, i = !1) {
		...
		if (a && a !== `none`) {
			...
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$7(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$9(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	function c$2(t, c = new DOMMatrix()) {
		...
		for (r$3(c); l;) {
			...
			if (t && (a$2.setMatrixValue(t), !a$2.isIdentity)) {
				...
				i$2(t, s$2);
				let { x: n, y: u, z: d } = s$2;
				d === 0 ? (a$2.translateSelf(-n, -u), r$3(o$2).translateSelf(n, u)) : (a$2.translateSelf(-n, -u, -d), r$3(o$2).translateSelf(n, u, d)), a$2.preMultiplySelf(o$2), c.preMultiplySelf(a$2);
			}
			l = l.parentElement;
		}
		return c;
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$11(e), a = e.getBoundingClientRect(), s = r$4(e, !0);
	...
	var R = class {
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$9.read, this._prepareMove, this._moveId), r$5.once(n$9.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$5.once(n$9.read, this._prepareStart, this._startId), r$5.once(n$9.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$5.off(n$9.read, this._startId), r$5.off(n$9.write, this._startId), r$5.off(n$9.read, this._moveId), r$5.off(n$9.write, this._moveId), r$5.off(n$9.read, this._alignId), r$5.off(n$9.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$9.read, this._prepareAlign, this._alignId), r$5.once(n$9.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	//#endregion
	//#region ../dragdoll/dist/create-touch-delay-predicate-CtoyDrK_.js
	const a$1 = new Set([
		`auto`,
		`scroll`,
		`overlay`
	...
	function o$1(t) {
		let n = t$11(t);
		return !!(a$1.has(n.overflowY) || a$1.has(n.overflowX));
	}
	function s$1(e, n = []) {
		let r = e?.parentNode;
		for (n.length = 0; r && !e$7(r);) r instanceof Element ? (o$1(r) && n.push(r), r = r.parentNode) : r = r instanceof ShadowRoot ? r.host : r.parentNode;
		return n.push(window), n;
	}
	function c$1(e) {
		let t = [];
		return o$1(e) && t.push(e), s$1(e, t), t;
	}
	function l(e = {}) {
		let t, a = 0, o = null, s, { touchDelay: l = 250, fallback: u = () => !0 } = e, d$2 = (e) => e.preventDefault(), f = (e) => {
			if (a) {
				if (t) {
					e.cancelable && e.preventDefault();
					return;
				}
				t === void 0 && (e.cancelable && e.timeStamp - a > l ? (t = !0, e.preventDefault()) : t = !1);
			}
		};
		return (e) => {
			if (!(e.sensor instanceof d)) return u(e);
			let { draggable: p, sensor: m, event: h } = e, g = h;
			if (g.pointerType === `touch`) {
				if (g.type === e$5.Start && (g.srcEvent.type === `pointerdown` || g.srcEvent.type === `touchstart`)) {
					o = g.target;
					let e = o ? c$1(o) : [];
					e.forEach((e) => {
					...
					let u = () => {
						a && (p.off(I.End, u), p.sensors.forEach((e) => {
							e instanceof d && e.off(e$5.End, u);
						}), o?.removeEventListener(`contextmenu`, d$2), e.forEach((e) => {
							e.removeEventListener(`touchmove`, f, { capture: !0 });
						}), a = 0, t = void 0, o = null, s = void window.clearTimeout(s));
					};
					t = void 0, a = g.srcEvent.timeStamp, o?.addEventListener(`contextmenu`, d$2), p.on(I.End, u), p.sensors.forEach((e) => {
						e instanceof d && e.on(e$5.End, u);
					}), l > 0 && (s = window.setTimeout(() => {
						p.resolveStartPredicate(m), t = !0, s = void 0;
					}, l));
				}
				return t;
			}
			return g.type === e$5.Start && !g.srcEvent.button;
		};
	}
	//#endregion
	...
	*/
	...
	function S(e) {
		...
		for (let n = 0; n < e.length; n++) {
			...
			let a = r.getBoundingClientRect(), o = t$11(r), s = r$4(r), c = s ? o.transformOrigin : ``, y, b;
	...
	*/
	...
	//#endregion
	//#region examples/react/011-draggable-touch-delay/index.tsx
	...
	const DraggableCardMemo = (0, import_react.memo)(function DraggableCard() {
		...
		const draggableSettings = (0, import_react.useMemo)(() => ({
			...
			startPredicate: l({ touchDelay: 1e3 }),
			positionModifiers: [U]
		}), []);
