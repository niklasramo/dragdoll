(function(factory) {
	...
	//#endregion
	//#region ../dragdoll-react/dist/drag-preview-store-BiFf77Ja.js
	const e$9 = () => {};
	let t$14 = /* @__PURE__ */ new Map();
	const n$16 = /* @__PURE__ */ new Set();
	function r$9() {
		n$16.forEach((e) => e());
	}
	const i$8 = {
		add(n, i, a) {
			t$14 = new Map(t$14), t$14.set(n, {
				sources: i,
				proxies: a,
				exiting: !1,
				done: e$9
		...
		startExiting(e, n) {
			let i = t$14.get(e);
			i && (t$14 = new Map(t$14), t$14.set(e, {
				...i,
				exiting: !0,
				done: n
			}), r$9());
		...
		remove(e) {
			t$14.has(e) && (t$14 = new Map(t$14), t$14.delete(e), r$9());
		},
		subscribe(e) {
			return n$16.add(e), () => n$16.delete(e);
		},
		getSnapshot() {
			return t$14;
		}
	...
	*/
	...
	//#endregion
	//#region ../dragdoll-react/dist/dnd-observer-context.js
	var import_react = require_react();
	const t$13 = (0, import_react.createContext)(null);
	//#endregion
	//#region ../dragdoll-react/dist/use-dnd-observer-context.js
	function n$15() {
		return (0, import_react.useContext)(t$13);
	}
	//#endregion
	//#region ../dragdoll-react/dist/use-isomorphic-layout-effect-DlbbETLC.js
	const n$14 = typeof window > `u` ? import_react.useEffect : import_react.useLayoutEffect;
	//#endregion
	//#region ../dragdoll-react/dist/use-dnd-observer-callback.js
	function r$8(r, i, a) {
		let o = n$15(), s = a === void 0 ? o : a, c = !!i, l = (0, import_react.useRef)(i);
		l.current = i, n$14(() => {
			if (!s || !c) return;
			let e = s.on(r, ((...e) => {
				l.current?.(...e);
			}));
			return () => void s.off(r, e);
		}, [
			r,
			s,
			c
	...
	var t$10 = class {
		...
		constructor(e = {}) {
			...
			this._phases = t, this._emitter = new t$10({
				getId: s,
				dedupe: r
	...
	var a$7 = class {
		...
		_checkCollision(r, i, a) {
			...
			if (!o) return null;
			let c = e$5(o, s, a.intersectionRect);
			if (c === null) return null;
			let l = n$11(o, s, c);
			return l <= 0 ? null : (a.droppableId = i.id, n$10(s, a.droppableRect), n$10(o, a.draggableRect), a.intersectionScore = l, a);
		}
		_sortCollisions(e, t) {
			return t.sort((e, t) => {
		...
		_createCollisionData() {
			return {
				...
				droppableRect: n$10(),
				draggableRect: n$10(),
				intersectionRect: n$10(),
				intersectionScore: 0
			};
		}
		_getCollisionDataArena(e) {
			let t = this._cdArenaMap.get(e);
			return t || (t = this._cdArenaPool.pop() || new r$6((e) => e || this._createCollisionData()), this._cdArenaMap.set(e, t)), t;
		}
	...
	const e$2 = typeof window < `u` && window.document !== void 0, t$7 = e$2 && `ontouchstart` in window, n$9 = e$2 && !!window.PointerEvent;
	...
	function c$5(n) {
		return n === `auto` || n === void 0 ? n$9 ? `pointer` : t$7 ? `touch` : `mouse` : n;
	}
	const l$2 = {
		pointer: {
			start: `pointerdown`,
	...
	var d = class {
		...
		constructor(e, t = {}) {
			...
			this.element = e, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._cancelOnVisibilityChange = o ?? !0, this._cancelOnEscape = d ?? !0, this._preventNativeDrag = f ?? !0, this._preventContextMenu = p ?? !1, this._startPredicate = a, this._listenerOptions = s$3(n), this._sourceEvents = c$5(i), this._emitter = new t$10(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e.addEventListener(l$2[this._sourceEvents].start, this._onStart, this._listenerOptions), o && document.addEventListener(`visibilitychange`, this._visibilityChangeHandler);
		}
		_getTrackedPointerEventData(e) {
			return this.drag ? i$6(e, this.drag.pointerId) : null;
		}
		_onStart(e) {
			if (this._removeClickBlocker?.(), this.isDestroyed || this.drag || !this._startPredicate(e)) return;
			let t = a$6(e);
			if (t === null) return;
			let r = i$6(e, t);
			if (r === null) return;
		...
		_onMove(e) {
			...
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$4.Move, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r);
		}
		_onCancel(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$4.Cancel, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		_onEnd(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$4.End, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		_bindWindowListeners() {
			if (this._areWindowListenersBound) return;
			let { move: e, end: t, cancel: n } = l$2[this._sourceEvents];
		...
		destroy() {
			this.isDestroyed || (this.isDestroyed = !0, this._removeClickBlocker?.(), this.cancel(), this._emitter.emit(e$4.Destroy, { type: e$4.Destroy }), this._emitter.off(), this.element.removeEventListener(l$2[this._sourceEvents].start, this._onStart, this._listenerOptions), this._cancelOnVisibilityChange && document.removeEventListener(`visibilitychange`, this._visibilityChangeHandler));
		}
	};
	//#endregion
	...
	function r$5(r, i = !1) {
		let { translate: a, rotate: o, scale: s, transform: c } = t$8(r), l = ``;
		if (a && a !== `none`) {
			let [e = `0px`, i = `0px`, o] = a.split(` `);
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$8(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$6(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	const a$5 = e$2 ? new DOMMatrix() : null, o$1 = e$2 ? new DOMMatrix() : null, s$2 = {
		x: 0,
		y: 0,
		z: 0
	};
	function c$4(t, c = new DOMMatrix()) {
		let l = t;
		for (r$4(c); l;) {
			let t = r$5(l);
			if (t && (a$5.setMatrixValue(t), !a$5.isIdentity)) {
				let { transformOrigin: t } = t$8(l);
				i$5(t, s$2);
				let { x: n, y: u, z: d } = s$2;
				d === 0 ? (a$5.translateSelf(-n, -u), r$4(o$1).translateSelf(n, u)) : (a$5.translateSelf(-n, -u, -d), r$4(o$1).translateSelf(n, u, d)), a$5.preMultiplySelf(o$1), c.preMultiplySelf(a$5);
			}
			l = l.parentElement;
		}
		return c;
	...
	var g$1 = class {
		...
		_clientOffsetCache;
		constructor(e, t) {
			this.sensor = e, this.startEvent = { ...t }, this.prevMoveEvent = { ...t }, this.moveEvent = { ...t }, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new g$1(), this._clientOffsetCache = new g$1();
		}
	};
	function v$1(e, t, n = !1) {
		let { style: r } = e;
		for (let e in t) r.setProperty(e, t[e], n ? `important` : ``);
	}
	function y$1() {
		let e = document.createElement(`div`);
		return e.classList.add(`dragdoll-measure`), v$1(e, {
			display: `block`,
			position: `absolute`,
			inset: `0px`,
			padding: `0px`,
	...
	function b$1(e, t = {
		...
		let { x: r, y: i } = e.getBoundingClientRect(), a = t$8(e);
	...
	function w(e, t, n = {
		...
		let r = x$1(e) ? e : b$1(e, S$1), i = x$1(t) ? t : b$1(t, C$1);
		return n.x = i.x - r.x, n.y = i.y - r.y, n;
	}
	const T = e$2 ? y$1() : null;
	var E = class {
		data;
		element;
		elementContainer;
		...
		constructor(e, t) {
			...
			let i = t$8(e), a = e.getBoundingClientRect(), s = r$5(e, !0);
			this.data = {}, this.element = e, this.elementTransformOrigin = i$5(i.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s + i.transform), this.elementOffsetMatrix = new DOMMatrix(s).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
				x: 0,
				y: 0
		...
		_updateContainerMatrices() {
			[this.elementContainer, this.dragContainer].forEach((e) => {
				if (!this._matrixCache.isValid(e)) {
					...
					c$4(e, n), r$4(r).multiplySelf(n).invertSelf(), this._matrixCache.set(e, t);
				}
			});
		}
		_updateContainerOffset() {
			...
			if (e !== n) {
				let [s, c] = [[r, n], [t, e]].map(([e, t]) => {
					...
					if (!a.isValid(t)) {
						let r = o.get(e);
						t instanceof HTMLElement && r && !r[0].isIdentity ? p$1(r[0]) ? (T.style.setProperty(`transform`, r[1].toString(), `important`), t.append(T), b$1(T, n), T.remove()) : (b$1(t, n), n.x -= r[0].m41, n.y -= r[0].m42) : b$1(t, n);
					}
					return a.set(t, n), n;
				});
				w(s, c, i);
	...
	const D = {
		...
		x: 0,
		y: 0
	}, k = e$2 ? new DOMMatrix() : null, A = e$2 ? new DOMMatrix() : null;
	var j = function(e) {
	...
	const N = {
		...
		applyPosition: ({ item: e, phase: t }) => {
			...
			r$4(k), _ && (g === 0 ? k.translateSelf(-m, -h) : k.translateSelf(-m, -h, -g)), n ? i.isIdentity || k.multiplySelf(i) : o.isIdentity || k.multiplySelf(o), r$4(A).translateSelf(v, y), k.multiplySelf(A), r.isIdentity || k.multiplySelf(r), _ && (r$4(A).translateSelf(m, h, g), k.multiplySelf(A)), d.isIdentity || k.multiplySelf(d), p.isIdentity || k.preMultiplySelf(p), e.element.style.transform = `${k}`;
		},
	...
	var R = class {
		...
		constructor(e, t = {}) {
			let { id: n = Symbol(), ...r } = t;
			this.id = n, this._sensors = e, this.settings = this._parseSettings(r), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new t$10(), this._startPhase = j.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._modifierData = {
				draggable: this,
				drag: null,
				item: null,
				phase: N.Start
		...
		_bindSensor(e) {
			this._sensorData.set(e, {
				...
				predicateEvent: null,
				onMove: (t) => this._onMove(t, e),
				onEnd: (t) => this._onEnd(t, e)
			});
			let { onMove: t, onEnd: n } = this._sensorData.get(e);
			e.on(e$4.Start, t, t), e.on(e$4.Move, t, t), e.on(e$4.Cancel, n, n), e.on(e$4.End, n, n);
		}
		_unbindSensor(e) {
			let t = this._sensorData.get(e);
			if (!t) return;
			let { onMove: n, onEnd: r } = t;
			e.off(e$4.Start, n), e.off(e$4.Move, n), e.off(e$4.Cancel, r), e.off(e$4.End, r), this._sensorData.delete(e);
		}
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$7.once(n$12.read, this._prepareMove, this._moveId), r$7.once(n$12.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		_applyStart() {
			...
			if (!(!e || this._startPhase !== j.FinishPrepare)) {
				...
				for (let t of e.items) t.dragContainer !== t.elementContainer && m$1(t.dragContainer, t.element), t.frozenStyles && Object.assign(t.element.style, t.frozenStyles), this.settings.applyPosition({
					phase: F.Start,
					draggable: this,
					drag: e,
					item: t
				...
				for (let t of e.items) {
					...
					if (f$1(e, n) || !p$1(e) && !p$1(n)) continue;
					let r = t.element.getBoundingClientRect(), { alignmentOffset: i } = t;
					i.x += h$1(t.clientRect.x - r.x, 3), i.y += h$1(t.clientRect.y - r.y, 3);
				}
				for (let t of e.items) {
		...
		resolveStartPredicate(n, r) {
			...
			i.predicateState === M.Pending && a && (this._startPhase = j.Init, i.predicateState = M.Resolved, i.predicateEvent = null, this.drag = new _$1(n, a), this._sensorData.forEach((e, t) => {
				t !== n && (e.predicateState = M.Rejected, e.predicateEvent = null);
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$7.once(n$12.read, this._prepareStart, this._startId), r$7.once(n$12.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$7.off(n$12.read, this._startId), r$7.off(n$12.write, this._startId), r$7.off(n$12.read, this._moveId), r$7.off(n$12.write, this._moveId), r$7.off(n$12.read, this._alignId), r$7.off(n$12.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
			...
			for (let e of n.items) {
				if (e.elementContainer !== e.dragContainer && (m$1(e.elementContainer, e.element), e.alignmentOffset.x = 0, e.alignmentOffset.y = 0, e.containerOffset.x = 0, e.containerOffset.y = 0), e.unfrozenStyles) for (let t in e.unfrozenStyles) e.element.style[t] = e.unfrozenStyles[t] || ``;
			...
			for (let e of n.items) if (e.elementContainer !== e.dragContainer) {
				...
				e.alignmentOffset.x = h$1(e.clientRect.x - t.x, 3), e.alignmentOffset.y = h$1(e.clientRect.y - t.y, 3);
			}
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$7.once(n$12.read, this._prepareAlign, this._alignId), r$7.once(n$12.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	var r$3 = class {
		...
		_emitter;
		constructor(t, r = {}) {
			let { id: i = Symbol(), accept: a = n$7.accept, data: o = {}, computeClientRect: s = n$7.computeClientRect } = r;
			this.id = i, this.element = t, this.isDestroyed = !1, this.accept = a, this.data = o, this.computeClientRect = s, this._clientRect = {
				x: 0,
				y: 0,
				width: 0,
				height: 0
			}, this._emitter = new t$10(), this.updateClientRect();
		}
		on(e, t, n) {
			return this._emitter.on(e, t, n);
		}
	...
	var u = class {
		...
		constructor(e = {}) {
			...
			this.draggables = /* @__PURE__ */ new Map(), this.droppables = /* @__PURE__ */ new Map(), this.isDestroyed = !1, this._drags = /* @__PURE__ */ new Map(), this._listenerId = Symbol(), this._emitter = new t$10(), this._onScroll = this._onScroll.bind(this), this.updateDroppableClientRects = this.updateDroppableClientRects.bind(this), this._collisionDetector = t ? t(this) : new a$7(this);
		}
		get drags() {
			return this._drags;
		}
		...
		_onDragPrepareStart(e) {
			...
			}), this._drags.size === 1 && this.updateDroppableClientRects(), this._computeCollisions(e), this._drags.size === 1 && window.addEventListener(`scroll`, this._onScroll, c$3)));
		}
		_onDragStart(e) {
			let t = this._drags.get(e);
			if (!(!t || t.isEnded)) {
				if (this._emitter.listenerCount(l$1.Start)) {
					...
					n.targets = this._getTargets(e), this._emitter.emit(l$1.Start, n);
				}
		...
		_onDragMove(e) {
			...
			if (!(!t || t.isEnded)) {
				if (this._emitter.listenerCount(l$1.Move)) {
					let n = t._events.base;
					n.targets = this._getTargets(e), this._emitter.emit(l$1.Move, n);
				}
				this._emitCollisions(e);
			}
		}
		...
		_onScroll = () => {
			this._drags.size !== 0 && (r$7.once(n$12.read, this.updateDroppableClientRects, this._listenerId), this.detectCollisions());
		};
		_stopDrag(n, r = !1) {
			...
			if (this._emitter.listenerCount(l$1.End)) {
				let e = i._events.end;
				e.canceled = r, e.targets = a, e.collisions = o, e.contacts = u, this._emitter.emit(l$1.End, e);
			}
			this._drags.delete(n), this._collisionDetector._removeCollisionDataArena(n), r$7.off(n$12.read, i._cd.tickerId), r$7.off(n$12.write, i._cd.tickerId), this._drags.size || (r$7.off(n$12.read, this._listenerId), window.removeEventListener(`scroll`, this._onScroll, c$3));
		}
		...
		_emitCollisions(e, t = !1) {
			...
			if (d.size && i.listenerCount(l$1.Leave)) {
				let e = n._events.leave;
				e.targets = o, e.collisions = a, e.contacts = f, e.removedContacts = p, i.emit(l$1.Leave, e);
			}
			if (c.size && i.listenerCount(l$1.Enter)) {
				let e = n._events.enter;
				e.targets = o, e.collisions = a, e.contacts = f, e.addedContacts = c, i.emit(l$1.Enter, e);
			}
			if (i.listenerCount(l$1.Collide) && (f.size || p.size)) {
				let e = n._events.collide;
				e.targets = o, e.collisions = a, e.contacts = f, e.addedContacts = c, e.removedContacts = p, e.persistedContacts = u, i.emit(l$1.Collide, e);
			}
		...
		detectCollisions(n) {
			if (!this.isDestroyed) if (n) {
				...
				r$7.once(n$12.read, r._cd._compute, r._cd.tickerId), r$7.once(n$12.write, r._cd._emit, r._cd.tickerId);
			} else for (let [, n] of this._drags) n.isEnded || (r$7.once(n$12.read, n._cd._compute, n._cd.tickerId), r$7.once(n$12.write, n._cd._emit, n._cd.tickerId));
		}
		addDraggables(e) {
			if (this.isDestroyed) return;
			let t = /* @__PURE__ */ new Set();
			for (let n of e) this.draggables.has(n.id) || (t.add(n), this.draggables.set(n.id, n), n.on(I.PrepareStart, () => {
				...
				this._onDragMove(n);
			}, this._listenerId), n.on(I.End, (e) => {
				e.endEvent?.type === e$4.End ? this._onDragEnd(n) : this._onDragCancel(n);
			}, this._listenerId), n.on(I.Destroy, () => {
				this._onDraggableDestroy(n);
			}, this._listenerId));
			if (t.size) {
				this._emitter.listenerCount(l$1.AddDraggables) && this._emitter.emit(l$1.AddDraggables, { draggables: t });
		...
		removeDraggables(e) {
			...
			this._emitter.listenerCount(l$1.RemoveDraggables) && this._emitter.emit(l$1.RemoveDraggables, { draggables: t });
		}
		addDroppables(e) {
			if (this.isDestroyed) return;
			let t = /* @__PURE__ */ new Set();
			for (let n of e) this.droppables.has(n.id) || (t.add(n), this.droppables.set(n.id, n), n.on(t$5.Destroy, () => {
			...
			t.size && this._emitter.listenerCount(l$1.AddDroppables) && this._emitter.emit(l$1.AddDroppables, { droppables: t });
		}
		removeDroppables(e) {
			if (this.isDestroyed) return;
			let t = /* @__PURE__ */ new Set();
			for (let n of e) this.droppables.has(n.id) && (this.droppables.delete(n.id), t.add(n), n.off(t$5.Destroy, this._listenerId), this._drags.forEach(({ _targets: e }, t) => {
				e && e.has(n.id) && (e.delete(n.id), this.detectCollisions(t));
			}));
			t.size && this._emitter.listenerCount(l$1.RemoveDroppables) && this._emitter.emit(l$1.RemoveDroppables, { droppables: t });
		}
		destroy() {
			if (this.isDestroyed) return;
			...
			this.isDestroyed = !0, this.draggables.forEach((e) => {
				...
				e.off(t$5.Destroy, this._listenerId);
			});
	...
	//#endregion
	//#region ../dragdoll-react/dist/use-dnd-observer.js
	function a$4({ collisionDetector: a, onStart: o, onMove: s, onEnter: c, onLeave: l, onCollide: u$3, onEnd: d, onAddDraggables: f, onRemoveDraggables: p, onAddDroppables: m, onRemoveDroppables: h, onDestroy: g } = {}) {
		let [_, v] = (0, import_react.useState)(null);
		return n$14(() => {
			let e = new u({ collisionDetector: a });
			return v(e), () => {
				e.destroy(), v(null);
			};
		}, [a]), r$8(l$1.Start, o, _), r$8(l$1.Move, s, _), r$8(l$1.Enter, c, _), r$8(l$1.Leave, l, _), r$8(l$1.Collide, u$3, _), r$8(l$1.End, d, _), r$8(l$1.AddDraggables, f, _), r$8(l$1.RemoveDraggables, p, _), r$8(l$1.AddDroppables, m, _), r$8(l$1.RemoveDroppables, h, _), r$8(l$1.Destroy, g, _), _;
	}
	//#endregion
	//#region ../dragdoll-react/dist/are-configs-equal-BRSXLLVO.js
	const e$1 = Object.prototype.hasOwnProperty, t$4 = (e) => {
	...
	function n$5(r, i) {
		...
		if (r === null || i === null || typeof r != `object` || typeof i != `object`) return !1;
		let a = Array.isArray(r), o = Array.isArray(i);
		if (a || o) {
			if (!a || !o) return !1;
			let e = r.length;
			if (e !== i.length) return !1;
			for (let t = 0; t < e; t++) if (!n$5(r[t], i[t])) return !1;
			return !0;
		}
		let s = r instanceof Set, c = i instanceof Set;
		if (s || c) return !s || !c || r.size !== i.size ? !1 : r.isSubsetOf(i);
		if (!t$4(r) || !t$4(i)) return !1;
		let l = Object.keys(r), u = Object.keys(i);
		if (l.length !== u.length) return !1;
		for (let t = 0; t < l.length; t++) {
			let a = l[t];
			if (!e$1.call(i, a) || !n$5(r[a], i[a])) return !1;
		}
		return !0;
	}
	//#endregion
	//#region ../dragdoll-react/dist/use-callback-stable-CnEpzaNq.js
	function t$3(e, t) {
		if (e === t) return !0;
	...
	function n$4(n, r) {
		let i = (0, import_react.useRef)(null), a = i.current || {
			deps: r,
			value: n()
		};
		return i.current ? t$3(r, a.deps) || (a.deps = r, a.value = n()) : i.current = a, a.value;
	}
	function r$2(e, t) {
		return n$4(() => e, t);
	}
	...
	var n$3 = class {
		...
		_emitter;
		constructor() {
			this.drag = null, this.isDestroyed = !1, this._emitter = new t$10();
		}
		_createDragData(e) {
			return {
				x: e.x,
		...
		_start(t) {
			...
			r.startX = n.startX, r.startY = n.startY, r.deltaX = n.deltaX, r.deltaY = n.deltaY, this.drag = n, this._emitter.emit(e$4.Start, r);
		}
		_move(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$4.Move, n);
		}
		_end(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$4.End, n), this._resetDragData();
		}
		_cancel(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$4.Cancel, n), this._resetDragData();
		}
		on(e, t, n) {
			return this._emitter.on(e, t, n);
		}
	...
	var i$4 = class extends n$3 {
		...
		_start(n) {
			this.isDestroyed || this.drag || (super._start(n), r$7.on(n$12.read, this._tick, this._tick));
		}
		_end(n) {
			this.drag && (r$7.off(n$12.read, this._tick), super._end(n));
		}
		_cancel(n) {
			this.drag && (r$7.off(n$12.read, this._tick), super._cancel(n));
		}
		_tick(e) {
	...
	var a$3 = class extends i$4 {
		...
		constructor(e, t = {}) {
			super();
			let { startPredicate: n = i$3.startPredicate, computeSpeed: r = i$3.computeSpeed, cancelOnVisibilityChange: a = i$3.cancelOnVisibilityChange, cancelOnBlur: o = i$3.cancelOnBlur, startKeys: s = i$3.startKeys, moveLeftKeys: c = i$3.moveLeftKeys, moveRightKeys: l = i$3.moveRightKeys, moveUpKeys: u = i$3.moveUpKeys, moveDownKeys: d = i$3.moveDownKeys, cancelKeys: f = i$3.cancelKeys, endKeys: p = i$3.endKeys } = t;
		...
		_updateDirection() {
			let e = r$1(this._moveLeftKeys, this._moveKeyTimestamps), t = r$1(this._moveRightKeys, this._moveKeyTimestamps), n = r$1(this._moveUpKeys, this._moveKeyTimestamps), i = r$1(this._moveDownKeys, this._moveKeyTimestamps), a = e === t ? 0 : e < t ? -1 : 1, o = n === i ? 0 : n < i ? -1 : 1;
			if (!(a === 0 || o === 0)) {
		...
		_onKeyDown(t) {
			if (!this.drag) {
				if (this._startKeys.has(t.key)) {
					...
					if (n) {
						...
						r.type = e$4.Start, r.x = n.x, r.y = n.y, r.srcEvent = t, this._start(r);
					}
				}
				return;
			}
			...
			if (this._endKeys.has(t.key)) {
				...
				n.type = e$4.End, n.x = this.drag.x, n.y = this.drag.y, n.srcEvent = t, this._end(n);
				return;
			}
	...
	//#endregion
	//#region ../dragdoll-react/dist/use-draggable-Dz4Xt7Zh.js
	const f = /* @__PURE__ */ new Map(), p = [], m = [], h = [], g = [], _ = [], v = [], y = [], b = [];
	function x() {
		f.clear(), p.length = 0, m.length = 0, h.length = 0, g.length = 0, _.length = 0, v.length = 0, y.length = 0, b.length = 0;
	}
	function S(e) {
		let t = [];
		x();
		for (let n = 0; n < e.length; n++) {
			let r = e[n], i = r.parentElement;
			if (!i) throw Error(`Source element must have a parent element.`);
			let a = r.getBoundingClientRect(), o = t$8(r), s = r$5(r), c = s ? o.transformOrigin : ``, y, b;
			if (r instanceof SVGSVGElement) y = `${a.width}px`, b = `${a.height}px`;
			else {
				let e = parseFloat(o.width), t = parseFloat(o.height);
				if (!(e >= 0) || !(t >= 0)) y = `${a.width}px`, b = `${a.height}px`;
				else if (o.boxSizing === `border-box`) y = o.width, b = o.height;
				else {
					let n = parseFloat(o.paddingLeft) || 0, r = parseFloat(o.paddingRight) || 0, i = parseFloat(o.borderLeftWidth) || 0, a = parseFloat(o.borderRightWidth) || 0, s = parseFloat(o.paddingTop) || 0, c = parseFloat(o.paddingBottom) || 0, l = parseFloat(o.borderTopWidth) || 0, u = parseFloat(o.borderBottomWidth) || 0;
					y = `${e + n + r + i + a}px`, b = `${t + s + c + l + u}px`;
				}
			}
			let x = document.createElement(`div`), S = x.style;
			S.position = `absolute`, S.left = `0px`, S.top = `0px`, S.margin = `0`, S.padding = `0`, S.boxSizing = `border-box`, S.pointerEvents = `none`, S.contain = `layout`, x.dataset.dragPreviewProxy = `true`, p[n] = i, t[n] = x, m[n] = a, h[n] = s, g[n] = c, _[n] = y, v[n] = b, f.has(i) || f.set(i, c$4(i));
		}
		for (let n = 0; n < e.length; n++) {
			let e = p[n], r = t[n], i = h[n], a = g[n], o = _[n], s = v[n], c = r.style;
			c.width = o, c.height = s, i && (c.transform = i, a && (c.transformOrigin = a)), e.appendChild(r);
		}
		for (let n = 0; n < e.length; n++) {
			let e = p[n], r = t[n], i = m[n], a = f.get(e), o = 0, s = 0, c = a.m11, l = a.m12, u = a.m21, d = a.m22, h = c * d - l * u, g = r.getBoundingClientRect(), _ = i.left - g.left, v = i.top - g.top;
			if (Math.abs(h) < 1e-10) o = _, s = v;
			else {
				let e = 1 / h;
				o = (d * _ - u * v) * e, s = (-l * _ + c * v) * e;
			}
			y[n] = o, b[n] = s;
		}
		for (let n = 0; n < e.length; n++) {
			let e = t[n].style, r = y[n], i = b[n];
			e.left = `${r}px`, e.top = `${i}px`;
		}
		return x(), t;
	}
	function C(l, u) {
		let d = n$4(() => l.filter((e) => !!e), [...l]), { id: f, dndObserver: p, dragPreviewContainer: m, dragPreviewExitTimeout: h, ...g } = u || {}, _ = n$4(() => f === void 0 ? Symbol() : f, [f]), v = n$15(), y = p === void 0 ? v : p, [b, x] = (0, import_react.useState)(null), C = (0, import_react.useRef)(null), w = (0, import_react.useRef)(d);
		w.current = d;
		let T = (0, import_react.useRef)(g);
		T.current = g;
		let E = (0, import_react.useRef)(y);
		E.current = y;
		let D = (0, import_react.useRef)(m);
		D.current = m;
		let O = (0, import_react.useRef)(h);
		O.current = h;
		let k = (0, import_react.useRef)(void 0), A = r$2(() => {
			let e = C.current;
			e && (e.destroy(), C.current = null, k.current = void 0, x(null));
		}, []), j = r$2((t) => {
			A();
			let n = T.current.dragPreview, r = new R(w.current, {
				id: t,
				...T.current,
				elements(t) {
					let n = T.current, r = (n.elements || (() => null))(t);
					if (!n.dragPreview || !r || r.length === 0) return r;
					let i = S(r);
					i$8.add(t.draggable, r, i);
					let a = () => {
						let n = O.current || 0;
						if (n > 0) {
							for (let e of i) e.dataset.exiting = `true`;
							let r = !1, a = () => {
								r || (r = !0, clearTimeout(o), i$8.remove(t.draggable), setTimeout(() => {
									for (let e of i) e.remove();
								}, 0));
							}, o = setTimeout(a, n);
							i$8.startExiting(t.draggable, a);
						} else i$8.remove(t.draggable), setTimeout(() => {
							for (let e of i) e.remove();
						}, 0);
						t.draggable.off(`end`, o), t.draggable.off(`destroy`, s);
					}, o = t.draggable.on(`end`, a), s = t.draggable.on(`destroy`, a);
					return i;
				},
				...n ? { container: () => {
					let e = D.current;
			...
			C.current = r, k.current = T.current, x(r);
		}, [A]);
		return n$14(() => {
			(b === null || b.id !== _) && j(_);
		}, [
			...
			b && b.sensors !== d && (b.sensors = d);
		}, [b, d]), n$14(() => {
			if (b) return y?.addDraggables([b]), () => {
				y?.removeDraggables([b]);
			};
		}, [b, y]), n$14(() => {
			if (!b) return;
			let e = T.current, t = !1;
			if (k.current) {
				let n = { ...k.current }, i = { ...e };
				(n.elements === i.elements || n.dragPreview && i.dragPreview) && (delete n.elements, delete i.elements), t = !n$5(n, i);
			} else t = !0;
			if (!t) return;
			let n = b._parseSettings(e);
			if (b.updateSettings({
				...n,
				...!e.dragPreview && e.elements ? { elements: e.elements } : {},
				...e.dragPreview ? { container: () => {
					let e = D.current;
					return (typeof e == `function` ? e() : e) || document.body;
				} } : {}
			}), k.current) {
				let t = e.dndGroups !== k.current.dndGroups, n = e.computeClientRect !== k.current.computeClientRect;
				t && E.current?.clearTargets(b), (t || n) && E.current?.detectCollisions(b);
			}
			k.current = e;
		}, [b, u]), n$14(() => A, [A]), b;
	}
	//#endregion
	//#region ../dragdoll-react/dist/use-draggable-callback.js
	function n$1(n, r, i) {
		let a = !!i, o = (0, import_react.useRef)(i);
		o.current = i, n$14(() => {
			if (!n || !a) return;
			let e = n.on(r, ((...e) => {
				o.current?.(...e);
			}));
			return () => void n.off(r, e);
		}, [
			n,
			r,
			a
	...
	//#endregion
	//#region ../dragdoll-react/dist/use-draggable-drag.js
	function r(r, i = !1) {
		let [a, o] = (0, import_react.useState)(r?.drag || null), s = (0, import_react.useState)(void 0)[1];
		return n$1(r, I.Start, (e) => {
			o(e);
		}), n$1(r, I.Move, () => {
			i && s(Symbol());
		}), n$1(r, I.End, () => {
	...
	//#endregion
	//#region ../dragdoll-react/dist/use-droppable.js
	const c$2 = Symbol();
	function l({ id: l, accept: u, data: d, computeClientRect: f, element: p, dndObserver: m } = {}) {
		let h = n$15(), g = m === void 0 ? h : m, [_, v] = (0, import_react.useState)(null), y = (0, import_react.useRef)(null), b = (0, import_react.useRef)({
			id: l,
			accept: u,
			data: d,
			computeClientRect: f
		});
		b.current.id = l, b.current.accept = u, b.current.data = d, b.current.computeClientRect = f;
		let x = (0, import_react.useRef)(c$2), S = (0, import_react.useRef)(g);
		S.current = g;
		let C = r$2(() => {
			let e = y.current;
			e && (e.destroy(), y.current = null, x.current = c$2, v(null));
		}, []), w = r$2((e) => {
			let t = y.current;
			if (t) {
				if (t.element === e && x.current === b.current.id) return;
				t.destroy();
			}
			t = new r$3(e, b.current), y.current = t, x.current = b.current.id, v(t);
		}, []), T = r$2((e) => {
			if (p === void 0) {
				if (e === null) {
					C();
		...
		return n$14(() => {
			if (p !== void 0) return w(p), C;
		}, [
			p,
			w,
			C
		]), n$14(() => {
			_ && x.current !== l && w(_.element);
		}, [
			_,
			l,
			w
		]), n$14(() => {
			if (!(!_ || !g)) return g.addDroppables([_]), () => {
				g.removeDroppables([_]);
			};
		}, [_, g]), n$14(() => {
			_ && (_.accept = u || n$7.accept, S.current?.clearTargets(), S.current?.detectCollisions());
		}, [_, u]), n$14(() => {
			_ && (_.data = d || {});
		}, [_, d]), n$14(() => {
			_ && (_.computeClientRect = f || n$7.computeClientRect, _.updateClientRect(), S.current?.detectCollisions());
		}, [_, f]), n$14(() => C, [C]), n$4(() => [_, T], [_, T]);
	}
	//#endregion
	//#region ../dragdoll-react/dist/use-sensor-callback.js
	function n(n, r, i) {
		let a = !!i, o = (0, import_react.useRef)(i);
		o.current = i, n$14(() => {
			if (!n || !a) return;
	...
	//#endregion
	//#region ../dragdoll-react/dist/use-keyboard-motion-sensor.js
	function c$1(c, l) {
		let { onStart: u, onMove: d, onCancel: f, onEnd: p, onDestroy: m, onTick: h } = c || {}, [g, _] = (0, import_react.useState)(null), v = (0, import_react.useRef)(g), y = (0, import_react.useRef)(c);
		y.current = c, n(g, `start`, u), n(g, `move`, d), n(g, `cancel`, f), n(g, `end`, p), n(g, `destroy`, m), n(g, `tick`, h);
		let b = r$2((e) => {
			let t = v.current;
			if (t) {
				t.updateElement(e);
			...
			let n = new a$3(e, y.current);
			v.current = n, _(n);
		}, []), x = r$2(() => {
			let e = v.current;
			e && (e.destroy(), v.current = null, _(null));
		}, []), S = r$2((e) => {
			if (l === void 0) {
				if (e === null) {
					x();
		...
		return n$14(() => {
			...
			g && g.updateSettings({
				startKeys: c?.startKeys ?? i$3.startKeys,
				moveLeftKeys: c?.moveLeftKeys ?? i$3.moveLeftKeys,
				moveRightKeys: c?.moveRightKeys ?? i$3.moveRightKeys,
				moveUpKeys: c?.moveUpKeys ?? i$3.moveUpKeys,
				moveDownKeys: c?.moveDownKeys ?? i$3.moveDownKeys,
				cancelKeys: c?.cancelKeys ?? i$3.cancelKeys,
				endKeys: c?.endKeys ?? i$3.endKeys,
				cancelOnBlur: c?.cancelOnBlur ?? i$3.cancelOnBlur,
				cancelOnVisibilityChange: c?.cancelOnVisibilityChange ?? i$3.cancelOnVisibilityChange,
				computeSpeed: c?.computeSpeed ?? i$3.computeSpeed,
				startPredicate: c?.startPredicate ?? i$3.startPredicate
			});
		}, [g, c]), n$4(() => [g, S], [g, S]);
	}
	//#endregion
	//#region ../dragdoll-react/dist/use-pointer-sensor.js
	function c(c, l) {
		let { onStart: u, onMove: d$1, onCancel: f, onEnd: p, onDestroy: m } = c || {}, [h, g] = (0, import_react.useState)(null), _ = (0, import_react.useRef)(h), v = (0, import_react.useRef)(c);
		v.current = c, n(h, `start`, u), n(h, `move`, d$1), n(h, `cancel`, f), n(h, `end`, p), n(h, `destroy`, m);
		let y = r$2((e) => {
			let t = _.current;
			if (t) {
				t.updateElement(e);
			...
			let n = new d(e, v.current);
			_.current = n, g(n);
		}, []), b = r$2(() => {
			let e = _.current;
			e && (e.destroy(), _.current = null, g(null));
		}, []), x = r$2((e) => {
			if (l === void 0) {
				if (e === null) {
					b();
		...
		return n$14(() => {
			...
			h && h.updateSettings({
				listenerOptions: c?.listenerOptions ?? u$1.listenerOptions,
				sourceEvents: c?.sourceEvents ?? u$1.sourceEvents,
				startPredicate: c?.startPredicate ?? u$1.startPredicate,
				cancelOnVisibilityChange: c?.cancelOnVisibilityChange ?? u$1.cancelOnVisibilityChange,
				cancelOnEscape: c?.cancelOnEscape ?? u$1.cancelOnEscape,
				preventNativeDrag: c?.preventNativeDrag ?? u$1.preventNativeDrag,
				preventContextMenu: c?.preventContextMenu ?? u$1.preventContextMenu
			});
		}, [h, c]), n$4(() => [h, x], [h, x]);
	}
	//#endregion
	...
	*/
	...
	//#endregion
	//#region examples/react/014-dnd-basic/index.tsx
	...
	const DraggableCardMemo = (0, import_react.memo)(function DraggableCard({ zIndexRef }) {
		...
		const [pointerSensor, setPointerSensorRef] = c();
		const [keyboardSensor, setKeyboardSensorRef] = c$1();
	...
	function App() {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(t$13.Provider, {
			value: dndObserver,
