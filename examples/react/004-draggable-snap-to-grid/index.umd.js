(function(factory) {
	...
	var t$13 = class {
		...
		constructor(e = {}) {
			...
			this._phases = t, this._emitter = new t$13({
				getId: s,
				dedupe: r
	...
	const e$8 = /* @__PURE__ */ new WeakMap();
	function t$12(t) {
		let n = e$8.get(t)?.deref();
		return n || (n = window.getComputedStyle(t, null), e$8.set(t, new WeakRef(n))), n;
	}
	...
	const e$7 = typeof window < `u` && window.document !== void 0, t$11 = e$7 && `ontouchstart` in window, n$11 = e$7 && !!window.PointerEvent;
	e$7 && navigator.vendor && navigator.vendor.indexOf(`Apple`) > -1 && navigator.userAgent && navigator.userAgent.indexOf(`CriOS`) == -1 && navigator.userAgent.indexOf(`FxiOS`);
	//#endregion
	...
	function c$3(n) {
		return n === `auto` || n === void 0 ? n$11 ? `pointer` : t$11 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	var d = class {
		...
		_onMove(e) {
			...
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$6.Move, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r);
		}
		_onCancel(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$6.Cancel, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		_onEnd(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$6.End, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		...
		cancel() {
			this.drag && (this._eventData.type = e$6.Cancel, this._eventData.srcEvent = null, this._eventData.target = null, this._eventData.x = this.drag.x, this._eventData.y = this.drag.y, this._eventData.deltaX = this.drag.deltaX, this._eventData.deltaY = this.drag.deltaY, this._emitter.emit(this._eventData.type, this._eventData), this._resetDrag());
		}
		updateElement(e) {
	...
	function r$5(r, i = !1) {
		let { translate: a, rotate: o, scale: s, transform: c } = t$12(r), l = ``;
		if (a && a !== `none`) {
			let [e = `0px`, i = `0px`, o] = a.split(` `);
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$10(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$10(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	const a$2 = e$7 ? new DOMMatrix() : null, o$1 = e$7 ? new DOMMatrix() : null, s$1 = {
		x: 0,
		y: 0,
		z: 0
	};
	function c$2(t, c = new DOMMatrix()) {
		...
		for (r$4(c); l;) {
			...
			if (t && (a$2.setMatrixValue(t), !a$2.isIdentity)) {
				let { transformOrigin: t } = t$12(l);
				i$3(t, s$1);
				let { x: n, y: u, z: d } = s$1;
				d === 0 ? (a$2.translateSelf(-n, -u), r$4(o$1).translateSelf(n, u)) : (a$2.translateSelf(-n, -u, -d), r$4(o$1).translateSelf(n, u, d)), a$2.preMultiplySelf(o$1), c.preMultiplySelf(a$2);
			}
			l = l.parentElement;
		}
		return c;
	...
	function b$1(e, t = {
		...
		let { x: r, y: i } = e.getBoundingClientRect(), a = t$12(e);
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$12(e), a = e.getBoundingClientRect(), s = r$5(e, !0);
	...
	const D = {
		...
		x: 0,
		y: 0
	}, k = e$7 ? new DOMMatrix() : null, A = e$7 ? new DOMMatrix() : null;
	var j = function(e) {
	...
	var R = class {
		...
		constructor(e, t = {}) {
			let { id: n = Symbol(), ...r } = t;
			this.id = n, this._sensors = e, this.settings = this._parseSettings(r), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new t$13(), this._startPhase = j.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._modifierData = {
				draggable: this,
				drag: null,
				item: null,
				phase: N.Start
		...
		_bindSensor(e) {
			...
			e.on(e$6.Start, t, t), e.on(e$6.Move, t, t), e.on(e$6.Cancel, n, n), e.on(e$6.End, n, n);
		}
		_unbindSensor(e) {
			let t = this._sensorData.get(e);
			if (!t) return;
			let { onMove: n, onEnd: r } = t;
			e.off(e$6.Start, n), e.off(e$6.Move, n), e.off(e$6.Cancel, r), e.off(e$6.End, r), this._sensorData.delete(e);
		}
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$6.once(n$12.read, this._prepareMove, this._moveId), r$6.once(n$12.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$6.once(n$12.read, this._prepareStart, this._startId), r$6.once(n$12.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$6.off(n$12.read, this._startId), r$6.off(n$12.write, this._startId), r$6.off(n$12.read, this._moveId), r$6.off(n$12.write, this._moveId), r$6.off(n$12.read, this._alignId), r$6.off(n$12.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$6.once(n$12.read, this._prepareAlign, this._alignId), r$6.once(n$12.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	//#endregion
	//#region ../dragdoll/dist/draggable/modifiers/snap.js
	function e$5(e, t) {
		return Math.round(e / t) * t;
	}
	function t$9(t, n, r) {
		let i = r - n, a = Math.abs(i);
		if (a >= t) {
			let n = a % t;
			return e$5(i > 0 ? i - n : i + n, t);
		}
		return 0;
	}
	function n$9(e, n) {
		return function(r, { item: i }) {
			let a = i.data.__snap__ || (i.data.__snap__ = {
				snapX: 0,
				snapY: 0,
				sensorX: 0,
				sensorY: 0
			});
			a.sensorX += r.x, a.sensorY += r.y;
			let o = t$9(e, a.snapX, a.sensorX), s = t$9(n, a.snapY, a.sensorY);
			return a.snapX += o, a.snapY += s, r.x = o, r.y = s, r;
		};
	}
	//#endregion
	...
	var n$8 = class {
		...
		_emitter;
		constructor() {
			this.drag = null, this.isDestroyed = !1, this._emitter = new t$13();
		}
		_createDragData(e) {
			return {
				x: e.x,
		...
		_start(t) {
			...
			r.startX = n.startX, r.startY = n.startY, r.deltaX = n.deltaX, r.deltaY = n.deltaY, this.drag = n, this._emitter.emit(e$6.Start, r);
		}
		_move(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$6.Move, n);
		}
		_end(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$6.End, n), this._resetDragData();
		}
		_cancel(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$6.Cancel, n), this._resetDragData();
		}
		on(e, t, n) {
			return this._emitter.on(e, t, n);
		}
		...
		destroy() {
			this.isDestroyed || (this.isDestroyed = !0, this.cancel(), this._emitter.emit(e$6.Destroy, { type: e$6.Destroy }), this._emitter.off());
		}
	};
	//#endregion
	//#region ../dragdoll/dist/sensors/keyboard.js
	const n$7 = {
		moveDistance: 25,
		cancelOnBlur: !0,
		cancelOnVisibilityChange: !0,
		startPredicate: (e, t) => {
			if (t.element && (e.key === `Enter` || e.key === ` `) && document.activeElement === t.element) {
				let { x: e, y: n } = t.element.getBoundingClientRect();
				return {
					x: e,
					y: n
				};
	...
	var r$3 = class extends n$8 {
		...
		_onKeyDown(t) {
			...
			if (!this.drag) {
				...
				n && (t.preventDefault(), this._eventData = {
					type: e$6.Start,
					x: n.x,
					y: n.y,
					srcEvent: t
			...
			if (r) {
				t.preventDefault(), n.type = e$6.Cancel, n.x = r.x, n.y = r.y, n.srcEvent = t, this._cancel(n);
				return;
			}
			let i = this._endPredicate(t, this);
			if (i) {
				t.preventDefault(), n.type = e$6.End, n.x = i.x, n.y = i.y, n.srcEvent = t, this._end(n);
				return;
			}
			let a = this._movePredicate(t, this);
			if (a) {
				t.preventDefault(), n.type = e$6.Move, n.x = a.x, n.y = a.y, n.srcEvent = t, this._move(n);
				return;
			}
		}
		updateElement(e) {
	...
	*/
	...
	function S(e) {
		...
		for (let n = 0; n < e.length; n++) {
			...
			let a = r.getBoundingClientRect(), o = t$12(r), s = r$5(r), c = s ? o.transformOrigin : ``, y, b;
	...
	//#endregion
	//#region ../dragdoll-react/dist/use-keyboard-sensor.js
	function c$1(c, l) {
		let { onStart: u, onMove: d, onCancel: f, onEnd: p, onDestroy: m } = c || {}, [h, g] = (0, import_react.useState)(null), _ = (0, import_react.useRef)(h), v = (0, import_react.useRef)(c);
		v.current = c, n(h, `start`, u), n(h, `move`, d), n(h, `cancel`, f), n(h, `end`, p), n(h, `destroy`, m);
		let y = r$1((e) => {
			let t = _.current;
			if (t) {
				t.updateElement(e);
		...
		return n$4(() => {
			...
			h && h.updateSettings({
				moveDistance: c?.moveDistance ?? n$7.moveDistance,
				cancelOnBlur: c?.cancelOnBlur ?? n$7.cancelOnBlur,
				cancelOnVisibilityChange: c?.cancelOnVisibilityChange ?? n$7.cancelOnVisibilityChange,
				startPredicate: c?.startPredicate ?? n$7.startPredicate,
				movePredicate: c?.movePredicate ?? n$7.movePredicate,
				cancelPredicate: c?.cancelPredicate ?? n$7.cancelPredicate,
				endPredicate: c?.endPredicate ?? n$7.endPredicate
			});
		}, [h, c]), n$2(() => [h, x], [h, x]);
	}
	//#endregion
	...
	*/
	...
	//#endregion
	//#region examples/react/004-draggable-snap-to-grid/index.tsx
	...
	const DraggableCardMemo = (0, import_react.memo)(function DraggableCard() {
		...
		const [keyboardSensor, setKeyboardSensorRef] = c$1({ moveDistance: {
			x: GRID_WIDTH,
			y: GRID_HEIGHT
		} });
		const draggableSettings = (0, import_react.useMemo)(() => ({
			elements: () => elementRef.current ? [elementRef.current] : [],
			positionModifiers: [n$9(GRID_WIDTH, GRID_HEIGHT)]
		}), []);
