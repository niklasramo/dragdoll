(function(factory) {
	...
	const a$1 = e$6 ? new DOMMatrix() : null, o$1 = e$6 ? new DOMMatrix() : null, s$1 = {
		x: 0,
		y: 0,
		z: 0
	};
	function c$1(t, c = new DOMMatrix()) {
		...
		for (r$3(c); l;) {
			...
			if (t && (a$1.setMatrixValue(t), !a$1.isIdentity)) {
				...
				i$2(t, s$1);
				let { x: n, y: u, z: d } = s$1;
				d === 0 ? (a$1.translateSelf(-n, -u), r$3(o$1).translateSelf(n, u)) : (a$1.translateSelf(-n, -u, -d), r$3(o$1).translateSelf(n, u, d)), a$1.preMultiplySelf(o$1), c.preMultiplySelf(a$1);
			}
			l = l.parentElement;
		}
		return c;
		...
		_updateContainerMatrices() {
			[this.elementContainer, this.dragContainer].forEach((e) => {
				if (!this._matrixCache.isValid(e)) {
					...
					c$1(e, n), r$3(r).multiplySelf(n).invertSelf(), this._matrixCache.set(e, t);
				}
			});
		}
	...
	*/
	...
	//#endregion
	//#region examples/react/010-draggable-start-threshold/index.tsx
