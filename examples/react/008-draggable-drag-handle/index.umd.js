(function(factory) {
	...
	const e$6 = typeof window < `u` && window.document !== void 0, t$10 = e$6 && `ontouchstart` in window, n$10 = e$6 && !!window.PointerEvent;
	...
	function c$3(n) {
		return n === `auto` || n === void 0 ? n$10 ? `pointer` : t$10 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	function r$5(r, i = !1) {
		...
		if (a && a !== `none`) {
			...
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$9(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$9(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	function c$2(t, c = new DOMMatrix()) {
		...
		for (r$4(c); l;) {
			...
			if (t && (a$3.setMatrixValue(t), !a$3.isIdentity)) {
				...
				i$5(t, s$1);
				let { x: n, y: u, z: d } = s$1;
				d === 0 ? (a$3.translateSelf(-n, -u), r$4(o$1).translateSelf(n, u)) : (a$3.translateSelf(-n, -u, -d), r$4(o$1).translateSelf(n, u, d)), a$3.preMultiplySelf(o$1), c.preMultiplySelf(a$3);
			}
			l = l.parentElement;
		}
		return c;
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$11(e), a = e.getBoundingClientRect(), s = r$5(e, !0);
		...
		_updateContainerMatrices() {
			[this.elementContainer, this.dragContainer].forEach((e) => {
				if (!this._matrixCache.isValid(e)) {
					...
					c$2(e, n), r$4(r).multiplySelf(n).invertSelf(), this._matrixCache.set(e, t);
				}
			});
		}
	...
	var R = class {
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$6.once(n$11.read, this._prepareMove, this._moveId), r$6.once(n$11.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$6.once(n$11.read, this._prepareStart, this._startId), r$6.once(n$11.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$6.off(n$11.read, this._startId), r$6.off(n$11.write, this._startId), r$6.off(n$11.read, this._moveId), r$6.off(n$11.write, this._moveId), r$6.off(n$11.read, this._alignId), r$6.off(n$11.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$6.once(n$11.read, this._prepareAlign, this._alignId), r$6.once(n$11.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	var i$4 = class extends n$8 {
		...
		_start(n) {
			this.isDestroyed || this.drag || (super._start(n), r$6.on(n$11.read, this._tick, this._tick));
		}
		_end(n) {
			this.drag && (r$6.off(n$11.read, this._tick), super._end(n));
		}
		_cancel(n) {
			this.drag && (r$6.off(n$11.read, this._tick), super._cancel(n));
		}
		_tick(e) {
	...
	*/
	...
	function S(e) {
		...
		for (let n = 0; n < e.length; n++) {
			...
			let a = r.getBoundingClientRect(), o = t$11(r), s = r$5(r), c = s ? o.transformOrigin : ``, y, b;
	...
	*/
	...
	//#endregion
	//#region examples/react/008-draggable-drag-handle/index.tsx
	...
	const DraggableCardMemo = (0, import_react.memo)(function DraggableCard() {
		...
		const draggableSettings = (0, import_react.useMemo)(() => ({
			...
			onStart: (drag) => {
				setSensorType(drag.sensor instanceof d ? "pointer" : "keyboard");
			},
			onEnd: () => {
				setSensorType(null);
			}
