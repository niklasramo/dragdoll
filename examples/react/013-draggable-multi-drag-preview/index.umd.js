(function(factory) {
	...
	var t$15 = class {
		...
		_events;
		constructor(t = {}) {
			this.dedupe = t.dedupe || e$8.ADD, this.getId = t.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
		}
		_getListeners(e) {
		...
		on(t, n, r) {
			...
			if (r = r === void 0 ? this.getId(n) : r, o.has(r)) switch (this.dedupe) {
				case e$8.THROW: throw Error(`Eventti: duplicate listener id!`);
				case e$8.IGNORE: return r;
				case e$8.UPDATE:
					a.l = null;
					break;
		...
		constructor(e = {}) {
			...
			this._phases = t, this._emitter = new t$15({
				getId: s,
				dedupe: r
	...
	function t$14(t) {
		let n = e$7.get(t)?.deref();
		return n || (n = window.getComputedStyle(t, null), e$7.set(t, new WeakRef(n))), n;
	}
	...
	const e$6 = typeof window < `u` && window.document !== void 0, t$13 = e$6 && `ontouchstart` in window, n$12 = e$6 && !!window.PointerEvent;
	...
	function c$3(n) {
		return n === `auto` || n === void 0 ? n$12 ? `pointer` : t$13 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	var d = class {
		...
		_onMove(e) {
			...
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$5.Move, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r);
		}
		_onCancel(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$5.Cancel, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		_onEnd(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$5.End, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		...
		cancel() {
			this.drag && (this._eventData.type = e$5.Cancel, this._eventData.srcEvent = null, this._eventData.target = null, this._eventData.x = this.drag.x, this._eventData.y = this.drag.y, this._eventData.deltaX = this.drag.deltaX, this._eventData.deltaY = this.drag.deltaY, this._emitter.emit(this._eventData.type, this._eventData), this._resetDrag());
		}
		updateElement(e) {
		...
		updateSettings(e) {
			...
			let { listenerOptions: t, sourceEvents: n, startPredicate: r, cancelOnVisibilityChange: i, cancelOnEscape: a, preventNativeDrag: o, preventContextMenu: u } = e, d = c$3(n), f = s$2(t);
	...
	function r$7(r, i = !1) {
		let { translate: a, rotate: o, scale: s, transform: c } = t$14(r), l = ``;
		if (a && a !== `none`) {
			let [e = `0px`, i = `0px`, o] = a.split(` `);
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$11(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$12(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	const a$3 = e$6 ? new DOMMatrix() : null, o$1 = e$6 ? new DOMMatrix() : null, s$1 = {
		x: 0,
		y: 0,
		z: 0
	};
	function c$2(t, c = new DOMMatrix()) {
		...
		for (r$6(c); l;) {
			let t = r$7(l);
			if (t && (a$3.setMatrixValue(t), !a$3.isIdentity)) {
				let { transformOrigin: t } = t$14(l);
				i$6(t, s$1);
				let { x: n, y: u, z: d } = s$1;
				d === 0 ? (a$3.translateSelf(-n, -u), r$6(o$1).translateSelf(n, u)) : (a$3.translateSelf(-n, -u, -d), r$6(o$1).translateSelf(n, u, d)), a$3.preMultiplySelf(o$1), c.preMultiplySelf(a$3);
			}
			l = l.parentElement;
		}
		return c;
	...
	function b$1(e, t = {
		...
		let { x: r, y: i } = e.getBoundingClientRect(), a = t$14(e);
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$14(e), a = e.getBoundingClientRect(), s = r$7(e, !0);
			this.data = {}, this.element = e, this.elementTransformOrigin = i$6(i.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s + i.transform), this.elementOffsetMatrix = new DOMMatrix(s).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
				x: 0,
				y: 0
		...
		_updateContainerMatrices() {
			[this.elementContainer, this.dragContainer].forEach((e) => {
				if (!this._matrixCache.isValid(e)) {
					...
					c$2(e, n), r$6(r).multiplySelf(n).invertSelf(), this._matrixCache.set(e, t);
				}
			});
		}
	...
	const D = {
		...
		x: 0,
		y: 0
	}, k = e$6 ? new DOMMatrix() : null, A = e$6 ? new DOMMatrix() : null;
	var j = function(e) {
	...
	const N = {
		...
		applyPosition: ({ item: e, phase: t }) => {
			...
			r$6(k), _ && (g === 0 ? k.translateSelf(-m, -h) : k.translateSelf(-m, -h, -g)), n ? i.isIdentity || k.multiplySelf(i) : o.isIdentity || k.multiplySelf(o), r$6(A).translateSelf(v, y), k.multiplySelf(A), r.isIdentity || k.multiplySelf(r), _ && (r$6(A).translateSelf(m, h, g), k.multiplySelf(A)), d.isIdentity || k.multiplySelf(d), p.isIdentity || k.preMultiplySelf(p), e.element.style.transform = `${k}`;
		},
	...
	var R = class {
		...
		constructor(e, t = {}) {
			let { id: n = Symbol(), ...r } = t;
			this.id = n, this._sensors = e, this.settings = this._parseSettings(r), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new t$15(), this._startPhase = j.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._modifierData = {
				draggable: this,
				drag: null,
				item: null,
				phase: N.Start
		...
		_bindSensor(e) {
			...
			e.on(e$5.Start, t, t), e.on(e$5.Move, t, t), e.on(e$5.Cancel, n, n), e.on(e$5.End, n, n);
		}
		_unbindSensor(e) {
			let t = this._sensorData.get(e);
			if (!t) return;
			let { onMove: n, onEnd: r } = t;
			e.off(e$5.Start, n), e.off(e$5.Move, n), e.off(e$5.Cancel, r), e.off(e$5.End, r), this._sensorData.delete(e);
		}
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$8.once(n$13.read, this._prepareMove, this._moveId), r$8.once(n$13.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$8.once(n$13.read, this._prepareStart, this._startId), r$8.once(n$13.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$8.off(n$13.read, this._startId), r$8.off(n$13.write, this._startId), r$8.off(n$13.read, this._moveId), r$8.off(n$13.write, this._moveId), r$8.off(n$13.read, this._alignId), r$8.off(n$13.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$8.once(n$13.read, this._prepareAlign, this._alignId), r$8.once(n$13.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	var n$10 = class {
		...
		_emitter;
		constructor() {
			this.drag = null, this.isDestroyed = !1, this._emitter = new t$15();
		}
		_createDragData(e) {
			return {
				x: e.x,
		...
		_start(t) {
			...
			r.startX = n.startX, r.startY = n.startY, r.deltaX = n.deltaX, r.deltaY = n.deltaY, this.drag = n, this._emitter.emit(e$5.Start, r);
		}
		_move(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$5.Move, n);
		}
		_end(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$5.End, n), this._resetDragData();
		}
		_cancel(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$5.Cancel, n), this._resetDragData();
		}
		on(e, t, n) {
			return this._emitter.on(e, t, n);
		}
		...
		destroy() {
			this.isDestroyed || (this.isDestroyed = !0, this.cancel(), this._emitter.emit(e$5.Destroy, { type: e$5.Destroy }), this._emitter.off());
		}
	};
	//#endregion
	//#region ../dragdoll/dist/sensors/base-motion.js
	var i$5 = class extends n$10 {
		drag;
		_direction;
		_speed;
		_tickEvent;
		...
		_start(n) {
			this.isDestroyed || this.drag || (super._start(n), r$8.on(n$13.read, this._tick, this._tick));
		}
		_end(n) {
			this.drag && (r$8.off(n$13.read, this._tick), super._end(n));
		}
		_cancel(n) {
			this.drag && (r$8.off(n$13.read, this._tick), super._cancel(n));
		}
		_tick(e) {
	...
	var a$2 = class extends i$5 {
		...
		constructor(e, t = {}) {
			super();
			let { startPredicate: n = i$4.startPredicate, computeSpeed: r = i$4.computeSpeed, cancelOnVisibilityChange: a = i$4.cancelOnVisibilityChange, cancelOnBlur: o = i$4.cancelOnBlur, startKeys: s = i$4.startKeys, moveLeftKeys: c = i$4.moveLeftKeys, moveRightKeys: l = i$4.moveRightKeys, moveUpKeys: u = i$4.moveUpKeys, moveDownKeys: d = i$4.moveDownKeys, cancelKeys: f = i$4.cancelKeys, endKeys: p = i$4.endKeys } = t;
		...
		_updateDirection() {
			let e = r$5(this._moveLeftKeys, this._moveKeyTimestamps), t = r$5(this._moveRightKeys, this._moveKeyTimestamps), n = r$5(this._moveUpKeys, this._moveKeyTimestamps), i = r$5(this._moveDownKeys, this._moveKeyTimestamps), a = e === t ? 0 : e < t ? -1 : 1, o = n === i ? 0 : n < i ? -1 : 1;
			if (!(a === 0 || o === 0)) {
		...
		_onKeyDown(t) {
			if (!this.drag) {
				if (this._startKeys.has(t.key)) {
					...
					if (n) {
						...
						r.type = e$5.Start, r.x = n.x, r.y = n.y, r.srcEvent = t, this._start(r);
					}
				}
				return;
			}
			...
			if (this._endKeys.has(t.key)) {
				...
				n.type = e$5.End, n.x = this.drag.x, n.y = this.drag.y, n.srcEvent = t, this._end(n);
				return;
			}
	...
	const e$4 = () => {};
	let t$10 = /* @__PURE__ */ new Map();
	const n$8 = /* @__PURE__ */ new Set();
	function r$4() {
		n$8.forEach((e) => e());
	}
	const i$3 = {
		add(n, i, a) {
			t$10 = new Map(t$10), t$10.set(n, {
				sources: i,
				proxies: a,
				exiting: !1,
				done: e$4
		...
		startExiting(e, n) {
			let i = t$10.get(e);
			i && (t$10 = new Map(t$10), t$10.set(e, {
				...i,
				exiting: !0,
				done: n
			}), r$4());
		...
		remove(e) {
			t$10.has(e) && (t$10 = new Map(t$10), t$10.delete(e), r$4());
		},
		subscribe(e) {
			return n$8.add(e), () => n$8.delete(e);
		},
		getSnapshot() {
			return t$10;
		}
	...
	*/
	...
	//#endregion
	//#region ../dragdoll-react/dist/use-drag-preview.js
	var import_react = require_react();
	function r$3(r) {
		let i = (0, import_react.useSyncExternalStore)(i$3.subscribe, i$3.getSnapshot, i$3.getSnapshot);
	...
	*/
	...
	//#endregion
	//#region ../dragdoll-react/dist/drag-preview.js
	var import_react_dom = require_react_dom();
	var import_jsx_runtime = require_jsx_runtime();
	function i$2({ draggable: i, children: a }) {
		let o = r$3(i);
		if (!o || !o.proxies.length) return null;
		let { draggable: s, sources: c, proxies: l, exiting: u, done: d } = o, f = s.drag?.items;
		return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: l.map((e, n) => (0, import_react_dom.createPortal)(typeof a == `function` ? a({
			draggable: s,
			item: f?.[n] ?? null,
			index: n,
			sourceElement: c[n],
	...
	const n$4 = typeof window > `u` ? import_react.useEffect : import_react.useLayoutEffect;
	//#endregion
	...
	function n$3(r, i) {
		...
		if (a || o) {
			...
			for (let t = 0; t < e; t++) if (!n$3(r[t], i[t])) return !1;
			return !0;
		}
		...
		for (let t = 0; t < l.length; t++) {
			let a = l[t];
			if (!e$1.call(i, a) || !n$3(r[a], i[a])) return !1;
		}
		return !0;
	}
	//#endregion
	...
	function S(e) {
		...
		for (let n = 0; n < e.length; n++) {
			...
			let a = r.getBoundingClientRect(), o = t$14(r), s = r$7(r), c = s ? o.transformOrigin : ``, y, b;
			...
			S.position = `absolute`, S.left = `0px`, S.top = `0px`, S.margin = `0`, S.padding = `0`, S.boxSizing = `border-box`, S.pointerEvents = `none`, S.contain = `layout`, x.dataset.dragPreviewProxy = `true`, p[n] = i, t[n] = x, m[n] = a, h[n] = s, g[n] = c, _[n] = y, v[n] = b, f.has(i) || f.set(i, c$2(i));
		}
		for (let n = 0; n < e.length; n++) {
	...
	function C(l, u) {
		let d = n$2(() => l.filter((e) => !!e), [...l]), { id: f, dndObserver: p, dragPreviewContainer: m, dragPreviewExitTimeout: h, ...g } = u || {}, _ = n$2(() => f === void 0 ? Symbol() : f, [f]), v = n$5(), y = p === void 0 ? v : p, [b, x] = (0, import_react.useState)(null), C = (0, import_react.useRef)(null), w = (0, import_react.useRef)(d);
		w.current = d;
		...
		O.current = h;
		let k = (0, import_react.useRef)(void 0), A = r$1(() => {
			let e = C.current;
			...
			let n = T.current.dragPreview, r = new R(w.current, {
				...
				elements(t) {
					...
					let i = S(r);
					i$3.add(t.draggable, r, i);
					let a = () => {
						let n = O.current || 0;
						if (n > 0) {
							for (let e of i) e.dataset.exiting = `true`;
							let r = !1, a = () => {
								r || (r = !0, clearTimeout(o), i$3.remove(t.draggable), setTimeout(() => {
									for (let e of i) e.remove();
								}, 0));
							}, o = setTimeout(a, n);
							i$3.startExiting(t.draggable, a);
						} else i$3.remove(t.draggable), setTimeout(() => {
							for (let e of i) e.remove();
						}, 0);
		...
		return n$4(() => {
			...
			if (k.current) {
				let n = { ...k.current }, i = { ...e };
				(n.elements === i.elements || n.dragPreview && i.dragPreview) && (delete n.elements, delete i.elements), t = !n$3(n, i);
			} else t = !0;
			if (!t) return;
	...
	function c$1(c, l) {
		...
		return n$4(() => {
			...
			g && g.updateSettings({
				startKeys: c?.startKeys ?? i$4.startKeys,
				moveLeftKeys: c?.moveLeftKeys ?? i$4.moveLeftKeys,
				moveRightKeys: c?.moveRightKeys ?? i$4.moveRightKeys,
				moveUpKeys: c?.moveUpKeys ?? i$4.moveUpKeys,
				moveDownKeys: c?.moveDownKeys ?? i$4.moveDownKeys,
				cancelKeys: c?.cancelKeys ?? i$4.cancelKeys,
				endKeys: c?.endKeys ?? i$4.endKeys,
				cancelOnBlur: c?.cancelOnBlur ?? i$4.cancelOnBlur,
				cancelOnVisibilityChange: c?.cancelOnVisibilityChange ?? i$4.cancelOnVisibilityChange,
				computeSpeed: c?.computeSpeed ?? i$4.computeSpeed,
				startPredicate: c?.startPredicate ?? i$4.startPredicate
			});
		}, [g, c]), n$2(() => [g, S], [g, S]);
	}
	//#endregion
	...
	function c(c, l) {
		let { onStart: u$2, onMove: d$1, onCancel: f, onEnd: p, onDestroy: m } = c || {}, [h, g] = (0, import_react.useState)(null), _ = (0, import_react.useRef)(h), v = (0, import_react.useRef)(c);
		v.current = c, n(h, `start`, u$2), n(h, `move`, d$1), n(h, `cancel`, f), n(h, `end`, p), n(h, `destroy`, m);
		let y = r$1((e) => {
			let t = _.current;
			if (t) {
				t.updateElement(e);
		...
		return n$4(() => {
			...
			h && h.updateSettings({
				listenerOptions: c?.listenerOptions ?? u.listenerOptions,
				sourceEvents: c?.sourceEvents ?? u.sourceEvents,
				startPredicate: c?.startPredicate ?? u.startPredicate,
				cancelOnVisibilityChange: c?.cancelOnVisibilityChange ?? u.cancelOnVisibilityChange,
				cancelOnEscape: c?.cancelOnEscape ?? u.cancelOnEscape,
				preventNativeDrag: c?.preventNativeDrag ?? u.preventNativeDrag,
				preventContextMenu: c?.preventContextMenu ?? u.preventContextMenu
			});
		}, [h, c]), n$2(() => [h, x], [h, x]);
	}
	//#endregion
	...
	*/
	...
	//#endregion
	//#region examples/react/013-draggable-multi-drag-preview/index.tsx
	...
	const LABELS = [
		"skew(-8deg)",
		"rotate(12deg)",
		"skew(5deg) rotate(-6deg)"
	];
	const ITEM_COUNT = 3;
	function Card({ id, elementRefs, isDragging }) {
	...
	function App() {
		const cardElementRefs = (0, import_react.useRef)(new Array(ITEM_COUNT).fill(null));
		const containerRefs = (0, import_react.useRef)(new Array(ITEM_COUNT).fill(null));
		const sensorSettings = (0, import_react.useMemo)(() => ({ startPredicate: (e) => {
			if ("button" in e && e.button > 0) return false;
			const target = e.target;
			if (!target) return false;
			return containerRefs.current.some((container) => container?.contains(target));
		} }), []);
		const keyboardSensorSettings = (0, import_react.useMemo)(() => ({ startPredicate: () => {
		...
		const [pointerSensor] = c(sensorSettings, window);
		const [keyboardSensor] = c$1(keyboardSensorSettings, null);
		const draggableSettings = (0, import_react.useMemo)(() => ({
			dragPreview: true,
			elements: () => cardElementRefs.current.filter((el) => !!el),
			onEnd: (drag) => {
				...
				for (let i = 0; i < items.length; i++) {
					...
					const offset = t$11(cardElement, item.clientRect.x, item.clientRect.y);
		...
		const draggable = C([pointerSensor, keyboardSensor], draggableSettings);
		const drag = r(draggable);
		const setContainerRef = (0, import_react.useCallback)((id, node) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [[
			...
			ref: (node) => setContainerRef(id, node),
			className: "container",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "container-inner",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
					id,
					elementRefs: cardElementRefs,
					isDragging: !!drag
				})
		...
		}, id)), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(i$2, {
			draggable,
			children: ({ index }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
