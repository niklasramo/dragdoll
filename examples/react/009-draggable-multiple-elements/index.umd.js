(function(factory) {
	...
	const i$6 = {
		...
		remove(e) {
			t$10.has(e) && (t$10 = new Map(t$10), t$10.delete(e), r$5());
		},
		subscribe(e) {
			return n$10.add(e), () => n$10.delete(e);
		},
		getSnapshot() {
			return t$10;
		}
	...
	*/
	...
	const t$9 = (0, import_react.createContext)(null);
	//#endregion
	//#region ../dragdoll-react/dist/use-dnd-observer-context.js
	function n$9() {
		return (0, import_react.useContext)(t$9);
	}
	//#endregion
	//#region ../dragdoll-react/dist/use-isomorphic-layout-effect-DlbbETLC.js
	const n$8 = typeof window > `u` ? import_react.useEffect : import_react.useLayoutEffect;
	//#endregion
	...
	var t$6 = class {
		...
		constructor(e = {}) {
			...
			this._phases = t, this._emitter = new t$6({
				getId: s,
				dedupe: r
	...
	const e$2 = typeof window < `u` && window.document !== void 0, t$4 = e$2 && `ontouchstart` in window, n$6 = e$2 && !!window.PointerEvent;
	...
	function c$3(n) {
		return n === `auto` || n === void 0 ? n$6 ? `pointer` : t$4 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	function r$3(r, i = !1) {
		...
		if (a && a !== `none`) {
			...
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$5(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$3(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	function c$2(t, c = new DOMMatrix()) {
		...
		for (r$2(c); l;) {
			...
			if (t && (a$3.setMatrixValue(t), !a$3.isIdentity)) {
				...
				i$4(t, s$1);
				let { x: n, y: u, z: d } = s$1;
				d === 0 ? (a$3.translateSelf(-n, -u), r$2(o$1).translateSelf(n, u)) : (a$3.translateSelf(-n, -u, -d), r$2(o$1).translateSelf(n, u, d)), a$3.preMultiplySelf(o$1), c.preMultiplySelf(a$3);
			}
			l = l.parentElement;
		}
		return c;
	...
	var R = class {
		...
		constructor(e, t = {}) {
			let { id: n = Symbol(), ...r } = t;
			this.id = n, this._sensors = e, this.settings = this._parseSettings(r), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new t$6(), this._startPhase = j.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._modifierData = {
				draggable: this,
				drag: null,
				item: null,
				phase: N.Start
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$4.once(n$7.read, this._prepareMove, this._moveId), r$4.once(n$7.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$4.once(n$7.read, this._prepareStart, this._startId), r$4.once(n$7.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$4.off(n$7.read, this._startId), r$4.off(n$7.write, this._startId), r$4.off(n$7.read, this._moveId), r$4.off(n$7.write, this._moveId), r$4.off(n$7.read, this._alignId), r$4.off(n$7.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$4.once(n$7.read, this._prepareAlign, this._alignId), r$4.once(n$7.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	const e$1 = Object.prototype.hasOwnProperty, t$2 = (e) => {
	...
	function n$3(n, r) {
		...
		return i.current ? t$1(r, a.deps) || (a.deps = r, a.value = n()) : i.current = a, a.value;
	}
	function r$1(e, t) {
		return n$3(() => e, t);
	}
	...
	var n$2 = class {
		...
		_emitter;
		constructor() {
			this.drag = null, this.isDestroyed = !1, this._emitter = new t$6();
		}
		_createDragData(e) {
			return {
				x: e.x,
	...
	var i$3 = class extends n$2 {
		...
		_start(n) {
			this.isDestroyed || this.drag || (super._start(n), r$4.on(n$7.read, this._tick, this._tick));
		}
		_end(n) {
			this.drag && (r$4.off(n$7.read, this._tick), super._end(n));
		}
		_cancel(n) {
			this.drag && (r$4.off(n$7.read, this._tick), super._cancel(n));
		}
		_tick(e) {
	...
	function S(e) {
		...
		for (let n = 0; n < e.length; n++) {
			...
			let a = r.getBoundingClientRect(), o = t$5(r), s = r$3(r), c = s ? o.transformOrigin : ``, y, b;
	...
	function C(l, u) {
		let d = n$3(() => l.filter((e) => !!e), [...l]), { id: f, dndObserver: p, dragPreviewContainer: m, dragPreviewExitTimeout: h, ...g } = u || {}, _ = n$3(() => f === void 0 ? Symbol() : f, [f]), v = n$9(), y = p === void 0 ? v : p, [b, x] = (0, import_react.useState)(null), C = (0, import_react.useRef)(null), w = (0, import_react.useRef)(d);
		w.current = d;
		...
		return n$8(() => {
			...
			if (k.current) {
				let n = { ...k.current }, i = { ...e };
				(n.elements === i.elements || n.dragPreview && i.dragPreview) && (delete n.elements, delete i.elements), t = !n$4(n, i);
			} else t = !0;
			if (!t) return;
	...
	*/
	...
	//#endregion
	//#region examples/react/009-draggable-multiple-elements/index.tsx
