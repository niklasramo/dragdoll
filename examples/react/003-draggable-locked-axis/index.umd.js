(function(factory) {
	...
	const e$8 = () => {};
	let t$12 = /* @__PURE__ */ new Map();
	const n$11 = /* @__PURE__ */ new Set();
	function r$6() {
		n$11.forEach((e) => e());
	}
	const i$6 = {
		add(n, i, a) {
			t$12 = new Map(t$12), t$12.set(n, {
				sources: i,
				proxies: a,
				exiting: !1,
				done: e$8
		...
		startExiting(e, n) {
			let i = t$12.get(e);
			i && (t$12 = new Map(t$12), t$12.set(e, {
				...i,
				exiting: !0,
				done: n
			}), r$6());
		...
		remove(e) {
			t$12.has(e) && (t$12 = new Map(t$12), t$12.delete(e), r$6());
		},
		subscribe(e) {
			return n$11.add(e), () => n$11.delete(e);
		},
		getSnapshot() {
			return t$12;
		}
	...
	*/
	...
	const t$11 = (0, import_react.createContext)(null);
	//#endregion
	//#region ../dragdoll-react/dist/use-dnd-observer-context.js
	function n$10() {
		return (0, import_react.useContext)(t$11);
	}
	//#endregion
	//#region ../dragdoll-react/dist/use-isomorphic-layout-effect-DlbbETLC.js
	const n$9 = typeof window > `u` ? import_react.useEffect : import_react.useLayoutEffect;
	//#endregion
	...
	const e$2 = typeof window < `u` && window.document !== void 0, t$6 = e$2 && `ontouchstart` in window, n$7 = e$2 && !!window.PointerEvent;
	...
	function c$3(n) {
		return n === `auto` || n === void 0 ? n$7 ? `pointer` : t$6 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	function r$4(r, i = !1) {
		let { translate: a, rotate: o, scale: s, transform: c } = t$7(r), l = ``;
		if (a && a !== `none`) {
			let [e = `0px`, i = `0px`, o] = a.split(` `);
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$6(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$5(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	const a$3 = e$2 ? new DOMMatrix() : null, o$1 = e$2 ? new DOMMatrix() : null, s$1 = {
		x: 0,
		y: 0,
		z: 0
	};
	function c$2(t, c = new DOMMatrix()) {
		...
		for (r$3(c); l;) {
			...
			if (t && (a$3.setMatrixValue(t), !a$3.isIdentity)) {
				let { transformOrigin: t } = t$7(l);
				i$4(t, s$1);
				let { x: n, y: u, z: d } = s$1;
				d === 0 ? (a$3.translateSelf(-n, -u), r$3(o$1).translateSelf(n, u)) : (a$3.translateSelf(-n, -u, -d), r$3(o$1).translateSelf(n, u, d)), a$3.preMultiplySelf(o$1), c.preMultiplySelf(a$3);
			}
			l = l.parentElement;
		}
		return c;
	...
	function b$1(e, t = {
		...
		let { x: r, y: i } = e.getBoundingClientRect(), a = t$7(e);
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$7(e), a = e.getBoundingClientRect(), s = r$4(e, !0);
			this.data = {}, this.element = e, this.elementTransformOrigin = i$4(i.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s + i.transform), this.elementOffsetMatrix = new DOMMatrix(s).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
				x: 0,
				y: 0
	...
	var R = class {
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$8.read, this._prepareMove, this._moveId), r$5.once(n$8.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$5.once(n$8.read, this._prepareStart, this._startId), r$5.once(n$8.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$5.off(n$8.read, this._startId), r$5.off(n$8.write, this._startId), r$5.off(n$8.read, this._moveId), r$5.off(n$8.write, this._moveId), r$5.off(n$8.read, this._alignId), r$5.off(n$8.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$8.read, this._prepareAlign, this._alignId), r$5.once(n$8.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	var i$3 = class extends n$3 {
		...
		_start(n) {
			this.isDestroyed || this.drag || (super._start(n), r$5.on(n$8.read, this._tick, this._tick));
		}
		_end(n) {
			this.drag && (r$5.off(n$8.read, this._tick), super._end(n));
		}
		_cancel(n) {
			this.drag && (r$5.off(n$8.read, this._tick), super._cancel(n));
		}
		_tick(e) {
	...
	var a$2 = class extends i$3 {
		...
		constructor(e, t = {}) {
			super();
			let { startPredicate: n = i$2.startPredicate, computeSpeed: r = i$2.computeSpeed, cancelOnVisibilityChange: a = i$2.cancelOnVisibilityChange, cancelOnBlur: o = i$2.cancelOnBlur, startKeys: s = i$2.startKeys, moveLeftKeys: c = i$2.moveLeftKeys, moveRightKeys: l = i$2.moveRightKeys, moveUpKeys: u = i$2.moveUpKeys, moveDownKeys: d = i$2.moveDownKeys, cancelKeys: f = i$2.cancelKeys, endKeys: p = i$2.endKeys } = t;
	...
	function S(e) {
		...
		for (let n = 0; n < e.length; n++) {
			...
			let a = r.getBoundingClientRect(), o = t$7(r), s = r$4(r), c = s ? o.transformOrigin : ``, y, b;
	...
	function C(l, u) {
		let d = n$4(() => l.filter((e) => !!e), [...l]), { id: f, dndObserver: p, dragPreviewContainer: m, dragPreviewExitTimeout: h, ...g } = u || {}, _ = n$4(() => f === void 0 ? Symbol() : f, [f]), v = n$10(), y = p === void 0 ? v : p, [b, x] = (0, import_react.useState)(null), C = (0, import_react.useRef)(null), w = (0, import_react.useRef)(d);
		w.current = d;
		...
		let k = (0, import_react.useRef)(void 0), A = r$2(() => {
			...
			let n = T.current.dragPreview, r = new R(w.current, {
				...
				elements(t) {
					...
					let i = S(r);
					i$6.add(t.draggable, r, i);
					let a = () => {
						let n = O.current || 0;
						if (n > 0) {
							for (let e of i) e.dataset.exiting = `true`;
							let r = !1, a = () => {
								r || (r = !0, clearTimeout(o), i$6.remove(t.draggable), setTimeout(() => {
									for (let e of i) e.remove();
								}, 0));
							}, o = setTimeout(a, n);
							i$6.startExiting(t.draggable, a);
						} else i$6.remove(t.draggable), setTimeout(() => {
							for (let e of i) e.remove();
						}, 0);
	...
	function c$1(c, l) {
		...
		return n$9(() => {
			...
			g && g.updateSettings({
				startKeys: c?.startKeys ?? i$2.startKeys,
				moveLeftKeys: c?.moveLeftKeys ?? i$2.moveLeftKeys,
				moveRightKeys: c?.moveRightKeys ?? i$2.moveRightKeys,
				moveUpKeys: c?.moveUpKeys ?? i$2.moveUpKeys,
				moveDownKeys: c?.moveDownKeys ?? i$2.moveDownKeys,
				cancelKeys: c?.cancelKeys ?? i$2.cancelKeys,
				endKeys: c?.endKeys ?? i$2.endKeys,
				cancelOnBlur: c?.cancelOnBlur ?? i$2.cancelOnBlur,
				cancelOnVisibilityChange: c?.cancelOnVisibilityChange ?? i$2.cancelOnVisibilityChange,
				computeSpeed: c?.computeSpeed ?? i$2.computeSpeed,
				startPredicate: c?.startPredicate ?? i$2.startPredicate
			});
		}, [g, c]), n$4(() => [g, S], [g, S]);
	}
	//#endregion
	...
	*/
	...
	//#endregion
	//#region examples/react/003-draggable-locked-axis/index.tsx
