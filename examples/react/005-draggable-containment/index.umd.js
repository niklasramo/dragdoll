(function(factory) {
	...
	var t$12 = class {
		...
		_events;
		constructor(t = {}) {
			this.dedupe = t.dedupe || e$9.ADD, this.getId = t.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
		}
		_getListeners(e) {
		...
		on(t, n, r) {
			...
			if (r = r === void 0 ? this.getId(n) : r, o.has(r)) switch (this.dedupe) {
				case e$9.THROW: throw Error(`Eventti: duplicate listener id!`);
				case e$9.IGNORE: return r;
				case e$9.UPDATE:
					a.l = null;
					break;
		...
		constructor(e = {}) {
			...
			this._phases = t, this._emitter = new t$12({
				getId: s,
				dedupe: r
	...
	const e$6 = typeof window < `u` && window.document !== void 0, t$10 = e$6 && `ontouchstart` in window, n$11 = e$6 && !!window.PointerEvent;
	...
	function c$3(n) {
		return n === `auto` || n === void 0 ? n$11 ? `pointer` : t$10 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	function r$6(r, i = !1) {
		let { translate: a, rotate: o, scale: s, transform: c } = t$11(r), l = ``;
		if (a && a !== `none`) {
			let [e = `0px`, i = `0px`, o] = a.split(` `);
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$10(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$9(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	const a$4 = e$6 ? new DOMMatrix() : null, o$2 = e$6 ? new DOMMatrix() : null, s$2 = {
		x: 0,
		y: 0,
		z: 0
	};
	function c$2(t, c = new DOMMatrix()) {
		...
		for (r$5(c); l;) {
			let t = r$6(l);
			if (t && (a$4.setMatrixValue(t), !a$4.isIdentity)) {
				let { transformOrigin: t } = t$11(l);
				i$6(t, s$2);
				let { x: n, y: u, z: d } = s$2;
				d === 0 ? (a$4.translateSelf(-n, -u), r$5(o$2).translateSelf(n, u)) : (a$4.translateSelf(-n, -u, -d), r$5(o$2).translateSelf(n, u, d)), a$4.preMultiplySelf(o$2), c.preMultiplySelf(a$4);
			}
			l = l.parentElement;
		}
		return c;
	...
	function b$1(e, t = {
		...
		let { x: r, y: i } = e.getBoundingClientRect(), a = t$11(e);
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$11(e), a = e.getBoundingClientRect(), s = r$6(e, !0);
		...
		_updateContainerMatrices() {
			[this.elementContainer, this.dragContainer].forEach((e) => {
				if (!this._matrixCache.isValid(e)) {
					...
					c$2(e, n), r$5(r).multiplySelf(n).invertSelf(), this._matrixCache.set(e, t);
				}
			});
		}
	...
	const N = {
		...
		applyPosition: ({ item: e, phase: t }) => {
			...
			r$5(k), _ && (g === 0 ? k.translateSelf(-m, -h) : k.translateSelf(-m, -h, -g)), n ? i.isIdentity || k.multiplySelf(i) : o.isIdentity || k.multiplySelf(o), r$5(A).translateSelf(v, y), k.multiplySelf(A), r.isIdentity || k.multiplySelf(r), _ && (r$5(A).translateSelf(m, h, g), k.multiplySelf(A)), d.isIdentity || k.multiplySelf(d), p.isIdentity || k.preMultiplySelf(p), e.element.style.transform = `${k}`;
		},
	...
	var R = class {
		...
		constructor(e, t = {}) {
			let { id: n = Symbol(), ...r } = t;
			this.id = n, this._sensors = e, this.settings = this._parseSettings(r), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new t$12(), this._startPhase = j.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._modifierData = {
				draggable: this,
				drag: null,
				item: null,
				phase: N.Start
	...
	const n$9 = e$8(), r$4 = e$8(), i$5 = {
		change: 0,
		drift: 0
	};
	function a$3(e, t, n, r, a, o, s) {
		let c = o, l = a;
		if (o > 0) {
			if (c = Math.min(Math.max(r - t, 0), o), s) if (a < 0) {
				let e = Math.min(-a, o);
				l = a + e, c = Math.max(0, c - e);
			} else l = a + (o - c);
		} else if (o < 0 && (c = Math.max(Math.min(n - e, 0), o), s)) if (a > 0) {
			let e = Math.max(-a, o);
			l = a + e, c = Math.min(0, c - e);
		} else l = a + (o - c);
		i$5.change = c, i$5.drift = l;
	}
	function o$1(e, t, n) {
		let r = n - t, i = Math.abs(r);
		if (i >= e) {
			let t = i % e, n = r > 0 ? r - t : r + t;
			return Math.round(n / e) * e;
		}
		return 0;
	}
	function s$1(s, c) {
		let l = c?.trackSensorDrift ?? (({ drag: e }) => e.sensor instanceof d), u = c?.snapX || 0, d$2 = c?.snapY || 0;
		return function(t, c) {
			let f = e$8(s(c), n$9), p = e$8(c.item.clientRect, r$4), m = c.item.data, h = m.__containment__ || {
				drift: {
					x: 0,
					y: 0
				},
			...
			if (m.__containment__ ||= (h.trackDrift = typeof l == `function` ? l(c) : l, h), c.phase === `start`) return t.x &&= (a$3(p.left, p.right, f.left, f.right, 0, t.x, !1), i$5.change), t.y &&= (a$3(p.top, p.bottom, f.top, f.bottom, 0, t.y, !1), i$5.change), (u || d$2) && (h.startLeft = p.left + t.x, h.startTop = p.top + t.y, h.startRight = p.right + t.x, h.startBottom = p.bottom + t.y), t;
			if (u) {
				h.sensorX += t.x;
				let e = o$1(u, h.snapX, h.sensorX), n = h.snapX + e, r = Math.ceil((f.left - h.startLeft) / u) * u, i = Math.floor((f.right - h.startRight) / u) * u;
				n = Math.min(Math.max(n, r), i), t.x = n - h.snapX, h.snapX = n;
			} else t.x &&= (a$3(p.left, p.right, f.left, f.right, h.drift.x, t.x, h.trackDrift), h.drift.x = i$5.drift, i$5.change);
			if (d$2) {
				h.sensorY += t.y;
				let e = o$1(d$2, h.snapY, h.sensorY), n = h.snapY + e, r = Math.ceil((f.top - h.startTop) / d$2) * d$2, i = Math.floor((f.bottom - h.startBottom) / d$2) * d$2;
				n = Math.min(Math.max(n, r), i), t.y = n - h.snapY, h.snapY = n;
			} else t.y &&= (a$3(p.top, p.bottom, f.top, f.bottom, h.drift.y, t.y, h.trackDrift), h.drift.y = i$5.drift, i$5.change);
			return t;
		};
	}
	//#endregion
	...
	var n$8 = class {
		...
		_emitter;
		constructor() {
			this.drag = null, this.isDestroyed = !1, this._emitter = new t$12();
		}
		_createDragData(e) {
			return {
				x: e.x,
	...
	var a$2 = class extends i$4 {
		...
		_updateDirection() {
			let e = r$3(this._moveLeftKeys, this._moveKeyTimestamps), t = r$3(this._moveRightKeys, this._moveKeyTimestamps), n = r$3(this._moveUpKeys, this._moveKeyTimestamps), i = r$3(this._moveDownKeys, this._moveKeyTimestamps), a = e === t ? 0 : e < t ? -1 : 1, o = n === i ? 0 : n < i ? -1 : 1;
			if (!(a === 0 || o === 0)) {
	...
	const e$4 = () => {};
	let t$8 = /* @__PURE__ */ new Map();
	const n$6 = /* @__PURE__ */ new Set();
	function r$2() {
		n$6.forEach((e) => e());
	}
	const i$2 = {
		add(n, i, a) {
			t$8 = new Map(t$8), t$8.set(n, {
				sources: i,
				proxies: a,
				exiting: !1,
				done: e$4
		...
		remove(e) {
			t$8.has(e) && (t$8 = new Map(t$8), t$8.delete(e), r$2());
		},
		subscribe(e) {
			return n$6.add(e), () => n$6.delete(e);
		},
		getSnapshot() {
			return t$8;
		}
	...
	*/
	...
	function S(e) {
		...
		for (let n = 0; n < e.length; n++) {
			...
			let a = r.getBoundingClientRect(), o = t$11(r), s = r$6(r), c = s ? o.transformOrigin : ``, y, b;
		...
		let k = (0, import_react.useRef)(void 0), A = r$1(() => {
			...
			let n = T.current.dragPreview, r = new R(w.current, {
				...
				elements(t) {
					...
					let i = S(r);
					i$2.add(t.draggable, r, i);
					let a = () => {
						let n = O.current || 0;
						if (n > 0) {
							for (let e of i) e.dataset.exiting = `true`;
							let r = !1, a = () => {
								r || (r = !0, clearTimeout(o), i$2.remove(t.draggable), setTimeout(() => {
									for (let e of i) e.remove();
								}, 0));
							}, o = setTimeout(a, n);
							i$2.startExiting(t.draggable, a);
						} else i$2.remove(t.draggable), setTimeout(() => {
							for (let e of i) e.remove();
						}, 0);
	...
	*/
	...
	//#endregion
	//#region examples/react/005-draggable-containment/index.tsx
