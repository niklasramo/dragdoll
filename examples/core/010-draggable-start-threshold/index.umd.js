(function(factory) {
	...
	const a = e$1 ? new DOMMatrix() : null, o = e$1 ? new DOMMatrix() : null, s = {
		x: 0,
		y: 0,
		z: 0
	};
	function c(t, c = new DOMMatrix()) {
		...
		for (r(c); l;) {
			...
			if (t && (a.setMatrixValue(t), !a.isIdentity)) {
				...
				i(t, s);
				let { x: n, y: u, z: d } = s;
				d === 0 ? (a.translateSelf(-n, -u), r(o).translateSelf(n, u)) : (a.translateSelf(-n, -u, -d), r(o).translateSelf(n, u, d)), a.preMultiplySelf(o), c.preMultiplySelf(a);
			}
			l = l.parentElement;
		}
		return c;
		...
		_updateContainerMatrices() {
			[this.elementContainer, this.dragContainer].forEach((e) => {
				if (!this._matrixCache.isValid(e)) {
					...
					c(e, n), r(r$3).multiplySelf(n).invertSelf(), this._matrixCache.set(e, t);
				}
			});
		}
	...
	//#endregion
	//#region examples/core/010-draggable-start-threshold/index.ts
	const THRESHOLD = 5;
	let zIndex = 0;
