(function(factory) {
	...
	var t$4 = class {
		...
		_events;
		constructor(t = {}) {
			this.dedupe = t.dedupe || e$4.ADD, this.getId = t.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
		}
		_getListeners(e) {
		...
		on(t, n, r) {
			...
			if (r = r === void 0 ? this.getId(n) : r, o.has(r)) switch (this.dedupe) {
				case e$4.THROW: throw Error(`Eventti: duplicate listener id!`);
				case e$4.IGNORE: return r;
				case e$4.UPDATE:
					a.l = null;
					break;
		...
		constructor(e = {}) {
			...
			this._phases = t, this._emitter = new t$4({
				getId: s,
				dedupe: r
	...
	const e$2 = typeof window < `u` && window.document !== void 0, t$2 = e$2 && `ontouchstart` in window, n$4 = e$2 && !!window.PointerEvent;
	...
	function c$1(n) {
		return n === `auto` || n === void 0 ? n$4 ? `pointer` : t$2 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	var d = class {
		...
		_onMove(e) {
			...
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$1.Move, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r);
		}
		_onCancel(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$1.Cancel, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		_onEnd(e) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e$1.End, r.srcEvent = e, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		...
		cancel() {
			this.drag && (this._eventData.type = e$1.Cancel, this._eventData.srcEvent = null, this._eventData.target = null, this._eventData.x = this.drag.x, this._eventData.y = this.drag.y, this._eventData.deltaX = this.drag.deltaX, this._eventData.deltaY = this.drag.deltaY, this._emitter.emit(this._eventData.type, this._eventData), this._resetDrag());
		}
		updateElement(e) {
	...
	function r$2(r, i = !1) {
		let { translate: a, rotate: o, scale: s, transform: c } = t$3(r), l = ``;
		if (a && a !== `none`) {
			let [e = `0px`, i = `0px`, o] = a.split(` `);
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$3(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$1(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	const a = e$2 ? new DOMMatrix() : null, o = e$2 ? new DOMMatrix() : null, s = {
		x: 0,
		y: 0,
		z: 0
	};
	function c(t, c = new DOMMatrix()) {
		...
		for (r$1(c); l;) {
			let t = r$2(l);
			if (t && (a.setMatrixValue(t), !a.isIdentity)) {
				let { transformOrigin: t } = t$3(l);
				i(t, s);
				let { x: n, y: u, z: d } = s;
				d === 0 ? (a.translateSelf(-n, -u), r$1(o).translateSelf(n, u)) : (a.translateSelf(-n, -u, -d), r$1(o).translateSelf(n, u, d)), a.preMultiplySelf(o), c.preMultiplySelf(a);
			}
			l = l.parentElement;
		}
		return c;
	...
	function b(e, t = {
		...
		let { x: r, y: i } = e.getBoundingClientRect(), a = t$3(e);
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i$2 = t$3(e), a = e.getBoundingClientRect(), s = r$2(e, !0);
			this.data = {}, this.element = e, this.elementTransformOrigin = i(i$2.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s + i$2.transform), this.elementOffsetMatrix = new DOMMatrix(s).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
				x: 0,
				y: 0
	...
	var R = class {
		...
		constructor(e, t = {}) {
			let { id: n = Symbol(), ...r } = t;
			this.id = n, this._sensors = e, this.settings = this._parseSettings(r), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new t$4(), this._startPhase = j.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._modifierData = {
				draggable: this,
				drag: null,
				item: null,
				phase: N.Start
		...
		_bindSensor(e) {
			...
			e.on(e$1.Start, t, t), e.on(e$1.Move, t, t), e.on(e$1.Cancel, n, n), e.on(e$1.End, n, n);
		}
		_unbindSensor(e) {
			let t = this._sensorData.get(e);
			if (!t) return;
			let { onMove: n, onEnd: r } = t;
			e.off(e$1.Start, n), e.off(e$1.Move, n), e.off(e$1.Cancel, r), e.off(e$1.End, r), this._sensorData.delete(e);
		}
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$3.once(n$5.read, this._prepareMove, this._moveId), r$3.once(n$5.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$3.once(n$5.read, this._prepareStart, this._startId), r$3.once(n$5.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$3.off(n$5.read, this._startId), r$3.off(n$5.write, this._startId), r$3.off(n$5.read, this._moveId), r$3.off(n$5.write, this._moveId), r$3.off(n$5.read, this._alignId), r$3.off(n$5.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$3.once(n$5.read, this._prepareAlign, this._alignId), r$3.once(n$5.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	function n$2(e, n) {
		return function(r, { item: i }) {
			...
			let o = t(e, a.snapX, a.sensorX), s = t(n, a.snapY, a.sensorY);
	...
	var n$1 = class {
		...
		_emitter;
		constructor() {
			this.drag = null, this.isDestroyed = !1, this._emitter = new t$4();
		}
		_createDragData(e) {
			return {
				x: e.x,
		...
		_start(t) {
			...
			r.startX = n.startX, r.startY = n.startY, r.deltaX = n.deltaX, r.deltaY = n.deltaY, this.drag = n, this._emitter.emit(e$1.Start, r);
		}
		_move(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$1.Move, n);
		}
		_end(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$1.End, n), this._resetDragData();
		}
		_cancel(t) {
			if (!this.drag) return;
			this._updateDragData(t);
			let n = t;
			n.startX = this.drag.startX, n.startY = this.drag.startY, n.deltaX = this.drag.deltaX, n.deltaY = this.drag.deltaY, this._emitter.emit(e$1.Cancel, n), this._resetDragData();
		}
		on(e, t, n) {
			return this._emitter.on(e, t, n);
		}
	...
	var r = class extends n$1 {
		...
		constructor(e, t = {}) {
			super();
			let { moveDistance: r = n.moveDistance, cancelOnBlur: i = n.cancelOnBlur, cancelOnVisibilityChange: a = n.cancelOnVisibilityChange, startPredicate: o = n.startPredicate, movePredicate: s = n.movePredicate, cancelPredicate: c = n.cancelPredicate, endPredicate: l = n.endPredicate } = t;
		...
		_onKeyDown(t) {
			...
			if (r) {
				t.preventDefault(), n.type = e$1.Cancel, n.x = r.x, n.y = r.y, n.srcEvent = t, this._cancel(n);
				return;
			}
			let i = this._endPredicate(t, this);
			if (i) {
				t.preventDefault(), n.type = e$1.End, n.x = i.x, n.y = i.y, n.srcEvent = t, this._end(n);
				return;
			}
			let a = this._movePredicate(t, this);
			if (a) {
				t.preventDefault(), n.type = e$1.Move, n.x = a.x, n.y = a.y, n.srcEvent = t, this._move(n);
				return;
			}
		}
		updateElement(e) {
	...
	//#endregion
	//#region examples/core/004-draggable-snap-to-grid/index.ts
	const GRID_WIDTH = 40;
	const GRID_HEIGHT = 40;
	const element = document.querySelector(".draggable");
	new R([new d(element), new r(element, { moveDistance: {
		x: GRID_WIDTH,
		y: GRID_HEIGHT
	} })], {
		elements: () => [element],
		positionModifiers: [n$2(GRID_WIDTH, GRID_HEIGHT)],
		onStart: () => {
