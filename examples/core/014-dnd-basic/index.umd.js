(function(factory) {
	...
	var t$5 = class {
		...
		constructor(e = {}) {
			...
			this._phases = t, this._emitter = new t$5({
				getId: s,
				dedupe: r
	...
	var a$3 = class {
		...
		_checkCollision(r, i, a) {
			...
			if (!o) return null;
			let c = e$3(o, s, a.intersectionRect);
	...
	var d = class {
		...
		_onMove(e$10) {
			...
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e.Move, r.srcEvent = e$10, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r);
		}
		_onCancel(e$11) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e.Cancel, r.srcEvent = e$11, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
		_onEnd(e$12) {
			let t = this.drag, r = this._eventData;
			if (!t || !r) return;
			...
			if (!i) return;
			let a = i.clientX, o = i.clientY;
			t.deltaX = a - t.x, t.deltaY = o - t.y, t.x = a, t.y = o, r.type = e.End, r.srcEvent = e$12, r.target = i.target, r.x = a, r.y = o, r.deltaX = t.deltaX, r.deltaY = t.deltaY, this._emitter.emit(r.type, r), this._resetDrag();
		}
	...
	const a$1 = e$1 ? new DOMMatrix() : null, o = e$1 ? new DOMMatrix() : null, s$1 = {
		x: 0,
		y: 0,
		z: 0
	};
	function c$1(t, c = new DOMMatrix()) {
		...
		for (r$2(c); l;) {
			...
			if (t && (a$1.setMatrixValue(t), !a$1.isIdentity)) {
				...
				i$2(t, s$1);
				let { x: n, y: u, z: d } = s$1;
				d === 0 ? (a$1.translateSelf(-n, -u), r$2(o).translateSelf(n, u)) : (a$1.translateSelf(-n, -u, -d), r$2(o).translateSelf(n, u, d)), a$1.preMultiplySelf(o), c.preMultiplySelf(a$1);
			}
			l = l.parentElement;
		}
		return c;
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$3(e), a = e.getBoundingClientRect(), s = r$3(e, !0);
	...
	var R = class {
		...
		constructor(e, t = {}) {
			let { id: n = Symbol(), ...r } = t;
			this.id = n, this._sensors = e, this.settings = this._parseSettings(r), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new t$5(), this._startPhase = j.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._modifierData = {
				draggable: this,
				drag: null,
				item: null,
				phase: N.Start
		...
		_bindSensor(e$7) {
			this._sensorData.set(e$7, {
				...
				predicateEvent: null,
				onMove: (t) => this._onMove(t, e$7),
				onEnd: (t) => this._onEnd(t, e$7)
			});
			let { onMove: t, onEnd: n } = this._sensorData.get(e$7);
			e$7.on(e.Start, t, t), e$7.on(e.Move, t, t), e$7.on(e.Cancel, n, n), e$7.on(e.End, n, n);
		}
		_unbindSensor(e$8) {
			let t = this._sensorData.get(e$8);
			if (!t) return;
			let { onMove: n, onEnd: r } = t;
			e$8.off(e.Start, n), e$8.off(e.Move, n), e$8.off(e.Cancel, r), e$8.off(e.End, r), this._sensorData.delete(e$8);
		}
		...
		_onMove(n, r) {
			...
			if (i) switch (i.predicateState) {
				...
				case M.Resolved:
					this.drag && (Object.assign(this.drag.moveEvent, n), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$7.read, this._prepareMove, this._moveId), r$5.once(n$7.write, this._applyMove, this._moveId)));
					break;
			}
		}
		_onScroll() {
		...
		resolveStartPredicate(n, r) {
			...
			}), this.settings.sensorProcessingMode === P.Immediate ? (this._prepareStart(), this._applyStart()) : (r$5.once(n$7.read, this._prepareStart, this._startId), r$5.once(n$7.write, this._applyStart, this._startId)));
		}
		...
		stop() {
			...
			if (n.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = j.None, r$5.off(n$7.read, this._startId), r$5.off(n$7.write, this._startId), r$5.off(n$7.read, this._moveId), r$5.off(n$7.write, this._moveId), r$5.off(n$7.read, this._alignId), r$5.off(n$7.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, D), this._selectionChangeHandler &&= ((n.items[0]?.element?.ownerDocument ?? document).removeEventListener(`selectionchange`, this._selectionChangeHandler), null), this._pointerCaptureTarget && this._pointerCaptureId !== null) {
				try {
		...
		align(n = !1) {
			!this.drag || this.drag.isEnded || (n || this.settings.sensorProcessingMode === P.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$7.read, this._prepareAlign, this._alignId), r$5.once(n$7.write, this._applyAlign, this._alignId)));
		}
		getClientRect() {
	...
	var r$1 = class {
		...
		constructor(t, r = {}) {
			...
			this.id = i, this.element = t, this.isDestroyed = !1, this.accept = a, this.data = o, this.computeClientRect = s, this._clientRect = {
				...
				width: 0,
				height: 0
			}, this._emitter = new t$5(), this.updateClientRect();
		}
		on(e, t, n) {
			return this._emitter.on(e, t, n);
		}
		...
		destroy() {
			this.isDestroyed || (this.isDestroyed = !0, this._emitter.emit(t.Destroy), this._emitter.off());
		}
	};
	//#endregion
	...
	var u = class {
		...
		constructor(e = {}) {
			...
			this.draggables = /* @__PURE__ */ new Map(), this.droppables = /* @__PURE__ */ new Map(), this.isDestroyed = !1, this._drags = /* @__PURE__ */ new Map(), this._listenerId = Symbol(), this._emitter = new t$5(), this._onScroll = this._onScroll.bind(this), this.updateDroppableClientRects = this.updateDroppableClientRects.bind(this), this._collisionDetector = t ? t(this) : new a$3(this);
		}
		get drags() {
			return this._drags;
		}
		...
		_onDragPrepareStart(e) {
			...
			}), this._drags.size === 1 && this.updateDroppableClientRects(), this._computeCollisions(e), this._drags.size === 1 && window.addEventListener(`scroll`, this._onScroll, c)));
		}
		_onDragStart(e) {
			let t = this._drags.get(e);
			if (!(!t || t.isEnded)) {
		...
		_onScroll = () => {
			this._drags.size !== 0 && (r$5.once(n$7.read, this.updateDroppableClientRects, this._listenerId), this.detectCollisions());
		};
		_stopDrag(n, r = !1) {
			let i = this._drags.get(n);
			if (!i || i.isEnded) return;
			if (i._cd.phase === s.Emitting) throw Error(`Cannot stop dragging while collisions are being emitted.`);
			...
			this._drags.delete(n), this._collisionDetector._removeCollisionDataArena(n), r$5.off(n$7.read, i._cd.tickerId), r$5.off(n$7.write, i._cd.tickerId), this._drags.size || (r$5.off(n$7.read, this._listenerId), window.removeEventListener(`scroll`, this._onScroll, c));
		}
		_computeCollisions(e, t = !1) {
			...
			let r = n._cd;
			switch (r.phase) {
				case s.Computing: throw Error(`Collisions are being computed.`);
				case s.Emitting: throw Error(`Collisions are being emitted.`);
				default: break;
			}
			r.phase = s.Computing, r.targets = this._getTargets(e), this._collisionDetector.detectCollisions(e, r.targets, r.collisions), r.phase = s.Computed;
		}
		_emitCollisions(e, t = !1) {
			...
			c.clear(), u.clear(), d.clear(), r.phase = s.Idle;
		}
		on(e, t, n) {
			return this._emitter.on(e, t, n);
		}
		...
		detectCollisions(n) {
			if (!this.isDestroyed) if (n) {
				...
				r$5.once(n$7.read, r._cd._compute, r._cd.tickerId), r$5.once(n$7.write, r._cd._emit, r._cd.tickerId);
			} else for (let [, n] of this._drags) n.isEnded || (r$5.once(n$7.read, n._cd._compute, n._cd.tickerId), r$5.once(n$7.write, n._cd._emit, n._cd.tickerId));
		}
		addDraggables(e$6) {
			if (this.isDestroyed) return;
			let t = /* @__PURE__ */ new Set();
			for (let n of e$6) this.draggables.has(n.id) || (t.add(n), this.draggables.set(n.id, n), n.on(I.PrepareStart, () => {
				...
				this._onDragMove(n);
			}, this._listenerId), n.on(I.End, (e$5) => {
				e$5.endEvent?.type === e.End ? this._onDragEnd(n) : this._onDragCancel(n);
		...
		addDroppables(e) {
			...
			for (let n of e) this.droppables.has(n.id) || (t$6.add(n), this.droppables.set(n.id, n), n.on(t.Destroy, () => {
		...
		removeDroppables(e) {
			...
			for (let n of e) this.droppables.has(n.id) && (this.droppables.delete(n.id), t$7.add(n), n.off(t.Destroy, this._listenerId), this._drags.forEach(({ _targets: e }, t) => {
		...
		destroy() {
			if (this.isDestroyed) return;
			if (Array.from(this._drags.values()).some((e) => e._cd.phase === s.Emitting)) throw Error(`Cannot destroy the DndObserver while collisions are being emitted.`);
			this.isDestroyed = !0, this.draggables.forEach((e) => {
				...
				e.off(t.Destroy, this._listenerId);
			});
	...
	var n$1 = class {
		...
		_emitter;
		constructor() {
			this.drag = null, this.isDestroyed = !1, this._emitter = new t$5();
		}
		_createDragData(e) {
			return {
				x: e.x,
	...
	var i$1 = class extends n$1 {
		...
		_start(n) {
			this.isDestroyed || this.drag || (super._start(n), r$5.on(n$7.read, this._tick, this._tick));
		}
		_end(n) {
			this.drag && (r$5.off(n$7.read, this._tick), super._end(n));
		}
		_cancel(n) {
			this.drag && (r$5.off(n$7.read, this._tick), super._cancel(n));
		}
		_tick(e) {
	...
	draggableElements.forEach((element) => {
		const draggable = new R([new d(element), new a(element)], {
			elements: () => [element],
