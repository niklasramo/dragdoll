(function(factory) {
	...
	function r$4(r, i) {
		...
		if (t$3(r)) return a.x = 0, a.y = 0, a.width = r.innerWidth, a.height = r.innerHeight, a;
		let o = r.getBoundingClientRect(), s = t$4(r), c = parseFloat(s.borderLeftWidth) || 0, l = parseFloat(s.borderRightWidth) || 0, u = parseFloat(s.borderTopWidth) || 0, d = parseFloat(s.borderBottomWidth) || 0;
	...
	function u$1(e) {
		return t$3(e) || e === document.documentElement || e === document.body ? window : e;
	}
	function d$1(e) {
		return t$3(e) ? e.scrollX : e.scrollLeft;
	}
	function f$1(e) {
		return t$3(e) && (e = document.documentElement), e.scrollWidth - e.clientWidth;
	}
	function p$1(e) {
		return t$3(e) ? e.scrollY : e.scrollTop;
	}
	function m$1(e) {
		return t$3(e) && (e = document.documentElement), e.scrollHeight - e.clientHeight;
	}
	function h$1(e, t) {
	...
	function c$2(n) {
		return n === `auto` || n === void 0 ? n$3 ? `pointer` : t$2 ? `touch` : `mouse` : n;
	}
	const l = {
		pointer: {
			start: `pointerdown`,
	...
	function r$3(r, i = !1) {
		let { translate: a, rotate: o, scale: s, transform: c } = t$4(r), l = ``;
		if (a && a !== `none`) {
			let [e = `0px`, i = `0px`, o] = a.split(` `);
			e.includes(`%`) && (e = `${parseFloat(e) / 100 * n$2(r)}px`), i.includes(`%`) && (i = `${parseFloat(i) / 100 * t$1(r)}px`), o ? l += `translate3d(${e},${i},${o})` : l += `translate(${e},${i})`;
		}
		if (o && o !== `none`) {
			let e = o.split(` `);
	...
	function b(e, t = {
		...
		let { x: r, y: i } = e.getBoundingClientRect(), a = t$4(e);
	...
	var E = class {
		...
		constructor(e, t) {
			...
			let i = t$4(e), a = e.getBoundingClientRect(), s = r$3(e, !0);
	...
	//#endregion
	//#region examples/core/002-draggable-auto-scroll/index.ts
	const element = document.querySelector(".draggable");
	const dragContainer = document.querySelector(".drag-container");
	new R([new d(element), new a(element, { computeSpeed: () => 100 })], {
