...
const $46dbf0800ad71672$var$element = document.querySelector(".draggable");
const $46dbf0800ad71672$var$container = document.querySelector(".drag-container");
const $46dbf0800ad71672$var$pointerSensor = new (0, $792d52ca200635d4$export$b26af955418d6638)($46dbf0800ad71672$var$element);
const $46dbf0800ad71672$var$keyboardSensor = new (0, $9e75b1bcee5bf187$export$436f6efcc297171)();
const $46dbf0800ad71672$var$draggable = new (0, $792c55b8bb65db3f$export$f2a139e5d18b9882)([
    $46dbf0800ad71672$var$pointerSensor,
    $46dbf0800ad71672$var$keyboardSensor
], {
    container: $46dbf0800ad71672$var$container,
    getElements: ()=>[
            $46dbf0800ad71672$var$element
        ],
    getFrozenProps: ()=>[
            "left",
            "top"
...
}).use((0, $a19e81f4131cdd76$export$c0f5c18ade842ccd)({
    targets: [
        {
            element: window,
            axis: "y",
...
$46dbf0800ad71672$var$draggable.on("start", ()=>{
    $46dbf0800ad71672$var$element.classList.add("dragging");
});
$46dbf0800ad71672$var$draggable.on("end", ()=>{
    $46dbf0800ad71672$var$element.classList.remove("dragging");
});


//# sourceMappingURL=index.a918967e.js.map
