...
const $c891c342518a67f0$var$bestMatchMap = new Map();
// Get elements.
const $c891c342518a67f0$var$scrollContainers = [
    ...document.querySelectorAll('.scroll-list')
];
const $c891c342518a67f0$var$draggableElements = [
    ...document.querySelectorAll('.draggable')
];
const $c891c342518a67f0$var$droppableElements = [
    ...document.querySelectorAll('.droppable')
];
// Initialize DndContext.
const $c891c342518a67f0$var$dndContext = new (0, $fa11c4bc76a2544e$export$2d5c5ceac203fc1e)({
    collisionDetector: (ctx)=>new (0, $31f0e541fc872793$export$33a3c5dbfd7c6c65)(ctx)
});
// Create droppables.
const $c891c342518a67f0$var$droppables = [];
for (const droppableElement of $c891c342518a67f0$var$droppableElements){
    const droppable = new (0, $8cf3b9f73d8dfc46$export$423ec2075359570a)(droppableElement);
    $c891c342518a67f0$var$droppables.push(droppable);
}
// Create draggables.
const $c891c342518a67f0$var$draggables = [];
for (const draggableElement of $c891c342518a67f0$var$draggableElements){
    ...
    (0, $244877ffe9407e42$export$c0f5c18ade842ccd)({
        targets: $c891c342518a67f0$var$scrollContainers.map((scrollContainer)=>({
    ...
    $c891c342518a67f0$var$draggables.push(draggable);
}
// Add droppables and draggables to the context.
$c891c342518a67f0$var$dndContext.addDroppables($c891c342518a67f0$var$droppables);
$c891c342518a67f0$var$dndContext.addDraggables($c891c342518a67f0$var$draggables);
// On draggable collision with droppables.
$c891c342518a67f0$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Collide, ({ draggable: draggable, contacts: contacts })=>{
    ...
    const bestMatch = $c891c342518a67f0$var$bestMatchMap.get(draggable);
    if (nextBestMatch !== null && nextBestMatch !== bestMatch) {
        ...
        $c891c342518a67f0$var$bestMatchMap.set(draggable, nextBestMatch);
    }
});
// On drag end.
$c891c342518a67f0$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).End, ({ draggable: draggable, canceled: canceled })=>{
    const draggableElement = draggable.drag?.items[0].element;
    if (!draggableElement) return;
    ...
    bestMatch?.element.removeAttribute('data-draggable-over');
    $c891c342518a67f0$var$bestMatchMap.delete(draggable);
});
