...
const $8833b2928a680446$var$dndContext = new (0, $fa11c4bc76a2544e$export$2d5c5ceac203fc1e)({
    collisionDetector: (ctx)=>new (0, $5f07820b6d28407b$export$e7db3bbc7abd57f4)(ctx)
});
// Elements
...
$8833b2928a680446$var$droppableElements.forEach((element)=>{
    ...
    $8833b2928a680446$var$dndContext.addDroppable(droppable);
});
...
}// DnD logic (same pattern as example 011)
{
    ...
    const onEnterAndOver = (data)=>{
        ...
        for(let i = 1; i < collisionArray.length; i++){
            ...
            if (c.data.overIds.size === 0) c.element.classList.remove('draggable-over');
        }
    };
    const onLeave = (data)=>{
    ...
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Over, onEnterAndOver);
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Leave, onLeave);
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Drop, onDrop);
}
