...
let $8833b2928a680446$var$zIndex = 0;
// Initialize context with the visible-rect collision detector
const $8833b2928a680446$var$dndContext = new (0, $fa11c4bc76a2544e$export$2d5c5ceac203fc1e)({
    collisionDetector: (ctx)=>new (0, $31f0e541fc872793$export$33a3c5dbfd7c6c65)(ctx)
});
// Elements
const $8833b2928a680446$var$draggableElement = document.querySelector('.draggable');
const $8833b2928a680446$var$droppableElements = [
    ...document.querySelectorAll('.droppable')
];
// Create droppables inside the scroll container
$8833b2928a680446$var$droppableElements.forEach((element)=>{
    ...
    $8833b2928a680446$var$dndContext.addDroppables([
        droppable
    ]);
});
// Create a single draggable outside the scroll container
{
    const element = $8833b2928a680446$var$draggableElement;
    const draggable = new (0, $0d0c72b4b6dc9dbb$export$f2a139e5d18b9882)([
        ...
        onStart: ()=>{
            ...
            element.style.zIndex = `${++$8833b2928a680446$var$zIndex}`;
        },
        onEnd: ()=>{
            element.classList.remove('dragging');
        }
    });
    $8833b2928a680446$var$dndContext.addDraggable(draggable);
}// DnD logic (same pattern as example 011)
{
    ...
    const onEnterAndOver = (data)=>{
        ...
        const target = targetId ? $8833b2928a680446$var$dndContext.droppables.get(targetId) : null;
        if (target) {
        ...
        for (const droppable of $8833b2928a680446$var$dndContext.droppables.values())if (droppable !== target && !collisions.some((c)=>c.droppableId === droppable.id)) {
    ...
    const onLeave = (data)=>{
        const { draggable: draggable, removedContacts: removedContacts } = data;
    ...
    const onEnd = (data)=>{
        const { draggable: draggable, collisions: collisions } = data;
        const target = collisions.length > 0 ? $8833b2928a680446$var$dndContext.droppables.get(collisions[0].droppableId) : null;
        if (!target) return;
    ...
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Start, onStart);
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Enter, onEnterAndOver);
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Collide, onEnterAndOver);
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).Leave, onLeave);
    $8833b2928a680446$var$dndContext.on((0, $fa11c4bc76a2544e$export$360ab8c194eb7385).End, onEnd);
}
