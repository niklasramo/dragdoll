...
const $2ddef4f9151b1d9f$var$GRID_WIDTH = 40;
const $2ddef4f9151b1d9f$var$GRID_HEIGHT = 40;
const $2ddef4f9151b1d9f$var$element = document.querySelector(".draggable");
const $2ddef4f9151b1d9f$var$pointerSensor = new (0, $792d52ca200635d4$export$b26af955418d6638)($2ddef4f9151b1d9f$var$element);
const $2ddef4f9151b1d9f$var$keyboardSensor = new (0, $70401cb4f427e35f$export$44d67f2a438aeba9)({
    moveDistance: {
        x: $2ddef4f9151b1d9f$var$GRID_WIDTH,
        y: $2ddef4f9151b1d9f$var$GRID_HEIGHT
    }
});
const $2ddef4f9151b1d9f$var$draggable = new (0, $792c55b8bb65db3f$export$f2a139e5d18b9882)([
    $2ddef4f9151b1d9f$var$pointerSensor,
    $2ddef4f9151b1d9f$var$keyboardSensor
], {
    getElements: ()=>[
            $2ddef4f9151b1d9f$var$element
        ],
    startPredicate: (0, $bf69e6d48d01a2a7$export$88d83dc4a35d804f)(),
    getPositionChange: (0, $16f33ecaba6c77e5$export$7f11ea1f0ba255b5)($2ddef4f9151b1d9f$var$GRID_WIDTH, $2ddef4f9151b1d9f$var$GRID_HEIGHT)
});
$2ddef4f9151b1d9f$var$draggable.on("start", ()=>{
    $2ddef4f9151b1d9f$var$element.classList.add("dragging");
});
$2ddef4f9151b1d9f$var$draggable.on("end", ()=>{
    $2ddef4f9151b1d9f$var$element.classList.remove("dragging");
});


//# sourceMappingURL=index.ced39f4b.js.map
