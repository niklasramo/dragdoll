...
const $1721b684b57c24ff$var$draggableElements = document.querySelectorAll(".draggable");
[
    ...$1721b684b57c24ff$var$draggableElements
    ...
    draggable.on("start", ()=>{
        ...
        draggableElement.style.zIndex = `${++$1721b684b57c24ff$var$zIndex}`;
    });
    draggable.on("end", ()=>{
