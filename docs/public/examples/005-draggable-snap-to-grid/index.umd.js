...
var s$1 = class {
	...
	constructor(e$4, t$4) {
		this.sensor = e$4, this.startEvent = t$4, this.prevMoveEvent = t$4, this.moveEvent = t$4, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new s$1(), this._clientOffsetCache = new s$1();
	}
};
function l$1(e$4, t$4 = {
	x: 0,
	y: 0
}) {
	...
	let { x: n$5, y: r$2 } = e$4.getBoundingClientRect(), a$1 = t$3(e$4);
	return t$4.x = n$5 + (parseFloat(a$1.borderLeftWidth) || 0), t$4.y = r$2 + (parseFloat(a$1.borderTopWidth) || 0), t$4;
}
function u$1(e$4) {
...
function p(e$4, t$4, n$5 = {
	x: 0,
	y: 0
}) {
	let r$2 = u$1(e$4) ? e$4 : l$1(e$4, d), i$1 = u$1(t$4) ? t$4 : l$1(t$4, f);
	return n$5.x = i$1.x - r$2.x, n$5.y = i$1.y - r$2.y, n$5;
}
function m(e$4) {
	let t$4 = t$3(e$4), n$5 = parseFloat(t$4.height) || 0;
	return t$4.boxSizing === `border-box` ? n$5 : (n$5 += parseFloat(t$4.borderTopWidth) || 0, n$5 += parseFloat(t$4.borderBottomWidth) || 0, n$5 += parseFloat(t$4.paddingTop) || 0, n$5 += parseFloat(t$4.paddingBottom) || 0, e$4 instanceof HTMLElement && (n$5 += e$4.offsetHeight - e$4.clientHeight), n$5);
}
function h(e$4) {
	let t$4 = t$3(e$4), n$5 = parseFloat(t$4.width) || 0;
	return t$4.boxSizing === `border-box` ? n$5 : (n$5 += parseFloat(t$4.borderLeftWidth) || 0, n$5 += parseFloat(t$4.borderRightWidth) || 0, n$5 += parseFloat(t$4.paddingLeft) || 0, n$5 += parseFloat(t$4.paddingRight) || 0, e$4 instanceof HTMLElement && (n$5 += e$4.offsetWidth - e$4.clientWidth), n$5);
}
function g(e$4, t$4 = !1) {
	let { translate: n$5, rotate: r$2, scale: a$1, transform: o$2 } = t$3(e$4), s$2 = ``;
	if (n$5 && n$5 !== `none`) {
		let [t$5 = `0px`, r$3 = `0px`, i$1] = n$5.split(` `);
		t$5.includes(`%`) && (t$5 = `${parseFloat(t$5) / 100 * h(e$4)}px`), r$3.includes(`%`) && (r$3 = `${parseFloat(r$3) / 100 * m(e$4)}px`), i$1 ? s$2 += `translate3d(${t$5},${r$3},${i$1})` : s$2 += `translate(${t$5},${r$3})`;
	}
	if (r$2 && r$2 !== `none`) {
		let e$5 = r$2.split(` `);
...
function b(e$4, t$4 = new DOMMatrix()) {
	...
	for (v$1(t$4); n$5;) {
		...
		if (e$5 && (y.setMatrixValue(e$5), !y.isIdentity)) {
			let { transformOrigin: e$6 } = t$3(n$5), { x: r$2, y: a$1, z: o$2 } = _(e$6);
			o$2 === 0 ? y.setMatrixValue(`translate(${r$2}px,${a$1}px) ${y} translate(${r$2 * -1}px,${a$1 * -1}px)`) : y.setMatrixValue(`translate3d(${r$2}px,${a$1}px,${o$2}px) ${y} translate3d(${r$2 * -1}px,${a$1 * -1}px,${o$2 * -1}px)`), t$4.preMultiplySelf(y);
		}
...
var T = class {
	constructor(e$4, t$4) {
		...
		let r$2 = t$3(e$4), a$1 = e$4.getBoundingClientRect(), s$2 = g(e$4, !0);
		this.data = {}, this.element = e$4, this.elementTransformOrigin = _(r$2.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$2 + r$2.transform), this.elementOffsetMatrix = new DOMMatrix(s$2).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
		...
		if (this.frozenStyles) {
			let t$5 = {};
			for (let n$6 in this.frozenStyles) this.frozenStyles.hasOwnProperty(n$6) && (t$5[n$6] = e$4.style[n$6]);
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$4) => {
			if (!this._matrixCache.isValid(e$4)) {
				...
				b(e$4, n$5), r$2.setMatrixValue(n$5.toString()).invertSelf(), this._matrixCache.set(e$4, t$4);
			}
		});
	}
	_updateContainerOffset() {
		...
		if (e$4 !== n$5) {
			let [s$2, c$2] = [[r$2, n$5], [t$4, e$4]].map(([e$5, t$5]) => {
				let n$6 = a$1.get(t$5) || {
					x: 0,
					y: 0
				};
				if (!a$1.isValid(t$5)) {
					let r$3 = o$2.get(e$5);
					t$5 instanceof HTMLElement && r$3 && !r$3[0].isIdentity ? C(r$3[0]) ? (w.style.setProperty(`transform`, r$3[1].toString(), `important`), t$5.append(w), l$1(w, n$6), w.remove()) : (l$1(t$5, n$6), n$6.x -= r$3[0].m41, n$6.y -= r$3[0].m42) : l$1(t$5, n$6);
				}
...
const F = {
	...
	applyPosition: ({ item: e$4, phase: t$4 }) => {
		let n$5 = t$4 === I.End || t$4 === I.EndAlign, [r$2, i$1] = e$4.getContainerMatrix(), [a$1, o$2] = e$4.getDragContainerMatrix(), { position: s$2, alignmentOffset: c$2, containerOffset: l$3, elementTransformMatrix: u$3, elementTransformOrigin: d$1, elementOffsetMatrix: f$1 } = e$4, { x: p$1, y: m$1, z: h$1 } = d$1, g$1 = !u$3.isIdentity && (p$1 !== 0 || m$1 !== 0 || h$1 !== 0), _$2 = s$2.x + c$2.x + l$3.x, y$1 = s$2.y + c$2.y + l$3.y;
		v$1(j), g$1 && (h$1 === 0 ? j.translateSelf(-p$1, -m$1) : j.translateSelf(-p$1, -m$1, -h$1)), n$5 ? i$1.isIdentity || j.multiplySelf(i$1) : o$2.isIdentity || j.multiplySelf(o$2), v$1(M).translateSelf(_$2, y$1), j.multiplySelf(M), r$2.isIdentity || j.multiplySelf(r$2), g$1 && (v$1(M).translateSelf(p$1, m$1, h$1), j.multiplySelf(M)), u$3.isIdentity || j.multiplySelf(u$3), f$1.isIdentity || j.preMultiplySelf(f$1), e$4.element.style.transform = `${j}`;
	},
...
var z = class {
	constructor(t$4, n$5 = {}) {
		...
		this.id = r$2, this.sensors = t$4, this.settings = this._parseSettings(i$1), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this.sensors.forEach((t$5) => {
			...
			t$5.on(e$1.Start, n$6, n$6), t$5.on(e$1.Move, n$6, n$6), t$5.on(e$1.Cancel, r$3, r$3), t$5.on(e$1.End, r$3, r$3), t$5.on(e$1.Destroy, r$3, r$3);
		});
	}
	_parseSettings(e$4, t$4 = R) {
		let { container: n$5 = t$4.container, startPredicate: r$2 = t$4.startPredicate, elements: i$1 = t$4.elements, frozenStyles: a$1 = t$4.frozenStyles, positionModifiers: o$2 = t$4.positionModifiers, applyPosition: s$2 = t$4.applyPosition, computeClientRect: c$2 = t$4.computeClientRect, group: l$3 = t$4.group, onPrepareStart: u$3 = t$4.onPrepareStart, onStart: d$1 = t$4.onStart, onPrepareMove: f$1 = t$4.onPrepareMove, onMove: p$1 = t$4.onMove, onEnd: m$1 = t$4.onEnd, onDestroy: h$1 = t$4.onDestroy } = e$4 || {};
		return {
			container: n$5,
			startPredicate: r$2,
			elements: i$1,
	...
	_onMove(e$4, r$2) {
		...
		if (i$1) switch (i$1.predicateState) {
			case P.Pending: {
				...
				t$4 === !0 ? this.resolveStartPredicate(r$2) : t$4 === !1 && this.rejectStartPredicate(r$2);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = e$4, n$4.once(t$2.read, this._prepareMove, this._moveId), n$4.once(t$2.write, this._applyMove, this._moveId));
				break;
		}
	}
	_onScroll() {
	...
	_applyStart() {
		...
		if (e$4) {
			...
			for (let t$4 of e$4.items) t$4.dragContainer !== t$4.elementContainer && E(t$4.dragContainer, t$4.element), t$4.frozenStyles && Object.assign(t$4.element.style, t$4.frozenStyles), this.settings.applyPosition({
				phase: I.Start,
				draggable: this,
				drag: e$4,
				item: t$4
	...
	_prepareMove() {
		...
		t$4 !== n$5 && (this._applyModifiers(F.Move, t$4.x - n$5.x, t$4.y - n$5.y), this._emit(L.PrepareMove, t$4), !e$4.isEnded && (this.settings.onPrepareMove?.(e$4, this), !e$4.isEnded && (e$4.prevMoveEvent = t$4)));
	}
	_applyMove() {
		let e$4 = this.drag;
		if (e$4) {
	...
	resolveStartPredicate(e$4, r$2) {
		...
		i$1.predicateState === P.Pending && a$1 && (this._startPhase = N.Init, i$1.predicateState = P.Resolved, i$1.predicateEvent = null, this.drag = new c$1(e$4, a$1), this._sensorData.forEach((t$4, n$5) => {
			n$5 !== e$4 && (t$4.predicateState = P.Rejected, t$4.predicateEvent = null);
		}), n$4.once(t$2.read, this._prepareStart, this._startId), n$4.once(t$2.write, this._applyStart, this._startId));
	}
	...
	stop() {
		...
		if (this._startPhase = N.None, e$4.isEnded = !0, n$4.off(t$2.read, this._startId), n$4.off(t$2.write, this._startId), n$4.off(t$2.read, this._moveId), n$4.off(t$2.write, this._moveId), n$4.off(t$2.read, this._alignId), n$4.off(t$2.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), r$2 > N.Init && this._applyModifiers(F.End, 0, 0), r$2 === N.FinishApply) {
			for (let t$4 of e$4.items) {
				if (t$4.elementContainer !== t$4.dragContainer && (E(t$4.elementContainer, t$4.element), t$4.alignmentOffset.x = 0, t$4.alignmentOffset.y = 0, t$4.containerOffset.x = 0, t$4.containerOffset.y = 0), t$4.unfrozenStyles) for (let e$5 in t$4.unfrozenStyles) t$4.element.style[e$5] = t$4.unfrozenStyles[e$5] || ``;
			...
			for (let t$4 of e$4.items) if (t$4.elementContainer !== t$4.dragContainer) {
				let e$5 = t$4.element.getBoundingClientRect();
				t$4.alignmentOffset.x = D(t$4.clientRect.x - e$5.x, 3), t$4.alignmentOffset.y = D(t$4.clientRect.y - e$5.y, 3);
			}
			for (let t$4 of e$4.items) t$4.elementContainer !== t$4.dragContainer && (t$4.alignmentOffset.x !== 0 || t$4.alignmentOffset.y !== 0) && this.settings.applyPosition({
				phase: I.EndAlign,
				draggable: this,
				drag: e$4,
				item: t$4
			});
		} else if (r$2 === N.FinishPrepare) for (let t$4 of e$4.items) t$4.clientRect.x -= t$4.position.x, t$4.clientRect.y -= t$4.position.y, t$4.position.x = 0, t$4.position.y = 0, t$4.elementContainer !== t$4.dragContainer && (t$4.alignmentOffset.x = 0, t$4.alignmentOffset.y = 0, t$4.containerOffset.x = 0, t$4.containerOffset.y = 0);
		this._emit(L.End, e$4.endEvent), this.settings.onEnd?.(e$4, this), this.drag = null;
	}
	align(e$4 = !1) {
		this.drag && (e$4 ? (this._prepareAlign(), this._applyAlign()) : (n$4.once(t$2.read, this._prepareAlign, this._alignId), n$4.once(t$2.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensorData.forEach(({ onMove: t$4, onEnd: n$5 }, r$2) => {
			r$2.off(e$1.Start, t$4), r$2.off(e$1.Move, t$4), r$2.off(e$1.Cancel, n$5), r$2.off(e$1.End, n$5), r$2.off(e$1.Destroy, n$5);
...
var u = class {
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.cancel(), this._emitter.emit(e$1.Destroy, { type: e$1.Destroy }), this._emitter.off(), this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
};
...
var n$1 = class {
	...
	_start(t$4) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$4), this._emitter.emit(e$1.Start, t$4));
	}
	_move(t$4) {
		this.drag && (this._updateDragData(t$4), this._emitter.emit(e$1.Move, t$4));
	}
	_end(t$4) {
		this.drag && (this._updateDragData(t$4), this._emitter.emit(e$1.End, t$4), this._resetDragData());
	}
	_cancel(t$4) {
		this.drag && (this._updateDragData(t$4), this._emitter.emit(e$1.Cancel, t$4), this._resetDragData());
	}
	on(e$4, t$4, n$5) {
		return this._emitter.on(e$4, t$4, n$5);
	}
...
new z([new u(element), new r(element, { moveDistance: {
	x: GRID_WIDTH,
	y: GRID_HEIGHT
} })], {
	elements: () => [element],
