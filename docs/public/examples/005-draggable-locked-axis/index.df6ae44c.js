...
const $40934f5a2cb9b57f$var$draggableElements = document.querySelectorAll(".draggable");
[
    ...$40934f5a2cb9b57f$var$draggableElements
].forEach((draggableElement)=>{
    const pointerSensor = new (0, $e72ff61c97f755fe$export$b26af955418d6638)(draggableElement);
    const keyboardSensor = new (0, $7fff4587bd07df96$export$436f6efcc297171)(draggableElement);
    const draggable = new (0, $0d0c72b4b6dc9dbb$export$f2a139e5d18b9882)([
        ...
        getPositionChange: (...args)=>{
            const change = (0, $0d0c72b4b6dc9dbb$export$7ce0cd3869d5dcd9).getPositionChange(...args);
            const { element: element } = args[0].item;
    ...
    draggable.on("start", ()=>{
        ...
        draggableElement.style.zIndex = `${++$40934f5a2cb9b57f$var$zIndex}`;
    });
    draggable.on("end", ()=>{
