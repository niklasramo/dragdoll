...
var s$1 = class {
	...
	constructor(e$4, t$3) {
		this.sensor = e$4, this.startEvent = t$3, this.prevMoveEvent = t$3, this.moveEvent = t$3, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new s$1(), this._clientOffsetCache = new s$1();
	}
};
function l$1(e$4, t$3 = {
	x: 0,
	y: 0
}) {
...
function p(e$4, t$3, n$5 = {
	x: 0,
	y: 0
}) {
	let r$3 = u$1(e$4) ? e$4 : l$1(e$4, d), i$4 = u$1(t$3) ? t$3 : l$1(t$3, f);
...
function g(e$4, t$3 = !1) {
	...
	if (n$5 && n$5 !== `none`) {
		...
		t$4.includes(`%`) && (t$4 = `${parseFloat(t$4) / 100 * h(e$4)}px`), r$4.includes(`%`) && (r$4 = `${parseFloat(r$4) / 100 * m(e$4)}px`), i$4 ? s$2 += `translate3d(${t$4},${r$4},${i$4})` : s$2 += `translate(${t$4},${r$4})`;
	}
	if (r$3 && r$3 !== `none`) {
		let e$5 = r$3.split(` `);
...
function b(e$4, t$3 = new DOMMatrix()) {
	...
	for (v$1(t$3); n$5;) {
		...
		if (e$5 && (y.setMatrixValue(e$5), !y.isIdentity)) {
			let { transformOrigin: e$6 } = t$2(n$5), { x: r$3, y: a$3, z: o$3 } = _(e$6);
			o$3 === 0 ? y.setMatrixValue(`translate(${r$3}px,${a$3}px) ${y} translate(${r$3 * -1}px,${a$3 * -1}px)`) : y.setMatrixValue(`translate3d(${r$3}px,${a$3}px,${o$3}px) ${y} translate3d(${r$3 * -1}px,${a$3 * -1}px,${o$3 * -1}px)`), t$3.preMultiplySelf(y);
		}
...
var T = class {
	constructor(e$4, t$3) {
		...
		let r$3 = t$2(e$4), a$3 = e$4.getBoundingClientRect(), s$2 = g(e$4, !0);
		this.data = {}, this.element = e$4, this.elementTransformOrigin = _(r$3.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$2 + r$3.transform), this.elementOffsetMatrix = new DOMMatrix(s$2).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
		...
		if (this.frozenStyles) {
			let t$4 = {};
			for (let n$6 in this.frozenStyles) this.frozenStyles.hasOwnProperty(n$6) && (t$4[n$6] = e$4.style[n$6]);
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$4) => {
			if (!this._matrixCache.isValid(e$4)) {
				...
				b(e$4, n$5), r$3.setMatrixValue(n$5.toString()).invertSelf(), this._matrixCache.set(e$4, t$3);
			}
		});
	}
	_updateContainerOffset() {
		...
		if (e$4 !== n$5) {
			let [s$2, c$2] = [[r$3, n$5], [t$3, e$4]].map(([e$5, t$4]) => {
				let n$6 = a$3.get(t$4) || {
					x: 0,
					y: 0
				};
				if (!a$3.isValid(t$4)) {
					let r$4 = o$3.get(e$5);
					t$4 instanceof HTMLElement && r$4 && !r$4[0].isIdentity ? C(r$4[0]) ? (w.style.setProperty(`transform`, r$4[1].toString(), `important`), t$4.append(w), l$1(w, n$6), w.remove()) : (l$1(t$4, n$6), n$6.x -= r$4[0].m41, n$6.y -= r$4[0].m42) : l$1(t$4, n$6);
				}
...
const F = {
	...
	applyPosition: ({ item: e$4, phase: t$3 }) => {
		let n$5 = t$3 === I.End || t$3 === I.EndAlign, [r$3, i$4] = e$4.getContainerMatrix(), [a$3, o$3] = e$4.getDragContainerMatrix(), { position: s$2, alignmentOffset: c$2, containerOffset: l$3, elementTransformMatrix: u$3, elementTransformOrigin: d$1, elementOffsetMatrix: f$1 } = e$4, { x: p$1, y: m$1, z: h$1 } = d$1, g$1 = !u$3.isIdentity && (p$1 !== 0 || m$1 !== 0 || h$1 !== 0), _$2 = s$2.x + c$2.x + l$3.x, y$1 = s$2.y + c$2.y + l$3.y;
		v$1(j), g$1 && (h$1 === 0 ? j.translateSelf(-p$1, -m$1) : j.translateSelf(-p$1, -m$1, -h$1)), n$5 ? i$4.isIdentity || j.multiplySelf(i$4) : o$3.isIdentity || j.multiplySelf(o$3), v$1(M).translateSelf(_$2, y$1), j.multiplySelf(M), r$3.isIdentity || j.multiplySelf(r$3), g$1 && (v$1(M).translateSelf(p$1, m$1, h$1), j.multiplySelf(M)), u$3.isIdentity || j.multiplySelf(u$3), f$1.isIdentity || j.preMultiplySelf(f$1), e$4.element.style.transform = `${j}`;
	},
...
var z = class {
	constructor(t$3, n$5 = {}) {
		...
		this.id = r$3, this.sensors = t$3, this.settings = this._parseSettings(i$4), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this.sensors.forEach((t$4) => {
			...
			t$4.on(e$1.Start, n$6, n$6), t$4.on(e$1.Move, n$6, n$6), t$4.on(e$1.Cancel, r$4, r$4), t$4.on(e$1.End, r$4, r$4), t$4.on(e$1.Destroy, r$4, r$4);
		});
	}
	...
	_applyStart() {
		...
		if (e$4) {
			...
			for (let t$3 of e$4.items) t$3.dragContainer !== t$3.elementContainer && E(t$3.dragContainer, t$3.element), t$3.frozenStyles && Object.assign(t$3.element.style, t$3.frozenStyles), this.settings.applyPosition({
				phase: I.Start,
				draggable: this,
				drag: e$4,
				item: t$3
	...
	resolveStartPredicate(e$4, r$3) {
		...
		i$4.predicateState === P.Pending && a$3 && (this._startPhase = N.Init, i$4.predicateState = P.Resolved, i$4.predicateEvent = null, this.drag = new c$1(e$4, a$3), this._sensorData.forEach((t$3, n$5) => {
	...
	stop() {
		...
		if (this._startPhase = N.None, e$4.isEnded = !0, n$3.off(t.read, this._startId), n$3.off(t.write, this._startId), n$3.off(t.read, this._moveId), n$3.off(t.write, this._moveId), n$3.off(t.read, this._alignId), n$3.off(t.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), r$3 > N.Init && this._applyModifiers(F.End, 0, 0), r$3 === N.FinishApply) {
			for (let t$3 of e$4.items) {
				if (t$3.elementContainer !== t$3.dragContainer && (E(t$3.elementContainer, t$3.element), t$3.alignmentOffset.x = 0, t$3.alignmentOffset.y = 0, t$3.containerOffset.x = 0, t$3.containerOffset.y = 0), t$3.unfrozenStyles) for (let e$5 in t$3.unfrozenStyles) t$3.element.style[e$5] = t$3.unfrozenStyles[e$5] || ``;
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensorData.forEach(({ onMove: t$3, onEnd: n$5 }, r$3) => {
			r$3.off(e$1.Start, t$3), r$3.off(e$1.Move, t$3), r$3.off(e$1.Cancel, n$5), r$3.off(e$1.End, n$5), r$3.off(e$1.Destroy, n$5);
...
var n$2 = class {
	...
	_start(t$3) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$3), this._emitter.emit(e$1.Start, t$3));
	}
	_move(t$3) {
		this.drag && (this._updateDragData(t$3), this._emitter.emit(e$1.Move, t$3));
	}
	_end(t$3) {
		this.drag && (this._updateDragData(t$3), this._emitter.emit(e$1.End, t$3), this._resetDragData());
	}
	_cancel(t$3) {
		this.drag && (this._updateDragData(t$3), this._emitter.emit(e$1.Cancel, t$3), this._resetDragData());
	}
	on(e$4, t$3, n$5) {
		return this._emitter.on(e$4, t$3, n$5);
	}
...
var a = class extends i$1 {
	constructor(e$4, t$3 = {}) {
		super();
		let { startPredicate: n$5 = i$2.startPredicate, computeSpeed: r$3 = i$2.computeSpeed, cancelOnVisibilityChange: a$3 = i$2.cancelOnVisibilityChange, cancelOnBlur: o$3 = i$2.cancelOnBlur, startKeys: s$2 = i$2.startKeys, moveLeftKeys: c$2 = i$2.moveLeftKeys, moveRightKeys: l$3 = i$2.moveRightKeys, moveUpKeys: u$3 = i$2.moveUpKeys, moveDownKeys: d$1 = i$2.moveDownKeys, cancelKeys: f$1 = i$2.cancelKeys, endKeys: p$1 = i$2.endKeys } = t$3;
	...
	_updateDirection() {
		let e$4 = r$1(this._moveLeftKeys, this._moveKeyTimestamps), t$3 = r$1(this._moveRightKeys, this._moveKeyTimestamps), n$5 = r$1(this._moveUpKeys, this._moveKeyTimestamps), i$4 = r$1(this._moveDownKeys, this._moveKeyTimestamps), a$3 = e$4 === t$3 ? 0 : e$4 < t$3 ? -1 : 1, o$3 = n$5 === i$4 ? 0 : n$5 < i$4 ? -1 : 1;
		if (!(a$3 === 0 || o$3 === 0)) {
...
function o(o$3, s$2 = ({ drag: t$3 }) => t$3.sensor instanceof u) {
	return function(e$4, c$2) {
		let l$3 = e(o$3(c$2), n), u$3 = e(c$2.item.clientRect, r), d$1 = c$2.item.data, f$1 = d$1.__containment__ || {
			drift: {
				x: 0,
				y: 0
			},
		...
		return e$4.x &&= (a$1(u$3.left, u$3.right, l$3.left, l$3.right, p$1.x, e$4.x, m$1), p$1.x = i.drift, i.change), e$4.y &&= (a$1(u$3.top, u$3.bottom, l$3.top, l$3.bottom, p$1.y, e$4.y, m$1), p$1.y = i.drift, i.change), e$4;
	};
}
