...
function t$4(t$5) {
	...
	return n$7 || (n$7 = window.getComputedStyle(t$5, null), e$3.set(t$5, new WeakRef(n$7))), n$7;
}
...
var s$2 = class {
	...
	constructor(e$4, t$5) {
		this.sensor = e$4, this.startEvent = t$5, this.prevMoveEvent = t$5, this.moveEvent = t$5, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new s$2(), this._clientOffsetCache = new s$2();
	}
};
function l$2(e$4, t$5 = {
	x: 0,
	y: 0
}) {
	...
	let { x: n$7, y: r$3 } = e$4.getBoundingClientRect(), a$3 = t$4(e$4);
	return t$5.x = n$7 + (parseFloat(a$3.borderLeftWidth) || 0), t$5.y = r$3 + (parseFloat(a$3.borderTopWidth) || 0), t$5;
}
function u$2(e$4) {
...
function p(e$4, t$5, n$7 = {
	x: 0,
	y: 0
}) {
	let r$3 = u$2(e$4) ? e$4 : l$2(e$4, d), i$4 = u$2(t$5) ? t$5 : l$2(t$5, f);
	return n$7.x = i$4.x - r$3.x, n$7.y = i$4.y - r$3.y, n$7;
}
function m(e$4) {
	let t$5 = t$4(e$4), n$7 = parseFloat(t$5.height) || 0;
	return t$5.boxSizing === `border-box` ? n$7 : (n$7 += parseFloat(t$5.borderTopWidth) || 0, n$7 += parseFloat(t$5.borderBottomWidth) || 0, n$7 += parseFloat(t$5.paddingTop) || 0, n$7 += parseFloat(t$5.paddingBottom) || 0, e$4 instanceof HTMLElement && (n$7 += e$4.offsetHeight - e$4.clientHeight), n$7);
}
function h(e$4) {
	let t$5 = t$4(e$4), n$7 = parseFloat(t$5.width) || 0;
	return t$5.boxSizing === `border-box` ? n$7 : (n$7 += parseFloat(t$5.borderLeftWidth) || 0, n$7 += parseFloat(t$5.borderRightWidth) || 0, n$7 += parseFloat(t$5.paddingLeft) || 0, n$7 += parseFloat(t$5.paddingRight) || 0, e$4 instanceof HTMLElement && (n$7 += e$4.offsetWidth - e$4.clientWidth), n$7);
}
function g(e$4, t$5 = !1) {
	let { translate: n$7, rotate: r$3, scale: a$3, transform: o$2 } = t$4(e$4), s$3 = ``;
	if (n$7 && n$7 !== `none`) {
		let [t$6 = `0px`, r$4 = `0px`, i$4] = n$7.split(` `);
		t$6.includes(`%`) && (t$6 = `${parseFloat(t$6) / 100 * h(e$4)}px`), r$4.includes(`%`) && (r$4 = `${parseFloat(r$4) / 100 * m(e$4)}px`), i$4 ? s$3 += `translate3d(${t$6},${r$4},${i$4})` : s$3 += `translate(${t$6},${r$4})`;
	}
	if (r$3 && r$3 !== `none`) {
		let e$5 = r$3.split(` `);
...
function b(e$4, t$5 = new DOMMatrix()) {
	...
	for (v$1(t$5); n$7;) {
		...
		if (e$5 && (y.setMatrixValue(e$5), !y.isIdentity)) {
			let { transformOrigin: e$6 } = t$4(n$7), { x: r$3, y: a$3, z: o$2 } = _(e$6);
			o$2 === 0 ? y.setMatrixValue(`translate(${r$3}px,${a$3}px) ${y} translate(${r$3 * -1}px,${a$3 * -1}px)`) : y.setMatrixValue(`translate3d(${r$3}px,${a$3}px,${o$2}px) ${y} translate3d(${r$3 * -1}px,${a$3 * -1}px,${o$2 * -1}px)`), t$5.preMultiplySelf(y);
		}
...
function S() {
	...
	return e$4.classList.add(`dragdoll-measure`), x(e$4, {
		display: `block`,
		position: `absolute`,
		inset: `0px`,
		padding: `0px`,
...
var T = class {
	constructor(e$4, t$5) {
		...
		let r$3 = t$4(e$4), a$3 = e$4.getBoundingClientRect(), s$3 = g(e$4, !0);
		this.data = {}, this.element = e$4, this.elementTransformOrigin = _(r$3.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$3 + r$3.transform), this.elementOffsetMatrix = new DOMMatrix(s$3).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
		...
		if (this.frozenStyles) {
			let t$6 = {};
			for (let n$8 in this.frozenStyles) this.frozenStyles.hasOwnProperty(n$8) && (t$6[n$8] = e$4.style[n$8]);
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$4) => {
			if (!this._matrixCache.isValid(e$4)) {
				...
				b(e$4, n$7), r$3.setMatrixValue(n$7.toString()).invertSelf(), this._matrixCache.set(e$4, t$5);
			}
		});
	}
	_updateContainerOffset() {
		...
		if (e$4 !== n$7) {
			let [s$3, c$3] = [[r$3, n$7], [t$5, e$4]].map(([e$5, t$6]) => {
				let n$8 = a$3.get(t$6) || {
					x: 0,
					y: 0
				};
				if (!a$3.isValid(t$6)) {
					let r$4 = o$2.get(e$5);
					t$6 instanceof HTMLElement && r$4 && !r$4[0].isIdentity ? C(r$4[0]) ? (w.style.setProperty(`transform`, r$4[1].toString(), `important`), t$6.append(w), l$2(w, n$8), w.remove()) : (l$2(t$6, n$8), n$8.x -= r$4[0].m41, n$8.y -= r$4[0].m42) : l$2(t$6, n$8);
				}
...
const F = {
	...
	applyPosition: ({ item: e$4, phase: t$5 }) => {
		let n$7 = t$5 === I.End || t$5 === I.EndAlign, [r$3, i$4] = e$4.getContainerMatrix(), [a$3, o$2] = e$4.getDragContainerMatrix(), { position: s$3, alignmentOffset: c$3, containerOffset: l$4, elementTransformMatrix: u$4, elementTransformOrigin: d$1, elementOffsetMatrix: f$1 } = e$4, { x: p$1, y: m$1, z: h$1 } = d$1, g$1 = !u$4.isIdentity && (p$1 !== 0 || m$1 !== 0 || h$1 !== 0), _$2 = s$3.x + c$3.x + l$4.x, y$1 = s$3.y + c$3.y + l$4.y;
		v$1(j), g$1 && (h$1 === 0 ? j.translateSelf(-p$1, -m$1) : j.translateSelf(-p$1, -m$1, -h$1)), n$7 ? i$4.isIdentity || j.multiplySelf(i$4) : o$2.isIdentity || j.multiplySelf(o$2), v$1(M).translateSelf(_$2, y$1), j.multiplySelf(M), r$3.isIdentity || j.multiplySelf(r$3), g$1 && (v$1(M).translateSelf(p$1, m$1, h$1), j.multiplySelf(M)), u$4.isIdentity || j.multiplySelf(u$4), f$1.isIdentity || j.preMultiplySelf(f$1), e$4.element.style.transform = `${j}`;
	},
...
var z = class {
	constructor(t$5, n$7 = {}) {
		...
		this.id = r$3, this.sensors = t$5, this.settings = this._parseSettings(i$4), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this.sensors.forEach((t$6) => {
			...
			t$6.on(e.Start, n$8, n$8), t$6.on(e.Move, n$8, n$8), t$6.on(e.Cancel, r$4, r$4), t$6.on(e.End, r$4, r$4), t$6.on(e.Destroy, r$4, r$4);
		});
	}
	_parseSettings(e$4, t$5 = R) {
		let { container: n$7 = t$5.container, startPredicate: r$3 = t$5.startPredicate, elements: i$4 = t$5.elements, frozenStyles: a$3 = t$5.frozenStyles, positionModifiers: o$2 = t$5.positionModifiers, applyPosition: s$3 = t$5.applyPosition, computeClientRect: c$3 = t$5.computeClientRect, group: l$4 = t$5.group, onPrepareStart: u$4 = t$5.onPrepareStart, onStart: d$1 = t$5.onStart, onPrepareMove: f$1 = t$5.onPrepareMove, onMove: p$1 = t$5.onMove, onEnd: m$1 = t$5.onEnd, onDestroy: h$1 = t$5.onDestroy } = e$4 || {};
		return {
			container: n$7,
			startPredicate: r$3,
			elements: i$4,
	...
	_onMove(e$4, r$3) {
		...
		if (i$4) switch (i$4.predicateState) {
			case P.Pending: {
				...
				t$5 === !0 ? this.resolveStartPredicate(r$3) : t$5 === !1 && this.rejectStartPredicate(r$3);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = e$4, n$3.once(t.read, this._prepareMove, this._moveId), n$3.once(t.write, this._applyMove, this._moveId));
				break;
		}
	}
	_onScroll() {
	...
	_prepareStart() {
		...
		e$4 && (this._startPhase = N.Prepare, e$4.items = (this.settings.elements({
			draggable: this,
			drag: e$4
		}) || []).map((e$5) => new T(e$5, this)), this._applyModifiers(F.Start, 0, 0), this._emit(L.PrepareStart, e$4.startEvent), this.settings.onPrepareStart?.(e$4, this), this._startPhase = N.FinishPrepare);
	}
	_applyStart() {
		let e$4 = this.drag;
		if (e$4) {
			this._startPhase = N.Apply;
			for (let t$5 of e$4.items) t$5.dragContainer !== t$5.elementContainer && E(t$5.dragContainer, t$5.element), t$5.frozenStyles && Object.assign(t$5.element.style, t$5.frozenStyles), this.settings.applyPosition({
				phase: I.Start,
				draggable: this,
				drag: e$4,
				item: t$5
	...
	_prepareMove() {
		...
		t$5 !== n$7 && (this._applyModifiers(F.Move, t$5.x - n$7.x, t$5.y - n$7.y), this._emit(L.PrepareMove, t$5), !e$4.isEnded && (this.settings.onPrepareMove?.(e$4, this), !e$4.isEnded && (e$4.prevMoveEvent = t$5)));
	}
	_applyMove() {
		let e$4 = this.drag;
		if (e$4) {
	...
	resolveStartPredicate(e$4, r$3) {
		...
		i$4.predicateState === P.Pending && a$3 && (this._startPhase = N.Init, i$4.predicateState = P.Resolved, i$4.predicateEvent = null, this.drag = new c$2(e$4, a$3), this._sensorData.forEach((t$5, n$7) => {
			n$7 !== e$4 && (t$5.predicateState = P.Rejected, t$5.predicateEvent = null);
		}), n$3.once(t.read, this._prepareStart, this._startId), n$3.once(t.write, this._applyStart, this._startId));
	}
	...
	stop() {
		...
		if (this._startPhase = N.None, e$4.isEnded = !0, n$3.off(t.read, this._startId), n$3.off(t.write, this._startId), n$3.off(t.read, this._moveId), n$3.off(t.write, this._moveId), n$3.off(t.read, this._alignId), n$3.off(t.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), r$3 > N.Init && this._applyModifiers(F.End, 0, 0), r$3 === N.FinishApply) {
			for (let t$5 of e$4.items) {
				if (t$5.elementContainer !== t$5.dragContainer && (E(t$5.elementContainer, t$5.element), t$5.alignmentOffset.x = 0, t$5.alignmentOffset.y = 0, t$5.containerOffset.x = 0, t$5.containerOffset.y = 0), t$5.unfrozenStyles) for (let e$5 in t$5.unfrozenStyles) t$5.element.style[e$5] = t$5.unfrozenStyles[e$5] || ``;
			...
			for (let t$5 of e$4.items) if (t$5.elementContainer !== t$5.dragContainer) {
				let e$5 = t$5.element.getBoundingClientRect();
				t$5.alignmentOffset.x = D(t$5.clientRect.x - e$5.x, 3), t$5.alignmentOffset.y = D(t$5.clientRect.y - e$5.y, 3);
			}
			for (let t$5 of e$4.items) t$5.elementContainer !== t$5.dragContainer && (t$5.alignmentOffset.x !== 0 || t$5.alignmentOffset.y !== 0) && this.settings.applyPosition({
				phase: I.EndAlign,
				draggable: this,
				drag: e$4,
				item: t$5
			});
		} else if (r$3 === N.FinishPrepare) for (let t$5 of e$4.items) t$5.clientRect.x -= t$5.position.x, t$5.clientRect.y -= t$5.position.y, t$5.position.x = 0, t$5.position.y = 0, t$5.elementContainer !== t$5.dragContainer && (t$5.alignmentOffset.x = 0, t$5.alignmentOffset.y = 0, t$5.containerOffset.x = 0, t$5.containerOffset.y = 0);
		this._emit(L.End, e$4.endEvent), this.settings.onEnd?.(e$4, this), this.drag = null;
	}
	align(e$4 = !1) {
		this.drag && (e$4 ? (this._prepareAlign(), this._applyAlign()) : (n$3.once(t.read, this._prepareAlign, this._alignId), n$3.once(t.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensorData.forEach(({ onMove: t$5, onEnd: n$7 }, r$3) => {
			r$3.off(e.Start, t$5), r$3.off(e.Move, t$5), r$3.off(e.Cancel, n$7), r$3.off(e.End, n$7), r$3.off(e.Destroy, n$7);
...
var a$2 = class {
	...
	_checkCollision(n$7, i$4, a$3) {
		let o$2 = n$7.getClientRect(), s$3 = i$4.getClientRect();
		if (!o$2) return null;
		let c$3 = e$1(o$2, s$3, a$3.intersectionRect);
		if (c$3 === null) return null;
		let l$4 = n$5(o$2, s$3, c$3);
		return l$4 <= 0 ? null : (a$3.droppableId = i$4.id, r$1(s$3, a$3.droppableRect), r$1(o$2, a$3.draggableRect), a$3.intersectionScore = l$4, a$3);
	}
	...
	getCollisionDataPool(e$4) {
		...
		return t$5 || (t$5 = this._collisionDataPoolCache.pop() || new n$6((e$5) => e$5 || this._createCollisionData()), this._collisionDataPoolMap.set(e$4, t$5)), t$5;
	}
...
var u = class {
	constructor(e$4 = {}) {
		this._onScroll = () => {
			this._drags.size !== 0 && (n$3.once(t.read, () => {
				this.updateDroppableClientRects();
			}, this._listenerId), this.detectCollisions());
		};
		let { collisionDetector: r$3 } = e$4;
		this.draggables = /* @__PURE__ */ new Map(), this.droppables = /* @__PURE__ */ new Map(), this.isDestroyed = !1, this._drags = /* @__PURE__ */ new Map(), this._listenerId = Symbol(), this._emitter = new v(), this._onScroll = this._onScroll.bind(this), this._collisionDetector = r$3 ? r$3(this) : new a$2(this);
	}
	get drags() {
		return this._drags;
	}
	...
	_finalizeStopDrag(e$4) {
		...
		!r$3 || !r$3.isEnded || (this._drags.delete(e$4), this._collisionDetector.removeCollisionDataPool(e$4), n$3.off(t.read, r$3._cd.tickerId), n$3.off(t.write, r$3._cd.tickerId), this._drags.size || (n$3.off(t.read, this._listenerId), window.removeEventListener(`scroll`, this._onScroll, c$1)));
	}
	...
	detectCollisions(e$4) {
		if (!this.isDestroyed) if (e$4) {
			let r$3 = this._drags.get(e$4);
			if (!r$3 || r$3.isEnded) return;
			n$3.once(t.read, () => this._computeCollisions(e$4), r$3._cd.tickerId), n$3.once(t.write, () => this._emitCollisions(e$4), r$3._cd.tickerId);
		} else for (let [e$5, r$3] of this._drags) r$3.isEnded || (n$3.once(t.read, () => this._computeCollisions(e$5), r$3._cd.tickerId), n$3.once(t.write, () => this._emitCollisions(e$5), r$3._cd.tickerId));
	}
	addDraggables(t$5) {
		if (this.isDestroyed) return;
		let n$7 = /* @__PURE__ */ new Set();
		for (let i$4 of t$5) this.draggables.has(i$4.id) || (n$7.add(i$4), this.draggables.set(i$4.id, i$4), i$4.on(L.PrepareStart, () => {
			this._onDragPrepareStart(i$4);
		}, this._listenerId), i$4.on(L.Start, () => {
			this._onDragStart(i$4);
		}, this._listenerId), i$4.on(L.PrepareMove, () => {
			this._onDragPrepareMove(i$4);
		}, this._listenerId), i$4.on(L.Move, () => {
			this._onDragMove(i$4);
		}, this._listenerId), i$4.on(L.End, (t$6) => {
			t$6?.type === e.End ? this._onDragEnd(i$4) : t$6?.type === e.Cancel && this._onDragCancel(i$4);
		}, this._listenerId), i$4.on(L.Destroy, () => {
		...
		if (n$7.size) {
			...
			for (let e$4 of n$7) if (!this.isDestroyed && e$4.drag && !e$4.drag.isEnded) {
	...
	removeDraggables(e$4) {
		...
		for (let n$7 of e$4) this.draggables.has(n$7.id) && (t$5.add(n$7), this.draggables.delete(n$7.id), n$7.off(L.PrepareStart, this._listenerId), n$7.off(L.Start, this._listenerId), n$7.off(L.PrepareMove, this._listenerId), n$7.off(L.Move, this._listenerId), n$7.off(L.End, this._listenerId), n$7.off(L.Destroy, this._listenerId));
	...
	destroy() {
		...
		this.isDestroyed = !0, this.draggables.forEach((e$5) => {
			e$5.off(L.PrepareStart, this._listenerId), e$5.off(L.Start, this._listenerId), e$5.off(L.PrepareMove, this._listenerId), e$5.off(L.Move, this._listenerId), e$5.off(L.End, this._listenerId), e$5.off(L.Destroy, this._listenerId);
...
var i = class extends n$2 {
	...
	_tick(t$5) {
		if (this.drag) if (t$5 && this.drag.time) {
