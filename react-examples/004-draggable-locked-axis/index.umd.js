...
const t$7 = (0, import_react.createContext)(null);

//#endregion
//#region ../dragdoll-react/dist/use-dnd-observer-context-BL_LF-TG.js
function n$7() {
	return (0, import_react.useContext)(t$7);
}
...
function t$5(t$9) {
	let n$9 = e$4.get(t$9)?.deref();
	return n$9 || (n$9 = window.getComputedStyle(t$9, null), e$4.set(t$9, new WeakRef(n$9))), n$9;
}

//#endregion
//#region ../dragdoll/dist/constants-CMClRu_c.js
const e$3 = typeof window < `u` && window.document !== void 0, t = e$3 && `ontouchstart` in window, n$2 = e$3 && !!window.PointerEvent;
...
function g(e$7, t$9 = {
	...
	let { x: r$7, y: i$5 } = e$7.getBoundingClientRect(), a$3 = t$5(e$7);
	return t$9.x = r$7 + (parseFloat(a$3.borderLeftWidth) || 0), t$9.y = i$5 + (parseFloat(a$3.borderTopWidth) || 0), t$9;
}
function _(e$7) {
	let t$9 = t$5(e$7), r$7 = parseFloat(t$9.height) || 0;
...
function v$1(e$7) {
	let t$9 = t$5(e$7), r$7 = parseFloat(t$9.width) || 0;
...
function y(e$7, t$9 = !1) {
	let { translate: r$7, rotate: i$5, scale: a$3, transform: o$3 } = t$5(e$7), s$4 = ``;
	if (r$7 && r$7 !== `none`) {
...
function E(e$7, t$9 = new DOMMatrix()) {
	...
	for (u$1(t$9); r$7;) {
		...
		if (e$8 && (T.setMatrixValue(e$8), !T.isIdentity)) {
			let { transformOrigin: e$9 } = t$5(r$7), { x: i$5, y: a$3, z: o$3 } = w(e$9);
...
var O = class {
	...
	constructor(e$7, t$9) {
		...
		let i$5 = t$5(e$7), a$3 = e$7.getBoundingClientRect(), s$4 = y(e$7, !0);
...
var B = class {
	...
	_bindSensor(e$7) {
		...
		e$7.on(e.Start, t$9, t$9), e$7.on(e.Move, t$9, t$9), e$7.on(e.Cancel, n$9, n$9), e$7.on(e.End, n$9, n$9), e$7.on(e.Destroy, n$9, n$9);
	}
	_unbindSensor(e$7) {
		let t$9 = this._sensorData.get(e$7);
		if (!t$9) return;
		let { onMove: n$9, onEnd: r$7 } = t$9;
		e$7.off(e.Start, n$9), e$7.off(e.Move, n$9), e$7.off(e.Cancel, r$7), e$7.off(e.End, r$7), e$7.off(e.Destroy, r$7), this._sensorData.delete(e$7);
	}
	...
	_onMove(n$9, r$7) {
		...
		if (i$5) switch (i$5.predicateState) {
			...
			case P.Resolved:
				this.drag && (this.drag.moveEvent = n$9, this.settings.sensorProcessingMode === I.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$4.read, this._prepareMove, this._moveId), r$5.once(n$4.write, this._applyMove, this._moveId)));
				break;
		}
	}
	_onScroll() {
	...
	stop() {
		...
		if (!(!n$9 || n$9.isEnded)) {
			...
			n$9.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$5.off(n$4.read, this._startId), r$5.off(n$4.write, this._startId), r$5.off(n$4.read, this._moveId), r$5.off(n$4.write, this._moveId), r$5.off(n$4.read, this._alignId), r$5.off(n$4.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
	...
	align(n$9 = !1) {
		!this.drag || this.drag.isEnded || (n$9 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$4.read, this._prepareAlign, this._alignId), r$5.once(n$4.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
...
function n$1(n$9, r$7) {
	...
	return i$5.current ? t$3(r$7, a$3.deps) || (a$3.deps = r$7, a$3.value = n$9()) : i$5.current = a$3, a$3.value;
}
...
function c(c$3, l$3) {
	let u$3 = n$1(() => c$3.filter((e$7) => !!e$7), [...c$3]), { id: d$2, dndObserver: f$1,...p$1 } = l$3 || {}, m$1 = n$1(() => d$2 === void 0 ? Symbol() : d$2, [d$2]), h$1 = n$7(), g$1 = f$1 === void 0 ? h$1 : f$1, [_$2, v$2] = (0, import_react.useState)(null), y$1 = (0, import_react.useRef)(null), b$1 = (0, import_react.useRef)(u$3);
	b$1.current = u$3;
	...
	return n(() => {
		...
		if (!_$2) return;
		let e$7 = x$1.current;
		C$1.current !== e$7 && (n$8(C$1.current, e$7) || (_$2.updateSettings(_$2._parseSettings(e$7)), C$1.current && e$7.dndGroups !== C$1.current.dndGroups && S$1.current?.clearTargets(_$2)), C$1.current = e$7);
	}, [_$2, l$3]), n(() => w$1, [w$1]), _$2;
}

//#endregion
//#region ../dragdoll-react/dist/use-draggable-callback-Cd1g8lnj.js
function n$6(n$9, r$7, i$5) {
...
var n$5 = class {
	...
	_start(t$9) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$9), this._emitter.emit(e.Start, t$9));
	}
	_move(t$9) {
		this.drag && (this._updateDragData(t$9), this._emitter.emit(e.Move, t$9));
	}
	_end(t$9) {
		this.drag && (this._updateDragData(t$9), this._emitter.emit(e.End, t$9), this._resetDragData());
	}
	_cancel(t$9) {
		this.drag && (this._updateDragData(t$9), this._emitter.emit(e.Cancel, t$9), this._resetDragData());
	}
	on(e$7, t$9, n$9) {
		return this._emitter.on(e$7, t$9, n$9);
	}
...
var i$4 = class extends n$5 {
	...
	_start(n$9) {
		this.isDestroyed || this.drag || (super._start(n$9), r$5.on(n$4.read, this._tick, this._tick));
	}
	_end(n$9) {
		this.drag && (r$5.off(n$4.read, this._tick), super._end(n$9));
	}
	_cancel(n$9) {
		this.drag && (r$5.off(n$4.read, this._tick), super._cancel(n$9));
	}
	_tick(e$7) {
...
var a$1 = class extends i$4 {
	...
	constructor(e$7, t$9 = {}) {
		super();
		let { startPredicate: n$9 = i$3.startPredicate, computeSpeed: r$7 = i$3.computeSpeed, cancelOnVisibilityChange: a$3 = i$3.cancelOnVisibilityChange, cancelOnBlur: o$3 = i$3.cancelOnBlur, startKeys: s$4 = i$3.startKeys, moveLeftKeys: c$3 = i$3.moveLeftKeys, moveRightKeys: l$3 = i$3.moveRightKeys, moveUpKeys: u$3 = i$3.moveUpKeys, moveDownKeys: d$2 = i$3.moveDownKeys, cancelKeys: f$1 = i$3.cancelKeys, endKeys: p$1 = i$3.endKeys } = t$9;
...
function s(s$4, c$3) {
	...
	let p$1 = r$1((e$7) => {
		...
		let n$9 = new a$1(e$7, f$1.current);
	...
	return n(() => {
		...
		if (l$3) {
			let { startKeys: e$7 = i$3.startKeys, moveLeftKeys: t$9 = i$3.moveLeftKeys, moveRightKeys: n$9 = i$3.moveRightKeys, moveUpKeys: r$7 = i$3.moveUpKeys, moveDownKeys: i$5 = i$3.moveDownKeys, cancelKeys: a$3 = i$3.cancelKeys, endKeys: c$4 = i$3.endKeys, cancelOnBlur: u$4 = i$3.cancelOnBlur, cancelOnVisibilityChange: d$3 = i$3.cancelOnVisibilityChange, computeSpeed: f$2 = i$3.computeSpeed, startPredicate: p$2 = i$3.startPredicate } = s$4 || {};
			l$3.updateSettings({
				startKeys: e$7,
				moveLeftKeys: t$9,
				moveRightKeys: n$9,
...
function c$1(n$9) {
	return n$9 === `auto` || n$9 === void 0 ? n$2 ? `pointer` : t ? `touch` : `mouse` : n$9;
}
const l = {
	pointer: {
		start: `pointerdown`,
...
var d = class {
	...
	_getTrackedPointerEventData(e$7) {
		return this.drag ? i$1(e$7, this.drag.pointerId) : null;
	}
	_onStart(e$7) {
...
//#endregion
//#region react-examples/004-draggable-locked-axis/index.tsx
var import_client = /* @__PURE__ */ __toESM(require_client());
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
const DraggableCardMemo = (0, import_react.memo)(function DraggableCard({ axis, zIndexRef }) {
	...
	const svgPath = axis === "x" ? "M406.6 374.6l96-96c12.5-12.5 12.5-32.8 0-45.3l-96-96c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224l-293.5 0 41.4-41.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-96 96c-12.5 12.5-12.5 32.8 0 45.3l96 96c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 288l293.5 0-41.4 41.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z" : "M182.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-96 96c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L128 109.3l0 293.5L86.6 361.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l96 96c12.5 12.5 32.8 12.5 45.3 0l96-96c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 402.7l0-293.5 41.4 41.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-96-96z";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
			...
			viewBox: svgViewBox,
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: svgPath })
		})
	});
});
function App() {
	const zIndexRef = (0, import_react.useRef)(1);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraggableCardMemo, {
		axis: "x",
		zIndexRef
	}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraggableCardMemo, {
		axis: "y",
		zIndexRef
	})] });
}
