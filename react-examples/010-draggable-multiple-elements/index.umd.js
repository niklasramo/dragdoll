...
var __copyProps = (to, from, except, desc) => {
	if (from && typeof from === "object" || typeof from === "function") for (var keys = __getOwnPropNames(from), i$5 = 0, n$8 = keys.length, key; i$5 < n$8; i$5++) {
		key = keys[i$5];
...
var E$1 = {
	...
	constructor(t$7 = {}) {
		this.dedupe = t$7.dedupe || E$1.ADD, this.getId = t$7.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
	}
	_getListeners(t$7) {
		let n$8 = this._events.get(t$7);
		return n$8 ? n$8.l || (n$8.l = [...n$8.m.values()]) : null;
	}
	on(t$7, n$8, e$7) {
		let i$5 = this._events, s$4 = i$5.get(t$7);
		s$4 || (s$4 = {
			m: /* @__PURE__ */ new Map(),
			l: null
		}, i$5.set(t$7, s$4));
		let o$3 = s$4.m;
		if (e$7 = e$7 === r$5 ? this.getId(n$8) : e$7, o$3.has(e$7)) switch (this.dedupe) {
	...
	once(t$7, n$8, e$7) {
		let i$5 = 0;
		return e$7 = e$7 === r$5 ? this.getId(n$8) : e$7, this.on(t$7, (...s$4) => {
	...
	off(t$7, n$8) {
		...
		let e$7 = this._events.get(t$7);
		e$7?.m.delete(n$8) && (e$7.l = null, e$7.m.size || this._events.delete(t$7));
	}
	emit(t$7, ...n$8) {
...
var _$1 = E$1, o$2 = class {
	constructor(e$7 = {}) {
		...
		this._phases = t$7, this._emitter = new v({
			getId: s$4,
			dedupe: r$6
	...
	on(e$7, t$7, r$6) {
		return this._emitter.on(e$7, t$7, r$6);
	}
	once(e$7, t$7, r$6) {
		return this._emitter.once(e$7, t$7, r$6);
	}
	off(e$7, t$7) {
		return this._emitter.off(e$7, t$7);
	}
	count(e$7) {
	...
	_fillQueue() {
		let e$7 = this._queue, t$7 = this._phases, r$6 = this._getListeners, s$4 = 0, a$3 = t$7.length, n$8;
		for (; s$4 < a$3; s$4++) n$8 = r$6(t$7[s$4]), n$8 && e$7.push(n$8);
		return e$7;
	}
	_processQueue(...e$7) {
		let t$7 = this._queue, r$6 = t$7.length;
		if (!r$6) return;
		let s$4 = 0, a$3 = 0, n$8, c$3;
		for (; s$4 < r$6; s$4++) for (n$8 = t$7[s$4], a$3 = 0, c$3 = n$8.length; a$3 < c$3; a$3++) n$8[a$3](...e$7);
		t$7.length = 0;
	}
};
function u$2(i$5 = 60) {
	if (typeof requestAnimationFrame == "function" && typeof cancelAnimationFrame == "function") return (e$7) => {
		let t$7 = requestAnimationFrame(e$7);
		return () => cancelAnimationFrame(t$7);
	};
	{
		let e$7 = 1e3 / i$5, t$7 = typeof performance > "u" ? () => Date.now() : () => performance.now();
		return (r$6) => {
...
var l$2 = class extends o$2 {
	constructor(e$7 = {}) {
		...
		super(a$3), this._paused = t$7, this._onDemand = r$6, this._requestFrame = s$4, this._cancelFrame = null, this._empty = !0, !t$7 && !r$6 && this._request();
	}
	get phases() {
		return this._phases;
	}
...
function t$3(t$7) {
	let n$8 = e$4.get(t$7)?.deref();
	return n$8 || (n$8 = window.getComputedStyle(t$7, null), e$4.set(t$7, new WeakRef(n$8))), n$8;
}
...
function getStyle(e$7, t$7) {
	if (t$7) return window.getComputedStyle(e$7, t$7);
...
const IS_CHROMIUM = (() => {
	try {
		return window.navigator.userAgentData.brands.some((({ brand: n$8 }) => "Chromium" === n$8));
	} catch (n$8) {
		return !1;
	}
})();
...
function isContainingBlockForFixedElement(n$8) {
	const t$7 = getStyle(n$8);
	if (!IS_SAFARI) {
		const { filter: n$9 } = t$7;
		if (n$9 && "none" !== n$9) return !0;
		const { backdropFilter: e$8 } = t$7;
		if (e$8 && "none" !== e$8) return !0;
		const { willChange: i$6 } = t$7;
		if (i$6 && (i$6.indexOf("filter") > -1 || i$6.indexOf("backdrop-filter") > -1)) return !0;
	}
	const e$7 = isBlockElement(n$8);
	if (!e$7) return e$7;
...
function getContainingBlock(e$7, t$7 = {}) {
	...
	const n$8 = t$7.position || getStyle(e$7).position, { skipDisplayNone: i$5, container: o$3 } = t$7;
	switch (n$8) {
		case "static":
		case "relative":
		case "sticky":
		...
		case "fixed": {
			...
			for (; l$3;) {
				const e$8 = t$8 ? isContainingBlockForFixedElement(l$3) : isContainingBlockForAbsoluteElement(l$3);
				if (!0 === e$8) return l$3;
				if (null === e$8 && !i$5) return null;
...
function isWindow(n$8) {
	return n$8 instanceof Window;
}
...
function getOffsetContainer(n$8, t$7 = {}) {
	...
	const e$7 = t$7.position || getStyle(n$8).position, { skipDisplayNone: s$4, container: r$6 } = t$7;
	switch (e$7) {
		case "relative": return n$8;
		case "fixed": return getContainingBlock(n$8, {
			container: r$6,
			position: e$7,
			skipDisplayNone: s$4
		});
...
function s$3(e$7, t$7) {
	return e$7.isIdentity && t$7.isIdentity ? !0 : e$7.is2D && t$7.is2D ? e$7.a === t$7.a && e$7.b === t$7.b && e$7.c === t$7.c && e$7.d === t$7.d && e$7.e === t$7.e && e$7.f === t$7.f : e$7.m11 === t$7.m11 && e$7.m12 === t$7.m12 && e$7.m13 === t$7.m13 && e$7.m14 === t$7.m14 && e$7.m21 === t$7.m21 && e$7.m22 === t$7.m22 && e$7.m23 === t$7.m23 && e$7.m24 === t$7.m24 && e$7.m31 === t$7.m31 && e$7.m32 === t$7.m32 && e$7.m33 === t$7.m33 && e$7.m34 === t$7.m34 && e$7.m41 === t$7.m41 && e$7.m42 === t$7.m42 && e$7.m43 === t$7.m43 && e$7.m44 === t$7.m44;
}
function c$2(e$7) {
...
function l$1(e$7, t$7, n$8 = null) {
	if (`moveBefore` in e$7 && e$7.isConnected === t$7.isConnected) try {
		e$7.moveBefore(t$7, n$8);
		return;
	} catch {}
	let r$6 = document.activeElement, i$5 = t$7.contains(r$6);
	e$7.insertBefore(t$7, n$8), i$5 && document.activeElement !== r$6 && r$6 instanceof HTMLElement && r$6.focus({ preventScroll: !0 });
}
function u$1(e$7) {
...
var f = class {
	...
	set(e$7, t$7) {
		this._cache.set(e$7, t$7), this._validation.add(e$7);
	}
	get(e$7) {
	...
	_clientOffsetCache;
	constructor(e$7, t$7) {
		this.sensor = e$7, this.startEvent = t$7, this.prevMoveEvent = t$7, this.moveEvent = t$7, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f(), this._clientOffsetCache = new f();
	}
};
function m(e$7, t$7, n$8 = !1) {
	let { style: r$6 } = e$7;
	for (let e$8 in t$7) r$6.setProperty(e$8, t$7[e$8], n$8 ? `important` : ``);
}
function h() {
...
function g(e$7, t$7 = {
	...
	if (t$7.x = 0, t$7.y = 0, e$7 instanceof Window) return t$7;
	if (e$7 instanceof Document) return t$7.x = window.scrollX * -1, t$7.y = window.scrollY * -1, t$7;
	let { x: r$6, y: i$5 } = e$7.getBoundingClientRect(), a$3 = t$3(e$7);
	return t$7.x = r$6 + (parseFloat(a$3.borderLeftWidth) || 0), t$7.y = i$5 + (parseFloat(a$3.borderTopWidth) || 0), t$7;
}
function _(e$7) {
	let t$7 = t$3(e$7), r$6 = parseFloat(t$7.height) || 0;
	return t$7.boxSizing === `border-box` ? r$6 : (r$6 += parseFloat(t$7.borderTopWidth) || 0, r$6 += parseFloat(t$7.borderBottomWidth) || 0, r$6 += parseFloat(t$7.paddingTop) || 0, r$6 += parseFloat(t$7.paddingBottom) || 0, e$7 instanceof HTMLElement && (r$6 += e$7.offsetHeight - e$7.clientHeight), r$6);
}
function v$1(e$7) {
	let t$7 = t$3(e$7), r$6 = parseFloat(t$7.width) || 0;
	return t$7.boxSizing === `border-box` ? r$6 : (r$6 += parseFloat(t$7.borderLeftWidth) || 0, r$6 += parseFloat(t$7.borderRightWidth) || 0, r$6 += parseFloat(t$7.paddingLeft) || 0, r$6 += parseFloat(t$7.paddingRight) || 0, e$7 instanceof HTMLElement && (r$6 += e$7.offsetWidth - e$7.clientWidth), r$6);
}
function y(e$7, t$7 = !1) {
	let { translate: r$6, rotate: i$5, scale: a$3, transform: o$3 } = t$3(e$7), s$4 = ``;
	if (r$6 && r$6 !== `none`) {
		let [t$8 = `0px`, n$8 = `0px`, i$6] = r$6.split(` `);
		t$8.includes(`%`) && (t$8 = `${parseFloat(t$8) / 100 * v$1(e$7)}px`), n$8.includes(`%`) && (n$8 = `${parseFloat(n$8) / 100 * _(e$7)}px`), i$6 ? s$4 += `translate3d(${t$8},${n$8},${i$6})` : s$4 += `translate(${t$8},${n$8})`;
	}
	if (i$5 && i$5 !== `none`) {
		let e$8 = i$5.split(` `);
...
function C(e$7, t$7, n$8 = {
	x: 0,
	y: 0
}) {
	let r$6 = b(e$7) ? e$7 : g(e$7, x), i$5 = b(t$7) ? t$7 : g(t$7, S);
	return n$8.x = i$5.x - r$6.x, n$8.y = i$5.y - r$6.y, n$8;
}
function w(e$7) {
	let t$7 = e$7.split(` `), n$8 = ``, r$6 = ``, i$5 = ``;
	return t$7.length === 1 ? n$8 = r$6 = t$7[0] : t$7.length === 2 ? [n$8, r$6] = t$7 : [n$8, r$6, i$5] = t$7, {
		x: parseFloat(n$8) || 0,
		y: parseFloat(r$6) || 0,
		z: parseFloat(i$5) || 0
	};
...
function E(e$7, t$7 = new DOMMatrix()) {
	let r$6 = e$7;
	for (u$1(t$7); r$6;) {
		let e$8 = y(r$6);
		if (e$8 && (T.setMatrixValue(e$8), !T.isIdentity)) {
			let { transformOrigin: e$9 } = t$3(r$6), { x: i$5, y: a$3, z: o$3 } = w(e$9);
			o$3 === 0 ? T.setMatrixValue(`translate(${i$5}px,${a$3}px) ${T} translate(${i$5 * -1}px,${a$3 * -1}px)`) : T.setMatrixValue(`translate3d(${i$5}px,${a$3}px,${o$3}px) ${T} translate3d(${i$5 * -1}px,${a$3 * -1}px,${o$3 * -1}px)`), t$7.preMultiplySelf(T);
		}
...
var O = class {
	...
	constructor(e$7, t$7) {
		...
		let i$5 = t$3(e$7), a$3 = e$7.getBoundingClientRect(), s$4 = y(e$7, !0);
		this.data = {}, this.element = e$7, this.elementTransformOrigin = w(i$5.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$4 + i$5.transform), this.elementOffsetMatrix = new DOMMatrix(s$4).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			...
			x: 0,
			y: 0
		}, this._matrixCache = r$6._matrixCache, this._clientOffsetCache = r$6._clientOffsetCache;
		let c$3 = e$7.parentElement;
		if (!c$3) throw Error(`Dragged element does not have a parent element.`);
		this.elementContainer = c$3;
		let l$3 = t$7.settings.container, u$3 = (typeof l$3 == `function` ? l$3({
			draggable: t$7,
			drag: r$6,
			element: e$7
		}) : l$3) || c$3;
		...
		let f$1 = t$7.settings.frozenStyles({
			draggable: t$7,
			drag: r$6,
			item: this,
			style: i$5
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$7) => {
			if (!this._matrixCache.isValid(e$7)) {
				let t$7 = this._matrixCache.get(e$7) || [new DOMMatrix(), new DOMMatrix()], [n$8, r$6] = t$7;
				E(e$7, n$8), r$6.setMatrixValue(n$8.toString()).invertSelf(), this._matrixCache.set(e$7, t$7);
			}
		});
	}
	_updateContainerOffset() {
		let { elementOffsetContainer: e$7, elementContainer: t$7, dragOffsetContainer: n$8, dragContainer: r$6, containerOffset: i$5, _clientOffsetCache: a$3, _matrixCache: o$3 } = this;
		if (e$7 !== n$8) {
			let [s$4, l$3] = [[r$6, n$8], [t$7, e$7]].map(([e$8, t$8]) => {
				let n$9 = a$3.get(t$8) || {
					x: 0,
					y: 0
				};
				if (!a$3.isValid(t$8)) {
					let r$7 = o$3.get(e$8);
					t$8 instanceof HTMLElement && r$7 && !r$7[0].isIdentity ? c$2(r$7[0]) ? (D.style.setProperty(`transform`, r$7[1].toString(), `important`), t$8.append(D), g(D, n$9), D.remove()) : (g(t$8, n$9), n$9.x -= r$7[0].m41, n$9.y -= r$7[0].m42) : g(t$8, n$9);
				}
	...
	updateSize(e$7) {
		if (e$7) this.clientRect.width = e$7.width, this.clientRect.height = e$7.height;
			...
			let { width: e$8, height: t$7 } = this.element.getBoundingClientRect();
			this.clientRect.width = e$8, this.clientRect.height = t$7;
		}
	}
};
const k = {
...
const F = {
	...
	applyPosition: ({ item: e$7, phase: t$7 }) => {
		let n$8 = t$7 === L.End || t$7 === L.EndAlign, [r$6, i$5] = e$7.getContainerMatrix(), [a$3, o$3] = e$7.getDragContainerMatrix(), { position: s$4, alignmentOffset: c$3, containerOffset: l$3, elementTransformMatrix: d$2, elementTransformOrigin: f$1, elementOffsetMatrix: p$1 } = e$7, { x: m$1, y: h$1, z: g$1 } = f$1, _$2 = !d$2.isIdentity && (m$1 !== 0 || h$1 !== 0 || g$1 !== 0), v$2 = s$4.x + c$3.x + l$3.x, y$1 = s$4.y + c$3.y + l$3.y;
		u$1(j), _$2 && (g$1 === 0 ? j.translateSelf(-m$1, -h$1) : j.translateSelf(-m$1, -h$1, -g$1)), n$8 ? i$5.isIdentity || j.multiplySelf(i$5) : o$3.isIdentity || j.multiplySelf(o$3), u$1(M).translateSelf(v$2, y$1), j.multiplySelf(M), r$6.isIdentity || j.multiplySelf(r$6), _$2 && (u$1(M).translateSelf(m$1, h$1, g$1), j.multiplySelf(M)), d$2.isIdentity || j.multiplySelf(d$2), p$1.isIdentity || j.preMultiplySelf(p$1), e$7.element.style.transform = `${j}`;
	},
...
var B = class {
	...
	_alignId;
	constructor(e$7, t$7 = {}) {
		let { id: n$8 = Symbol(),...r$6 } = t$7;
		this.id = n$8, this._sensors = e$7, this.settings = this._parseSettings(r$6), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$8) => {
	...
	set sensors(e$7) {
		let t$7 = this._sensors;
		if (e$7 === t$7) return;
		let n$8 = t$7.filter((t$8) => !e$7.includes(t$8)), r$6 = e$7.filter((e$8) => !t$7.includes(e$8));
		this._sensors = e$7, n$8.forEach((e$8) => {
			this._unbindSensor(e$8);
		}), r$6.forEach((e$8) => {
			this._bindSensor(e$8);
		});
		let i$5 = this.drag?.sensor;
		i$5 && n$8.includes(i$5) && this.stop();
	}
	_bindSensor(e$7) {
	...
	_unbindSensor(e$7) {
		let t$7 = this._sensorData.get(e$7);
		if (!t$7) return;
		let { onMove: n$8, onEnd: r$6 } = t$7;
		e$7.off(e.Start, n$8), e$7.off(e.Move, n$8), e$7.off(e.Cancel, r$6), e$7.off(e.End, r$6), e$7.off(e.Destroy, r$6), this._sensorData.delete(e$7);
	}
	_parseSettings(e$7, t$7 = z) {
		let { container: n$8 = t$7.container, startPredicate: r$6 = t$7.startPredicate, elements: i$5 = t$7.elements, frozenStyles: a$3 = t$7.frozenStyles, positionModifiers: o$3 = t$7.positionModifiers, applyPosition: s$4 = t$7.applyPosition, computeClientRect: c$3 = t$7.computeClientRect, sensorProcessingMode: l$3 = t$7.sensorProcessingMode, dndGroups: u$3 = t$7.dndGroups, onPrepareStart: d$2 = t$7.onPrepareStart, onStart: f$1 = t$7.onStart, onPrepareMove: p$1 = t$7.onPrepareMove, onMove: m$1 = t$7.onMove, onEnd: h$1 = t$7.onEnd, onDestroy: g$1 = t$7.onDestroy } = e$7 || {};
		return {
			container: n$8,
			startPredicate: r$6,
			elements: i$5,
	...
	_emit(e$7, ...t$7) {
		this._emitter.emit(e$7, ...t$7);
	}
	_onMove(n$8, r$6) {
		let i$5 = this._sensorData.get(r$6);
		if (i$5) switch (i$5.predicateState) {
			case P.Pending: {
				i$5.predicateEvent = n$8;
				let e$7 = this.settings.startPredicate({
					draggable: this,
					sensor: r$6,
					event: n$8
				});
				e$7 === !0 ? this.resolveStartPredicate(r$6) : e$7 === !1 && this.rejectStartPredicate(r$6);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = n$8, this.settings.sensorProcessingMode === I.Immediate ? (this._prepareMove(), this._applyMove()) : (r$4.once(n$4.read, this._prepareMove, this._moveId), r$4.once(n$4.write, this._applyMove, this._moveId)));
				break;
		}
	}
	_onScroll() {
	...
	_onEnd(e$7, t$7) {
		let n$8 = this._sensorData.get(t$7);
		n$8 && (this.drag ? n$8.predicateState === P.Resolved && (this.drag.endEvent = e$7, this._sensorData.forEach((e$8) => {
			e$8.predicateState = P.Pending, e$8.predicateEvent = null;
		}), this.stop()) : (n$8.predicateState = P.Pending, n$8.predicateEvent = null));
	}
	_prepareStart() {
		let e$7 = this.drag;
	...
	_applyStart() {
		...
		if (!(!e$7 || this._startPhase !== N.FinishPrepare)) {
			...
			for (let t$7 of e$7.items) t$7.dragContainer !== t$7.elementContainer && l$1(t$7.dragContainer, t$7.element), t$7.frozenStyles && Object.assign(t$7.element.style, t$7.frozenStyles), this.settings.applyPosition({
				phase: L.Start,
				draggable: this,
				drag: e$7,
				item: t$7
			...
			for (let t$7 of e$7.items) {
				let e$8 = t$7.getContainerMatrix()[0], n$8 = t$7.getDragContainerMatrix()[0];
				if (s$3(e$8, n$8) || !c$2(e$8) && !c$2(n$8)) continue;
				let r$6 = t$7.element.getBoundingClientRect(), { alignmentOffset: i$5 } = t$7;
				i$5.x += d$1(t$7.clientRect.x - r$6.x, 3), i$5.y += d$1(t$7.clientRect.y - r$6.y, 3);
			}
			for (let t$7 of e$7.items) {
				let { alignmentOffset: n$8 } = t$7;
				(n$8.x !== 0 || n$8.y !== 0) && this.settings.applyPosition({
					phase: L.StartAlign,
					draggable: this,
					drag: e$7,
					item: t$7
	...
	_prepareMove() {
		...
		let { moveEvent: t$7, prevMoveEvent: n$8 } = e$7;
		t$7 !== n$8 && (this._applyModifiers(F.Move, t$7.x - n$8.x, t$7.y - n$8.y), this._emit(R.PrepareMove, e$7, this), !e$7.isEnded && (this.settings.onPrepareMove?.(e$7, this), !e$7.isEnded && (e$7.prevMoveEvent = t$7)));
	}
	_applyMove() {
		let e$7 = this.drag;
		if (!(!e$7 || e$7.isEnded)) {
			for (let t$7 of e$7.items) t$7._moveDiff.x = 0, t$7._moveDiff.y = 0, this.settings.applyPosition({
				phase: L.Move,
				draggable: this,
				drag: e$7,
				item: t$7
	...
	_prepareAlign() {
		let { drag: e$7 } = this;
		if (!(!e$7 || e$7.isEnded)) for (let t$7 of e$7.items) {
			let { x: e$8, y: n$8 } = t$7.element.getBoundingClientRect(), r$6 = t$7.clientRect.x - t$7._moveDiff.x - e$8;
			t$7.alignmentOffset.x = t$7.alignmentOffset.x - t$7._alignDiff.x + r$6, t$7._alignDiff.x = r$6;
			let i$5 = t$7.clientRect.y - t$7._moveDiff.y - n$8;
			t$7.alignmentOffset.y = t$7.alignmentOffset.y - t$7._alignDiff.y + i$5, t$7._alignDiff.y = i$5;
		}
	}
	_applyAlign() {
		let { drag: e$7 } = this;
		if (!(!e$7 || e$7.isEnded)) for (let t$7 of e$7.items) t$7._alignDiff.x = 0, t$7._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$7,
			item: t$7
	...
	_applyModifiers(e$7, t$7, n$8) {
		...
		for (let a$3 of r$6.items) {
			let o$3 = A;
			o$3.x = t$7, o$3.y = n$8;
			for (let t$8 of i$5) o$3 = t$8(o$3, {
				draggable: this,
				drag: r$6,
				item: a$3,
				phase: e$7
	...
	on(e$7, t$7, n$8) {
		return this._emitter.on(e$7, t$7, n$8);
	}
	off(e$7, t$7) {
		this._emitter.off(e$7, t$7);
	}
	resolveStartPredicate(n$8, r$6) {
		let i$5 = this._sensorData.get(n$8);
		if (!i$5) return;
		let a$3 = r$6 || i$5.predicateEvent;
		i$5.predicateState === P.Pending && a$3 && (this._startPhase = N.Init, i$5.predicateState = P.Resolved, i$5.predicateEvent = null, this.drag = new p(n$8, a$3), this._sensorData.forEach((e$7, t$7) => {
			t$7 !== n$8 && (e$7.predicateState = P.Rejected, e$7.predicateEvent = null);
		}), this.settings.sensorProcessingMode === I.Immediate ? (this._prepareStart(), this._applyStart()) : (r$4.once(n$4.read, this._prepareStart, this._startId), r$4.once(n$4.write, this._applyStart, this._startId)));
	}
	...
	stop() {
		...
		if (!(!n$8 || n$8.isEnded)) {
			...
			n$8.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$4.off(n$4.read, this._startId), r$4.off(n$4.write, this._startId), r$4.off(n$4.read, this._moveId), r$4.off(n$4.write, this._moveId), r$4.off(n$4.read, this._alignId), r$4.off(n$4.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
			for (let e$7 of n$8.items) {
				if (e$7.elementContainer !== e$7.dragContainer && (l$1(e$7.elementContainer, e$7.element), e$7.alignmentOffset.x = 0, e$7.alignmentOffset.y = 0, e$7.containerOffset.x = 0, e$7.containerOffset.y = 0), e$7.unfrozenStyles) for (let t$7 in e$7.unfrozenStyles) e$7.element.style[t$7] = e$7.unfrozenStyles[t$7] || ``;
			...
			for (let e$7 of n$8.items) if (e$7.elementContainer !== e$7.dragContainer) {
				let t$7 = e$7.element.getBoundingClientRect();
				e$7.alignmentOffset.x = d$1(e$7.clientRect.x - t$7.x, 3), e$7.alignmentOffset.y = d$1(e$7.clientRect.y - t$7.y, 3);
			}
			for (let e$7 of n$8.items) e$7.elementContainer !== e$7.dragContainer && (e$7.alignmentOffset.x !== 0 || e$7.alignmentOffset.y !== 0) && this.settings.applyPosition({
				phase: L.EndAlign,
				draggable: this,
				drag: n$8,
				item: e$7
			});
			this._emit(R.End, n$8, this), this.settings.onEnd?.(n$8, this), this.drag = null;
		}
	}
	align(n$8 = !1) {
		!this.drag || this.drag.isEnded || (n$8 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$4.once(n$4.read, this._prepareAlign, this._alignId), r$4.once(n$4.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
		let { drag: e$7, settings: t$7 } = this;
		return e$7 && t$7.computeClientRect?.({
			draggable: this,
			drag: e$7
		}) || null;
	}
...
const e$2 = Object.prototype.hasOwnProperty, t$2 = (e$7) => {
	if (typeof e$7 != `object` || !e$7) return !1;
	let t$7 = Object.getPrototypeOf(e$7);
	return t$7 === Object.prototype || t$7 === null;
};
function n$7(r$6, i$5) {
	if (Object.is(r$6, i$5)) return !0;
	if (r$6 === null || i$5 === null || typeof r$6 != `object` || typeof i$5 != `object`) return !1;
	let a$3 = Array.isArray(r$6), o$3 = Array.isArray(i$5);
	if (a$3 || o$3) {
		if (!a$3 || !o$3) return !1;
		let e$7 = r$6.length;
	...
	let s$4 = r$6 instanceof Set, c$3 = i$5 instanceof Set;
	if (s$4 || c$3) return !s$4 || !c$3 || r$6.size !== i$5.size ? !1 : r$6.isSubsetOf(i$5);
	if (!t$2(r$6) || !t$2(i$5)) return !1;
	let l$3 = Object.keys(r$6), u$3 = Object.keys(i$5);
	if (l$3.length !== u$3.length) return !1;
	for (let t$7 = 0; t$7 < l$3.length; t$7++) {
		let a$4 = l$3[t$7];
		if (!e$2.call(i$5, a$4) || !n$7(r$6[a$4], i$5[a$4])) return !1;
	}
	return !0;
}
...
function t$1(e$7, t$7) {
	if (e$7 === t$7) return !0;
	if (e$7.length !== t$7.length) return !1;
	for (let n$8 = 0; n$8 < e$7.length; n$8++) if (!Object.is(e$7[n$8], t$7[n$8])) return !1;
	return !0;
}
function n$1(n$8, r$6) {
	let i$5 = (0, import_react.useRef)(null), a$3 = i$5.current || {
		deps: r$6,
		value: n$8()
	};
	return i$5.current ? t$1(r$6, a$3.deps) || (a$3.deps = r$6, a$3.value = n$8()) : i$5.current = a$3, a$3.value;
}
function r(e$7, t$7) {
	return n$1(() => e$7, t$7);
}
...
function c(c$3, l$3) {
	let u$3 = n$1(() => c$3.filter((e$7) => !!e$7), [...c$3]), { id: d$2, dndObserver: f$1,...p$1 } = l$3 || {}, m$1 = n$1(() => d$2 === void 0 ? Symbol() : d$2, [d$2]), h$1 = n$6(), g$1 = f$1 === void 0 ? h$1 : f$1, [_$2, v$2] = (0, import_react.useState)(null), y$1 = (0, import_react.useRef)(null), b$1 = (0, import_react.useRef)(u$3);
	b$1.current = u$3;
	let x$1 = (0, import_react.useRef)(p$1);
	x$1.current = p$1;
	let S$1 = (0, import_react.useRef)(g$1);
	S$1.current = g$1;
	let C$1 = (0, import_react.useRef)(void 0), w$1 = r(() => {
		let e$7 = y$1.current;
		e$7 && (e$7.destroy(), y$1.current = null, C$1.current = void 0, v$2(null));
	}, []), T$1 = r((e$7) => {
		w$1();
		let t$7 = new B(b$1.current, {
			id: e$7,
			...x$1.current
		});
		y$1.current = t$7, C$1.current = x$1.current, v$2(t$7);
	}, [w$1]);
	return n(() => {
		...
		if (!_$2) return;
		let e$7 = x$1.current;
		C$1.current !== e$7 && (n$7(C$1.current, e$7) || (_$2.updateSettings(_$2._parseSettings(e$7)), C$1.current && e$7.dndGroups !== C$1.current.dndGroups && S$1.current?.clearTargets(_$2)), C$1.current = e$7);
...
var n$5 = class {
	...
	_start(t$7) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$7), this._emitter.emit(e.Start, t$7));
	}
	_move(t$7) {
		this.drag && (this._updateDragData(t$7), this._emitter.emit(e.Move, t$7));
	}
	_end(t$7) {
		this.drag && (this._updateDragData(t$7), this._emitter.emit(e.End, t$7), this._resetDragData());
	}
	_cancel(t$7) {
		this.drag && (this._updateDragData(t$7), this._emitter.emit(e.Cancel, t$7), this._resetDragData());
	}
	on(e$7, t$7, n$8) {
		return this._emitter.on(e$7, t$7, n$8);
	}
...
var i$4 = class extends n$5 {
	...
	_start(n$8) {
		this.isDestroyed || this.drag || (super._start(n$8), r$4.on(n$4.read, this._tick, this._tick));
	}
	_end(n$8) {
		this.drag && (r$4.off(n$4.read, this._tick), super._end(n$8));
	}
	_cancel(n$8) {
		this.drag && (r$4.off(n$4.read, this._tick), super._cancel(n$8));
	}
	_tick(e$7) {
		if (this.drag) if (e$7 && this.drag.time) {
			...
			if (this._emitter.emit(`tick`, t$7), !this.drag) return;
			let r$6 = this._speed * (this.drag.deltaTime / 1e3), i$5 = this._direction.x * r$6, a$3 = this._direction.y * r$6;
			(i$5 || a$3) && this._move({
				type: e.Move,
				x: this.drag.x + i$5,
				y: this.drag.y + a$3
...
const i$3 = {
	...
	computeSpeed: () => 500,
	startPredicate: (e$7, t$7) => {
		if (t$7.element && document.activeElement === t$7.element) {
			let { left: e$8, top: n$8 } = t$7.element.getBoundingClientRect();
			return {
				x: e$8,
				y: n$8
			};
...
var a$1 = class extends i$4 {
	...
	constructor(e$7, t$7 = {}) {
		super();
		let { startPredicate: n$8 = i$3.startPredicate, computeSpeed: r$6 = i$3.computeSpeed, cancelOnVisibilityChange: a$3 = i$3.cancelOnVisibilityChange, cancelOnBlur: o$3 = i$3.cancelOnBlur, startKeys: s$4 = i$3.startKeys, moveLeftKeys: c$3 = i$3.moveLeftKeys, moveRightKeys: l$3 = i$3.moveRightKeys, moveUpKeys: u$3 = i$3.moveUpKeys, moveDownKeys: d$2 = i$3.moveDownKeys, cancelKeys: f$1 = i$3.cancelKeys, endKeys: p$1 = i$3.endKeys } = t$7;
	...
	_updateDirection() {
		let e$7 = r$3(this._moveLeftKeys, this._moveKeyTimestamps), t$7 = r$3(this._moveRightKeys, this._moveKeyTimestamps), n$8 = r$3(this._moveUpKeys, this._moveKeyTimestamps), i$5 = r$3(this._moveDownKeys, this._moveKeyTimestamps), a$3 = e$7 === t$7 ? 0 : e$7 < t$7 ? -1 : 1, o$3 = n$8 === i$5 ? 0 : n$8 < i$5 ? -1 : 1;
		if (!(a$3 === 0 || o$3 === 0)) {
	...
	_onKeyDown(t$7) {
		if (!this.drag) {
			if (this._startKeys.has(t$7.key)) {
				let n$8 = this._startPredicate(t$7, this);
				n$8 && (t$7.preventDefault(), this._start({
					type: e.Start,
					x: n$8.x,
					y: n$8.y
				}));
	...
	updateSettings(e$7) {
		...
		let t$7 = !1, { cancelOnBlur: r$6, cancelOnVisibilityChange: i$5, startPredicate: a$3, computeSpeed: o$3 } = e$7;
		if (r$6 !== void 0 && this._cancelOnBlur !== r$6 && (this._cancelOnBlur = r$6, r$6 ? this.element?.addEventListener(`blur`, this._blurCancelHandler) : this.element?.removeEventListener(`blur`, this._blurCancelHandler)), i$5 !== void 0 && this._cancelOnVisibilityChange !== i$5 && (this._cancelOnVisibilityChange = i$5, i$5 ? document.addEventListener(`visibilitychange`, this._internalCancel) : document.removeEventListener(`visibilitychange`, this._internalCancel)), a$3 !== void 0 && (this._startPredicate = a$3), o$3 !== void 0 && (this._computeSpeed = o$3), n$3.forEach((n$8, r$7) => {
			let i$6 = `${n$8}Keys`, a$4 = e$7[i$6];
			a$4 !== void 0 && (this[`_${i$6}`] = new Set(a$4), r$7 >= 3 && (t$7 = !0));
		}), t$7) {
			let e$8 = [
				...this._moveLeftKeys,
				...this._moveRightKeys,
			...
			[...this._moveKeys].every((t$8, n$8) => e$8[n$8] === t$8) || (this._moveKeys = new Set(e$8), this._moveKeyTimestamps.clear(), this._updateDirection());
		}
	}
	destroy() {
...
function s(s$4, c$3) {
	...
	return n(() => {
		...
		if (l$3) {
			let { startKeys: e$7 = i$3.startKeys, moveLeftKeys: t$7 = i$3.moveLeftKeys, moveRightKeys: n$8 = i$3.moveRightKeys, moveUpKeys: r$6 = i$3.moveUpKeys, moveDownKeys: i$5 = i$3.moveDownKeys, cancelKeys: a$3 = i$3.cancelKeys, endKeys: c$4 = i$3.endKeys, cancelOnBlur: u$4 = i$3.cancelOnBlur, cancelOnVisibilityChange: d$3 = i$3.cancelOnVisibilityChange, computeSpeed: f$2 = i$3.computeSpeed, startPredicate: p$2 = i$3.startPredicate } = s$4 || {};
			l$3.updateSettings({
				startKeys: e$7,
				moveLeftKeys: t$7,
				moveRightKeys: n$8,
...
function i$1(e$7, t$7) {
	...
	if (`changedTouches` in e$7) {
		let n$8 = 0;
		for (; n$8 < e$7.changedTouches.length; n$8++) if (e$7.changedTouches[n$8].identifier === t$7) return e$7.changedTouches[n$8];
		return null;
	}
	return e$7;
}
...
var d = class {
	...
	_emitter;
	constructor(e$7, t$7 = {}) {
		let { listenerOptions: n$8 = u.listenerOptions, sourceEvents: i$5 = u.sourceEvents, startPredicate: a$3 = u.startPredicate } = t$7;
		this.element = e$7, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$3, this._listenerOptions = s$2(n$8), this._sourceEvents = c$1(i$5), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$7.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	...
	_onMove(e$7) {
		if (!this.drag) return;
		let t$7 = this._getTrackedPointerEventData(e$7);
		if (!t$7) return;
		this.drag.x = t$7.clientX, this.drag.y = t$7.clientY;
		let r$6 = {
			type: e.Move,
			srcEvent: e$7,
			target: t$7.target,
	...
	_bindWindowListeners() {
		...
		let { move: e$7, end: t$7, cancel: n$8 } = l[this._sourceEvents];
		window.addEventListener(e$7, this._onMove, this._listenerOptions), window.addEventListener(t$7, this._onEnd, this._listenerOptions), n$8 && window.addEventListener(n$8, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !0;
	}
	_unbindWindowListeners() {
		if (this._areWindowListenersBound) {
			let { move: e$7, end: t$7, cancel: n$8 } = l[this._sourceEvents];
			window.removeEventListener(e$7, this._onMove, this._listenerOptions), window.removeEventListener(t$7, this._onEnd, this._listenerOptions), n$8 && window.removeEventListener(n$8, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !1;
		}
	}
	_resetDrag() {
	...
	updateSettings(e$7) {
		if (this.isDestroyed) return;
		let { listenerOptions: t$7, sourceEvents: n$8, startPredicate: r$6 } = e$7, i$5 = c$1(n$8), a$3 = s$2(t$7);
		r$6 && this._startPredicate !== r$6 && (this._startPredicate = r$6), (t$7 && (this._listenerOptions.capture !== a$3.capture || this._listenerOptions.passive === a$3.passive) || n$8 && this._sourceEvents !== i$5) && (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this._unbindWindowListeners(), this.cancel(), n$8 && (this._sourceEvents = i$5), t$7 && a$3 && (this._listenerOptions = a$3), this.element.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
	on(e$7, t$7, n$8) {
		return this._emitter.on(e$7, t$7, n$8);
	}
...
function s$1(s$4, c$3) {
	...
	return n(() => {
		...
		if (l$3) {
			let { listenerOptions: e$7 = u.listenerOptions, sourceEvents: t$7 = u.sourceEvents, startPredicate: n$8 = u.startPredicate } = s$4 || {};
			l$3.updateSettings({
				listenerOptions: e$7,
				sourceEvents: t$7,
				startPredicate: n$8
				...
				if (null !== lastEffect) {
					...
					do {
						if ((updateQueue.tag & flags) === flags && (lastEffect = void 0, (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !0), lastEffect = runWithFiberInDEV(finishedWork, callCreateInDEV, updateQueue), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !1), void 0 !== lastEffect && "function" !== typeof lastEffect)) {
							...
							runWithFiberInDEV(finishedWork, function(n$8, a$3) {
								console.error("%s must not return anything besides a function, which is used for clean-up.%s", n$8, a$3);
							}, hookName, addendum);
						}
...
//#endregion
//#region react-examples/010-draggable-multiple-elements/index.tsx
...
const DraggableCardMemo = (0, import_react.memo)(function DraggableCard({ id, elementRefsMap }) {
	...
	c([pointerSensor, keyboardSensor], draggableSettings);
...
function App() {
	const elementRefsMap = (0, import_react.useRef)(/* @__PURE__ */ new Map());
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: [
		0,
		1,
		2,
		3
	].map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraggableCardMemo, {
		id,
		elementRefsMap
	}, id)) });
}
