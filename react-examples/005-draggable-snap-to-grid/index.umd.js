...
var __copyProps = (to, from, except, desc) => {
	if (from && typeof from === "object" || typeof from === "function") for (var keys = __getOwnPropNames(from), i$3 = 0, n$10 = keys.length, key; i$3 < n$10; i$3++) {
		key = keys[i$3];
...
var E$1 = {
	...
	constructor(t$10 = {}) {
		this.dedupe = t$10.dedupe || E$1.ADD, this.getId = t$10.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
	}
	_getListeners(t$10) {
		let n$10 = this._events.get(t$10);
		return n$10 ? n$10.l || (n$10.l = [...n$10.m.values()]) : null;
	}
	on(t$10, n$10, e$8) {
		let i$3 = this._events, s$4 = i$3.get(t$10);
		s$4 || (s$4 = {
			m: /* @__PURE__ */ new Map(),
			l: null
		}, i$3.set(t$10, s$4));
		let o$3 = s$4.m;
		if (e$8 = e$8 === r$6 ? this.getId(n$10) : e$8, o$3.has(e$8)) switch (this.dedupe) {
			case E$1.THROW: throw new Error("Eventti: duplicate listener id!");
			case E$1.IGNORE: return e$8;
			case E$1.UPDATE:
				s$4.l = null;
				break;
			default: o$3.delete(e$8), s$4.l = null;
		}
		return o$3.set(e$8, n$10), s$4.l?.push(n$10), e$8;
	}
	once(t$10, n$10, e$8) {
		let i$3 = 0;
		return e$8 = e$8 === r$6 ? this.getId(n$10) : e$8, this.on(t$10, (...s$4) => {
			i$3 || (i$3 = 1, this.off(t$10, e$8), n$10(...s$4));
		}, e$8);
	}
	off(t$10, n$10) {
		if (t$10 === r$6) {
		...
		if (n$10 === r$6) {
			this._events.delete(t$10);
			return;
		}
		let e$8 = this._events.get(t$10);
		e$8?.m.delete(n$10) && (e$8.l = null, e$8.m.size || this._events.delete(t$10));
	}
	emit(t$10, ...n$10) {
		let e$8 = this._getListeners(t$10);
		if (e$8) {
			let i$3 = e$8.length, s$4 = 0;
			if (n$10.length) for (; s$4 < i$3; s$4++) e$8[s$4](...n$10);
			else for (; s$4 < i$3; s$4++) e$8[s$4]();
		}
	}
	listenerCount(t$10) {
		if (t$10 === r$6) {
		...
		return this._events.get(t$10)?.m.size || 0;
	}
};
...
var _$1 = E$1, o$2 = class {
	constructor(e$8 = {}) {
		let { phases: t$10 = [], dedupe: r$7, getId: s$4 } = e$8;
		this._phases = t$10, this._emitter = new v({
			getId: s$4,
			dedupe: r$7
	...
	on(e$8, t$10, r$7) {
		return this._emitter.on(e$8, t$10, r$7);
	}
	once(e$8, t$10, r$7) {
		return this._emitter.once(e$8, t$10, r$7);
	}
	off(e$8, t$10) {
		return this._emitter.off(e$8, t$10);
	}
	count(e$8) {
	...
	_fillQueue() {
		let e$8 = this._queue, t$10 = this._phases, r$7 = this._getListeners, s$4 = 0, a$2 = t$10.length, n$10;
		for (; s$4 < a$2; s$4++) n$10 = r$7(t$10[s$4]), n$10 && e$8.push(n$10);
		return e$8;
	}
	_processQueue(...e$8) {
		let t$10 = this._queue, r$7 = t$10.length;
		if (!r$7) return;
		let s$4 = 0, a$2 = 0, n$10, c$3;
		for (; s$4 < r$7; s$4++) for (n$10 = t$10[s$4], a$2 = 0, c$3 = n$10.length; a$2 < c$3; a$2++) n$10[a$2](...e$8);
		t$10.length = 0;
	}
};
function u$2(i$3 = 60) {
	if (typeof requestAnimationFrame == "function" && typeof cancelAnimationFrame == "function") return (e$8) => {
		let t$10 = requestAnimationFrame(e$8);
		return () => cancelAnimationFrame(t$10);
	};
	{
		let e$8 = 1e3 / i$3, t$10 = typeof performance > "u" ? () => Date.now() : () => performance.now();
		return (r$7) => {
			let s$4 = setTimeout(() => r$7(t$10()), e$8);
...
var l$2 = class extends o$2 {
	constructor(e$8 = {}) {
		let { paused: t$10 = !1, onDemand: r$7 = !1, requestFrame: s$4 = u$2(),...a$2 } = e$8;
		super(a$2), this._paused = t$10, this._onDemand = r$7, this._requestFrame = s$4, this._cancelFrame = null, this._empty = !0, !t$10 && !r$7 && this._request();
	}
	get phases() {
		return this._phases;
	}
	...
	on(e$8, t$10, r$7) {
		let s$4 = super.on(e$8, t$10, r$7);
		return this._empty = !1, this._request(), s$4;
	}
	once(e$8, t$10, r$7) {
		let s$4 = super.once(e$8, t$10, r$7);
		return this._empty = !1, this._request(), s$4;
	}
	_request() {
...
function getStyle(e$8, t$10) {
	if (t$10) return window.getComputedStyle(e$8, t$10);
...
function t$9(t$10) {
	let n$10 = e$7.get(t$10)?.deref();
	return n$10 || (n$10 = window.getComputedStyle(t$10, null), e$7.set(t$10, new WeakRef(n$10))), n$10;
}

//#endregion
//#region ../dragdoll/dist/constants-CMClRu_c.js
const e$6 = typeof window < `u` && window.document !== void 0, t$8 = e$6 && `ontouchstart` in window, n$8 = e$6 && !!window.PointerEvent;
e$6 && navigator.vendor && navigator.vendor.indexOf(`Apple`) > -1 && navigator.userAgent && navigator.userAgent.indexOf(`CriOS`) == -1 && navigator.userAgent.indexOf(`FxiOS`);
...
function isContainingBlockForAbsoluteElement(t$10) {
	return "static" !== getStyle(t$10).position || isContainingBlockForFixedElement(t$10);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getContainingBlock.js
function getContainingBlock(e$8, t$10 = {}) {
	if (isDocumentElement(e$8)) return e$8.ownerDocument.defaultView;
	const n$10 = t$10.position || getStyle(e$8).position, { skipDisplayNone: i$3, container: o$3 } = t$10;
	switch (n$10) {
		case "static":
		case "relative":
		case "sticky":
		case "-webkit-sticky": {
			let t$11 = o$3 || e$8.parentElement;
			for (; t$11;) {
				const e$9 = isBlockElement(t$11);
				if (e$9) return t$11;
				if (null === e$9 && !i$3) return null;
		...
		case "absolute":
		case "fixed": {
			const t$11 = "fixed" === n$10;
			let l$3 = o$3 || e$8.parentElement;
			for (; l$3;) {
				const e$9 = t$11 ? isContainingBlockForFixedElement(l$3) : isContainingBlockForAbsoluteElement(l$3);
				if (!0 === e$9) return l$3;
				if (null === e$9 && !i$3) return null;
...
function getOffsetContainer(n$10, t$10 = {}) {
	const { display: o$3 } = getStyle(n$10);
	if ("none" === o$3 || "contents" === o$3) return null;
	const e$8 = t$10.position || getStyle(n$10).position, { skipDisplayNone: s$4, container: r$7 } = t$10;
	switch (e$8) {
		case "relative": return n$10;
		case "fixed": return getContainingBlock(n$10, {
			container: r$7,
			position: e$8,
			skipDisplayNone: s$4
		});
		case "absolute": {
			const t$11 = getContainingBlock(n$10, {
				container: r$7,
				position: e$8,
				skipDisplayNone: s$4
			});
			return isWindow(t$11) ? n$10.ownerDocument : t$11;
		}
		default: return null;
	}
}
...
function s$3(e$8, t$10) {
	return e$8.isIdentity && t$10.isIdentity ? !0 : e$8.is2D && t$10.is2D ? e$8.a === t$10.a && e$8.b === t$10.b && e$8.c === t$10.c && e$8.d === t$10.d && e$8.e === t$10.e && e$8.f === t$10.f : e$8.m11 === t$10.m11 && e$8.m12 === t$10.m12 && e$8.m13 === t$10.m13 && e$8.m14 === t$10.m14 && e$8.m21 === t$10.m21 && e$8.m22 === t$10.m22 && e$8.m23 === t$10.m23 && e$8.m24 === t$10.m24 && e$8.m31 === t$10.m31 && e$8.m32 === t$10.m32 && e$8.m33 === t$10.m33 && e$8.m34 === t$10.m34 && e$8.m41 === t$10.m41 && e$8.m42 === t$10.m42 && e$8.m43 === t$10.m43 && e$8.m44 === t$10.m44;
}
function c$2(e$8) {
...
function l$1(e$8, t$10, n$10 = null) {
	if (`moveBefore` in e$8 && e$8.isConnected === t$10.isConnected) try {
		e$8.moveBefore(t$10, n$10);
		return;
	} catch {}
	let r$7 = document.activeElement, i$3 = t$10.contains(r$7);
	e$8.insertBefore(t$10, n$10), i$3 && document.activeElement !== r$7 && r$7 instanceof HTMLElement && r$7.focus({ preventScroll: !0 });
}
function u$1(e$8) {
	return e$8.setMatrixValue(`scale(1, 1)`);
}
function d$1(e$8, t$10 = 0) {
	let n$10 = 10 ** t$10;
...
var f = class {
	...
	set(e$8, t$10) {
		this._cache.set(e$8, t$10), this._validation.add(e$8);
	}
	get(e$8) {
	...
	_matrixCache;
	_clientOffsetCache;
	constructor(e$8, t$10) {
		this.sensor = e$8, this.startEvent = t$10, this.prevMoveEvent = t$10, this.moveEvent = t$10, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f(), this._clientOffsetCache = new f();
	}
};
function m(e$8, t$10, n$10 = !1) {
	let { style: r$7 } = e$8;
	for (let e$9 in t$10) r$7.setProperty(e$9, t$10[e$9], n$10 ? `important` : ``);
}
function h() {
...
function g(e$8, t$10 = {
	...
	if (t$10.x = 0, t$10.y = 0, e$8 instanceof Window) return t$10;
	if (e$8 instanceof Document) return t$10.x = window.scrollX * -1, t$10.y = window.scrollY * -1, t$10;
	let { x: r$7, y: i$3 } = e$8.getBoundingClientRect(), a$2 = t$9(e$8);
	return t$10.x = r$7 + (parseFloat(a$2.borderLeftWidth) || 0), t$10.y = i$3 + (parseFloat(a$2.borderTopWidth) || 0), t$10;
}
function _(e$8) {
	let t$10 = t$9(e$8), r$7 = parseFloat(t$10.height) || 0;
	return t$10.boxSizing === `border-box` ? r$7 : (r$7 += parseFloat(t$10.borderTopWidth) || 0, r$7 += parseFloat(t$10.borderBottomWidth) || 0, r$7 += parseFloat(t$10.paddingTop) || 0, r$7 += parseFloat(t$10.paddingBottom) || 0, e$8 instanceof HTMLElement && (r$7 += e$8.offsetHeight - e$8.clientHeight), r$7);
}
function v$1(e$8) {
	let t$10 = t$9(e$8), r$7 = parseFloat(t$10.width) || 0;
	return t$10.boxSizing === `border-box` ? r$7 : (r$7 += parseFloat(t$10.borderLeftWidth) || 0, r$7 += parseFloat(t$10.borderRightWidth) || 0, r$7 += parseFloat(t$10.paddingLeft) || 0, r$7 += parseFloat(t$10.paddingRight) || 0, e$8 instanceof HTMLElement && (r$7 += e$8.offsetWidth - e$8.clientWidth), r$7);
}
function y(e$8, t$10 = !1) {
	let { translate: r$7, rotate: i$3, scale: a$2, transform: o$3 } = t$9(e$8), s$4 = ``;
	if (r$7 && r$7 !== `none`) {
		let [t$11 = `0px`, n$10 = `0px`, i$4] = r$7.split(` `);
		t$11.includes(`%`) && (t$11 = `${parseFloat(t$11) / 100 * v$1(e$8)}px`), n$10.includes(`%`) && (n$10 = `${parseFloat(n$10) / 100 * _(e$8)}px`), i$4 ? s$4 += `translate3d(${t$11},${n$10},${i$4})` : s$4 += `translate(${t$11},${n$10})`;
	}
	if (i$3 && i$3 !== `none`) {
		let e$9 = i$3.split(` `);
		e$9.length > 1 ? s$4 += `rotate3d(${e$9.join(`,`)})` : s$4 += `rotate(${e$9.join(`,`)})`;
	}
	if (a$2 && a$2 !== `none`) {
		let e$9 = a$2.split(` `);
		e$9.length === 3 ? s$4 += `scale3d(${e$9.join(`,`)})` : s$4 += `scale(${e$9.join(`,`)})`;
	}
	return !t$10 && o$3 && o$3 !== `none` && (s$4 += o$3), s$4;
}
function b(e$8) {
...
function C(e$8, t$10, n$10 = {
	x: 0,
	y: 0
}) {
	let r$7 = b(e$8) ? e$8 : g(e$8, x), i$3 = b(t$10) ? t$10 : g(t$10, S);
	return n$10.x = i$3.x - r$7.x, n$10.y = i$3.y - r$7.y, n$10;
}
function w(e$8) {
	let t$10 = e$8.split(` `), n$10 = ``, r$7 = ``, i$3 = ``;
	return t$10.length === 1 ? n$10 = r$7 = t$10[0] : t$10.length === 2 ? [n$10, r$7] = t$10 : [n$10, r$7, i$3] = t$10, {
		x: parseFloat(n$10) || 0,
		y: parseFloat(r$7) || 0,
		z: parseFloat(i$3) || 0
	};
...
function E(e$8, t$10 = new DOMMatrix()) {
	let r$7 = e$8;
	for (u$1(t$10); r$7;) {
		let e$9 = y(r$7);
		if (e$9 && (T.setMatrixValue(e$9), !T.isIdentity)) {
			let { transformOrigin: e$10 } = t$9(r$7), { x: i$3, y: a$2, z: o$3 } = w(e$10);
			o$3 === 0 ? T.setMatrixValue(`translate(${i$3}px,${a$2}px) ${T} translate(${i$3 * -1}px,${a$2 * -1}px)`) : T.setMatrixValue(`translate3d(${i$3}px,${a$2}px,${o$3}px) ${T} translate3d(${i$3 * -1}px,${a$2 * -1}px,${o$3 * -1}px)`), t$10.preMultiplySelf(T);
		}
		r$7 = r$7.parentElement;
	}
	return t$10;
}
const D = e$6 ? h() : null;
var O = class {
	...
	constructor(e$8, t$10) {
		...
		let { drag: r$7 } = t$10;
		if (!r$7) throw Error(`Drag is not defined`);
		let i$3 = t$9(e$8), a$2 = e$8.getBoundingClientRect(), s$4 = y(e$8, !0);
		this.data = {}, this.element = e$8, this.elementTransformOrigin = w(i$3.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$4 + i$3.transform), this.elementOffsetMatrix = new DOMMatrix(s$4).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
			...
			x: 0,
			y: 0
		}, this._matrixCache = r$7._matrixCache, this._clientOffsetCache = r$7._clientOffsetCache;
		let c$3 = e$8.parentElement;
		if (!c$3) throw Error(`Dragged element does not have a parent element.`);
		this.elementContainer = c$3;
		let l$3 = t$10.settings.container, u$3 = (typeof l$3 == `function` ? l$3({
			draggable: t$10,
			drag: r$7,
			element: e$8
		}) : l$3) || c$3;
		if (this.dragContainer = u$3, c$3 !== u$3) {
			let { position: e$9 } = i$3;
		...
		this.elementOffsetContainer = d$2, this.dragOffsetContainer = u$3 === c$3 ? d$2 : getOffsetContainer(e$8, { container: u$3 });
		{
			let { width: e$9, height: t$11, x: n$10, y: r$8 } = a$2;
			this.clientRect = {
				width: e$9,
				height: t$11,
				x: n$10,
		...
		let f$1 = t$10.settings.frozenStyles({
			draggable: t$10,
			drag: r$7,
			item: this,
			style: i$3
		...
		if (Array.isArray(f$1)) if (f$1.length) {
			let e$9 = {};
			for (let t$11 of f$1) e$9[t$11] = i$3[t$11];
			this.frozenStyles = e$9;
		} else this.frozenStyles = null;
		else this.frozenStyles = f$1;
		if (this.frozenStyles) {
			let t$11 = {};
			for (let n$10 in this.frozenStyles) t$11[n$10] = e$8.style[n$10];
			this.unfrozenStyles = t$11;
		}
	}
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$8) => {
			if (!this._matrixCache.isValid(e$8)) {
				let t$10 = this._matrixCache.get(e$8) || [new DOMMatrix(), new DOMMatrix()], [n$10, r$7] = t$10;
				E(e$8, n$10), r$7.setMatrixValue(n$10.toString()).invertSelf(), this._matrixCache.set(e$8, t$10);
			}
		});
	}
	_updateContainerOffset() {
		let { elementOffsetContainer: e$8, elementContainer: t$10, dragOffsetContainer: n$10, dragContainer: r$7, containerOffset: i$3, _clientOffsetCache: a$2, _matrixCache: o$3 } = this;
		if (e$8 !== n$10) {
			let [s$4, l$3] = [[r$7, n$10], [t$10, e$8]].map(([e$9, t$11]) => {
				let n$11 = a$2.get(t$11) || {
					x: 0,
					y: 0
				};
				if (!a$2.isValid(t$11)) {
					let r$8 = o$3.get(e$9);
					t$11 instanceof HTMLElement && r$8 && !r$8[0].isIdentity ? c$2(r$8[0]) ? (D.style.setProperty(`transform`, r$8[1].toString(), `important`), t$11.append(D), g(D, n$11), D.remove()) : (g(t$11, n$11), n$11.x -= r$8[0].m41, n$11.y -= r$8[0].m42) : g(t$11, n$11);
				}
				return a$2.set(t$11, n$11), n$11;
			});
			C(s$4, l$3, i$3);
	...
	updateSize(e$8) {
		if (e$8) this.clientRect.width = e$8.width, this.clientRect.height = e$8.height;
			...
			let { width: e$9, height: t$10 } = this.element.getBoundingClientRect();
			this.clientRect.width = e$9, this.clientRect.height = t$10;
		}
	}
};
const k = {
	...
	x: 0,
	y: 0
}, j = e$6 ? new DOMMatrix() : null, M = e$6 ? new DOMMatrix() : null;
var N = function(e$8) {
...
const F = {
	...
	elements: () => null,
	frozenStyles: () => null,
	applyPosition: ({ item: e$8, phase: t$10 }) => {
		let n$10 = t$10 === L.End || t$10 === L.EndAlign, [r$7, i$3] = e$8.getContainerMatrix(), [a$2, o$3] = e$8.getDragContainerMatrix(), { position: s$4, alignmentOffset: c$3, containerOffset: l$3, elementTransformMatrix: d$2, elementTransformOrigin: f$1, elementOffsetMatrix: p$1 } = e$8, { x: m$1, y: h$1, z: g$1 } = f$1, _$2 = !d$2.isIdentity && (m$1 !== 0 || h$1 !== 0 || g$1 !== 0), v$2 = s$4.x + c$3.x + l$3.x, y$1 = s$4.y + c$3.y + l$3.y;
		u$1(j), _$2 && (g$1 === 0 ? j.translateSelf(-m$1, -h$1) : j.translateSelf(-m$1, -h$1, -g$1)), n$10 ? i$3.isIdentity || j.multiplySelf(i$3) : o$3.isIdentity || j.multiplySelf(o$3), u$1(M).translateSelf(v$2, y$1), j.multiplySelf(M), r$7.isIdentity || j.multiplySelf(r$7), _$2 && (u$1(M).translateSelf(m$1, h$1, g$1), j.multiplySelf(M)), d$2.isIdentity || j.multiplySelf(d$2), p$1.isIdentity || j.preMultiplySelf(p$1), e$8.element.style.transform = `${j}`;
	},
...
var B = class {
	...
	_alignId;
	constructor(e$8, t$10 = {}) {
		let { id: n$10 = Symbol(),...r$7 } = t$10;
		this.id = n$10, this._sensors = e$8, this.settings = this._parseSettings(r$7), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$9) => {
	...
	set sensors(e$8) {
		let t$10 = this._sensors;
		if (e$8 === t$10) return;
		let n$10 = t$10.filter((t$11) => !e$8.includes(t$11)), r$7 = e$8.filter((e$9) => !t$10.includes(e$9));
		this._sensors = e$8, n$10.forEach((e$9) => {
			this._unbindSensor(e$9);
		}), r$7.forEach((e$9) => {
			this._bindSensor(e$9);
		});
		let i$3 = this.drag?.sensor;
		i$3 && n$10.includes(i$3) && this.stop();
	}
	_bindSensor(e$8) {
		...
		e$8.on(e$4.Start, t$10, t$10), e$8.on(e$4.Move, t$10, t$10), e$8.on(e$4.Cancel, n$10, n$10), e$8.on(e$4.End, n$10, n$10), e$8.on(e$4.Destroy, n$10, n$10);
	}
	_unbindSensor(e$8) {
		let t$10 = this._sensorData.get(e$8);
		if (!t$10) return;
		let { onMove: n$10, onEnd: r$7 } = t$10;
		e$8.off(e$4.Start, n$10), e$8.off(e$4.Move, n$10), e$8.off(e$4.Cancel, r$7), e$8.off(e$4.End, r$7), e$8.off(e$4.Destroy, r$7), this._sensorData.delete(e$8);
	}
	_parseSettings(e$8, t$10 = z) {
		let { container: n$10 = t$10.container, startPredicate: r$7 = t$10.startPredicate, elements: i$3 = t$10.elements, frozenStyles: a$2 = t$10.frozenStyles, positionModifiers: o$3 = t$10.positionModifiers, applyPosition: s$4 = t$10.applyPosition, computeClientRect: c$3 = t$10.computeClientRect, sensorProcessingMode: l$3 = t$10.sensorProcessingMode, dndGroups: u$3 = t$10.dndGroups, onPrepareStart: d$2 = t$10.onPrepareStart, onStart: f$1 = t$10.onStart, onPrepareMove: p$1 = t$10.onPrepareMove, onMove: m$1 = t$10.onMove, onEnd: h$1 = t$10.onEnd, onDestroy: g$1 = t$10.onDestroy } = e$8 || {};
		return {
			container: n$10,
			startPredicate: r$7,
			elements: i$3,
	...
	_emit(e$8, ...t$10) {
		this._emitter.emit(e$8, ...t$10);
	}
	_onMove(n$10, r$7) {
		let i$3 = this._sensorData.get(r$7);
		if (i$3) switch (i$3.predicateState) {
			case P.Pending: {
				i$3.predicateEvent = n$10;
				let e$8 = this.settings.startPredicate({
					draggable: this,
					sensor: r$7,
					event: n$10
				});
				e$8 === !0 ? this.resolveStartPredicate(r$7) : e$8 === !1 && this.rejectStartPredicate(r$7);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = n$10, this.settings.sensorProcessingMode === I.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$9.read, this._prepareMove, this._moveId), r$5.once(n$9.write, this._applyMove, this._moveId)));
				break;
		}
	}
	_onScroll() {
	...
	_onEnd(e$8, t$10) {
		let n$10 = this._sensorData.get(t$10);
		n$10 && (this.drag ? n$10.predicateState === P.Resolved && (this.drag.endEvent = e$8, this._sensorData.forEach((e$9) => {
			e$9.predicateState = P.Pending, e$9.predicateEvent = null;
		}), this.stop()) : (n$10.predicateState = P.Pending, n$10.predicateEvent = null));
	}
	_prepareStart() {
		let e$8 = this.drag;
	...
	_applyStart() {
		...
		if (!(!e$8 || this._startPhase !== N.FinishPrepare)) {
			...
			for (let t$10 of e$8.items) t$10.dragContainer !== t$10.elementContainer && l$1(t$10.dragContainer, t$10.element), t$10.frozenStyles && Object.assign(t$10.element.style, t$10.frozenStyles), this.settings.applyPosition({
				phase: L.Start,
				draggable: this,
				drag: e$8,
				item: t$10
			});
			for (let t$10 of e$8.items) {
				let e$9 = t$10.getContainerMatrix()[0], n$10 = t$10.getDragContainerMatrix()[0];
				if (s$3(e$9, n$10) || !c$2(e$9) && !c$2(n$10)) continue;
				let r$7 = t$10.element.getBoundingClientRect(), { alignmentOffset: i$3 } = t$10;
				i$3.x += d$1(t$10.clientRect.x - r$7.x, 3), i$3.y += d$1(t$10.clientRect.y - r$7.y, 3);
			}
			for (let t$10 of e$8.items) {
				let { alignmentOffset: n$10 } = t$10;
				(n$10.x !== 0 || n$10.y !== 0) && this.settings.applyPosition({
					phase: L.StartAlign,
					draggable: this,
					drag: e$8,
					item: t$10
	...
	_prepareMove() {
		...
		let { moveEvent: t$10, prevMoveEvent: n$10 } = e$8;
		t$10 !== n$10 && (this._applyModifiers(F.Move, t$10.x - n$10.x, t$10.y - n$10.y), this._emit(R.PrepareMove, e$8, this), !e$8.isEnded && (this.settings.onPrepareMove?.(e$8, this), !e$8.isEnded && (e$8.prevMoveEvent = t$10)));
	}
	_applyMove() {
		let e$8 = this.drag;
		if (!(!e$8 || e$8.isEnded)) {
			for (let t$10 of e$8.items) t$10._moveDiff.x = 0, t$10._moveDiff.y = 0, this.settings.applyPosition({
				phase: L.Move,
				draggable: this,
				drag: e$8,
				item: t$10
	...
	_prepareAlign() {
		let { drag: e$8 } = this;
		if (!(!e$8 || e$8.isEnded)) for (let t$10 of e$8.items) {
			let { x: e$9, y: n$10 } = t$10.element.getBoundingClientRect(), r$7 = t$10.clientRect.x - t$10._moveDiff.x - e$9;
			t$10.alignmentOffset.x = t$10.alignmentOffset.x - t$10._alignDiff.x + r$7, t$10._alignDiff.x = r$7;
			let i$3 = t$10.clientRect.y - t$10._moveDiff.y - n$10;
			t$10.alignmentOffset.y = t$10.alignmentOffset.y - t$10._alignDiff.y + i$3, t$10._alignDiff.y = i$3;
		}
	}
	_applyAlign() {
		let { drag: e$8 } = this;
		if (!(!e$8 || e$8.isEnded)) for (let t$10 of e$8.items) t$10._alignDiff.x = 0, t$10._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$8,
			item: t$10
	...
	_applyModifiers(e$8, t$10, n$10) {
		let { drag: r$7 } = this;
		if (!r$7) return;
		let { positionModifiers: i$3 } = this.settings;
		for (let a$2 of r$7.items) {
			let o$3 = A;
			o$3.x = t$10, o$3.y = n$10;
			for (let t$11 of i$3) o$3 = t$11(o$3, {
				draggable: this,
				drag: r$7,
				item: a$2,
				phase: e$8
			});
			a$2.position.x += o$3.x, a$2.position.y += o$3.y, a$2.clientRect.x += o$3.x, a$2.clientRect.y += o$3.y, e$8 === `move` && (a$2._moveDiff.x += o$3.x, a$2._moveDiff.y += o$3.y);
		}
	}
	on(e$8, t$10, n$10) {
		return this._emitter.on(e$8, t$10, n$10);
	}
	off(e$8, t$10) {
		this._emitter.off(e$8, t$10);
	}
	resolveStartPredicate(n$10, r$7) {
		let i$3 = this._sensorData.get(n$10);
		if (!i$3) return;
		let a$2 = r$7 || i$3.predicateEvent;
		i$3.predicateState === P.Pending && a$2 && (this._startPhase = N.Init, i$3.predicateState = P.Resolved, i$3.predicateEvent = null, this.drag = new p(n$10, a$2), this._sensorData.forEach((e$8, t$10) => {
			t$10 !== n$10 && (e$8.predicateState = P.Rejected, e$8.predicateEvent = null);
		}), this.settings.sensorProcessingMode === I.Immediate ? (this._prepareStart(), this._applyStart()) : (r$5.once(n$9.read, this._prepareStart, this._startId), r$5.once(n$9.write, this._applyStart, this._startId)));
	}
	rejectStartPredicate(e$8) {
		let t$10 = this._sensorData.get(e$8);
		t$10?.predicateState === P.Pending && (t$10.predicateState = P.Rejected, t$10.predicateEvent = null);
	}
	stop() {
		let n$10 = this.drag;
		if (!(!n$10 || n$10.isEnded)) {
			...
			n$10.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$5.off(n$9.read, this._startId), r$5.off(n$9.write, this._startId), r$5.off(n$9.read, this._moveId), r$5.off(n$9.write, this._moveId), r$5.off(n$9.read, this._alignId), r$5.off(n$9.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
			for (let e$8 of n$10.items) {
				if (e$8.elementContainer !== e$8.dragContainer && (l$1(e$8.elementContainer, e$8.element), e$8.alignmentOffset.x = 0, e$8.alignmentOffset.y = 0, e$8.containerOffset.x = 0, e$8.containerOffset.y = 0), e$8.unfrozenStyles) for (let t$10 in e$8.unfrozenStyles) e$8.element.style[t$10] = e$8.unfrozenStyles[t$10] || ``;
			...
			for (let e$8 of n$10.items) if (e$8.elementContainer !== e$8.dragContainer) {
				let t$10 = e$8.element.getBoundingClientRect();
				e$8.alignmentOffset.x = d$1(e$8.clientRect.x - t$10.x, 3), e$8.alignmentOffset.y = d$1(e$8.clientRect.y - t$10.y, 3);
			}
			for (let e$8 of n$10.items) e$8.elementContainer !== e$8.dragContainer && (e$8.alignmentOffset.x !== 0 || e$8.alignmentOffset.y !== 0) && this.settings.applyPosition({
				phase: L.EndAlign,
				draggable: this,
				drag: n$10,
				item: e$8
	...
	align(n$10 = !1) {
		!this.drag || this.drag.isEnded || (n$10 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$9.read, this._prepareAlign, this._alignId), r$5.once(n$9.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
		let { drag: e$8, settings: t$10 } = this;
		return e$8 && t$10.computeClientRect?.({
			draggable: this,
			drag: e$8
		}) || null;
	}
...
function i$2(e$8, t$10) {
	if (`pointerId` in e$8) return e$8.pointerId === t$10 ? e$8 : null;
	if (`changedTouches` in e$8) {
		let n$10 = 0;
		for (; n$10 < e$8.changedTouches.length; n$10++) if (e$8.changedTouches[n$10].identifier === t$10) return e$8.changedTouches[n$10];
		return null;
	}
	return e$8;
}
...
function s$2(e$8 = {}) {
	let { capture: t$10 = !0, passive: n$10 = !0 } = e$8;
	return {
		capture: t$10,
		passive: n$10
	};
...
function c$1(n$10) {
	return n$10 === `auto` || n$10 === void 0 ? n$8 ? `pointer` : t$8 ? `touch` : `mouse` : n$10;
}
const l = {
	pointer: {
		start: `pointerdown`,
...
var d = class {
	...
	_emitter;
	constructor(e$8, t$10 = {}) {
		let { listenerOptions: n$10 = u.listenerOptions, sourceEvents: i$3 = u.sourceEvents, startPredicate: a$2 = u.startPredicate } = t$10;
		this.element = e$8, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$2, this._listenerOptions = s$2(n$10), this._sourceEvents = c$1(i$3), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$8.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	_getTrackedPointerEventData(e$8) {
		return this.drag ? i$2(e$8, this.drag.pointerId) : null;
	}
	_onStart(e$8) {
		if (this.isDestroyed || this.drag || !this._startPredicate(e$8)) return;
		let t$10 = a$1(e$8);
		if (t$10 === null) return;
		let r$7 = i$2(e$8, t$10);
		if (r$7 === null) return;
		let s$4 = {
			pointerId: t$10,
			pointerType: o$1(e$8),
	...
	_onMove(e$8) {
		if (!this.drag) return;
		let t$10 = this._getTrackedPointerEventData(e$8);
		if (!t$10) return;
		this.drag.x = t$10.clientX, this.drag.y = t$10.clientY;
		let r$7 = {
			type: e$4.Move,
			srcEvent: e$8,
			target: t$10.target,
		...
		this._emitter.emit(r$7.type, r$7);
	}
	_onCancel(e$8) {
		if (!this.drag) return;
		let t$10 = this._getTrackedPointerEventData(e$8);
		...
		this._emitter.emit(r$7.type, r$7), this._resetDrag();
	}
	_onEnd(e$8) {
		if (!this.drag) return;
		let t$10 = this._getTrackedPointerEventData(e$8);
	...
	_bindWindowListeners() {
		...
		let { move: e$8, end: t$10, cancel: n$10 } = l[this._sourceEvents];
		window.addEventListener(e$8, this._onMove, this._listenerOptions), window.addEventListener(t$10, this._onEnd, this._listenerOptions), n$10 && window.addEventListener(n$10, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !0;
	}
	_unbindWindowListeners() {
		if (this._areWindowListenersBound) {
			let { move: e$8, end: t$10, cancel: n$10 } = l[this._sourceEvents];
			window.removeEventListener(e$8, this._onMove, this._listenerOptions), window.removeEventListener(t$10, this._onEnd, this._listenerOptions), n$10 && window.removeEventListener(n$10, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !1;
		}
	}
	_resetDrag() {
	...
	updateElement(e$8) {
		this.isDestroyed || this.element === e$8 || (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), e$8.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this.element = e$8);
	}
	updateSettings(e$8) {
		if (this.isDestroyed) return;
		let { listenerOptions: t$10, sourceEvents: n$10, startPredicate: r$7 } = e$8, i$3 = c$1(n$10), a$2 = s$2(t$10);
		r$7 && this._startPredicate !== r$7 && (this._startPredicate = r$7), (t$10 && (this._listenerOptions.capture !== a$2.capture || this._listenerOptions.passive === a$2.passive) || n$10 && this._sourceEvents !== i$3) && (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this._unbindWindowListeners(), this.cancel(), n$10 && (this._sourceEvents = i$3), t$10 && a$2 && (this._listenerOptions = a$2), this.element.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
	on(e$8, t$10, n$10) {
		return this._emitter.on(e$8, t$10, n$10);
	}
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.cancel(), this._emitter.emit(e$4.Destroy, { type: e$4.Destroy }), this._emitter.off(), this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
};

//#endregion
//#region ../dragdoll/dist/create-snap-modifier-BgWO4pEt.js
function e$5(e$8, t$10) {
	return Math.round(e$8 / t$10) * t$10;
}
function t$7(t$10, n$10, r$7) {
	let i$3 = r$7 - n$10, a$2 = Math.abs(i$3);
	if (a$2 >= t$10) {
		let n$11 = a$2 % t$10;
		return e$5(i$3 > 0 ? i$3 - n$11 : i$3 + n$11, t$10);
	}
	return 0;
}
function n(e$8, n$10) {
	return function(r$7, { item: i$3 }) {
		let a$2 = i$3.data.__snap__ || (i$3.data.__snap__ = {
			snapX: 0,
			snapY: 0,
			sensorX: 0,
			sensorY: 0
		});
		a$2.sensorX += r$7.x, a$2.sensorY += r$7.y;
		let o$3 = t$7(e$8, a$2.snapX, a$2.sensorX), s$4 = t$7(n$10, a$2.snapY, a$2.sensorY);
		return a$2.snapX += o$3, a$2.snapY += s$4, r$7.x = o$3, r$7.y = s$4, r$7;
	};
}
...
var n$7 = class {
	...
	_start(t$10) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$10), this._emitter.emit(e$4.Start, t$10));
	}
	_move(t$10) {
		this.drag && (this._updateDragData(t$10), this._emitter.emit(e$4.Move, t$10));
	}
	_end(t$10) {
		this.drag && (this._updateDragData(t$10), this._emitter.emit(e$4.End, t$10), this._resetDragData());
	}
	_cancel(t$10) {
		this.drag && (this._updateDragData(t$10), this._emitter.emit(e$4.Cancel, t$10), this._resetDragData());
	}
	on(e$8, t$10, n$10) {
		return this._emitter.on(e$8, t$10, n$10);
	}
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.cancel(), this._emitter.emit(e$4.Destroy, { type: e$4.Destroy }), this._emitter.off());
	}
};

//#endregion
//#region ../dragdoll/dist/keyboard-sensor-rH_K02ev.js
const n$3 = {
	moveDistance: 25,
	cancelOnBlur: !0,
	cancelOnVisibilityChange: !0,
	startPredicate: (e$8, t$10) => {
		if (t$10.element && (e$8.key === `Enter` || e$8.key === ` `) && document.activeElement === t$10.element) {
			let { x: e$9, y: n$10 } = t$10.element.getBoundingClientRect();
			return {
				x: e$9,
				y: n$10
			};
	...
	movePredicate: (e$8, t$10) => {
		if (!t$10.drag) return null;
		switch (e$8.key) {
			case `ArrowLeft`: return {
				x: t$10.drag.x - t$10.moveDistance.x,
				y: t$10.drag.y
			};
			...
			case `ArrowUp`: return {
				x: t$10.drag.x,
				y: t$10.drag.y - t$10.moveDistance.y
			};
	...
	cancelPredicate: (e$8, t$10) => {
		if (t$10.drag && e$8.key === `Escape`) {
			let { x: e$9, y: n$10 } = t$10.drag;
			return {
				x: e$9,
				y: n$10
			};
	...
	endPredicate: (e$8, t$10) => {
		if (t$10.drag && (e$8.key === `Enter` || e$8.key === ` `)) {
			let { x: e$9, y: n$10 } = t$10.drag;
			return {
				x: e$9,
				y: n$10
...
var r$4 = class extends n$7 {
	...
	constructor(e$8, t$10 = {}) {
		super();
		let { moveDistance: r$7 = n$3.moveDistance, cancelOnBlur: i$3 = n$3.cancelOnBlur, cancelOnVisibilityChange: a$2 = n$3.cancelOnVisibilityChange, startPredicate: o$3 = n$3.startPredicate, movePredicate: s$4 = n$3.movePredicate, cancelPredicate: c$3 = n$3.cancelPredicate, endPredicate: l$3 = n$3.endPredicate } = t$10;
		this.element = e$8, this.moveDistance = typeof r$7 == `number` ? {
			x: r$7,
			y: r$7
		} : { ...r$7 }, this._cancelOnBlur = i$3, this._cancelOnVisibilityChange = a$2, this._startPredicate = o$3, this._movePredicate = s$4, this._cancelPredicate = c$3, this._endPredicate = l$3, this._onKeyDown = this._onKeyDown.bind(this), this._internalCancel = this._internalCancel.bind(this), this._blurCancelHandler = this._blurCancelHandler.bind(this), document.addEventListener(`keydown`, this._onKeyDown), i$3 && e$8?.addEventListener(`blur`, this._blurCancelHandler), a$2 && document.addEventListener(`visibilitychange`, this._internalCancel);
	}
	_internalCancel() {
		this.cancel();
	}
	...
	_onKeyDown(t$10) {
		if (!this.drag) {
			let n$11 = this._startPredicate(t$10, this);
			n$11 && (t$10.preventDefault(), this._start({
				type: e$4.Start,
				x: n$11.x,
				y: n$11.y,
				srcEvent: t$10
		...
		let n$10 = this._cancelPredicate(t$10, this);
		if (n$10) {
			t$10.preventDefault(), this._cancel({
				type: e$4.Cancel,
				x: n$10.x,
				y: n$10.y,
				srcEvent: t$10
		...
		let r$7 = this._endPredicate(t$10, this);
		if (r$7) {
			t$10.preventDefault(), this._end({
				type: e$4.End,
				x: r$7.x,
				y: r$7.y,
				srcEvent: t$10
		...
		let i$3 = this._movePredicate(t$10, this);
		if (i$3) {
			t$10.preventDefault(), this._move({
				type: e$4.Move,
				x: i$3.x,
				y: i$3.y,
				srcEvent: t$10
	...
	updateSettings(e$8) {
		if (this.isDestroyed) return;
		let { moveDistance: t$10, cancelOnBlur: n$10, cancelOnVisibilityChange: r$7, startPredicate: i$3, movePredicate: a$2, cancelPredicate: o$3, endPredicate: s$4 } = e$8;
		t$10 !== void 0 && (typeof t$10 == `number` ? this.moveDistance.x = this.moveDistance.y = t$10 : (this.moveDistance.x = t$10.x, this.moveDistance.y = t$10.y)), n$10 !== void 0 && this._cancelOnBlur !== n$10 && (this._cancelOnBlur = n$10, n$10 ? this.element?.addEventListener(`blur`, this._blurCancelHandler) : this.element?.removeEventListener(`blur`, this._blurCancelHandler)), r$7 !== void 0 && this._cancelOnVisibilityChange !== r$7 && (this._cancelOnVisibilityChange = r$7, r$7 ? document.addEventListener(`visibilitychange`, this._internalCancel) : document.removeEventListener(`visibilitychange`, this._internalCancel)), i$3 && (this._startPredicate = i$3), a$2 && (this._movePredicate = a$2), o$3 && (this._cancelPredicate = o$3), s$4 && (this._endPredicate = s$4);
	}
	destroy() {
	...
	(function() {
		...
		function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
			...
			if (invokeCallback) {
				...
				isArrayImpl(callback) ? (escapedPrefix = "", null != childKey && (escapedPrefix = childKey.replace(userProvidedKeyEscapeRegex, "$&/") + "/"), mapIntoArray(callback, array, escapedPrefix, "", function(c$3) {
					return c$3;
			...
			if (isArrayImpl(children)) for (var i$3 = 0; i$3 < children.length; i$3++) nameSoFar = children[i$3], type = childKey + getElementKey(nameSoFar, i$3), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if (i$3 = getIteratorFn(children), "function" === typeof i$3) for (i$3 === children.entries && (didWarnAboutMaps || console.warn("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), didWarnAboutMaps = !0), children = i$3.call(children), i$3 = 0; !(nameSoFar = children.next()).done;) nameSoFar = nameSoFar.value, type = childKey + getElementKey(nameSoFar, i$3++), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if ("object" === type) {
		...
		function flushActQueue(queue) {
			if (!isFlushing) {
				...
				var i$3 = 0;
				try {
					for (; i$3 < queue.length; i$3++) {
						var callback = queue[i$3];
						do {
					...
					queue.splice(0, i$3 + 1), ReactSharedInternals.thrownErrors.push(error);
				} finally {
					isFlushing = !1;
				}
			}
		...
		exports.createElement = function(type, config, children) {
			...
			key && defineKeyPropWarningGetter(i$3, "function" === typeof type ? type.displayName || type.name || "Unknown" : type);
			var propName = 1e4 > ReactSharedInternals.recentlyCreatedOwnerStacks++;
			return ReactElement(type, key, i$3, getOwner(), propName ? Error("react-stack-top-frame") : unknownOwnerDebugStack, propName ? createTask(getTaskName(type)) : unknownOwnerDebugTask);
		};
...
const n$1 = typeof window > `u` ? import_react.useEffect : import_react.useLayoutEffect;

//#endregion
//#region ../dragdoll-react/dist/are-configs-equal-Cv4ZY5_I.js
const e$1 = Object.prototype.hasOwnProperty, t$3 = (e$8) => {
	if (typeof e$8 != `object` || !e$8) return !1;
	let t$10 = Object.getPrototypeOf(e$8);
	return t$10 === Object.prototype || t$10 === null;
};
function n$6(r$7, i$3) {
	if (Object.is(r$7, i$3)) return !0;
	if (r$7 === null || i$3 === null || typeof r$7 != `object` || typeof i$3 != `object`) return !1;
	let a$2 = Array.isArray(r$7), o$3 = Array.isArray(i$3);
	if (a$2 || o$3) {
		if (!a$2 || !o$3) return !1;
		let e$8 = r$7.length;
		if (e$8 !== i$3.length) return !1;
		for (let t$10 = 0; t$10 < e$8; t$10++) if (!n$6(r$7[t$10], i$3[t$10])) return !1;
		return !0;
	}
	let s$4 = r$7 instanceof Set, c$3 = i$3 instanceof Set;
	if (s$4 || c$3) return !s$4 || !c$3 || r$7.size !== i$3.size ? !1 : r$7.isSubsetOf(i$3);
	if (!t$3(r$7) || !t$3(i$3)) return !1;
	let l$3 = Object.keys(r$7), u$3 = Object.keys(i$3);
	if (l$3.length !== u$3.length) return !1;
	for (let t$10 = 0; t$10 < l$3.length; t$10++) {
		let a$3 = l$3[t$10];
		if (!e$1.call(i$3, a$3) || !n$6(r$7[a$3], i$3[a$3])) return !1;
	}
	return !0;
}
...
function t$2(e$8, t$10) {
	if (e$8 === t$10) return !0;
	if (e$8.length !== t$10.length) return !1;
	for (let n$10 = 0; n$10 < e$8.length; n$10++) if (!Object.is(e$8[n$10], t$10[n$10])) return !1;
	return !0;
}
function n$2(n$10, r$7) {
	let i$3 = (0, import_react.useRef)(null), a$2 = i$3.current || {
		deps: r$7,
		value: n$10()
	};
	return i$3.current ? t$2(r$7, a$2.deps) || (a$2.deps = r$7, a$2.value = n$10()) : i$3.current = a$2, a$2.value;
}
function r$1(e$8, t$10) {
	return n$2(() => e$8, t$10);
}
...
function c(c$3, l$3) {
	let u$3 = n$2(() => c$3.filter((e$8) => !!e$8), [...c$3]), { id: d$2, dndObserver: f$1,...p$1 } = l$3 || {}, m$1 = n$2(() => d$2 === void 0 ? Symbol() : d$2, [d$2]), h$1 = n$5(), g$1 = f$1 === void 0 ? h$1 : f$1, [_$2, v$2] = (0, import_react.useState)(null), y$1 = (0, import_react.useRef)(null), b$1 = (0, import_react.useRef)(u$3);
	b$1.current = u$3;
	...
	let C$1 = (0, import_react.useRef)(void 0), w$1 = r$1(() => {
		...
		w$1();
		let t$10 = new B(b$1.current, {
			id: e$8,
			...x$1.current
		});
		y$1.current = t$10, C$1.current = x$1.current, v$2(t$10);
	}, [w$1]);
	return n$1(() => {
		...
		if (!_$2) return;
		let e$8 = x$1.current;
		C$1.current !== e$8 && (n$6(C$1.current, e$8) || (_$2.updateSettings(_$2._parseSettings(e$8)), C$1.current && e$8.dndGroups !== C$1.current.dndGroups && S$1.current?.clearTargets(_$2)), C$1.current = e$8);
	}, [_$2, l$3]), n$1(() => w$1, [w$1]), _$2;
}

//#endregion
//#region ../dragdoll-react/dist/use-draggable-callback-Cd1g8lnj.js
function n$4(n$10, r$7, i$3) {
	let a$2 = !!i$3, o$3 = (0, import_react.useRef)(i$3);
	o$3.current = i$3, n$1(() => {
		if (!n$10 || !a$2) return;
		let e$8 = n$10.on(r$7, ((...e$9) => {
			o$3.current?.(...e$9);
		}));
		return () => void n$10.off(r$7, e$8);
	}, [
		n$10,
		r$7,
		a$2
...
function r(r$7, i$3 = !1) {
	let [a$2, o$3] = (0, import_react.useState)(r$7?.drag || null), s$4 = (0, import_react.useState)(void 0)[1];
	return n$4(r$7, R.Start, (e$8) => {
		o$3(e$8);
	}), n$4(r$7, R.Move, () => {
		i$3 && s$4(Symbol());
	}), n$4(r$7, R.End, () => {
...
//#endregion
//#region ../dragdoll-react/dist/use-keyboard-sensor-XD_9uHz1.js
function s(s$4, c$3) {
	let [l$3, u$3] = (0, import_react.useState)(null), d$2 = (0, import_react.useRef)(l$3), f$1 = (0, import_react.useRef)(s$4);
	f$1.current = s$4;
	let p$1 = r$1((e$8) => {
		let t$10 = d$2.current;
		if (t$10) {
			t$10.updateElement(e$8);
			return;
		}
		let n$10 = new r$4(e$8, f$1.current);
		d$2.current = n$10, u$3(n$10);
	}, []), m$1 = r$1(() => {
		let e$8 = d$2.current;
		e$8 && (e$8.destroy(), d$2.current = null, u$3(null));
	}, []), h$1 = r$1((e$8) => {
		if (c$3 === void 0) {
			if (e$8 === null) {
				m$1();
	...
	return n$1(() => {
		...
		if (l$3) {
			let { moveDistance: e$8 = n$3.moveDistance, cancelOnBlur: t$10 = n$3.cancelOnBlur, cancelOnVisibilityChange: n$10 = n$3.cancelOnVisibilityChange, startPredicate: r$7 = n$3.startPredicate, movePredicate: i$3 = n$3.movePredicate, cancelPredicate: a$2 = n$3.cancelPredicate, endPredicate: c$4 = n$3.endPredicate } = s$4 || {};
			l$3.updateSettings({
				moveDistance: e$8,
				cancelOnBlur: t$10,
				cancelOnVisibilityChange: n$10,
				startPredicate: r$7,
				movePredicate: i$3,
				cancelPredicate: a$2,
				endPredicate: c$4
...
function s$1(s$4, c$3) {
	...
	let p$1 = r$1((e$8) => {
		...
		let n$10 = new d(e$8, f$1.current);
		d$2.current = n$10, u$3(n$10);
	}, []), m$1 = r$1(() => {
		let e$8 = d$2.current;
		e$8 && (e$8.destroy(), d$2.current = null, u$3(null));
	...
	return n$1(() => {
		...
		if (l$3) {
			let { listenerOptions: e$8 = u.listenerOptions, sourceEvents: t$10 = u.sourceEvents, startPredicate: n$10 = u.startPredicate } = s$4 || {};
			l$3.updateSettings({
				listenerOptions: e$8,
				sourceEvents: t$10,
				startPredicate: n$10
...
var require_scheduler_development = /* @__PURE__ */ __commonJS({ "../../node_modules/scheduler/cjs/scheduler.development.js": ((exports) => {
	(function() {
		...
		function compare(a$2, b$1) {
			var diff = a$2.sortIndex - b$1.sortIndex;
			return 0 !== diff ? diff : a$2.id - b$1.id;
		}
...
var require_react_dom_development = /* @__PURE__ */ __commonJS({ "../../node_modules/react-dom/cjs/react-dom.development.js": ((exports) => {
	(function() {
		...
		exports.unstable_batchedUpdates = function(fn, a$2) {
			return fn(a$2);
		};
	...
	(function() {
		...
		function copyWithRename(obj, oldPath, newPath) {
			if (oldPath.length !== newPath.length) console.warn("copyWithRename() expects paths of the same length");
				...
				for (var i$3 = 0; i$3 < newPath.length - 1; i$3++) if (oldPath[i$3] !== newPath[i$3]) {
		...
		function findCurrentFiberUsingSlowPath(fiber) {
			...
			for (var a$2 = fiber, b$1 = alternate;;) {
				var parentA = a$2.return;
				...
				if (parentA.child === parentB.child) {
					for (parentB = parentA.child; parentB;) {
						if (parentB === a$2) return assertIsMounted(parentA), fiber;
						if (parentB === b$1) return assertIsMounted(parentA), alternate;
						parentB = parentB.sibling;
					}
					throw Error("Unable to find node on an unmounted component.");
				}
				if (a$2.return !== b$1.return) a$2 = parentA, b$1 = parentB;
				else {
				...
				if (a$2.alternate !== b$1) throw Error("Return fibers should always be each others' alternates. This error is likely caused by a bug in React. Please file an issue.");
			}
			if (3 !== a$2.tag) throw Error("Unable to find node on an unmounted component.");
			return a$2.stateNode.current === a$2 ? fiber : alternate;
		}
		...
		function getComponentNameFromFiber(fiber) {
			...
			switch (fiber.tag) {
				...
				case 29:
					...
					if (null != type) {
						for (var i$3 = type.length - 1; 0 <= i$3; i$3--) if ("string" === typeof type[i$3].name) return type[i$3].name;
					}
		...
		function requiredContext(c$3) {
			null === c$3 && console.error("Expected host context to exist. This error is likely caused by a bug in React. Please file an issue.");
			return c$3;
		}
		...
		function getStackByFiberInDevAndProd(workInProgress$1) {
			try {
				...
				do {
					...
					if (debugInfo) for (var i$3 = debugInfo.length - 1; 0 <= i$3; i$3--) {
						var entry = debugInfo[i$3];
		...
		function createLaneMap(initial) {
			for (var laneMap = [], i$3 = 0; 31 > i$3; i$3++) laneMap.push(initial);
			return laneMap;
		}
		...
		function updateOptions(node, multiple, propValue, setDefaultSelected) {
			...
			if (multiple) {
				multiple = {};
				for (var i$3 = 0; i$3 < propValue.length; i$3++) multiple["$" + propValue[i$3]] = !0;
				for (propValue = 0; propValue < node.length; propValue++) i$3 = multiple.hasOwnProperty("$" + node[propValue].value), node[propValue].selected !== i$3 && (node[propValue].selected = i$3), i$3 && setDefaultSelected && (node[propValue].defaultSelected = !0);
			} else {
				propValue = "" + getToStringValue(propValue);
				multiple = null;
				for (i$3 = 0; i$3 < node.length; i$3++) {
					if (node[i$3].value === propValue) {
						node[i$3].selected = !0;
						setDefaultSelected && (node[i$3].defaultSelected = !0);
						return;
					}
					null !== multiple || node[i$3].disabled || (multiple = node[i$3]);
				}
		...
		function describeNode(node, indent) {
			...
			if (debugInfo) for (var i$3 = 0; i$3 < debugInfo.length; i$3++) {
				var serverComponentName = debugInfo[i$3].name;
				"string" === typeof serverComponentName && (skipToNode += indentation(indent) + "<" + serverComponentName + ">\n", indent++);
			}
			debugInfo = "";
			i$3 = node.fiber.pendingProps;
			if (6 === node.fiber.tag) debugInfo = describeTextDiff(i$3, node.serverProps, indent), indent++;
				...
				for (propName in i$3) if (i$3.hasOwnProperty(propName) && "children" !== propName) {
					var propValue = describePropValue(i$3[propName], 15);
				...
				indent++;
			} else null === node.serverProps ? (debugInfo = describeExpandedElement(serverComponentName, i$3, added(indent)), indent++) : "string" === typeof node.serverProps ? console.error("Should not have matched a non HostText fiber to a Text node. This is a bug in React.") : (debugInfo = describeElementDiff(serverComponentName, i$3, node.serverProps, indent), indent++);
			var propName = "";
			i$3 = node.fiber.child;
			for (serverComponentName = 0; i$3 && serverComponentName < node.children.length;) maxLength = node.children[serverComponentName], maxLength.fiber === i$3 ? (propName += describeNode(maxLength, indent), serverComponentName++) : propName += describeSiblingFiber(i$3, indent), i$3 = i$3.sibling;
			i$3 && 0 < node.children.length && (propName += indentation(indent) + "...\n");
			i$3 = node.serverTail;
			null === node.serverProps && indent--;
			for (node = 0; node < i$3.length; node++) serverComponentName = i$3[node], propName = "string" === typeof serverComponentName ? propName + (removed(indent) + describeTextNode(serverComponentName, 120 - 2 * indent) + "\n") : propName + describeExpandedElement(serverComponentName.type, serverComponentName.props, removed(indent));
		...
		function setValueForStyles(node, styles, prevStyles) {
			...
			if (null != prevStyles) {
				if (styles) {
					var expandedUpdates = {};
					if (prevStyles) {
						for (var key in prevStyles) if (prevStyles.hasOwnProperty(key) && !styles.hasOwnProperty(key)) for (var longhands = shorthandToLonghand[key] || [key], i$3 = 0; i$3 < longhands.length; i$3++) expandedUpdates[longhands[i$3]] = key;
					}
					...
					key$jscomp$0 = {};
					for (var _key2 in expandedUpdates) if (key = expandedUpdates[_key2], (longhands = _key[_key2]) && key !== longhands && (i$3 = key + "," + longhands, !key$jscomp$0[i$3])) {
						key$jscomp$0[i$3] = !0;
						i$3 = console;
						var value = styles[key];
						i$3.error.call(i$3, "%s a style property during rerender (%s) when a conflicting property is set (%s) can lead to styling bugs. To avoid this, don't mix shorthand and non-shorthand properties for the same value; instead, replace the shorthand with separate values.", null == value || "boolean" === typeof value || "" === value ? "Removing" : "Updating", key, longhands);
					}
				}
		...
		function batchedUpdates$1(fn, a$2, b$1) {
			if (isInsideEventHandler) return fn(a$2, b$1);
			isInsideEventHandler = !0;
			try {
				return fn(a$2);
			} finally {
				if (isInsideEventHandler = !1, null !== restoreTarget || null !== restoreQueue) {
					if (flushSyncWork$1(), restoreTarget && (a$2 = restoreTarget, fn = restoreQueue, restoreQueue = restoreTarget = null, restoreStateOfTarget(a$2), fn)) for (a$2 = 0; a$2 < fn.length; a$2++) restoreStateOfTarget(fn[a$2]);
				}
			}
		}
		...
		function getArrayKind(array) {
			for (var kind = EMPTY_ARRAY, i$3 = 0; i$3 < array.length; i$3++) {
				var value = array[i$3];
		...
		function logComponentErrored(fiber, startTime, endTime, errors) {
			if (supportsUserTiming) {
				var name = getComponentNameFromFiber(fiber);
				if (null !== name) {
					for (var debugTask = null, properties = [], i$3 = 0; i$3 < errors.length; i$3++) {
						var capturedValue = errors[i$3];
		...
		function logRecoveredRenderPhase(startTime, endTime, lanes, recoverableErrors, hydrationFailed, debugTask) {
			if (supportsUserTiming && !(endTime <= startTime)) {
				lanes = [];
				for (var i$3 = 0; i$3 < recoverableErrors.length; i$3++) {
					var error = recoverableErrors[i$3].value;
		...
		function logCommitErrored(startTime, endTime, errors, passive, debugTask) {
			if (supportsUserTiming && !(endTime <= startTime)) {
				for (var properties = [], i$3 = 0; i$3 < errors.length; i$3++) {
					var error = errors[i$3].value;
		...
		function finishQueueingConcurrentUpdates() {
			for (var endIndex = concurrentQueuesIndex, i$3 = concurrentlyUpdatedLanes = concurrentQueuesIndex = 0; i$3 < endIndex;) {
				var fiber = concurrentQueues[i$3];
				concurrentQueues[i$3++] = null;
				var queue = concurrentQueues[i$3];
				concurrentQueues[i$3++] = null;
				var update = concurrentQueues[i$3];
				concurrentQueues[i$3++] = null;
				var lane = concurrentQueues[i$3];
				concurrentQueues[i$3++] = null;
			...
			for (; null !== fiber;) {
				...
				if (null !== list) {
					...
					a: for (; null !== list;) {
						var dependency = list;
						list = fiber;
						for (var i$3 = 0; i$3 < contexts.length; i$3++) if (dependency.context === contexts[i$3]) {
		...
		function pingEngtangledActionScope() {
			if (0 === --currentEntangledPendingCount && (-1 < transitionUpdateTime || (transitionStartTime = -1.1), null !== currentEntangledListeners)) {
				...
				for (var i$3 = 0; i$3 < listeners.length; i$3++) (0, listeners[i$3])();
			}
		}
		function chainThenableValue(thenable, result) {
			...
			thenable.then(function() {
				...
				for (var i$3 = 0; i$3 < listeners.length; i$3++) (0, listeners[i$3])(result);
			}, function(error) {
		...
		function getCurrentDebugTask() {
			...
			if (null != debugInfo) {
				for (var i$3 = debugInfo.length - 1; 0 <= i$3; i$3--) if (null != debugInfo[i$3].name) {
					var debugTask = debugInfo[i$3].debugTask;
		...
		function validateFragmentProps(element, fiber, returnFiber) {
			for (var keys = Object.keys(element.props), i$3 = 0; i$3 < keys.length; i$3++) {
				var key = keys[i$3];
		...
		function createChildReconciler(shouldTrackSideEffects) {
			...
			return function(returnFiber, currentFirstChild, newChild, lanes) {
				...
				try {
					...
					if (null != debugInfo) {
						for (var i$3 = debugInfo.length - 1; 0 <= i$3; i$3--) if ("string" === typeof debugInfo[i$3].stack) {
							fiber._debugOwner = debugInfo[i$3];
							fiber._debugTask = debugInfo[i$3].debugTask;
							break;
						}
					}
					return fiber;
		...
		function updateHookTypesDev() {
			...
			if (null !== hookTypesDev && (hookTypesUpdateIndexDev++, hookTypesDev[hookTypesUpdateIndexDev] !== hookName)) {
				...
				if (!didWarnAboutMismatchedHooksForComponent.has(componentName$1) && (didWarnAboutMismatchedHooksForComponent.add(componentName$1), null !== hookTypesDev)) {
					for (var table = "", i$3 = 0; i$3 <= hookTypesUpdateIndexDev; i$3++) {
						var oldHookName = hookTypesDev[i$3], newHookName = i$3 === hookTypesUpdateIndexDev ? hookName : oldHookName;
						for (oldHookName = i$3 + 1 + ". " + oldHookName; 30 > oldHookName.length;) oldHookName += " ";
		...
		function areHookInputsEqual(nextDeps, prevDeps) {
			...
			for (var i$3 = 0; i$3 < prevDeps.length && i$3 < nextDeps.length; i$3++) if (!objectIs(nextDeps[i$3], prevDeps[i$3])) return !1;
			return !0;
		}
		...
		function notifyActionListeners(actionNode) {
			...
			for (var i$3 = 0; i$3 < actionNode.length; i$3++) (0, actionNode[i$3])();
		}
				...
				if (null !== lastEffect) {
					...
					do {
						if ((updateQueue.tag & flags) === flags && (lastEffect = void 0, (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !0), lastEffect = runWithFiberInDEV(finishedWork, callCreateInDEV, updateQueue), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !1), void 0 !== lastEffect && "function" !== typeof lastEffect)) {
							...
							runWithFiberInDEV(finishedWork, function(n$10, a$2) {
								console.error("%s must not return anything besides a function, which is used for clean-up.%s", n$10, a$2);
							}, hookName, addendum);
						}
		...
		function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber) {
			...
			if (null !== deletions) for (var i$3 = 0; i$3 < deletions.length; i$3++) {
				var root$1 = root$jscomp$0, returnFiber = parentFiber, deletedFiber = deletions[i$3], prevEffectStart = pushComponentEffectStart(), parent = returnFiber;
				a: for (; null !== parent;) {
					switch (parent.tag) {
						case 27:
								...
								b: switch (flags) {
									...
									case "meta":
										if (maybeNodes = getHydratableHoistableCache("meta", "content", existingHiddenCallbacks).get(flags + (current$1.content || ""))) {
											for (i$3 = 0; i$3 < maybeNodes.length; i$3++) if (currentResource = maybeNodes[i$3], checkAttributeStringCoercion(current$1.content, "content"), currentResource.getAttribute("content") === (null == current$1.content ? null : "" + current$1.content) && currentResource.getAttribute("name") === (null == current$1.name ? null : current$1.name) && currentResource.getAttribute("property") === (null == current$1.property ? null : current$1.property) && currentResource.getAttribute("http-equiv") === (null == current$1.httpEquiv ? null : current$1.httpEquiv) && currentResource.getAttribute("charset") === (null == current$1.charSet ? null : current$1.charSet)) {
												maybeNodes.splice(i$3, 1);
												break b;
											}
										}
					...
					if (flags & 8192) a: for (root$1 = finishedWork.stateNode, root$1._visibility = existingHiddenCallbacks ? root$1._visibility & ~OffscreenVisible : root$1._visibility | OffscreenVisible, !existingHiddenCallbacks || null === current$1 || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || (recursivelyTraverseDisappearLayoutEffects(finishedWork), (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentTrigger(finishedWork, componentEffectStartTime, componentEffectEndTime, "Disconnect")), current$1 = null, root$1 = finishedWork;;) {
						if (5 === root$1.tag || 26 === root$1.tag) {
							...
							if (null === current$1) {
								wasHidden = root$1;
								try {
									i$3 = wasHidden.stateNode, existingHiddenCallbacks ? runWithFiberInDEV(wasHidden, hideDehydratedBoundary, i$3) : runWithFiberInDEV(wasHidden, unhideDehydratedBoundary, wasHidden.stateNode);
								} catch (error) {
									captureCommitPhaseError(wasHidden, wasHidden.return, error);
								}
							}
		...
		function recursivelyTraversePassiveUnmountEffects(parentFiber) {
			...
			if (0 !== (parentFiber.flags & 16)) {
				if (null !== deletions) for (var i$3 = 0; i$3 < deletions.length; i$3++) {
					var childToDelete = deletions[i$3], prevEffectStart = pushComponentEffectStart();
		...
		function isRenderConsistentWithExternalStores(finishedWork) {
			for (var node = finishedWork;;) {
				var tag = node.tag;
				if ((0 === tag || 11 === tag || 15 === tag) && node.flags & 16384 && (tag = node.updateQueue, null !== tag && (tag = tag.stores, null !== tag))) for (var i$3 = 0; i$3 < tag.length; i$3++) {
					var check = tag[i$3], getSnapshot = check.getSnapshot;
					check = check.value;
					try {
		...
		function processDispatchQueue(dispatchQueue, eventSystemFlags) {
			...
			for (var i$3 = 0; i$3 < dispatchQueue.length; i$3++) {
				var _dispatchQueue$i = dispatchQueue[i$3];
				a: {
		...
		function getStylesObjectFromElement(domElement) {
			...
			for (var i$3 = 0; i$3 < domElement.length; i$3++) {
				var styleName = domElement[i$3];
		...
		function diffHydratedProperties(domElement, tag, props, hostContext) {
			for (var serverDifferences = {}, extraAttributes = /* @__PURE__ */ new Set(), attributes = domElement.attributes, i$3 = 0; i$3 < attributes.length; i$3++) switch (attributes[i$3].name.toLowerCase()) {
				case "value": break;
				case "checked": break;
				case "selected": break;
				default: extraAttributes.add(attributes[i$3].name);
			}
				...
				if (registrationNameDependencies.hasOwnProperty(value)) "function" !== typeof propKey && warnForInvalidEventListener(value, propKey);
					...
					case "download":
						a: {
							...
							extraAttributes.delete(attributeName);
							i$3 = i$3.getAttribute(attributeName);
							if (null === i$3) switch (typeof propKey) {
								case "undefined":
								case "function":
								case "symbol": break a;
								...
								case "symbol": break;
								case "boolean":
									if (!0 === propKey && "" === i$3) break a;
									break;
								default: if (checkAttributeStringCoercion(propKey, attributes), i$3 === "" + propKey) break a;
							}
							warnForPropDifference(attributes, i$3, propKey, serverDifferences$jscomp$0);
						}
						continue;
					case "cols":
					case "rows":
					...
					case "span":
						a: {
							...
							if (null === i$3) switch (typeof propKey) {
								...
								case "symbol":
								case "boolean": break;
								default: if (!(isNaN(propKey) || 1 > propKey) && (checkAttributeStringCoercion(propKey, attributes), i$3 === "" + propKey)) break a;
							}
							warnForPropDifference(attributes, i$3, propKey, serverDifferences$jscomp$0);
						}
						continue;
					...
					default: if (!(2 < value.length) || "o" !== value[0] && "O" !== value[0] || "n" !== value[1] && "N" !== value[1]) {
						i$3 = getAttributeAlias(value);
						attributes = !1;
						hostContext.context === HostContextNamespaceNone && "svg" !== tag && "math" !== tag ? extraAttributes.delete(i$3.toLowerCase()) : (attributeName = value.toLowerCase(), attributeName = possibleStandardNames.hasOwnProperty(attributeName) ? possibleStandardNames[attributeName] || null : null, null !== attributeName && attributeName !== value && (attributes = !0, extraAttributes.delete(attributeName)), extraAttributes.delete(i$3));
						a: if (attributeName = domElement, serverDifferences$jscomp$0 = i$3, i$3 = propKey, isAttributeNameSafe(serverDifferences$jscomp$0)) if (attributeName.hasAttribute(serverDifferences$jscomp$0)) attributeName = attributeName.getAttribute(serverDifferences$jscomp$0), checkAttributeStringCoercion(i$3, serverDifferences$jscomp$0), i$3 = attributeName === "" + i$3 ? i$3 : attributeName;
						else {
							switch (typeof i$3) {
								case "function":
								case "symbol": break a;
							...
							i$3 = void 0 === i$3 ? void 0 : null;
						}
						else i$3 = void 0;
						attributes || warnForPropDifference(value, i$3, propKey, serverDifferences);
					}
				}
			}
		...
		function estimateBandwidth() {
			if ("function" === typeof performance.getEntriesByType) {
				for (var count = 0, bits = 0, resourceEntries = performance.getEntriesByType("resource"), i$3 = 0; i$3 < resourceEntries.length; i$3++) {
					var entry = resourceEntries[i$3], transferSize = entry.transferSize, initiatorType = entry.initiatorType, duration = entry.duration;
					if (transferSize && duration && isLikelyStaticResource(initiatorType)) {
						initiatorType = 0;
						duration = entry.responseEnd;
						for (i$3 += 1; i$3 < resourceEntries.length; i$3++) {
							var overlapEntry = resourceEntries[i$3], overlapStartTime = overlapEntry.startTime;
		...
		function describeHydratableInstanceForDevWarnings(instance) {
			if (1 === instance.nodeType) {
				for (var JSCompiler_temp_const = instance.nodeName.toLowerCase(), serverDifferences = {}, attributes = instance.attributes, i$3 = 0; i$3 < attributes.length; i$3++) {
					var attr = attributes[i$3];
		...
		function insertStylesheet(instance, precedence, root$1) {
			for (var nodes = root$1.querySelectorAll("link[rel=\"stylesheet\"][data-precedence],style[data-precedence]"), last = nodes.length ? nodes[nodes.length - 1] : null, prior = last, i$3 = 0; i$3 < nodes.length; i$3++) {
				var node = nodes[i$3];
		...
		function insertStylesheetIntoRoot(root$1, resource) {
			if (!(resource.state.loading & Inserted)) {
				...
				if (precedences) var last = precedences.get(LAST_PRECEDENCE);
					...
					for (var nodes = root$1.querySelectorAll("link[data-precedence],style[data-precedence]"), i$3 = 0; i$3 < nodes.length; i$3++) {
						var node = nodes[i$3];
				...
				i$3 = precedences.get(node) || last;
				i$3 === last && precedences.set(LAST_PRECEDENCE, nodes);
				precedences.set(node, nodes);
				this.count++;
				last = onUnsuspend.bind(this);
				nodes.addEventListener("load", last);
				nodes.addEventListener("error", last);
				i$3 ? i$3.parentNode.insertBefore(nodes, i$3.nextSibling) : (root$1 = 9 === root$1.nodeType ? root$1.head : root$1, root$1.insertBefore(nodes, root$1.firstChild));
				resource.state.loading |= Inserted;
			}
		}
		...
		function markRetryLaneImpl(fiber, retryLane) {
			...
			if (null !== fiber && null !== fiber.dehydrated) {
				var a$2 = fiber.retryLane;
				fiber.retryLane = 0 !== a$2 && a$2 < retryLane ? a$2 : retryLane;
			}
		}
		...
		function scheduleReplayQueueIfNeeded(formReplayingQueue) {
			lastScheduledReplayQueue !== formReplayingQueue && (lastScheduledReplayQueue = formReplayingQueue, Scheduler.unstable_scheduleCallback(Scheduler.unstable_NormalPriority, function() {
				...
				for (var i$3 = 0; i$3 < formReplayingQueue.length; i$3 += 3) {
					var form = formReplayingQueue[i$3], submitterOrAction = formReplayingQueue[i$3 + 1], formData = formReplayingQueue[i$3 + 2];
					if ("function" !== typeof submitterOrAction) if (null === findInstanceBlockingTarget(submitterOrAction || form)) continue;
					else break;
					var formInst = getInstanceFromNode(form);
					null !== formInst && (formReplayingQueue.splice(i$3, 3), i$3 -= 3, form = {
						pending: !0,
						data: formData,
						method: form.method,
		...
		function retryIfBlockedOn(unblocked) {
			...
			for (var i$3 = 0; i$3 < queuedExplicitHydrationTargets.length; i$3++) {
				var queuedTarget = queuedExplicitHydrationTargets[i$3];
				queuedTarget.blockedOn === unblocked && (queuedTarget.blockedOn = null);
			}
			for (; 0 < queuedExplicitHydrationTargets.length && (i$3 = queuedExplicitHydrationTargets[0], null === i$3.blockedOn);) attemptExplicitHydrationTarget(i$3), null === i$3.blockedOn && queuedExplicitHydrationTargets.shift();
			i$3 = (unblocked.ownerDocument || unblocked).$$reactFormReplay;
			if (null != i$3) for (queuedTarget = 0; queuedTarget < i$3.length; queuedTarget += 3) {
				var form = i$3[queuedTarget], submitterOrAction = i$3[queuedTarget + 1], formProps = form[internalPropsKey] || null;
				if ("function" === typeof submitterOrAction) formProps || scheduleReplayQueueIfNeeded(i$3);
				else if (formProps) {
					var action = null;
					...
					"function" === typeof action ? i$3[queuedTarget + 1] = action : (i$3.splice(queuedTarget, 3), queuedTarget -= 3);
					scheduleReplayQueueIfNeeded(i$3);
				}
			}
		}
		...
		(function() {
			for (var i$3 = 0; i$3 < simpleEventPluginEvents.length; i$3++) {
				var eventName = simpleEventPluginEvents[i$3], domEventName = eventName.toLowerCase();
		...
		ReactDOMHydrationRoot.prototype.unstable_scheduleHydration = function(target) {
			if (target) {
				...
				for (var i$3 = 0; i$3 < queuedExplicitHydrationTargets.length && 0 !== updatePriority && updatePriority < queuedExplicitHydrationTargets[i$3].priority; i$3++);
				queuedExplicitHydrationTargets.splice(i$3, 0, target);
				0 === i$3 && attemptExplicitHydrationTarget(target);
			}
		};
		(function() {
...
//#endregion
//#region react-examples/005-draggable-snap-to-grid/index.tsx
...
const DraggableCardMemo = (0, import_react.memo)(function DraggableCard() {
	...
	const [keyboardSensor, setKeyboardSensorRef] = s({ moveDistance: {
		x: GRID_WIDTH,
		y: GRID_HEIGHT
	} });
