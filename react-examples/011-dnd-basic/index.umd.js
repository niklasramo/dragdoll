...
var __copyProps = (to, from, except, desc) => {
	if (from && typeof from === "object" || typeof from === "function") for (var keys = __getOwnPropNames(from), i$7 = 0, n$14 = keys.length, key; i$7 < n$14; i$7++) {
		key = keys[i$7];
...
function r$7(r$10, i$7, a$6) {
	let o$3 = n$6(), s$5 = a$6 === void 0 ? o$3 : a$6, c$5 = !!i$7, l$5 = (0, import_react.useRef)(i$7);
	l$5.current = i$7, n(() => {
		if (!s$5 || !c$5) return;
		let e$8 = s$5.on(r$10, ((...e$9) => {
			l$5.current?.(...e$9);
		}));
		return () => void s$5.off(r$10, e$8);
	}, [
		r$10,
		s$5,
		c$5
...
var E$1 = {
	...
	constructor(t$11 = {}) {
		this.dedupe = t$11.dedupe || E$1.ADD, this.getId = t$11.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
	}
	_getListeners(t$11) {
		let n$14 = this._events.get(t$11);
		return n$14 ? n$14.l || (n$14.l = [...n$14.m.values()]) : null;
	}
	on(t$11, n$14, e$8) {
		let i$7 = this._events, s$5 = i$7.get(t$11);
		s$5 || (s$5 = {
			m: /* @__PURE__ */ new Map(),
			l: null
		}, i$7.set(t$11, s$5));
		let o$3 = s$5.m;
		if (e$8 = e$8 === r$9 ? this.getId(n$14) : e$8, o$3.has(e$8)) switch (this.dedupe) {
			case E$1.THROW: throw new Error("Eventti: duplicate listener id!");
			case E$1.IGNORE: return e$8;
			case E$1.UPDATE:
				s$5.l = null;
				break;
			default: o$3.delete(e$8), s$5.l = null;
		}
		return o$3.set(e$8, n$14), s$5.l?.push(n$14), e$8;
	}
	once(t$11, n$14, e$8) {
		let i$7 = 0;
		return e$8 = e$8 === r$9 ? this.getId(n$14) : e$8, this.on(t$11, (...s$5) => {
			i$7 || (i$7 = 1, this.off(t$11, e$8), n$14(...s$5));
		}, e$8);
	}
	off(t$11, n$14) {
		if (t$11 === r$9) {
		...
		if (n$14 === r$9) {
			this._events.delete(t$11);
			return;
		}
		let e$8 = this._events.get(t$11);
		e$8?.m.delete(n$14) && (e$8.l = null, e$8.m.size || this._events.delete(t$11));
	}
	emit(t$11, ...n$14) {
		let e$8 = this._getListeners(t$11);
		if (e$8) {
			let i$7 = e$8.length, s$5 = 0;
			if (n$14.length) for (; s$5 < i$7; s$5++) e$8[s$5](...n$14);
			else for (; s$5 < i$7; s$5++) e$8[s$5]();
		}
	}
	listenerCount(t$11) {
		if (t$11 === r$9) {
			let n$14 = 0;
			return this._events.forEach((e$8) => {
				n$14 += e$8.m.size;
			}), n$14;
		}
		return this._events.get(t$11)?.m.size || 0;
	}
};
...
var _$1 = E$1, o$2 = class {
	constructor(e$8 = {}) {
		let { phases: t$11 = [], dedupe: r$10, getId: s$5 } = e$8;
		this._phases = t$11, this._emitter = new v({
			getId: s$5,
			dedupe: r$10
	...
	on(e$8, t$11, r$10) {
		return this._emitter.on(e$8, t$11, r$10);
	}
	once(e$8, t$11, r$10) {
		return this._emitter.once(e$8, t$11, r$10);
	}
	off(e$8, t$11) {
		return this._emitter.off(e$8, t$11);
	}
	count(e$8) {
	...
	_fillQueue() {
		let e$8 = this._queue, t$11 = this._phases, r$10 = this._getListeners, s$5 = 0, a$6 = t$11.length, n$14;
		for (; s$5 < a$6; s$5++) n$14 = r$10(t$11[s$5]), n$14 && e$8.push(n$14);
		return e$8;
	}
	_processQueue(...e$8) {
		let t$11 = this._queue, r$10 = t$11.length;
		if (!r$10) return;
		let s$5 = 0, a$6 = 0, n$14, c$5;
		for (; s$5 < r$10; s$5++) for (n$14 = t$11[s$5], a$6 = 0, c$5 = n$14.length; a$6 < c$5; a$6++) n$14[a$6](...e$8);
		t$11.length = 0;
	}
};
function u$3(i$7 = 60) {
	if (typeof requestAnimationFrame == "function" && typeof cancelAnimationFrame == "function") return (e$8) => {
		let t$11 = requestAnimationFrame(e$8);
		return () => cancelAnimationFrame(t$11);
	};
	{
		let e$8 = 1e3 / i$7, t$11 = typeof performance > "u" ? () => Date.now() : () => performance.now();
		return (r$10) => {
			let s$5 = setTimeout(() => r$10(t$11()), e$8);
			return () => clearTimeout(s$5);
		};
	}
}
var l$4 = class extends o$2 {
	constructor(e$8 = {}) {
		let { paused: t$11 = !1, onDemand: r$10 = !1, requestFrame: s$5 = u$3(),...a$6 } = e$8;
		super(a$6), this._paused = t$11, this._onDemand = r$10, this._requestFrame = s$5, this._cancelFrame = null, this._empty = !0, !t$11 && !r$10 && this._request();
	}
	get phases() {
		return this._phases;
	}
	set phases(e$8) {
		this._phases = e$8, e$8.length ? (this._empty = !1, this._request()) : this._empty = !0;
	}
	get paused() {
		return this._paused;
	}
	...
	set requestFrame(e$8) {
		this._requestFrame !== e$8 && (this._requestFrame = e$8, this._cancelFrame && (this._cancel(), this._request()));
	}
	tick(...e$8) {
	...
	on(e$8, t$11, r$10) {
		let s$5 = super.on(e$8, t$11, r$10);
		return this._empty = !1, this._request(), s$5;
	}
	once(e$8, t$11, r$10) {
		let s$5 = super.once(e$8, t$11, r$10);
		return this._empty = !1, this._request(), s$5;
	}
	_request() {
...
function e$5(e$8, t$11, n$14 = {
	width: 0,
	height: 0,
	x: 0,
	y: 0
}) {
	let r$10 = Math.max(e$8.x, t$11.x), i$7 = Math.min(e$8.x + e$8.width, t$11.x + t$11.width);
	if (i$7 <= r$10) return null;
	let a$6 = Math.max(e$8.y, t$11.y), o$3 = Math.min(e$8.y + e$8.height, t$11.y + t$11.height);
	return o$3 <= a$6 ? null : (n$14.x = r$10, n$14.y = a$6, n$14.width = i$7 - r$10, n$14.height = o$3 - a$6, n$14);
}
const t$8 = {
	width: 0,
	height: 0,
...
function n$11(n$14, r$10, i$7) {
	if (i$7 ||= e$5(n$14, r$10, t$8), !i$7) return 0;
	let a$6 = i$7.width * i$7.height;
	return a$6 ? a$6 / (Math.min(n$14.width, r$10.width) * Math.min(n$14.height, r$10.height)) * 100 : 0;
}

//#endregion
//#region ../dragdoll/dist/collision-detector-DevU0v1G.js
function n$12(e$8, t$11 = {
	width: 0,
	height: 0,
	x: 0,
	y: 0
}) {
	return e$8 && (t$11.width = e$8.width, t$11.height = e$8.height, t$11.x = e$8.x, t$11.y = e$8.y), t$11;
}
var r$8 = class {
	_items;
	_index;
	_initItem;
	constructor(e$8) {
		this._items = [], this._index = 0, this._initItem = e$8;
	}
	allocate(...e$8) {
		let t$11 = this._index, n$14 = this._items, r$10 = this._initItem(n$14[t$11], ...e$8);
		return n$14[t$11] = r$10, ++this._index, r$10;
	}
	reset() {
		this._index = 0;
	}
	truncate(e$8 = 0) {
		let t$11 = Math.max(0, Math.min(e$8, this._items.length));
		this._index = Math.min(this._index, t$11), this._items.length = t$11;
	}
};
const i$6 = Symbol();
var a$5 = class {
	...
	_cdArenaMap;
	constructor(e$8) {
		this._listenerId = Symbol(), this._dndObserver = e$8, this._cdArenaPool = [], this._cdArenaMap = /* @__PURE__ */ new Map();
	}
	_checkCollision(r$10, i$7, a$6) {
		let o$3 = r$10.getClientRect(), s$5 = i$7.getClientRect();
		if (!o$3) return null;
		let c$5 = e$5(o$3, s$5, a$6.intersectionRect);
		if (c$5 === null) return null;
		let l$5 = n$11(o$3, s$5, c$5);
		return l$5 <= 0 ? null : (a$6.droppableId = i$7.id, n$12(s$5, a$6.droppableRect), n$12(o$3, a$6.draggableRect), a$6.intersectionScore = l$5, a$6);
	}
	_sortCollisions(e$8, t$11) {
		return t$11.sort((e$9, t$12) => {
			let n$14 = t$12.intersectionScore - e$9.intersectionScore;
			return n$14 === 0 ? e$9.droppableRect.width * e$9.droppableRect.height - t$12.droppableRect.width * t$12.droppableRect.height : n$14;
		});
	}
	_createCollisionData() {
		return {
			...
			droppableRect: n$12(),
			draggableRect: n$12(),
			intersectionRect: n$12(),
			intersectionScore: 0
		};
	}
	_getCollisionDataArena(e$8) {
		let t$11 = this._cdArenaMap.get(e$8);
		return t$11 || (t$11 = this._cdArenaPool.pop() || new r$8((e$9) => e$9 || this._createCollisionData()), this._cdArenaMap.set(e$8, t$11)), t$11;
	}
	_removeCollisionDataArena(e$8) {
		let t$11 = this._cdArenaMap.get(e$8);
		t$11 && (t$11.truncate(20), t$11.reset(), this._cdArenaPool.push(t$11), this._cdArenaMap.delete(e$8));
	}
	detectCollisions(e$8, t$11, n$14) {
		if (n$14.length = 0, !t$11.size) return;
		let r$10 = this._getCollisionDataArena(e$8), i$7 = null, a$6 = t$11.values();
		for (let t$12 of a$6) i$7 ||= r$10.allocate(), this._checkCollision(e$8, t$12, i$7) && (n$14.push(i$7), i$7 = null);
		n$14.length > 1 && this._sortCollisions(e$8, n$14), r$10.reset();
	}
	destroy() {
		this._cdArenaMap.forEach((e$8) => {
			e$8.truncate();
		});
	}
};
...
function t$7(t$11) {
	let n$14 = e$4.get(t$11)?.deref();
	return n$14 || (n$14 = window.getComputedStyle(t$11, null), e$4.set(t$11, new WeakRef(n$14))), n$14;
}

//#endregion
//#region ../dragdoll/dist/constants-CMClRu_c.js
const e$3 = typeof window < `u` && window.document !== void 0, t$1 = e$3 && `ontouchstart` in window, n$2 = e$3 && !!window.PointerEvent;
...
function getStyle(e$8, t$11) {
	if (t$11) return window.getComputedStyle(e$8, t$11);
	let C$1 = STYLE_DECLARATION_CACHE.get(e$8)?.deref();
	return C$1 || (C$1 = window.getComputedStyle(e$8, null), STYLE_DECLARATION_CACHE.set(e$8, new WeakRef(C$1))), C$1;
}
...
const IS_CHROMIUM = (() => {
	try {
		return window.navigator.userAgentData.brands.some((({ brand: n$14 }) => "Chromium" === n$14));
	} catch (n$14) {
		return !1;
	}
})();
...
function isContainingBlockForFixedElement(n$14) {
	const t$11 = getStyle(n$14);
	if (!IS_SAFARI) {
		const { filter: n$15 } = t$11;
		if (n$15 && "none" !== n$15) return !0;
		const { backdropFilter: e$9 } = t$11;
		if (e$9 && "none" !== e$9) return !0;
		const { willChange: i$8 } = t$11;
		if (i$8 && (i$8.indexOf("filter") > -1 || i$8.indexOf("backdrop-filter") > -1)) return !0;
	}
	const e$8 = isBlockElement(n$14);
	if (!e$8) return e$8;
	const { transform: i$7 } = t$11;
	if (i$7 && "none" !== i$7) return !0;
	const { perspective: r$10 } = t$11;
	if (r$10 && "none" !== r$10) return !0;
	const { contentVisibility: o$3 } = t$11;
	if (o$3 && "auto" === o$3) return !0;
	const { contain: f$1 } = t$11;
	if (f$1 && ("strict" === f$1 || "content" === f$1 || f$1.indexOf("paint") > -1 || f$1.indexOf("layout") > -1)) return !0;
	const { willChange: c$5 } = t$11;
...
function isContainingBlockForAbsoluteElement(t$11) {
	return "static" !== getStyle(t$11).position || isContainingBlockForFixedElement(t$11);
}
...
function getContainingBlock(e$8, t$11 = {}) {
	if (isDocumentElement(e$8)) return e$8.ownerDocument.defaultView;
	const n$14 = t$11.position || getStyle(e$8).position, { skipDisplayNone: i$7, container: o$3 } = t$11;
	switch (n$14) {
		case "static":
		case "relative":
		case "sticky":
		case "-webkit-sticky": {
			let t$12 = o$3 || e$8.parentElement;
			for (; t$12;) {
				const e$9 = isBlockElement(t$12);
				if (e$9) return t$12;
				if (null === e$9 && !i$7) return null;
				t$12 = t$12.parentElement;
			}
			return e$8.ownerDocument.documentElement;
		}
		case "absolute":
		case "fixed": {
			const t$12 = "fixed" === n$14;
			let l$5 = o$3 || e$8.parentElement;
			for (; l$5;) {
				const e$9 = t$12 ? isContainingBlockForFixedElement(l$5) : isContainingBlockForAbsoluteElement(l$5);
				if (!0 === e$9) return l$5;
				if (null === e$9 && !i$7) return null;
...
function isWindow(n$14) {
	return n$14 instanceof Window;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getOffsetContainer.js
function getOffsetContainer(n$14, t$11 = {}) {
	const { display: o$3 } = getStyle(n$14);
	if ("none" === o$3 || "contents" === o$3) return null;
	const e$8 = t$11.position || getStyle(n$14).position, { skipDisplayNone: s$5, container: r$10 } = t$11;
	switch (e$8) {
		case "relative": return n$14;
		case "fixed": return getContainingBlock(n$14, {
			container: r$10,
			position: e$8,
			skipDisplayNone: s$5
		});
		case "absolute": {
			const t$12 = getContainingBlock(n$14, {
				container: r$10,
				position: e$8,
				skipDisplayNone: s$5
			});
			return isWindow(t$12) ? n$14.ownerDocument : t$12;
		}
		default: return null;
	}
}
...
function s$4(e$8, t$11) {
	return e$8.isIdentity && t$11.isIdentity ? !0 : e$8.is2D && t$11.is2D ? e$8.a === t$11.a && e$8.b === t$11.b && e$8.c === t$11.c && e$8.d === t$11.d && e$8.e === t$11.e && e$8.f === t$11.f : e$8.m11 === t$11.m11 && e$8.m12 === t$11.m12 && e$8.m13 === t$11.m13 && e$8.m14 === t$11.m14 && e$8.m21 === t$11.m21 && e$8.m22 === t$11.m22 && e$8.m23 === t$11.m23 && e$8.m24 === t$11.m24 && e$8.m31 === t$11.m31 && e$8.m32 === t$11.m32 && e$8.m33 === t$11.m33 && e$8.m34 === t$11.m34 && e$8.m41 === t$11.m41 && e$8.m42 === t$11.m42 && e$8.m43 === t$11.m43 && e$8.m44 === t$11.m44;
}
function c$4(e$8) {
	return e$8.m11 !== 1 || e$8.m12 !== 0 || e$8.m13 !== 0 || e$8.m14 !== 0 || e$8.m21 !== 0 || e$8.m22 !== 1 || e$8.m23 !== 0 || e$8.m24 !== 0 || e$8.m31 !== 0 || e$8.m32 !== 0 || e$8.m33 !== 1 || e$8.m34 !== 0 || e$8.m43 !== 0 || e$8.m44 !== 1;
}
function l$3(e$8, t$11, n$14 = null) {
	if (`moveBefore` in e$8 && e$8.isConnected === t$11.isConnected) try {
		e$8.moveBefore(t$11, n$14);
		return;
	} catch {}
	let r$10 = document.activeElement, i$7 = t$11.contains(r$10);
	e$8.insertBefore(t$11, n$14), i$7 && document.activeElement !== r$10 && r$10 instanceof HTMLElement && r$10.focus({ preventScroll: !0 });
}
function u$2(e$8) {
	return e$8.setMatrixValue(`scale(1, 1)`);
}
function d$1(e$8, t$11 = 0) {
	let n$14 = 10 ** t$11;
	return Math.round((e$8 + 2 ** -52) * n$14) / n$14;
}
var f = class {
	_cache;
	_validation;
	...
	set(e$8, t$11) {
		this._cache.set(e$8, t$11), this._validation.add(e$8);
	}
	get(e$8) {
	...
	constructor(e$8, t$11) {
		this.sensor = e$8, this.startEvent = t$11, this.prevMoveEvent = t$11, this.moveEvent = t$11, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f(), this._clientOffsetCache = new f();
	}
};
function m(e$8, t$11, n$14 = !1) {
	let { style: r$10 } = e$8;
	for (let e$9 in t$11) r$10.setProperty(e$9, t$11[e$9], n$14 ? `important` : ``);
}
function h() {
	let e$8 = document.createElement(`div`);
	return e$8.classList.add(`dragdoll-measure`), m(e$8, {
		display: `block`,
		position: `absolute`,
		inset: `0px`,
		padding: `0px`,
...
function g(e$8, t$11 = {
	...
	if (t$11.x = 0, t$11.y = 0, e$8 instanceof Window) return t$11;
	if (e$8 instanceof Document) return t$11.x = window.scrollX * -1, t$11.y = window.scrollY * -1, t$11;
	let { x: r$10, y: i$7 } = e$8.getBoundingClientRect(), a$6 = t$7(e$8);
	return t$11.x = r$10 + (parseFloat(a$6.borderLeftWidth) || 0), t$11.y = i$7 + (parseFloat(a$6.borderTopWidth) || 0), t$11;
}
function _(e$8) {
	let t$11 = t$7(e$8), r$10 = parseFloat(t$11.height) || 0;
	return t$11.boxSizing === `border-box` ? r$10 : (r$10 += parseFloat(t$11.borderTopWidth) || 0, r$10 += parseFloat(t$11.borderBottomWidth) || 0, r$10 += parseFloat(t$11.paddingTop) || 0, r$10 += parseFloat(t$11.paddingBottom) || 0, e$8 instanceof HTMLElement && (r$10 += e$8.offsetHeight - e$8.clientHeight), r$10);
}
function v$1(e$8) {
	let t$11 = t$7(e$8), r$10 = parseFloat(t$11.width) || 0;
	return t$11.boxSizing === `border-box` ? r$10 : (r$10 += parseFloat(t$11.borderLeftWidth) || 0, r$10 += parseFloat(t$11.borderRightWidth) || 0, r$10 += parseFloat(t$11.paddingLeft) || 0, r$10 += parseFloat(t$11.paddingRight) || 0, e$8 instanceof HTMLElement && (r$10 += e$8.offsetWidth - e$8.clientWidth), r$10);
}
function y(e$8, t$11 = !1) {
	let { translate: r$10, rotate: i$7, scale: a$6, transform: o$3 } = t$7(e$8), s$5 = ``;
	if (r$10 && r$10 !== `none`) {
		let [t$12 = `0px`, n$14 = `0px`, i$8] = r$10.split(` `);
		t$12.includes(`%`) && (t$12 = `${parseFloat(t$12) / 100 * v$1(e$8)}px`), n$14.includes(`%`) && (n$14 = `${parseFloat(n$14) / 100 * _(e$8)}px`), i$8 ? s$5 += `translate3d(${t$12},${n$14},${i$8})` : s$5 += `translate(${t$12},${n$14})`;
	}
	if (i$7 && i$7 !== `none`) {
		let e$9 = i$7.split(` `);
		e$9.length > 1 ? s$5 += `rotate3d(${e$9.join(`,`)})` : s$5 += `rotate(${e$9.join(`,`)})`;
	}
	if (a$6 && a$6 !== `none`) {
		let e$9 = a$6.split(` `);
		e$9.length === 3 ? s$5 += `scale3d(${e$9.join(`,`)})` : s$5 += `scale(${e$9.join(`,`)})`;
	}
	return !t$11 && o$3 && o$3 !== `none` && (s$5 += o$3), s$5;
}
function b(e$8) {
...
function C(e$8, t$11, n$14 = {
	x: 0,
	y: 0
}) {
	let r$10 = b(e$8) ? e$8 : g(e$8, x), i$7 = b(t$11) ? t$11 : g(t$11, S);
	return n$14.x = i$7.x - r$10.x, n$14.y = i$7.y - r$10.y, n$14;
}
function w(e$8) {
	let t$11 = e$8.split(` `), n$14 = ``, r$10 = ``, i$7 = ``;
	return t$11.length === 1 ? n$14 = r$10 = t$11[0] : t$11.length === 2 ? [n$14, r$10] = t$11 : [n$14, r$10, i$7] = t$11, {
		x: parseFloat(n$14) || 0,
		y: parseFloat(r$10) || 0,
		z: parseFloat(i$7) || 0
	};
...
function E(e$8, t$11 = new DOMMatrix()) {
	let r$10 = e$8;
	for (u$2(t$11); r$10;) {
		let e$9 = y(r$10);
		if (e$9 && (T.setMatrixValue(e$9), !T.isIdentity)) {
			let { transformOrigin: e$10 } = t$7(r$10), { x: i$7, y: a$6, z: o$3 } = w(e$10);
			o$3 === 0 ? T.setMatrixValue(`translate(${i$7}px,${a$6}px) ${T} translate(${i$7 * -1}px,${a$6 * -1}px)`) : T.setMatrixValue(`translate3d(${i$7}px,${a$6}px,${o$3}px) ${T} translate3d(${i$7 * -1}px,${a$6 * -1}px,${o$3 * -1}px)`), t$11.preMultiplySelf(T);
		}
		r$10 = r$10.parentElement;
	}
	return t$11;
}
const D = e$3 ? h() : null;
var O = class {
	...
	constructor(e$8, t$11) {
		...
		let i$7 = t$7(e$8), a$6 = e$8.getBoundingClientRect(), s$5 = y(e$8, !0);
		this.data = {}, this.element = e$8, this.elementTransformOrigin = w(i$7.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$5 + i$7.transform), this.elementOffsetMatrix = new DOMMatrix(s$5).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
			...
			x: 0,
			y: 0
		}, this._matrixCache = r$10._matrixCache, this._clientOffsetCache = r$10._clientOffsetCache;
		let c$5 = e$8.parentElement;
		if (!c$5) throw Error(`Dragged element does not have a parent element.`);
		this.elementContainer = c$5;
		let l$5 = t$11.settings.container, u$4 = (typeof l$5 == `function` ? l$5({
			draggable: t$11,
			drag: r$10,
			element: e$8
		}) : l$5) || c$5;
		if (this.dragContainer = u$4, c$5 !== u$4) {
			let { position: e$9 } = i$7;
			if (e$9 !== `fixed` && e$9 !== `absolute`) throw Error(`Dragged element has "${e$9}" position, but only "fixed" or "absolute" are allowed when using a custom drag container.`);
		}
		let d$2 = getOffsetContainer(e$8) || e$8;
		this.elementOffsetContainer = d$2, this.dragOffsetContainer = u$4 === c$5 ? d$2 : getOffsetContainer(e$8, { container: u$4 });
		{
			let { width: e$9, height: t$12, x: n$14, y: r$11 } = a$6;
			this.clientRect = {
				width: e$9,
				height: t$12,
				x: n$14,
		...
		let f$1 = t$11.settings.frozenStyles({
			draggable: t$11,
			drag: r$10,
			item: this,
			style: i$7
		...
		if (Array.isArray(f$1)) if (f$1.length) {
			let e$9 = {};
			for (let t$12 of f$1) e$9[t$12] = i$7[t$12];
			this.frozenStyles = e$9;
		} else this.frozenStyles = null;
		else this.frozenStyles = f$1;
		if (this.frozenStyles) {
			let t$12 = {};
			for (let n$14 in this.frozenStyles) t$12[n$14] = e$8.style[n$14];
			this.unfrozenStyles = t$12;
		}
	}
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$8) => {
			if (!this._matrixCache.isValid(e$8)) {
				let t$11 = this._matrixCache.get(e$8) || [new DOMMatrix(), new DOMMatrix()], [n$14, r$10] = t$11;
				E(e$8, n$14), r$10.setMatrixValue(n$14.toString()).invertSelf(), this._matrixCache.set(e$8, t$11);
			}
		});
	}
	_updateContainerOffset() {
		let { elementOffsetContainer: e$8, elementContainer: t$11, dragOffsetContainer: n$14, dragContainer: r$10, containerOffset: i$7, _clientOffsetCache: a$6, _matrixCache: o$3 } = this;
		if (e$8 !== n$14) {
			let [s$5, l$5] = [[r$10, n$14], [t$11, e$8]].map(([e$9, t$12]) => {
				let n$15 = a$6.get(t$12) || {
					x: 0,
					y: 0
				};
				if (!a$6.isValid(t$12)) {
					let r$11 = o$3.get(e$9);
					t$12 instanceof HTMLElement && r$11 && !r$11[0].isIdentity ? c$4(r$11[0]) ? (D.style.setProperty(`transform`, r$11[1].toString(), `important`), t$12.append(D), g(D, n$15), D.remove()) : (g(t$12, n$15), n$15.x -= r$11[0].m41, n$15.y -= r$11[0].m42) : g(t$12, n$15);
				}
				return a$6.set(t$12, n$15), n$15;
			});
			C(s$5, l$5, i$7);
	...
	updateSize(e$8) {
		if (e$8) this.clientRect.width = e$8.width, this.clientRect.height = e$8.height;
			...
			let { width: e$9, height: t$11 } = this.element.getBoundingClientRect();
			this.clientRect.width = e$9, this.clientRect.height = t$11;
		}
	}
};
const k = {
...
var N = function(e$8) {
	return e$8[e$8.None = 0] = `None`, e$8[e$8.Init = 1] = `Init`, e$8[e$8.Prepare = 2] = `Prepare`, e$8[e$8.FinishPrepare = 3] = `FinishPrepare`, e$8[e$8.Apply = 4] = `Apply`, e$8[e$8.FinishApply = 5] = `FinishApply`, e$8;
}(N || {}), P = function(e$8) {
	return e$8[e$8.Pending = 0] = `Pending`, e$8[e$8.Resolved = 1] = `Resolved`, e$8[e$8.Rejected = 2] = `Rejected`, e$8;
}(P || {});
const F = {
	Start: `start`,
	Move: `move`,
	...
	elements: () => null,
	frozenStyles: () => null,
	applyPosition: ({ item: e$8, phase: t$11 }) => {
		let n$14 = t$11 === L.End || t$11 === L.EndAlign, [r$10, i$7] = e$8.getContainerMatrix(), [a$6, o$3] = e$8.getDragContainerMatrix(), { position: s$5, alignmentOffset: c$5, containerOffset: l$5, elementTransformMatrix: d$2, elementTransformOrigin: f$1, elementOffsetMatrix: p$1 } = e$8, { x: m$1, y: h$1, z: g$1 } = f$1, _$2 = !d$2.isIdentity && (m$1 !== 0 || h$1 !== 0 || g$1 !== 0), v$2 = s$5.x + c$5.x + l$5.x, y$1 = s$5.y + c$5.y + l$5.y;
		u$2(j), _$2 && (g$1 === 0 ? j.translateSelf(-m$1, -h$1) : j.translateSelf(-m$1, -h$1, -g$1)), n$14 ? i$7.isIdentity || j.multiplySelf(i$7) : o$3.isIdentity || j.multiplySelf(o$3), u$2(M).translateSelf(v$2, y$1), j.multiplySelf(M), r$10.isIdentity || j.multiplySelf(r$10), _$2 && (u$2(M).translateSelf(m$1, h$1, g$1), j.multiplySelf(M)), d$2.isIdentity || j.multiplySelf(d$2), p$1.isIdentity || j.preMultiplySelf(p$1), e$8.element.style.transform = `${j}`;
	},
...
var B = class {
	...
	_alignId;
	constructor(e$8, t$11 = {}) {
		let { id: n$14 = Symbol(),...r$10 } = t$11;
		this.id = n$14, this._sensors = e$8, this.settings = this._parseSettings(r$10), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$9) => {
	...
	set sensors(e$8) {
		...
		if (e$8 === t$11) return;
		let n$14 = t$11.filter((t$12) => !e$8.includes(t$12)), r$10 = e$8.filter((e$9) => !t$11.includes(e$9));
		this._sensors = e$8, n$14.forEach((e$9) => {
	...
	_bindSensor(e$8) {
		...
		e$8.on(e.Start, t$11, t$11), e$8.on(e.Move, t$11, t$11), e$8.on(e.Cancel, n$14, n$14), e$8.on(e.End, n$14, n$14), e$8.on(e.Destroy, n$14, n$14);
	}
	_unbindSensor(e$8) {
		let t$11 = this._sensorData.get(e$8);
		if (!t$11) return;
		let { onMove: n$14, onEnd: r$10 } = t$11;
		e$8.off(e.Start, n$14), e$8.off(e.Move, n$14), e$8.off(e.Cancel, r$10), e$8.off(e.End, r$10), e$8.off(e.Destroy, r$10), this._sensorData.delete(e$8);
	}
	_parseSettings(e$8, t$11 = z) {
		let { container: n$14 = t$11.container, startPredicate: r$10 = t$11.startPredicate, elements: i$7 = t$11.elements, frozenStyles: a$6 = t$11.frozenStyles, positionModifiers: o$3 = t$11.positionModifiers, applyPosition: s$5 = t$11.applyPosition, computeClientRect: c$5 = t$11.computeClientRect, sensorProcessingMode: l$5 = t$11.sensorProcessingMode, dndGroups: u$4 = t$11.dndGroups, onPrepareStart: d$2 = t$11.onPrepareStart, onStart: f$1 = t$11.onStart, onPrepareMove: p$1 = t$11.onPrepareMove, onMove: m$1 = t$11.onMove, onEnd: h$1 = t$11.onEnd, onDestroy: g$1 = t$11.onDestroy } = e$8 || {};
		return {
			container: n$14,
			startPredicate: r$10,
			elements: i$7,
	...
	_emit(e$8, ...t$11) {
		this._emitter.emit(e$8, ...t$11);
	}
	_onMove(n$14, r$10) {
		let i$7 = this._sensorData.get(r$10);
		if (i$7) switch (i$7.predicateState) {
			case P.Pending: {
				i$7.predicateEvent = n$14;
				let e$8 = this.settings.startPredicate({
					draggable: this,
					sensor: r$10,
					event: n$14
				});
				e$8 === !0 ? this.resolveStartPredicate(r$10) : e$8 === !1 && this.rejectStartPredicate(r$10);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = n$14, this.settings.sensorProcessingMode === I.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$4.read, this._prepareMove, this._moveId), r$5.once(n$4.write, this._applyMove, this._moveId)));
				break;
		}
	}
	_onScroll() {
	...
	_onEnd(e$8, t$11) {
		let n$14 = this._sensorData.get(t$11);
		n$14 && (this.drag ? n$14.predicateState === P.Resolved && (this.drag.endEvent = e$8, this._sensorData.forEach((e$9) => {
			e$9.predicateState = P.Pending, e$9.predicateEvent = null;
		}), this.stop()) : (n$14.predicateState = P.Pending, n$14.predicateEvent = null));
	}
	_prepareStart() {
		let e$8 = this.drag;
		!e$8 || this._startPhase !== N.Init || (this._startPhase = N.Prepare, e$8.items = (this.settings.elements({
			draggable: this,
			drag: e$8
		}) || []).map((e$9) => new O(e$9, this)), this._applyModifiers(F.Start, 0, 0), this._emit(R.PrepareStart, e$8, this), this.settings.onPrepareStart?.(e$8, this), this._startPhase = N.FinishPrepare);
	}
	_applyStart() {
		let e$8 = this.drag;
		if (!(!e$8 || this._startPhase !== N.FinishPrepare)) {
			this._startPhase = N.Apply;
			for (let t$11 of e$8.items) t$11.dragContainer !== t$11.elementContainer && l$3(t$11.dragContainer, t$11.element), t$11.frozenStyles && Object.assign(t$11.element.style, t$11.frozenStyles), this.settings.applyPosition({
				phase: L.Start,
				draggable: this,
				drag: e$8,
				item: t$11
			});
			for (let t$11 of e$8.items) {
				let e$9 = t$11.getContainerMatrix()[0], n$14 = t$11.getDragContainerMatrix()[0];
				if (s$4(e$9, n$14) || !c$4(e$9) && !c$4(n$14)) continue;
				let r$10 = t$11.element.getBoundingClientRect(), { alignmentOffset: i$7 } = t$11;
				i$7.x += d$1(t$11.clientRect.x - r$10.x, 3), i$7.y += d$1(t$11.clientRect.y - r$10.y, 3);
			}
			for (let t$11 of e$8.items) {
				let { alignmentOffset: n$14 } = t$11;
				(n$14.x !== 0 || n$14.y !== 0) && this.settings.applyPosition({
					phase: L.StartAlign,
					draggable: this,
					drag: e$8,
					item: t$11
			...
			window.addEventListener(`scroll`, this._onScroll, k), this._emit(R.Start, e$8, this), this.settings.onStart?.(e$8, this), this._startPhase = N.FinishApply;
		}
	}
	_prepareMove() {
		let e$8 = this.drag;
		if (!e$8 || e$8.isEnded) return;
		let { moveEvent: t$11, prevMoveEvent: n$14 } = e$8;
		t$11 !== n$14 && (this._applyModifiers(F.Move, t$11.x - n$14.x, t$11.y - n$14.y), this._emit(R.PrepareMove, e$8, this), !e$8.isEnded && (this.settings.onPrepareMove?.(e$8, this), !e$8.isEnded && (e$8.prevMoveEvent = t$11)));
	}
	_applyMove() {
		let e$8 = this.drag;
		if (!(!e$8 || e$8.isEnded)) {
			for (let t$11 of e$8.items) t$11._moveDiff.x = 0, t$11._moveDiff.y = 0, this.settings.applyPosition({
				phase: L.Move,
				draggable: this,
				drag: e$8,
				item: t$11
	...
	_prepareAlign() {
		let { drag: e$8 } = this;
		if (!(!e$8 || e$8.isEnded)) for (let t$11 of e$8.items) {
			let { x: e$9, y: n$14 } = t$11.element.getBoundingClientRect(), r$10 = t$11.clientRect.x - t$11._moveDiff.x - e$9;
			t$11.alignmentOffset.x = t$11.alignmentOffset.x - t$11._alignDiff.x + r$10, t$11._alignDiff.x = r$10;
			let i$7 = t$11.clientRect.y - t$11._moveDiff.y - n$14;
			t$11.alignmentOffset.y = t$11.alignmentOffset.y - t$11._alignDiff.y + i$7, t$11._alignDiff.y = i$7;
		}
	}
	_applyAlign() {
		let { drag: e$8 } = this;
		if (!(!e$8 || e$8.isEnded)) for (let t$11 of e$8.items) t$11._alignDiff.x = 0, t$11._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$8,
			item: t$11
	...
	_applyModifiers(e$8, t$11, n$14) {
		let { drag: r$10 } = this;
		if (!r$10) return;
		let { positionModifiers: i$7 } = this.settings;
		for (let a$6 of r$10.items) {
			let o$3 = A;
			o$3.x = t$11, o$3.y = n$14;
			for (let t$12 of i$7) o$3 = t$12(o$3, {
				draggable: this,
				drag: r$10,
				item: a$6,
				phase: e$8
			});
			a$6.position.x += o$3.x, a$6.position.y += o$3.y, a$6.clientRect.x += o$3.x, a$6.clientRect.y += o$3.y, e$8 === `move` && (a$6._moveDiff.x += o$3.x, a$6._moveDiff.y += o$3.y);
		}
	}
	on(e$8, t$11, n$14) {
		return this._emitter.on(e$8, t$11, n$14);
	}
	off(e$8, t$11) {
		this._emitter.off(e$8, t$11);
	}
	resolveStartPredicate(n$14, r$10) {
		let i$7 = this._sensorData.get(n$14);
		if (!i$7) return;
		let a$6 = r$10 || i$7.predicateEvent;
		i$7.predicateState === P.Pending && a$6 && (this._startPhase = N.Init, i$7.predicateState = P.Resolved, i$7.predicateEvent = null, this.drag = new p(n$14, a$6), this._sensorData.forEach((e$8, t$11) => {
			t$11 !== n$14 && (e$8.predicateState = P.Rejected, e$8.predicateEvent = null);
	...
	rejectStartPredicate(e$8) {
		let t$11 = this._sensorData.get(e$8);
		t$11?.predicateState === P.Pending && (t$11.predicateState = P.Rejected, t$11.predicateEvent = null);
	}
	stop() {
		let n$14 = this.drag;
		if (!(!n$14 || n$14.isEnded)) {
			if (this._startPhase === N.Prepare || this._startPhase === N.Apply) throw Error(`Cannot stop drag start process at this point`);
			n$14.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$5.off(n$4.read, this._startId), r$5.off(n$4.write, this._startId), r$5.off(n$4.read, this._moveId), r$5.off(n$4.write, this._moveId), r$5.off(n$4.read, this._alignId), r$5.off(n$4.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
			for (let e$8 of n$14.items) {
				if (e$8.elementContainer !== e$8.dragContainer && (l$3(e$8.elementContainer, e$8.element), e$8.alignmentOffset.x = 0, e$8.alignmentOffset.y = 0, e$8.containerOffset.x = 0, e$8.containerOffset.y = 0), e$8.unfrozenStyles) for (let t$11 in e$8.unfrozenStyles) e$8.element.style[t$11] = e$8.unfrozenStyles[t$11] || ``;
			...
			for (let e$8 of n$14.items) if (e$8.elementContainer !== e$8.dragContainer) {
				let t$11 = e$8.element.getBoundingClientRect();
				e$8.alignmentOffset.x = d$1(e$8.clientRect.x - t$11.x, 3), e$8.alignmentOffset.y = d$1(e$8.clientRect.y - t$11.y, 3);
			}
			for (let e$8 of n$14.items) e$8.elementContainer !== e$8.dragContainer && (e$8.alignmentOffset.x !== 0 || e$8.alignmentOffset.y !== 0) && this.settings.applyPosition({
				phase: L.EndAlign,
				draggable: this,
				drag: n$14,
				item: e$8
			});
			this._emit(R.End, n$14, this), this.settings.onEnd?.(n$14, this), this.drag = null;
		}
	}
	align(n$14 = !1) {
		!this.drag || this.drag.isEnded || (n$14 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$4.read, this._prepareAlign, this._alignId), r$5.once(n$4.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
		let { drag: e$8, settings: t$11 } = this;
		return e$8 && t$11.computeClientRect?.({
			draggable: this,
			drag: e$8
		}) || null;
	}
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensors.forEach((e$8) => {
...
//#endregion
//#region ../dragdoll/dist/droppable-DCmokLJh.js
const t$6 = { Destroy: `destroy` }, n$7 = {
	accept: () => !0,
	computeClientRect: (e$8) => e$8.element?.getBoundingClientRect() || e$8.getClientRect()
};
var r$6 = class {
	id;
	element;
	...
	_clientRect;
	_emitter;
	constructor(t$11, r$10 = {}) {
		let { id: i$7 = Symbol(), accept: a$6 = n$7.accept, data: o$3 = {}, computeClientRect: s$5 = n$7.computeClientRect } = r$10;
		this.id = i$7, this.element = t$11, this.isDestroyed = !1, this.accept = a$6, this.data = o$3, this.computeClientRect = s$5, this._clientRect = {
			x: 0,
			y: 0,
			width: 0,
			height: 0
	...
	updateClientRect() {
		let e$8 = this.computeClientRect(this), t$11 = this._clientRect;
		t$11.x = e$8.x, t$11.y = e$8.y, t$11.width = e$8.width, t$11.height = e$8.height;
	}
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this._emitter.emit(t$6.Destroy), this._emitter.off());
	}
};

//#endregion
//#region ../dragdoll/dist/dnd-observer-DnQocni-.js
var s$3 = function(e$8) {
	return e$8[e$8.Idle = 0] = `Idle`, e$8[e$8.Computing = 1] = `Computing`, e$8[e$8.Computed = 2] = `Computed`, e$8[e$8.Emitting = 3] = `Emitting`, e$8;
}(s$3 || {});
const c$3 = {
	capture: !0,
	passive: !0
...
var u$1 = class {
	...
	_emitter;
	constructor(e$8 = {}) {
		let { collisionDetector: t$11 } = e$8;
		this.draggables = /* @__PURE__ */ new Map(), this.droppables = /* @__PURE__ */ new Map(), this.isDestroyed = !1, this._drags = /* @__PURE__ */ new Map(), this._listenerId = Symbol(), this._emitter = new v(), this._onScroll = this._onScroll.bind(this), this._collisionDetector = t$11 ? t$11(this) : new a$5(this);
	}
	get drags() {
		return this._drags;
	}
	_isMatch(e$8, t$11) {
		let n$14 = !1;
		if (typeof t$11.accept == `function`) n$14 = t$11.accept(e$8);
		else {
			let r$10 = e$8.settings.dndGroups, i$7 = t$11.accept;
			if (!r$10 || r$10.size === 0 || i$7.size === 0) return !1;
			let a$6 = i$7.size < r$10.size, o$3 = a$6 ? i$7 : r$10, s$5 = a$6 ? r$10 : i$7;
			for (let e$9 of o$3) if (s$5.has(e$9)) {
				n$14 = !0;
				break;
			}
		}
	...
	_getTargets(e$8) {
		let t$11 = this._drags.get(e$8);
		if (t$11?._targets) return t$11._targets;
		let n$14 = /* @__PURE__ */ new Map();
		for (let t$12 of this.droppables.values()) this._isMatch(e$8, t$12) && n$14.set(t$12.id, t$12);
		return t$11 && (t$11._targets = n$14), n$14;
	}
	_onDragPrepareStart(e$8) {
		this.draggables.has(e$8.id) && (this._drags.get(e$8) || (this._drags.set(e$8, {
			isEnded: !1,
			data: {},
			_targets: null,
			_cd: {
		...
		}), this._drags.size === 1 && this.updateDroppableClientRects(), this._computeCollisions(e$8), this._drags.size === 1 && window.addEventListener(`scroll`, this._onScroll, c$3)));
	}
	_onDragStart(e$8) {
		let t$11 = this._drags.get(e$8);
		if (!(!t$11 || t$11.isEnded)) {
			if (this._emitter.listenerCount(l$2.Start)) {
				let t$12 = this._getTargets(e$8);
				this._emitter.emit(l$2.Start, {
					draggable: e$8,
					targets: t$12
				});
			}
			this._emitCollisions(e$8);
		}
	}
	_onDragPrepareMove(e$8) {
		let t$11 = this._drags.get(e$8);
		!t$11 || t$11.isEnded || this._computeCollisions(e$8);
	}
	_onDragMove(e$8) {
		let t$11 = this._drags.get(e$8);
		if (!(!t$11 || t$11.isEnded)) {
			if (this._emitter.listenerCount(l$2.Move)) {
				let t$12 = this._getTargets(e$8);
				this._emitter.emit(l$2.Move, {
					draggable: e$8,
					targets: t$12
				});
			}
	...
	_onDragCancel(e$8) {
		this._stopDrag(e$8, !0);
	}
	_onDraggableDestroy(e$8) {
		this.removeDraggables([e$8]);
	}
	_onScroll = () => {
		this._drags.size !== 0 && (r$5.once(n$4.read, () => {
			this.updateDroppableClientRects();
		}, this._listenerId), this.detectCollisions());
	};
	_stopDrag(n$14, r$10 = !1) {
		let i$7 = this._drags.get(n$14);
		if (!i$7 || i$7.isEnded) return;
		if (i$7._cd.phase === s$3.Emitting) throw Error(`Cannot stop dragging while collisions are being emitted.`);
		i$7.isEnded = !0, this._computeCollisions(n$14, !0), this._emitCollisions(n$14, !0);
		let { targets: a$6, collisions: o$3, contacts: u$4 } = i$7._cd;
		this._emitter.listenerCount(l$2.End) && this._emitter.emit(l$2.End, {
			canceled: r$10,
			draggable: n$14,
			targets: a$6,
			collisions: o$3,
			contacts: u$4
		}), this._drags.delete(n$14), this._collisionDetector._removeCollisionDataArena(n$14), r$5.off(n$4.read, i$7._cd.tickerId), r$5.off(n$4.write, i$7._cd.tickerId), this._drags.size || (r$5.off(n$4.read, this._listenerId), window.removeEventListener(`scroll`, this._onScroll, c$3));
	}
	_computeCollisions(e$8, t$11 = !1) {
		let n$14 = this._drags.get(e$8);
		if (!n$14 || !t$11 && n$14.isEnded) return;
		let r$10 = n$14._cd;
		switch (r$10.phase) {
			case s$3.Computing: throw Error(`Collisions are being computed.`);
			case s$3.Emitting: throw Error(`Collisions are being emitted.`);
			default: break;
		}
		r$10.phase = s$3.Computing, r$10.targets = this._getTargets(e$8), this._collisionDetector.detectCollisions(e$8, r$10.targets, r$10.collisions), r$10.phase = s$3.Computed;
	}
	_emitCollisions(e$8, t$11 = !1) {
		let n$14 = this._drags.get(e$8);
		if (!n$14 || !t$11 && n$14.isEnded) return;
		let r$10 = n$14._cd;
		switch (r$10.phase) {
			case s$3.Computing: throw Error(`Collisions are being computed.`);
			case s$3.Emitting: throw Error(`Collisions are being emitted.`);
			case s$3.Idle: return;
			default: break;
		}
		r$10.phase = s$3.Emitting;
		let i$7 = this._emitter, a$6 = r$10.collisions, o$3 = r$10.targets, c$5 = r$10.addedContacts, u$4 = r$10.persistedContacts, d$2 = r$10.contacts, f$1 = r$10.prevContacts;
		r$10.prevContacts = d$2, r$10.contacts = f$1;
		let p$1 = d$2;
		c$5.clear(), u$4.clear(), f$1.clear();
		for (let e$9 of a$6) {
			let t$12 = o$3.get(e$9.droppableId);
			t$12 && (f$1.add(t$12), d$2.has(t$12) ? (u$4.add(t$12), d$2.delete(t$12)) : c$5.add(t$12));
		}
		d$2.size && i$7.listenerCount(l$2.Leave) && i$7.emit(l$2.Leave, {
			draggable: e$8,
			targets: o$3,
			collisions: a$6,
			contacts: f$1,
			removedContacts: p$1
		}), c$5.size && i$7.listenerCount(l$2.Enter) && i$7.emit(l$2.Enter, {
			draggable: e$8,
			targets: o$3,
			collisions: a$6,
			contacts: f$1,
			addedContacts: c$5
		}), i$7.listenerCount(l$2.Collide) && (f$1.size || p$1.size) && i$7.emit(l$2.Collide, {
			draggable: e$8,
			targets: o$3,
			collisions: a$6,
			contacts: f$1,
		...
		}), c$5.clear(), u$4.clear(), d$2.clear(), r$10.phase = s$3.Idle;
	}
	on(e$8, t$11, n$14) {
		return this._emitter.on(e$8, t$11, n$14);
	}
	...
	updateDroppableClientRects() {
		for (let e$8 of this.droppables.values()) e$8.updateClientRect();
	}
	clearTargets(e$8) {
		if (e$8) {
			let t$11 = this._drags.get(e$8);
			t$11 && (t$11._targets = null);
		} else for (let e$9 of this._drags.values()) e$9._targets = null;
	}
	detectCollisions(n$14) {
		if (!this.isDestroyed) if (n$14) {
			let r$10 = this._drags.get(n$14);
			if (!r$10 || r$10.isEnded) return;
			r$5.once(n$4.read, () => this._computeCollisions(n$14), r$10._cd.tickerId), r$5.once(n$4.write, () => this._emitCollisions(n$14), r$10._cd.tickerId);
		} else for (let [n$15, r$10] of this._drags) r$10.isEnded || (r$5.once(n$4.read, () => this._computeCollisions(n$15), r$10._cd.tickerId), r$5.once(n$4.write, () => this._emitCollisions(n$15), r$10._cd.tickerId));
	}
	addDraggables(e$8) {
		if (this.isDestroyed) return;
		let t$11 = /* @__PURE__ */ new Set();
		for (let n$14 of e$8) this.draggables.has(n$14.id) || (t$11.add(n$14), this.draggables.set(n$14.id, n$14), n$14.on(R.PrepareStart, () => {
			this._onDragPrepareStart(n$14);
		}, this._listenerId), n$14.on(R.Start, () => {
			this._onDragStart(n$14);
		}, this._listenerId), n$14.on(R.PrepareMove, () => {
			this._onDragPrepareMove(n$14);
		}, this._listenerId), n$14.on(R.Move, () => {
			this._onDragMove(n$14);
		}, this._listenerId), n$14.on(R.End, (e$9) => {
			e$9.endEvent?.type === e.End ? this._onDragEnd(n$14) : this._onDragCancel(n$14);
		}, this._listenerId), n$14.on(R.Destroy, () => {
			this._onDraggableDestroy(n$14);
		}, this._listenerId));
		if (t$11.size) {
			this._emitter.listenerCount(l$2.AddDraggables) && this._emitter.emit(l$2.AddDraggables, { draggables: t$11 });
			for (let e$9 of t$11) if (!this.isDestroyed && e$9.drag && !e$9.drag.isEnded) {
				let t$12 = e$9._startPhase;
				t$12 >= 2 && this._onDragPrepareStart(e$9), t$12 >= 4 && this._onDragStart(e$9);
			}
		}
	}
	removeDraggables(e$8) {
		if (this.isDestroyed) return;
		let t$11 = /* @__PURE__ */ new Set();
		for (let n$14 of e$8) this.draggables.has(n$14.id) && (t$11.add(n$14), this.draggables.delete(n$14.id), n$14.off(R.PrepareStart, this._listenerId), n$14.off(R.Start, this._listenerId), n$14.off(R.PrepareMove, this._listenerId), n$14.off(R.Move, this._listenerId), n$14.off(R.End, this._listenerId), n$14.off(R.Destroy, this._listenerId));
		for (let e$9 of t$11) this._stopDrag(e$9, !0);
		this._emitter.listenerCount(l$2.RemoveDraggables) && this._emitter.emit(l$2.RemoveDraggables, { draggables: t$11 });
	}
	addDroppables(e$8) {
		if (this.isDestroyed) return;
		let t$11 = /* @__PURE__ */ new Set();
		for (let n$14 of e$8) this.droppables.has(n$14.id) || (t$11.add(n$14), this.droppables.set(n$14.id, n$14), n$14.on(t$6.Destroy, () => {
			this.removeDroppables([n$14]);
		}, this._listenerId), this._drags.forEach(({ _targets: e$9 }, t$12) => {
			e$9 && this._isMatch(t$12, n$14) && (e$9.set(n$14.id, n$14), this.detectCollisions(t$12));
		}));
		t$11.size && this._emitter.listenerCount(l$2.AddDroppables) && this._emitter.emit(l$2.AddDroppables, { droppables: t$11 });
	}
	removeDroppables(e$8) {
		if (this.isDestroyed) return;
		let t$11 = /* @__PURE__ */ new Set();
		for (let n$14 of e$8) this.droppables.has(n$14.id) && (this.droppables.delete(n$14.id), t$11.add(n$14), n$14.off(t$6.Destroy, this._listenerId), this._drags.forEach(({ _targets: e$9 }, t$12) => {
			e$9 && e$9.has(n$14.id) && (e$9.delete(n$14.id), this.detectCollisions(t$12));
		}));
		t$11.size && this._emitter.listenerCount(l$2.RemoveDroppables) && this._emitter.emit(l$2.RemoveDroppables, { droppables: t$11 });
	}
	destroy() {
		if (this.isDestroyed) return;
		if (Array.from(this._drags.values()).some((e$9) => e$9._cd.phase === s$3.Emitting)) throw Error(`Cannot destroy the DndObserver while collisions are being emitted.`);
		this.isDestroyed = !0, this.draggables.forEach((e$9) => {
			e$9.off(R.PrepareStart, this._listenerId), e$9.off(R.Start, this._listenerId), e$9.off(R.PrepareMove, this._listenerId), e$9.off(R.Move, this._listenerId), e$9.off(R.End, this._listenerId), e$9.off(R.Destroy, this._listenerId);
		}), this.droppables.forEach((e$9) => {
			e$9.off(t$6.Destroy, this._listenerId);
		});
		let e$8 = this._drags.keys();
		for (let t$11 of e$8) this._stopDrag(t$11, !0);
		this._emitter.emit(l$2.Destroy), this._emitter.off(), this._collisionDetector.destroy(), this.draggables.clear(), this.droppables.clear();
	}
};

//#endregion
//#region ../dragdoll-react/dist/use-dnd-observer-B2HZwsIC.js
function a({ collisionDetector: a$6, onStart: o$3, onMove: s$5, onEnter: c$5, onLeave: l$5, onCollide: u$4, onEnd: d$2, onAddDraggables: f$1, onRemoveDraggables: p$1, onAddDroppables: m$1, onRemoveDroppables: h$1, onDestroy: g$1 } = {}) {
	let [_$2, v$2] = (0, import_react.useState)(null);
	return n(() => {
		let e$8 = new u$1({ collisionDetector: a$6 });
		return v$2(e$8), () => {
			e$8.destroy(), v$2(null);
		};
	}, [a$6]), r$7(l$2.Start, o$3, _$2), r$7(l$2.Move, s$5, _$2), r$7(l$2.Enter, c$5, _$2), r$7(l$2.Leave, l$5, _$2), r$7(l$2.Collide, u$4, _$2), r$7(l$2.End, d$2, _$2), r$7(l$2.AddDraggables, f$1, _$2), r$7(l$2.RemoveDraggables, p$1, _$2), r$7(l$2.AddDroppables, m$1, _$2), r$7(l$2.RemoveDroppables, h$1, _$2), r$7(l$2.Destroy, g$1, _$2), _$2;
}

//#endregion
//#region ../dragdoll-react/dist/are-configs-equal-Cv4ZY5_I.js
const e$2 = Object.prototype.hasOwnProperty, t$5 = (e$8) => {
	if (typeof e$8 != `object` || !e$8) return !1;
	let t$11 = Object.getPrototypeOf(e$8);
	return t$11 === Object.prototype || t$11 === null;
};
function n$9(r$10, i$7) {
	if (Object.is(r$10, i$7)) return !0;
	if (r$10 === null || i$7 === null || typeof r$10 != `object` || typeof i$7 != `object`) return !1;
	let a$6 = Array.isArray(r$10), o$3 = Array.isArray(i$7);
	if (a$6 || o$3) {
		if (!a$6 || !o$3) return !1;
		let e$8 = r$10.length;
		if (e$8 !== i$7.length) return !1;
		for (let t$11 = 0; t$11 < e$8; t$11++) if (!n$9(r$10[t$11], i$7[t$11])) return !1;
		return !0;
	}
	let s$5 = r$10 instanceof Set, c$5 = i$7 instanceof Set;
	if (s$5 || c$5) return !s$5 || !c$5 || r$10.size !== i$7.size ? !1 : r$10.isSubsetOf(i$7);
	if (!t$5(r$10) || !t$5(i$7)) return !1;
	let l$5 = Object.keys(r$10), u$4 = Object.keys(i$7);
	if (l$5.length !== u$4.length) return !1;
	for (let t$11 = 0; t$11 < l$5.length; t$11++) {
		let a$7 = l$5[t$11];
		if (!e$2.call(i$7, a$7) || !n$9(r$10[a$7], i$7[a$7])) return !1;
	}
	return !0;
}
...
function t$4(e$8, t$11) {
	if (e$8 === t$11) return !0;
	if (e$8.length !== t$11.length) return !1;
	for (let n$14 = 0; n$14 < e$8.length; n$14++) if (!Object.is(e$8[n$14], t$11[n$14])) return !1;
	return !0;
}
function n$1(n$14, r$10) {
	let i$7 = (0, import_react.useRef)(null), a$6 = i$7.current || {
		deps: r$10,
		value: n$14()
	};
	return i$7.current ? t$4(r$10, a$6.deps) || (a$6.deps = r$10, a$6.value = n$14()) : i$7.current = a$6, a$6.value;
}
function r$1(e$8, t$11) {
	return n$1(() => e$8, t$11);
}
...
function c(c$5, l$5) {
	let u$4 = n$1(() => c$5.filter((e$8) => !!e$8), [...c$5]), { id: d$2, dndObserver: f$1,...p$1 } = l$5 || {}, m$1 = n$1(() => d$2 === void 0 ? Symbol() : d$2, [d$2]), h$1 = n$6(), g$1 = f$1 === void 0 ? h$1 : f$1, [_$2, v$2] = (0, import_react.useState)(null), y$1 = (0, import_react.useRef)(null), b$1 = (0, import_react.useRef)(u$4);
	b$1.current = u$4;
	let x$1 = (0, import_react.useRef)(p$1);
	x$1.current = p$1;
	let S$1 = (0, import_react.useRef)(g$1);
	S$1.current = g$1;
	let C$1 = (0, import_react.useRef)(void 0), w$1 = r$1(() => {
		let e$8 = y$1.current;
		e$8 && (e$8.destroy(), y$1.current = null, C$1.current = void 0, v$2(null));
	}, []), T$1 = r$1((e$8) => {
		w$1();
		let t$11 = new B(b$1.current, {
			id: e$8,
			...x$1.current
		});
		y$1.current = t$11, C$1.current = x$1.current, v$2(t$11);
	}, [w$1]);
	return n(() => {
		...
		_$2 && _$2.sensors !== u$4 && (_$2.sensors = u$4);
	}, [_$2, u$4]), n(() => {
		if (_$2) return g$1?.addDraggables([_$2]), () => {
			g$1?.removeDraggables([_$2]);
		};
	}, [_$2, g$1]), n(() => {
		if (!_$2) return;
		let e$8 = x$1.current;
		C$1.current !== e$8 && (n$9(C$1.current, e$8) || (_$2.updateSettings(_$2._parseSettings(e$8)), C$1.current && e$8.dndGroups !== C$1.current.dndGroups && S$1.current?.clearTargets(_$2)), C$1.current = e$8);
	}, [_$2, l$5]), n(() => w$1, [w$1]), _$2;
}

//#endregion
//#region ../dragdoll-react/dist/use-draggable-callback-Cd1g8lnj.js
function n$8(n$14, r$10, i$7) {
	let a$6 = !!i$7, o$3 = (0, import_react.useRef)(i$7);
	o$3.current = i$7, n(() => {
		if (!n$14 || !a$6) return;
		let e$8 = n$14.on(r$10, ((...e$9) => {
			o$3.current?.(...e$9);
		}));
		return () => void n$14.off(r$10, e$8);
	}, [
		n$14,
		r$10,
		a$6
...
function r(r$10, i$7 = !1) {
	let [a$6, o$3] = (0, import_react.useState)(r$10?.drag || null), s$5 = (0, import_react.useState)(void 0)[1];
	return n$8(r$10, R.Start, (e$8) => {
		o$3(e$8);
	}), n$8(r$10, R.Move, () => {
		i$7 && s$5(Symbol());
	}), n$8(r$10, R.End, () => {
...
const c$2 = Symbol();
function l({ id: l$5, accept: u$4, data: d$2, computeClientRect: f$1, element: p$1, dndObserver: m$1 } = {}) {
	let h$1 = n$6(), g$1 = m$1 === void 0 ? h$1 : m$1, [_$2, v$2] = (0, import_react.useState)(null), y$1 = (0, import_react.useRef)(null), b$1 = (0, import_react.useRef)({
		id: l$5,
		accept: u$4,
		data: d$2,
		computeClientRect: f$1
	});
	b$1.current.id = l$5, b$1.current.accept = u$4, b$1.current.data = d$2, b$1.current.computeClientRect = f$1;
	let x$1 = (0, import_react.useRef)(c$2), S$1 = (0, import_react.useRef)(g$1);
	S$1.current = g$1;
	let C$1 = r$1(() => {
		let e$8 = y$1.current;
		e$8 && (e$8.destroy(), y$1.current = null, x$1.current = c$2, v$2(null));
	}, []), w$1 = r$1((e$8) => {
		let t$11 = y$1.current;
		if (t$11) {
			if (t$11.element === e$8 && x$1.current === b$1.current.id) return;
			t$11.destroy();
		}
		t$11 = new r$6(e$8, b$1.current), y$1.current = t$11, x$1.current = b$1.current.id, v$2(t$11);
	}, []), T$1 = r$1((e$8) => {
		if (p$1 === void 0) {
			if (e$8 === null) {
				C$1();
	...
	return n(() => {
		if (p$1 !== void 0) return w$1(p$1), C$1;
	}, [
		p$1,
		w$1,
		C$1
	]), n(() => {
		_$2 && x$1.current !== l$5 && w$1(_$2.element);
	}, [
		_$2,
		l$5,
		w$1
	]), n(() => {
		if (!(!_$2 || !g$1)) return g$1.addDroppables([_$2]), () => {
			g$1.removeDroppables([_$2]);
		};
	}, [_$2, g$1]), n(() => {
		_$2 && (_$2.accept = u$4 || n$7.accept, S$1.current?.clearTargets());
	}, [_$2, u$4]), n(() => {
		_$2 && (_$2.data = d$2 || {});
	}, [_$2, d$2]), n(() => {
		_$2 && (_$2.computeClientRect = f$1 || n$7.computeClientRect, _$2.updateClientRect(), S$1.current?.detectCollisions());
	}, [_$2, f$1]), n(() => C$1, [C$1]), n$1(() => [_$2, T$1], [_$2, T$1]);
}
...
var n$5 = class {
	...
	_start(t$11) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$11), this._emitter.emit(e.Start, t$11));
	}
	_move(t$11) {
		this.drag && (this._updateDragData(t$11), this._emitter.emit(e.Move, t$11));
	}
	_end(t$11) {
		this.drag && (this._updateDragData(t$11), this._emitter.emit(e.End, t$11), this._resetDragData());
	}
	_cancel(t$11) {
		this.drag && (this._updateDragData(t$11), this._emitter.emit(e.Cancel, t$11), this._resetDragData());
	}
	on(e$8, t$11, n$14) {
		return this._emitter.on(e$8, t$11, n$14);
	}
...
var i$4 = class extends n$5 {
	...
	_start(n$14) {
		this.isDestroyed || this.drag || (super._start(n$14), r$5.on(n$4.read, this._tick, this._tick));
	}
	_end(n$14) {
		this.drag && (r$5.off(n$4.read, this._tick), super._end(n$14));
	}
	_cancel(n$14) {
		this.drag && (r$5.off(n$4.read, this._tick), super._cancel(n$14));
	}
	_tick(e$8) {
		if (this.drag) if (e$8 && this.drag.time) {
			...
			if (this._emitter.emit(`tick`, t$11), !this.drag) return;
			let r$10 = this._speed * (this.drag.deltaTime / 1e3), i$7 = this._direction.x * r$10, a$6 = this._direction.y * r$10;
			(i$7 || a$6) && this._move({
				type: e.Move,
				x: this.drag.x + i$7,
				y: this.drag.y + a$6
...
function r$4(e$8, t$11) {
	if (!e$8.size || !t$11.size) return Infinity;
	let n$14 = Infinity;
	for (let r$10 of e$8) {
		let e$9 = t$11.get(r$10);
		e$9 !== void 0 && e$9 < n$14 && (n$14 = e$9);
	}
	return n$14;
}
const i$3 = {
	...
	computeSpeed: () => 500,
	startPredicate: (e$8, t$11) => {
		if (t$11.element && document.activeElement === t$11.element) {
			let { left: e$9, top: n$14 } = t$11.element.getBoundingClientRect();
			return {
				x: e$9,
				y: n$14
			};
...
var a$2 = class extends i$4 {
	...
	constructor(e$8, t$11 = {}) {
		super();
		let { startPredicate: n$14 = i$3.startPredicate, computeSpeed: r$10 = i$3.computeSpeed, cancelOnVisibilityChange: a$6 = i$3.cancelOnVisibilityChange, cancelOnBlur: o$3 = i$3.cancelOnBlur, startKeys: s$5 = i$3.startKeys, moveLeftKeys: c$5 = i$3.moveLeftKeys, moveRightKeys: l$5 = i$3.moveRightKeys, moveUpKeys: u$4 = i$3.moveUpKeys, moveDownKeys: d$2 = i$3.moveDownKeys, cancelKeys: f$1 = i$3.cancelKeys, endKeys: p$1 = i$3.endKeys } = t$11;
		this.element = e$8, this._startKeys = new Set(s$5), this._cancelKeys = new Set(f$1), this._endKeys = new Set(p$1), this._moveLeftKeys = new Set(c$5), this._moveRightKeys = new Set(l$5), this._moveUpKeys = new Set(u$4), this._moveDownKeys = new Set(d$2), this._moveKeys = new Set([
			...c$5,
			...l$5,
			...u$4,
			...d$2
		]), this._moveKeyTimestamps = /* @__PURE__ */ new Map(), this._cancelOnBlur = o$3, this._cancelOnVisibilityChange = a$6, this._computeSpeed = r$10, this._startPredicate = n$14, this._onKeyDown = this._onKeyDown.bind(this), this._onKeyUp = this._onKeyUp.bind(this), this._onTick = this._onTick.bind(this), this._internalCancel = this._internalCancel.bind(this), this._blurCancelHandler = this._blurCancelHandler.bind(this), this.on(`tick`, this._onTick, this._onTick), document.addEventListener(`keydown`, this._onKeyDown), document.addEventListener(`keyup`, this._onKeyUp), o$3 && e$8?.addEventListener(`blur`, this._blurCancelHandler), a$6 && document.addEventListener(`visibilitychange`, this._internalCancel);
	}
	_end(e$8) {
		this.drag && (this._moveKeyTimestamps.clear(), this._direction.x = 0, this._direction.y = 0, super._end(e$8));
	}
	_cancel(e$8) {
		this.drag && (this._moveKeyTimestamps.clear(), this._direction.x = 0, this._direction.y = 0, super._cancel(e$8));
	}
	_internalCancel() {
		this.cancel();
	}
	...
	_updateDirection() {
		let e$8 = r$4(this._moveLeftKeys, this._moveKeyTimestamps), t$11 = r$4(this._moveRightKeys, this._moveKeyTimestamps), n$14 = r$4(this._moveUpKeys, this._moveKeyTimestamps), i$7 = r$4(this._moveDownKeys, this._moveKeyTimestamps), a$6 = e$8 === t$11 ? 0 : e$8 < t$11 ? -1 : 1, o$3 = n$14 === i$7 ? 0 : n$14 < i$7 ? -1 : 1;
		if (!(a$6 === 0 || o$3 === 0)) {
			let e$9 = 1 / (Math.sqrt(a$6 * a$6 + o$3 * o$3) || 1);
			a$6 *= e$9, o$3 *= e$9;
		}
		this._direction.x = a$6, this._direction.y = o$3;
	}
	_onTick() {
		this._speed = this._computeSpeed(this);
	}
	_onKeyUp(e$8) {
		this._moveKeyTimestamps.get(e$8.key) && (this._moveKeyTimestamps.delete(e$8.key), this._updateDirection());
	}
	_onKeyDown(t$11) {
		if (!this.drag) {
			if (this._startKeys.has(t$11.key)) {
				let n$14 = this._startPredicate(t$11, this);
				n$14 && (t$11.preventDefault(), this._start({
					type: e.Start,
					x: n$14.x,
					y: n$14.y
				}));
		...
		if (this._cancelKeys.has(t$11.key)) {
			t$11.preventDefault(), this._internalCancel();
			return;
		}
		if (this._endKeys.has(t$11.key)) {
			t$11.preventDefault(), this._end({
				type: e.End,
				x: this.drag.x,
				y: this.drag.y
			});
		...
		if (this._moveKeys.has(t$11.key)) {
			t$11.preventDefault(), this._moveKeyTimestamps.get(t$11.key) || (this._moveKeyTimestamps.set(t$11.key, Date.now()), this._updateDirection());
			return;
		}
	}
	updateElement(e$8) {
		this.isDestroyed || this.element === e$8 || (this._cancelOnBlur && (this.element?.removeEventListener(`blur`, this._blurCancelHandler), e$8?.addEventListener(`blur`, this._blurCancelHandler)), this.element = e$8);
	}
	updateSettings(e$8) {
		if (this.isDestroyed) return;
		let t$11 = !1, { cancelOnBlur: r$10, cancelOnVisibilityChange: i$7, startPredicate: a$6, computeSpeed: o$3 } = e$8;
		if (r$10 !== void 0 && this._cancelOnBlur !== r$10 && (this._cancelOnBlur = r$10, r$10 ? this.element?.addEventListener(`blur`, this._blurCancelHandler) : this.element?.removeEventListener(`blur`, this._blurCancelHandler)), i$7 !== void 0 && this._cancelOnVisibilityChange !== i$7 && (this._cancelOnVisibilityChange = i$7, i$7 ? document.addEventListener(`visibilitychange`, this._internalCancel) : document.removeEventListener(`visibilitychange`, this._internalCancel)), a$6 !== void 0 && (this._startPredicate = a$6), o$3 !== void 0 && (this._computeSpeed = o$3), n$3.forEach((n$14, r$11) => {
			let i$8 = `${n$14}Keys`, a$7 = e$8[i$8];
			a$7 !== void 0 && (this[`_${i$8}`] = new Set(a$7), r$11 >= 3 && (t$11 = !0));
		}), t$11) {
			let e$9 = [
				...this._moveLeftKeys,
				...this._moveRightKeys,
			...
			[...this._moveKeys].every((t$12, n$14) => e$9[n$14] === t$12) || (this._moveKeys = new Set(e$9), this._moveKeyTimestamps.clear(), this._updateDirection());
		}
	}
	destroy() {
...
function s(s$5, c$5) {
	let [l$5, u$4] = (0, import_react.useState)(null), d$2 = (0, import_react.useRef)(l$5), f$1 = (0, import_react.useRef)(s$5);
	f$1.current = s$5;
	let p$1 = r$1((e$8) => {
		let t$11 = d$2.current;
		if (t$11) {
			t$11.updateElement(e$8);
			return;
		}
		let n$14 = new a$2(e$8, f$1.current);
		d$2.current = n$14, u$4(n$14);
	}, []), m$1 = r$1(() => {
		let e$8 = d$2.current;
		e$8 && (e$8.destroy(), d$2.current = null, u$4(null));
	}, []), h$1 = r$1((e$8) => {
		if (c$5 === void 0) {
			if (e$8 === null) {
				m$1();
	...
	return n(() => {
		if (c$5 !== void 0) return p$1(c$5), m$1;
	}, [
		c$5,
		p$1,
		m$1
		...
		if (l$5) {
			let { startKeys: e$8 = i$3.startKeys, moveLeftKeys: t$11 = i$3.moveLeftKeys, moveRightKeys: n$14 = i$3.moveRightKeys, moveUpKeys: r$10 = i$3.moveUpKeys, moveDownKeys: i$7 = i$3.moveDownKeys, cancelKeys: a$6 = i$3.cancelKeys, endKeys: c$6 = i$3.endKeys, cancelOnBlur: u$5 = i$3.cancelOnBlur, cancelOnVisibilityChange: d$3 = i$3.cancelOnVisibilityChange, computeSpeed: f$2 = i$3.computeSpeed, startPredicate: p$2 = i$3.startPredicate } = s$5 || {};
			l$5.updateSettings({
				startKeys: e$8,
				moveLeftKeys: t$11,
				moveRightKeys: n$14,
	...
	}, [l$5, s$5]), n$1(() => [l$5, h$1], [l$5, h$1]);
}

//#endregion
//#region ../dragdoll/dist/pointer-sensor-C2e8cAmq.js
function i$1(e$8, t$11) {
	if (`pointerId` in e$8) return e$8.pointerId === t$11 ? e$8 : null;
	if (`changedTouches` in e$8) {
		let n$14 = 0;
		for (; n$14 < e$8.changedTouches.length; n$14++) if (e$8.changedTouches[n$14].identifier === t$11) return e$8.changedTouches[n$14];
		return null;
	}
	return e$8;
}
function a$1(e$8) {
	return `pointerId` in e$8 ? e$8.pointerId : `changedTouches` in e$8 ? e$8.changedTouches[0] ? e$8.changedTouches[0].identifier : null : -1;
}
function o(e$8) {
	return `pointerType` in e$8 ? e$8.pointerType : `touches` in e$8 ? `touch` : `mouse`;
}
function s$2(e$8 = {}) {
	let { capture: t$11 = !0, passive: n$14 = !0 } = e$8;
	return {
		capture: t$11,
		passive: n$14
	};
...
function c$1(n$14) {
	return n$14 === `auto` || n$14 === void 0 ? n$2 ? `pointer` : t$1 ? `touch` : `mouse` : n$14;
}
const l$1 = {
	pointer: {
		start: `pointerdown`,
	...
	listenerOptions: {},
	sourceEvents: `auto`,
	startPredicate: (e$8) => !(`button` in e$8 && e$8.button > 0)
};
var d = class {
	element;
	drag;
	...
	_emitter;
	constructor(e$8, t$11 = {}) {
		let { listenerOptions: n$14 = u.listenerOptions, sourceEvents: i$7 = u.sourceEvents, startPredicate: a$6 = u.startPredicate } = t$11;
		this.element = e$8, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$6, this._listenerOptions = s$2(n$14), this._sourceEvents = c$1(i$7), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$8.addEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	_getTrackedPointerEventData(e$8) {
		return this.drag ? i$1(e$8, this.drag.pointerId) : null;
	}
	_onStart(e$8) {
		if (this.isDestroyed || this.drag || !this._startPredicate(e$8)) return;
		let t$11 = a$1(e$8);
		if (t$11 === null) return;
		let r$10 = i$1(e$8, t$11);
		if (r$10 === null) return;
		let s$5 = {
			pointerId: t$11,
			pointerType: o(e$8),
	...
	_onMove(e$8) {
		if (!this.drag) return;
		let t$11 = this._getTrackedPointerEventData(e$8);
		if (!t$11) return;
		this.drag.x = t$11.clientX, this.drag.y = t$11.clientY;
		let r$10 = {
			type: e.Move,
			srcEvent: e$8,
			target: t$11.target,
		...
		this._emitter.emit(r$10.type, r$10);
	}
	_onCancel(e$8) {
		if (!this.drag) return;
		let t$11 = this._getTrackedPointerEventData(e$8);
		...
		this._emitter.emit(r$10.type, r$10), this._resetDrag();
	}
	_onEnd(e$8) {
		if (!this.drag) return;
		let t$11 = this._getTrackedPointerEventData(e$8);
	...
	_bindWindowListeners() {
		...
		let { move: e$8, end: t$11, cancel: n$14 } = l$1[this._sourceEvents];
		window.addEventListener(e$8, this._onMove, this._listenerOptions), window.addEventListener(t$11, this._onEnd, this._listenerOptions), n$14 && window.addEventListener(n$14, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !0;
	}
	_unbindWindowListeners() {
		if (this._areWindowListenersBound) {
			let { move: e$8, end: t$11, cancel: n$14 } = l$1[this._sourceEvents];
			window.removeEventListener(e$8, this._onMove, this._listenerOptions), window.removeEventListener(t$11, this._onEnd, this._listenerOptions), n$14 && window.removeEventListener(n$14, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !1;
		}
	}
	_resetDrag() {
	...
	updateElement(e$8) {
		this.isDestroyed || this.element === e$8 || (this.element.removeEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions), e$8.addEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions), this.element = e$8);
	}
	updateSettings(e$8) {
		if (this.isDestroyed) return;
		let { listenerOptions: t$11, sourceEvents: n$14, startPredicate: r$10 } = e$8, i$7 = c$1(n$14), a$6 = s$2(t$11);
		r$10 && this._startPredicate !== r$10 && (this._startPredicate = r$10), (t$11 && (this._listenerOptions.capture !== a$6.capture || this._listenerOptions.passive === a$6.passive) || n$14 && this._sourceEvents !== i$7) && (this.element.removeEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions), this._unbindWindowListeners(), this.cancel(), n$14 && (this._sourceEvents = i$7), t$11 && a$6 && (this._listenerOptions = a$6), this.element.addEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
	on(e$8, t$11, n$14) {
		return this._emitter.on(e$8, t$11, n$14);
	}
...
function s$1(s$5, c$5) {
	...
	let p$1 = r$1((e$8) => {
		...
		let n$14 = new d(e$8, f$1.current);
		d$2.current = n$14, u$4(n$14);
	}, []), m$1 = r$1(() => {
		let e$8 = d$2.current;
		e$8 && (e$8.destroy(), d$2.current = null, u$4(null));
	...
	return n(() => {
		...
		if (l$5) {
			let { listenerOptions: e$8 = u.listenerOptions, sourceEvents: t$11 = u.sourceEvents, startPredicate: n$14 = u.startPredicate } = s$5 || {};
			l$5.updateSettings({
				listenerOptions: e$8,
				sourceEvents: t$11,
				startPredicate: n$14
...
var require_scheduler_development = /* @__PURE__ */ __commonJS({ "../../node_modules/scheduler/cjs/scheduler.development.js": ((exports) => {
	(function() {
		...
		function compare(a$6, b$1) {
			var diff = a$6.sortIndex - b$1.sortIndex;
			return 0 !== diff ? diff : a$6.id - b$1.id;
		}
...
var require_react_dom_development = /* @__PURE__ */ __commonJS({ "../../node_modules/react-dom/cjs/react-dom.development.js": ((exports) => {
	(function() {
		...
		exports.unstable_batchedUpdates = function(fn, a$6) {
			return fn(a$6);
		};
...
var require_react_dom_client_development = /* @__PURE__ */ __commonJS({ "../../node_modules/react-dom/cjs/react-dom-client.development.js": ((exports) => {
	(function() {
		...
		function findCurrentFiberUsingSlowPath(fiber) {
			...
			for (var a$6 = fiber, b$1 = alternate;;) {
				var parentA = a$6.return;
				...
				if (parentA.child === parentB.child) {
					for (parentB = parentA.child; parentB;) {
						if (parentB === a$6) return assertIsMounted(parentA), fiber;
						if (parentB === b$1) return assertIsMounted(parentA), alternate;
						parentB = parentB.sibling;
					}
					throw Error("Unable to find node on an unmounted component.");
				}
				if (a$6.return !== b$1.return) a$6 = parentA, b$1 = parentB;
				else {
				...
				if (a$6.alternate !== b$1) throw Error("Return fibers should always be each others' alternates. This error is likely caused by a bug in React. Please file an issue.");
			}
			if (3 !== a$6.tag) throw Error("Unable to find node on an unmounted component.");
			return a$6.stateNode.current === a$6 ? fiber : alternate;
		}
		...
		function camelize(string) {
			return string.replace(hyphenPattern, function(_$2, character) {
		...
		function batchedUpdates$1(fn, a$6, b$1) {
			if (isInsideEventHandler) return fn(a$6, b$1);
			isInsideEventHandler = !0;
			try {
				return fn(a$6);
			} finally {
				if (isInsideEventHandler = !1, null !== restoreTarget || null !== restoreQueue) {
					if (flushSyncWork$1(), restoreTarget && (a$6 = restoreTarget, fn = restoreQueue, restoreQueue = restoreTarget = null, restoreStateOfTarget(a$6), fn)) for (a$6 = 0; a$6 < fn.length; a$6++) restoreStateOfTarget(fn[a$6]);
				}
			}
		}
				...
				if (null !== lastEffect) {
					...
					do {
						if ((updateQueue.tag & flags) === flags && (lastEffect = void 0, (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !0), lastEffect = runWithFiberInDEV(finishedWork, callCreateInDEV, updateQueue), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !1), void 0 !== lastEffect && "function" !== typeof lastEffect)) {
							...
							runWithFiberInDEV(finishedWork, function(n$14, a$6) {
								console.error("%s must not return anything besides a function, which is used for clean-up.%s", n$14, a$6);
							}, hookName, addendum);
						}
		...
		function markRetryLaneImpl(fiber, retryLane) {
			...
			if (null !== fiber && null !== fiber.dehydrated) {
				var a$6 = fiber.retryLane;
				fiber.retryLane = 0 !== a$6 && a$6 < retryLane ? a$6 : retryLane;
			}
		}
...
//#endregion
//#region react-examples/011-dnd-basic/index.tsx
...
const DropZoneMemo = (0, import_react.memo)(function DropZone() {
	const [_droppable, setDroppableElementRef] = l((0, import_react.useMemo)(() => ({ data: {
		overIds: /* @__PURE__ */ new Set(),
...
function App() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(t.Provider, {
		value: dndObserver,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				2,
				3
			].map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraggableCardMemo, { zIndexRef }, id))
			...
			children: [
				...
				2,
				3
			].map((id) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropZoneMemo, {}, id))
		})]
	});
}
