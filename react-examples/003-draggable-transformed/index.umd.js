...
var __copyProps = (to, from, except, desc) => {
	if (from && typeof from === "object" || typeof from === "function") for (var keys = __getOwnPropNames(from), i$7 = 0, n$11 = keys.length, key; i$7 < n$11; i$7++) {
		key = keys[i$7];
	...
	(function() {
		...
		function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
			...
			if (invokeCallback) {
				...
				isArrayImpl(callback) ? (escapedPrefix = "", null != childKey && (escapedPrefix = childKey.replace(userProvidedKeyEscapeRegex, "$&/") + "/"), mapIntoArray(callback, array, escapedPrefix, "", function(c$5) {
					return c$5;
			...
			if (isArrayImpl(children)) for (var i$7 = 0; i$7 < children.length; i$7++) nameSoFar = children[i$7], type = childKey + getElementKey(nameSoFar, i$7), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if (i$7 = getIteratorFn(children), "function" === typeof i$7) for (i$7 === children.entries && (didWarnAboutMaps || console.warn("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), didWarnAboutMaps = !0), children = i$7.call(children), i$7 = 0; !(nameSoFar = children.next()).done;) nameSoFar = nameSoFar.value, type = childKey + getElementKey(nameSoFar, i$7++), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if ("object" === type) {
		...
		function flushActQueue(queue) {
			if (!isFlushing) {
				...
				var i$7 = 0;
				try {
					for (; i$7 < queue.length; i$7++) {
						var callback = queue[i$7];
						do {
					...
					queue.splice(0, i$7 + 1), ReactSharedInternals.thrownErrors.push(error);
				} finally {
					isFlushing = !1;
				}
			}
		...
		exports.cloneElement = function(element, config, children) {
			...
			if (1 === propName) props.children = children;
				...
				for (var i$7 = 0; i$7 < propName; i$7++) JSCompiler_inline_result[i$7] = arguments[i$7 + 2];
		...
		exports.createElement = function(type, config, children) {
			for (var i$7 = 2; i$7 < arguments.length; i$7++) validateChildKeys(arguments[i$7]);
			i$7 = {};
			var key = null;
			if (null != config) for (propName in didWarnAboutOldJSXRuntime || !("__self" in config) || "key" in config || (didWarnAboutOldJSXRuntime = !0, console.warn("Your app (or one of its dependencies) is using an outdated JSX transform. Update to the modern JSX transform for faster performance: https://react.dev/link/new-jsx-transform")), hasValidKey(config) && (checkKeyStringCoercion(config.key), key = "" + config.key), config) hasOwnProperty.call(config, propName) && "key" !== propName && "__self" !== propName && "__source" !== propName && (i$7[propName] = config[propName]);
			var childrenLength = arguments.length - 2;
			if (1 === childrenLength) i$7.children = children;
			else if (1 < childrenLength) {
				for (var childArray = Array(childrenLength), _i = 0; _i < childrenLength; _i++) childArray[_i] = arguments[_i + 2];
				Object.freeze && Object.freeze(childArray);
				i$7.children = childArray;
			}
			if (type && type.defaultProps) for (propName in childrenLength = type.defaultProps, childrenLength) void 0 === i$7[propName] && (i$7[propName] = childrenLength[propName]);
			key && defineKeyPropWarningGetter(i$7, "function" === typeof type ? type.displayName || type.name || "Unknown" : type);
			var propName = 1e4 > ReactSharedInternals.recentlyCreatedOwnerStacks++;
			return ReactElement(type, key, i$7, getOwner(), propName ? Error("react-stack-top-frame") : unknownOwnerDebugStack, propName ? createTask(getTaskName(type)) : unknownOwnerDebugTask);
		};
...
const t$10 = (0, import_react.createContext)(null);

//#endregion
//#region ../dragdoll-react/dist/use-dnd-observer-context-BL_LF-TG.js
function n$10() {
	return (0, import_react.useContext)(t$10);
}
...
var E$2 = {
	...
	constructor(t$12 = {}) {
		this.dedupe = t$12.dedupe || E$2.ADD, this.getId = t$12.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
	}
	_getListeners(t$12) {
		let n$11 = this._events.get(t$12);
		return n$11 ? n$11.l || (n$11.l = [...n$11.m.values()]) : null;
	}
	on(t$12, n$11, e$9) {
		let i$7 = this._events, s$6 = i$7.get(t$12);
		s$6 || (s$6 = {
			m: /* @__PURE__ */ new Map(),
			l: null
		}, i$7.set(t$12, s$6));
		let o$5 = s$6.m;
		if (e$9 = e$9 === r$7 ? this.getId(n$11) : e$9, o$5.has(e$9)) switch (this.dedupe) {
			case E$2.THROW: throw new Error("Eventti: duplicate listener id!");
			case E$2.IGNORE: return e$9;
			case E$2.UPDATE:
				s$6.l = null;
				break;
			default: o$5.delete(e$9), s$6.l = null;
		}
		return o$5.set(e$9, n$11), s$6.l?.push(n$11), e$9;
	}
	once(t$12, n$11, e$9) {
		let i$7 = 0;
		return e$9 = e$9 === r$7 ? this.getId(n$11) : e$9, this.on(t$12, (...s$6) => {
			i$7 || (i$7 = 1, this.off(t$12, e$9), n$11(...s$6));
		}, e$9);
	}
	off(t$12, n$11) {
		if (t$12 === r$7) {
		...
		if (n$11 === r$7) {
			this._events.delete(t$12);
			return;
		}
		let e$9 = this._events.get(t$12);
		e$9?.m.delete(n$11) && (e$9.l = null, e$9.m.size || this._events.delete(t$12));
	}
	emit(t$12, ...n$11) {
		let e$9 = this._getListeners(t$12);
		if (e$9) {
			let i$7 = e$9.length, s$6 = 0;
			if (n$11.length) for (; s$6 < i$7; s$6++) e$9[s$6](...n$11);
			else for (; s$6 < i$7; s$6++) e$9[s$6]();
		}
	}
	listenerCount(t$12) {
		if (t$12 === r$7) {
			let n$11 = 0;
			return this._events.forEach((e$9) => {
				n$11 += e$9.m.size;
			}), n$11;
		}
		return this._events.get(t$12)?.m.size || 0;
	}
};

//#endregion
//#region ../../node_modules/tikki/dist/index.js
var _$2 = E$2, o$4 = class {
	constructor(e$9 = {}) {
		let { phases: t$12 = [], dedupe: r$8, getId: s$6 } = e$9;
		this._phases = t$12, this._emitter = new v({
			getId: s$6,
			dedupe: r$8
	...
	set dedupe(e$9) {
		this._emitter.dedupe = e$9;
	}
	get getId() {
		return this._emitter.getId;
	}
	set getId(e$9) {
		this._emitter.getId = e$9;
	}
	tick(...e$9) {
		this._assertEmptyQueue(), this._fillQueue(), this._processQueue(...e$9);
	}
	on(e$9, t$12, r$8) {
		return this._emitter.on(e$9, t$12, r$8);
	}
	once(e$9, t$12, r$8) {
		return this._emitter.once(e$9, t$12, r$8);
	}
	off(e$9, t$12) {
		return this._emitter.off(e$9, t$12);
	}
	count(e$9) {
		return this._emitter.listenerCount(e$9);
	}
	_assertEmptyQueue() {
		if (this._queue.length) throw new Error("Ticker: Can't tick before the previous tick has finished!");
	}
	_fillQueue() {
		let e$9 = this._queue, t$12 = this._phases, r$8 = this._getListeners, s$6 = 0, a$4 = t$12.length, n$11;
		for (; s$6 < a$4; s$6++) n$11 = r$8(t$12[s$6]), n$11 && e$9.push(n$11);
		return e$9;
	}
	_processQueue(...e$9) {
		let t$12 = this._queue, r$8 = t$12.length;
		if (!r$8) return;
		let s$6 = 0, a$4 = 0, n$11, c$5;
		for (; s$6 < r$8; s$6++) for (n$11 = t$12[s$6], a$4 = 0, c$5 = n$11.length; a$4 < c$5; a$4++) n$11[a$4](...e$9);
		t$12.length = 0;
	}
};
function u$3(i$7 = 60) {
	if (typeof requestAnimationFrame == "function" && typeof cancelAnimationFrame == "function") return (e$9) => {
		let t$12 = requestAnimationFrame(e$9);
		return () => cancelAnimationFrame(t$12);
	};
	{
		let e$9 = 1e3 / i$7, t$12 = typeof performance > "u" ? () => Date.now() : () => performance.now();
		return (r$8) => {
			let s$6 = setTimeout(() => r$8(t$12()), e$9);
			return () => clearTimeout(s$6);
		};
	}
}
var l$3 = class extends o$4 {
	constructor(e$9 = {}) {
		let { paused: t$12 = !1, onDemand: r$8 = !1, requestFrame: s$6 = u$3(),...a$4 } = e$9;
		super(a$4), this._paused = t$12, this._onDemand = r$8, this._requestFrame = s$6, this._cancelFrame = null, this._empty = !0, !t$12 && !r$8 && this._request();
	}
	get phases() {
		return this._phases;
	}
	set phases(e$9) {
		this._phases = e$9, e$9.length ? (this._empty = !1, this._request()) : this._empty = !0;
	}
	get paused() {
		return this._paused;
	}
	set paused(e$9) {
		this._paused = e$9, e$9 ? this._cancel() : this._request();
	}
	get onDemand() {
		return this._onDemand;
	}
	set onDemand(e$9) {
		this._onDemand = e$9, e$9 || this._request();
	}
	get requestFrame() {
		return this._requestFrame;
	}
	set requestFrame(e$9) {
		this._requestFrame !== e$9 && (this._requestFrame = e$9, this._cancelFrame && (this._cancel(), this._request()));
	}
	tick(...e$9) {
		if (this._assertEmptyQueue(), this._cancelFrame = null, this._onDemand || this._request(), !this._empty) {
			...
			this._onDemand && this._request(), this._processQueue(...e$9);
		}
	}
	on(e$9, t$12, r$8) {
		let s$6 = super.on(e$9, t$12, r$8);
		return this._empty = !1, this._request(), s$6;
	}
	once(e$9, t$12, r$8) {
		let s$6 = super.once(e$9, t$12, r$8);
		return this._empty = !1, this._request(), s$6;
	}
	_request() {
...
function e$6(e$9, t$12, n$11 = {
	width: 0,
	height: 0,
	x: 0,
	y: 0
}) {
	let r$8 = Math.max(e$9.x, t$12.x), i$7 = Math.min(e$9.x + e$9.width, t$12.x + t$12.width);
	if (i$7 <= r$8) return null;
	let a$4 = Math.max(e$9.y, t$12.y), o$5 = Math.min(e$9.y + e$9.height, t$12.y + t$12.height);
	return o$5 <= a$4 ? null : (n$11.x = r$8, n$11.y = a$4, n$11.width = i$7 - r$8, n$11.height = o$5 - a$4, n$11);
}
const t$8 = {
	width: 0,
	height: 0,
...
function n$9(n$11, r$8, i$7) {
	if (i$7 ||= e$6(n$11, r$8, t$8), !i$7) return 0;
	let a$4 = i$7.width * i$7.height;
	return a$4 ? a$4 / (Math.min(n$11.width, r$8.width) * Math.min(n$11.height, r$8.height)) * 100 : 0;
}
...
function t$7(t$12) {
	let n$11 = e$5.get(t$12)?.deref();
	return n$11 || (n$11 = window.getComputedStyle(t$12, null), e$5.set(t$12, new WeakRef(n$11))), n$11;
}

//#endregion
//#region ../dragdoll/dist/constants-CMClRu_c.js
const e$4 = typeof window < `u` && window.document !== void 0, t = e$4 && `ontouchstart` in window, n$2 = e$4 && !!window.PointerEvent;
...
function getStyle(e$9, t$12) {
	if (t$12) return window.getComputedStyle(e$9, t$12);
	let C$2 = STYLE_DECLARATION_CACHE.get(e$9)?.deref();
	return C$2 || (C$2 = window.getComputedStyle(e$9, null), STYLE_DECLARATION_CACHE.set(e$9, new WeakRef(C$2))), C$2;
}
...
const IS_CHROMIUM = (() => {
	try {
		return window.navigator.userAgentData.brands.some((({ brand: n$11 }) => "Chromium" === n$11));
	} catch (n$11) {
		return !1;
	}
})();
...
function isBlockElement(e$9) {
	switch (getStyle(e$9).display) {
...
function isContainingBlockForFixedElement(n$11) {
	const t$12 = getStyle(n$11);
	if (!IS_SAFARI) {
		const { filter: n$12 } = t$12;
		if (n$12 && "none" !== n$12) return !0;
		const { backdropFilter: e$10 } = t$12;
		if (e$10 && "none" !== e$10) return !0;
		const { willChange: i$8 } = t$12;
		if (i$8 && (i$8.indexOf("filter") > -1 || i$8.indexOf("backdrop-filter") > -1)) return !0;
	}
	const e$9 = isBlockElement(n$11);
	if (!e$9) return e$9;
	const { transform: i$7 } = t$12;
	if (i$7 && "none" !== i$7) return !0;
	const { perspective: r$8 } = t$12;
	if (r$8 && "none" !== r$8) return !0;
	const { contentVisibility: o$5 } = t$12;
	if (o$5 && "auto" === o$5) return !0;
	const { contain: f$2 } = t$12;
	if (f$2 && ("strict" === f$2 || "content" === f$2 || f$2.indexOf("paint") > -1 || f$2.indexOf("layout") > -1)) return !0;
	const { willChange: c$5 } = t$12;
	return !(!c$5 || !(c$5.indexOf("transform") > -1 || c$5.indexOf("perspective") > -1 || c$5.indexOf("contain") > -1)) || !!(IS_SAFARI && c$5 && c$5.indexOf("filter") > -1);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/isContainingBlockForAbsoluteElement.js
function isContainingBlockForAbsoluteElement(t$12) {
	return "static" !== getStyle(t$12).position || isContainingBlockForFixedElement(t$12);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/isDocumentElement.js
function isDocumentElement(e$9) {
	return e$9 instanceof HTMLHtmlElement;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getContainingBlock.js
function getContainingBlock(e$9, t$12 = {}) {
	if (isDocumentElement(e$9)) return e$9.ownerDocument.defaultView;
	const n$11 = t$12.position || getStyle(e$9).position, { skipDisplayNone: i$7, container: o$5 } = t$12;
	switch (n$11) {
		case "static":
		case "relative":
		case "sticky":
		case "-webkit-sticky": {
			let t$13 = o$5 || e$9.parentElement;
			for (; t$13;) {
				const e$10 = isBlockElement(t$13);
				if (e$10) return t$13;
				if (null === e$10 && !i$7) return null;
				t$13 = t$13.parentElement;
			}
			return e$9.ownerDocument.documentElement;
		}
		case "absolute":
		case "fixed": {
			const t$13 = "fixed" === n$11;
			let l$4 = o$5 || e$9.parentElement;
			for (; l$4;) {
				const e$10 = t$13 ? isContainingBlockForFixedElement(l$4) : isContainingBlockForAbsoluteElement(l$4);
				if (!0 === e$10) return l$4;
				if (null === e$10 && !i$7) return null;
				l$4 = l$4.parentElement;
			}
			return e$9.ownerDocument.defaultView;
		}
		default: return null;
	}
}
...
function isWindow(n$11) {
	return n$11 instanceof Window;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getOffsetContainer.js
function getOffsetContainer(n$11, t$12 = {}) {
	const { display: o$5 } = getStyle(n$11);
	if ("none" === o$5 || "contents" === o$5) return null;
	const e$9 = t$12.position || getStyle(n$11).position, { skipDisplayNone: s$6, container: r$8 } = t$12;
	switch (e$9) {
		case "relative": return n$11;
		case "fixed": return getContainingBlock(n$11, {
			container: r$8,
			position: e$9,
			skipDisplayNone: s$6
		});
		case "absolute": {
			const t$13 = getContainingBlock(n$11, {
				container: r$8,
				position: e$9,
				skipDisplayNone: s$6
			});
			return isWindow(t$13) ? n$11.ownerDocument : t$13;
		}
		default: return null;
	}
}
...
function s$5(e$9, t$12) {
	return e$9.isIdentity && t$12.isIdentity ? !0 : e$9.is2D && t$12.is2D ? e$9.a === t$12.a && e$9.b === t$12.b && e$9.c === t$12.c && e$9.d === t$12.d && e$9.e === t$12.e && e$9.f === t$12.f : e$9.m11 === t$12.m11 && e$9.m12 === t$12.m12 && e$9.m13 === t$12.m13 && e$9.m14 === t$12.m14 && e$9.m21 === t$12.m21 && e$9.m22 === t$12.m22 && e$9.m23 === t$12.m23 && e$9.m24 === t$12.m24 && e$9.m31 === t$12.m31 && e$9.m32 === t$12.m32 && e$9.m33 === t$12.m33 && e$9.m34 === t$12.m34 && e$9.m41 === t$12.m41 && e$9.m42 === t$12.m42 && e$9.m43 === t$12.m43 && e$9.m44 === t$12.m44;
}
function c$4(e$9) {
	return e$9.m11 !== 1 || e$9.m12 !== 0 || e$9.m13 !== 0 || e$9.m14 !== 0 || e$9.m21 !== 0 || e$9.m22 !== 1 || e$9.m23 !== 0 || e$9.m24 !== 0 || e$9.m31 !== 0 || e$9.m32 !== 0 || e$9.m33 !== 1 || e$9.m34 !== 0 || e$9.m43 !== 0 || e$9.m44 !== 1;
}
function l$2(e$9, t$12, n$11 = null) {
	if (`moveBefore` in e$9 && e$9.isConnected === t$12.isConnected) try {
		e$9.moveBefore(t$12, n$11);
		return;
	} catch {}
	let r$8 = document.activeElement, i$7 = t$12.contains(r$8);
	e$9.insertBefore(t$12, n$11), i$7 && document.activeElement !== r$8 && r$8 instanceof HTMLElement && r$8.focus({ preventScroll: !0 });
}
function u$2(e$9) {
	return e$9.setMatrixValue(`scale(1, 1)`);
}
function d$2(e$9, t$12 = 0) {
	let n$11 = 10 ** t$12;
	return Math.round((e$9 + 2 ** -52) * n$11) / n$11;
}
var f$1 = class {
	_cache;
	_validation;
	...
	set(e$9, t$12) {
		this._cache.set(e$9, t$12), this._validation.add(e$9);
	}
	get(e$9) {
		return this._cache.get(e$9);
	}
	has(e$9) {
		return this._cache.has(e$9);
	}
	delete(e$9) {
		this._cache.delete(e$9), this._validation.delete(e$9);
	}
	isValid(e$9) {
		return this._validation.has(e$9);
	}
	invalidate(e$9) {
		e$9 === void 0 ? this._validation.clear() : this._validation.delete(e$9);
	}
	clear() {
	...
	_matrixCache;
	_clientOffsetCache;
	constructor(e$9, t$12) {
		this.sensor = e$9, this.startEvent = t$12, this.prevMoveEvent = t$12, this.moveEvent = t$12, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f$1(), this._clientOffsetCache = new f$1();
	}
};
function m$1(e$9, t$12, n$11 = !1) {
	let { style: r$8 } = e$9;
	for (let e$10 in t$12) r$8.setProperty(e$10, t$12[e$10], n$11 ? `important` : ``);
}
function h$1() {
	let e$9 = document.createElement(`div`);
	return e$9.classList.add(`dragdoll-measure`), m$1(e$9, {
		display: `block`,
		position: `absolute`,
		inset: `0px`,
		padding: `0px`,
...
function g$1(e$9, t$12 = {
	x: 0,
	y: 0
}) {
	if (t$12.x = 0, t$12.y = 0, e$9 instanceof Window) return t$12;
	if (e$9 instanceof Document) return t$12.x = window.scrollX * -1, t$12.y = window.scrollY * -1, t$12;
	let { x: r$8, y: i$7 } = e$9.getBoundingClientRect(), a$4 = t$7(e$9);
	return t$12.x = r$8 + (parseFloat(a$4.borderLeftWidth) || 0), t$12.y = i$7 + (parseFloat(a$4.borderTopWidth) || 0), t$12;
}
function _$1(e$9) {
	let t$12 = t$7(e$9), r$8 = parseFloat(t$12.height) || 0;
	return t$12.boxSizing === `border-box` ? r$8 : (r$8 += parseFloat(t$12.borderTopWidth) || 0, r$8 += parseFloat(t$12.borderBottomWidth) || 0, r$8 += parseFloat(t$12.paddingTop) || 0, r$8 += parseFloat(t$12.paddingBottom) || 0, e$9 instanceof HTMLElement && (r$8 += e$9.offsetHeight - e$9.clientHeight), r$8);
}
function v$2(e$9) {
	let t$12 = t$7(e$9), r$8 = parseFloat(t$12.width) || 0;
	return t$12.boxSizing === `border-box` ? r$8 : (r$8 += parseFloat(t$12.borderLeftWidth) || 0, r$8 += parseFloat(t$12.borderRightWidth) || 0, r$8 += parseFloat(t$12.paddingLeft) || 0, r$8 += parseFloat(t$12.paddingRight) || 0, e$9 instanceof HTMLElement && (r$8 += e$9.offsetWidth - e$9.clientWidth), r$8);
}
function y$1(e$9, t$12 = !1) {
	let { translate: r$8, rotate: i$7, scale: a$4, transform: o$5 } = t$7(e$9), s$6 = ``;
	if (r$8 && r$8 !== `none`) {
		let [t$13 = `0px`, n$11 = `0px`, i$8] = r$8.split(` `);
		t$13.includes(`%`) && (t$13 = `${parseFloat(t$13) / 100 * v$2(e$9)}px`), n$11.includes(`%`) && (n$11 = `${parseFloat(n$11) / 100 * _$1(e$9)}px`), i$8 ? s$6 += `translate3d(${t$13},${n$11},${i$8})` : s$6 += `translate(${t$13},${n$11})`;
	}
	if (i$7 && i$7 !== `none`) {
		let e$10 = i$7.split(` `);
		e$10.length > 1 ? s$6 += `rotate3d(${e$10.join(`,`)})` : s$6 += `rotate(${e$10.join(`,`)})`;
	}
	if (a$4 && a$4 !== `none`) {
		let e$10 = a$4.split(` `);
		e$10.length === 3 ? s$6 += `scale3d(${e$10.join(`,`)})` : s$6 += `scale(${e$10.join(`,`)})`;
	}
	return !t$12 && o$5 && o$5 !== `none` && (s$6 += o$5), s$6;
}
function b$1(e$9) {
	return typeof e$9 == `object` && !!e$9 && `x` in e$9 && `y` in e$9;
}
const x$1 = {
	x: 0,
	y: 0
...
function C$1(e$9, t$12, n$11 = {
	x: 0,
	y: 0
}) {
	let r$8 = b$1(e$9) ? e$9 : g$1(e$9, x$1), i$7 = b$1(t$12) ? t$12 : g$1(t$12, S$1);
	return n$11.x = i$7.x - r$8.x, n$11.y = i$7.y - r$8.y, n$11;
}
function w$1(e$9) {
	let t$12 = e$9.split(` `), n$11 = ``, r$8 = ``, i$7 = ``;
	return t$12.length === 1 ? n$11 = r$8 = t$12[0] : t$12.length === 2 ? [n$11, r$8] = t$12 : [n$11, r$8, i$7] = t$12, {
		x: parseFloat(n$11) || 0,
		y: parseFloat(r$8) || 0,
		z: parseFloat(i$7) || 0
	};
}
const T$1 = e$4 ? new DOMMatrix() : null;
function E$1(e$9, t$12 = new DOMMatrix()) {
	let r$8 = e$9;
	for (u$2(t$12); r$8;) {
		let e$10 = y$1(r$8);
		if (e$10 && (T$1.setMatrixValue(e$10), !T$1.isIdentity)) {
			let { transformOrigin: e$11 } = t$7(r$8), { x: i$7, y: a$4, z: o$5 } = w$1(e$11);
			o$5 === 0 ? T$1.setMatrixValue(`translate(${i$7}px,${a$4}px) ${T$1} translate(${i$7 * -1}px,${a$4 * -1}px)`) : T$1.setMatrixValue(`translate3d(${i$7}px,${a$4}px,${o$5}px) ${T$1} translate3d(${i$7 * -1}px,${a$4 * -1}px,${o$5 * -1}px)`), t$12.preMultiplySelf(T$1);
		}
		r$8 = r$8.parentElement;
	}
	return t$12;
}
const D$1 = e$4 ? h$1() : null;
var O$1 = class {
	data;
	element;
	elementContainer;
	...
	_clientOffsetCache;
	constructor(e$9, t$12) {
		if (!e$9.isConnected) throw Error(`Element is not connected`);
		let { drag: r$8 } = t$12;
		if (!r$8) throw Error(`Drag is not defined`);
		let i$7 = t$7(e$9), a$4 = e$9.getBoundingClientRect(), s$6 = y$1(e$9, !0);
		this.data = {}, this.element = e$9, this.elementTransformOrigin = w$1(i$7.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$6 + i$7.transform), this.elementOffsetMatrix = new DOMMatrix(s$6).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
			...
			x: 0,
			y: 0
		}, this._matrixCache = r$8._matrixCache, this._clientOffsetCache = r$8._clientOffsetCache;
		let c$5 = e$9.parentElement;
		if (!c$5) throw Error(`Dragged element does not have a parent element.`);
		this.elementContainer = c$5;
		let l$4 = t$12.settings.container, u$4 = (typeof l$4 == `function` ? l$4({
			draggable: t$12,
			drag: r$8,
			element: e$9
		}) : l$4) || c$5;
		if (this.dragContainer = u$4, c$5 !== u$4) {
			let { position: e$10 } = i$7;
			if (e$10 !== `fixed` && e$10 !== `absolute`) throw Error(`Dragged element has "${e$10}" position, but only "fixed" or "absolute" are allowed when using a custom drag container.`);
		}
		let d$3 = getOffsetContainer(e$9) || e$9;
		this.elementOffsetContainer = d$3, this.dragOffsetContainer = u$4 === c$5 ? d$3 : getOffsetContainer(e$9, { container: u$4 });
		{
			let { width: e$10, height: t$13, x: n$11, y: r$9 } = a$4;
			this.clientRect = {
				width: e$10,
				height: t$13,
				x: n$11,
		...
		let f$2 = t$12.settings.frozenStyles({
			draggable: t$12,
			drag: r$8,
			item: this,
			style: i$7
		...
		if (Array.isArray(f$2)) if (f$2.length) {
			let e$10 = {};
			for (let t$13 of f$2) e$10[t$13] = i$7[t$13];
			this.frozenStyles = e$10;
		} else this.frozenStyles = null;
		else this.frozenStyles = f$2;
		if (this.frozenStyles) {
			let t$13 = {};
			for (let n$11 in this.frozenStyles) t$13[n$11] = e$9.style[n$11];
			this.unfrozenStyles = t$13;
		}
	}
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$9) => {
			if (!this._matrixCache.isValid(e$9)) {
				let t$12 = this._matrixCache.get(e$9) || [new DOMMatrix(), new DOMMatrix()], [n$11, r$8] = t$12;
				E$1(e$9, n$11), r$8.setMatrixValue(n$11.toString()).invertSelf(), this._matrixCache.set(e$9, t$12);
			}
		});
	}
	_updateContainerOffset() {
		let { elementOffsetContainer: e$9, elementContainer: t$12, dragOffsetContainer: n$11, dragContainer: r$8, containerOffset: i$7, _clientOffsetCache: a$4, _matrixCache: o$5 } = this;
		if (e$9 !== n$11) {
			let [s$6, l$4] = [[r$8, n$11], [t$12, e$9]].map(([e$10, t$13]) => {
				let n$12 = a$4.get(t$13) || {
					x: 0,
					y: 0
				};
				if (!a$4.isValid(t$13)) {
					let r$9 = o$5.get(e$10);
					t$13 instanceof HTMLElement && r$9 && !r$9[0].isIdentity ? c$4(r$9[0]) ? (D$1.style.setProperty(`transform`, r$9[1].toString(), `important`), t$13.append(D$1), g$1(D$1, n$12), D$1.remove()) : (g$1(t$13, n$12), n$12.x -= r$9[0].m41, n$12.y -= r$9[0].m42) : g$1(t$13, n$12);
				}
				return a$4.set(t$13, n$12), n$12;
			});
			C$1(s$6, l$4, i$7);
		} else i$7.x = 0, i$7.y = 0;
	}
	getContainerMatrix() {
	...
	updateSize(e$9) {
		if (e$9) this.clientRect.width = e$9.width, this.clientRect.height = e$9.height;
		else {
			let { width: e$10, height: t$12 } = this.element.getBoundingClientRect();
			this.clientRect.width = e$10, this.clientRect.height = t$12;
		}
	}
};
const k$1 = {
...
var N$1 = function(e$9) {
	return e$9[e$9.None = 0] = `None`, e$9[e$9.Init = 1] = `Init`, e$9[e$9.Prepare = 2] = `Prepare`, e$9[e$9.FinishPrepare = 3] = `FinishPrepare`, e$9[e$9.Apply = 4] = `Apply`, e$9[e$9.FinishApply = 5] = `FinishApply`, e$9;
}(N$1 || {}), P = function(e$9) {
	return e$9[e$9.Pending = 0] = `Pending`, e$9[e$9.Resolved = 1] = `Resolved`, e$9[e$9.Rejected = 2] = `Rejected`, e$9;
}(P || {});
const F = {
	Start: `start`,
	Move: `move`,
	...
	elements: () => null,
	frozenStyles: () => null,
	applyPosition: ({ item: e$9, phase: t$12 }) => {
		let n$11 = t$12 === L.End || t$12 === L.EndAlign, [r$8, i$7] = e$9.getContainerMatrix(), [a$4, o$5] = e$9.getDragContainerMatrix(), { position: s$6, alignmentOffset: c$5, containerOffset: l$4, elementTransformMatrix: d$3, elementTransformOrigin: f$2, elementOffsetMatrix: p$2 } = e$9, { x: m$2, y: h$2, z: g$2 } = f$2, _$3 = !d$3.isIdentity && (m$2 !== 0 || h$2 !== 0 || g$2 !== 0), v$3 = s$6.x + c$5.x + l$4.x, y$2 = s$6.y + c$5.y + l$4.y;
		u$2(j$1), _$3 && (g$2 === 0 ? j$1.translateSelf(-m$2, -h$2) : j$1.translateSelf(-m$2, -h$2, -g$2)), n$11 ? i$7.isIdentity || j$1.multiplySelf(i$7) : o$5.isIdentity || j$1.multiplySelf(o$5), u$2(M$1).translateSelf(v$3, y$2), j$1.multiplySelf(M$1), r$8.isIdentity || j$1.multiplySelf(r$8), _$3 && (u$2(M$1).translateSelf(m$2, h$2, g$2), j$1.multiplySelf(M$1)), d$3.isIdentity || j$1.multiplySelf(d$3), p$2.isIdentity || j$1.preMultiplySelf(p$2), e$9.element.style.transform = `${j$1}`;
	},
...
var B = class {
	...
	_alignId;
	constructor(e$9, t$12 = {}) {
		let { id: n$11 = Symbol(),...r$8 } = t$12;
		this.id = n$11, this._sensors = e$9, this.settings = this._parseSettings(r$8), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N$1.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$10) => {
			this._bindSensor(e$10);
		});
	}
	get sensors() {
	...
	set sensors(e$9) {
		let t$12 = this._sensors;
		if (e$9 === t$12) return;
		let n$11 = t$12.filter((t$13) => !e$9.includes(t$13)), r$8 = e$9.filter((e$10) => !t$12.includes(e$10));
		this._sensors = e$9, n$11.forEach((e$10) => {
			this._unbindSensor(e$10);
		}), r$8.forEach((e$10) => {
			this._bindSensor(e$10);
		});
		let i$7 = this.drag?.sensor;
		i$7 && n$11.includes(i$7) && this.stop();
	}
	_bindSensor(e$9) {
		...
		let { onMove: t$12, onEnd: n$11 } = this._sensorData.get(e$9);
		e$9.on(e.Start, t$12, t$12), e$9.on(e.Move, t$12, t$12), e$9.on(e.Cancel, n$11, n$11), e$9.on(e.End, n$11, n$11), e$9.on(e.Destroy, n$11, n$11);
	}
	_unbindSensor(e$9) {
		let t$12 = this._sensorData.get(e$9);
		if (!t$12) return;
		let { onMove: n$11, onEnd: r$8 } = t$12;
		e$9.off(e.Start, n$11), e$9.off(e.Move, n$11), e$9.off(e.Cancel, r$8), e$9.off(e.End, r$8), e$9.off(e.Destroy, r$8), this._sensorData.delete(e$9);
	}
	_parseSettings(e$9, t$12 = z) {
		let { container: n$11 = t$12.container, startPredicate: r$8 = t$12.startPredicate, elements: i$7 = t$12.elements, frozenStyles: a$4 = t$12.frozenStyles, positionModifiers: o$5 = t$12.positionModifiers, applyPosition: s$6 = t$12.applyPosition, computeClientRect: c$5 = t$12.computeClientRect, sensorProcessingMode: l$4 = t$12.sensorProcessingMode, dndGroups: u$4 = t$12.dndGroups, onPrepareStart: d$3 = t$12.onPrepareStart, onStart: f$2 = t$12.onStart, onPrepareMove: p$2 = t$12.onPrepareMove, onMove: m$2 = t$12.onMove, onEnd: h$2 = t$12.onEnd, onDestroy: g$2 = t$12.onDestroy } = e$9 || {};
		return {
			container: n$11,
			startPredicate: r$8,
			elements: i$7,
	...
	_emit(e$9, ...t$12) {
		this._emitter.emit(e$9, ...t$12);
	}
	_onMove(n$11, r$8) {
		let i$7 = this._sensorData.get(r$8);
		if (i$7) switch (i$7.predicateState) {
			case P.Pending: {
				i$7.predicateEvent = n$11;
				let e$9 = this.settings.startPredicate({
					draggable: this,
					sensor: r$8,
					event: n$11
				});
				e$9 === !0 ? this.resolveStartPredicate(r$8) : e$9 === !1 && this.rejectStartPredicate(r$8);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = n$11, this.settings.sensorProcessingMode === I.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$4.read, this._prepareMove, this._moveId), r$5.once(n$4.write, this._applyMove, this._moveId)));
				break;
		}
	}
	_onScroll() {
	...
	_onEnd(e$9, t$12) {
		let n$11 = this._sensorData.get(t$12);
		n$11 && (this.drag ? n$11.predicateState === P.Resolved && (this.drag.endEvent = e$9, this._sensorData.forEach((e$10) => {
			e$10.predicateState = P.Pending, e$10.predicateEvent = null;
		}), this.stop()) : (n$11.predicateState = P.Pending, n$11.predicateEvent = null));
	}
	_prepareStart() {
		let e$9 = this.drag;
		!e$9 || this._startPhase !== N$1.Init || (this._startPhase = N$1.Prepare, e$9.items = (this.settings.elements({
			draggable: this,
			drag: e$9
		}) || []).map((e$10) => new O$1(e$10, this)), this._applyModifiers(F.Start, 0, 0), this._emit(R.PrepareStart, e$9, this), this.settings.onPrepareStart?.(e$9, this), this._startPhase = N$1.FinishPrepare);
	}
	_applyStart() {
		let e$9 = this.drag;
		if (!(!e$9 || this._startPhase !== N$1.FinishPrepare)) {
			this._startPhase = N$1.Apply;
			for (let t$12 of e$9.items) t$12.dragContainer !== t$12.elementContainer && l$2(t$12.dragContainer, t$12.element), t$12.frozenStyles && Object.assign(t$12.element.style, t$12.frozenStyles), this.settings.applyPosition({
				phase: L.Start,
				draggable: this,
				drag: e$9,
				item: t$12
			});
			for (let t$12 of e$9.items) {
				let e$10 = t$12.getContainerMatrix()[0], n$11 = t$12.getDragContainerMatrix()[0];
				if (s$5(e$10, n$11) || !c$4(e$10) && !c$4(n$11)) continue;
				let r$8 = t$12.element.getBoundingClientRect(), { alignmentOffset: i$7 } = t$12;
				i$7.x += d$2(t$12.clientRect.x - r$8.x, 3), i$7.y += d$2(t$12.clientRect.y - r$8.y, 3);
			}
			for (let t$12 of e$9.items) {
				let { alignmentOffset: n$11 } = t$12;
				(n$11.x !== 0 || n$11.y !== 0) && this.settings.applyPosition({
					phase: L.StartAlign,
					draggable: this,
					drag: e$9,
					item: t$12
			...
			window.addEventListener(`scroll`, this._onScroll, k$1), this._emit(R.Start, e$9, this), this.settings.onStart?.(e$9, this), this._startPhase = N$1.FinishApply;
		}
	}
	_prepareMove() {
		let e$9 = this.drag;
		if (!e$9 || e$9.isEnded) return;
		let { moveEvent: t$12, prevMoveEvent: n$11 } = e$9;
		t$12 !== n$11 && (this._applyModifiers(F.Move, t$12.x - n$11.x, t$12.y - n$11.y), this._emit(R.PrepareMove, e$9, this), !e$9.isEnded && (this.settings.onPrepareMove?.(e$9, this), !e$9.isEnded && (e$9.prevMoveEvent = t$12)));
	}
	_applyMove() {
		let e$9 = this.drag;
		if (!(!e$9 || e$9.isEnded)) {
			for (let t$12 of e$9.items) t$12._moveDiff.x = 0, t$12._moveDiff.y = 0, this.settings.applyPosition({
				phase: L.Move,
				draggable: this,
				drag: e$9,
				item: t$12
			});
			this._emit(R.Move, e$9, this), !e$9.isEnded && this.settings.onMove?.(e$9, this);
		}
	}
	_prepareAlign() {
		let { drag: e$9 } = this;
		if (!(!e$9 || e$9.isEnded)) for (let t$12 of e$9.items) {
			let { x: e$10, y: n$11 } = t$12.element.getBoundingClientRect(), r$8 = t$12.clientRect.x - t$12._moveDiff.x - e$10;
			t$12.alignmentOffset.x = t$12.alignmentOffset.x - t$12._alignDiff.x + r$8, t$12._alignDiff.x = r$8;
			let i$7 = t$12.clientRect.y - t$12._moveDiff.y - n$11;
			t$12.alignmentOffset.y = t$12.alignmentOffset.y - t$12._alignDiff.y + i$7, t$12._alignDiff.y = i$7;
		}
	}
	_applyAlign() {
		let { drag: e$9 } = this;
		if (!(!e$9 || e$9.isEnded)) for (let t$12 of e$9.items) t$12._alignDiff.x = 0, t$12._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$9,
			item: t$12
	...
	_applyModifiers(e$9, t$12, n$11) {
		let { drag: r$8 } = this;
		if (!r$8) return;
		let { positionModifiers: i$7 } = this.settings;
		for (let a$4 of r$8.items) {
			let o$5 = A$1;
			o$5.x = t$12, o$5.y = n$11;
			for (let t$13 of i$7) o$5 = t$13(o$5, {
				draggable: this,
				drag: r$8,
				item: a$4,
				phase: e$9
			});
			a$4.position.x += o$5.x, a$4.position.y += o$5.y, a$4.clientRect.x += o$5.x, a$4.clientRect.y += o$5.y, e$9 === `move` && (a$4._moveDiff.x += o$5.x, a$4._moveDiff.y += o$5.y);
		}
	}
	on(e$9, t$12, n$11) {
		return this._emitter.on(e$9, t$12, n$11);
	}
	off(e$9, t$12) {
		this._emitter.off(e$9, t$12);
	}
	resolveStartPredicate(n$11, r$8) {
		let i$7 = this._sensorData.get(n$11);
		if (!i$7) return;
		let a$4 = r$8 || i$7.predicateEvent;
		i$7.predicateState === P.Pending && a$4 && (this._startPhase = N$1.Init, i$7.predicateState = P.Resolved, i$7.predicateEvent = null, this.drag = new p$1(n$11, a$4), this._sensorData.forEach((e$9, t$12) => {
			t$12 !== n$11 && (e$9.predicateState = P.Rejected, e$9.predicateEvent = null);
		}), this.settings.sensorProcessingMode === I.Immediate ? (this._prepareStart(), this._applyStart()) : (r$5.once(n$4.read, this._prepareStart, this._startId), r$5.once(n$4.write, this._applyStart, this._startId)));
	}
	rejectStartPredicate(e$9) {
		let t$12 = this._sensorData.get(e$9);
		t$12?.predicateState === P.Pending && (t$12.predicateState = P.Rejected, t$12.predicateEvent = null);
	}
	stop() {
		let n$11 = this.drag;
		if (!(!n$11 || n$11.isEnded)) {
			if (this._startPhase === N$1.Prepare || this._startPhase === N$1.Apply) throw Error(`Cannot stop drag start process at this point`);
			n$11.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N$1.None, r$5.off(n$4.read, this._startId), r$5.off(n$4.write, this._startId), r$5.off(n$4.read, this._moveId), r$5.off(n$4.write, this._moveId), r$5.off(n$4.read, this._alignId), r$5.off(n$4.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k$1), this._applyModifiers(F.End, 0, 0);
			for (let e$9 of n$11.items) {
				if (e$9.elementContainer !== e$9.dragContainer && (l$2(e$9.elementContainer, e$9.element), e$9.alignmentOffset.x = 0, e$9.alignmentOffset.y = 0, e$9.containerOffset.x = 0, e$9.containerOffset.y = 0), e$9.unfrozenStyles) for (let t$12 in e$9.unfrozenStyles) e$9.element.style[t$12] = e$9.unfrozenStyles[t$12] || ``;
			...
			for (let e$9 of n$11.items) if (e$9.elementContainer !== e$9.dragContainer) {
				let t$12 = e$9.element.getBoundingClientRect();
				e$9.alignmentOffset.x = d$2(e$9.clientRect.x - t$12.x, 3), e$9.alignmentOffset.y = d$2(e$9.clientRect.y - t$12.y, 3);
			}
			for (let e$9 of n$11.items) e$9.elementContainer !== e$9.dragContainer && (e$9.alignmentOffset.x !== 0 || e$9.alignmentOffset.y !== 0) && this.settings.applyPosition({
				phase: L.EndAlign,
				draggable: this,
				drag: n$11,
				item: e$9
			});
			this._emit(R.End, n$11, this), this.settings.onEnd?.(n$11, this), this.drag = null;
		}
	}
	align(n$11 = !1) {
		!this.drag || this.drag.isEnded || (n$11 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$4.read, this._prepareAlign, this._alignId), r$5.once(n$4.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
		let { drag: e$9, settings: t$12 } = this;
		return e$9 && t$12.computeClientRect?.({
			draggable: this,
			drag: e$9
		}) || null;
	}
	updateSettings(e$9) {
		this.settings = this._parseSettings(e$9, this.settings);
	}
	use(e$9) {
		return e$9(this);
	}
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensors.forEach((e$9) => {
...
const e$3 = Object.prototype.hasOwnProperty, t$6 = (e$9) => {
	if (typeof e$9 != `object` || !e$9) return !1;
	let t$12 = Object.getPrototypeOf(e$9);
	return t$12 === Object.prototype || t$12 === null;
};
function n$7(r$8, i$7) {
	if (Object.is(r$8, i$7)) return !0;
	if (r$8 === null || i$7 === null || typeof r$8 != `object` || typeof i$7 != `object`) return !1;
	let a$4 = Array.isArray(r$8), o$5 = Array.isArray(i$7);
	if (a$4 || o$5) {
		if (!a$4 || !o$5) return !1;
		let e$9 = r$8.length;
		if (e$9 !== i$7.length) return !1;
		for (let t$12 = 0; t$12 < e$9; t$12++) if (!n$7(r$8[t$12], i$7[t$12])) return !1;
		return !0;
	}
	let s$6 = r$8 instanceof Set, c$5 = i$7 instanceof Set;
	if (s$6 || c$5) return !s$6 || !c$5 || r$8.size !== i$7.size ? !1 : r$8.isSubsetOf(i$7);
	if (!t$6(r$8) || !t$6(i$7)) return !1;
	let l$4 = Object.keys(r$8), u$4 = Object.keys(i$7);
	if (l$4.length !== u$4.length) return !1;
	for (let t$12 = 0; t$12 < l$4.length; t$12++) {
		let a$5 = l$4[t$12];
		if (!e$3.call(i$7, a$5) || !n$7(r$8[a$5], i$7[a$5])) return !1;
	}
	return !0;
}
...
function t$5(e$9, t$12) {
	if (e$9 === t$12) return !0;
	if (e$9.length !== t$12.length) return !1;
	for (let n$11 = 0; n$11 < e$9.length; n$11++) if (!Object.is(e$9[n$11], t$12[n$11])) return !1;
	return !0;
}
function n$1(n$11, r$8) {
	let i$7 = (0, import_react.useRef)(null), a$4 = i$7.current || {
		deps: r$8,
		value: n$11()
	};
	return i$7.current ? t$5(r$8, a$4.deps) || (a$4.deps = r$8, a$4.value = n$11()) : i$7.current = a$4, a$4.value;
}
function r$1(e$9, t$12) {
	return n$1(() => e$9, t$12);
}
...
function c(c$5, l$4) {
	let u$4 = n$1(() => c$5.filter((e$9) => !!e$9), [...c$5]), { id: d$3, dndObserver: f$2,...p$2 } = l$4 || {}, m$2 = n$1(() => d$3 === void 0 ? Symbol() : d$3, [d$3]), h$2 = n$10(), g$2 = f$2 === void 0 ? h$2 : f$2, [_$3, v$3] = (0, import_react.useState)(null), y$2 = (0, import_react.useRef)(null), b$2 = (0, import_react.useRef)(u$4);
	b$2.current = u$4;
	let x$2 = (0, import_react.useRef)(p$2);
	x$2.current = p$2;
	let S$2 = (0, import_react.useRef)(g$2);
	S$2.current = g$2;
	let C$2 = (0, import_react.useRef)(void 0), w$2 = r$1(() => {
		let e$9 = y$2.current;
	...
	return n(() => {
		...
		if (_$3) return g$2?.addDraggables([_$3]), () => {
			g$2?.removeDraggables([_$3]);
		};
	}, [_$3, g$2]), n(() => {
		if (!_$3) return;
		let e$9 = x$2.current;
		C$2.current !== e$9 && (n$7(C$2.current, e$9) || (_$3.updateSettings(_$3._parseSettings(e$9)), C$2.current && e$9.dndGroups !== C$2.current.dndGroups && S$2.current?.clearTargets(_$3)), C$2.current = e$9);
	}, [_$3, l$4]), n(() => w$2, [w$2]), _$3;
}

//#endregion
//#region ../dragdoll/dist/create-full-rect-Dd45f4o1.js
function e$1(e$9, t$12 = {
	width: 0,
	height: 0,
	x: 0,
	y: 0,
	...
	return e$9 && (t$12.width = e$9.width, t$12.height = e$9.height, t$12.x = e$9.x, t$12.y = e$9.y, t$12.left = e$9.x, t$12.top = e$9.y, t$12.right = e$9.x + e$9.width, t$12.bottom = e$9.y + e$9.height), t$12;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/isDocument.js
function isDocument(n$11) {
	return n$11 instanceof Document;
}
...
function getSubpixelScrollbarSize(t$12, e$9) {
	const n$11 = t$12.split(".");
	let l$4 = SUBPIXEL_OFFSET.get(n$11[1]);
	if (void 0 === l$4) {
		testStyleElement || (testStyleElement = document.createElement("style")), testStyleElement.innerHTML = `\n      #mezr-scrollbar-test::-webkit-scrollbar {\n        width: ${t$12} !important;\n      }\n    `, testParentElement && testChildElement || (testParentElement = document.createElement("div"), testChildElement = document.createElement("div"), testParentElement.appendChild(testChildElement), testParentElement.id = "mezr-scrollbar-test", testParentElement.style.cssText = "\n        all: unset !important;\n        position: fixed !important;\n        top: -200px !important;\n        left: 0px !important;\n        width: 100px !important;\n        height: 100px !important;\n        overflow: scroll !important;\n        pointer-events: none !important;\n        visibility: hidden !important;\n      ", testChildElement.style.cssText = "\n        all: unset !important;\n        position: absolute !important;\n        inset: 0 !important;\n      "), document.body.appendChild(testStyleElement), document.body.appendChild(testParentElement);
		l$4 = testParentElement.getBoundingClientRect().width - testChildElement.getBoundingClientRect().width - e$9, SUBPIXEL_OFFSET.set(n$11[1], l$4), document.body.removeChild(testParentElement), document.body.removeChild(testStyleElement);
	}
	return e$9 + l$4;
}
function getPreciseScrollbarSize(t$12, e$9, n$11) {
	if (n$11 <= 0) return 0;
	if (IS_CHROMIUM) {
		const n$12 = getStyle(t$12, "::-webkit-scrollbar"), l$4 = "x" === e$9 ? n$12.height : n$12.width, i$7 = parseFloat(l$4);
		if (!Number.isNaN(i$7) && !Number.isInteger(i$7)) return getSubpixelScrollbarSize(l$4, i$7);
	}
	return n$11;
}
...
function getWindowWidth(e$9, r$8 = !1) {
	if (r$8) return e$9.innerWidth;
	const { innerWidth: t$12, document: i$7 } = e$9, { documentElement: n$11 } = i$7, { clientWidth: c$5 } = n$11;
	return t$12 - getPreciseScrollbarSize(n$11, "y", t$12 - c$5);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getDocumentWidth.js
function getDocumentWidth({ documentElement: t$12 }) {
	return Math.max(t$12.scrollWidth, t$12.clientWidth, t$12.getBoundingClientRect().width);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getElementWidth.js
function getElementWidth(t$12, e$9 = BOX_EDGE.border) {
	let { width: r$8 } = t$12.getBoundingClientRect();
	if (e$9 === BOX_EDGE.border) return r$8;
	const o$5 = getStyle(t$12);
	return e$9 === BOX_EDGE.margin ? (r$8 += Math.max(0, parseFloat(o$5.marginLeft) || 0), r$8 += Math.max(0, parseFloat(o$5.marginRight) || 0), r$8) : (r$8 -= parseFloat(o$5.borderLeftWidth) || 0, r$8 -= parseFloat(o$5.borderRightWidth) || 0, e$9 === BOX_EDGE.scrollbar ? r$8 : (!isDocumentElement(t$12) && SCROLLABLE_OVERFLOWS.has(o$5.overflowY) && (r$8 -= getPreciseScrollbarSize(t$12, "y", Math.round(r$8) - t$12.clientWidth)), e$9 === BOX_EDGE.padding || (r$8 -= parseFloat(o$5.paddingLeft) || 0, r$8 -= parseFloat(o$5.paddingRight) || 0), r$8));
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getWidth.js
function getWidth(t$12, i$7 = BOX_EDGE.border) {
	return isWindow(t$12) ? getWindowWidth(t$12, INCLUDE_WINDOW_SCROLLBAR[i$7]) : isDocument(t$12) ? getDocumentWidth(t$12) : getElementWidth(t$12, i$7);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getWindowHeight.js
function getWindowHeight(e$9, r$8 = !1) {
	if (r$8) return e$9.innerHeight;
	const { innerHeight: t$12, document: i$7 } = e$9, { documentElement: n$11 } = i$7, { clientHeight: c$5 } = n$11;
	return t$12 - getPreciseScrollbarSize(n$11, "x", t$12 - c$5);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getDocumentHeight.js
function getDocumentHeight({ documentElement: t$12 }) {
	return Math.max(t$12.scrollHeight, t$12.clientHeight, t$12.getBoundingClientRect().height);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getElementHeight.js
function getElementHeight(t$12, e$9 = BOX_EDGE.border) {
	let { height: r$8 } = t$12.getBoundingClientRect();
	if (e$9 === BOX_EDGE.border) return r$8;
	const o$5 = getStyle(t$12);
	return e$9 === BOX_EDGE.margin ? (r$8 += Math.max(0, parseFloat(o$5.marginTop) || 0), r$8 += Math.max(0, parseFloat(o$5.marginBottom) || 0), r$8) : (r$8 -= parseFloat(o$5.borderTopWidth) || 0, r$8 -= parseFloat(o$5.borderBottomWidth) || 0, e$9 === BOX_EDGE.scrollbar ? r$8 : (!isDocumentElement(t$12) && SCROLLABLE_OVERFLOWS.has(o$5.overflowX) && (r$8 -= getPreciseScrollbarSize(t$12, "x", Math.round(r$8) - t$12.clientHeight)), e$9 === BOX_EDGE.padding || (r$8 -= parseFloat(o$5.paddingTop) || 0, r$8 -= parseFloat(o$5.paddingBottom) || 0), r$8));
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getHeight.js
function getHeight(t$12, e$9 = BOX_EDGE.border) {
	return isWindow(t$12) ? getWindowHeight(t$12, INCLUDE_WINDOW_SCROLLBAR[e$9]) : isDocument(t$12) ? getDocumentHeight(t$12) : getElementHeight(t$12, e$9);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/isRectObject.js
function isRectObject(t$12) {
	return t$12?.constructor === Object;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getOffsetFromDocument.js
function getOffsetFromDocument(t$12, o$5 = BOX_EDGE.border) {
	const e$9 = {
		left: 0,
		top: 0
	};
	if (isDocument(t$12)) return e$9;
	if (isWindow(t$12)) return e$9.left += t$12.scrollX || 0, e$9.top += t$12.scrollY || 0, e$9;
	const r$8 = t$12.ownerDocument.defaultView;
	r$8 && (e$9.left += r$8.scrollX || 0, e$9.top += r$8.scrollY || 0);
	const n$11 = t$12.getBoundingClientRect();
	if (e$9.left += n$11.left, e$9.top += n$11.top, o$5 === BOX_EDGE.border) return e$9;
	const l$4 = getStyle(t$12);
	return o$5 === BOX_EDGE.margin ? (e$9.left -= Math.max(0, parseFloat(l$4.marginLeft) || 0), e$9.top -= Math.max(0, parseFloat(l$4.marginTop) || 0), e$9) : (e$9.left += parseFloat(l$4.borderLeftWidth) || 0, e$9.top += parseFloat(l$4.borderTopWidth) || 0, o$5 === BOX_EDGE.scrollbar || o$5 === BOX_EDGE.padding || (e$9.left += parseFloat(l$4.paddingLeft) || 0, e$9.top += parseFloat(l$4.paddingTop) || 0), e$9);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getOffset.js
function getOffset(t$12, e$9) {
	const o$5 = isRectObject(t$12) ? {
		left: t$12.left,
		top: t$12.top
	} : Array.isArray(t$12) ? getOffsetFromDocument(...t$12) : getOffsetFromDocument(t$12);
	if (e$9 && !isDocument(e$9)) {
		const t$13 = isRectObject(e$9) ? e$9 : Array.isArray(e$9) ? getOffsetFromDocument(e$9[0], e$9[1]) : getOffsetFromDocument(e$9);
		o$5.left -= t$13.left, o$5.top -= t$13.top;
	}
	return o$5;
}
...
function getRect(t$12, e$9) {
	let i$7 = 0, g$2 = 0;
	isRectObject(t$12) ? (i$7 = t$12.width, g$2 = t$12.height) : Array.isArray(t$12) ? (i$7 = getWidth(...t$12), g$2 = getHeight(...t$12)) : (i$7 = getWidth(t$12), g$2 = getHeight(t$12));
	const r$8 = getOffset(t$12, e$9);
	return {
		width: i$7,
		height: g$2,
		...r$8,
...
function t$4(...t$12) {
	let { width: n$11, height: r$8, left: i$7, top: a$4 } = getRect(...t$12);
	return {
		width: n$11,
		height: r$8,
		x: i$7,
...
function isIntersecting(t$12, e$9) {
	return !(t$12.left + t$12.width <= e$9.left || e$9.left + e$9.width <= t$12.left || t$12.top + t$12.height <= e$9.top || e$9.top + e$9.height <= t$12.top);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getDistanceBetweenPoints.js
function getDistanceBetweenPoints(t$12, e$9, n$11, o$5) {
	return Math.sqrt(Math.pow(n$11 - t$12, 2) + Math.pow(o$5 - e$9, 2));
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getDistanceBetweenRects.js
function getDistanceBetweenRects(t$12, e$9) {
	if (isIntersecting(t$12, e$9)) return null;
	const n$11 = t$12.left + t$12.width, i$7 = t$12.top + t$12.height, o$5 = e$9.left + e$9.width, s$6 = e$9.top + e$9.height;
	return n$11 <= e$9.left ? i$7 <= e$9.top ? getDistanceBetweenPoints(n$11, i$7, e$9.left, e$9.top) : t$12.top >= s$6 ? getDistanceBetweenPoints(n$11, t$12.top, e$9.left, s$6) : e$9.left - n$11 : t$12.left >= o$5 ? i$7 <= e$9.top ? getDistanceBetweenPoints(t$12.left, i$7, o$5, e$9.top) : t$12.top >= s$6 ? getDistanceBetweenPoints(t$12.left, t$12.top, o$5, s$6) : t$12.left - o$5 : i$7 <= e$9.top ? e$9.top - i$7 : t$12.top - s$6;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getNormalizedRect.js
function getNormalizedRect(t$12) {
	return isRectObject(t$12) ? t$12 : getRect(t$12);
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/getDistance.js
function getDistance(e$9, t$12) {
	return getDistanceBetweenRects(getNormalizedRect(e$9), getNormalizedRect(t$12));
}

//#endregion
//#region ../dragdoll/dist/auto-scroll-uAZMypL4.js
const o$2 = e$1(), s$4 = e$1();
function c$3(e$9, t$12) {
	return getDistance(e$1(e$9, o$2), e$1(t$12, s$4));
}
function l$1(e$9) {
	return e$9 instanceof Window;
}
function u$1(e$9) {
	return l$1(e$9) || e$9 === document.documentElement || e$9 === document.body ? window : e$9;
}
function d$1(e$9) {
	return l$1(e$9) ? e$9.scrollX : e$9.scrollLeft;
}
function f(e$9) {
	return l$1(e$9) && (e$9 = document.documentElement), e$9.scrollWidth - e$9.clientWidth;
}
function p(e$9) {
	return l$1(e$9) ? e$9.scrollY : e$9.scrollTop;
}
function m(e$9) {
	return l$1(e$9) && (e$9 = document.documentElement), e$9.scrollHeight - e$9.clientHeight;
}
function h(e$9, t$12) {
	return !(e$9.x + e$9.width <= t$12.x || t$12.x + t$12.width <= e$9.x || e$9.y + e$9.height <= t$12.y || t$12.y + t$12.height <= e$9.y);
}
var g = class {
	_batchSize;
	_maxSize;
	...
	_getItem;
	_onRelease;
	constructor(e$9, { batchSize: t$12 = 100, minBatchCount: n$11 = 0, maxBatchCount: r$8 = 2 ** 53 - 1, initialBatchCount: i$7 = 0, shrinkThreshold: a$4 = 2, onRelease: o$5 } = {}) {
		this._batchSize = Math.floor(Math.max(t$12, 1)), this._minSize = Math.floor(Math.max(n$11, 0)) * this._batchSize, this._maxSize = Math.floor(Math.min(Math.max(r$8 * this._batchSize, this._batchSize), 2 ** 53 - 1)), this._shrinkThreshold = Math.floor(Math.max(a$4, 1) * this._batchSize), this._data = Array(Math.floor(Math.max(Math.max(i$7, n$11) * this._batchSize, 0))), this._index = 0, this._getItem = e$9, this._onRelease = o$5;
	}
	get(...e$9) {
		if (this._index > 0) return this._getItem(this._data[--this._index], ...e$9);
		if (this._index === 0) {
			let e$10 = this._data.length, t$12 = Math.min(this._batchSize, this._maxSize - e$10);
			t$12 > 0 && (this._data.length = e$10 + t$12);
		}
		return this._getItem(void 0, ...e$9);
	}
	release(e$9) {
		if (this._index < this._maxSize && (this._onRelease && this._onRelease(e$9), this._data[this._index++] = e$9, this._index >= this._shrinkThreshold)) {
			let e$10 = this._data.length - this._batchSize;
			e$10 >= this._minSize && (this._data.length = e$10, this._index -= this._batchSize);
		}
	}
	destroy() {
...
function w(e$9) {
	switch (e$9) {
		...
		default: throw Error(`Unknown direction value: ${e$9}`);
	}
}
function T(e$9, t$12, n$11) {
	let { left: r$8 = 0, right: i$7 = 0, top: a$4 = 0, bottom: o$5 = 0 } = t$12;
	return r$8 = Math.max(0, r$8), i$7 = Math.max(0, i$7), a$4 = Math.max(0, a$4), o$5 = Math.max(0, o$5), n$11.width = e$9.width + r$8 + i$7, n$11.height = e$9.height + a$4 + o$5, n$11.x = e$9.x - r$8, n$11.y = e$9.y - a$4, n$11;
}
function E(e$9, t$12) {
	return Math.ceil(e$9) >= Math.floor(t$12);
}
function D(e$9, t$12) {
	return Math.min(t$12 / 2, e$9);
}
function O(e$9, t$12, n$11, r$8) {
	return Math.max(0, n$11 + e$9 * 2 + r$8 * t$12 - r$8) / 2;
}
var k = class {
	positionX;
	positionY;
	...
	addRequest(e$9) {
		y.x & e$9.direction ? (this.requestX && this.removeRequest(this.requestX), this.requestX = e$9) : (this.requestY && this.removeRequest(this.requestY), this.requestY = e$9), e$9.action = this;
	}
	removeRequest(e$9) {
		this.requestX === e$9 ? (this.requestX = null, e$9.action = null) : this.requestY === e$9 && (this.requestY = null, e$9.action = null);
	}
	computeScrollValues() {
		this.element && (this.scrollLeft = this.requestX ? this.requestX.value : d$1(this.element), this.scrollTop = this.requestY ? this.requestY.value : p(this.element));
	}
	scroll() {
	...
	computeCurrentScrollValue() {
		return this.element ? this.value === this.value ? Math.max(0, Math.min(this.value, this.maxValue)) : y.x & this.direction ? d$1(this.element) : p(this.element) : 0;
	}
	computeNextScrollValue() {
		let e$9 = this.speed * (this.deltaTime / 1e3), t$12 = b.forward & this.direction ? this.value + e$9 : this.value - e$9;
		return Math.max(0, Math.min(t$12, this.maxValue));
	}
	computeSpeed() {
		if (!this.item || !this.element) return 0;
		let { speed: e$9 } = this.item;
		return typeof e$9 == `function` ? (v$1.direction = w(this.direction), v$1.threshold = this.threshold, v$1.distance = this.distance, v$1.value = this.value, v$1.maxValue = this.maxValue, v$1.duration = this.duration, v$1.speed = this.speed, v$1.deltaTime = this.deltaTime, v$1.isEnding = this.isEnding, e$9(this.element, v$1)) : e$9;
	}
	tick(e$9) {
		return this.isActive || (this.isActive = !0, this.onStart()), this.deltaTime = e$9, this.value = this.computeCurrentScrollValue(), this.speed = this.computeSpeed(), this.value = this.computeNextScrollValue(), this.duration += e$9, this.value;
	}
	onStart() {
		if (!this.item || !this.element) return;
		let { onStart: e$9 } = this.item;
		typeof e$9 == `function` && e$9(this.element, w(this.direction));
	}
	onStop() {
		if (!this.item || !this.element) return;
		let { onStop: e$9 } = this.item;
		typeof e$9 == `function` && e$9(this.element, w(this.direction));
	}
};
function M(e$9 = 500, t$12 = .5, n$11 = .25) {
	let r$8 = e$9 * (t$12 > 0 ? 1 / t$12 : Infinity), i$7 = e$9 * (n$11 > 0 ? 1 / n$11 : Infinity);
	return function(t$13, n$12) {
		let a$4 = 0;
		if (!n$12.isEnding) if (n$12.threshold > 0) {
			let t$14 = n$12.threshold - Math.max(0, n$12.distance);
			a$4 = e$9 / n$12.threshold * t$14;
		} else a$4 = e$9;
		let o$5 = n$12.speed;
		if (o$5 === a$4) return a$4;
		let s$6 = a$4;
		return o$5 < a$4 ? (s$6 = o$5 + r$8 * (n$12.deltaTime / 1e3), Math.min(a$4, s$6)) : (s$6 = o$5 - i$7 * (n$12.deltaTime / 1e3), Math.max(a$4, s$6));
	};
}
var N = class {
	items;
	...
	_actionPool;
	constructor(e$9 = {}) {
		let { overlapCheckInterval: t$12 = 150 } = e$9;
		this.items = [], this.settings = { overlapCheckInterval: t$12 }, this._actions = [], this._isDestroyed = !1, this._isTicking = !1, this._tickTime = 0, this._tickDeltaTime = 0, this._requests = {
			[y.x]: /* @__PURE__ */ new Map(),
			[y.y]: /* @__PURE__ */ new Map()
		}, this._itemData = /* @__PURE__ */ new Map(), this._requestPool = new g((e$10) => e$10 || new j(), {
			initialBatchCount: 1,
			minBatchCount: 1,
			onRelease: (e$10) => e$10.reset()
		}), this._actionPool = new g((e$10) => e$10 || new A(), {
			batchSize: 10,
			initialBatchCount: 1,
			minBatchCount: 1,
			onRelease: (e$10) => e$10.reset()
	...
	_frameRead(e$9) {
		this._isDestroyed || (e$9 && this._tickTime ? (this._tickDeltaTime = e$9 - this._tickTime, this._tickTime = e$9, this._updateItems(), this._updateRequests(), this._updateActions()) : (this._tickTime = e$9, this._tickDeltaTime = 0));
	}
	_frameWrite() {
		this._isDestroyed || this._applyActions();
	}
	_startTicking() {
		this._isTicking || (this._isTicking = !0, r$5.on(n$4.read, this._frameRead, this._frameRead), r$5.on(n$4.write, this._frameWrite, this._frameWrite));
	}
	_stopTicking() {
		this._isTicking && (this._isTicking = !1, this._tickTime = 0, this._tickDeltaTime = 0, r$5.off(n$4.read, this._frameRead), r$5.off(n$4.write, this._frameWrite));
	}
	_requestItemScroll(e$9, t$12, n$11, r$8, i$7, a$4, o$5) {
		let s$6 = this._requests[t$12], c$5 = s$6.get(e$9);
		c$5 ? (c$5.element !== n$11 || c$5.direction !== r$8) && c$5.reset() : (c$5 = this._requestPool.get(), s$6.set(e$9, c$5)), c$5.item = e$9, c$5.element = n$11, c$5.direction = r$8, c$5.threshold = i$7, c$5.distance = a$4, c$5.maxValue = o$5;
	}
	_cancelItemScroll(e$9, t$12) {
		let n$11 = this._requests[t$12], r$8 = n$11.get(e$9);
		r$8 && (r$8.action && r$8.action.removeRequest(r$8), this._requestPool.release(r$8), n$11.delete(e$9));
	}
	_checkItemOverlap(e$9, t$12, n$11) {
		let { inertAreaSize: a$4, targets: o$5, clientRect: s$6 } = e$9;
		if (!o$5.length) {
			t$12 && this._cancelItemScroll(e$9, y.x), n$11 && this._cancelItemScroll(e$9, y.y);
			return;
		}
		let l$4 = this._itemData.get(e$9), g$2 = l$4?.directionX, v$3 = l$4?.directionY;
		if (!g$2 && !v$3) {
			t$12 && this._cancelItemScroll(e$9, y.x), n$11 && this._cancelItemScroll(e$9, y.y);
			return;
		}
		let b$2 = null, x$2 = -Infinity, w$2 = 0, k$2 = -Infinity, A$2 = C.none, j$2 = 0, M$2 = 0, N$2 = null, P$1 = -Infinity, F$1 = 0, I$1 = -Infinity, L$1 = C.none, R$1 = 0, z$1 = 0, B$1 = 0;
		for (; B$1 < o$5.length; B$1++) {
			let e$10 = o$5[B$1], l$5 = typeof e$10.threshold == `number` ? e$10.threshold : 50, y$2 = !!(t$12 && g$2 && e$10.axis !== `y`), V = !!(n$11 && v$3 && e$10.axis !== `x`), H = e$10.priority || 0;
			if ((!y$2 || H < x$2) && (!V || H < P$1)) continue;
			let U = u$1(e$10.element || e$10), W = y$2 ? f(U) : -1, G = V ? m(U) : -1;
			if (W <= 0 && G <= 0) continue;
			let K = t$4([U, `padding`], window), q = n$9(s$6, K) || -Infinity;
			if (q === -Infinity) if (e$10.padding && h(s$6, T(K, e$10.padding, _))) q = -(c$3(s$6, K) || 0);
			else continue;
			if (y$2 && H >= x$2 && W > 0 && (H > x$2 || q > k$2)) {
				let e$11 = 0, t$13 = C.none, n$12 = D(l$5, K.width), r$8 = O(n$12, a$4, s$6.width, K.width);
				g$2 === C.right ? (e$11 = K.x + K.width + r$8 - (s$6.x + s$6.width), e$11 <= n$12 && !E(d$1(U), W) && (t$13 = C.right)) : g$2 === C.left && (e$11 = s$6.x - (K.x - r$8), e$11 <= n$12 && d$1(U) > 0 && (t$13 = C.left)), t$13 && (b$2 = U, x$2 = H, w$2 = n$12, k$2 = q, A$2 = t$13, j$2 = e$11, M$2 = W);
			}
			if (V && H >= P$1 && G > 0 && (H > P$1 || q > I$1)) {
				let e$11 = 0, t$13 = S.none, n$12 = D(l$5, K.height), r$8 = O(n$12, a$4, s$6.height, K.height);
				v$3 === C.down ? (e$11 = K.y + K.height + r$8 - (s$6.y + s$6.height), e$11 <= n$12 && !E(p(U), G) && (t$13 = C.down)) : v$3 === C.up && (e$11 = s$6.y - (K.y - r$8), e$11 <= n$12 && p(U) > 0 && (t$13 = C.up)), t$13 && (N$2 = U, P$1 = H, F$1 = n$12, I$1 = q, L$1 = t$13, R$1 = e$11, z$1 = G);
			}
		}
		t$12 && (b$2 && A$2 ? this._requestItemScroll(e$9, y.x, b$2, A$2, w$2, j$2, M$2) : this._cancelItemScroll(e$9, y.x)), n$11 && (N$2 && L$1 ? this._requestItemScroll(e$9, y.y, N$2, L$1, F$1, R$1, z$1) : this._cancelItemScroll(e$9, y.y));
	}
	_updateScrollRequest(e$9) {
		let { inertAreaSize: t$12, smoothStop: n$11, targets: a$4, clientRect: o$5 } = e$9.item, s$6 = null, c$5 = 0;
		for (; c$5 < a$4.length; c$5++) {
			let n$12 = a$4[c$5], l$4 = u$1(n$12.element || n$12);
			if (l$4 !== e$9.element) continue;
			let g$2 = !!(y.x & e$9.direction);
			if (g$2) {
				if (n$12.axis === `y`) continue;
			} else if (n$12.axis === `x`) continue;
			let v$3 = g$2 ? f(l$4) : m(l$4);
			if (v$3 <= 0) break;
			let x$2 = t$4([l$4, `padding`], window);
			if ((n$9(o$5, x$2) || -Infinity) === -Infinity) {
				let e$10 = n$12.scrollPadding || n$12.padding;
				if (!(e$10 && h(o$5, T(x$2, e$10, _)))) break;
			}
			let S$2 = D(typeof n$12.threshold == `number` ? n$12.threshold : 50, g$2 ? x$2.width : x$2.height), w$2 = O(S$2, t$12, g$2 ? o$5.width : o$5.height, g$2 ? x$2.width : x$2.height), k$2 = 0;
			if (k$2 = e$9.direction === C.left ? o$5.x - (x$2.x - w$2) : e$9.direction === C.right ? x$2.x + x$2.width + w$2 - (o$5.x + o$5.width) : e$9.direction === C.up ? o$5.y - (x$2.y - w$2) : x$2.y + x$2.height + w$2 - (o$5.y + o$5.height), k$2 > S$2) break;
			let A$2 = g$2 ? d$1(l$4) : p(l$4);
			if (s$6 = b.forward & e$9.direction ? E(A$2, v$3) : A$2 <= 0, s$6) break;
			return e$9.maxValue = v$3, e$9.threshold = S$2, e$9.distance = k$2, e$9.isEnding = !1, !0;
		}
		return n$11 === !0 && e$9.speed > 0 ? (s$6 === null && (s$6 = e$9.hasReachedEnd()), e$9.isEnding = !s$6) : e$9.isEnding = !1, e$9.isEnding;
	}
	_updateItems() {
		for (let e$9 = 0; e$9 < this.items.length; e$9++) {
			let t$12 = this.items[e$9], n$11 = this._itemData.get(t$12), { x: r$8, y: i$7 } = t$12.position, a$4 = n$11.positionX, o$5 = n$11.positionY;
			r$8 === a$4 && i$7 === o$5 || (n$11.directionX = r$8 > a$4 ? C.right : r$8 < a$4 ? C.left : n$11.directionX, n$11.directionY = i$7 > o$5 ? C.down : i$7 < o$5 ? C.up : n$11.directionY, n$11.positionX = r$8, n$11.positionY = i$7, n$11.overlapCheckRequestTime === 0 && (n$11.overlapCheckRequestTime = this._tickTime));
		}
	}
	_updateRequests() {
		let e$9 = this.items, t$12 = this._requests[y.x], n$11 = this._requests[y.y], r$8 = 0;
		for (; r$8 < e$9.length; r$8++) {
			let i$7 = e$9[r$8], a$4 = this._itemData.get(i$7), o$5 = a$4.overlapCheckRequestTime, s$6 = o$5 > 0 && this._tickTime - o$5 > this.settings.overlapCheckInterval, c$5 = !0, l$4 = t$12.get(i$7);
			l$4 && l$4.isActive && (c$5 = !this._updateScrollRequest(l$4), c$5 && (s$6 = !0, this._cancelItemScroll(i$7, y.x)));
			let u$4 = !0, d$3 = n$11.get(i$7);
			d$3 && d$3.isActive && (u$4 = !this._updateScrollRequest(d$3), u$4 && (s$6 = !0, this._cancelItemScroll(i$7, y.y))), s$6 && (a$4.overlapCheckRequestTime = 0, this._checkItemOverlap(i$7, c$5, u$4));
		}
	}
	_requestAction(e$9, t$12) {
		let n$11 = t$12 === y.x, r$8 = null, i$7 = 0;
		for (; i$7 < this._actions.length; i$7++) {
			if (r$8 = this._actions[i$7], e$9.element !== r$8.element) {
				r$8 = null;
				continue;
			}
			if (n$11 ? r$8.requestX : r$8.requestY) {
				this._cancelItemScroll(e$9.item, t$12);
				return;
			}
			break;
		}
		r$8 ||= this._actionPool.get(), r$8.element = e$9.element, r$8.addRequest(e$9), e$9.tick(this._tickDeltaTime), this._actions.push(r$8);
	}
	_updateActions() {
		let e$9 = 0;
		for (e$9 = 0; e$9 < this.items.length; e$9++) {
			let t$12 = this.items[e$9], n$11 = this._requests[y.x].get(t$12), r$8 = this._requests[y.y].get(t$12);
			n$11 && this._requestAction(n$11, y.x), r$8 && this._requestAction(r$8, y.y);
		}
		for (e$9 = 0; e$9 < this._actions.length; e$9++) this._actions[e$9].computeScrollValues();
	}
	_applyActions() {
		if (!this._actions.length) return;
		let e$9 = 0;
		for (e$9 = 0; e$9 < this._actions.length; e$9++) this._actions[e$9].scroll(), this._actionPool.release(this._actions[e$9]);
		this._actions.length = 0;
	}
	addItem(e$9) {
		if (this._isDestroyed || this._itemData.has(e$9)) return;
		let { x: t$12, y: n$11 } = e$9.position, r$8 = new k();
		r$8.positionX = t$12, r$8.positionY = n$11, r$8.directionX = C.none, r$8.directionY = C.none, r$8.overlapCheckRequestTime = this._tickTime, this._itemData.set(e$9, r$8), this.items.push(e$9), this._isTicking || this._startTicking();
	}
	removeItem(e$9) {
		if (this._isDestroyed) return;
		let t$12 = this.items.indexOf(e$9);
		t$12 !== -1 && (this._requests[y.x].get(e$9) && (this._cancelItemScroll(e$9, y.x), this._requests[y.x].delete(e$9)), this._requests[y.y].get(e$9) && (this._cancelItemScroll(e$9, y.y), this._requests[y.y].delete(e$9)), this._itemData.delete(e$9), this.items.splice(t$12, 1), this._isTicking && !this.items.length && this._stopTicking());
	}
	isDestroyed() {
		return this._isDestroyed;
	}
	isItemScrollingX(e$9) {
		return !!this._requests[y.x].get(e$9)?.isActive;
	}
	isItemScrollingY(e$9) {
		return !!this._requests[y.y].get(e$9)?.isActive;
	}
	isItemScrolling(e$9) {
		return this.isItemScrollingX(e$9) || this.isItemScrollingY(e$9);
	}
	updateSettings(e$9 = {}) {
		let { overlapCheckInterval: t$12 = this.settings.overlapCheckInterval } = e$9;
		this.settings.overlapCheckInterval = t$12;
	}
	destroy() {
		this._isDestroyed ||= (this.items.forEach((e$9) => this.removeItem(e$9)), this._requestPool.destroy(), this._actionPool.destroy(), this._actions.length = 0, !0);
	}
};
...
function a$2() {
	return {
		...
		smoothStop: !1,
		getPosition: (e$9) => {
			let { drag: t$12 } = e$9, n$11 = t$12?.items[0];
			if (n$11) return n$11.position;
			let i$7 = t$12 && (t$12.moveEvent || t$12.startEvent);
			return r$6.x = i$7 ? i$7.x : 0, r$6.y = i$7 ? i$7.y : 0, r$6;
		},
		getClientRect: (e$9) => {
			let { drag: t$12 } = e$9, n$11 = e$9.getClientRect();
			if (n$11) return n$11;
			let r$8 = t$12 && (t$12.moveEvent || t$12.startEvent);
			return i$6.width = r$8 ? 50 : 0, i$6.height = r$8 ? 50 : 0, i$6.x = r$8 ? r$8.x - 25 : 0, i$6.y = r$8 ? r$8.y - 25 : 0, i$6;
		},
		onStart: null,
		onStop: null
	};
...
var o$1 = class {
	...
	_clientRect;
	constructor(e$9, t$12) {
		this._draggableAutoScroll = e$9, this._draggable = t$12, this._position = {
			x: 0,
			y: 0
		}, this._clientRect = {
			width: 0,
	...
	get targets() {
		let { targets: e$9 } = this._getSettings();
		return typeof e$9 == `function` && (e$9 = e$9(this._draggable)), e$9;
	}
	get position() {
		let e$9 = this._position, { getPosition: t$12 } = this._getSettings();
		return typeof t$12 == `function` ? Object.assign(e$9, t$12(this._draggable)) : (e$9.x = 0, e$9.y = 0), e$9;
	}
	get clientRect() {
		let e$9 = this._clientRect, { getClientRect: t$12 } = this._getSettings();
		return typeof t$12 == `function` ? Object.assign(e$9, t$12(this._draggable)) : (e$9.width = 0, e$9.height = 0, e$9.x = 0, e$9.y = 0), e$9;
	}
	get inertAreaSize() {
	...
	_autoScrollProxy;
	constructor(e$9, r$8 = {}) {
		this.name = `autoscroll`, this.version = `0.0.3`, this.settings = this._parseSettings(r$8), this._autoScrollProxy = null, e$9.on(R.Start, () => {
			this._autoScrollProxy || (this._autoScrollProxy = new o$1(this, e$9), t$3.addItem(this._autoScrollProxy));
		}), e$9.on(R.End, () => {
			this._autoScrollProxy &&= (t$3.removeItem(this._autoScrollProxy), null);
		});
	}
	_parseSettings(e$9, t$12 = a$2()) {
		let { targets: n$11 = t$12.targets, inertAreaSize: r$8 = t$12.inertAreaSize, speed: i$7 = t$12.speed, smoothStop: o$5 = t$12.smoothStop, getPosition: s$6 = t$12.getPosition, getClientRect: c$5 = t$12.getClientRect, onStart: l$4 = t$12.onStart, onStop: u$4 = t$12.onStop } = e$9 || {};
		return {
			targets: n$11,
			inertAreaSize: r$8,
			speed: i$7,
...
function c$2(e$9) {
	return (t$12) => {
		let n$11 = new s$3(t$12, e$9), r$8 = t$12;
		return r$8.plugins[n$11.name] = n$11, r$8;
	};
}
...
function i(i$7, a$4) {
	let o$5 = (0, import_react.useRef)(a$4);
	o$5.current = a$4;
	let s$6 = (0, import_react.useRef)(a$4);
	return n(() => {
		i$7 && (i$7.plugins.autoscroll || (i$7.use(c$2(o$5.current)), s$6.current = o$5.current));
	}, [i$7]), n(() => {
		let e$9 = i$7?.plugins.autoscroll;
		e$9 && (n$7(s$6.current, a$4) || e$9.updateSettings(e$9._parseSettings(a$4)), s$6.current = a$4);
	}, [i$7, a$4]), i$7;
}

//#endregion
//#region ../dragdoll-react/dist/use-draggable-callback-Cd1g8lnj.js
function n$6(n$11, r$8, i$7) {
	let a$4 = !!i$7, o$5 = (0, import_react.useRef)(i$7);
	o$5.current = i$7, n(() => {
		if (!n$11 || !a$4) return;
		let e$9 = n$11.on(r$8, ((...e$10) => {
			o$5.current?.(...e$10);
		}));
		return () => void n$11.off(r$8, e$9);
	}, [
		n$11,
		r$8,
		a$4
...
function r(r$8, i$7 = !1) {
	let [a$4, o$5] = (0, import_react.useState)(r$8?.drag || null), s$6 = (0, import_react.useState)(void 0)[1];
	return n$6(r$8, R.Start, (e$9) => {
		o$5(e$9);
	}), n$6(r$8, R.Move, () => {
		i$7 && s$6(Symbol());
	}), n$6(r$8, R.End, () => {
...
var n$5 = class {
	...
	_updateDragData(e$9) {
		this.drag && (this.drag.x = e$9.x, this.drag.y = e$9.y);
	}
	_resetDragData() {
		this.drag = null;
	}
	_start(t$12) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$12), this._emitter.emit(e.Start, t$12));
	}
	_move(t$12) {
		this.drag && (this._updateDragData(t$12), this._emitter.emit(e.Move, t$12));
	}
	_end(t$12) {
		this.drag && (this._updateDragData(t$12), this._emitter.emit(e.End, t$12), this._resetDragData());
	}
	_cancel(t$12) {
		this.drag && (this._updateDragData(t$12), this._emitter.emit(e.Cancel, t$12), this._resetDragData());
	}
	on(e$9, t$12, n$11) {
		return this._emitter.on(e$9, t$12, n$11);
	}
...
var i$5 = class extends n$5 {
	...
	_createDragData(e$9) {
		return {
			...super._createDragData(e$9),
			time: 0,
			deltaTime: 0
		};
	}
	_start(n$11) {
		this.isDestroyed || this.drag || (super._start(n$11), r$5.on(n$4.read, this._tick, this._tick));
	}
	_end(n$11) {
		this.drag && (r$5.off(n$4.read, this._tick), super._end(n$11));
	}
	_cancel(n$11) {
		this.drag && (r$5.off(n$4.read, this._tick), super._cancel(n$11));
	}
	_tick(e$9) {
		if (this.drag) if (e$9 && this.drag.time) {
			this.drag.deltaTime = e$9 - this.drag.time, this.drag.time = e$9;
			let t$12 = {
				type: `tick`,
				time: this.drag.time,
				deltaTime: this.drag.deltaTime
			};
			if (this._emitter.emit(`tick`, t$12), !this.drag) return;
			let r$8 = this._speed * (this.drag.deltaTime / 1e3), i$7 = this._direction.x * r$8, a$4 = this._direction.y * r$8;
			(i$7 || a$4) && this._move({
				type: e.Move,
				x: this.drag.x + i$7,
				y: this.drag.y + a$4
			});
		} else this.drag.time = e$9, this.drag.deltaTime = 0;
	}
};
...
function r$4(e$9, t$12) {
	if (!e$9.size || !t$12.size) return Infinity;
	let n$11 = Infinity;
	for (let r$8 of e$9) {
		let e$10 = t$12.get(r$8);
		e$10 !== void 0 && e$10 < n$11 && (n$11 = e$10);
	}
	return n$11;
}
const i$4 = {
	...
	computeSpeed: () => 500,
	startPredicate: (e$9, t$12) => {
		if (t$12.element && document.activeElement === t$12.element) {
			let { left: e$10, top: n$11 } = t$12.element.getBoundingClientRect();
			return {
				x: e$10,
				y: n$11
			};
...
var a$1 = class extends i$5 {
	...
	constructor(e$9, t$12 = {}) {
		super();
		let { startPredicate: n$11 = i$4.startPredicate, computeSpeed: r$8 = i$4.computeSpeed, cancelOnVisibilityChange: a$4 = i$4.cancelOnVisibilityChange, cancelOnBlur: o$5 = i$4.cancelOnBlur, startKeys: s$6 = i$4.startKeys, moveLeftKeys: c$5 = i$4.moveLeftKeys, moveRightKeys: l$4 = i$4.moveRightKeys, moveUpKeys: u$4 = i$4.moveUpKeys, moveDownKeys: d$3 = i$4.moveDownKeys, cancelKeys: f$2 = i$4.cancelKeys, endKeys: p$2 = i$4.endKeys } = t$12;
		this.element = e$9, this._startKeys = new Set(s$6), this._cancelKeys = new Set(f$2), this._endKeys = new Set(p$2), this._moveLeftKeys = new Set(c$5), this._moveRightKeys = new Set(l$4), this._moveUpKeys = new Set(u$4), this._moveDownKeys = new Set(d$3), this._moveKeys = new Set([
			...c$5,
			...l$4,
			...u$4,
			...d$3
		]), this._moveKeyTimestamps = /* @__PURE__ */ new Map(), this._cancelOnBlur = o$5, this._cancelOnVisibilityChange = a$4, this._computeSpeed = r$8, this._startPredicate = n$11, this._onKeyDown = this._onKeyDown.bind(this), this._onKeyUp = this._onKeyUp.bind(this), this._onTick = this._onTick.bind(this), this._internalCancel = this._internalCancel.bind(this), this._blurCancelHandler = this._blurCancelHandler.bind(this), this.on(`tick`, this._onTick, this._onTick), document.addEventListener(`keydown`, this._onKeyDown), document.addEventListener(`keyup`, this._onKeyUp), o$5 && e$9?.addEventListener(`blur`, this._blurCancelHandler), a$4 && document.addEventListener(`visibilitychange`, this._internalCancel);
	}
	_end(e$9) {
		this.drag && (this._moveKeyTimestamps.clear(), this._direction.x = 0, this._direction.y = 0, super._end(e$9));
	}
	_cancel(e$9) {
		this.drag && (this._moveKeyTimestamps.clear(), this._direction.x = 0, this._direction.y = 0, super._cancel(e$9));
	}
	_internalCancel() {
		this.cancel();
	}
	...
	_updateDirection() {
		let e$9 = r$4(this._moveLeftKeys, this._moveKeyTimestamps), t$12 = r$4(this._moveRightKeys, this._moveKeyTimestamps), n$11 = r$4(this._moveUpKeys, this._moveKeyTimestamps), i$7 = r$4(this._moveDownKeys, this._moveKeyTimestamps), a$4 = e$9 === t$12 ? 0 : e$9 < t$12 ? -1 : 1, o$5 = n$11 === i$7 ? 0 : n$11 < i$7 ? -1 : 1;
		if (!(a$4 === 0 || o$5 === 0)) {
			let e$10 = 1 / (Math.sqrt(a$4 * a$4 + o$5 * o$5) || 1);
			a$4 *= e$10, o$5 *= e$10;
		}
		this._direction.x = a$4, this._direction.y = o$5;
	}
	_onTick() {
		this._speed = this._computeSpeed(this);
	}
	_onKeyUp(e$9) {
		this._moveKeyTimestamps.get(e$9.key) && (this._moveKeyTimestamps.delete(e$9.key), this._updateDirection());
	}
	_onKeyDown(t$12) {
		if (!this.drag) {
			if (this._startKeys.has(t$12.key)) {
				let n$11 = this._startPredicate(t$12, this);
				n$11 && (t$12.preventDefault(), this._start({
					type: e.Start,
					x: n$11.x,
					y: n$11.y
				}));
		...
		if (this._cancelKeys.has(t$12.key)) {
			t$12.preventDefault(), this._internalCancel();
			return;
		}
		if (this._endKeys.has(t$12.key)) {
			t$12.preventDefault(), this._end({
				type: e.End,
				x: this.drag.x,
				y: this.drag.y
			});
		...
		if (this._moveKeys.has(t$12.key)) {
			t$12.preventDefault(), this._moveKeyTimestamps.get(t$12.key) || (this._moveKeyTimestamps.set(t$12.key, Date.now()), this._updateDirection());
			return;
		}
	}
	updateElement(e$9) {
		this.isDestroyed || this.element === e$9 || (this._cancelOnBlur && (this.element?.removeEventListener(`blur`, this._blurCancelHandler), e$9?.addEventListener(`blur`, this._blurCancelHandler)), this.element = e$9);
	}
	updateSettings(e$9) {
		if (this.isDestroyed) return;
		let t$12 = !1, { cancelOnBlur: r$8, cancelOnVisibilityChange: i$7, startPredicate: a$4, computeSpeed: o$5 } = e$9;
		if (r$8 !== void 0 && this._cancelOnBlur !== r$8 && (this._cancelOnBlur = r$8, r$8 ? this.element?.addEventListener(`blur`, this._blurCancelHandler) : this.element?.removeEventListener(`blur`, this._blurCancelHandler)), i$7 !== void 0 && this._cancelOnVisibilityChange !== i$7 && (this._cancelOnVisibilityChange = i$7, i$7 ? document.addEventListener(`visibilitychange`, this._internalCancel) : document.removeEventListener(`visibilitychange`, this._internalCancel)), a$4 !== void 0 && (this._startPredicate = a$4), o$5 !== void 0 && (this._computeSpeed = o$5), n$3.forEach((n$11, r$9) => {
			let i$8 = `${n$11}Keys`, a$5 = e$9[i$8];
			a$5 !== void 0 && (this[`_${i$8}`] = new Set(a$5), r$9 >= 3 && (t$12 = !0));
		}), t$12) {
			let e$10 = [
				...this._moveLeftKeys,
				...this._moveRightKeys,
			...
			[...this._moveKeys].every((t$13, n$11) => e$10[n$11] === t$13) || (this._moveKeys = new Set(e$10), this._moveKeyTimestamps.clear(), this._updateDirection());
		}
	}
	destroy() {
...
function s(s$6, c$5) {
	let [l$4, u$4] = (0, import_react.useState)(null), d$3 = (0, import_react.useRef)(l$4), f$2 = (0, import_react.useRef)(s$6);
	f$2.current = s$6;
	let p$2 = r$1((e$9) => {
		let t$12 = d$3.current;
		if (t$12) {
			t$12.updateElement(e$9);
			return;
		}
		let n$11 = new a$1(e$9, f$2.current);
		d$3.current = n$11, u$4(n$11);
	}, []), m$2 = r$1(() => {
		let e$9 = d$3.current;
		e$9 && (e$9.destroy(), d$3.current = null, u$4(null));
	}, []), h$2 = r$1((e$9) => {
		if (c$5 === void 0) {
			if (e$9 === null) {
				m$2();
	...
	return n(() => {
		if (c$5 !== void 0) return p$2(c$5), m$2;
	}, [
		c$5,
		p$2,
		m$2
		...
		if (l$4) {
			let { startKeys: e$9 = i$4.startKeys, moveLeftKeys: t$12 = i$4.moveLeftKeys, moveRightKeys: n$11 = i$4.moveRightKeys, moveUpKeys: r$8 = i$4.moveUpKeys, moveDownKeys: i$7 = i$4.moveDownKeys, cancelKeys: a$4 = i$4.cancelKeys, endKeys: c$6 = i$4.endKeys, cancelOnBlur: u$5 = i$4.cancelOnBlur, cancelOnVisibilityChange: d$4 = i$4.cancelOnVisibilityChange, computeSpeed: f$3 = i$4.computeSpeed, startPredicate: p$3 = i$4.startPredicate } = s$6 || {};
			l$4.updateSettings({
				startKeys: e$9,
				moveLeftKeys: t$12,
				moveRightKeys: n$11,
				...
				endKeys: c$6,
				cancelOnBlur: u$5,
				cancelOnVisibilityChange: d$4,
				computeSpeed: f$3,
				startPredicate: p$3
			});
		}
	}, [l$4, s$6]), n$1(() => [l$4, h$2], [l$4, h$2]);
}

//#endregion
//#region ../dragdoll/dist/pointer-sensor-C2e8cAmq.js
function i$2(e$9, t$12) {
	if (`pointerId` in e$9) return e$9.pointerId === t$12 ? e$9 : null;
	if (`changedTouches` in e$9) {
		let n$11 = 0;
		for (; n$11 < e$9.changedTouches.length; n$11++) if (e$9.changedTouches[n$11].identifier === t$12) return e$9.changedTouches[n$11];
		return null;
	}
	return e$9;
}
function a(e$9) {
	return `pointerId` in e$9 ? e$9.pointerId : `changedTouches` in e$9 ? e$9.changedTouches[0] ? e$9.changedTouches[0].identifier : null : -1;
}
function o(e$9) {
	return `pointerType` in e$9 ? e$9.pointerType : `touches` in e$9 ? `touch` : `mouse`;
}
function s$2(e$9 = {}) {
	let { capture: t$12 = !0, passive: n$11 = !0 } = e$9;
	return {
		capture: t$12,
		passive: n$11
	};
...
function c$1(n$11) {
	return n$11 === `auto` || n$11 === void 0 ? n$2 ? `pointer` : t ? `touch` : `mouse` : n$11;
}
const l = {
	pointer: {
		start: `pointerdown`,
	...
	listenerOptions: {},
	sourceEvents: `auto`,
	startPredicate: (e$9) => !(`button` in e$9 && e$9.button > 0)
};
var d = class {
	element;
	drag;
	...
	_emitter;
	constructor(e$9, t$12 = {}) {
		let { listenerOptions: n$11 = u.listenerOptions, sourceEvents: i$7 = u.sourceEvents, startPredicate: a$4 = u.startPredicate } = t$12;
		this.element = e$9, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$4, this._listenerOptions = s$2(n$11), this._sourceEvents = c$1(i$7), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$9.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	_getTrackedPointerEventData(e$9) {
		return this.drag ? i$2(e$9, this.drag.pointerId) : null;
	}
	_onStart(e$9) {
		if (this.isDestroyed || this.drag || !this._startPredicate(e$9)) return;
		let t$12 = a(e$9);
		if (t$12 === null) return;
		let r$8 = i$2(e$9, t$12);
		if (r$8 === null) return;
		let s$6 = {
			pointerId: t$12,
			pointerType: o(e$9),
		...
		this._emitter.emit(c$5.type, c$5), this.drag && this._bindWindowListeners();
	}
	_onMove(e$9) {
		if (!this.drag) return;
		let t$12 = this._getTrackedPointerEventData(e$9);
		if (!t$12) return;
		this.drag.x = t$12.clientX, this.drag.y = t$12.clientY;
		let r$8 = {
			type: e.Move,
			srcEvent: e$9,
			target: t$12.target,
	...
	_bindWindowListeners() {
		...
		let { move: e$9, end: t$12, cancel: n$11 } = l[this._sourceEvents];
		window.addEventListener(e$9, this._onMove, this._listenerOptions), window.addEventListener(t$12, this._onEnd, this._listenerOptions), n$11 && window.addEventListener(n$11, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !0;
	}
	_unbindWindowListeners() {
		if (this._areWindowListenersBound) {
			let { move: e$9, end: t$12, cancel: n$11 } = l[this._sourceEvents];
			window.removeEventListener(e$9, this._onMove, this._listenerOptions), window.removeEventListener(t$12, this._onEnd, this._listenerOptions), n$11 && window.removeEventListener(n$11, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !1;
		}
	}
	_resetDrag() {
	...
	cancel() {
		...
		this._emitter.emit(e$9.type, e$9), this._resetDrag();
	}
	updateElement(e$9) {
		this.isDestroyed || this.element === e$9 || (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), e$9.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this.element = e$9);
	}
	updateSettings(e$9) {
		if (this.isDestroyed) return;
		let { listenerOptions: t$12, sourceEvents: n$11, startPredicate: r$8 } = e$9, i$7 = c$1(n$11), a$4 = s$2(t$12);
		r$8 && this._startPredicate !== r$8 && (this._startPredicate = r$8), (t$12 && (this._listenerOptions.capture !== a$4.capture || this._listenerOptions.passive === a$4.passive) || n$11 && this._sourceEvents !== i$7) && (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this._unbindWindowListeners(), this.cancel(), n$11 && (this._sourceEvents = i$7), t$12 && a$4 && (this._listenerOptions = a$4), this.element.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
	on(e$9, t$12, n$11) {
		return this._emitter.on(e$9, t$12, n$11);
	}
...
function s$1(s$6, c$5) {
	...
	let p$2 = r$1((e$9) => {
		...
		let n$11 = new d(e$9, f$2.current);
		d$3.current = n$11, u$4(n$11);
	}, []), m$2 = r$1(() => {
		let e$9 = d$3.current;
		e$9 && (e$9.destroy(), d$3.current = null, u$4(null));
	...
	return n(() => {
		...
		if (l$4) {
			let { listenerOptions: e$9 = u.listenerOptions, sourceEvents: t$12 = u.sourceEvents, startPredicate: n$11 = u.startPredicate } = s$6 || {};
			l$4.updateSettings({
				listenerOptions: e$9,
				sourceEvents: t$12,
				startPredicate: n$11
...
var require_react_dom_development = /* @__PURE__ */ __commonJS({ "../../node_modules/react-dom/cjs/react-dom.development.js": ((exports) => {
	(function() {
		...
		exports.unstable_batchedUpdates = function(fn, a$4) {
			return fn(a$4);
		};
	...
	(function() {
		...
		function copyWithRename(obj, oldPath, newPath) {
			if (oldPath.length !== newPath.length) console.warn("copyWithRename() expects paths of the same length");
				...
				for (var i$7 = 0; i$7 < newPath.length - 1; i$7++) if (oldPath[i$7] !== newPath[i$7]) {
		...
		function findCurrentFiberUsingSlowPath(fiber) {
			...
			for (var a$4 = fiber, b$2 = alternate;;) {
				...
				if (a$4.alternate !== b$2) throw Error("Return fibers should always be each others' alternates. This error is likely caused by a bug in React. Please file an issue.");
			}
			if (3 !== a$4.tag) throw Error("Unable to find node on an unmounted component.");
			return a$4.stateNode.current === a$4 ? fiber : alternate;
		}
		...
		function getComponentNameFromFiber(fiber) {
			...
			switch (fiber.tag) {
				...
				case 29:
					...
					if (null != type) {
						for (var i$7 = type.length - 1; 0 <= i$7; i$7--) if ("string" === typeof type[i$7].name) return type[i$7].name;
					}
		...
		function requiredContext(c$5) {
			null === c$5 && console.error("Expected host context to exist. This error is likely caused by a bug in React. Please file an issue.");
			return c$5;
		}
		...
		function getStackByFiberInDevAndProd(workInProgress$1) {
			try {
				...
				do {
					...
					if (debugInfo) for (var i$7 = debugInfo.length - 1; 0 <= i$7; i$7--) {
						var entry = debugInfo[i$7];
		...
		function createLaneMap(initial) {
			for (var laneMap = [], i$7 = 0; 31 > i$7; i$7++) laneMap.push(initial);
			return laneMap;
		}
		...
		function updateOptions(node, multiple, propValue, setDefaultSelected) {
			...
			if (multiple) {
				multiple = {};
				for (var i$7 = 0; i$7 < propValue.length; i$7++) multiple["$" + propValue[i$7]] = !0;
				for (propValue = 0; propValue < node.length; propValue++) i$7 = multiple.hasOwnProperty("$" + node[propValue].value), node[propValue].selected !== i$7 && (node[propValue].selected = i$7), i$7 && setDefaultSelected && (node[propValue].defaultSelected = !0);
			} else {
				propValue = "" + getToStringValue(propValue);
				multiple = null;
				for (i$7 = 0; i$7 < node.length; i$7++) {
					if (node[i$7].value === propValue) {
						node[i$7].selected = !0;
						setDefaultSelected && (node[i$7].defaultSelected = !0);
						return;
					}
					null !== multiple || node[i$7].disabled || (multiple = node[i$7]);
				}
		...
		function objectName(object) {
			return Object.prototype.toString.call(object).replace(/^\[object (.*)\]$/, function(m$2, p0) {
				return p0;
			});
		}
		...
		function describeNode(node, indent) {
			...
			if (debugInfo) for (var i$7 = 0; i$7 < debugInfo.length; i$7++) {
				var serverComponentName = debugInfo[i$7].name;
				"string" === typeof serverComponentName && (skipToNode += indentation(indent) + "<" + serverComponentName + ">\n", indent++);
			}
			debugInfo = "";
			i$7 = node.fiber.pendingProps;
			if (6 === node.fiber.tag) debugInfo = describeTextDiff(i$7, node.serverProps, indent), indent++;
				...
				for (propName in i$7) if (i$7.hasOwnProperty(propName) && "children" !== propName) {
					var propValue = describePropValue(i$7[propName], 15);
				...
				indent++;
			} else null === node.serverProps ? (debugInfo = describeExpandedElement(serverComponentName, i$7, added(indent)), indent++) : "string" === typeof node.serverProps ? console.error("Should not have matched a non HostText fiber to a Text node. This is a bug in React.") : (debugInfo = describeElementDiff(serverComponentName, i$7, node.serverProps, indent), indent++);
			var propName = "";
			i$7 = node.fiber.child;
			for (serverComponentName = 0; i$7 && serverComponentName < node.children.length;) maxLength = node.children[serverComponentName], maxLength.fiber === i$7 ? (propName += describeNode(maxLength, indent), serverComponentName++) : propName += describeSiblingFiber(i$7, indent), i$7 = i$7.sibling;
			i$7 && 0 < node.children.length && (propName += indentation(indent) + "...\n");
			i$7 = node.serverTail;
			null === node.serverProps && indent--;
			for (node = 0; node < i$7.length; node++) serverComponentName = i$7[node], propName = "string" === typeof serverComponentName ? propName + (removed(indent) + describeTextNode(serverComponentName, 120 - 2 * indent) + "\n") : propName + describeExpandedElement(serverComponentName.type, serverComponentName.props, removed(indent));
		...
		function camelize(string) {
			return string.replace(hyphenPattern, function(_$3, character) {
		...
		function setValueForStyles(node, styles, prevStyles) {
			...
			if (null != prevStyles) {
				if (styles) {
					var expandedUpdates = {};
					if (prevStyles) {
						for (var key in prevStyles) if (prevStyles.hasOwnProperty(key) && !styles.hasOwnProperty(key)) for (var longhands = shorthandToLonghand[key] || [key], i$7 = 0; i$7 < longhands.length; i$7++) expandedUpdates[longhands[i$7]] = key;
					}
					...
					key$jscomp$0 = {};
					for (var _key2 in expandedUpdates) if (key = expandedUpdates[_key2], (longhands = _key[_key2]) && key !== longhands && (i$7 = key + "," + longhands, !key$jscomp$0[i$7])) {
						key$jscomp$0[i$7] = !0;
						i$7 = console;
						var value = styles[key];
						i$7.error.call(i$7, "%s a style property during rerender (%s) when a conflicting property is set (%s) can lead to styling bugs. To avoid this, don't mix shorthand and non-shorthand properties for the same value; instead, replace the shorthand with separate values.", null == value || "boolean" === typeof value || "" === value ? "Removing" : "Updating", key, longhands);
					}
				}
		...
		function batchedUpdates$1(fn, a$4, b$2) {
			...
			try {
				...
				if (isInsideEventHandler = !1, null !== restoreTarget || null !== restoreQueue) {
					if (flushSyncWork$1(), restoreTarget && (a$4 = restoreTarget, fn = restoreQueue, restoreQueue = restoreTarget = null, restoreStateOfTarget(a$4), fn)) for (a$4 = 0; a$4 < fn.length; a$4++) restoreStateOfTarget(fn[a$4]);
				}
			}
		}
		...
		function getArrayKind(array) {
			for (var kind = EMPTY_ARRAY, i$7 = 0; i$7 < array.length; i$7++) {
				var value = array[i$7];
		...
		function logComponentErrored(fiber, startTime, endTime, errors) {
			if (supportsUserTiming) {
				var name = getComponentNameFromFiber(fiber);
				if (null !== name) {
					for (var debugTask = null, properties = [], i$7 = 0; i$7 < errors.length; i$7++) {
						var capturedValue = errors[i$7];
		...
		function logComponentEffect(fiber, startTime, endTime, selfTime, errors) {
			if (null !== errors) {
				if (supportsUserTiming) {
					...
					if (null !== name) {
						selfTime = [];
						for (var i$7 = 0; i$7 < errors.length; i$7++) {
							var error = errors[i$7].value;
		...
		function logRecoveredRenderPhase(startTime, endTime, lanes, recoverableErrors, hydrationFailed, debugTask) {
			if (supportsUserTiming && !(endTime <= startTime)) {
				lanes = [];
				for (var i$7 = 0; i$7 < recoverableErrors.length; i$7++) {
					var error = recoverableErrors[i$7].value;
		...
		function logCommitErrored(startTime, endTime, errors, passive, debugTask) {
			if (supportsUserTiming && !(endTime <= startTime)) {
				for (var properties = [], i$7 = 0; i$7 < errors.length; i$7++) {
					var error = errors[i$7].value;
		...
		function finishQueueingConcurrentUpdates() {
			for (var endIndex = concurrentQueuesIndex, i$7 = concurrentlyUpdatedLanes = concurrentQueuesIndex = 0; i$7 < endIndex;) {
				var fiber = concurrentQueues[i$7];
				concurrentQueues[i$7++] = null;
				var queue = concurrentQueues[i$7];
				concurrentQueues[i$7++] = null;
				var update = concurrentQueues[i$7];
				concurrentQueues[i$7++] = null;
				var lane = concurrentQueues[i$7];
				concurrentQueues[i$7++] = null;
			...
			for (; null !== fiber;) {
				...
				if (null !== list) {
					...
					a: for (; null !== list;) {
						var dependency = list;
						list = fiber;
						for (var i$7 = 0; i$7 < contexts.length; i$7++) if (dependency.context === contexts[i$7]) {
		...
		function pingEngtangledActionScope() {
			if (0 === --currentEntangledPendingCount && (-1 < transitionUpdateTime || (transitionStartTime = -1.1), null !== currentEntangledListeners)) {
				...
				for (var i$7 = 0; i$7 < listeners.length; i$7++) (0, listeners[i$7])();
			}
		}
		function chainThenableValue(thenable, result) {
			...
			thenable.then(function() {
				...
				for (var i$7 = 0; i$7 < listeners.length; i$7++) (0, listeners[i$7])(result);
			}, function(error) {
		...
		function resolveLazy(lazyType) {
			try {
				...
				if (null !== x$2 && "object" === typeof x$2 && "function" === typeof x$2.then) throw suspendedThenable = x$2, needsToResetSuspendedThenableDEV = !0, SuspenseException;
				throw x$2;
			}
		}
		...
		function getCurrentDebugTask() {
			...
			if (null != debugInfo) {
				for (var i$7 = debugInfo.length - 1; 0 <= i$7; i$7--) if (null != debugInfo[i$7].name) {
					var debugTask = debugInfo[i$7].debugTask;
		...
		function validateFragmentProps(element, fiber, returnFiber) {
			for (var keys = Object.keys(element.props), i$7 = 0; i$7 < keys.length; i$7++) {
				var key = keys[i$7];
		...
		function createChildReconciler(shouldTrackSideEffects) {
			...
			return function(returnFiber, currentFirstChild, newChild, lanes) {
				...
				try {
					...
					if (null != debugInfo) {
						for (var i$7 = debugInfo.length - 1; 0 <= i$7; i$7--) if ("string" === typeof debugInfo[i$7].stack) {
							fiber._debugOwner = debugInfo[i$7];
							fiber._debugTask = debugInfo[i$7].debugTask;
							break;
						}
					}
					return fiber;
		...
		function updateHookTypesDev() {
			...
			if (null !== hookTypesDev && (hookTypesUpdateIndexDev++, hookTypesDev[hookTypesUpdateIndexDev] !== hookName)) {
				...
				if (!didWarnAboutMismatchedHooksForComponent.has(componentName$1) && (didWarnAboutMismatchedHooksForComponent.add(componentName$1), null !== hookTypesDev)) {
					for (var table = "", i$7 = 0; i$7 <= hookTypesUpdateIndexDev; i$7++) {
						var oldHookName = hookTypesDev[i$7], newHookName = i$7 === hookTypesUpdateIndexDev ? hookName : oldHookName;
						for (oldHookName = i$7 + 1 + ". " + oldHookName; 30 > oldHookName.length;) oldHookName += " ";
		...
		function areHookInputsEqual(nextDeps, prevDeps) {
			...
			for (var i$7 = 0; i$7 < prevDeps.length && i$7 < nextDeps.length; i$7++) if (!objectIs(nextDeps[i$7], prevDeps[i$7])) return !1;
			return !0;
		}
		...
		function notifyActionListeners(actionNode) {
			...
			for (var i$7 = 0; i$7 < actionNode.length; i$7++) (0, actionNode[i$7])();
		}
				...
				if (null !== lastEffect) {
					...
					do {
						if ((updateQueue.tag & flags) === flags && (lastEffect = void 0, (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !0), lastEffect = runWithFiberInDEV(finishedWork, callCreateInDEV, updateQueue), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !1), void 0 !== lastEffect && "function" !== typeof lastEffect)) {
							...
							runWithFiberInDEV(finishedWork, function(n$11, a$4) {
								console.error("%s must not return anything besides a function, which is used for clean-up.%s", n$11, a$4);
							}, hookName, addendum);
						}
		...
		function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber) {
			...
			if (null !== deletions) for (var i$7 = 0; i$7 < deletions.length; i$7++) {
				var root$1 = root$jscomp$0, returnFiber = parentFiber, deletedFiber = deletions[i$7], prevEffectStart = pushComponentEffectStart(), parent = returnFiber;
				a: for (; null !== parent;) {
					switch (parent.tag) {
						case 27:
								...
								b: switch (flags) {
									...
									case "meta":
										if (maybeNodes = getHydratableHoistableCache("meta", "content", existingHiddenCallbacks).get(flags + (current$1.content || ""))) {
											for (i$7 = 0; i$7 < maybeNodes.length; i$7++) if (currentResource = maybeNodes[i$7], checkAttributeStringCoercion(current$1.content, "content"), currentResource.getAttribute("content") === (null == current$1.content ? null : "" + current$1.content) && currentResource.getAttribute("name") === (null == current$1.name ? null : current$1.name) && currentResource.getAttribute("property") === (null == current$1.property ? null : current$1.property) && currentResource.getAttribute("http-equiv") === (null == current$1.httpEquiv ? null : current$1.httpEquiv) && currentResource.getAttribute("charset") === (null == current$1.charSet ? null : current$1.charSet)) {
												maybeNodes.splice(i$7, 1);
												break b;
											}
										}
					...
					if (flags & 8192) a: for (root$1 = finishedWork.stateNode, root$1._visibility = existingHiddenCallbacks ? root$1._visibility & ~OffscreenVisible : root$1._visibility | OffscreenVisible, !existingHiddenCallbacks || null === current$1 || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || (recursivelyTraverseDisappearLayoutEffects(finishedWork), (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentTrigger(finishedWork, componentEffectStartTime, componentEffectEndTime, "Disconnect")), current$1 = null, root$1 = finishedWork;;) {
						if (5 === root$1.tag || 26 === root$1.tag) {
							...
							if (null === current$1) {
								wasHidden = root$1;
								try {
									i$7 = wasHidden.stateNode, existingHiddenCallbacks ? runWithFiberInDEV(wasHidden, hideDehydratedBoundary, i$7) : runWithFiberInDEV(wasHidden, unhideDehydratedBoundary, wasHidden.stateNode);
								} catch (error) {
									captureCommitPhaseError(wasHidden, wasHidden.return, error);
								}
							}
		...
		function recursivelyTraversePassiveUnmountEffects(parentFiber) {
			...
			if (0 !== (parentFiber.flags & 16)) {
				if (null !== deletions) for (var i$7 = 0; i$7 < deletions.length; i$7++) {
					var childToDelete = deletions[i$7], prevEffectStart = pushComponentEffectStart();
		...
		function isRenderConsistentWithExternalStores(finishedWork) {
			for (var node = finishedWork;;) {
				var tag = node.tag;
				if ((0 === tag || 11 === tag || 15 === tag) && node.flags & 16384 && (tag = node.updateQueue, null !== tag && (tag = tag.stores, null !== tag))) for (var i$7 = 0; i$7 < tag.length; i$7++) {
					var check = tag[i$7], getSnapshot = check.getSnapshot;
					check = check.value;
					try {
		...
		function processDispatchQueue(dispatchQueue, eventSystemFlags) {
			...
			for (var i$7 = 0; i$7 < dispatchQueue.length; i$7++) {
				var _dispatchQueue$i = dispatchQueue[i$7];
				a: {
		...
		function getStylesObjectFromElement(domElement) {
			...
			for (var i$7 = 0; i$7 < domElement.length; i$7++) {
				var styleName = domElement[i$7];
		...
		function diffHydratedProperties(domElement, tag, props, hostContext) {
			for (var serverDifferences = {}, extraAttributes = /* @__PURE__ */ new Set(), attributes = domElement.attributes, i$7 = 0; i$7 < attributes.length; i$7++) switch (attributes[i$7].name.toLowerCase()) {
				case "value": break;
				case "checked": break;
				case "selected": break;
				default: extraAttributes.add(attributes[i$7].name);
			}
				...
				if (registrationNameDependencies.hasOwnProperty(value)) "function" !== typeof propKey && warnForInvalidEventListener(value, propKey);
					...
					case "download":
						a: {
							...
							extraAttributes.delete(attributeName);
							i$7 = i$7.getAttribute(attributeName);
							if (null === i$7) switch (typeof propKey) {
								case "undefined":
								case "function":
								case "symbol": break a;
								...
								case "symbol": break;
								case "boolean":
									if (!0 === propKey && "" === i$7) break a;
									break;
								default: if (checkAttributeStringCoercion(propKey, attributes), i$7 === "" + propKey) break a;
							}
							warnForPropDifference(attributes, i$7, propKey, serverDifferences$jscomp$0);
						}
						continue;
					case "cols":
					case "rows":
					...
					case "span":
						a: {
							...
							if (null === i$7) switch (typeof propKey) {
								...
								case "symbol":
								case "boolean": break;
								default: if (!(isNaN(propKey) || 1 > propKey) && (checkAttributeStringCoercion(propKey, attributes), i$7 === "" + propKey)) break a;
							}
							warnForPropDifference(attributes, i$7, propKey, serverDifferences$jscomp$0);
						}
						continue;
					...
					default: if (!(2 < value.length) || "o" !== value[0] && "O" !== value[0] || "n" !== value[1] && "N" !== value[1]) {
						i$7 = getAttributeAlias(value);
						attributes = !1;
						hostContext.context === HostContextNamespaceNone && "svg" !== tag && "math" !== tag ? extraAttributes.delete(i$7.toLowerCase()) : (attributeName = value.toLowerCase(), attributeName = possibleStandardNames.hasOwnProperty(attributeName) ? possibleStandardNames[attributeName] || null : null, null !== attributeName && attributeName !== value && (attributes = !0, extraAttributes.delete(attributeName)), extraAttributes.delete(i$7));
						a: if (attributeName = domElement, serverDifferences$jscomp$0 = i$7, i$7 = propKey, isAttributeNameSafe(serverDifferences$jscomp$0)) if (attributeName.hasAttribute(serverDifferences$jscomp$0)) attributeName = attributeName.getAttribute(serverDifferences$jscomp$0), checkAttributeStringCoercion(i$7, serverDifferences$jscomp$0), i$7 = attributeName === "" + i$7 ? i$7 : attributeName;
						else {
							switch (typeof i$7) {
								case "function":
								case "symbol": break a;
							...
							i$7 = void 0 === i$7 ? void 0 : null;
						}
						else i$7 = void 0;
						attributes || warnForPropDifference(value, i$7, propKey, serverDifferences);
					}
				}
			}
		...
		function estimateBandwidth() {
			if ("function" === typeof performance.getEntriesByType) {
				for (var count = 0, bits = 0, resourceEntries = performance.getEntriesByType("resource"), i$7 = 0; i$7 < resourceEntries.length; i$7++) {
					var entry = resourceEntries[i$7], transferSize = entry.transferSize, initiatorType = entry.initiatorType, duration = entry.duration;
					if (transferSize && duration && isLikelyStaticResource(initiatorType)) {
						initiatorType = 0;
						duration = entry.responseEnd;
						for (i$7 += 1; i$7 < resourceEntries.length; i$7++) {
							var overlapEntry = resourceEntries[i$7], overlapStartTime = overlapEntry.startTime;
		...
		function describeHydratableInstanceForDevWarnings(instance) {
			if (1 === instance.nodeType) {
				for (var JSCompiler_temp_const = instance.nodeName.toLowerCase(), serverDifferences = {}, attributes = instance.attributes, i$7 = 0; i$7 < attributes.length; i$7++) {
					var attr = attributes[i$7];
		...
		function insertStylesheet(instance, precedence, root$1) {
			for (var nodes = root$1.querySelectorAll("link[rel=\"stylesheet\"][data-precedence],style[data-precedence]"), last = nodes.length ? nodes[nodes.length - 1] : null, prior = last, i$7 = 0; i$7 < nodes.length; i$7++) {
				var node = nodes[i$7];
		...
		function insertStylesheetIntoRoot(root$1, resource) {
			if (!(resource.state.loading & Inserted)) {
				...
				if (precedences) var last = precedences.get(LAST_PRECEDENCE);
					...
					for (var nodes = root$1.querySelectorAll("link[data-precedence],style[data-precedence]"), i$7 = 0; i$7 < nodes.length; i$7++) {
						var node = nodes[i$7];
				...
				i$7 = precedences.get(node) || last;
				i$7 === last && precedences.set(LAST_PRECEDENCE, nodes);
				precedences.set(node, nodes);
				this.count++;
				last = onUnsuspend.bind(this);
				nodes.addEventListener("load", last);
				nodes.addEventListener("error", last);
				i$7 ? i$7.parentNode.insertBefore(nodes, i$7.nextSibling) : (root$1 = 9 === root$1.nodeType ? root$1.head : root$1, root$1.insertBefore(nodes, root$1.firstChild));
				resource.state.loading |= Inserted;
			}
		}
		...
		function markRetryLaneImpl(fiber, retryLane) {
			...
			if (null !== fiber && null !== fiber.dehydrated) {
				var a$4 = fiber.retryLane;
				fiber.retryLane = 0 !== a$4 && a$4 < retryLane ? a$4 : retryLane;
			}
		}
		...
		function scheduleReplayQueueIfNeeded(formReplayingQueue) {
			lastScheduledReplayQueue !== formReplayingQueue && (lastScheduledReplayQueue = formReplayingQueue, Scheduler.unstable_scheduleCallback(Scheduler.unstable_NormalPriority, function() {
				...
				for (var i$7 = 0; i$7 < formReplayingQueue.length; i$7 += 3) {
					var form = formReplayingQueue[i$7], submitterOrAction = formReplayingQueue[i$7 + 1], formData = formReplayingQueue[i$7 + 2];
					if ("function" !== typeof submitterOrAction) if (null === findInstanceBlockingTarget(submitterOrAction || form)) continue;
					else break;
					var formInst = getInstanceFromNode(form);
					null !== formInst && (formReplayingQueue.splice(i$7, 3), i$7 -= 3, form = {
						pending: !0,
						data: formData,
						method: form.method,
		...
		function retryIfBlockedOn(unblocked) {
			...
			for (var i$7 = 0; i$7 < queuedExplicitHydrationTargets.length; i$7++) {
				var queuedTarget = queuedExplicitHydrationTargets[i$7];
				queuedTarget.blockedOn === unblocked && (queuedTarget.blockedOn = null);
			}
			for (; 0 < queuedExplicitHydrationTargets.length && (i$7 = queuedExplicitHydrationTargets[0], null === i$7.blockedOn);) attemptExplicitHydrationTarget(i$7), null === i$7.blockedOn && queuedExplicitHydrationTargets.shift();
			i$7 = (unblocked.ownerDocument || unblocked).$$reactFormReplay;
			if (null != i$7) for (queuedTarget = 0; queuedTarget < i$7.length; queuedTarget += 3) {
				var form = i$7[queuedTarget], submitterOrAction = i$7[queuedTarget + 1], formProps = form[internalPropsKey] || null;
				if ("function" === typeof submitterOrAction) formProps || scheduleReplayQueueIfNeeded(i$7);
				else if (formProps) {
					var action = null;
					...
					"function" === typeof action ? i$7[queuedTarget + 1] = action : (i$7.splice(queuedTarget, 3), queuedTarget -= 3);
					scheduleReplayQueueIfNeeded(i$7);
				}
			}
		}
		...
		(function() {
			for (var i$7 = 0; i$7 < simpleEventPluginEvents.length; i$7++) {
				var eventName = simpleEventPluginEvents[i$7], domEventName = eventName.toLowerCase();
		...
		ReactDOMHydrationRoot.prototype.unstable_scheduleHydration = function(target) {
			if (target) {
				...
				for (var i$7 = 0; i$7 < queuedExplicitHydrationTargets.length && 0 !== updatePriority && updatePriority < queuedExplicitHydrationTargets[i$7].priority; i$7++);
				queuedExplicitHydrationTargets.splice(i$7, 0, target);
				0 === i$7 && attemptExplicitHydrationTarget(target);
			}
		};
		(function() {
...
//#endregion
//#region react-examples/003-draggable-transformed/index.tsx
var import_client = /* @__PURE__ */ __toESM(require_client());
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
const DraggableCardMemo = (0, import_react.memo)(function DraggableCard({ dragContainerRef }) {
	const elementRef = (0, import_react.useRef)(null);
	const [pointerSensor, setPointerSensorRef] = s$1();
	const [keyboardSensor, setKeyboardSensorRef] = s({ computeSpeed: () => 100 });
	...
	const autoScrollSettings = (0, import_react.useMemo)(() => ({ targets: [{
		element: window,
		axis: "y",
		padding: {
			top: Infinity,
	...
	const drag = r(i(c([pointerSensor, keyboardSensor], draggableSettings), autoScrollSettings));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
			...
			viewBox: "0 0 512 512",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: "M278.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l9.4-9.4L224 224l-114.7 0 9.4-9.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-9.4-9.4L224 288l0 114.7-9.4-9.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-9.4 9.4L288 288l114.7 0-9.4 9.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3l-64-64c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l9.4 9.4L288 224l0-114.7 9.4 9.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-64-64z" })
		})
	});
});
function App() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "drag-container-outer",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DraggableCardMemo, { dragContainerRef }, "card")
		})
	})] });
}
