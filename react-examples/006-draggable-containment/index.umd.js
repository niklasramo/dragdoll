...
var __copyProps = (to, from, except, desc) => {
	if (from && typeof from === "object" || typeof from === "function") for (var keys = __getOwnPropNames(from), i$6 = 0, n$10 = keys.length, key; i$6 < n$10; i$6++) {
		key = keys[i$6];
...
var E$1 = {
	...
	on(t$9, n$10, e$8) {
		let i$6 = this._events, s$4 = i$6.get(t$9);
		s$4 || (s$4 = {
			m: /* @__PURE__ */ new Map(),
			l: null
		}, i$6.set(t$9, s$4));
		let o$4 = s$4.m;
		if (e$8 = e$8 === r$7 ? this.getId(n$10) : e$8, o$4.has(e$8)) switch (this.dedupe) {
			case E$1.THROW: throw new Error("Eventti: duplicate listener id!");
			case E$1.IGNORE: return e$8;
			case E$1.UPDATE:
				s$4.l = null;
				break;
			default: o$4.delete(e$8), s$4.l = null;
		}
		return o$4.set(e$8, n$10), s$4.l?.push(n$10), e$8;
	}
	once(t$9, n$10, e$8) {
		let i$6 = 0;
		return e$8 = e$8 === r$7 ? this.getId(n$10) : e$8, this.on(t$9, (...s$4) => {
			i$6 || (i$6 = 1, this.off(t$9, e$8), n$10(...s$4));
		}, e$8);
	}
	off(t$9, n$10) {
		if (t$9 === r$7) {
	...
	emit(t$9, ...n$10) {
		...
		if (e$8) {
			let i$6 = e$8.length, s$4 = 0;
			if (n$10.length) for (; s$4 < i$6; s$4++) e$8[s$4](...n$10);
			else for (; s$4 < i$6; s$4++) e$8[s$4]();
		}
	}
	listenerCount(t$9) {
		if (t$9 === r$7) {
...
var _$1 = E$1, o$3 = class {
	constructor(e$8 = {}) {
		let { phases: t$9 = [], dedupe: r$8, getId: s$4 } = e$8;
	...
	_fillQueue() {
		let e$8 = this._queue, t$9 = this._phases, r$8 = this._getListeners, s$4 = 0, a$4 = t$9.length, n$10;
		for (; s$4 < a$4; s$4++) n$10 = r$8(t$9[s$4]), n$10 && e$8.push(n$10);
		return e$8;
	}
	_processQueue(...e$8) {
		let t$9 = this._queue, r$8 = t$9.length;
		if (!r$8) return;
		let s$4 = 0, a$4 = 0, n$10, c$3;
		for (; s$4 < r$8; s$4++) for (n$10 = t$9[s$4], a$4 = 0, c$3 = n$10.length; a$4 < c$3; a$4++) n$10[a$4](...e$8);
		t$9.length = 0;
	}
};
function u$2(i$6 = 60) {
	...
	{
		let e$8 = 1e3 / i$6, t$9 = typeof performance > "u" ? () => Date.now() : () => performance.now();
		return (r$8) => {
			let s$4 = setTimeout(() => r$8(t$9()), e$8);
...
var l$2 = class extends o$3 {
	constructor(e$8 = {}) {
		let { paused: t$9 = !1, onDemand: r$8 = !1, requestFrame: s$4 = u$2(),...a$4 } = e$8;
		super(a$4), this._paused = t$9, this._onDemand = r$8, this._requestFrame = s$4, this._cancelFrame = null, this._empty = !0, !t$9 && !r$8 && this._request();
	}
	get phases() {
		return this._phases;
	}
	...
	on(e$8, t$9, r$8) {
		let s$4 = super.on(e$8, t$9, r$8);
		return this._empty = !1, this._request(), s$4;
	}
	once(e$8, t$9, r$8) {
		let s$4 = super.once(e$8, t$9, r$8);
		return this._empty = !1, this._request(), s$4;
	}
	_request() {
...
function e$5(e$8, t$9 = {
	...
	return e$8 && (t$9.width = e$8.width, t$9.height = e$8.height, t$9.x = e$8.x, t$9.y = e$8.y, t$9.left = e$8.x, t$9.top = e$8.y, t$9.right = e$8.x + e$8.width, t$9.bottom = e$8.y + e$8.height), t$9;
}
...
function t$8(t$9) {
	...
	return n$10 || (n$10 = window.getComputedStyle(t$9, null), e$7.set(t$9, new WeakRef(n$10))), n$10;
}

//#endregion
//#region ../dragdoll/dist/constants-CMClRu_c.js
const e$6 = typeof window < `u` && window.document !== void 0, t$7 = e$6 && `ontouchstart` in window, n$9 = e$6 && !!window.PointerEvent;
...
function isContainingBlockForFixedElement(n$10) {
	...
	const { contentVisibility: o$4 } = t$9;
...
function getContainingBlock(e$8, t$9 = {}) {
	...
	const n$10 = t$9.position || getStyle(e$8).position, { skipDisplayNone: i$6, container: o$4 } = t$9;
	switch (n$10) {
		case "static":
		case "relative":
		case "sticky":
		case "-webkit-sticky": {
			let t$10 = o$4 || e$8.parentElement;
			for (; t$10;) {
		...
		case "fixed": {
			...
			let l$3 = o$4 || e$8.parentElement;
			for (; l$3;) {
				const e$9 = t$10 ? isContainingBlockForFixedElement(l$3) : isContainingBlockForAbsoluteElement(l$3);
				if (!0 === e$9) return l$3;
				if (null === e$9 && !i$6) return null;
...
function getOffsetContainer(n$10, t$9 = {}) {
	const { display: o$4 } = getStyle(n$10);
	if ("none" === o$4 || "contents" === o$4) return null;
	const e$8 = t$9.position || getStyle(n$10).position, { skipDisplayNone: s$4, container: r$8 } = t$9;
	switch (e$8) {
...
function s$3(e$8, t$9) {
	return e$8.isIdentity && t$9.isIdentity ? !0 : e$8.is2D && t$9.is2D ? e$8.a === t$9.a && e$8.b === t$9.b && e$8.c === t$9.c && e$8.d === t$9.d && e$8.e === t$9.e && e$8.f === t$9.f : e$8.m11 === t$9.m11 && e$8.m12 === t$9.m12 && e$8.m13 === t$9.m13 && e$8.m14 === t$9.m14 && e$8.m21 === t$9.m21 && e$8.m22 === t$9.m22 && e$8.m23 === t$9.m23 && e$8.m24 === t$9.m24 && e$8.m31 === t$9.m31 && e$8.m32 === t$9.m32 && e$8.m33 === t$9.m33 && e$8.m34 === t$9.m34 && e$8.m41 === t$9.m41 && e$8.m42 === t$9.m42 && e$8.m43 === t$9.m43 && e$8.m44 === t$9.m44;
}
function c$2(e$8) {
...
function l$1(e$8, t$9, n$10 = null) {
	if (`moveBefore` in e$8 && e$8.isConnected === t$9.isConnected) try {
		e$8.moveBefore(t$9, n$10);
		return;
	} catch {}
	let r$8 = document.activeElement, i$6 = t$9.contains(r$8);
	e$8.insertBefore(t$9, n$10), i$6 && document.activeElement !== r$8 && r$8 instanceof HTMLElement && r$8.focus({ preventScroll: !0 });
}
function u$1(e$8) {
	return e$8.setMatrixValue(`scale(1, 1)`);
}
function d$1(e$8, t$9 = 0) {
	let n$10 = 10 ** t$9;
...
var f = class {
	...
	_clientOffsetCache;
	constructor(e$8, t$9) {
		this.sensor = e$8, this.startEvent = t$9, this.prevMoveEvent = t$9, this.moveEvent = t$9, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f(), this._clientOffsetCache = new f();
	}
};
...
function g(e$8, t$9 = {
	...
	if (e$8 instanceof Document) return t$9.x = window.scrollX * -1, t$9.y = window.scrollY * -1, t$9;
	let { x: r$8, y: i$6 } = e$8.getBoundingClientRect(), a$4 = t$8(e$8);
	return t$9.x = r$8 + (parseFloat(a$4.borderLeftWidth) || 0), t$9.y = i$6 + (parseFloat(a$4.borderTopWidth) || 0), t$9;
}
function _(e$8) {
	let t$9 = t$8(e$8), r$8 = parseFloat(t$9.height) || 0;
	return t$9.boxSizing === `border-box` ? r$8 : (r$8 += parseFloat(t$9.borderTopWidth) || 0, r$8 += parseFloat(t$9.borderBottomWidth) || 0, r$8 += parseFloat(t$9.paddingTop) || 0, r$8 += parseFloat(t$9.paddingBottom) || 0, e$8 instanceof HTMLElement && (r$8 += e$8.offsetHeight - e$8.clientHeight), r$8);
}
function v$1(e$8) {
	let t$9 = t$8(e$8), r$8 = parseFloat(t$9.width) || 0;
	return t$9.boxSizing === `border-box` ? r$8 : (r$8 += parseFloat(t$9.borderLeftWidth) || 0, r$8 += parseFloat(t$9.borderRightWidth) || 0, r$8 += parseFloat(t$9.paddingLeft) || 0, r$8 += parseFloat(t$9.paddingRight) || 0, e$8 instanceof HTMLElement && (r$8 += e$8.offsetWidth - e$8.clientWidth), r$8);
}
function y(e$8, t$9 = !1) {
	let { translate: r$8, rotate: i$6, scale: a$4, transform: o$4 } = t$8(e$8), s$4 = ``;
	if (r$8 && r$8 !== `none`) {
		let [t$10 = `0px`, n$10 = `0px`, i$7] = r$8.split(` `);
		t$10.includes(`%`) && (t$10 = `${parseFloat(t$10) / 100 * v$1(e$8)}px`), n$10.includes(`%`) && (n$10 = `${parseFloat(n$10) / 100 * _(e$8)}px`), i$7 ? s$4 += `translate3d(${t$10},${n$10},${i$7})` : s$4 += `translate(${t$10},${n$10})`;
	}
	if (i$6 && i$6 !== `none`) {
		let e$9 = i$6.split(` `);
	...
	return !t$9 && o$4 && o$4 !== `none` && (s$4 += o$4), s$4;
}
function b(e$8) {
...
function C(e$8, t$9, n$10 = {
	x: 0,
	y: 0
}) {
	let r$8 = b(e$8) ? e$8 : g(e$8, x), i$6 = b(t$9) ? t$9 : g(t$9, S);
	return n$10.x = i$6.x - r$8.x, n$10.y = i$6.y - r$8.y, n$10;
}
function w(e$8) {
	let t$9 = e$8.split(` `), n$10 = ``, r$8 = ``, i$6 = ``;
	return t$9.length === 1 ? n$10 = r$8 = t$9[0] : t$9.length === 2 ? [n$10, r$8] = t$9 : [n$10, r$8, i$6] = t$9, {
		x: parseFloat(n$10) || 0,
		y: parseFloat(r$8) || 0,
		z: parseFloat(i$6) || 0
	};
...
function E(e$8, t$9 = new DOMMatrix()) {
	...
	for (u$1(t$9); r$8;) {
		...
		if (e$9 && (T.setMatrixValue(e$9), !T.isIdentity)) {
			let { transformOrigin: e$10 } = t$8(r$8), { x: i$6, y: a$4, z: o$4 } = w(e$10);
			o$4 === 0 ? T.setMatrixValue(`translate(${i$6}px,${a$4}px) ${T} translate(${i$6 * -1}px,${a$4 * -1}px)`) : T.setMatrixValue(`translate3d(${i$6}px,${a$4}px,${o$4}px) ${T} translate3d(${i$6 * -1}px,${a$4 * -1}px,${o$4 * -1}px)`), t$9.preMultiplySelf(T);
		}
...
var O = class {
	...
	constructor(e$8, t$9) {
		...
		let i$6 = t$8(e$8), a$4 = e$8.getBoundingClientRect(), s$4 = y(e$8, !0);
		this.data = {}, this.element = e$8, this.elementTransformOrigin = w(i$6.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$4 + i$6.transform), this.elementOffsetMatrix = new DOMMatrix(s$4).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$8) => {
			if (!this._matrixCache.isValid(e$8)) {
				let t$9 = this._matrixCache.get(e$8) || [new DOMMatrix(), new DOMMatrix()], [n$10, r$8] = t$9;
				E(e$8, n$10), r$8.setMatrixValue(n$10.toString()).invertSelf(), this._matrixCache.set(e$8, t$9);
			}
		});
	}
	_updateContainerOffset() {
		let { elementOffsetContainer: e$8, elementContainer: t$9, dragOffsetContainer: n$10, dragContainer: r$8, containerOffset: i$6, _clientOffsetCache: a$4, _matrixCache: o$4 } = this;
		if (e$8 !== n$10) {
			let [s$4, l$3] = [[r$8, n$10], [t$9, e$8]].map(([e$9, t$10]) => {
				...
				if (!a$4.isValid(t$10)) {
					let r$9 = o$4.get(e$9);
					t$10 instanceof HTMLElement && r$9 && !r$9[0].isIdentity ? c$2(r$9[0]) ? (D.style.setProperty(`transform`, r$9[1].toString(), `important`), t$10.append(D), g(D, n$11), D.remove()) : (g(t$10, n$11), n$11.x -= r$9[0].m41, n$11.y -= r$9[0].m42) : g(t$10, n$11);
				}
...
const F = {
	...
	applyPosition: ({ item: e$8, phase: t$9 }) => {
		let n$10 = t$9 === L.End || t$9 === L.EndAlign, [r$8, i$6] = e$8.getContainerMatrix(), [a$4, o$4] = e$8.getDragContainerMatrix(), { position: s$4, alignmentOffset: c$3, containerOffset: l$3, elementTransformMatrix: d$2, elementTransformOrigin: f$1, elementOffsetMatrix: p$1 } = e$8, { x: m$1, y: h$1, z: g$1 } = f$1, _$2 = !d$2.isIdentity && (m$1 !== 0 || h$1 !== 0 || g$1 !== 0), v$2 = s$4.x + c$3.x + l$3.x, y$1 = s$4.y + c$3.y + l$3.y;
		u$1(j), _$2 && (g$1 === 0 ? j.translateSelf(-m$1, -h$1) : j.translateSelf(-m$1, -h$1, -g$1)), n$10 ? i$6.isIdentity || j.multiplySelf(i$6) : o$4.isIdentity || j.multiplySelf(o$4), u$1(M).translateSelf(v$2, y$1), j.multiplySelf(M), r$8.isIdentity || j.multiplySelf(r$8), _$2 && (u$1(M).translateSelf(m$1, h$1, g$1), j.multiplySelf(M)), d$2.isIdentity || j.multiplySelf(d$2), p$1.isIdentity || j.preMultiplySelf(p$1), e$8.element.style.transform = `${j}`;
	},
...
var B = class {
	...
	constructor(e$8, t$9 = {}) {
		...
		this.id = n$10, this._sensors = e$8, this.settings = this._parseSettings(r$8), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$9) => {
	...
	set sensors(e$8) {
		...
		if (e$8 === t$9) return;
		let n$10 = t$9.filter((t$10) => !e$8.includes(t$10)), r$8 = e$8.filter((e$9) => !t$9.includes(e$9));
		this._sensors = e$8, n$10.forEach((e$9) => {
			this._unbindSensor(e$9);
		}), r$8.forEach((e$9) => {
			this._bindSensor(e$9);
		});
		let i$6 = this.drag?.sensor;
		i$6 && n$10.includes(i$6) && this.stop();
	}
	_bindSensor(e$8) {
		this._sensorData.set(e$8, {
			predicateState: P.Pending,
			predicateEvent: null,
			onMove: (t$10) => this._onMove(t$10, e$8),
			onEnd: (t$10) => this._onEnd(t$10, e$8)
		});
		let { onMove: t$9, onEnd: n$10 } = this._sensorData.get(e$8);
		e$8.on(e$4.Start, t$9, t$9), e$8.on(e$4.Move, t$9, t$9), e$8.on(e$4.Cancel, n$10, n$10), e$8.on(e$4.End, n$10, n$10), e$8.on(e$4.Destroy, n$10, n$10);
	}
	_unbindSensor(e$8) {
		let t$9 = this._sensorData.get(e$8);
		if (!t$9) return;
		let { onMove: n$10, onEnd: r$8 } = t$9;
		e$8.off(e$4.Start, n$10), e$8.off(e$4.Move, n$10), e$8.off(e$4.Cancel, r$8), e$8.off(e$4.End, r$8), e$8.off(e$4.Destroy, r$8), this._sensorData.delete(e$8);
	}
	_parseSettings(e$8, t$9 = z) {
		let { container: n$10 = t$9.container, startPredicate: r$8 = t$9.startPredicate, elements: i$6 = t$9.elements, frozenStyles: a$4 = t$9.frozenStyles, positionModifiers: o$4 = t$9.positionModifiers, applyPosition: s$4 = t$9.applyPosition, computeClientRect: c$3 = t$9.computeClientRect, sensorProcessingMode: l$3 = t$9.sensorProcessingMode, dndGroups: u$3 = t$9.dndGroups, onPrepareStart: d$2 = t$9.onPrepareStart, onStart: f$1 = t$9.onStart, onPrepareMove: p$1 = t$9.onPrepareMove, onMove: m$1 = t$9.onMove, onEnd: h$1 = t$9.onEnd, onDestroy: g$1 = t$9.onDestroy } = e$8 || {};
		return {
			container: n$10,
			startPredicate: r$8,
			elements: i$6,
	...
	_onMove(n$10, r$8) {
		...
		if (i$6) switch (i$6.predicateState) {
			case P.Pending: {
				...
				e$8 === !0 ? this.resolveStartPredicate(r$8) : e$8 === !1 && this.rejectStartPredicate(r$8);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = n$10, this.settings.sensorProcessingMode === I.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$6.read, this._prepareMove, this._moveId), r$5.once(n$6.write, this._applyMove, this._moveId)));
				break;
		}
	}
	_onScroll() {
	...
	_applyStart() {
		...
		if (!(!e$8 || this._startPhase !== N.FinishPrepare)) {
			...
			for (let t$9 of e$8.items) t$9.dragContainer !== t$9.elementContainer && l$1(t$9.dragContainer, t$9.element), t$9.frozenStyles && Object.assign(t$9.element.style, t$9.frozenStyles), this.settings.applyPosition({
				phase: L.Start,
				draggable: this,
				drag: e$8,
				item: t$9
			...
			for (let t$9 of e$8.items) {
				let e$9 = t$9.getContainerMatrix()[0], n$10 = t$9.getDragContainerMatrix()[0];
				if (s$3(e$9, n$10) || !c$2(e$9) && !c$2(n$10)) continue;
				let r$8 = t$9.element.getBoundingClientRect(), { alignmentOffset: i$6 } = t$9;
				i$6.x += d$1(t$9.clientRect.x - r$8.x, 3), i$6.y += d$1(t$9.clientRect.y - r$8.y, 3);
			}
			for (let t$9 of e$8.items) {
	...
	_prepareMove() {
		...
		t$9 !== n$10 && (this._applyModifiers(F.Move, t$9.x - n$10.x, t$9.y - n$10.y), this._emit(R.PrepareMove, e$8, this), !e$8.isEnded && (this.settings.onPrepareMove?.(e$8, this), !e$8.isEnded && (e$8.prevMoveEvent = t$9)));
	}
	_applyMove() {
		let e$8 = this.drag;
		if (!(!e$8 || e$8.isEnded)) {
			for (let t$9 of e$8.items) t$9._moveDiff.x = 0, t$9._moveDiff.y = 0, this.settings.applyPosition({
				phase: L.Move,
				draggable: this,
				drag: e$8,
				item: t$9
	...
	_prepareAlign() {
		let { drag: e$8 } = this;
		if (!(!e$8 || e$8.isEnded)) for (let t$9 of e$8.items) {
			let { x: e$9, y: n$10 } = t$9.element.getBoundingClientRect(), r$8 = t$9.clientRect.x - t$9._moveDiff.x - e$9;
			t$9.alignmentOffset.x = t$9.alignmentOffset.x - t$9._alignDiff.x + r$8, t$9._alignDiff.x = r$8;
			let i$6 = t$9.clientRect.y - t$9._moveDiff.y - n$10;
			t$9.alignmentOffset.y = t$9.alignmentOffset.y - t$9._alignDiff.y + i$6, t$9._alignDiff.y = i$6;
		}
	}
	_applyAlign() {
		let { drag: e$8 } = this;
		if (!(!e$8 || e$8.isEnded)) for (let t$9 of e$8.items) t$9._alignDiff.x = 0, t$9._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$8,
			item: t$9
	...
	_applyModifiers(e$8, t$9, n$10) {
		...
		for (let a$4 of r$8.items) {
			let o$4 = A;
			o$4.x = t$9, o$4.y = n$10;
			for (let t$10 of i$6) o$4 = t$10(o$4, {
				draggable: this,
				drag: r$8,
				item: a$4,
				phase: e$8
			});
			a$4.position.x += o$4.x, a$4.position.y += o$4.y, a$4.clientRect.x += o$4.x, a$4.clientRect.y += o$4.y, e$8 === `move` && (a$4._moveDiff.x += o$4.x, a$4._moveDiff.y += o$4.y);
		}
	}
	on(e$8, t$9, n$10) {
	...
	resolveStartPredicate(n$10, r$8) {
		...
		i$6.predicateState === P.Pending && a$4 && (this._startPhase = N.Init, i$6.predicateState = P.Resolved, i$6.predicateEvent = null, this.drag = new p(n$10, a$4), this._sensorData.forEach((e$8, t$9) => {
	...
	stop() {
		...
		if (!(!n$10 || n$10.isEnded)) {
			...
			n$10.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$5.off(n$6.read, this._startId), r$5.off(n$6.write, this._startId), r$5.off(n$6.read, this._moveId), r$5.off(n$6.write, this._moveId), r$5.off(n$6.read, this._alignId), r$5.off(n$6.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
			for (let e$8 of n$10.items) {
				if (e$8.elementContainer !== e$8.dragContainer && (l$1(e$8.elementContainer, e$8.element), e$8.alignmentOffset.x = 0, e$8.alignmentOffset.y = 0, e$8.containerOffset.x = 0, e$8.containerOffset.y = 0), e$8.unfrozenStyles) for (let t$9 in e$8.unfrozenStyles) e$8.element.style[t$9] = e$8.unfrozenStyles[t$9] || ``;
			...
			for (let e$8 of n$10.items) if (e$8.elementContainer !== e$8.dragContainer) {
				...
				e$8.alignmentOffset.x = d$1(e$8.clientRect.x - t$9.x, 3), e$8.alignmentOffset.y = d$1(e$8.clientRect.y - t$9.y, 3);
			}
	...
	align(n$10 = !1) {
		!this.drag || this.drag.isEnded || (n$10 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$6.read, this._prepareAlign, this._alignId), r$5.once(n$6.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
		let { drag: e$8, settings: t$9 } = this;
		return e$8 && t$9.computeClientRect?.({
			draggable: this,
			drag: e$8
		}) || null;
	}
...
function i$5(e$8, t$9) {
	...
	if (`changedTouches` in e$8) {
		let n$10 = 0;
		for (; n$10 < e$8.changedTouches.length; n$10++) if (e$8.changedTouches[n$10].identifier === t$9) return e$8.changedTouches[n$10];
		return null;
	}
	return e$8;
}
...
var d = class {
	...
	_emitter;
	constructor(e$8, t$9 = {}) {
		let { listenerOptions: n$10 = u.listenerOptions, sourceEvents: i$6 = u.sourceEvents, startPredicate: a$4 = u.startPredicate } = t$9;
		this.element = e$8, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$4, this._listenerOptions = s$2(n$10), this._sourceEvents = c$1(i$6), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$8.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	...
	_bindWindowListeners() {
		...
		window.addEventListener(e$8, this._onMove, this._listenerOptions), window.addEventListener(t$9, this._onEnd, this._listenerOptions), n$10 && window.addEventListener(n$10, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !0;
	}
	_unbindWindowListeners() {
		if (this._areWindowListenersBound) {
			let { move: e$8, end: t$9, cancel: n$10 } = l[this._sourceEvents];
			window.removeEventListener(e$8, this._onMove, this._listenerOptions), window.removeEventListener(t$9, this._onEnd, this._listenerOptions), n$10 && window.removeEventListener(n$10, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !1;
		}
	}
	_resetDrag() {
	...
	updateSettings(e$8) {
		...
		let { listenerOptions: t$9, sourceEvents: n$10, startPredicate: r$8 } = e$8, i$6 = c$1(n$10), a$4 = s$2(t$9);
		r$8 && this._startPredicate !== r$8 && (this._startPredicate = r$8), (t$9 && (this._listenerOptions.capture !== a$4.capture || this._listenerOptions.passive === a$4.passive) || n$10 && this._sourceEvents !== i$6) && (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this._unbindWindowListeners(), this.cancel(), n$10 && (this._sourceEvents = i$6), t$9 && a$4 && (this._listenerOptions = a$4), this.element.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
	on(e$8, t$9, n$10) {
		return this._emitter.on(e$8, t$9, n$10);
	}
...
const n$8 = e$5(), r$6 = e$5(), i$4 = {
	change: 0,
	drift: 0
};
function a$2(e$8, t$9, n$10, r$8, a$4, o$4, s$4) {
	let c$3 = o$4, l$3 = a$4;
	if (o$4 > 0) {
		if (c$3 = Math.min(Math.max(r$8 - t$9, 0), o$4), s$4) if (a$4 < 0) {
			let e$9 = Math.min(-a$4, o$4);
			l$3 = a$4 + e$9, c$3 = Math.max(0, c$3 - e$9);
		} else l$3 = a$4 + (o$4 - c$3);
	} else if (o$4 < 0 && (c$3 = Math.max(Math.min(n$10 - e$8, 0), o$4), s$4)) if (a$4 > 0) {
		let e$9 = Math.max(-a$4, o$4);
		l$3 = a$4 + e$9, c$3 = Math.min(0, c$3 - e$9);
	} else l$3 = a$4 + (o$4 - c$3);
	i$4.change = c$3, i$4.drift = l$3;
}
function o(o$4, s$4 = ({ drag: e$8 }) => e$8.sensor instanceof d) {
	return function(t$9, c$3) {
		let l$3 = e$5(o$4(c$3), n$8), u$3 = e$5(c$3.item.clientRect, r$6), d$2 = c$3.item.data, f$1 = d$2.__containment__ || {
			drift: {
				x: 0,
				y: 0
			},
		...
		d$2.__containment__ ||= (f$1.trackDrift = typeof s$4 == `function` ? s$4(c$3) : s$4, f$1);
		let { drift: p$1, trackDrift: m$1 } = f$1;
		return t$9.x &&= (a$2(u$3.left, u$3.right, l$3.left, l$3.right, p$1.x, t$9.x, m$1), p$1.x = i$4.drift, i$4.change), t$9.y &&= (a$2(u$3.top, u$3.bottom, l$3.top, l$3.bottom, p$1.y, t$9.y, m$1), p$1.y = i$4.drift, i$4.change), t$9;
	};
}
...
var i$3 = class extends n$7 {
	...
	_start(n$10) {
		this.isDestroyed || this.drag || (super._start(n$10), r$5.on(n$6.read, this._tick, this._tick));
	}
	_end(n$10) {
	...
	_tick(e$8) {
		if (this.drag) if (e$8 && this.drag.time) {
			...
			let r$8 = this._speed * (this.drag.deltaTime / 1e3), i$6 = this._direction.x * r$8, a$4 = this._direction.y * r$8;
			(i$6 || a$4) && this._move({
				type: e$4.Move,
				x: this.drag.x + i$6,
				y: this.drag.y + a$4
...
var a = class extends i$3 {
	...
	constructor(e$8, t$9 = {}) {
		super();
		let { startPredicate: n$10 = i$2.startPredicate, computeSpeed: r$8 = i$2.computeSpeed, cancelOnVisibilityChange: a$4 = i$2.cancelOnVisibilityChange, cancelOnBlur: o$4 = i$2.cancelOnBlur, startKeys: s$4 = i$2.startKeys, moveLeftKeys: c$3 = i$2.moveLeftKeys, moveRightKeys: l$3 = i$2.moveRightKeys, moveUpKeys: u$3 = i$2.moveUpKeys, moveDownKeys: d$2 = i$2.moveDownKeys, cancelKeys: f$1 = i$2.cancelKeys, endKeys: p$1 = i$2.endKeys } = t$9;
		this.element = e$8, this._startKeys = new Set(s$4), this._cancelKeys = new Set(f$1), this._endKeys = new Set(p$1), this._moveLeftKeys = new Set(c$3), this._moveRightKeys = new Set(l$3), this._moveUpKeys = new Set(u$3), this._moveDownKeys = new Set(d$2), this._moveKeys = new Set([
			...c$3,
			...l$3,
			...u$3,
			...d$2
		]), this._moveKeyTimestamps = /* @__PURE__ */ new Map(), this._cancelOnBlur = o$4, this._cancelOnVisibilityChange = a$4, this._computeSpeed = r$8, this._startPredicate = n$10, this._onKeyDown = this._onKeyDown.bind(this), this._onKeyUp = this._onKeyUp.bind(this), this._onTick = this._onTick.bind(this), this._internalCancel = this._internalCancel.bind(this), this._blurCancelHandler = this._blurCancelHandler.bind(this), this.on(`tick`, this._onTick, this._onTick), document.addEventListener(`keydown`, this._onKeyDown), document.addEventListener(`keyup`, this._onKeyUp), o$4 && e$8?.addEventListener(`blur`, this._blurCancelHandler), a$4 && document.addEventListener(`visibilitychange`, this._internalCancel);
	}
	_end(e$8) {
	...
	_updateDirection() {
		let e$8 = r$4(this._moveLeftKeys, this._moveKeyTimestamps), t$9 = r$4(this._moveRightKeys, this._moveKeyTimestamps), n$10 = r$4(this._moveUpKeys, this._moveKeyTimestamps), i$6 = r$4(this._moveDownKeys, this._moveKeyTimestamps), a$4 = e$8 === t$9 ? 0 : e$8 < t$9 ? -1 : 1, o$4 = n$10 === i$6 ? 0 : n$10 < i$6 ? -1 : 1;
		if (!(a$4 === 0 || o$4 === 0)) {
			let e$9 = 1 / (Math.sqrt(a$4 * a$4 + o$4 * o$4) || 1);
			a$4 *= e$9, o$4 *= e$9;
		}
	...
	_onKeyDown(t$9) {
		if (!this.drag) {
			if (this._startKeys.has(t$9.key)) {
				...
				n$10 && (t$9.preventDefault(), this._start({
					type: e$4.Start,
					x: n$10.x,
					y: n$10.y
				}));
	...
	updateSettings(e$8) {
		if (this.isDestroyed) return;
		let t$9 = !1, { cancelOnBlur: r$8, cancelOnVisibilityChange: i$6, startPredicate: a$4, computeSpeed: o$4 } = e$8;
		if (r$8 !== void 0 && this._cancelOnBlur !== r$8 && (this._cancelOnBlur = r$8, r$8 ? this.element?.addEventListener(`blur`, this._blurCancelHandler) : this.element?.removeEventListener(`blur`, this._blurCancelHandler)), i$6 !== void 0 && this._cancelOnVisibilityChange !== i$6 && (this._cancelOnVisibilityChange = i$6, i$6 ? document.addEventListener(`visibilitychange`, this._internalCancel) : document.removeEventListener(`visibilitychange`, this._internalCancel)), a$4 !== void 0 && (this._startPredicate = a$4), o$4 !== void 0 && (this._computeSpeed = o$4), n$5.forEach((n$10, r$9) => {
			let i$7 = `${n$10}Keys`, a$5 = e$8[i$7];
			...
			[...this._moveKeys].every((t$10, n$10) => e$9[n$10] === t$10) || (this._moveKeys = new Set(e$9), this._moveKeyTimestamps.clear(), this._updateDirection());
		}
	}
	destroy() {
...
var require_react_development = /* @__PURE__ */ __commonJS({ "../../node_modules/react/cjs/react.development.js": ((exports, module) => {
	(function() {
		...
		function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
			...
			if (isArrayImpl(children)) for (var i$6 = 0; i$6 < children.length; i$6++) nameSoFar = children[i$6], type = childKey + getElementKey(nameSoFar, i$6), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if (i$6 = getIteratorFn(children), "function" === typeof i$6) for (i$6 === children.entries && (didWarnAboutMaps || console.warn("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), didWarnAboutMaps = !0), children = i$6.call(children), i$6 = 0; !(nameSoFar = children.next()).done;) nameSoFar = nameSoFar.value, type = childKey + getElementKey(nameSoFar, i$6++), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if ("object" === type) {
		...
		exports.cloneElement = function(element, config, children) {
			...
			if (1 === propName) props.children = children;
				...
				for (var i$6 = 0; i$6 < propName; i$6++) JSCompiler_inline_result[i$6] = arguments[i$6 + 2];
		...
		exports.createElement = function(type, config, children) {
			...
			if (type && type.defaultProps) for (propName in childrenLength = type.defaultProps, childrenLength) void 0 === i$6[propName] && (i$6[propName] = childrenLength[propName]);
			key && defineKeyPropWarningGetter(i$6, "function" === typeof type ? type.displayName || type.name || "Unknown" : type);
			var propName = 1e4 > ReactSharedInternals.recentlyCreatedOwnerStacks++;
			return ReactElement(type, key, i$6, getOwner(), propName ? Error("react-stack-top-frame") : unknownOwnerDebugStack, propName ? createTask(getTaskName(type)) : unknownOwnerDebugTask);
		};
...
function n$4(r$8, i$6) {
	...
	let a$4 = Array.isArray(r$8), o$4 = Array.isArray(i$6);
	if (a$4 || o$4) {
		if (!a$4 || !o$4) return !1;
		let e$8 = r$8.length;
	...
	let s$4 = r$8 instanceof Set, c$3 = i$6 instanceof Set;
	if (s$4 || c$3) return !s$4 || !c$3 || r$8.size !== i$6.size ? !1 : r$8.isSubsetOf(i$6);
	if (!t$3(r$8) || !t$3(i$6)) return !1;
	let l$3 = Object.keys(r$8), u$3 = Object.keys(i$6);
...
function n$1(n$10, r$8) {
	let i$6 = (0, import_react.useRef)(null), a$4 = i$6.current || {
		deps: r$8,
		value: n$10()
	};
	return i$6.current ? t$2(r$8, a$4.deps) || (a$4.deps = r$8, a$4.value = n$10()) : i$6.current = a$4, a$4.value;
}
...
function c(c$3, l$3) {
	let u$3 = n$1(() => c$3.filter((e$8) => !!e$8), [...c$3]), { id: d$2, dndObserver: f$1,...p$1 } = l$3 || {}, m$1 = n$1(() => d$2 === void 0 ? Symbol() : d$2, [d$2]), h$1 = n$3(), g$1 = f$1 === void 0 ? h$1 : f$1, [_$2, v$2] = (0, import_react.useState)(null), y$1 = (0, import_react.useRef)(null), b$1 = (0, import_react.useRef)(u$3);
	b$1.current = u$3;
	...
	return n(() => {
		...
		if (!_$2) return;
		let e$8 = x$1.current;
		C$1.current !== e$8 && (n$4(C$1.current, e$8) || (_$2.updateSettings(_$2._parseSettings(e$8)), C$1.current && e$8.dndGroups !== C$1.current.dndGroups && S$1.current?.clearTargets(_$2)), C$1.current = e$8);
...
function n$2(n$10, r$8, i$6) {
	let a$4 = !!i$6, o$4 = (0, import_react.useRef)(i$6);
	o$4.current = i$6, n(() => {
		if (!n$10 || !a$4) return;
...
function r(r$8, i$6 = !1) {
	let [a$4, o$4] = (0, import_react.useState)(r$8?.drag || null), s$4 = (0, import_react.useState)(void 0)[1];
	return n$2(r$8, R.Start, (e$8) => {
		o$4(e$8);
	}), n$2(r$8, R.Move, () => {
		i$6 && s$4(Symbol());
	}), n$2(r$8, R.End, () => {
...
function s(s$4, c$3) {
	...
	let p$1 = r$1((e$8) => {
		let t$9 = d$2.current;
		if (t$9) {
			t$9.updateElement(e$8);
			return;
		}
		let n$10 = new a(e$8, f$1.current);
	...
	return n(() => {
		...
		if (l$3) {
			let { startKeys: e$8 = i$2.startKeys, moveLeftKeys: t$9 = i$2.moveLeftKeys, moveRightKeys: n$10 = i$2.moveRightKeys, moveUpKeys: r$8 = i$2.moveUpKeys, moveDownKeys: i$6 = i$2.moveDownKeys, cancelKeys: a$4 = i$2.cancelKeys, endKeys: c$4 = i$2.endKeys, cancelOnBlur: u$4 = i$2.cancelOnBlur, cancelOnVisibilityChange: d$3 = i$2.cancelOnVisibilityChange, computeSpeed: f$2 = i$2.computeSpeed, startPredicate: p$2 = i$2.startPredicate } = s$4 || {};
			l$3.updateSettings({
				startKeys: e$8,
				moveLeftKeys: t$9,
				moveRightKeys: n$10,
...
function s$1(s$4, c$3) {
	...
	return n(() => {
		...
		if (l$3) {
			let { listenerOptions: e$8 = u.listenerOptions, sourceEvents: t$9 = u.sourceEvents, startPredicate: n$10 = u.startPredicate } = s$4 || {};
			l$3.updateSettings({
				listenerOptions: e$8,
				sourceEvents: t$9,
				startPredicate: n$10
	...
	(function() {
		...
		function copyWithRename(obj, oldPath, newPath) {
			if (oldPath.length !== newPath.length) console.warn("copyWithRename() expects paths of the same length");
				...
				for (var i$6 = 0; i$6 < newPath.length - 1; i$6++) if (oldPath[i$6] !== newPath[i$6]) {
		...
		function findCurrentFiberUsingSlowPath(fiber) {
			...
			for (var a$4 = fiber, b$1 = alternate;;) {
				...
				if (a$4.alternate !== b$1) throw Error("Return fibers should always be each others' alternates. This error is likely caused by a bug in React. Please file an issue.");
			}
		...
		function getComponentNameFromFiber(fiber) {
			...
			switch (fiber.tag) {
				...
				case 29:
					...
					if (null != type) {
						for (var i$6 = type.length - 1; 0 <= i$6; i$6--) if ("string" === typeof type[i$6].name) return type[i$6].name;
					}
		...
		function getStackByFiberInDevAndProd(workInProgress$1) {
			try {
				...
				do {
					...
					if (debugInfo) for (var i$6 = debugInfo.length - 1; 0 <= i$6; i$6--) {
		...
		function updateOptions(node, multiple, propValue, setDefaultSelected) {
			...
			if (multiple) {
				...
				for (propValue = 0; propValue < node.length; propValue++) i$6 = multiple.hasOwnProperty("$" + node[propValue].value), node[propValue].selected !== i$6 && (node[propValue].selected = i$6), i$6 && setDefaultSelected && (node[propValue].defaultSelected = !0);
			} else {
		...
		function describeNode(node, indent) {
			...
			if (debugInfo) for (var i$6 = 0; i$6 < debugInfo.length; i$6++) {
				var serverComponentName = debugInfo[i$6].name;
				"string" === typeof serverComponentName && (skipToNode += indentation(indent) + "<" + serverComponentName + ">\n", indent++);
			}
			debugInfo = "";
			i$6 = node.fiber.pendingProps;
			if (6 === node.fiber.tag) debugInfo = describeTextDiff(i$6, node.serverProps, indent), indent++;
				...
				for (propName in i$6) if (i$6.hasOwnProperty(propName) && "children" !== propName) {
				...
				indent++;
			} else null === node.serverProps ? (debugInfo = describeExpandedElement(serverComponentName, i$6, added(indent)), indent++) : "string" === typeof node.serverProps ? console.error("Should not have matched a non HostText fiber to a Text node. This is a bug in React.") : (debugInfo = describeElementDiff(serverComponentName, i$6, node.serverProps, indent), indent++);
			var propName = "";
			i$6 = node.fiber.child;
			for (serverComponentName = 0; i$6 && serverComponentName < node.children.length;) maxLength = node.children[serverComponentName], maxLength.fiber === i$6 ? (propName += describeNode(maxLength, indent), serverComponentName++) : propName += describeSiblingFiber(i$6, indent), i$6 = i$6.sibling;
			i$6 && 0 < node.children.length && (propName += indentation(indent) + "...\n");
			i$6 = node.serverTail;
			null === node.serverProps && indent--;
			for (node = 0; node < i$6.length; node++) serverComponentName = i$6[node], propName = "string" === typeof serverComponentName ? propName + (removed(indent) + describeTextNode(serverComponentName, 120 - 2 * indent) + "\n") : propName + describeExpandedElement(serverComponentName.type, serverComponentName.props, removed(indent));
		...
		function setValueForStyles(node, styles, prevStyles) {
			...
			if (null != prevStyles) {
				if (styles) {
					var expandedUpdates = {};
					if (prevStyles) {
						for (var key in prevStyles) if (prevStyles.hasOwnProperty(key) && !styles.hasOwnProperty(key)) for (var longhands = shorthandToLonghand[key] || [key], i$6 = 0; i$6 < longhands.length; i$6++) expandedUpdates[longhands[i$6]] = key;
					}
					...
					key$jscomp$0 = {};
					for (var _key2 in expandedUpdates) if (key = expandedUpdates[_key2], (longhands = _key[_key2]) && key !== longhands && (i$6 = key + "," + longhands, !key$jscomp$0[i$6])) {
						key$jscomp$0[i$6] = !0;
						i$6 = console;
						var value = styles[key];
						i$6.error.call(i$6, "%s a style property during rerender (%s) when a conflicting property is set (%s) can lead to styling bugs. To avoid this, don't mix shorthand and non-shorthand properties for the same value; instead, replace the shorthand with separate values.", null == value || "boolean" === typeof value || "" === value ? "Removing" : "Updating", key, longhands);
					}
				}
		...
		function finishQueueingConcurrentUpdates() {
			for (var endIndex = concurrentQueuesIndex, i$6 = concurrentlyUpdatedLanes = concurrentQueuesIndex = 0; i$6 < endIndex;) {
			...
			for (; null !== fiber;) {
				...
				if (null !== list) {
					...
					a: for (; null !== list;) {
						var dependency = list;
						list = fiber;
						for (var i$6 = 0; i$6 < contexts.length; i$6++) if (dependency.context === contexts[i$6]) {
		...
		function getCurrentDebugTask() {
			...
			if (null != debugInfo) {
				for (var i$6 = debugInfo.length - 1; 0 <= i$6; i$6--) if (null != debugInfo[i$6].name) {
		...
		function createChildReconciler(shouldTrackSideEffects) {
			...
			return function(returnFiber, currentFirstChild, newChild, lanes) {
				...
				try {
					...
					if (null != debugInfo) {
						for (var i$6 = debugInfo.length - 1; 0 <= i$6; i$6--) if ("string" === typeof debugInfo[i$6].stack) {
			...
			if (null !== hookTypesDev && (hookTypesUpdateIndexDev++, hookTypesDev[hookTypesUpdateIndexDev] !== hookName)) {
				...
				if (!didWarnAboutMismatchedHooksForComponent.has(componentName$1) && (didWarnAboutMismatchedHooksForComponent.add(componentName$1), null !== hookTypesDev)) {
					for (var table = "", i$6 = 0; i$6 <= hookTypesUpdateIndexDev; i$6++) {
						var oldHookName = hookTypesDev[i$6], newHookName = i$6 === hookTypesUpdateIndexDev ? hookName : oldHookName;
						for (oldHookName = i$6 + 1 + ". " + oldHookName; 30 > oldHookName.length;) oldHookName += " ";
		...
		function areHookInputsEqual(nextDeps, prevDeps) {
			...
			for (var i$6 = 0; i$6 < prevDeps.length && i$6 < nextDeps.length; i$6++) if (!objectIs(nextDeps[i$6], prevDeps[i$6])) return !1;
			return !0;
		}
				...
				if (null !== lastEffect) {
					...
					do {
						if ((updateQueue.tag & flags) === flags && (lastEffect = void 0, (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !0), lastEffect = runWithFiberInDEV(finishedWork, callCreateInDEV, updateQueue), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !1), void 0 !== lastEffect && "function" !== typeof lastEffect)) {
							...
							runWithFiberInDEV(finishedWork, function(n$10, a$4) {
								console.error("%s must not return anything besides a function, which is used for clean-up.%s", n$10, a$4);
							}, hookName, addendum);
						}
		...
		function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber) {
			...
			if (null !== deletions) for (var i$6 = 0; i$6 < deletions.length; i$6++) {
				var root$1 = root$jscomp$0, returnFiber = parentFiber, deletedFiber = deletions[i$6], prevEffectStart = pushComponentEffectStart(), parent = returnFiber;
				a: for (; null !== parent;) {
					switch (parent.tag) {
						case 27:
								...
								b: switch (flags) {
									...
									case "meta":
										if (maybeNodes = getHydratableHoistableCache("meta", "content", existingHiddenCallbacks).get(flags + (current$1.content || ""))) {
											for (i$6 = 0; i$6 < maybeNodes.length; i$6++) if (currentResource = maybeNodes[i$6], checkAttributeStringCoercion(current$1.content, "content"), currentResource.getAttribute("content") === (null == current$1.content ? null : "" + current$1.content) && currentResource.getAttribute("name") === (null == current$1.name ? null : current$1.name) && currentResource.getAttribute("property") === (null == current$1.property ? null : current$1.property) && currentResource.getAttribute("http-equiv") === (null == current$1.httpEquiv ? null : current$1.httpEquiv) && currentResource.getAttribute("charset") === (null == current$1.charSet ? null : current$1.charSet)) {
												maybeNodes.splice(i$6, 1);
												break b;
											}
										}
					...
					if (flags & 8192) a: for (root$1 = finishedWork.stateNode, root$1._visibility = existingHiddenCallbacks ? root$1._visibility & ~OffscreenVisible : root$1._visibility | OffscreenVisible, !existingHiddenCallbacks || null === current$1 || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || (recursivelyTraverseDisappearLayoutEffects(finishedWork), (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentTrigger(finishedWork, componentEffectStartTime, componentEffectEndTime, "Disconnect")), current$1 = null, root$1 = finishedWork;;) {
						if (5 === root$1.tag || 26 === root$1.tag) {
							...
							if (null === current$1) {
								wasHidden = root$1;
								try {
									i$6 = wasHidden.stateNode, existingHiddenCallbacks ? runWithFiberInDEV(wasHidden, hideDehydratedBoundary, i$6) : runWithFiberInDEV(wasHidden, unhideDehydratedBoundary, wasHidden.stateNode);
								} catch (error) {
									captureCommitPhaseError(wasHidden, wasHidden.return, error);
								}
							}
		...
		function recursivelyTraversePassiveUnmountEffects(parentFiber) {
			...
			if (0 !== (parentFiber.flags & 16)) {
				if (null !== deletions) for (var i$6 = 0; i$6 < deletions.length; i$6++) {
					var childToDelete = deletions[i$6], prevEffectStart = pushComponentEffectStart();
		...
		function isRenderConsistentWithExternalStores(finishedWork) {
			for (var node = finishedWork;;) {
				var tag = node.tag;
				if ((0 === tag || 11 === tag || 15 === tag) && node.flags & 16384 && (tag = node.updateQueue, null !== tag && (tag = tag.stores, null !== tag))) for (var i$6 = 0; i$6 < tag.length; i$6++) {
					var check = tag[i$6], getSnapshot = check.getSnapshot;
					check = check.value;
					try {
		...
		function diffHydratedProperties(domElement, tag, props, hostContext) {
			for (var serverDifferences = {}, extraAttributes = /* @__PURE__ */ new Set(), attributes = domElement.attributes, i$6 = 0; i$6 < attributes.length; i$6++) switch (attributes[i$6].name.toLowerCase()) {
				case "value": break;
				case "checked": break;
				case "selected": break;
				default: extraAttributes.add(attributes[i$6].name);
			}
				...
				if (registrationNameDependencies.hasOwnProperty(value)) "function" !== typeof propKey && warnForInvalidEventListener(value, propKey);
					...
					case "download":
						a: {
							...
							if (null === i$6) switch (typeof propKey) {
								case "undefined":
								case "function":
								case "symbol": break a;
								...
								case "boolean":
									...
									break;
								default: if (checkAttributeStringCoercion(propKey, attributes), i$6 === "" + propKey) break a;
							}
					...
					case "span":
						a: {
							...
							if (null === i$6) switch (typeof propKey) {
								...
								case "symbol":
								case "boolean": break;
								default: if (!(isNaN(propKey) || 1 > propKey) && (checkAttributeStringCoercion(propKey, attributes), i$6 === "" + propKey)) break a;
							}
							warnForPropDifference(attributes, i$6, propKey, serverDifferences$jscomp$0);
						}
						continue;
					...
					default: if (!(2 < value.length) || "o" !== value[0] && "O" !== value[0] || "n" !== value[1] && "N" !== value[1]) {
						...
						attributes = !1;
						hostContext.context === HostContextNamespaceNone && "svg" !== tag && "math" !== tag ? extraAttributes.delete(i$6.toLowerCase()) : (attributeName = value.toLowerCase(), attributeName = possibleStandardNames.hasOwnProperty(attributeName) ? possibleStandardNames[attributeName] || null : null, null !== attributeName && attributeName !== value && (attributes = !0, extraAttributes.delete(attributeName)), extraAttributes.delete(i$6));
						a: if (attributeName = domElement, serverDifferences$jscomp$0 = i$6, i$6 = propKey, isAttributeNameSafe(serverDifferences$jscomp$0)) if (attributeName.hasAttribute(serverDifferences$jscomp$0)) attributeName = attributeName.getAttribute(serverDifferences$jscomp$0), checkAttributeStringCoercion(i$6, serverDifferences$jscomp$0), i$6 = attributeName === "" + i$6 ? i$6 : attributeName;
						else {
							switch (typeof i$6) {
								case "function":
								case "symbol": break a;
		...
		function estimateBandwidth() {
			if ("function" === typeof performance.getEntriesByType) {
				for (var count = 0, bits = 0, resourceEntries = performance.getEntriesByType("resource"), i$6 = 0; i$6 < resourceEntries.length; i$6++) {
					var entry = resourceEntries[i$6], transferSize = entry.transferSize, initiatorType = entry.initiatorType, duration = entry.duration;
					if (transferSize && duration && isLikelyStaticResource(initiatorType)) {
						initiatorType = 0;
						duration = entry.responseEnd;
						for (i$6 += 1; i$6 < resourceEntries.length; i$6++) {
							var overlapEntry = resourceEntries[i$6], overlapStartTime = overlapEntry.startTime;
		...
		function describeHydratableInstanceForDevWarnings(instance) {
			if (1 === instance.nodeType) {
				for (var JSCompiler_temp_const = instance.nodeName.toLowerCase(), serverDifferences = {}, attributes = instance.attributes, i$6 = 0; i$6 < attributes.length; i$6++) {
		...
		function insertStylesheet(instance, precedence, root$1) {
			for (var nodes = root$1.querySelectorAll("link[rel=\"stylesheet\"][data-precedence],style[data-precedence]"), last = nodes.length ? nodes[nodes.length - 1] : null, prior = last, i$6 = 0; i$6 < nodes.length; i$6++) {
				var node = nodes[i$6];
		...
		function insertStylesheetIntoRoot(root$1, resource) {
			if (!(resource.state.loading & Inserted)) {
				...
				if (precedences) var last = precedences.get(LAST_PRECEDENCE);
					...
					for (var nodes = root$1.querySelectorAll("link[data-precedence],style[data-precedence]"), i$6 = 0; i$6 < nodes.length; i$6++) {
						var node = nodes[i$6];
				...
				i$6 ? i$6.parentNode.insertBefore(nodes, i$6.nextSibling) : (root$1 = 9 === root$1.nodeType ? root$1.head : root$1, root$1.insertBefore(nodes, root$1.firstChild));
				resource.state.loading |= Inserted;
			}
		}
		...
		function scheduleReplayQueueIfNeeded(formReplayingQueue) {
			lastScheduledReplayQueue !== formReplayingQueue && (lastScheduledReplayQueue = formReplayingQueue, Scheduler.unstable_scheduleCallback(Scheduler.unstable_NormalPriority, function() {
				...
				for (var i$6 = 0; i$6 < formReplayingQueue.length; i$6 += 3) {
					var form = formReplayingQueue[i$6], submitterOrAction = formReplayingQueue[i$6 + 1], formData = formReplayingQueue[i$6 + 2];
					if ("function" !== typeof submitterOrAction) if (null === findInstanceBlockingTarget(submitterOrAction || form)) continue;
					else break;
					var formInst = getInstanceFromNode(form);
					null !== formInst && (formReplayingQueue.splice(i$6, 3), i$6 -= 3, form = {
						pending: !0,
						data: formData,
						method: form.method,
		...
		function retryIfBlockedOn(unblocked) {
			...
			for (; 0 < queuedExplicitHydrationTargets.length && (i$6 = queuedExplicitHydrationTargets[0], null === i$6.blockedOn);) attemptExplicitHydrationTarget(i$6), null === i$6.blockedOn && queuedExplicitHydrationTargets.shift();
			i$6 = (unblocked.ownerDocument || unblocked).$$reactFormReplay;
			if (null != i$6) for (queuedTarget = 0; queuedTarget < i$6.length; queuedTarget += 3) {
				var form = i$6[queuedTarget], submitterOrAction = i$6[queuedTarget + 1], formProps = form[internalPropsKey] || null;
				if ("function" === typeof submitterOrAction) formProps || scheduleReplayQueueIfNeeded(i$6);
				else if (formProps) {
					var action = null;
					...
					"function" === typeof action ? i$6[queuedTarget + 1] = action : (i$6.splice(queuedTarget, 3), queuedTarget -= 3);
		...
		(function() {
			for (var i$6 = 0; i$6 < simpleEventPluginEvents.length; i$6++) {
				var eventName = simpleEventPluginEvents[i$6], domEventName = eventName.toLowerCase();
		...
		ReactDOMHydrationRoot.prototype.unstable_scheduleHydration = function(target) {
			if (target) {
				...
				for (var i$6 = 0; i$6 < queuedExplicitHydrationTargets.length && 0 !== updatePriority && updatePriority < queuedExplicitHydrationTargets[i$6].priority; i$6++);
