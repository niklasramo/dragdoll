...
var __copyProps = (to, from, except, desc) => {
	if (from && typeof from === "object" || typeof from === "function") for (var keys = __getOwnPropNames(from), i$5 = 0, n$9 = keys.length, key; i$5 < n$9; i$5++) {
		key = keys[i$5];
...
var E$1 = {
	...
	constructor(t$9 = {}) {
		this.dedupe = t$9.dedupe || E$1.ADD, this.getId = t$9.getId || (() => Symbol()), this._events = /* @__PURE__ */ new Map();
	}
	_getListeners(t$9) {
		let n$9 = this._events.get(t$9);
		return n$9 ? n$9.l || (n$9.l = [...n$9.m.values()]) : null;
	}
	on(t$9, n$9, e$7) {
		let i$5 = this._events, s$4 = i$5.get(t$9);
		s$4 || (s$4 = {
			m: /* @__PURE__ */ new Map(),
			l: null
		}, i$5.set(t$9, s$4));
		let o$3 = s$4.m;
		if (e$7 = e$7 === r$6 ? this.getId(n$9) : e$7, o$3.has(e$7)) switch (this.dedupe) {
			case E$1.THROW: throw new Error("Eventti: duplicate listener id!");
			case E$1.IGNORE: return e$7;
			case E$1.UPDATE:
				s$4.l = null;
				break;
			default: o$3.delete(e$7), s$4.l = null;
		}
		return o$3.set(e$7, n$9), s$4.l?.push(n$9), e$7;
	}
	once(t$9, n$9, e$7) {
		let i$5 = 0;
		return e$7 = e$7 === r$6 ? this.getId(n$9) : e$7, this.on(t$9, (...s$4) => {
			i$5 || (i$5 = 1, this.off(t$9, e$7), n$9(...s$4));
		}, e$7);
	}
	off(t$9, n$9) {
		if (t$9 === r$6) {
		...
		let e$7 = this._events.get(t$9);
		e$7?.m.delete(n$9) && (e$7.l = null, e$7.m.size || this._events.delete(t$9));
	}
	emit(t$9, ...n$9) {
		let e$7 = this._getListeners(t$9);
		if (e$7) {
			let i$5 = e$7.length, s$4 = 0;
			if (n$9.length) for (; s$4 < i$5; s$4++) e$7[s$4](...n$9);
	...
	listenerCount(t$9) {
		if (t$9 === r$6) {
			let n$9 = 0;
			return this._events.forEach((e$7) => {
				n$9 += e$7.m.size;
			}), n$9;
		}
...
var _$1 = E$1, o$2 = class {
	constructor(e$7 = {}) {
		let { phases: t$9 = [], dedupe: r$7, getId: s$4 } = e$7;
		this._phases = t$9, this._emitter = new v({
			getId: s$4,
			dedupe: r$7
	...
	set dedupe(e$7) {
		this._emitter.dedupe = e$7;
	}
	get getId() {
		return this._emitter.getId;
	}
	set getId(e$7) {
		this._emitter.getId = e$7;
	}
	tick(...e$7) {
		this._assertEmptyQueue(), this._fillQueue(), this._processQueue(...e$7);
	}
	on(e$7, t$9, r$7) {
		return this._emitter.on(e$7, t$9, r$7);
	}
	once(e$7, t$9, r$7) {
		return this._emitter.once(e$7, t$9, r$7);
	}
	off(e$7, t$9) {
		return this._emitter.off(e$7, t$9);
	}
	count(e$7) {
		return this._emitter.listenerCount(e$7);
	}
	_assertEmptyQueue() {
		if (this._queue.length) throw new Error("Ticker: Can't tick before the previous tick has finished!");
	}
	_fillQueue() {
		let e$7 = this._queue, t$9 = this._phases, r$7 = this._getListeners, s$4 = 0, a$3 = t$9.length, n$9;
		for (; s$4 < a$3; s$4++) n$9 = r$7(t$9[s$4]), n$9 && e$7.push(n$9);
		return e$7;
	}
	_processQueue(...e$7) {
		let t$9 = this._queue, r$7 = t$9.length;
		if (!r$7) return;
		let s$4 = 0, a$3 = 0, n$9, c$3;
		for (; s$4 < r$7; s$4++) for (n$9 = t$9[s$4], a$3 = 0, c$3 = n$9.length; a$3 < c$3; a$3++) n$9[a$3](...e$7);
		t$9.length = 0;
	}
};
function u$2(i$5 = 60) {
	if (typeof requestAnimationFrame == "function" && typeof cancelAnimationFrame == "function") return (e$7) => {
		let t$9 = requestAnimationFrame(e$7);
		return () => cancelAnimationFrame(t$9);
	};
	{
		let e$7 = 1e3 / i$5, t$9 = typeof performance > "u" ? () => Date.now() : () => performance.now();
		return (r$7) => {
			let s$4 = setTimeout(() => r$7(t$9()), e$7);
...
var l$2 = class extends o$2 {
	constructor(e$7 = {}) {
		let { paused: t$9 = !1, onDemand: r$7 = !1, requestFrame: s$4 = u$2(),...a$3 } = e$7;
		super(a$3), this._paused = t$9, this._onDemand = r$7, this._requestFrame = s$4, this._cancelFrame = null, this._empty = !0, !t$9 && !r$7 && this._request();
	}
	get phases() {
		return this._phases;
	}
	set phases(e$7) {
		this._phases = e$7, e$7.length ? (this._empty = !1, this._request()) : this._empty = !0;
	}
	get paused() {
		return this._paused;
	}
	set paused(e$7) {
		this._paused = e$7, e$7 ? this._cancel() : this._request();
	}
	get onDemand() {
		return this._onDemand;
	}
	set onDemand(e$7) {
		this._onDemand = e$7, e$7 || this._request();
	}
	get requestFrame() {
		return this._requestFrame;
	}
	set requestFrame(e$7) {
		this._requestFrame !== e$7 && (this._requestFrame = e$7, this._cancelFrame && (this._cancel(), this._request()));
	}
	tick(...e$7) {
		if (this._assertEmptyQueue(), this._cancelFrame = null, this._onDemand || this._request(), !this._empty) {
			...
			this._onDemand && this._request(), this._processQueue(...e$7);
		}
	}
	on(e$7, t$9, r$7) {
		let s$4 = super.on(e$7, t$9, r$7);
		return this._empty = !1, this._request(), s$4;
	}
	once(e$7, t$9, r$7) {
		let s$4 = super.once(e$7, t$9, r$7);
		return this._empty = !1, this._request(), s$4;
	}
	_request() {
...
const IS_CHROMIUM = (() => {
	try {
		return window.navigator.userAgentData.brands.some((({ brand: n$9 }) => "Chromium" === n$9));
	} catch (n$9) {
		return !1;
	}
})();
...
function isWindow(n$9) {
	return n$9 instanceof Window;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/getStyle.js
const STYLE_DECLARATION_CACHE = /* @__PURE__ */ new WeakMap();
function getStyle(e$7, t$9) {
	if (t$9) return window.getComputedStyle(e$7, t$9);
	let C$1 = STYLE_DECLARATION_CACHE.get(e$7)?.deref();
	return C$1 || (C$1 = window.getComputedStyle(e$7, null), STYLE_DECLARATION_CACHE.set(e$7, new WeakRef(C$1))), C$1;
}

//#endregion
//#region ../../node_modules/mezr/dist/esm/utils/isDocumentElement.js
function isDocumentElement(e$7) {
	return e$7 instanceof HTMLHtmlElement;
}

//#endregion
//#region ../dragdoll/dist/get-style-CC2j8jdv.js
const e$6 = /* @__PURE__ */ new WeakMap();
function t$8(t$9) {
	let n$9 = e$6.get(t$9)?.deref();
	return n$9 || (n$9 = window.getComputedStyle(t$9, null), e$6.set(t$9, new WeakRef(n$9))), n$9;
}

//#endregion
//#region ../dragdoll/dist/constants-CMClRu_c.js
const e$5 = typeof window < `u` && window.document !== void 0, t$7 = e$5 && `ontouchstart` in window, n$8 = e$5 && !!window.PointerEvent;
e$5 && navigator.vendor && navigator.vendor.indexOf(`Apple`) > -1 && navigator.userAgent && navigator.userAgent.indexOf(`CriOS`) == -1 && navigator.userAgent.indexOf(`FxiOS`);
...
function isBlockElement(e$7) {
	switch (getStyle(e$7).display) {
...
function isContainingBlockForFixedElement(n$9) {
	const t$9 = getStyle(n$9);
	if (!IS_SAFARI) {
		const { filter: n$10 } = t$9;
		if (n$10 && "none" !== n$10) return !0;
		const { backdropFilter: e$8 } = t$9;
		if (e$8 && "none" !== e$8) return !0;
		const { willChange: i$6 } = t$9;
		if (i$6 && (i$6.indexOf("filter") > -1 || i$6.indexOf("backdrop-filter") > -1)) return !0;
	}
	const e$7 = isBlockElement(n$9);
	if (!e$7) return e$7;
	const { transform: i$5 } = t$9;
	if (i$5 && "none" !== i$5) return !0;
	const { perspective: r$7 } = t$9;
	if (r$7 && "none" !== r$7) return !0;
	const { contentVisibility: o$3 } = t$9;
...
function getContainingBlock(e$7, t$9 = {}) {
	if (isDocumentElement(e$7)) return e$7.ownerDocument.defaultView;
	const n$9 = t$9.position || getStyle(e$7).position, { skipDisplayNone: i$5, container: o$3 } = t$9;
	switch (n$9) {
		case "static":
		case "relative":
		case "sticky":
		case "-webkit-sticky": {
			let t$10 = o$3 || e$7.parentElement;
			for (; t$10;) {
				const e$8 = isBlockElement(t$10);
				if (e$8) return t$10;
				if (null === e$8 && !i$5) return null;
				t$10 = t$10.parentElement;
			}
			return e$7.ownerDocument.documentElement;
		}
		case "absolute":
		case "fixed": {
			const t$10 = "fixed" === n$9;
			let l$3 = o$3 || e$7.parentElement;
			for (; l$3;) {
				const e$8 = t$10 ? isContainingBlockForFixedElement(l$3) : isContainingBlockForAbsoluteElement(l$3);
				if (!0 === e$8) return l$3;
				if (null === e$8 && !i$5) return null;
				l$3 = l$3.parentElement;
			}
			return e$7.ownerDocument.defaultView;
		}
		default: return null;
	}
}
...
function getOffsetContainer(n$9, t$9 = {}) {
	const { display: o$3 } = getStyle(n$9);
	if ("none" === o$3 || "contents" === o$3) return null;
	const e$7 = t$9.position || getStyle(n$9).position, { skipDisplayNone: s$4, container: r$7 } = t$9;
	switch (e$7) {
		case "relative": return n$9;
		case "fixed": return getContainingBlock(n$9, {
			container: r$7,
			position: e$7,
			skipDisplayNone: s$4
		});
		case "absolute": {
			const t$10 = getContainingBlock(n$9, {
				container: r$7,
				position: e$7,
				skipDisplayNone: s$4
			});
			return isWindow(t$10) ? n$9.ownerDocument : t$10;
		}
		default: return null;
	}
}
...
function s$3(e$7, t$9) {
	return e$7.isIdentity && t$9.isIdentity ? !0 : e$7.is2D && t$9.is2D ? e$7.a === t$9.a && e$7.b === t$9.b && e$7.c === t$9.c && e$7.d === t$9.d && e$7.e === t$9.e && e$7.f === t$9.f : e$7.m11 === t$9.m11 && e$7.m12 === t$9.m12 && e$7.m13 === t$9.m13 && e$7.m14 === t$9.m14 && e$7.m21 === t$9.m21 && e$7.m22 === t$9.m22 && e$7.m23 === t$9.m23 && e$7.m24 === t$9.m24 && e$7.m31 === t$9.m31 && e$7.m32 === t$9.m32 && e$7.m33 === t$9.m33 && e$7.m34 === t$9.m34 && e$7.m41 === t$9.m41 && e$7.m42 === t$9.m42 && e$7.m43 === t$9.m43 && e$7.m44 === t$9.m44;
}
function c$2(e$7) {
	return e$7.m11 !== 1 || e$7.m12 !== 0 || e$7.m13 !== 0 || e$7.m14 !== 0 || e$7.m21 !== 0 || e$7.m22 !== 1 || e$7.m23 !== 0 || e$7.m24 !== 0 || e$7.m31 !== 0 || e$7.m32 !== 0 || e$7.m33 !== 1 || e$7.m34 !== 0 || e$7.m43 !== 0 || e$7.m44 !== 1;
}
function l$1(e$7, t$9, n$9 = null) {
	if (`moveBefore` in e$7 && e$7.isConnected === t$9.isConnected) try {
		e$7.moveBefore(t$9, n$9);
		return;
	} catch {}
	let r$7 = document.activeElement, i$5 = t$9.contains(r$7);
	e$7.insertBefore(t$9, n$9), i$5 && document.activeElement !== r$7 && r$7 instanceof HTMLElement && r$7.focus({ preventScroll: !0 });
}
function u$1(e$7) {
	return e$7.setMatrixValue(`scale(1, 1)`);
}
function d$1(e$7, t$9 = 0) {
	let n$9 = 10 ** t$9;
	return Math.round((e$7 + 2 ** -52) * n$9) / n$9;
}
var f = class {
	_cache;
	_validation;
	...
	set(e$7, t$9) {
		this._cache.set(e$7, t$9), this._validation.add(e$7);
	}
	get(e$7) {
		return this._cache.get(e$7);
	}
	has(e$7) {
		return this._cache.has(e$7);
	}
	delete(e$7) {
		this._cache.delete(e$7), this._validation.delete(e$7);
	}
	isValid(e$7) {
		return this._validation.has(e$7);
	}
	invalidate(e$7) {
		e$7 === void 0 ? this._validation.clear() : this._validation.delete(e$7);
	}
	clear() {
	...
	_clientOffsetCache;
	constructor(e$7, t$9) {
		this.sensor = e$7, this.startEvent = t$9, this.prevMoveEvent = t$9, this.moveEvent = t$9, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f(), this._clientOffsetCache = new f();
	}
};
function m(e$7, t$9, n$9 = !1) {
	let { style: r$7 } = e$7;
	for (let e$8 in t$9) r$7.setProperty(e$8, t$9[e$8], n$9 ? `important` : ``);
}
function h() {
	let e$7 = document.createElement(`div`);
	return e$7.classList.add(`dragdoll-measure`), m(e$7, {
		display: `block`,
		position: `absolute`,
		inset: `0px`,
		padding: `0px`,
...
function g(e$7, t$9 = {
	...
	if (t$9.x = 0, t$9.y = 0, e$7 instanceof Window) return t$9;
	if (e$7 instanceof Document) return t$9.x = window.scrollX * -1, t$9.y = window.scrollY * -1, t$9;
	let { x: r$7, y: i$5 } = e$7.getBoundingClientRect(), a$3 = t$8(e$7);
	return t$9.x = r$7 + (parseFloat(a$3.borderLeftWidth) || 0), t$9.y = i$5 + (parseFloat(a$3.borderTopWidth) || 0), t$9;
}
function _(e$7) {
	let t$9 = t$8(e$7), r$7 = parseFloat(t$9.height) || 0;
	return t$9.boxSizing === `border-box` ? r$7 : (r$7 += parseFloat(t$9.borderTopWidth) || 0, r$7 += parseFloat(t$9.borderBottomWidth) || 0, r$7 += parseFloat(t$9.paddingTop) || 0, r$7 += parseFloat(t$9.paddingBottom) || 0, e$7 instanceof HTMLElement && (r$7 += e$7.offsetHeight - e$7.clientHeight), r$7);
}
function v$1(e$7) {
	let t$9 = t$8(e$7), r$7 = parseFloat(t$9.width) || 0;
	return t$9.boxSizing === `border-box` ? r$7 : (r$7 += parseFloat(t$9.borderLeftWidth) || 0, r$7 += parseFloat(t$9.borderRightWidth) || 0, r$7 += parseFloat(t$9.paddingLeft) || 0, r$7 += parseFloat(t$9.paddingRight) || 0, e$7 instanceof HTMLElement && (r$7 += e$7.offsetWidth - e$7.clientWidth), r$7);
}
function y(e$7, t$9 = !1) {
	let { translate: r$7, rotate: i$5, scale: a$3, transform: o$3 } = t$8(e$7), s$4 = ``;
	if (r$7 && r$7 !== `none`) {
		let [t$10 = `0px`, n$9 = `0px`, i$6] = r$7.split(` `);
		t$10.includes(`%`) && (t$10 = `${parseFloat(t$10) / 100 * v$1(e$7)}px`), n$9.includes(`%`) && (n$9 = `${parseFloat(n$9) / 100 * _(e$7)}px`), i$6 ? s$4 += `translate3d(${t$10},${n$9},${i$6})` : s$4 += `translate(${t$10},${n$9})`;
	}
	if (i$5 && i$5 !== `none`) {
		let e$8 = i$5.split(` `);
	...
	return !t$9 && o$3 && o$3 !== `none` && (s$4 += o$3), s$4;
}
function b(e$7) {
...
function C(e$7, t$9, n$9 = {
	x: 0,
	y: 0
}) {
	let r$7 = b(e$7) ? e$7 : g(e$7, x), i$5 = b(t$9) ? t$9 : g(t$9, S);
	return n$9.x = i$5.x - r$7.x, n$9.y = i$5.y - r$7.y, n$9;
}
function w(e$7) {
	let t$9 = e$7.split(` `), n$9 = ``, r$7 = ``, i$5 = ``;
	return t$9.length === 1 ? n$9 = r$7 = t$9[0] : t$9.length === 2 ? [n$9, r$7] = t$9 : [n$9, r$7, i$5] = t$9, {
		x: parseFloat(n$9) || 0,
		y: parseFloat(r$7) || 0,
		z: parseFloat(i$5) || 0
	};
}
const T = e$5 ? new DOMMatrix() : null;
function E(e$7, t$9 = new DOMMatrix()) {
	let r$7 = e$7;
	for (u$1(t$9); r$7;) {
		let e$8 = y(r$7);
		if (e$8 && (T.setMatrixValue(e$8), !T.isIdentity)) {
			let { transformOrigin: e$9 } = t$8(r$7), { x: i$5, y: a$3, z: o$3 } = w(e$9);
			o$3 === 0 ? T.setMatrixValue(`translate(${i$5}px,${a$3}px) ${T} translate(${i$5 * -1}px,${a$3 * -1}px)`) : T.setMatrixValue(`translate3d(${i$5}px,${a$3}px,${o$3}px) ${T} translate3d(${i$5 * -1}px,${a$3 * -1}px,${o$3 * -1}px)`), t$9.preMultiplySelf(T);
		}
...
var O = class {
	...
	_clientOffsetCache;
	constructor(e$7, t$9) {
		if (!e$7.isConnected) throw Error(`Element is not connected`);
		let { drag: r$7 } = t$9;
		if (!r$7) throw Error(`Drag is not defined`);
		let i$5 = t$8(e$7), a$3 = e$7.getBoundingClientRect(), s$4 = y(e$7, !0);
		this.data = {}, this.element = e$7, this.elementTransformOrigin = w(i$5.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$4 + i$5.transform), this.elementOffsetMatrix = new DOMMatrix(s$4).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
		...
		let l$3 = t$9.settings.container, u$3 = (typeof l$3 == `function` ? l$3({
			draggable: t$9,
			drag: r$7,
			element: e$7
		}) : l$3) || c$3;
		if (this.dragContainer = u$3, c$3 !== u$3) {
			...
			if (e$8 !== `fixed` && e$8 !== `absolute`) throw Error(`Dragged element has "${e$8}" position, but only "fixed" or "absolute" are allowed when using a custom drag container.`);
		}
		let d$2 = getOffsetContainer(e$7) || e$7;
		this.elementOffsetContainer = d$2, this.dragOffsetContainer = u$3 === c$3 ? d$2 : getOffsetContainer(e$7, { container: u$3 });
		{
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$7) => {
			if (!this._matrixCache.isValid(e$7)) {
				let t$9 = this._matrixCache.get(e$7) || [new DOMMatrix(), new DOMMatrix()], [n$9, r$7] = t$9;
				E(e$7, n$9), r$7.setMatrixValue(n$9.toString()).invertSelf(), this._matrixCache.set(e$7, t$9);
			}
		});
	}
	_updateContainerOffset() {
		let { elementOffsetContainer: e$7, elementContainer: t$9, dragOffsetContainer: n$9, dragContainer: r$7, containerOffset: i$5, _clientOffsetCache: a$3, _matrixCache: o$3 } = this;
		if (e$7 !== n$9) {
			let [s$4, l$3] = [[r$7, n$9], [t$9, e$7]].map(([e$8, t$10]) => {
				let n$10 = a$3.get(t$10) || {
					x: 0,
					y: 0
				};
				if (!a$3.isValid(t$10)) {
					let r$8 = o$3.get(e$8);
					t$10 instanceof HTMLElement && r$8 && !r$8[0].isIdentity ? c$2(r$8[0]) ? (D.style.setProperty(`transform`, r$8[1].toString(), `important`), t$10.append(D), g(D, n$10), D.remove()) : (g(t$10, n$10), n$10.x -= r$8[0].m41, n$10.y -= r$8[0].m42) : g(t$10, n$10);
				}
				return a$3.set(t$10, n$10), n$10;
			});
			C(s$4, l$3, i$5);
	...
	updateSize(e$7) {
		if (e$7) this.clientRect.width = e$7.width, this.clientRect.height = e$7.height;
		else {
			let { width: e$8, height: t$9 } = this.element.getBoundingClientRect();
			this.clientRect.width = e$8, this.clientRect.height = t$9;
		}
	}
};
const k = {
	...
	x: 0,
	y: 0
}, j = e$5 ? new DOMMatrix() : null, M = e$5 ? new DOMMatrix() : null;
var N = function(e$7) {
	return e$7[e$7.None = 0] = `None`, e$7[e$7.Init = 1] = `Init`, e$7[e$7.Prepare = 2] = `Prepare`, e$7[e$7.FinishPrepare = 3] = `FinishPrepare`, e$7[e$7.Apply = 4] = `Apply`, e$7[e$7.FinishApply = 5] = `FinishApply`, e$7;
}(N || {}), P = function(e$7) {
	return e$7[e$7.Pending = 0] = `Pending`, e$7[e$7.Resolved = 1] = `Resolved`, e$7[e$7.Rejected = 2] = `Rejected`, e$7;
}(P || {});
const F = {
	Start: `start`,
	Move: `move`,
	...
	elements: () => null,
	frozenStyles: () => null,
	applyPosition: ({ item: e$7, phase: t$9 }) => {
		let n$9 = t$9 === L.End || t$9 === L.EndAlign, [r$7, i$5] = e$7.getContainerMatrix(), [a$3, o$3] = e$7.getDragContainerMatrix(), { position: s$4, alignmentOffset: c$3, containerOffset: l$3, elementTransformMatrix: d$2, elementTransformOrigin: f$1, elementOffsetMatrix: p$1 } = e$7, { x: m$1, y: h$1, z: g$1 } = f$1, _$2 = !d$2.isIdentity && (m$1 !== 0 || h$1 !== 0 || g$1 !== 0), v$2 = s$4.x + c$3.x + l$3.x, y$1 = s$4.y + c$3.y + l$3.y;
		u$1(j), _$2 && (g$1 === 0 ? j.translateSelf(-m$1, -h$1) : j.translateSelf(-m$1, -h$1, -g$1)), n$9 ? i$5.isIdentity || j.multiplySelf(i$5) : o$3.isIdentity || j.multiplySelf(o$3), u$1(M).translateSelf(v$2, y$1), j.multiplySelf(M), r$7.isIdentity || j.multiplySelf(r$7), _$2 && (u$1(M).translateSelf(m$1, h$1, g$1), j.multiplySelf(M)), d$2.isIdentity || j.multiplySelf(d$2), p$1.isIdentity || j.preMultiplySelf(p$1), e$7.element.style.transform = `${j}`;
	},
...
var B = class {
	...
	constructor(e$7, t$9 = {}) {
		...
		this.id = n$9, this._sensors = e$7, this.settings = this._parseSettings(r$7), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$8) => {
	...
	set sensors(e$7) {
		...
		if (e$7 === t$9) return;
		let n$9 = t$9.filter((t$10) => !e$7.includes(t$10)), r$7 = e$7.filter((e$8) => !t$9.includes(e$8));
		this._sensors = e$7, n$9.forEach((e$8) => {
	...
	_bindSensor(e$7) {
		...
		e$7.on(e$4.Start, t$9, t$9), e$7.on(e$4.Move, t$9, t$9), e$7.on(e$4.Cancel, n$9, n$9), e$7.on(e$4.End, n$9, n$9), e$7.on(e$4.Destroy, n$9, n$9);
	}
	_unbindSensor(e$7) {
		let t$9 = this._sensorData.get(e$7);
		if (!t$9) return;
		let { onMove: n$9, onEnd: r$7 } = t$9;
		e$7.off(e$4.Start, n$9), e$7.off(e$4.Move, n$9), e$7.off(e$4.Cancel, r$7), e$7.off(e$4.End, r$7), e$7.off(e$4.Destroy, r$7), this._sensorData.delete(e$7);
	}
	_parseSettings(e$7, t$9 = z) {
		let { container: n$9 = t$9.container, startPredicate: r$7 = t$9.startPredicate, elements: i$5 = t$9.elements, frozenStyles: a$3 = t$9.frozenStyles, positionModifiers: o$3 = t$9.positionModifiers, applyPosition: s$4 = t$9.applyPosition, computeClientRect: c$3 = t$9.computeClientRect, sensorProcessingMode: l$3 = t$9.sensorProcessingMode, dndGroups: u$3 = t$9.dndGroups, onPrepareStart: d$2 = t$9.onPrepareStart, onStart: f$1 = t$9.onStart, onPrepareMove: p$1 = t$9.onPrepareMove, onMove: m$1 = t$9.onMove, onEnd: h$1 = t$9.onEnd, onDestroy: g$1 = t$9.onDestroy } = e$7 || {};
		return {
			container: n$9,
			startPredicate: r$7,
			elements: i$5,
	...
	_emit(e$7, ...t$9) {
		this._emitter.emit(e$7, ...t$9);
	}
	_onMove(n$9, r$7) {
		let i$5 = this._sensorData.get(r$7);
		if (i$5) switch (i$5.predicateState) {
			case P.Pending: {
				i$5.predicateEvent = n$9;
				let e$7 = this.settings.startPredicate({
					draggable: this,
					sensor: r$7,
					event: n$9
				});
				e$7 === !0 ? this.resolveStartPredicate(r$7) : e$7 === !1 && this.rejectStartPredicate(r$7);
				break;
			}
			case P.Resolved:
				this.drag && (this.drag.moveEvent = n$9, this.settings.sensorProcessingMode === I.Immediate ? (this._prepareMove(), this._applyMove()) : (r$5.once(n$6.read, this._prepareMove, this._moveId), r$5.once(n$6.write, this._applyMove, this._moveId)));
				break;
		}
	}
	_onScroll() {
	...
	_onEnd(e$7, t$9) {
		let n$9 = this._sensorData.get(t$9);
		n$9 && (this.drag ? n$9.predicateState === P.Resolved && (this.drag.endEvent = e$7, this._sensorData.forEach((e$8) => {
			e$8.predicateState = P.Pending, e$8.predicateEvent = null;
		}), this.stop()) : (n$9.predicateState = P.Pending, n$9.predicateEvent = null));
	}
	_prepareStart() {
		let e$7 = this.drag;
		!e$7 || this._startPhase !== N.Init || (this._startPhase = N.Prepare, e$7.items = (this.settings.elements({
			draggable: this,
			drag: e$7
		}) || []).map((e$8) => new O(e$8, this)), this._applyModifiers(F.Start, 0, 0), this._emit(R.PrepareStart, e$7, this), this.settings.onPrepareStart?.(e$7, this), this._startPhase = N.FinishPrepare);
	}
	_applyStart() {
		let e$7 = this.drag;
		if (!(!e$7 || this._startPhase !== N.FinishPrepare)) {
			this._startPhase = N.Apply;
			for (let t$9 of e$7.items) t$9.dragContainer !== t$9.elementContainer && l$1(t$9.dragContainer, t$9.element), t$9.frozenStyles && Object.assign(t$9.element.style, t$9.frozenStyles), this.settings.applyPosition({
				phase: L.Start,
				draggable: this,
				drag: e$7,
				item: t$9
			});
			for (let t$9 of e$7.items) {
				let e$8 = t$9.getContainerMatrix()[0], n$9 = t$9.getDragContainerMatrix()[0];
				if (s$3(e$8, n$9) || !c$2(e$8) && !c$2(n$9)) continue;
				let r$7 = t$9.element.getBoundingClientRect(), { alignmentOffset: i$5 } = t$9;
				i$5.x += d$1(t$9.clientRect.x - r$7.x, 3), i$5.y += d$1(t$9.clientRect.y - r$7.y, 3);
			}
			for (let t$9 of e$7.items) {
				let { alignmentOffset: n$9 } = t$9;
				(n$9.x !== 0 || n$9.y !== 0) && this.settings.applyPosition({
					phase: L.StartAlign,
					draggable: this,
					drag: e$7,
					item: t$9
			...
			window.addEventListener(`scroll`, this._onScroll, k), this._emit(R.Start, e$7, this), this.settings.onStart?.(e$7, this), this._startPhase = N.FinishApply;
		}
	}
	_prepareMove() {
		let e$7 = this.drag;
		if (!e$7 || e$7.isEnded) return;
		let { moveEvent: t$9, prevMoveEvent: n$9 } = e$7;
		t$9 !== n$9 && (this._applyModifiers(F.Move, t$9.x - n$9.x, t$9.y - n$9.y), this._emit(R.PrepareMove, e$7, this), !e$7.isEnded && (this.settings.onPrepareMove?.(e$7, this), !e$7.isEnded && (e$7.prevMoveEvent = t$9)));
	}
	_applyMove() {
		let e$7 = this.drag;
		if (!(!e$7 || e$7.isEnded)) {
			for (let t$9 of e$7.items) t$9._moveDiff.x = 0, t$9._moveDiff.y = 0, this.settings.applyPosition({
				phase: L.Move,
				draggable: this,
				drag: e$7,
				item: t$9
			});
			this._emit(R.Move, e$7, this), !e$7.isEnded && this.settings.onMove?.(e$7, this);
		}
	}
	_prepareAlign() {
		let { drag: e$7 } = this;
		if (!(!e$7 || e$7.isEnded)) for (let t$9 of e$7.items) {
			let { x: e$8, y: n$9 } = t$9.element.getBoundingClientRect(), r$7 = t$9.clientRect.x - t$9._moveDiff.x - e$8;
			t$9.alignmentOffset.x = t$9.alignmentOffset.x - t$9._alignDiff.x + r$7, t$9._alignDiff.x = r$7;
			let i$5 = t$9.clientRect.y - t$9._moveDiff.y - n$9;
			t$9.alignmentOffset.y = t$9.alignmentOffset.y - t$9._alignDiff.y + i$5, t$9._alignDiff.y = i$5;
		}
	}
	_applyAlign() {
		let { drag: e$7 } = this;
		if (!(!e$7 || e$7.isEnded)) for (let t$9 of e$7.items) t$9._alignDiff.x = 0, t$9._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$7,
			item: t$9
	...
	_applyModifiers(e$7, t$9, n$9) {
		let { drag: r$7 } = this;
		if (!r$7) return;
		let { positionModifiers: i$5 } = this.settings;
		for (let a$3 of r$7.items) {
			let o$3 = A;
			o$3.x = t$9, o$3.y = n$9;
			for (let t$10 of i$5) o$3 = t$10(o$3, {
				draggable: this,
				drag: r$7,
				item: a$3,
				phase: e$7
			});
			a$3.position.x += o$3.x, a$3.position.y += o$3.y, a$3.clientRect.x += o$3.x, a$3.clientRect.y += o$3.y, e$7 === `move` && (a$3._moveDiff.x += o$3.x, a$3._moveDiff.y += o$3.y);
		}
	}
	on(e$7, t$9, n$9) {
		return this._emitter.on(e$7, t$9, n$9);
	}
	off(e$7, t$9) {
		this._emitter.off(e$7, t$9);
	}
	resolveStartPredicate(n$9, r$7) {
		let i$5 = this._sensorData.get(n$9);
		if (!i$5) return;
		let a$3 = r$7 || i$5.predicateEvent;
		i$5.predicateState === P.Pending && a$3 && (this._startPhase = N.Init, i$5.predicateState = P.Resolved, i$5.predicateEvent = null, this.drag = new p(n$9, a$3), this._sensorData.forEach((e$7, t$9) => {
			t$9 !== n$9 && (e$7.predicateState = P.Rejected, e$7.predicateEvent = null);
		}), this.settings.sensorProcessingMode === I.Immediate ? (this._prepareStart(), this._applyStart()) : (r$5.once(n$6.read, this._prepareStart, this._startId), r$5.once(n$6.write, this._applyStart, this._startId)));
	}
	rejectStartPredicate(e$7) {
		let t$9 = this._sensorData.get(e$7);
		t$9?.predicateState === P.Pending && (t$9.predicateState = P.Rejected, t$9.predicateEvent = null);
	}
	stop() {
		let n$9 = this.drag;
		if (!(!n$9 || n$9.isEnded)) {
			if (this._startPhase === N.Prepare || this._startPhase === N.Apply) throw Error(`Cannot stop drag start process at this point`);
			n$9.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$5.off(n$6.read, this._startId), r$5.off(n$6.write, this._startId), r$5.off(n$6.read, this._moveId), r$5.off(n$6.write, this._moveId), r$5.off(n$6.read, this._alignId), r$5.off(n$6.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
			for (let e$7 of n$9.items) {
				if (e$7.elementContainer !== e$7.dragContainer && (l$1(e$7.elementContainer, e$7.element), e$7.alignmentOffset.x = 0, e$7.alignmentOffset.y = 0, e$7.containerOffset.x = 0, e$7.containerOffset.y = 0), e$7.unfrozenStyles) for (let t$9 in e$7.unfrozenStyles) e$7.element.style[t$9] = e$7.unfrozenStyles[t$9] || ``;
			...
			for (let e$7 of n$9.items) if (e$7.elementContainer !== e$7.dragContainer) {
				let t$9 = e$7.element.getBoundingClientRect();
				e$7.alignmentOffset.x = d$1(e$7.clientRect.x - t$9.x, 3), e$7.alignmentOffset.y = d$1(e$7.clientRect.y - t$9.y, 3);
			}
			for (let e$7 of n$9.items) e$7.elementContainer !== e$7.dragContainer && (e$7.alignmentOffset.x !== 0 || e$7.alignmentOffset.y !== 0) && this.settings.applyPosition({
				phase: L.EndAlign,
				draggable: this,
				drag: n$9,
				item: e$7
			});
			this._emit(R.End, n$9, this), this.settings.onEnd?.(n$9, this), this.drag = null;
		}
	}
	align(n$9 = !1) {
		!this.drag || this.drag.isEnded || (n$9 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$5.once(n$6.read, this._prepareAlign, this._alignId), r$5.once(n$6.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
		let { drag: e$7, settings: t$9 } = this;
		return e$7 && t$9.computeClientRect?.({
			draggable: this,
			drag: e$7
		}) || null;
	}
	updateSettings(e$7) {
		this.settings = this._parseSettings(e$7, this.settings);
	}
	use(e$7) {
		return e$7(this);
	}
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensors.forEach((e$7) => {
...
function i$4(e$7, t$9) {
	if (`pointerId` in e$7) return e$7.pointerId === t$9 ? e$7 : null;
	if (`changedTouches` in e$7) {
		let n$9 = 0;
		for (; n$9 < e$7.changedTouches.length; n$9++) if (e$7.changedTouches[n$9].identifier === t$9) return e$7.changedTouches[n$9];
		return null;
	}
	return e$7;
}
function a$2(e$7) {
	return `pointerId` in e$7 ? e$7.pointerId : `changedTouches` in e$7 ? e$7.changedTouches[0] ? e$7.changedTouches[0].identifier : null : -1;
}
function o$1(e$7) {
	return `pointerType` in e$7 ? e$7.pointerType : `touches` in e$7 ? `touch` : `mouse`;
}
function s$2(e$7 = {}) {
	let { capture: t$9 = !0, passive: n$9 = !0 } = e$7;
	return {
		capture: t$9,
		passive: n$9
	};
...
function c$1(n$9) {
	return n$9 === `auto` || n$9 === void 0 ? n$8 ? `pointer` : t$7 ? `touch` : `mouse` : n$9;
}
const l = {
	pointer: {
		start: `pointerdown`,
...
var d = class {
	...
	_emitter;
	constructor(e$7, t$9 = {}) {
		let { listenerOptions: n$9 = u.listenerOptions, sourceEvents: i$5 = u.sourceEvents, startPredicate: a$3 = u.startPredicate } = t$9;
		this.element = e$7, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$3, this._listenerOptions = s$2(n$9), this._sourceEvents = c$1(i$5), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$7.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	_getTrackedPointerEventData(e$7) {
		return this.drag ? i$4(e$7, this.drag.pointerId) : null;
	}
	_onStart(e$7) {
		if (this.isDestroyed || this.drag || !this._startPredicate(e$7)) return;
		let t$9 = a$2(e$7);
		if (t$9 === null) return;
		let r$7 = i$4(e$7, t$9);
		if (r$7 === null) return;
	...
	_onMove(e$7) {
		if (!this.drag) return;
		let t$9 = this._getTrackedPointerEventData(e$7);
		if (!t$9) return;
	...
	_bindWindowListeners() {
		...
		let { move: e$7, end: t$9, cancel: n$9 } = l[this._sourceEvents];
		window.addEventListener(e$7, this._onMove, this._listenerOptions), window.addEventListener(t$9, this._onEnd, this._listenerOptions), n$9 && window.addEventListener(n$9, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !0;
	}
	_unbindWindowListeners() {
		if (this._areWindowListenersBound) {
			let { move: e$7, end: t$9, cancel: n$9 } = l[this._sourceEvents];
			window.removeEventListener(e$7, this._onMove, this._listenerOptions), window.removeEventListener(t$9, this._onEnd, this._listenerOptions), n$9 && window.removeEventListener(n$9, this._onCancel, this._listenerOptions), this._areWindowListenersBound = !1;
		}
	}
	_resetDrag() {
	...
	updateElement(e$7) {
		this.isDestroyed || this.element === e$7 || (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), e$7.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this.element = e$7);
	}
	updateSettings(e$7) {
		if (this.isDestroyed) return;
		let { listenerOptions: t$9, sourceEvents: n$9, startPredicate: r$7 } = e$7, i$5 = c$1(n$9), a$3 = s$2(t$9);
		r$7 && this._startPredicate !== r$7 && (this._startPredicate = r$7), (t$9 && (this._listenerOptions.capture !== a$3.capture || this._listenerOptions.passive === a$3.passive) || n$9 && this._sourceEvents !== i$5) && (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this._unbindWindowListeners(), this.cancel(), n$9 && (this._sourceEvents = i$5), t$9 && a$3 && (this._listenerOptions = a$3), this.element.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
	on(e$7, t$9, n$9) {
		return this._emitter.on(e$7, t$9, n$9);
	}
...
var n$7 = class {
	...
	_updateDragData(e$7) {
		this.drag && (this.drag.x = e$7.x, this.drag.y = e$7.y);
	}
	_resetDragData() {
		this.drag = null;
	}
	_start(t$9) {
		this.isDestroyed || this.drag || (this.drag = this._createDragData(t$9), this._emitter.emit(e$4.Start, t$9));
	}
	_move(t$9) {
		this.drag && (this._updateDragData(t$9), this._emitter.emit(e$4.Move, t$9));
	}
	_end(t$9) {
		this.drag && (this._updateDragData(t$9), this._emitter.emit(e$4.End, t$9), this._resetDragData());
	}
	_cancel(t$9) {
		this.drag && (this._updateDragData(t$9), this._emitter.emit(e$4.Cancel, t$9), this._resetDragData());
	}
	on(e$7, t$9, n$9) {
		return this._emitter.on(e$7, t$9, n$9);
	}
...
var i$3 = class extends n$7 {
	...
	_createDragData(e$7) {
		return {
			...super._createDragData(e$7),
			time: 0,
			deltaTime: 0
		};
	}
	_start(n$9) {
		this.isDestroyed || this.drag || (super._start(n$9), r$5.on(n$6.read, this._tick, this._tick));
	}
	_end(n$9) {
		this.drag && (r$5.off(n$6.read, this._tick), super._end(n$9));
	}
	_cancel(n$9) {
		this.drag && (r$5.off(n$6.read, this._tick), super._cancel(n$9));
	}
	_tick(e$7) {
		if (this.drag) if (e$7 && this.drag.time) {
			this.drag.deltaTime = e$7 - this.drag.time, this.drag.time = e$7;
			let t$9 = {
				type: `tick`,
				time: this.drag.time,
			...
			let r$7 = this._speed * (this.drag.deltaTime / 1e3), i$5 = this._direction.x * r$7, a$3 = this._direction.y * r$7;
			(i$5 || a$3) && this._move({
				type: e$4.Move,
				x: this.drag.x + i$5,
				y: this.drag.y + a$3
			});
		} else this.drag.time = e$7, this.drag.deltaTime = 0;
	}
};
...
function r$4(e$7, t$9) {
	if (!e$7.size || !t$9.size) return Infinity;
	let n$9 = Infinity;
	for (let r$7 of e$7) {
		let e$8 = t$9.get(r$7);
		e$8 !== void 0 && e$8 < n$9 && (n$9 = e$8);
	}
	return n$9;
}
const i$2 = {
	...
	computeSpeed: () => 500,
	startPredicate: (e$7, t$9) => {
		if (t$9.element && document.activeElement === t$9.element) {
			let { left: e$8, top: n$9 } = t$9.element.getBoundingClientRect();
			return {
				x: e$8,
				y: n$9
			};
...
var a = class extends i$3 {
	...
	constructor(e$7, t$9 = {}) {
		super();
		let { startPredicate: n$9 = i$2.startPredicate, computeSpeed: r$7 = i$2.computeSpeed, cancelOnVisibilityChange: a$3 = i$2.cancelOnVisibilityChange, cancelOnBlur: o$3 = i$2.cancelOnBlur, startKeys: s$4 = i$2.startKeys, moveLeftKeys: c$3 = i$2.moveLeftKeys, moveRightKeys: l$3 = i$2.moveRightKeys, moveUpKeys: u$3 = i$2.moveUpKeys, moveDownKeys: d$2 = i$2.moveDownKeys, cancelKeys: f$1 = i$2.cancelKeys, endKeys: p$1 = i$2.endKeys } = t$9;
		this.element = e$7, this._startKeys = new Set(s$4), this._cancelKeys = new Set(f$1), this._endKeys = new Set(p$1), this._moveLeftKeys = new Set(c$3), this._moveRightKeys = new Set(l$3), this._moveUpKeys = new Set(u$3), this._moveDownKeys = new Set(d$2), this._moveKeys = new Set([
			...c$3,
			...l$3,
			...u$3,
			...d$2
		]), this._moveKeyTimestamps = /* @__PURE__ */ new Map(), this._cancelOnBlur = o$3, this._cancelOnVisibilityChange = a$3, this._computeSpeed = r$7, this._startPredicate = n$9, this._onKeyDown = this._onKeyDown.bind(this), this._onKeyUp = this._onKeyUp.bind(this), this._onTick = this._onTick.bind(this), this._internalCancel = this._internalCancel.bind(this), this._blurCancelHandler = this._blurCancelHandler.bind(this), this.on(`tick`, this._onTick, this._onTick), document.addEventListener(`keydown`, this._onKeyDown), document.addEventListener(`keyup`, this._onKeyUp), o$3 && e$7?.addEventListener(`blur`, this._blurCancelHandler), a$3 && document.addEventListener(`visibilitychange`, this._internalCancel);
	}
	_end(e$7) {
		this.drag && (this._moveKeyTimestamps.clear(), this._direction.x = 0, this._direction.y = 0, super._end(e$7));
	}
	_cancel(e$7) {
		this.drag && (this._moveKeyTimestamps.clear(), this._direction.x = 0, this._direction.y = 0, super._cancel(e$7));
	}
	_internalCancel() {
		this.cancel();
	}
	...
	_updateDirection() {
		let e$7 = r$4(this._moveLeftKeys, this._moveKeyTimestamps), t$9 = r$4(this._moveRightKeys, this._moveKeyTimestamps), n$9 = r$4(this._moveUpKeys, this._moveKeyTimestamps), i$5 = r$4(this._moveDownKeys, this._moveKeyTimestamps), a$3 = e$7 === t$9 ? 0 : e$7 < t$9 ? -1 : 1, o$3 = n$9 === i$5 ? 0 : n$9 < i$5 ? -1 : 1;
		if (!(a$3 === 0 || o$3 === 0)) {
	...
	_onKeyUp(e$7) {
		this._moveKeyTimestamps.get(e$7.key) && (this._moveKeyTimestamps.delete(e$7.key), this._updateDirection());
	}
	_onKeyDown(t$9) {
		if (!this.drag) {
			if (this._startKeys.has(t$9.key)) {
				let n$9 = this._startPredicate(t$9, this);
				n$9 && (t$9.preventDefault(), this._start({
					type: e$4.Start,
					x: n$9.x,
					y: n$9.y
				}));
		...
		if (this._moveKeys.has(t$9.key)) {
			t$9.preventDefault(), this._moveKeyTimestamps.get(t$9.key) || (this._moveKeyTimestamps.set(t$9.key, Date.now()), this._updateDirection());
			return;
		}
	}
	updateElement(e$7) {
		this.isDestroyed || this.element === e$7 || (this._cancelOnBlur && (this.element?.removeEventListener(`blur`, this._blurCancelHandler), e$7?.addEventListener(`blur`, this._blurCancelHandler)), this.element = e$7);
	}
	updateSettings(e$7) {
		if (this.isDestroyed) return;
		let t$9 = !1, { cancelOnBlur: r$7, cancelOnVisibilityChange: i$5, startPredicate: a$3, computeSpeed: o$3 } = e$7;
		if (r$7 !== void 0 && this._cancelOnBlur !== r$7 && (this._cancelOnBlur = r$7, r$7 ? this.element?.addEventListener(`blur`, this._blurCancelHandler) : this.element?.removeEventListener(`blur`, this._blurCancelHandler)), i$5 !== void 0 && this._cancelOnVisibilityChange !== i$5 && (this._cancelOnVisibilityChange = i$5, i$5 ? document.addEventListener(`visibilitychange`, this._internalCancel) : document.removeEventListener(`visibilitychange`, this._internalCancel)), a$3 !== void 0 && (this._startPredicate = a$3), o$3 !== void 0 && (this._computeSpeed = o$3), n$5.forEach((n$9, r$8) => {
			let i$6 = `${n$9}Keys`, a$4 = e$7[i$6];
			a$4 !== void 0 && (this[`_${i$6}`] = new Set(a$4), r$8 >= 3 && (t$9 = !0));
		}), t$9) {
			let e$8 = [
				...this._moveLeftKeys,
				...this._moveRightKeys,
			...
			[...this._moveKeys].every((t$10, n$9) => e$8[n$9] === t$10) || (this._moveKeys = new Set(e$8), this._moveKeyTimestamps.clear(), this._updateDirection());
		}
	}
	destroy() {
...
var require_react_development = /* @__PURE__ */ __commonJS({ "../../node_modules/react/cjs/react.development.js": ((exports, module) => {
	(function() {
		...
		function mapIntoArray(children, array, escapedPrefix, nameSoFar, callback) {
			...
			if (isArrayImpl(children)) for (var i$5 = 0; i$5 < children.length; i$5++) nameSoFar = children[i$5], type = childKey + getElementKey(nameSoFar, i$5), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if (i$5 = getIteratorFn(children), "function" === typeof i$5) for (i$5 === children.entries && (didWarnAboutMaps || console.warn("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), didWarnAboutMaps = !0), children = i$5.call(children), i$5 = 0; !(nameSoFar = children.next()).done;) nameSoFar = nameSoFar.value, type = childKey + getElementKey(nameSoFar, i$5++), invokeCallback += mapIntoArray(nameSoFar, array, escapedPrefix, type, callback);
			else if ("object" === type) {
		...
		exports.cloneElement = function(element, config, children) {
			...
			if (1 === propName) props.children = children;
				...
				for (var i$5 = 0; i$5 < propName; i$5++) JSCompiler_inline_result[i$5] = arguments[i$5 + 2];
		...
		exports.createElement = function(type, config, children) {
			...
			if (type && type.defaultProps) for (propName in childrenLength = type.defaultProps, childrenLength) void 0 === i$5[propName] && (i$5[propName] = childrenLength[propName]);
			key && defineKeyPropWarningGetter(i$5, "function" === typeof type ? type.displayName || type.name || "Unknown" : type);
			var propName = 1e4 > ReactSharedInternals.recentlyCreatedOwnerStacks++;
			return ReactElement(type, key, i$5, getOwner(), propName ? Error("react-stack-top-frame") : unknownOwnerDebugStack, propName ? createTask(getTaskName(type)) : unknownOwnerDebugTask);
		};
...
const e$1 = Object.prototype.hasOwnProperty, t$3 = (e$7) => {
	if (typeof e$7 != `object` || !e$7) return !1;
	let t$9 = Object.getPrototypeOf(e$7);
	return t$9 === Object.prototype || t$9 === null;
};
function n$4(r$7, i$5) {
	if (Object.is(r$7, i$5)) return !0;
	if (r$7 === null || i$5 === null || typeof r$7 != `object` || typeof i$5 != `object`) return !1;
	let a$3 = Array.isArray(r$7), o$3 = Array.isArray(i$5);
	if (a$3 || o$3) {
		if (!a$3 || !o$3) return !1;
		let e$7 = r$7.length;
		if (e$7 !== i$5.length) return !1;
		for (let t$9 = 0; t$9 < e$7; t$9++) if (!n$4(r$7[t$9], i$5[t$9])) return !1;
		return !0;
	}
	let s$4 = r$7 instanceof Set, c$3 = i$5 instanceof Set;
	if (s$4 || c$3) return !s$4 || !c$3 || r$7.size !== i$5.size ? !1 : r$7.isSubsetOf(i$5);
	if (!t$3(r$7) || !t$3(i$5)) return !1;
	let l$3 = Object.keys(r$7), u$3 = Object.keys(i$5);
	if (l$3.length !== u$3.length) return !1;
	for (let t$9 = 0; t$9 < l$3.length; t$9++) {
		let a$4 = l$3[t$9];
		if (!e$1.call(i$5, a$4) || !n$4(r$7[a$4], i$5[a$4])) return !1;
	}
	return !0;
}
...
function t$2(e$7, t$9) {
	if (e$7 === t$9) return !0;
	if (e$7.length !== t$9.length) return !1;
	for (let n$9 = 0; n$9 < e$7.length; n$9++) if (!Object.is(e$7[n$9], t$9[n$9])) return !1;
	return !0;
}
function n$1(n$9, r$7) {
	let i$5 = (0, import_react.useRef)(null), a$3 = i$5.current || {
		deps: r$7,
		value: n$9()
	};
	return i$5.current ? t$2(r$7, a$3.deps) || (a$3.deps = r$7, a$3.value = n$9()) : i$5.current = a$3, a$3.value;
}
function r$1(e$7, t$9) {
	return n$1(() => e$7, t$9);
}
...
function c(c$3, l$3) {
	let u$3 = n$1(() => c$3.filter((e$7) => !!e$7), [...c$3]), { id: d$2, dndObserver: f$1,...p$1 } = l$3 || {}, m$1 = n$1(() => d$2 === void 0 ? Symbol() : d$2, [d$2]), h$1 = n$3(), g$1 = f$1 === void 0 ? h$1 : f$1, [_$2, v$2] = (0, import_react.useState)(null), y$1 = (0, import_react.useRef)(null), b$1 = (0, import_react.useRef)(u$3);
	b$1.current = u$3;
	...
	return n(() => {
		...
		if (!_$2) return;
		let e$7 = x$1.current;
		C$1.current !== e$7 && (n$4(C$1.current, e$7) || (_$2.updateSettings(_$2._parseSettings(e$7)), C$1.current && e$7.dndGroups !== C$1.current.dndGroups && S$1.current?.clearTargets(_$2)), C$1.current = e$7);
	}, [_$2, l$3]), n(() => w$1, [w$1]), _$2;
}

//#endregion
//#region ../dragdoll-react/dist/use-draggable-callback-Cd1g8lnj.js
function n$2(n$9, r$7, i$5) {
	let a$3 = !!i$5, o$3 = (0, import_react.useRef)(i$5);
	o$3.current = i$5, n(() => {
		if (!n$9 || !a$3) return;
		let e$7 = n$9.on(r$7, ((...e$8) => {
			o$3.current?.(...e$8);
		}));
		return () => void n$9.off(r$7, e$7);
	}, [
		n$9,
		r$7,
		a$3
...
function r(r$7, i$5 = !1) {
	let [a$3, o$3] = (0, import_react.useState)(r$7?.drag || null), s$4 = (0, import_react.useState)(void 0)[1];
	return n$2(r$7, R.Start, (e$7) => {
		o$3(e$7);
	}), n$2(r$7, R.Move, () => {
		i$5 && s$4(Symbol());
	}), n$2(r$7, R.End, () => {
...
function s(s$4, c$3) {
	...
	let p$1 = r$1((e$7) => {
		let t$9 = d$2.current;
		if (t$9) {
			t$9.updateElement(e$7);
			return;
		}
		let n$9 = new a(e$7, f$1.current);
		d$2.current = n$9, u$3(n$9);
	}, []), m$1 = r$1(() => {
		let e$7 = d$2.current;
	...
	return n(() => {
		...
		if (l$3) {
			let { startKeys: e$7 = i$2.startKeys, moveLeftKeys: t$9 = i$2.moveLeftKeys, moveRightKeys: n$9 = i$2.moveRightKeys, moveUpKeys: r$7 = i$2.moveUpKeys, moveDownKeys: i$5 = i$2.moveDownKeys, cancelKeys: a$3 = i$2.cancelKeys, endKeys: c$4 = i$2.endKeys, cancelOnBlur: u$4 = i$2.cancelOnBlur, cancelOnVisibilityChange: d$3 = i$2.cancelOnVisibilityChange, computeSpeed: f$2 = i$2.computeSpeed, startPredicate: p$2 = i$2.startPredicate } = s$4 || {};
			l$3.updateSettings({
				startKeys: e$7,
				moveLeftKeys: t$9,
				moveRightKeys: n$9,
...
function s$1(s$4, c$3) {
	...
	return n(() => {
		...
		if (l$3) {
			let { listenerOptions: e$7 = u.listenerOptions, sourceEvents: t$9 = u.sourceEvents, startPredicate: n$9 = u.startPredicate } = s$4 || {};
			l$3.updateSettings({
				listenerOptions: e$7,
				sourceEvents: t$9,
				startPredicate: n$9
...
var require_scheduler_development = /* @__PURE__ */ __commonJS({ "../../node_modules/scheduler/cjs/scheduler.development.js": ((exports) => {
	(function() {
		...
		function compare(a$3, b$1) {
			var diff = a$3.sortIndex - b$1.sortIndex;
			return 0 !== diff ? diff : a$3.id - b$1.id;
		}
...
var require_react_dom_development = /* @__PURE__ */ __commonJS({ "../../node_modules/react-dom/cjs/react-dom.development.js": ((exports) => {
	(function() {
		...
		exports.unstable_batchedUpdates = function(fn, a$3) {
			return fn(a$3);
		};
	...
	(function() {
		...
		function copyWithRename(obj, oldPath, newPath) {
			if (oldPath.length !== newPath.length) console.warn("copyWithRename() expects paths of the same length");
				...
				for (var i$5 = 0; i$5 < newPath.length - 1; i$5++) if (oldPath[i$5] !== newPath[i$5]) {
		...
		function findCurrentFiberUsingSlowPath(fiber) {
			...
			for (var a$3 = fiber, b$1 = alternate;;) {
				var parentA = a$3.return;
				...
				if (parentA.child === parentB.child) {
					for (parentB = parentA.child; parentB;) {
						if (parentB === a$3) return assertIsMounted(parentA), fiber;
						if (parentB === b$1) return assertIsMounted(parentA), alternate;
						parentB = parentB.sibling;
					}
					throw Error("Unable to find node on an unmounted component.");
				}
				if (a$3.return !== b$1.return) a$3 = parentA, b$1 = parentB;
				else {
				...
				if (a$3.alternate !== b$1) throw Error("Return fibers should always be each others' alternates. This error is likely caused by a bug in React. Please file an issue.");
			}
			if (3 !== a$3.tag) throw Error("Unable to find node on an unmounted component.");
			return a$3.stateNode.current === a$3 ? fiber : alternate;
		}
		...
		function getComponentNameFromFiber(fiber) {
			...
			switch (fiber.tag) {
				...
				case 29:
					...
					if (null != type) {
						for (var i$5 = type.length - 1; 0 <= i$5; i$5--) if ("string" === typeof type[i$5].name) return type[i$5].name;
					}
		...
		function getStackByFiberInDevAndProd(workInProgress$1) {
			try {
				...
				do {
					...
					if (debugInfo) for (var i$5 = debugInfo.length - 1; 0 <= i$5; i$5--) {
		...
		function updateOptions(node, multiple, propValue, setDefaultSelected) {
			...
			if (multiple) {
				...
				for (propValue = 0; propValue < node.length; propValue++) i$5 = multiple.hasOwnProperty("$" + node[propValue].value), node[propValue].selected !== i$5 && (node[propValue].selected = i$5), i$5 && setDefaultSelected && (node[propValue].defaultSelected = !0);
			} else {
		...
		function describeNode(node, indent) {
			...
			if (debugInfo) for (var i$5 = 0; i$5 < debugInfo.length; i$5++) {
				var serverComponentName = debugInfo[i$5].name;
				"string" === typeof serverComponentName && (skipToNode += indentation(indent) + "<" + serverComponentName + ">\n", indent++);
			}
			debugInfo = "";
			i$5 = node.fiber.pendingProps;
			if (6 === node.fiber.tag) debugInfo = describeTextDiff(i$5, node.serverProps, indent), indent++;
				...
				for (propName in i$5) if (i$5.hasOwnProperty(propName) && "children" !== propName) {
				...
				indent++;
			} else null === node.serverProps ? (debugInfo = describeExpandedElement(serverComponentName, i$5, added(indent)), indent++) : "string" === typeof node.serverProps ? console.error("Should not have matched a non HostText fiber to a Text node. This is a bug in React.") : (debugInfo = describeElementDiff(serverComponentName, i$5, node.serverProps, indent), indent++);
			var propName = "";
			i$5 = node.fiber.child;
			for (serverComponentName = 0; i$5 && serverComponentName < node.children.length;) maxLength = node.children[serverComponentName], maxLength.fiber === i$5 ? (propName += describeNode(maxLength, indent), serverComponentName++) : propName += describeSiblingFiber(i$5, indent), i$5 = i$5.sibling;
			i$5 && 0 < node.children.length && (propName += indentation(indent) + "...\n");
			i$5 = node.serverTail;
			null === node.serverProps && indent--;
			for (node = 0; node < i$5.length; node++) serverComponentName = i$5[node], propName = "string" === typeof serverComponentName ? propName + (removed(indent) + describeTextNode(serverComponentName, 120 - 2 * indent) + "\n") : propName + describeExpandedElement(serverComponentName.type, serverComponentName.props, removed(indent));
		...
		function setValueForStyles(node, styles, prevStyles) {
			...
			if (null != prevStyles) {
				if (styles) {
					var expandedUpdates = {};
					if (prevStyles) {
						for (var key in prevStyles) if (prevStyles.hasOwnProperty(key) && !styles.hasOwnProperty(key)) for (var longhands = shorthandToLonghand[key] || [key], i$5 = 0; i$5 < longhands.length; i$5++) expandedUpdates[longhands[i$5]] = key;
					}
					...
					key$jscomp$0 = {};
					for (var _key2 in expandedUpdates) if (key = expandedUpdates[_key2], (longhands = _key[_key2]) && key !== longhands && (i$5 = key + "," + longhands, !key$jscomp$0[i$5])) {
						key$jscomp$0[i$5] = !0;
						i$5 = console;
						var value = styles[key];
						i$5.error.call(i$5, "%s a style property during rerender (%s) when a conflicting property is set (%s) can lead to styling bugs. To avoid this, don't mix shorthand and non-shorthand properties for the same value; instead, replace the shorthand with separate values.", null == value || "boolean" === typeof value || "" === value ? "Removing" : "Updating", key, longhands);
					}
				}
		...
		function batchedUpdates$1(fn, a$3, b$1) {
			if (isInsideEventHandler) return fn(a$3, b$1);
			isInsideEventHandler = !0;
			try {
				return fn(a$3);
			} finally {
				if (isInsideEventHandler = !1, null !== restoreTarget || null !== restoreQueue) {
					if (flushSyncWork$1(), restoreTarget && (a$3 = restoreTarget, fn = restoreQueue, restoreQueue = restoreTarget = null, restoreStateOfTarget(a$3), fn)) for (a$3 = 0; a$3 < fn.length; a$3++) restoreStateOfTarget(fn[a$3]);
				}
			}
		}
		...
		function finishQueueingConcurrentUpdates() {
			for (var endIndex = concurrentQueuesIndex, i$5 = concurrentlyUpdatedLanes = concurrentQueuesIndex = 0; i$5 < endIndex;) {
			...
			for (; null !== fiber;) {
				...
				if (null !== list) {
					...
					a: for (; null !== list;) {
						var dependency = list;
						list = fiber;
						for (var i$5 = 0; i$5 < contexts.length; i$5++) if (dependency.context === contexts[i$5]) {
		...
		function getCurrentDebugTask() {
			...
			if (null != debugInfo) {
				for (var i$5 = debugInfo.length - 1; 0 <= i$5; i$5--) if (null != debugInfo[i$5].name) {
		...
		function createChildReconciler(shouldTrackSideEffects) {
			...
			return function(returnFiber, currentFirstChild, newChild, lanes) {
				...
				try {
					...
					if (null != debugInfo) {
						for (var i$5 = debugInfo.length - 1; 0 <= i$5; i$5--) if ("string" === typeof debugInfo[i$5].stack) {
			...
			if (null !== hookTypesDev && (hookTypesUpdateIndexDev++, hookTypesDev[hookTypesUpdateIndexDev] !== hookName)) {
				...
				if (!didWarnAboutMismatchedHooksForComponent.has(componentName$1) && (didWarnAboutMismatchedHooksForComponent.add(componentName$1), null !== hookTypesDev)) {
					for (var table = "", i$5 = 0; i$5 <= hookTypesUpdateIndexDev; i$5++) {
						var oldHookName = hookTypesDev[i$5], newHookName = i$5 === hookTypesUpdateIndexDev ? hookName : oldHookName;
						for (oldHookName = i$5 + 1 + ". " + oldHookName; 30 > oldHookName.length;) oldHookName += " ";
		...
		function areHookInputsEqual(nextDeps, prevDeps) {
			...
			for (var i$5 = 0; i$5 < prevDeps.length && i$5 < nextDeps.length; i$5++) if (!objectIs(nextDeps[i$5], prevDeps[i$5])) return !1;
			return !0;
		}
				...
				if (null !== lastEffect) {
					...
					do {
						if ((updateQueue.tag & flags) === flags && (lastEffect = void 0, (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !0), lastEffect = runWithFiberInDEV(finishedWork, callCreateInDEV, updateQueue), (flags & Insertion) !== NoFlags && (isRunningInsertionEffect = !1), void 0 !== lastEffect && "function" !== typeof lastEffect)) {
							...
							runWithFiberInDEV(finishedWork, function(n$9, a$3) {
								console.error("%s must not return anything besides a function, which is used for clean-up.%s", n$9, a$3);
							}, hookName, addendum);
						}
		...
		function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber) {
			...
			if (null !== deletions) for (var i$5 = 0; i$5 < deletions.length; i$5++) {
				var root$1 = root$jscomp$0, returnFiber = parentFiber, deletedFiber = deletions[i$5], prevEffectStart = pushComponentEffectStart(), parent = returnFiber;
				a: for (; null !== parent;) {
					switch (parent.tag) {
						case 27:
								...
								b: switch (flags) {
									...
									case "meta":
										if (maybeNodes = getHydratableHoistableCache("meta", "content", existingHiddenCallbacks).get(flags + (current$1.content || ""))) {
											for (i$5 = 0; i$5 < maybeNodes.length; i$5++) if (currentResource = maybeNodes[i$5], checkAttributeStringCoercion(current$1.content, "content"), currentResource.getAttribute("content") === (null == current$1.content ? null : "" + current$1.content) && currentResource.getAttribute("name") === (null == current$1.name ? null : current$1.name) && currentResource.getAttribute("property") === (null == current$1.property ? null : current$1.property) && currentResource.getAttribute("http-equiv") === (null == current$1.httpEquiv ? null : current$1.httpEquiv) && currentResource.getAttribute("charset") === (null == current$1.charSet ? null : current$1.charSet)) {
												maybeNodes.splice(i$5, 1);
												break b;
											}
										}
					...
					if (flags & 8192) a: for (root$1 = finishedWork.stateNode, root$1._visibility = existingHiddenCallbacks ? root$1._visibility & ~OffscreenVisible : root$1._visibility | OffscreenVisible, !existingHiddenCallbacks || null === current$1 || wasHidden || offscreenSubtreeIsHidden || offscreenSubtreeWasHidden || (recursivelyTraverseDisappearLayoutEffects(finishedWork), (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentTrigger(finishedWork, componentEffectStartTime, componentEffectEndTime, "Disconnect")), current$1 = null, root$1 = finishedWork;;) {
						if (5 === root$1.tag || 26 === root$1.tag) {
							...
							if (null === current$1) {
								wasHidden = root$1;
								try {
									i$5 = wasHidden.stateNode, existingHiddenCallbacks ? runWithFiberInDEV(wasHidden, hideDehydratedBoundary, i$5) : runWithFiberInDEV(wasHidden, unhideDehydratedBoundary, wasHidden.stateNode);
								} catch (error) {
									captureCommitPhaseError(wasHidden, wasHidden.return, error);
								}
							}
		...
		function recursivelyTraversePassiveUnmountEffects(parentFiber) {
			...
			if (0 !== (parentFiber.flags & 16)) {
				if (null !== deletions) for (var i$5 = 0; i$5 < deletions.length; i$5++) {
					var childToDelete = deletions[i$5], prevEffectStart = pushComponentEffectStart();
		...
		function isRenderConsistentWithExternalStores(finishedWork) {
			for (var node = finishedWork;;) {
				var tag = node.tag;
				if ((0 === tag || 11 === tag || 15 === tag) && node.flags & 16384 && (tag = node.updateQueue, null !== tag && (tag = tag.stores, null !== tag))) for (var i$5 = 0; i$5 < tag.length; i$5++) {
					var check = tag[i$5], getSnapshot = check.getSnapshot;
					check = check.value;
					try {
		...
		function diffHydratedProperties(domElement, tag, props, hostContext) {
			for (var serverDifferences = {}, extraAttributes = /* @__PURE__ */ new Set(), attributes = domElement.attributes, i$5 = 0; i$5 < attributes.length; i$5++) switch (attributes[i$5].name.toLowerCase()) {
				case "value": break;
				case "checked": break;
				case "selected": break;
				default: extraAttributes.add(attributes[i$5].name);
			}
				...
				if (registrationNameDependencies.hasOwnProperty(value)) "function" !== typeof propKey && warnForInvalidEventListener(value, propKey);
					...
					case "download":
						a: {
							...
							if (null === i$5) switch (typeof propKey) {
								case "undefined":
								case "function":
								case "symbol": break a;
								...
								case "boolean":
									...
									break;
								default: if (checkAttributeStringCoercion(propKey, attributes), i$5 === "" + propKey) break a;
							}
					...
					case "span":
						a: {
							...
							if (null === i$5) switch (typeof propKey) {
								...
								case "symbol":
								case "boolean": break;
								default: if (!(isNaN(propKey) || 1 > propKey) && (checkAttributeStringCoercion(propKey, attributes), i$5 === "" + propKey)) break a;
							}
							warnForPropDifference(attributes, i$5, propKey, serverDifferences$jscomp$0);
						}
						continue;
					...
					default: if (!(2 < value.length) || "o" !== value[0] && "O" !== value[0] || "n" !== value[1] && "N" !== value[1]) {
						...
						attributes = !1;
						hostContext.context === HostContextNamespaceNone && "svg" !== tag && "math" !== tag ? extraAttributes.delete(i$5.toLowerCase()) : (attributeName = value.toLowerCase(), attributeName = possibleStandardNames.hasOwnProperty(attributeName) ? possibleStandardNames[attributeName] || null : null, null !== attributeName && attributeName !== value && (attributes = !0, extraAttributes.delete(attributeName)), extraAttributes.delete(i$5));
						a: if (attributeName = domElement, serverDifferences$jscomp$0 = i$5, i$5 = propKey, isAttributeNameSafe(serverDifferences$jscomp$0)) if (attributeName.hasAttribute(serverDifferences$jscomp$0)) attributeName = attributeName.getAttribute(serverDifferences$jscomp$0), checkAttributeStringCoercion(i$5, serverDifferences$jscomp$0), i$5 = attributeName === "" + i$5 ? i$5 : attributeName;
						else {
							switch (typeof i$5) {
								case "function":
								case "symbol": break a;
		...
		function estimateBandwidth() {
			if ("function" === typeof performance.getEntriesByType) {
				for (var count = 0, bits = 0, resourceEntries = performance.getEntriesByType("resource"), i$5 = 0; i$5 < resourceEntries.length; i$5++) {
					var entry = resourceEntries[i$5], transferSize = entry.transferSize, initiatorType = entry.initiatorType, duration = entry.duration;
					if (transferSize && duration && isLikelyStaticResource(initiatorType)) {
						initiatorType = 0;
						duration = entry.responseEnd;
						for (i$5 += 1; i$5 < resourceEntries.length; i$5++) {
							var overlapEntry = resourceEntries[i$5], overlapStartTime = overlapEntry.startTime;
		...
		function describeHydratableInstanceForDevWarnings(instance) {
			if (1 === instance.nodeType) {
				for (var JSCompiler_temp_const = instance.nodeName.toLowerCase(), serverDifferences = {}, attributes = instance.attributes, i$5 = 0; i$5 < attributes.length; i$5++) {
		...
		function insertStylesheet(instance, precedence, root$1) {
			for (var nodes = root$1.querySelectorAll("link[rel=\"stylesheet\"][data-precedence],style[data-precedence]"), last = nodes.length ? nodes[nodes.length - 1] : null, prior = last, i$5 = 0; i$5 < nodes.length; i$5++) {
				var node = nodes[i$5];
		...
		function insertStylesheetIntoRoot(root$1, resource) {
			if (!(resource.state.loading & Inserted)) {
				...
				if (precedences) var last = precedences.get(LAST_PRECEDENCE);
					...
					for (var nodes = root$1.querySelectorAll("link[data-precedence],style[data-precedence]"), i$5 = 0; i$5 < nodes.length; i$5++) {
						var node = nodes[i$5];
				...
				i$5 ? i$5.parentNode.insertBefore(nodes, i$5.nextSibling) : (root$1 = 9 === root$1.nodeType ? root$1.head : root$1, root$1.insertBefore(nodes, root$1.firstChild));
				resource.state.loading |= Inserted;
			}
		}
		...
		function markRetryLaneImpl(fiber, retryLane) {
			...
			if (null !== fiber && null !== fiber.dehydrated) {
				var a$3 = fiber.retryLane;
				fiber.retryLane = 0 !== a$3 && a$3 < retryLane ? a$3 : retryLane;
			}
		}
		...
		function scheduleReplayQueueIfNeeded(formReplayingQueue) {
			lastScheduledReplayQueue !== formReplayingQueue && (lastScheduledReplayQueue = formReplayingQueue, Scheduler.unstable_scheduleCallback(Scheduler.unstable_NormalPriority, function() {
				...
				for (var i$5 = 0; i$5 < formReplayingQueue.length; i$5 += 3) {
					var form = formReplayingQueue[i$5], submitterOrAction = formReplayingQueue[i$5 + 1], formData = formReplayingQueue[i$5 + 2];
					if ("function" !== typeof submitterOrAction) if (null === findInstanceBlockingTarget(submitterOrAction || form)) continue;
					else break;
					var formInst = getInstanceFromNode(form);
					null !== formInst && (formReplayingQueue.splice(i$5, 3), i$5 -= 3, form = {
						pending: !0,
						data: formData,
						method: form.method,
		...
		function retryIfBlockedOn(unblocked) {
			...
			for (; 0 < queuedExplicitHydrationTargets.length && (i$5 = queuedExplicitHydrationTargets[0], null === i$5.blockedOn);) attemptExplicitHydrationTarget(i$5), null === i$5.blockedOn && queuedExplicitHydrationTargets.shift();
			i$5 = (unblocked.ownerDocument || unblocked).$$reactFormReplay;
			if (null != i$5) for (queuedTarget = 0; queuedTarget < i$5.length; queuedTarget += 3) {
				var form = i$5[queuedTarget], submitterOrAction = i$5[queuedTarget + 1], formProps = form[internalPropsKey] || null;
				if ("function" === typeof submitterOrAction) formProps || scheduleReplayQueueIfNeeded(i$5);
				else if (formProps) {
					var action = null;
					...
					"function" === typeof action ? i$5[queuedTarget + 1] = action : (i$5.splice(queuedTarget, 3), queuedTarget -= 3);
		...
		(function() {
			for (var i$5 = 0; i$5 < simpleEventPluginEvents.length; i$5++) {
				var eventName = simpleEventPluginEvents[i$5], domEventName = eventName.toLowerCase();
		...
		ReactDOMHydrationRoot.prototype.unstable_scheduleHydration = function(target) {
			if (target) {
				...
				for (var i$5 = 0; i$5 < queuedExplicitHydrationTargets.length && 0 !== updatePriority && updatePriority < queuedExplicitHydrationTargets[i$5].priority; i$5++);
...
//#endregion
//#region react-examples/008-draggable-drag-handle/index.tsx
...
const DraggableCardMemo = (0, import_react.memo)(function DraggableCard() {
	...
	const [sensorType, setSensorType] = (0, import_react.useState)(null);
	const draggableSettings = (0, import_react.useMemo)(() => ({
		elements: () => elementRef.current ? [elementRef.current] : [],
		onStart: (drag$1) => {
			setSensorType(drag$1.sensor instanceof d ? "pointer" : "keyboard");
		},
		onEnd: () => {
			setSensorType(null);
		}
	...
	const setElementRef = (0, import_react.useCallback)((node) => {
		elementRef.current = node;
		setKeyboardSensorRef(node);
	}, [setKeyboardSensorRef]);
	const setHandleRef = (0, import_react.useCallback)((node) => {
