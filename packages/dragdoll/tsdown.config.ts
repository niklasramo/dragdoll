...
export default defineConfig({
  entry: {
    ...
    'utils/get-element-transform-string': 'src/utils/get-element-transform-string.ts',
    'utils/get-local-offset': 'src/utils/get-local-offset.ts',
    'utils/get-style': 'src/utils/get-style.ts',
    'utils/get-world-transform-matrix': 'src/utils/get-world-transform-matrix.ts',
  },
  outDir: './dist',
  platform: 'browser',
  format: 'esm',
