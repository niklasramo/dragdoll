...
import { a as SensorEventListenerId, s as SensorEvents, t as Sensor, u as SensorsEventsType } from "./sensor-C7UNOJhU.js";
...
type DraggableEventCallback<S extends Sensor[], T extends keyof DraggableEventCallbacks<SensorsEventsType<S>>> = DraggableEventCallbacks<SensorsEventsType<S>>[T];
...
declare class Draggable<S extends Sensor[] = Sensor[], P extends DraggablePluginMap = {}> {
  ...
  protected _emitter: Emitter<{ [K in keyof DraggableEventCallbacks<SensorsEventsType<S>>]: DraggableEventCallbacks<SensorsEventsType<S>>[K] }>;
  ...
  protected _emit<K extends keyof DraggableEventCallbacks<SensorsEventsType<S>>>(type: K, ...e: Parameters<DraggableEventCallbacks<SensorsEventsType<S>>[K]>): void;
  ...
  on<T extends keyof DraggableEventCallbacks<SensorsEventsType<S>>>(type: T, listener: DraggableEventCallbacks<SensorsEventsType<S>>[T], listenerId?: SensorEventListenerId): SensorEventListenerId;
  off<T extends keyof DraggableEventCallbacks<SensorsEventsType<S>>>(type: T, listenerId: SensorEventListenerId): void;
...
//# sourceMappingURL=draggable-D4I6XYtd.d.ts.map