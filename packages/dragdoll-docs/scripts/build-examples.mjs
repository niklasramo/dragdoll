...
async function buildExampleDirectories() {
  const examplesDir = path.join(process.cwd(), './examples/core/');
  ...
  for (const dir of directories) {
    ...
    const outputDir = path.join(process.cwd(), `./docs/public/examples/core/${exampleName}`);
...
async function buildExamplesMarkdown() {
  ...
  for (const dir of directories) {
    ...
    try {
      ...
      markdownContent += `<iframe src="/dragdoll/examples/core/${exampleName}/index.html"></iframe>`;
      markdownContent += `<a class="example-link" target="_blank" href="/dragdoll/examples/core/${exampleName}/index.html" title="Open in a new tab">`;
