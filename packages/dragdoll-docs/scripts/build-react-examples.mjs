...
async function buildExampleDirectories() {
  const examplesDir = path.join(process.cwd(), './examples/react/');
  ...
  for (const dir of directories) {
    ...
    const outputDir = path.join(process.cwd(), `./docs/public/examples/react/${exampleName}`);
...
async function buildExamplesMarkdown() {
  ...
  for (const dir of directories) {
    ...
    try {
      ...
      markdownContent += `<iframe src="/dragdoll/examples/react/${exampleName}/index.html"></iframe>`;
      markdownContent += `<a class="example-link" target="_blank" href="/dragdoll/examples/react/${exampleName}/index.html" title="Open in a new tab">`;
