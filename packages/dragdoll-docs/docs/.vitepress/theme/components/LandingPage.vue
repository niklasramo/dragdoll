  ...
  <div class="landing">
      ...
      <div class="hero-content">
        <div class="hero-text">
          ...
          <div class="hero-actions">
            ...
            <a
              href="https://github.com/niklasramo/dragdoll"
    ...
    <section class="frameworks">
      <div class="frameworks-container">
        <h2 class="section-title">Framework Support</h2>
        <p class="section-subtitle">Use DragDoll your way.</p>
        <div class="frameworks-grid frameworks-grid-available">
          ...
          <a :href="`${base}solid/`" class="framework-card framework-card-available">
            <div class="framework-icon">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <path
        ...
        <div class="frameworks-grid frameworks-grid-soon">
          <div class="framework-card framework-card-soon">
            ...
            <div class="framework-status soon">Coming Soon</div>
          </div>
          <div class="framework-card framework-card-soon">
            <div class="framework-icon">
              <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <section class="bottom-cta">
      ...
      <p>Install DragDoll and start dragging in minutes.</p>
...
.frameworks-grid-available {
  grid-template-columns: repeat(3, 1fr);
}

.frameworks-grid-soon {
  grid-template-columns: repeat(2, 1fr);
  max-width: 66%;
  margin: 16px auto 0;
}
