'use strict';
var SolidExample_007_draggable_center_to_pointer = (() => {
  ...
  function wt(e, t) {
    let n = S,
      ...
      s = e.length === 0,
      i = t === void 0 ? r : t,
      o = s ? St : { owned: null, cleanups: null, context: i ? i.context : null, owner: i },
      a = s ? e : () => e(() => R(() => ee(o)));
    ((p = o), (S = null));
    try {
      return z(a, !0);
  ...
  function T(e, t, n) {
    ...
    let r = Xe(e, t, !1, F),
      s = je && qe(je);
    (s && (r.suspense = s), (!n || !n.render) && (r.user = !0), k ? k.push(r) : pe(r));
  }
  function E(e, t, n) {
        ...
        z(() => {
          for (let s = 0; s < e.observers.length; s += 1) {
            let i = e.observers[s],
              o = f && f.running;
            (o && f.disposed.has(i)) ||
              ((o ? !i.tState : !i.state) && (i.pure ? x.push(i) : k.push(i), i.observers && Mt(i)),
  ...
  function pe(e) {
    ...
    ee(e);
    let t = Pe;
    (vt(e, f && f.running && f.sources.has(e) ? e.tValue : e.value, t),
      f &&
        !f.running &&
        f.sources.has(e) &&
        queueMicrotask(() => {
          z(() => {
            (f && (f.running = !0), (S = p = e), vt(e, e.tValue, t), (S = p = null));
          }, !1);
        }));
  }
  function vt(e, t, n) {
  ...
  function z(e, t) {
    ...
    try {
      ...
      (n || (k = null), (x = null), We(r));
    }
  }
  function Dn(e) {
    if ((x && (me && f && f.running ? Cn(x) : Ot(x), (x = null)), e)) return;
    let t;
    if (f) {
      if (!f.promises.size && !f.queue.size) {
        ...
        ((f.running = !1), f.effects.push.apply(f.effects, k), (k = null), yt(!0));
        return;
      }
    }
    let n = k;
    ((k = null), n.length && z(() => bt(n), !1), t && t());
  }
  function Ot(e) {
  ...
  function Pt(e, t) {
    if ((t || ((e.tState = 0), f.disposed.add(e)), e.owned))
      for (let n = 0; n < e.owned.length; n++) Pt(e.owned[n]);
  }
  function Mn(e) {
  ...
  function Pn(e, t) {
    return function (r) {
      ...
      return (
        te(
          () => (s = R(() => ((p.context = { ...p.context, [e]: r.value }), En(() => r.children)))),
          void 0,
        ),
        s
      );
        ...
        if (c != null)
          if (a < c && c < i) {
            let h = o,
              g = 1,
              m;
            for (; ++h < s && h < i && !((m = u.get(t[h])) == null || m !== c + g); ) g++;
            if (g > c - a) {
              let b = t[o];
  ...
  function Te(e, t, n, r, s) {
    ...
    if (((e = (a && n[0] && n[0].parentNode) || e), o === 'string' || o === 'number')) {
      ...
      if (Array.isArray(t)) {
        ...
        } else u ? (n.length === 0 ? kt(e, l, r) : Ln(e, n, l)) : (n && ce(e), kt(e, l));
        n = l;
      } else if (t.nodeType) {
  ...
  function Ze(e, t = {}) {
    ...
    switch (s) {
      case 'relative':
        return e;
      case 'fixed':
        return Je(e, { container: o, position: s, skipDisplayNone: i });
      case 'absolute': {
        let a = Je(e, { container: o, position: s, skipDisplayNone: i });
  ...
  var Re = Q ? jn() : null,
    Jt = class {
      constructor(e, t) {
        ...
        ((this.data = {}),
          (this.element = e),
          (this.elementTransformOrigin = Qe(r.transformOrigin)),
        ...
        ((this.elementOffsetContainer = u),
          (this.dragOffsetContainer = l === o ? u : Ze(e, { container: l })));
        {
          let { width: h, height: g, x: m, y: b } = s;
    ...
    Zt = {
      ...
      applyPosition: ({ item: e, phase: t }) => {
        let n = t === Z.End || t === Z.EndAlign,
          ...
          { x: m, y: b, z: C } = h,
          M = !c.isIdentity && (m !== 0 || b !== 0 || C !== 0),
          L = a.x + l.x + u.x,
          G = a.y + l.y + u.y;
        (_e(W),
          M && (C === 0 ? W.translateSelf(-m, -b) : W.translateSelf(-m, -b, -C)),
          n ? s.isIdentity || W.multiplySelf(s) : o.isIdentity || W.multiplySelf(o),
          _e(Fe).translateSelf(L, G),
          W.multiplySelf(Fe),
          r.isIdentity || W.multiplySelf(r),
          M && (_e(Fe).translateSelf(m, b, C), W.multiplySelf(Fe)),
    ...
    tt = class {
      ...
      _prepareStart() {
        let e = this.drag;
        !e ||
          this._startPhase !== B.Init ||
          ((this._startPhase = B.Prepare),
          ...
          (this._startPhase = B.FinishPrepare));
      }
      _applyStart() {
        let e = this.drag;
        if (!(!e || this._startPhase !== B.FinishPrepare)) {
          if (((this._startPhase = B.Apply), this.settings.preventClickOnEnd)) {
            let t = e.sensor;
          ...
          (window.addEventListener('scroll', this._onScroll, Gt),
            ...
            (this._startPhase = B.FinishApply));
        }
      }
      _prepareMove() {
        let e = this.drag;
      ...
      stop() {
        let e = this.drag;
        if (!e || e.isEnded) return;
        if (this._startPhase === B.Prepare || this._startPhase === B.Apply)
  ...
  var Ee = {
    add(e, t, n) {
      ((V = new Map(V)), V.set(e, { sources: t, proxies: n, exiting: !1, done: zn }), nt());
    },
    startExiting(e, t) {
      let n = V.get(e);
  ...
  function cn(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      if (r instanceof SVGSVGElement) ((u = `${i.width}px`), (c = `${i.height}px`));
        ...
        if (!(m >= 0) || !(b >= 0)) ((u = `${i.width}px`), (c = `${i.height}px`));
          ...
          ((u = `${m + C + M + L + G}px`), (c = `${b + ie + y + _ + Y}px`));
        }
      }
    ...
    for (let n = 0; n < e.length; n++) {
      let r = Be[n],
        ...
        C = i.left - b.left,
        M = i.top - b.top;
      if (Math.abs(m) < 1e-10) ((a = C), (l = M));
      else {
        let L = 1 / m;
        ((a = (g * C - h * M) * L), (l = (-c * C + u * M) * L));
      }
      ((ct[n] = a), (dt[n] = l));
    }
    for (let n = 0; n < e.length; n++) {
  ...
  function dn(e, t) {
    if (de) return () => null;
    let n = E(() => (Array.isArray(e) ? rn(e) : (j(e) ?? [])).filter((y) => !!y)),
      r = E(() => j(t)),
      s = E(() => r()?.id),
      i = E(() => r()?.dndObserver),
      o = E(() => {
      ...
      L = r()?.dragPreviewExitTimeout;
    T(() => {
      let y = r();
      ((C = o()), (M = y?.dragPreviewContainer), (L = y?.dragPreviewExitTimeout));
    });
    let G = () => {
        ...
        xt(() => {
          ...
          let _ = R(o),
            ...
            P = new tt(y, {
              ...
              elements(I) {
                let ut = C,
                  ue = (ut?.elements || (() => null))(I);
                if (!ut?.dragPreview || !ue || ue.length === 0) return ue;
                let fe = cn(ue);
                ...
                let ft = () => {
                    ...
                    if (ht > 0) {
                      ...
                      let Ce = !1,
                        ...
                        yn = setTimeout(gt, ht);
                      Ee.startExiting(I.draggable, gt);
                    } else
                      (Ee.remove(I.draggable),
                        setTimeout(() => {
                  ...
                  mn = I.draggable.on('end', ft),
                  pn = I.draggable.on('destroy', ft);
                return fe;
              },
              ...(De
                ? {
            ...
            q = R(l);
          (q?.addDraggables([P]), (h = P), (g = Y), (m = _), (b = q), c(P));
        });
      };
    return (
      T(() => {
        ...
        (y.length !== _.sensors.length || y.some((Y) => !_.sensors.includes(Y))) && ie();
      }),
      T(() => {
        if (!h) return;
        let _ = s();
      ...
      T(() => {
        ...
        if (b === y) return;
        let _ = h;
        (_ && (b?.removeDraggables([_]), y?.addDraggables([_])), (b = y));
      }),
      T(() => {
        let y = h;
        if (!y) return;
        ...
        if (m) {
          let P = { ...m },
            q = { ..._ };
          ((P.elements === q.elements || (P.dragPreview && q.dragPreview)) &&
            (delete P.elements, delete q.elements),
            (Y = !$e(P, q)));
        } else Y = !0;
        if (!Y) return;
        let De = y._parseSettings(_);
        if (
          (y.updateSettings({
            ...De,
          ...
          let P = _?.dndGroups !== m.dndGroups,
            q = _?.computeClientRect !== m.computeClientRect;
          (P && b?.clearTargets(y), (P || q) && b?.detectCollisions(y));
        }
        m = _;
      }),
      $(G),
  ...
  function er() {
    let e = null,
      ...
      o = dn([t, r], {
        elements: () => (e ? [e] : []),
        positionModifiers: [
          (u, { drag: c, item: h, phase: g }) => {
            if (g === 'start' && c.sensor instanceof se) {
              let { clientRect: m } = h,
                { x: b, y: C } = c.startEvent,
                M = m.x + m.width / 2,
                L = m.y + m.height / 2;
              ((u.x = b - M), (u.y = C - L));
            }
    ...
    return (() => {
      var u = Zn();
      return (It(l, u), te(() => Lt(u, `card draggable ${a() ? 'dragging' : ''}`)), u);
    })();
  }
  function tr() {
    return ke(er, {});
