'use strict';
var SolidExample_012_draggable_drag_preview = (() => {
  var Ti = Object.defineProperty;
  var Pi = (e, t, n) =>
    t in e ? Ti(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n);
  var c = (e, t, n) => Pi(e, typeof t != 'symbol' ? t + '' : t, n);
  var L = {
    context: void 0,
    registry: void 0,
    effects: void 0,
  ...
  var Ai = !1,
    Ri = (e, t) => e === t;
  var Ii = Symbol('solid-track');
  var st = { equals: Ri },
    an = null,
    fn = _n,
    Z = 1,
    Ne = 2,
    hn = { owned: null, cleanups: null, context: null, owner: null };
  var b = null,
    h = null,
    Ke = null,
    Re = null,
  ...
  function De(e, t) {
    let n = C,
      ...
      r = e.length === 0,
      s = t === void 0 ? i : t,
      o = r ? hn : { owned: null, cleanups: null, context: s ? s.context : null, owner: s },
      a = r ? e : () => e(() => G(() => me(o)));
    ((b = o), (C = null));
    try {
      return oe(a, !0);
  ...
  function ge(e, t, n) {
    let i = Mt(e, t, !1, Z);
    Ke && h && h.running ? F.push(i) : We(i);
  }
  function P(e, t, n) {
    fn = Ni;
    let i = Mt(e, t, !1, Z),
      r = Et && Ct(Et);
    (r && (i.suspense = r), (!n || !n.render) && (i.user = !0), H ? H.push(i) : We(i));
  }
  function M(e, t, n) {
    ...
    return (
      ...
      Ke && h && h.running ? ((i.tState = Z), F.push(i)) : We(i),
      pn.bind(i)
    );
  }
  function mn(e) {
  ...
  function G(e) {
    if (!Re && C === null) return e();
    let t = C;
    C = null;
    try {
      return Re ? Re.untrack(e) : e();
    } finally {
      C = t;
    }
  }
  ...
  function gn(e, t) {
    ...
    return { id: n, Provider: Ki(n), defaultValue: e };
  }
  function Ct(e) {
    let t;
  ...
  function pn() {
    ...
    if (this.sources && (e ? this.tState : this.state))
      if ((e ? this.tState : this.state) === Z) We(this);
      else {
        let t = F;
        ((F = null), oe(() => ot(this), !1), (F = t));
      }
    if (C) {
      let t = this.observers ? this.observers.length : 0;
      (C.sources
        ? (C.sources.push(this), C.sourceSlots.push(t))
        : ((C.sources = [this]), (C.sourceSlots = [t])),
        this.observers
        ...
        oe(() => {
          for (let r = 0; r < e.observers.length; r += 1) {
            let s = e.observers[r],
              o = h && h.running;
            (o && h.disposed.has(s)) ||
              ((o ? !s.tState : !s.state) && (s.pure ? F.push(s) : H.push(s), s.observers && vn(s)),
              o ? (s.tState = Z) : (s.state = Z));
          }
  ...
  function We(e) {
    ...
    me(e);
    let t = at;
    (cn(e, h && h.running && h.sources.has(e) ? e.tValue : e.value, t),
      h &&
        !h.running &&
        h.sources.has(e) &&
        queueMicrotask(() => {
          oe(() => {
            (h && (h.running = !0), (C = b = e), cn(e, e.tValue, t), (C = b = null));
          }, !1);
        }));
  }
  function cn(e, t, n) {
    ...
    try {
      ...
      return (
        e.pure &&
          (h && h.running
            ? ((e.tState = Z), e.tOwned && e.tOwned.forEach(me), (e.tOwned = void 0))
            : ((e.state = Z), e.owned && e.owned.forEach(me), (e.owned = null))),
        (e.updatedAt = n + 1),
        Ot(o)
      );
    } finally {
    ...
    (!e.updatedAt || e.updatedAt <= n) &&
      (e.updatedAt != null && 'observers' in e
        ? yn(e, i, !0)
        : h && h.running && e.pure
          ? (h.sources.has(e) || (e.value = i), h.sources.add(e), (e.tValue = i))
          : (e.value = i),
      (e.updatedAt = n));
  }
  function Mt(e, t, n, i = Z, r) {
    let s = {
      fn: e,
      state: i,
      updatedAt: null,
    ...
    if (
      ...
      s.fn = (m) => (a(), h && h.running ? (u || (u = Re.factory(o, d)), u.track(m)) : f.track(m));
    }
    return s;
  }
  function $e(e) {
    ...
    if ((t ? e.tState : e.state) === Ne) return ot(e);
    ...
    for (let i = n.length - 1; i >= 0; i--) {
      ...
      if ((t ? e.tState : e.state) === Z) We(e);
      else if ((t ? e.tState : e.state) === Ne) {
        let r = F;
        ((F = null), oe(() => ot(e, n[0]), !1), (F = r));
      }
    }
  }
  function oe(e, t) {
    ...
    try {
      ...
      (n || (H = null), (F = null), Ot(i));
    }
  }
  function qi(e) {
    if ((F && (Ke && h && h.running ? Bi(F) : _n(F), (F = null)), e)) return;
    let t;
    if (h) {
      if (!h.promises.size && !h.queue.size) {
        let i = h.sources,
          r = h.disposed;
        (H.push.apply(H, h.effects), (t = h.resolve));
        for (let s of H) ('tState' in s && (s.state = s.tState), delete s.tState);
        ((h = null),
          oe(() => {
            for (let s of r) me(s);
            for (let s of i) {
              if (((s.value = s.tValue), s.owned))
                for (let o = 0, a = s.owned.length; o < a; o++) me(s.owned[o]);
              (s.tOwned && (s.owned = s.tOwned), delete s.tValue, delete s.tOwned, (s.tState = 0));
            }
            ln(!1);
          }, !1));
      } else if (h.running) {
        ((h.running = !1), h.effects.push.apply(h.effects, H), (H = null), ln(!0));
        return;
      }
    }
    let n = H;
    ((H = null), n.length && oe(() => fn(n), !1), t && t());
  }
  function _n(e) {
  ...
  function ot(e, t) {
    ...
    for (let i = 0; i < e.sources.length; i += 1) {
      ...
      if (r.sources) {
        ...
        s === Z ? r !== t && (!r.updatedAt || r.updatedAt < at) && $e(r) : s === Ne && ot(r, t);
      }
    }
  }
  function vn(e) {
    ...
    for (let n = 0; n < e.observers.length; n += 1) {
      let i = e.observers[n];
      (t ? !i.tState : !i.state) &&
        (t ? (i.tState = Ne) : (i.state = Ne),
        i.pure ? F.push(i) : H.push(i),
        i.observers && vn(i));
    }
  }
  function me(e) {
  ...
  function bn(e, t) {
    if ((t || ((e.tState = 0), h.disposed.add(e)), e.owned))
      for (let n = 0; n < e.owned.length; n++) bn(e.owned[n]);
  }
  function $i(e) {
  ...
  function Ot(e, t = b) {
    let n = an && t && t.context && t.context[an],
      i = $i(e);
    if (!n) throw i;
    H
      ? H.push({
  ...
  function Dt(e) {
    if (typeof e == 'function' && !e.length) return Dt(e());
    if (Array.isArray(e)) {
      let t = [];
  ...
  function Ki(e, t) {
    return function (i) {
      ...
      return (
        ge(
          () => (r = G(() => ((b.context = { ...b.context, [e]: i.value }), Fi(() => i.children)))),
          void 0,
        ),
        r
      );
    ...
    return (
      ...
      () => {
        ...
        return (
          l[Ii],
          G(() => {
            let g, y, S, w, R, T, I, p, _;
            if (f === 0)
              (o !== 0 && (dn(s), (s = []), (i = []), (r = []), (o = 0), a && (a = [])),
                n.fallback &&
                  ((i = [Wi]), (r[0] = De((W) => ((s[0] = W), n.fallback()))), (o = 1)));
            else if (o === 0) {
              for (r = new Array(f), d = 0; d < f; d++) ((i[d] = l[d]), (r[d] = De(m)));
              o = f;
            } else {
              for (
                S = new Array(f),
              ...
              for (I = o - 1, p = f - 1; I >= T && p >= T && i[I] === l[p]; I--, p--)
                ((S[p] = r[I]), (w[p] = s[I]), a && (R[p] = a[I]));
              for (g = new Map(), y = new Array(p + 1), d = p; d >= T; d--)
                ((_ = l[d]), (u = g.get(_)), (y[d] = u === void 0 ? -1 : u), g.set(_, d));
              for (u = T; u <= I; u++)
                ((_ = i[u]),
                  (d = g.get(_)),
                  d !== void 0 && d !== -1
                    ? ((S[d] = r[u]), (w[d] = s[u]), a && (R[d] = a[u]), (d = y[d]), g.set(_, d))
                    : s[u]());
              for (d = T; d < f; d++)
                d in S
                  ? ((r[d] = S[d]), (s[d] = w[d]), a && ((a[d] = R[d]), a[d](d)))
                  : (r[d] = De(m));
              ((r = r.slice(0, (o = f))), (i = l.slice(0)));
            }
            return r;
          })
        );
  ...
  function Tt(e) {
    ...
    return M(Hi(() => e.each, e.children, t || void 0));
  }
  var Yi = [
      'allowfullscreen',
      'async',
  ...
  function ji(e, t, n) {
    ...
    for (; o < r || a < s; ) {
      ...
      } else if (s === a) for (; o < r; ) ((!f || !f.has(t[o])) && t[o].remove(), o++);
        ...
        if (u != null)
          if (a < u && u < s) {
            let d = o,
              m = 1,
              g;
            for (; ++d < r && d < s && !((g = f.get(t[d])) == null || g !== u + m); ) m++;
            if (m > u - a) {
              let y = t[o];
              for (; a < u; ) e.insertBefore(n[a++], y);
  ...
  function xn(e, t, n, i = {}) {
    ...
    return (
      De((s) => {
        ((r = s), t === document ? e() : He(t, e(), t.firstChild ? null : void 0, n));
      }, i.owner),
      () => {
        (r(), (t.textContent = ''));
      }
  ...
  function ct(e, t, n, i) {
    let r,
      ...
      o = t
        ? () => G(() => document.importNode(r || (r = s()), !0))
        : () => (r || (r = s())).cloneNode(!0);
    return ((o.cloneNode = o), o);
  }
  function wn(e, t) {
    En(e) || (t == null ? e.removeAttribute('class') : (e.className = t));
  }
  function kt(e, t, n) {
    return G(() => e(t, n));
  }
  ...
  function lt(e, t, n, i, r) {
    ...
    if (((e = (a && n[0] && n[0].parentNode) || e), o === 'string' || o === 'number')) {
      ...
      if (Array.isArray(t)) {
        let l = [],
          f = n && Array.isArray(n);
        if (Pt(l, t, n, r)) return (ge(() => (n = lt(e, l, n, i, !0))), () => n);
        if (s) {
        ...
        if (l.length === 0) {
          if (((n = Le(e, n, i)), a)) return n;
        } else f ? (n.length === 0 ? Sn(e, l, i) : ji(e, n, l)) : (n && Le(e), Sn(e, l));
        n = l;
      } else if (t.nodeType) {
        if (s && t.parentNode) return (n = a ? [t] : t);
        if (Array.isArray(n)) {
          if (a) return (n = Le(e, n, i, t));
          Le(e, n, null, t);
        } else
  ...
  function Pt(e, t, n, i) {
    ...
    for (let s = 0, o = t.length; s < o; s++) {
      ...
      if (!(a == null || a === !0 || a === !1))
        ...
        else if (Array.isArray(a)) r = Pt(e, a, l) || r;
        else if (f === 'function')
          if (i) {
            for (; typeof a == 'function'; ) a = a();
            r = Pt(e, Array.isArray(a) ? a : [a], Array.isArray(l) ? l : [l]) || r;
          } else (e.push(a), (r = !0));
        else {
          let u = String(a);
  ...
  var zi = class {
    constructor(e = {}) {
      ...
      ((this._phases = t),
        (this._emitter = new pe({ getId: i, dedupe: n })),
        (this._queue = []),
  ...
  var Dn = class extends zi {
    constructor(e = {}) {
      let { paused: t = !1, onDemand: n = !1, requestFrame: i = At(), ...r } = e;
      (super(r),
        (this._paused = t),
        (this._onDemand = n),
  ...
  var O = { read: Symbol(), write: Symbol() },
    k = new Dn({
      ...
      requestFrame: typeof window < 'u' ? At() : () => () => {},
    });
  function Xe(e, t = { width: 0, height: 0, x: 0, y: 0, left: 0, top: 0, right: 0, bottom: 0 }) {
    return (
      e &&
        ((t.width = e.width),
        (t.height = e.height),
  ...
  function Ui(e, t, n = { width: 0, height: 0, x: 0, y: 0 }) {
  ...
  var Gi = { width: 0, height: 0, x: 0, y: 0 };
  function Rt(e, t, n) {
    if ((n || (n = Ui(e, t, Gi)), !n)) return 0;
    let i = n.width * n.height;
    return i ? (i / (Math.min(e.width, t.width) * Math.min(e.height, t.height))) * 100 : 0;
  }
  var Cn = new WeakMap();
  function Q(e) {
    let t = Cn.get(e)?.deref();
    return (t || ((t = window.getComputedStyle(e, null)), Cn.set(e, new WeakRef(t))), t);
  }
  function Ce(e) {
    return e instanceof Window;
  }
  var Mn = new Set(['auto', 'scroll']);
  function It(e, t) {
    ...
    let f = i.width - s - o,
      ...
      d = e;
    return (
      d !== d.ownerDocument.documentElement &&
        (Mn.has(r.overflowY) && (f -= Math.max(0, Math.round(f) - d.clientWidth)),
        Mn.has(r.overflowX) && (u -= Math.max(0, Math.round(u) - d.clientHeight))),
      (n.width = f),
      (n.height = u),
      n
    );
  ...
  var Qi = typeof window < 'u' && window.document !== void 0,
    Lt = !!(
      Qi &&
      navigator.vendor &&
    ...
    ut = { [E.content]: !1, [E.padding]: !1, [E.scrollbar]: !0, [E.border]: !0, [E.margin]: !0 },
    dt = new Set(['auto', 'scroll']),
    Pn = (() => {
      try {
  ...
  function q(e, t) {
    ...
    let n = kn.get(e)?.deref();
    return (n || ((n = window.getComputedStyle(e, null)), kn.set(e, new WeakRef(n))), n);
  }
  var An = new Map(),
    je = null,
    ve = null,
  ...
  function Ji(e, t) {
    ...
    return (
      i === void 0 &&
        (je || (je = document.createElement('style')),
        (je.innerHTML = `
    ...
    `),
      ...
      `)),
        ...
        (i = ve.getBoundingClientRect().width - ze.getBoundingClientRect().width - t),
        An.set(n[1], i),
  ...
  function be(e, t, n) {
    if (n <= 0) return 0;
    if (Pn) {
      let i = q(e, '::-webkit-scrollbar'),
        r = t === 'x' ? i.height : i.width,
        s = parseFloat(r);
      if (!Number.isNaN(s) && !Number.isInteger(s)) return Ji(r, s);
    }
    return n;
  }
  function Rn(e, t = !1) {
  ...
  function Ln(e, t = E.border) {
    ...
    return t === E.margin
      ...
      : ((n -= parseFloat(i.borderLeftWidth) || 0),
        ...
        t === E.scrollbar ||
          (!qe(e) && dt.has(i.overflowY) && (n -= be(e, 'y', Math.round(n) - e.clientWidth)),
          t === E.padding ||
            ((n -= parseFloat(i.paddingLeft) || 0), (n -= parseFloat(i.paddingRight) || 0))),
        n);
  }
  function Ft(e, t = E.border) {
    return ye(e) ? Rn(e, ut[t]) : _e(e) ? In(e) : Ln(e, t);
  }
  function Fn(e, t = !1) {
  ...
  function Bn(e, t = E.border) {
    ...
    return t === E.margin
      ...
      : ((n -= parseFloat(i.borderTopWidth) || 0),
        ...
        t === E.scrollbar ||
          (!qe(e) && dt.has(i.overflowX) && (n -= be(e, 'x', Math.round(n) - e.clientHeight)),
          t === E.padding ||
            ((n -= parseFloat(i.paddingTop) || 0), (n -= parseFloat(i.paddingBottom) || 0))),
        n);
  }
  function qt(e, t = E.border) {
    return ye(e) ? Fn(e, ut[t]) : _e(e) ? qn(e) : Bn(e, t);
  }
  function Me(e) {
    return e?.constructor === Object;
  }
  function Ue(e, t = E.border) {
    let n = { left: 0, top: 0 };
    if (_e(e)) return n;
    if (ye(e)) return ((n.left += e.scrollX || 0), (n.top += e.scrollY || 0), n);
    let i = e.ownerDocument.defaultView;
    i && ((n.left += i.scrollX || 0), (n.top += i.scrollY || 0));
    let r = e.getBoundingClientRect();
    if (((n.left += r.left), (n.top += r.top), t === E.border)) return n;
    let s = q(e);
    return t === E.margin
  ...
  function Nn(e, t) {
    let n = Me(e) ? { left: e.left, top: e.top } : Array.isArray(e) ? Ue(...e) : Ue(e);
    if (t && !_e(t)) {
      let i = Me(t) ? t : Array.isArray(t) ? Ue(t[0], t[1]) : Ue(t);
  ...
  var Yn = class {
    ...
    jn = { width: 0, height: 0, x: 0, y: 0 },
    zn = { width: 0, height: 0, x: 0, y: 0 },
    ae = {
      direction: 'none',
      threshold: 0,
      distance: 0,
    ...
    ft = { none: 0, left: v.x | Oe.reverse, right: v.x | Oe.forward },
    Je = { none: 0, up: v.y | Oe.reverse, down: v.y | Oe.forward },
    A = { ...ft, ...Je };
  function Nt(e) {
    switch (e) {
      case ft.none:
  ...
  var nr = class {
      constructor() {
        ...
        ((this.positionX = 0),
          (this.positionY = 0),
          (this.directionX = A.none),
          (this.directionY = A.none),
    ...
    ir = class {
      ...
      computeScrollValues() {
        this.element &&
          ((this.scrollLeft = this.requestX ? this.requestX.value : Ge(this.element)),
          (this.scrollTop = this.requestY ? this.requestY.value : Qe(this.element)));
      }
      scroll() {
        this.element &&
    ...
    rr = class {
      ...
      hasReachedEnd() {
        return Oe.forward & this.direction ? ht(this.value, this.maxValue) : this.value <= 0;
      }
      ...
      computeSpeed() {
        ...
        return typeof e == 'function'
          ? ((ae.direction = Nt(this.direction)),
      ...
      onStart() {
        ...
        typeof e == 'function' && e(this.element, Nt(this.direction));
      }
      onStop() {
        if (!this.item || !this.element) return;
  ...
  function Gn(e = 500, t = 0.5, n = 0.25) {
    let i = e * (t > 0 ? 1 / t : 1 / 0),
      r = e * (n > 0 ? 1 / n : 1 / 0);
    return function (s, o) {
      let a = 0;
  ...
  var Qn = class {
    constructor(e = {}) {
      ...
      ((this.items = []),
        ...
        (this._requests = { [v.x]: new Map(), [v.y]: new Map() }),
        (this._itemData = new Map()),
        (this._requestPool = new Yn((n) => n || new rr(), {
          initialBatchCount: 1,
          minBatchCount: 1,
          onRelease: (n) => n.reset(),
        })),
        (this._actionPool = new Yn((n) => n || new ir(), {
          batchSize: 10,
          initialBatchCount: 1,
          minBatchCount: 1,
          onRelease: (n) => n.reset(),
    ...
    _startTicking() {
      this._isTicking ||
        ((this._isTicking = !0),
        k.on(O.read, this._frameRead, this._frameRead),
        k.on(O.write, this._frameWrite, this._frameWrite));
    }
    _stopTicking() {
      this._isTicking &&
        ((this._isTicking = !1),
        (this._tickTime = 0),
        (this._tickDeltaTime = 0),
        k.off(O.read, this._frameRead),
        k.off(O.write, this._frameWrite));
    }
    ...
    _checkItemOverlap(e, t, n) {
      ...
      if (!r.length) {
        (t && this._cancelItemScroll(e, v.x), n && this._cancelItemScroll(e, v.y));
        return;
      }
      ...
      for (; fe < r.length; fe++) {
        let D = r[fe],
          j = typeof D.threshold == 'number' ? D.threshold : 50,
          B = !!(t && a && D.axis !== 'y'),
          Ae = !!(n && l && D.axis !== 'x'),
          le = D.priority || 0;
        if ((!B || le < u) && (!Ae || le < R)) continue;
        let V = Wn(D.element || D),
          se = B ? Hn(V) : -1,
          we = Ae ? Vn(V) : -1;
        if (se <= 0 && we <= 0) continue;
        let X = It(V, zn),
          he = Rt(s, X) || -1 / 0;
        if (he === -1 / 0)
          if (D.padding && Xn(s, Un(X, D.padding, jn))) he = -(tr(s, X) || 0);
          else continue;
        if (B && le >= u && se > 0 && (le > u || he > m)) {
          let z = 0,
            U = A.none,
            J = $t(j, X.width),
            Ee = Kt(J, i, s.width, X.width);
          (a === A.right
            ? ((z = X.x + X.width + Ee - (s.x + s.width)),
              z <= J && !ht(Ge(V), se) && (U = A.right))
            : a === A.left && ((z = s.x - (X.x - Ee)), z <= J && Ge(V) > 0 && (U = A.left)),
            U && ((f = V), (u = le), (d = J), (m = he), (g = U), (y = z), (S = se)));
        }
        if (Ae && le >= R && we > 0 && (le > R || he > I)) {
          let z = 0,
            U = Je.none,
            J = $t(j, X.height),
            Ee = Kt(J, i, s.height, X.height);
          (l === A.down
            ? ((z = X.y + X.height + Ee - (s.y + s.height)),
              z <= J && !ht(Qe(V), we) && (U = A.down))
            : l === A.up && ((z = s.y - (X.y - Ee)), z <= J && Qe(V) > 0 && (U = A.up)),
            U && ((w = V), (R = le), (T = J), (I = he), (p = U), (_ = z), (W = we)));
        }
      }
      (t &&
        (f && g ? this._requestItemScroll(e, v.x, f, g, d, y, S) : this._cancelItemScroll(e, v.x)),
        n &&
          (w && p
            ? this._requestItemScroll(e, v.y, w, p, T, _, W)
            : this._cancelItemScroll(e, v.y)));
    }
    _updateScrollRequest(e) {
      ...
      for (; o < i.length; o++) {
        ...
        let d = It(l, zn);
        if ((Rt(r, d) || -1 / 0) === -1 / 0) {
          let w = a.scrollPadding || a.padding;
          if (!(w && Xn(r, Un(d, w, jn)))) break;
        }
        let m = $t(typeof a.threshold == 'number' ? a.threshold : 50, f ? d.width : d.height),
          g = Kt(m, t, f ? r.width : r.height, f ? d.width : d.height),
          y = 0;
        if (
          ((y =
            e.direction === A.left
              ? r.x - (d.x - g)
              : e.direction === A.right
                ? d.x + d.width + g - (r.x + r.width)
                : e.direction === A.up
                  ? r.y - (d.y - g)
                  : d.y + d.height + g - (r.y + r.height)),
          y > m)
        )
          break;
        let S = f ? Ge(l) : Qe(l);
        if (((s = Oe.forward & e.direction ? ht(S, u) : S <= 0), s)) break;
        return ((e.maxValue = u), (e.threshold = m), (e.distance = y), (e.isEnding = !1), !0);
      }
      return (
        n === !0 && e.speed > 0
    ...
    _updateItems() {
      for (let e = 0; e < this.items.length; e++) {
        let t = this.items[e],
          ...
          o = n.positionY;
        (i === s && r === o) ||
          ((n.directionX = i > s ? A.right : i < s ? A.left : n.directionX),
          (n.directionY = r > o ? A.down : r < o ? A.up : n.directionY),
          (n.positionX = i),
          (n.positionY = r),
    ...
    _updateRequests() {
      let e = this.items,
        t = this._requests[v.x],
        n = this._requests[v.y],
        i = 0;
      for (; i < e.length; i++) {
        let r = e[i],
        ...
        f &&
          f.isActive &&
          ((l = !this._updateScrollRequest(f)), l && ((a = !0), this._cancelItemScroll(r, v.x)));
        let u = !0,
          d = n.get(r);
        (d &&
          d.isActive &&
          ((u = !this._updateScrollRequest(d)), u && ((a = !0), this._cancelItemScroll(r, v.y))),
    ...
    _updateActions() {
      ...
      for (e = 0; e < this.items.length; e++) {
        let t = this.items[e],
          n = this._requests[v.x].get(t),
          i = this._requests[v.y].get(t);
        (n && this._requestAction(n, v.x), i && this._requestAction(i, v.y));
      }
    ...
    removeItem(e) {
      ...
      t !== -1 &&
        (this._requests[v.x].get(e) &&
          (this._cancelItemScroll(e, v.x), this._requests[v.x].delete(e)),
        this._requests[v.y].get(e) &&
          (this._cancelItemScroll(e, v.y), this._requests[v.y].delete(e)),
    ...
    isItemScrollingX(e) {
      return !!this._requests[v.x].get(e)?.isActive;
    }
    isItemScrollingY(e) {
      return !!this._requests[v.y].get(e)?.isActive;
    }
    isItemScrolling(e) {
  ...
  var ce = typeof window < 'u' && window.document !== void 0,
    Jn = ce && 'ontouchstart' in window,
    Zn = ce && !!window.PointerEvent;
  ce &&
    navigator.vendor &&
    navigator.vendor.indexOf('Apple') > -1 &&
    navigator.userAgent &&
  ...
  function ni(e) {
    return e === 'auto' || e === void 0 ? (Zn ? 'pointer' : Jn ? 'touch' : 'mouse') : e;
  }
  var Se = {
      pointer: {
        start: 'pointerdown',
    ...
    Ze = class {
      constructor(e, t = {}) {
        ...
        let {
          listenerOptions: n = xe.listenerOptions,
          sourceEvents: i = xe.sourceEvents,
          startPredicate: r = xe.startPredicate,
          cancelOnVisibilityChange: s = xe.cancelOnVisibilityChange,
          cancelOnEscape: o = xe.cancelOnEscape,
          preventNativeDrag: a = xe.preventNativeDrag,
          preventContextMenu: l = xe.preventContextMenu,
        } = t;
        ((this.element = e),
          (this.drag = null),
          (this.isDestroyed = !1),
          ...
          (this._listenerOptions = ti(n)),
          (this._sourceEvents = ni(i)),
          (this._emitter = new pe()),
      ...
      _getTrackedPointerEventData(e) {
        return this.drag ? ei(e, this.drag.pointerId) : null;
      }
      _onStart(e) {
        if (
        ...
        ((this.drag = i),
          (this._eventData = { ...i, type: x.Start, srcEvent: e, target: n.target }),
  ...
  function Te(e, t = !1) {
    ...
    if (n && n !== 'none') {
      ...
      (a.includes('%') && (a = `${(parseFloat(a) / 100) * lr(e)}px`),
        l.includes('%') && (l = `${(parseFloat(l) / 100) * ar(e)}px`),
  ...
  var Pe = ce ? new DOMMatrix() : null;
  function ke(e, t = new DOMMatrix()) {
    let n = e;
    for (et(t); n; ) {
      let i = Te(n);
      if (i && (Pe.setMatrixValue(i), !Pe.isIdentity)) {
        let { transformOrigin: r } = Q(n),
          { x: s, y: o, z: a } = Wt(r);
        (a === 0
          ? Pe.setMatrixValue(`translate(${s}px,${o}px) ${Pe} translate(${s * -1}px,${o * -1}px)`)
          : Pe.setMatrixValue(
              `translate3d(${s}px,${o}px,${a}px) ${Pe} translate3d(${s * -1}px,${o * -1}px,${a * -1}px)`,
            ),
          t.preMultiplySelf(Pe));
      }
      n = n.parentElement;
    }
    return t;
  ...
  function gt(e) {
    ...
    return (
      ...
      ) || !!(Lt && a && a.indexOf('filter') > -1)
    );
  }
  function ii(e) {
    return q(e).position !== 'static' || gt(e);
  }
  function Ht(e, t = {}) {
    if (qe(e)) return e.ownerDocument.defaultView;
  ...
  function Vt(e, t = {}) {
    ...
    let r = t.position || q(e).position,
      { skipDisplayNone: s, container: o } = t;
    switch (r) {
      case 'relative':
        return e;
      case 'fixed':
        return Ht(e, { container: o, position: r, skipDisplayNone: s });
      case 'absolute': {
        let a = Ht(e, { container: o, position: r, skipDisplayNone: s });
        return ye(a) ? e.ownerDocument : a;
      }
      default:
        return null;
    }
    ...
    li = class {
      constructor(e, t) {
        ...
        ((this.sensor = e),
          ...
          (this.items = []),
          (this.isEnded = !1),
          (this._matrixCache = new si()),
          (this._clientOffsetCache = new si()));
      }
    };
  function ur(e, t, n = !1) {
    let { style: i } = e;
  ...
  var fr = { x: 0, y: 0 },
    hr = { x: 0, y: 0 };
  function mr(e, t, n = { x: 0, y: 0 }) {
    let i = oi(e) ? e : nt(e, fr),
      r = oi(t) ? t : nt(t, hr);
  ...
  var yt = ce ? dr() : null,
    ci = class {
      constructor(e, t) {
        ...
        ((this.data = {}),
          (this.element = e),
          (this.elementTransformOrigin = Wt(i.transformOrigin)),
        ...
        ((this.elementOffsetContainer = f),
          (this.dragOffsetContainer = l === o ? f : Vt(e, { container: l })));
        {
          let { width: d, height: m, x: g, y } = r;
          this.clientRect = { width: d, height: m, x: g, y };
        }
        ...
        [this.elementContainer, this.dragContainer].forEach((e) => {
          if (!this._matrixCache.isValid(e)) {
            let t = this._matrixCache.get(e) || [new DOMMatrix(), new DOMMatrix()],
              [n, i] = t;
            (ke(e, n), i.setMatrixValue(n.toString()).invertSelf(), this._matrixCache.set(e, t));
          }
        });
      }
      _updateContainerOffset() {
        ...
        if (e !== n) {
          let [a, l] = [
            ...
            let d = s.get(u) || { x: 0, y: 0 };
            if (!s.isValid(u)) {
              let m = o.get(f);
              u instanceof HTMLElement && m && !m[0].isIdentity
                ? Xt(m[0])
                  ? (yt.style.setProperty('transform', m[1].toString(), 'important'),
                    u.append(yt),
                    nt(yt, d),
                    yt.remove())
                  : (nt(u, d), (d.x -= m[0].m41), (d.y -= m[0].m42))
                : nt(u, d);
            }
            return (s.set(u, d), d);
          });
    ...
    ai = { capture: !0, passive: !0 },
    gr = { x: 0, y: 0 },
    ie = ce ? new DOMMatrix() : null,
    _t = ce ? new DOMMatrix() : null,
    ee = (function (e) {
      return (
        (e[(e.None = 0)] = 'None'),
        (e[(e.Init = 1)] = 'Init'),
    ...
    tt = { Start: 'start', Move: 'move', End: 'end' },
    it = { Immediate: 'immediate', Sampled: 'sampled' },
    ue = {
      Start: 'start',
    ...
    ui = {
      ...
      applyPosition: ({ item: e, phase: t }) => {
        let n = t === ue.End || t === ue.EndAlign,
          ...
          { x: g, y, z: S } = d,
          w = !u.isIdentity && (g !== 0 || y !== 0 || S !== 0),
          R = a.x + l.x + f.x,
          T = a.y + l.y + f.y;
        (et(ie),
          w && (S === 0 ? ie.translateSelf(-g, -y) : ie.translateSelf(-g, -y, -S)),
          n ? r.isIdentity || ie.multiplySelf(r) : o.isIdentity || ie.multiplySelf(o),
          et(_t).translateSelf(R, T),
          ie.multiplySelf(_t),
          i.isIdentity || ie.multiplySelf(i),
          w && (et(_t).translateSelf(g, y, S), ie.multiplySelf(_t)),
          u.isIdentity || ie.multiplySelf(u),
          m.isIdentity || ie.preMultiplySelf(m),
          (e.element.style.transform = `${ie}`));
      },
      computeClientRect: ({ drag: e }) => e.items[0].clientRect || null,
      positionModifiers: [],
      sensorProcessingMode: it.Sampled,
      dndGroups: void 0,
      preventClickOnEnd: !0,
    ...
    Yt = class {
      constructor(e, t = {}) {
        ...
        ((this.id = n),
          ...
          (this._modifierData = { draggable: this, drag: null, item: null, phase: tt.Start }),
          (this._onMove = this._onMove.bind(this)),
      ...
      _parseSettings(e, t = ui) {
        let {
          ...
          onStart: S = t.onStart,
          onPrepareMove: w = t.onPrepareMove,
          onMove: R = t.onMove,
          onEnd: T = t.onEnd,
          ...
          switch (n.predicateState) {
            ...
            case te.Resolved:
              this.drag &&
                ...
                this.settings.sensorProcessingMode === it.Immediate
      ...
      _prepareStart() {
        ...
        !e ||
          ...
          this._applyModifiers(tt.Start, 0, 0),
          this._emit($.PrepareStart, e, this),
      ...
      _applyStart() {
        ...
        if (!(!e || this._startPhase !== ee.FinishPrepare)) {
          ...
          for (let t of e.items)
            (t.dragContainer !== t.elementContainer && ri(t.dragContainer, t.element),
          ...
          for (let t of e.items) {
            ...
            if (cr(n, i) || (!Xt(n) && !Xt(i))) continue;
            let r = t.element.getBoundingClientRect(),
              { alignmentOffset: s } = t;
            ((s.x += pt(t.clientRect.x - r.x, 3)), (s.y += pt(t.clientRect.y - r.y, 3)));
          }
          for (let t of e.items) {
          ...
          (window.addEventListener('scroll', this._onScroll, ai),
            this._emit($.Start, e, this),
      ...
      _prepareMove() {
        ...
        let { moveEvent: t, prevMoveEvent: n } = e,
          ...
          r = t.y - n.y;
        (!i && !r) ||
          (this._applyModifiers(tt.Move, i, r),
          this._emit($.PrepareMove, e, this),
          !e.isEnded &&
      ...
      _applyMove() {
        ...
        if (!(!e || e.isEnded)) {
          ...
          (this._emit($.Move, e, this), !e.isEnded && this.settings.onMove?.(e, this));
        }
      }
      _prepareAlign() {
        let { drag: e } = this;
      ...
      stop() {
        ...
        if (
          ...
          window.removeEventListener('scroll', this._onScroll, ai),
        ...
        this._applyModifiers(tt.End, 0, 0);
        for (let n of e.items) {
          if (
            (n.elementContainer !== n.dragContainer &&
              (ri(n.elementContainer, n.element),
        ...
        for (let n of e.items)
          if (n.elementContainer !== n.dragContainer) {
            ...
            ((n.alignmentOffset.x = pt(n.clientRect.x - i.x, 3)),
              (n.alignmentOffset.y = pt(n.clientRect.y - i.y, 3)));
          }
        for (let n of e.items)
          n.elementContainer !== n.dragContainer &&
            (n.alignmentOffset.x !== 0 || n.alignmentOffset.y !== 0) &&
            this.settings.applyPosition({ phase: ue.EndAlign, draggable: this, drag: e, item: n });
        (this._emit($.End, e, this), this.settings.onEnd?.(e, this), (this.drag = null));
      ...
      align(e = !1) {
        !this.drag ||
          this.drag.isEnded ||
          (e || this.settings.sensorProcessingMode === it.Immediate
  ...
  function pr() {
    return {
      ...
      getPosition: (e) => {
        ...
        return ((zt.x = i ? i.x : 0), (zt.y = i ? i.y : 0), zt);
      },
      getClientRect: (e) => {
        let { drag: t } = e,
          n = e.getClientRect();
        ...
        ((this.name = 'autoscroll'),
          ...
          e.on($.Start, () => {
            this._autoScrollProxy ||
              ((this._autoScrollProxy = new yr(this, e)), jt.addItem(this._autoScrollProxy));
          }),
          e.on($.End, () => {
            this._autoScrollProxy &&
              (this._autoScrollProxy = (jt.removeItem(this._autoScrollProxy), null));
          }));
      }
      _parseSettings(e, t = pr()) {
        let {
          targets: n = t.targets,
  ...
  var fi = class {
    constructor() {
      ...
      c(this, 'isDestroyed');
      c(this, '_emitter');
      ((this.drag = null), (this.isDestroyed = !1), (this._emitter = new pe()));
    }
    _createDragData(e) {
  ...
  var vr = ['start', 'cancel', 'end', 'moveLeft', 'moveRight', 'moveUp', 'moveDown'];
  function vt(e, t) {
  ...
  var re = {
    ...
    mi = class extends hi {
      constructor(t, n = {}) {
        ...
        c(this, '_startPredicate');
        let {
          startPredicate: i = re.startPredicate,
          computeSpeed: r = re.computeSpeed,
          cancelOnVisibilityChange: s = re.cancelOnVisibilityChange,
          cancelOnBlur: o = re.cancelOnBlur,
          startKeys: a = re.startKeys,
          moveLeftKeys: l = re.moveLeftKeys,
          moveRightKeys: f = re.moveRightKeys,
          moveUpKeys: u = re.moveUpKeys,
          moveDownKeys: d = re.moveDownKeys,
          cancelKeys: m = re.cancelKeys,
          endKeys: g = re.endKeys,
        } = n;
        ((this.element = t),
          ...
          (this._moveKeys = new Set([...l, ...f, ...u, ...d])),
      ...
      _updateDirection() {
        let t = vt(this._moveLeftKeys, this._moveKeyTimestamps),
          n = vt(this._moveRightKeys, this._moveKeyTimestamps),
          i = vt(this._moveUpKeys, this._moveKeyTimestamps),
          r = vt(this._moveDownKeys, this._moveKeyTimestamps),
          s = t === n ? 0 : t < n ? -1 : 1,
          o = i === r ? 0 : i < r ? -1 : 1;
        if (!(s === 0 || o === 0)) {
        ...
        if (!this.drag) {
          if (this._startKeys.has(t.key)) {
            ...
            if (n) {
              ...
              ((i.type = x.Start), (i.x = n.x), (i.y = n.y), (i.srcEvent = t), this._start(i));
            }
          }
          return;
        }
      ...
      updateSettings(t) {
        ...
        if (
          ...
          vr.forEach((a, l) => {
            let f = `${a}Keys`,
              u = t[f];
            u !== void 0 && ((this[`_${f}`] = new Set(u)), l >= 3 && (n = !0));
          }),
          n)
        ) {
          let a = [
  ...
  function Ut(e, t, n, i) {
    ...
    if (!r) {
      ...
      return ((s.x = t - w.left), (s.y = n - w.top), s);
    }
    let o = ke(r),
      a = o.m11,
      l = o.m12,
      ...
      g = n - d.top,
      y = a * u - l * f;
    if (Math.abs(y) < 1e-10) return ((s.x = m), (s.y = g), s);
    let S = 1 / y;
    return ((s.x = (u * m - f * g) * S), (s.y = (-l * m + a * g) * S), s);
  }
  var br = () => {},
    ne = new Map(),
    Qt = new Set();
  ...
  var de = {
    add(e, t, n) {
      ((ne = new Map(ne)), ne.set(e, { sources: t, proxies: n, exiting: !1, done: br }), Gt());
    },
    startExiting(e, t) {
      let n = ne.get(e);
      n && ((ne = new Map(ne)), ne.set(e, { ...n, exiting: !0, done: t }), Gt());
    },
    remove(e) {
      ne.has(e) && ((ne = new Map(ne)), ne.delete(e), Gt());
    },
    subscribe(e) {
  ...
  var Sr = (e) => typeof e == 'function' && e.length === 0;
  function K(e, t) {
    return e === void 0 ? t : Sr(e) ? e() : e;
  }
  function gi(e) {
    return e.map((t) => K(t));
  }
  function pi(e) {
    let [t, n] = Y(de.getSnapshot());
    return (
      P(() => {
        let i = de.subscribe(() => {
          n(de.getSnapshot());
  ...
  function yi(e) {
    ...
    (P(() => {
      let r = t();
      if ((i(), !r || !r.proxies.length)) return;
      let { draggable: s, sources: o, proxies: a, exiting: l, done: f } = r;
  ...
  function Be(e, t) {
    ...
    if (n || i) {
      ...
      for (let f = 0; f < l; f++) if (!Be(e[f], t[f])) return !1;
      return !0;
    }
    ...
    for (let l = 0; l < o.length; l++) {
      let f = o[l];
      if (!wr.call(t, f) || !Be(e[f], t[f])) return !1;
    }
    return !0;
  }
  var bt = new Map(),
  ...
  function xi(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      let s = i.getBoundingClientRect(),
        ...
        f,
        u;
      if (i instanceof SVGSVGElement) ((f = `${s.width}px`), (u = `${s.height}px`));
      else {
        let g = parseFloat(o.width),
          y = parseFloat(o.height);
        if (!(g >= 0) || !(y >= 0)) ((f = `${s.width}px`), (u = `${s.height}px`));
        else if (o.boxSizing === 'border-box') ((f = o.width), (u = o.height));
        else {
          let S = parseFloat(o.paddingLeft) || 0,
            w = parseFloat(o.paddingRight) || 0,
    ...
    for (let n = 0; n < e.length; n++) {
      let i = St[n],
        ...
        S = s.left - y.left,
        w = s.top - y.top;
      if (Math.abs(g) < 1e-10) ((a = S), (l = w));
      else {
        let R = 1 / g;
        ((a = (m * S - d * w) * R), (l = (-u * S + f * w) * R));
      }
      ((rn[n] = a), (sn[n] = l));
    }
    for (let n = 0; n < e.length; n++) {
  ...
  function wi(e, t) {
    if (Fe) return () => null;
    let n = M(() => (Array.isArray(e) ? gi(e) : (K(e) ?? [])).filter((p) => !!p)),
      i = M(() => K(t)),
      r = M(() => i()?.id),
      s = M(() => i()?.dndObserver),
      o = M(() => {
      ...
      y = l(),
      S = o(),
      w = i()?.dragPreviewContainer,
      R = i()?.dragPreviewExitTimeout;
    P(() => {
      let p = i();
      ((S = o()), (w = p?.dragPreviewContainer), (R = p?.dragPreviewExitTimeout));
    });
    let T = () => {
        d && (d.destroy(), (d = null), (g = void 0), u(null));
      },
      I = () => {
        mn(() => {
          T();
          ...
          let _ = G(o),
            ...
            D = new Yt(p, {
              ...
              elements(B) {
                let Ae = S,
                  V = (Ae?.elements || (() => null))(B);
                if (!Ae?.dragPreview || !V || V.length === 0) return V;
                let se = xi(V);
                de.add(B.draggable, V, se);
                let we = () => {
                    let z = R || 0;
                    if (z > 0) {
                      for (let xt of se) xt.dataset.exiting = 'true';
                      let U = !1,
                        J = () => {
                          U ||
                            ((U = !0),
                            clearTimeout(Ee),
                            de.remove(B.draggable),
                            setTimeout(() => {
                              for (let xt of se) xt.remove();
                            }, 0));
                        },
                        Ee = setTimeout(J, z);
                      de.startExiting(B.draggable, J);
                    } else
                      (de.remove(B.draggable),
                        setTimeout(() => {
                          for (let U of se) U.remove();
                        }, 0));
                    (B.draggable.off('end', X), B.draggable.off('destroy', he));
                  },
                  X = B.draggable.on('end', we),
                  he = B.draggable.on('destroy', we);
                return se;
              },
              ...(fe
                ? {
                    container: () => {
                      let B = w;
                      return (typeof B == 'function' ? B() : B) || document.body;
                    },
                  }
                : {}),
            }),
            j = G(l);
          (j?.addDraggables([D]), (d = D), (m = W), (g = _), (y = j), u(D));
        });
      };
    return (
      P(() => {
        ...
        (p.length !== _.sensors.length || p.some((W) => !_.sensors.includes(W))) && I();
      }),
      P(() => {
        if (!d) return;
        let _ = r();
      ...
      P(() => {
        ...
        if (y === p) return;
        let _ = d;
        (_ && (y?.removeDraggables([_]), p?.addDraggables([_])), (y = p));
      }),
      P(() => {
        let p = d;
        if (!p) return;
        ...
        if (g) {
          let D = { ...g },
            j = { ..._ };
          ((D.elements === j.elements || (D.dragPreview && j.dragPreview)) &&
            (delete D.elements, delete j.elements),
            (W = !Be(D, j)));
        } else W = !0;
        if (!W) return;
        let fe = p._parseSettings(_);
        if (
          (p.updateSettings({
            ...fe,
          ...
          let D = _?.dndGroups !== g.dndGroups,
            j = _?.computeClientRect !== g.computeClientRect;
          (D && y?.clearTargets(p), (D || j) && y?.detectCollisions(p));
        }
        g = _;
      }),
      N(T),
  ...
  function Ei(e, t) {
    ...
    return (
      ...
      P(() => {
        ...
        if (!o) return;
        let a = i();
        Be(r, a) || (o.updateSettings(o._parseSettings(a)), (r = a));
      }),
      n
    );
  }
  function Di(e, t = !1) {
    ...
    return (
      P(() => {
        ...
        N(() => {
          (a.off($.Start, l), f && a.off($.Move, f), a.off($.End, u));
        });
      }),
      M(() => (s(), i()))
    );
  ...
  var Er = ct(
    ...
    Dr = ct('<div class=preview-content>PREVIEW'),
    Cr = ct('<div class=transform-outer><div class=transform-inner><div class=scroll-content>'),
    Mr = 0;
  function Or(e) {
    let t = null,
      [n, i] = Mi(),
      ...
      o = Ei(
        wi([n, r], {
          ...
          onEnd: (l) => {
            let f = l.items[0];
            if (!t || !f) return;
            let u = Ut(t, f.clientRect.x, f.clientRect.y),
              d = (getComputedStyle(t).translate || '').split(' '),
              m = (parseFloat(d[0]) || 0) + u.x,
              g = (parseFloat(d[1]) || 0) + u.y;
            ((t.style.translate = `${m}px ${g}px`), (t.style.zIndex = String(++Mr)));
          },
        }),
        {
          targets: () => {
            let l = e.getScrollContainer();
            return l ? [{ element: l, axis: 'y', padding: { top: 1 / 0, bottom: 1 / 0 } }] : [];
          },
        },
      ),
      a = Di(o);
    return [
      (() => {
        ...
        return (
          ...
          ge(() => wn(l, `card draggable ${a() ? 'dragging' : ''}`)),
          l
        );
      })(),
      Ie(yi, {
  ...
  function Pr() {
    ...
    return (() => {
      ...
      return (
        kt((r) => (e = r), n),
        He(i, Ie(Tt, { each: Tr, children: () => Ie(Or, { getScrollContainer: () => e }) })),
        t
      );
    })();
  }
  var Oi = document.getElementById('root');
  if (!Oi) throw new Error('Failed to find the root element');
  xn(() => Ie(Pr, {}), Oi);
})();
