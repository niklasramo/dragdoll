'use strict';
var SolidExample_009_draggable_multiple_elements = (() => {
  var yn = Object.defineProperty;
  var vn = (e, t, n) =>
    t in e ? yn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n);
  var u = (e, t, n) => vn(e, typeof t != 'symbol' ? t + '' : t, n);
  var E = {
    context: void 0,
    registry: void 0,
    effects: void 0,
  ...
  function fe(e, t) {
    let n = S,
      ...
      s = e.length === 0,
      i = t === void 0 ? r : t,
      o = s ? Et : { owned: null, cleanups: null, context: i ? i.context : null, owner: i },
      a = s ? e : () => e(() => I(() => Z(o)));
    ((v = o), (S = null));
    try {
      return U(a, !0);
  ...
  function P(e, t, n) {
    ...
    return (
      ...
      ge && h && h.running ? ((r.tState = $), C.push(r)) : pe(r),
      Ot.bind(r)
    );
  }
  function Dt(e) {
  ...
  function Ot() {
    ...
    if (this.sources && (e ? this.tState : this.state))
      if ((e ? this.tState : this.state) === $) pe(this);
      else {
        let t = C;
        ((C = null), U(() => ke(this), !1), (C = t));
      }
    if (S) {
        ...
        U(() => {
          for (let s = 0; s < e.observers.length; s += 1) {
            let i = e.observers[s],
              o = h && h.running;
            (o && h.disposed.has(i)) ||
              ((o ? !i.tState : !i.state) && (i.pure ? C.push(i) : L.push(i), i.observers && kt(i)),
              o ? (i.tState = $) : (i.state = $));
          }
  ...
  function pe(e) {
    ...
    Z(e);
    let t = Te;
    (bt(e, h && h.running && h.sources.has(e) ? e.tValue : e.value, t),
      h &&
        !h.running &&
        h.sources.has(e) &&
        queueMicrotask(() => {
          U(() => {
            (h && (h.running = !0), (S = v = e), bt(e, e.tValue, t), (S = v = null));
          }, !1);
        }));
  }
  function bt(e, t, n) {
    ...
    try {
      ...
      return (
        e.pure &&
          (h && h.running
            ? ((e.tState = $), e.tOwned && e.tOwned.forEach(Z), (e.tOwned = void 0))
            : ((e.state = $), e.owned && e.owned.forEach(Z), (e.owned = null))),
        (e.updatedAt = n + 1),
        Ue(o)
      );
    } finally {
  ...
  function We(e, t, n, r = $, s) {
    ...
    if (
      ...
      i.fn = (m) => (a(), h && h.running ? (c || (c = oe.factory(o, d)), c.track(m)) : f.track(m));
    }
    return i;
  }
  function me(e) {
    ...
    for (let r = n.length - 1; r >= 0; r--) {
      ...
      if ((t ? e.tState : e.state) === $) pe(e);
      else if ((t ? e.tState : e.state) === he) {
        let s = C;
        ((C = null), U(() => ke(e, n[0]), !1), (C = s));
      }
    }
  }
  function U(e, t) {
    ...
    try {
      ...
      (n || (L = null), (C = null), Ue(r));
    }
  }
  function Dn(e) {
    if ((C && (ge && h && h.running ? Cn(C) : Pt(C), (C = null)), e)) return;
    let t;
    if (h) {
      if (!h.promises.size && !h.queue.size) {
        ...
        ((h.running = !1), h.effects.push.apply(h.effects, L), (L = null), _t(!0));
        return;
      }
    }
    let n = L;
    ((L = null), n.length && U(() => xt(n), !1), t && t());
  }
  function Pt(e) {
  ...
  function ke(e, t) {
    ...
    for (let r = 0; r < e.sources.length; r += 1) {
      ...
      if (s.sources) {
        ...
        i === $ ? s !== t && (!s.updatedAt || s.updatedAt < Te) && me(s) : i === he && ke(s, t);
      }
    }
  }
  function kt(e) {
  ...
  function Pn(e, t) {
    return function (r) {
      ...
      return (
        ae(
          () => (s = I(() => ((v.context = { ...v.context, [e]: r.value }), En(() => r.children)))),
          void 0,
        ),
        s
      );
    ...
    return (
      ...
      () => {
        ...
        return (
          l[wn],
          I(() => {
            let p, b, w, D, T, x, M, g, y;
            if (f === 0)
              (o !== 0 && (wt(i), (i = []), (r = []), (s = []), (o = 0), a && (a = [])),
                n.fallback &&
                  ((r = [kn]), (s[0] = fe((R) => ((i[0] = R), n.fallback()))), (o = 1)));
            else if (o === 0) {
              ...
              for (M = o - 1, g = f - 1; M >= x && g >= x && r[M] === l[g]; M--, g--)
                ((w[g] = s[M]), (D[g] = i[M]), a && (T[g] = a[M]));
              for (p = new Map(), b = new Array(g + 1), d = g; d >= x; d--)
                ((y = l[d]), (c = p.get(y)), (b[d] = c === void 0 ? -1 : c), p.set(y, d));
              for (c = x; c <= M; c++)
                ((y = r[c]),
                  (d = p.get(y)),
                  d !== void 0 && d !== -1
                    ? ((w[d] = s[c]), (D[d] = i[c]), a && (T[d] = a[c]), (d = b[d]), p.set(y, d))
                    : i[c]());
              for (d = x; d < f; d++)
                d in w
                  ? ((s[d] = w[d]), (i[d] = D[d]), a && ((a[d] = T[d]), a[d](d)))
                  : (s[d] = fe(m));
  ...
  function ze(e) {
    ...
    return P(Tn(() => e.each, e.children, t || void 0));
  }
  var In = [
      'allowfullscreen',
      'async',
  ...
  function Ae(e, t, n, r, s) {
    ...
    if (((e = (a && n[0] && n[0].parentNode) || e), o === 'string' || o === 'number')) {
      ...
      if (Array.isArray(t)) {
        let l = [],
          f = n && Array.isArray(n);
        if (Ge(l, t, n, s)) return (ae(() => (n = Ae(e, l, n, r, !0))), () => n);
        if (i) {
  ...
  var ve = {
    add(e, t, n) {
      ((N = new Map(N)), N.set(e, { sources: t, proxies: n, exiting: !1, done: $n }), Qe());
    },
    startExiting(e, t) {
      let n = N.get(e);
      n && ((N = new Map(N)), N.set(e, { ...n, exiting: !0, done: t }), Qe());
    },
    remove(e) {
      N.has(e) && ((N = new Map(N)), N.delete(e), Qe());
    },
    subscribe(e) {
  ...
  var _ = { Start: 'start', Move: 'move', Cancel: 'cancel', End: 'end', Destroy: 'destroy' };
  var Nt = new WeakMap();
  function B(e) {
    let t = Nt.get(e)?.deref();
    return (t || ((t = window.getComputedStyle(e, null)), Nt.set(e, new WeakRef(t))), t);
  }
  var Q = typeof window < 'u' && window.document !== void 0,
    Bt = Q && 'ontouchstart' in window,
    Ht = Q && !!window.PointerEvent;
  Q &&
    navigator.vendor &&
  ...
  function qt(e) {
    return e === 'auto' || e === void 0 ? (Ht ? 'pointer' : Bt ? 'touch' : 'mouse') : e;
  }
  var te = {
      pointer: {
        start: 'pointerdown',
    ...
    be = class {
      ...
      _getTrackedPointerEventData(e) {
        return this.drag ? Vt(e, this.drag.pointerId) : null;
      }
      _onStart(e) {
        if (
        ...
        ((this.drag = r),
          (this._eventData = { ...r, type: _.Start, srcEvent: e, target: n.target }),
      ...
      destroy() {
        this.isDestroyed ||
          ...
          this._removeClickBlocker?.(),
          this.cancel(),
          this._emitter.emit(_.Destroy, { type: _.Destroy }),
          this._emitter.off(),
          this.element.removeEventListener(
            te[this._sourceEvents].start,
            this._onStart,
  ...
  function re(e, t = !1) {
    let { translate: n, rotate: r, scale: s, transform: i } = B(e),
      o = '';
    if (n && n !== 'none') {
  ...
  function Y(e, t) {
    ...
    let n = Yt.get(e)?.deref();
    return (n || ((n = window.getComputedStyle(e, null)), Yt.set(e, new WeakRef(n))), n);
  }
  ...
  function Xt(e) {
    return Y(e).position !== 'static' || Ie(e);
  }
  function Wt(e) {
    return e instanceof HTMLHtmlElement;
  }
  function nt(e, t = {}) {
    if (Wt(e)) return e.ownerDocument.defaultView;
  ...
  var Gn = { x: 0, y: 0 },
    Qn = { x: 0, y: 0 };
  function Jn(e, t, n = { x: 0, y: 0 }) {
    let r = Qt(e) ? e : De(e, Gn),
      s = Qt(t) ? t : De(t, Qn);
  ...
  var Fe = Q ? zn() : null,
    en = class {
      constructor(e, t) {
        ...
        ((this.elementOffsetContainer = f),
          (this.dragOffsetContainer = l === o ? f : rt(e, { container: l })));
        {
          let { width: d, height: m, x: p, y: b } = s;
          this.clientRect = { width: d, height: m, x: p, y: b };
        }
    ...
    Zn = { x: 0, y: 0 },
    X = Q ? new DOMMatrix() : null,
    Ke = Q ? new DOMMatrix() : null,
    H = (function (e) {
      return (
        (e[(e.None = 0)] = 'None'),
        (e[(e.Init = 1)] = 'Init'),
    ...
    tn = {
      ...
      applyPosition: ({ item: e, phase: t }) => {
        let n = t === J.End || t === J.EndAlign,
          ...
          { x: p, y: b, z: w } = d,
          D = !c.isIdentity && (p !== 0 || b !== 0 || w !== 0),
          T = a.x + l.x + f.x,
          x = a.y + l.y + f.y;
        (Se(X),
          D && (w === 0 ? X.translateSelf(-p, -b) : X.translateSelf(-p, -b, -w)),
          n ? s.isIdentity || X.multiplySelf(s) : o.isIdentity || X.multiplySelf(o),
          Se(Ke).translateSelf(T, x),
          X.multiplySelf(Ke),
          r.isIdentity || X.multiplySelf(r),
          D && (Se(Ke).translateSelf(p, b, w), X.multiplySelf(Ke)),
          c.isIdentity || X.multiplySelf(c),
          m.isIdentity || X.preMultiplySelf(m),
          (e.element.style.transform = `${X}`));
      },
    ...
    it = class {
      ...
      _parseSettings(e, t = tn) {
        let {
          ...
          onStart: w = t.onStart,
          onPrepareMove: D = t.onPrepareMove,
          onMove: T = t.onMove,
          onEnd: x = t.onEnd,
          onDestroy: M = t.onDestroy,
        } = e || {};
        return {
          container: n,
          startPredicate: r,
      ...
      _onEnd(e, t) {
        ...
        n &&
          (this.drag
            ? n.predicateState === V.Resolved &&
              ((this.drag.endEvent = { ...e }),
              this._sensorData.forEach((r) => {
                ((r.predicateState = V.Pending), (r.predicateEvent = null));
              }),
              this.stop())
            : ((n.predicateState = V.Pending), (n.predicateEvent = null)));
      }
      _prepareStart() {
        let e = this.drag;
        !e ||
          ...
          this._emit(ie.PrepareStart, e, this),
      ...
      _applyStart() {
        ...
        if (!(!e || this._startPhase !== H.FinishPrepare)) {
          ...
          for (let t of e.items)
            (t.dragContainer !== t.elementContainer && zt(t.dragContainer, t.element),
      ...
      _prepareMove() {
        ...
        (!r && !s) ||
          ...
          this._emit(ie.PrepareMove, e, this),
          !e.isEnded &&
      ...
      _applyMove() {
        ...
        if (!(!e || e.isEnded)) {
          ...
          (this._emit(ie.Move, e, this), !e.isEnded && this.settings.onMove?.(e, this));
        }
      }
      _prepareAlign() {
        let { drag: e } = this;
      ...
      resolveStartPredicate(e, t) {
        ...
        n.predicateState === V.Pending &&
          ...
          this._sensorData.forEach((s, i) => {
            i !== e && ((s.predicateState = V.Rejected), (s.predicateEvent = null));
          }),
          this.settings.sensorProcessingMode === Ce.Immediate
      ...
      rejectStartPredicate(e) {
        let t = this._sensorData.get(e);
        t?.predicateState === V.Pending &&
          ((t.predicateState = V.Rejected), (t.predicateEvent = null));
      }
      stop() {
        let e = this.drag;
        if (!e || e.isEnded) return;
        ...
        for (let n of e.items) {
          if (
            (n.elementContainer !== n.dragContainer &&
              (zt(n.elementContainer, n.element),
        ...
        (this._emit(ie.End, e, this), this.settings.onEnd?.(e, this), (this.drag = null));
  ...
  var W = {
    ...
    an = class extends on {
      constructor(t, n = {}) {
        ...
        u(this, '_startPredicate');
        let {
          startPredicate: r = W.startPredicate,
          computeSpeed: s = W.computeSpeed,
          cancelOnVisibilityChange: i = W.cancelOnVisibilityChange,
          cancelOnBlur: o = W.cancelOnBlur,
          startKeys: a = W.startKeys,
          moveLeftKeys: l = W.moveLeftKeys,
          moveRightKeys: f = W.moveRightKeys,
          moveUpKeys: c = W.moveUpKeys,
          moveDownKeys: d = W.moveDownKeys,
          cancelKeys: m = W.cancelKeys,
          endKeys: p = W.endKeys,
        } = n;
        ((this.element = t),
        ...
        if (!this.drag) {
          if (this._startKeys.has(t.key)) {
            ...
            if (n) {
              ...
              ((r.type = _.Start), (r.x = n.x), (r.y = n.y), (r.srcEvent = t), this._start(r));
            }
          }
          return;
        }
  ...
  function cn(e) {
    ...
    for (let n = 0; n < e.length; n++) {
      let r = He[n],
        ...
        w = i.left - b.left,
        D = i.top - b.top;
      if (Math.abs(p) < 1e-10) ((a = w), (l = D));
      else {
        let T = 1 / p;
        ((a = (m * w - d * D) * T), (l = (-c * w + f * D) * T));
      }
      ((ut[n] = a), (ft[n] = l));
    }
    for (let n = 0; n < e.length; n++) {
  ...
  function dn(e, t) {
    if (ce) return () => null;
    let n = P(() => (Array.isArray(e) ? Ft(e) : (G(e) ?? [])).filter((g) => !!g)),
      r = P(() => G(t)),
      s = P(() => r()?.id),
      i = P(() => r()?.dndObserver),
      o = P(() => {
      ...
      b = l(),
      w = o(),
      D = r()?.dragPreviewContainer,
      T = r()?.dragPreviewExitTimeout;
    K(() => {
      let g = r();
      ((w = o()), (D = g?.dragPreviewContainer), (T = g?.dragPreviewExitTimeout));
    });
    let x = () => {
      ...
      M = () => {
        Dt(() => {
          ...
          let y = I(o),
                      ...
                      let Me = !1,
                        pt = () => {
                          Me ||
                            ((Me = !0),
                            clearTimeout(pn),
                            ve.remove(F.draggable),
                            setTimeout(() => {
                              for (let Ve of ue) Ve.remove();
                            }, 0));
                        },
                        pn = setTimeout(pt, gt);
                      ve.startExiting(F.draggable, pt);
                    } else
                      (ve.remove(F.draggable),
                        setTimeout(() => {
                          for (let Me of ue) Me.remove();
                        }, 0));
                    (F.draggable.off('end', mn), F.draggable.off('destroy', gn));
                  },
                  mn = F.draggable.on('end', mt),
                  gn = F.draggable.on('destroy', mt);
                return ue;
              },
              ...(Oe
                ? {
            ...
            j = I(l);
          (j?.addDraggables([A]), (d = A), (m = R), (p = y), (b = j), c(A));
        });
      };
    return (
      K(() => {
        ...
        (g.length !== y.sensors.length || g.some((R) => !y.sensors.includes(R))) && M();
      }),
      K(() => {
        if (!d) return;
        let y = s();
      ...
      K(() => {
        ...
        if (b === g) return;
        let y = d;
        (y && (b?.removeDraggables([y]), g?.addDraggables([y])), (b = g));
      }),
      K(() => {
        let g = d;
        if (!g) return;
        ...
        if (p) {
          let A = { ...p },
            j = { ...y };
          ((A.elements === j.elements || (A.dragPreview && j.dragPreview)) &&
            (delete A.elements, delete j.elements),
            (R = !$e(A, j)));
        } else R = !0;
        if (!R) return;
        ...
        if (
          ...
          let A = y?.dndGroups !== p.dndGroups,
            j = y?.computeClientRect !== p.computeClientRect;
          (A && b?.clearTargets(g), (A || j) && b?.detectCollisions(g));
        }
        p = y;
      }),
      q(x),
  ...
  var nr = It(
    '<div class="card draggable"tabindex=0><svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 512 512"><path d="M278.6 9.4c-12.5-12.5-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l9.4-9.4L224 224l-114.7 0 9.4-9.4c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-64 64c-12.5 12.5-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-9.4-9.4L224 288l0 114.7-9.4-9.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l64 64c12.5 12.5 32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-9.4 9.4L288 288l114.7 0-9.4 9.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l64-64c12.5-12.5 12.5-32.8 0-45.3l-64-64c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l9.4 9.4L288 224l0-114.7 9.4 9.4c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3l-64-64z">',
  );
  function rr(e) {
    let t = null,
      [n, r] = fn(),
      [s, i] = un();
    dn([n, s], {
      elements: () => Array.from(e.elementRefsMap.values()).filter((l) => !!l),
      startPredicate: () => !t?.classList.contains('dragging'),
      onStart: (l) => {
        l.items.forEach((f) => {
          f.element.classList.add('dragging');
        });
      },
      onEnd: (l) => {
        l.items.forEach((f) => {
    ...
    let a = (l) => {
      ((t = l), r(l), i(l), e.elementRefsMap.set(e.id, l));
    };
    return (() => {
      var l = nr();
      return (Rt(a, l), l);
  ...
  function ir() {
    let e = new Map();
    return ye(ze, { each: sr, children: (t) => ye(rr, { id: t, elementRefsMap: e }) });
  }
