(function (factory) {
    ...
    v = class {
      ...
      on(t$3, n$4, e$3) {
        ...
        s$2 ||
          ...
          i$3.set(t$3, s$2));
        let o$2 = s$2.m;
        if (((e$3 = e$3 === r$1 ? this.getId(n$4) : e$3), o$2.has(e$3)))
          switch (this.dedupe) {
            case E$1.THROW:
      ...
      once(t$3, n$4, e$3) {
        let i$3 = 0;
        return (
          (e$3 = e$3 === r$1 ? this.getId(n$4) : e$3),
          this.on(
            t$3,
            (...s$2) => {
    ...
    o$1 = class {
      ...
      _processQueue(...e$3) {
        ...
        let s$2 = 0,
          ...
          c$2;
        for (; s$2 < r$2; s$2++)
          for (n$4 = t$3[s$2], a$2 = 0, c$2 = n$4.length; a$2 < c$2; a$2++) n$4[a$2](...e$3);
        t$3.length = 0;
      }
    };
  function u$2(i$3 = 60) {
  ...
  var l$2 = class extends o$1 {
    ...
    set phases(e$3) {
      ((this._phases = e$3),
        e$3.length ? ((this._empty = !1), this._request()) : (this._empty = !0));
    }
    get paused() {
      return this._paused;
    }
    ...
    set requestFrame(e$3) {
      this._requestFrame !== e$3 &&
        ((this._requestFrame = e$3), this._cancelFrame && (this._cancel(), this._request()));
    }
    tick(...e$3) {
      if (
  ...
  const e$1 = typeof window < `u` && window.document !== void 0,
    t$1 = e$1 && `ontouchstart` in window,
    n$3 = e$1 && !!window.PointerEvent;
  e$1 &&
    navigator.vendor &&
  ...
  function t$2(t$3) {
    ...
    return (
      n$4 || ((n$4 = window.getComputedStyle(t$3, null)), e$2.set(t$3, new WeakRef(n$4))),
      n$4
    );
  }
  ...
  function getStyle(e$3, t$3) {
    ...
    return (
      C$1 ||
        ((C$1 = window.getComputedStyle(e$3, null)),
        STYLE_DECLARATION_CACHE.set(e$3, new WeakRef(C$1))),
      C$1
    );
  }
  ...
  function getContainingBlock(e$3, t$3 = {}) {
    ...
    const n$4 = t$3.position || getStyle(e$3).position,
      { skipDisplayNone: i$3, container: o$2 } = t$3;
    switch (n$4) {
      case 'static':
      case 'relative':
      case 'sticky':
  ...
  function getOffsetContainer(n$4, t$3 = {}) {
    ...
    const e$3 = t$3.position || getStyle(n$4).position,
      { skipDisplayNone: s$2, container: r$2 } = t$3;
    switch (e$3) {
      case 'relative':
        return n$4;
      case 'fixed':
        return getContainingBlock(n$4, {
          container: r$2,
          position: e$3,
          skipDisplayNone: s$2,
        });
  ...
  function l$1(
    ...
    if (e$3 instanceof Document)
      return ((t$3.x = window.scrollX * -1), (t$3.y = window.scrollY * -1), t$3);
    let { x: n$4, y: r$2 } = e$3.getBoundingClientRect(),
      a$2 = t$2(e$3);
    return (
      (t$3.x = n$4 + (parseFloat(a$2.borderLeftWidth) || 0)),
      (t$3.y = r$2 + (parseFloat(a$2.borderTopWidth) || 0)),
      t$3
    );
  }
  function u$1(e$3) {
  ...
  function p(
    ...
    let r$2 = u$1(e$3) ? e$3 : l$1(e$3, d),
      i$3 = u$1(t$3) ? t$3 : l$1(t$3, f);
    return ((n$4.x = i$3.x - r$2.x), (n$4.y = i$3.y - r$2.y), n$4);
  }
  function m(e$3) {
    let t$3 = t$2(e$3),
      n$4 = parseFloat(t$3.height) || 0;
    return t$3.boxSizing === `border-box`
      ? n$4
      : ((n$4 += parseFloat(t$3.borderTopWidth) || 0),
        (n$4 += parseFloat(t$3.borderBottomWidth) || 0),
        (n$4 += parseFloat(t$3.paddingTop) || 0),
        (n$4 += parseFloat(t$3.paddingBottom) || 0),
        e$3 instanceof HTMLElement && (n$4 += e$3.offsetHeight - e$3.clientHeight),
        n$4);
  }
  function h(e$3) {
    let t$3 = t$2(e$3),
      n$4 = parseFloat(t$3.width) || 0;
    return t$3.boxSizing === `border-box`
      ? n$4
      : ((n$4 += parseFloat(t$3.borderLeftWidth) || 0),
        (n$4 += parseFloat(t$3.borderRightWidth) || 0),
        (n$4 += parseFloat(t$3.paddingLeft) || 0),
        (n$4 += parseFloat(t$3.paddingRight) || 0),
        e$3 instanceof HTMLElement && (n$4 += e$3.offsetWidth - e$3.clientWidth),
        n$4);
  }
  function g(e$3, t$3 = !1) {
    let { translate: n$4, rotate: r$2, scale: a$2, transform: o$2 } = t$2(e$3),
      s$2 = ``;
    if (n$4 && n$4 !== `none`) {
      let [t$4 = `0px`, r$3 = `0px`, i$3] = n$4.split(` `);
      (t$4.includes(`%`) && (t$4 = `${(parseFloat(t$4) / 100) * h(e$3)}px`),
        r$3.includes(`%`) && (r$3 = `${(parseFloat(r$3) / 100) * m(e$3)}px`),
        i$3 ? (s$2 += `translate3d(${t$4},${r$3},${i$3})`) : (s$2 += `translate(${t$4},${r$3})`));
    }
    if (r$2 && r$2 !== `none`) {
      let e$4 = r$2.split(` `);
  ...
  function b(e$3, t$3 = new DOMMatrix()) {
    ...
    for (v$1(t$3); n$4; ) {
      ...
      if (e$4 && (y.setMatrixValue(e$4), !y.isIdentity)) {
        let { transformOrigin: e$5 } = t$2(n$4),
          { x: r$2, y: a$2, z: o$2 } = _(e$5);
        (o$2 === 0
          ? y.setMatrixValue(
              `translate(${r$2}px,${a$2}px) ${y} translate(${r$2 * -1}px,${a$2 * -1}px)`,
            )
          : y.setMatrixValue(
              `translate3d(${r$2}px,${a$2}px,${o$2}px) ${y} translate3d(${r$2 * -1}px,${a$2 * -1}px,${o$2 * -1}px)`,
            ),
  ...
  function S() {
    ...
    return (
      e$3.classList.add(`dragdoll-measure`),
      x(
        e$3,
        {
          display: `block`,
  ...
  var T = class {
    constructor(e$3, t$3) {
      ...
      let r$2 = t$2(e$3),
        a$2 = e$3.getBoundingClientRect(),
        s$2 = g(e$3, !0);
      ((this.data = {}),
        (this.element = e$3),
        (this.elementTransformOrigin = _(r$2.transformOrigin)),
        (this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$2 + r$2.transform)),
        ...
        (this._matrixCache = n$4._matrixCache),
        (this._clientOffsetCache = n$4._clientOffsetCache));
      ...
      if (((this.dragContainer = l$3), c$2 !== l$3)) {
        ...
        if (e$4 !== `fixed` && e$4 !== `absolute`)
          throw Error(
            `Dragged element has "${e$4}" position, but only "fixed" or "absolute" are allowed when using a custom drag container.`,
          );
      }
      let u$3 = getOffsetContainer(e$3) || e$3;
      ((this.elementOffsetContainer = u$3),
        (this.dragOffsetContainer =
          l$3 === c$2 ? u$3 : getOffsetContainer(e$3, { container: l$3 })));
      {
      ...
      if (this.frozenStyles) {
        let t$4 = {};
        for (let n$5 in this.frozenStyles) t$4[n$5] = e$3.style[n$5];
    ...
    _updateContainerMatrices() {
      [this.elementContainer, this.dragContainer].forEach((e$3) => {
        if (!this._matrixCache.isValid(e$3)) {
          let t$3 = this._matrixCache.get(e$3) || [new DOMMatrix(), new DOMMatrix()],
            [n$4, r$2] = t$3;
          (b(e$3, n$4),
            r$2.setMatrixValue(n$4.toString()).invertSelf(),
            this._matrixCache.set(e$3, t$3));
        }
      });
    }
    _updateContainerOffset() {
      let {
        elementOffsetContainer: e$3,
        elementContainer: t$3,
        dragOffsetContainer: n$4,
        dragContainer: r$2,
        containerOffset: i$3,
        _clientOffsetCache: a$2,
        _matrixCache: o$2,
      } = this;
      if (e$3 !== n$4) {
        let [s$2, c$2] = [
          ...
          if (!a$2.isValid(t$4)) {
            let r$3 = o$2.get(e$4);
            t$4 instanceof HTMLElement && r$3 && !r$3[0].isIdentity
              ? C(r$3[0])
                ? (w.style.setProperty(`transform`, r$3[1].toString(), `important`),
                  t$4.append(w),
                  l$1(w, n$5),
                  w.remove())
                : (l$1(t$4, n$5), (n$5.x -= r$3[0].m41), (n$5.y -= r$3[0].m42))
              : l$1(t$4, n$5);
          }
  ...
  function E(e$3, t$3, n$4 = null) {
    if (`moveBefore` in e$3 && e$3.isConnected === t$3.isConnected)
      try {
        e$3.moveBefore(t$3, n$4);
        return;
      } catch {}
    let r$2 = document.activeElement,
      i$3 = t$3.contains(r$2);
    (e$3.insertBefore(t$3, n$4),
      i$3 &&
        document.activeElement !== r$2 &&
        r$2 instanceof HTMLElement &&
        r$2.focus({ preventScroll: !0 }));
  }
  ...
  function O(e$3, t$3) {
    return e$3.isIdentity && t$3.isIdentity
      ? !0
      : e$3.is2D && t$3.is2D
        ? e$3.a === t$3.a &&
          e$3.b === t$3.b &&
  ...
  const k = {
    ...
    j = e$1 ? new DOMMatrix() : null,
    M = e$1 ? new DOMMatrix() : null;
  var N = (function (e$3) {
      return (
        (e$3[(e$3.None = 0)] = `None`),
        (e$3[(e$3.Init = 1)] = `Init`),
        (e$3[(e$3.Prepare = 2)] = `Prepare`),
        (e$3[(e$3.FinishPrepare = 3)] = `FinishPrepare`),
        (e$3[(e$3.Apply = 4)] = `Apply`),
        (e$3[(e$3.FinishApply = 5)] = `FinishApply`),
        e$3
      );
    })(N || {}),
    P = (function (e$3) {
      return (
        (e$3[(e$3.Pending = 0)] = `Pending`),
        (e$3[(e$3.Resolved = 1)] = `Resolved`),
        (e$3[(e$3.Rejected = 2)] = `Rejected`),
        e$3
      );
    })(P || {});
  const F = {
    ...
    R = {
      ...
      applyPosition: ({ item: e$3, phase: t$3 }) => {
        let n$4 = t$3 === I.End || t$3 === I.EndAlign,
          [r$2, i$3] = e$3.getContainerMatrix(),
          [a$2, o$2] = e$3.getDragContainerMatrix(),
          {
            position: s$2,
            alignmentOffset: c$2,
            containerOffset: l$3,
        ...
        (v$1(j),
          ...
          n$4 ? i$3.isIdentity || j.multiplySelf(i$3) : o$2.isIdentity || j.multiplySelf(o$2),
          v$1(M).translateSelf(_$2, y$1),
          j.multiplySelf(M),
          r$2.isIdentity || j.multiplySelf(r$2),
  ...
  var z = class {
    constructor(t$3, n$4 = {}) {
      ...
      ((this.id = r$2),
        (this.sensors = t$3),
        (this.settings = this._parseSettings(i$3)),
        (this.plugins = {}),
        (this.drag = null),
        (this.isDestroyed = !1),
        ...
        this.sensors.forEach((t$4) => {
          ...
          (t$4.on(e.Start, n$5, n$5),
            t$4.on(e.Move, n$5, n$5),
            t$4.on(e.Cancel, r$3, r$3),
            t$4.on(e.End, r$3, r$3),
            t$4.on(e.Destroy, r$3, r$3));
        }));
    }
    _parseSettings(e$3, t$3 = R) {
      let {
        container: n$4 = t$3.container,
        startPredicate: r$2 = t$3.startPredicate,
        elements: i$3 = t$3.elements,
        frozenStyles: a$2 = t$3.frozenStyles,
        positionModifiers: o$2 = t$3.positionModifiers,
      ...
      if (i$3)
        switch (i$3.predicateState) {
          case P.Pending: {
            ...
            t$3 === !0
              ? this.resolveStartPredicate(r$2)
              : t$3 === !1 && this.rejectStartPredicate(r$2);
            break;
          }
          case P.Resolved:
            this.drag &&
              ((this.drag.moveEvent = e$3),
              n$2.once(t.read, this._prepareMove, this._moveId),
              n$2.once(t.write, this._applyMove, this._moveId));
            break;
        }
    }
    _onScroll() {
    ...
    _onEnd(e$3, t$3) {
      ...
      n$4 &&
        (this.drag
          ? n$4.predicateState === P.Resolved &&
            ((this.drag.endEvent = e$3),
            this._sensorData.forEach((e$4) => {
              ((e$4.predicateState = P.Pending), (e$4.predicateEvent = null));
            }),
            this.stop())
          : ((n$4.predicateState = P.Pending), (n$4.predicateEvent = null)));
    }
    _prepareStart() {
      let e$3 = this.drag;
      e$3 &&
        ...
        ).map((e$4) => new T(e$4, this))),
        this._applyModifiers(F.Start, 0, 0),
        this._emit(L.PrepareStart, e$3.startEvent),
        this.settings.onPrepareStart?.(e$3, this),
    ...
    _applyStart() {
      ...
      if (e$3) {
        ...
        for (let t$3 of e$3.items) {
          let e$4 = t$3.getContainerMatrix()[0],
            n$4 = t$3.getDragContainerMatrix()[0];
          if (O(e$4, n$4) || (!C(e$4) && !C(n$4))) continue;
          let r$2 = t$3.element.getBoundingClientRect(),
            { alignmentOffset: i$3 } = t$3;
        ...
        (window.addEventListener(`scroll`, this._onScroll, k),
          this._emit(L.Start, e$3.startEvent),
          this.settings.onStart?.(e$3, this),
    ...
    _prepareMove() {
      ...
      t$3 !== n$4 &&
        (this._applyModifiers(F.Move, t$3.x - n$4.x, t$3.y - n$4.y),
        this._emit(L.PrepareMove, t$3),
        !e$3.isEnded &&
          (this.settings.onPrepareMove?.(e$3, this), !e$3.isEnded && (e$3.prevMoveEvent = t$3)));
    }
    _applyMove() {
      let e$3 = this.drag;
      if (e$3) {
    ...
    _prepareAlign() {
      ...
      if (e$3)
        for (let t$3 of e$3.items) {
          let { x: e$4, y: n$4 } = t$3.element.getBoundingClientRect(),
            r$2 = t$3.clientRect.x - t$3._moveDiff.x - e$4;
          ((t$3.alignmentOffset.x = t$3.alignmentOffset.x - t$3._alignDiff.x + r$2),
            (t$3._alignDiff.x = r$2));
          let i$3 = t$3.clientRect.y - t$3._moveDiff.y - n$4;
          ((t$3.alignmentOffset.y = t$3.alignmentOffset.y - t$3._alignDiff.y + i$3),
            (t$3._alignDiff.y = i$3));
        }
    }
    _applyAlign() {
      let { drag: e$3 } = this;
    ...
    _applyModifiers(e$3, t$3, n$4) {
      ...
      for (let a$2 of r$2.items) {
        ...
        ((a$2.position.x += o$2.x),
          (a$2.position.y += o$2.y),
          (a$2.clientRect.x += o$2.x),
          (a$2.clientRect.y += o$2.y),
          e$3 === `move` && ((a$2._moveDiff.x += o$2.x), (a$2._moveDiff.y += o$2.y)));
      }
    }
    on(e$3, t$3, n$4) {
    ...
    resolveStartPredicate(e$3, r$2) {
      ...
      i$3.predicateState === P.Pending &&
        a$2 &&
        ((this._startPhase = N.Init),
        (i$3.predicateState = P.Resolved),
        (i$3.predicateEvent = null),
        (this.drag = new c$1(e$3, a$2)),
        this._sensorData.forEach((t$3, n$4) => {
          n$4 !== e$3 && ((t$3.predicateState = P.Rejected), (t$3.predicateEvent = null));
        }),
        n$2.once(t.read, this._prepareStart, this._startId),
        n$2.once(t.write, this._applyStart, this._startId));
    }
    ...
    stop() {
      ...
      if (r$2 === N.Prepare || r$2 === N.Apply)
        throw Error(`Cannot stop drag start process at this point`);
      if (
        ((this._startPhase = N.None),
        (e$3.isEnded = !0),
        n$2.off(t.read, this._startId),
        n$2.off(t.write, this._startId),
        n$2.off(t.read, this._moveId),
        n$2.off(t.write, this._moveId),
        n$2.off(t.read, this._alignId),
        n$2.off(t.write, this._alignId),
        window.removeEventListener(`scroll`, this._onScroll, k),
        r$2 > N.Init && this._applyModifiers(F.End, 0, 0),
        r$2 === N.FinishApply)
      ) {
        for (let t$3 of e$3.items) {
          if (
            ...
            for (let e$4 in t$3.unfrozenStyles)
              t$3.element.style[e$4] = t$3.unfrozenStyles[e$4] || ``;
          this.settings.applyPosition({
            phase: I.End,
            draggable: this,
            drag: e$3,
        ...
        for (let t$3 of e$3.items)
          if (t$3.elementContainer !== t$3.dragContainer) {
            ...
            ((t$3.alignmentOffset.x = D(t$3.clientRect.x - e$4.x, 3)),
              (t$3.alignmentOffset.y = D(t$3.clientRect.y - e$4.y, 3)));
          }
        for (let t$3 of e$3.items)
          t$3.elementContainer !== t$3.dragContainer &&
    ...
    align(e$3 = !1) {
      this.drag &&
        (e$3
          ...
          : (n$2.once(t.read, this._prepareAlign, this._alignId),
            n$2.once(t.write, this._applyAlign, this._alignId)));
    }
    getClientRect() {
    ...
    destroy() {
      this.isDestroyed ||
        ((this.isDestroyed = !0),
        this.stop(),
        this._sensorData.forEach(({ onMove: t$3, onEnd: n$4 }, r$2) => {
          (r$2.off(e.Start, t$3),
            r$2.off(e.Move, t$3),
            r$2.off(e.Cancel, n$4),
            r$2.off(e.End, n$4),
            r$2.off(e.Destroy, n$4));
        }),
  ...
  function i$2(e$3, t$3) {
    ...
    if (`changedTouches` in e$3) {
      let n$4 = 0;
      for (; n$4 < e$3.changedTouches.length; n$4++)
        if (e$3.changedTouches[n$4].identifier === t$3) return e$3.changedTouches[n$4];
      return null;
    }
    return e$3;
  }
  ...
  function o(e$3) {
    return `pointerId` in e$3
      ? e$3.pointerId
      : `changedTouches` in e$3
        ? e$3.changedTouches[0]
          ? e$3.changedTouches[0].identifier
          : null
        : -1;
  }
  function s(e$3 = {}) {
  ...
  var u = class {
    constructor(e$3, t$3 = {}) {
      let {
        listenerOptions: n$4 = {},
        sourceEvents: i$3 = `auto`,
        startPredicate: a$2 = (e$4) => !(`button` in e$4 && e$4.button > 0),
      } = t$3;
      ((this.element = e$3),
        (this.drag = null),
        (this.isDestroyed = !1),
        (this._areWindowListenersBound = !1),
        (this._startPredicate = a$2),
        (this._listenerOptions = s(n$4)),
        (this._sourceEvents = c(i$3)),
        (this._emitter = new v()),
        (this._onStart = this._onStart.bind(this)),
        (this._onMove = this._onMove.bind(this)),
        (this._onCancel = this._onCancel.bind(this)),
        (this._onEnd = this._onEnd.bind(this)),
        e$3.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
    }
    ...
    _bindWindowListeners() {
      ...
      (window.addEventListener(e$3, this._onMove, this._listenerOptions),
        window.addEventListener(t$3, this._onEnd, this._listenerOptions),
        n$4 && window.addEventListener(n$4, this._onCancel, this._listenerOptions),
        (this._areWindowListenersBound = !0));
    }
    _unbindWindowListeners() {
      if (this._areWindowListenersBound) {
        let { move: e$3, end: t$3, cancel: n$4 } = l[this._sourceEvents];
        (window.removeEventListener(e$3, this._onMove, this._listenerOptions),
          window.removeEventListener(t$3, this._onEnd, this._listenerOptions),
          n$4 && window.removeEventListener(n$4, this._onCancel, this._listenerOptions),
          (this._areWindowListenersBound = !1));
      }
    }
    _resetDrag() {
    ...
    updateSettings(e$3) {
      ...
      let { listenerOptions: t$3, sourceEvents: n$4, startPredicate: r$2 } = e$3,
        i$3 = c(n$4),
        a$2 = s(t$3);
      (r$2 && this._startPredicate !== r$2 && (this._startPredicate = r$2),
        ((t$3 &&
          (this._listenerOptions.capture !== a$2.capture ||
            this._listenerOptions.passive === a$2.passive)) ||
          (n$4 && this._sourceEvents !== i$3)) &&
          ...
          this.cancel(),
          n$4 && (this._sourceEvents = i$3),
          t$3 && a$2 && (this._listenerOptions = a$2),
  ...
  var n$1 = class {
    ...
    _start(t$3) {
      this.isDestroyed ||
        this.drag ||
        ((this.drag = this._createDragData(t$3)), this._emitter.emit(e.Start, t$3));
    }
    _move(t$3) {
    ...
    _end(t$3) {
      this.drag &&
        (this._updateDragData(t$3), this._emitter.emit(e.End, t$3), this._resetDragData());
    }
    _cancel(t$3) {
      this.drag &&
        (this._updateDragData(t$3), this._emitter.emit(e.Cancel, t$3), this._resetDragData());
    }
    on(e$3, t$3, n$4) {
      return this._emitter.on(e$3, t$3, n$4);
    }
    ...
    _tick(t$3) {
      if (this.drag)
        if (t$3 && this.drag.time) {
          ...
          let r$2 = this._speed * (this.drag.deltaTime / 1e3),
            i$3 = this._direction.x * r$2,
            a$2 = this._direction.y * r$2;
          (i$3 || a$2) &&
            this._move({
              type: e.Move,
              x: this.drag.x + i$3,
  ...
  const n = [`start`, `cancel`, `end`, `moveLeft`, `moveRight`, `moveUp`, `moveDown`];
  function r(e$3, t$3) {
  ...
  var a = class extends i {
    constructor(e$3, t$3 = {}) {
      super();
      let {
        startPredicate: n$4 = i$1.startPredicate,
        computeSpeed: r$2 = i$1.computeSpeed,
        cancelOnVisibilityChange: a$2 = i$1.cancelOnVisibilityChange,
        cancelOnBlur: o$2 = i$1.cancelOnBlur,
        startKeys: s$2 = i$1.startKeys,
        moveLeftKeys: c$2 = i$1.moveLeftKeys,
        moveRightKeys: l$3 = i$1.moveRightKeys,
        moveUpKeys: u$3 = i$1.moveUpKeys,
      ...
      ((this.element = e$3),
        ...
        (this._cancelOnVisibilityChange = a$2),
        (this._computeSpeed = r$2),
        (this._startPredicate = n$4),
        ...
        o$2 && e$3?.addEventListener(`blur`, this._blurCancelHandler),
        a$2 && document.addEventListener(`visibilitychange`, this._internalCancel));
    }
    _end(e$3) {
      this.drag &&
    ...
    _updateDirection() {
      let e$3 = r(this._moveLeftKeys, this._moveKeyTimestamps),
        t$3 = r(this._moveRightKeys, this._moveKeyTimestamps),
        n$4 = r(this._moveUpKeys, this._moveKeyTimestamps),
        i$3 = r(this._moveDownKeys, this._moveKeyTimestamps),
        a$2 = e$3 === t$3 ? 0 : e$3 < t$3 ? -1 : 1,
        o$2 = n$4 === i$3 ? 0 : n$4 < i$3 ? -1 : 1;
      if (!(a$2 === 0 || o$2 === 0)) {
    ...
    _onKeyUp(e$3) {
      this._moveKeyTimestamps.get(e$3.key) &&
        (this._moveKeyTimestamps.delete(e$3.key), this._updateDirection());
    }
    _onKeyDown(t$3) {
      if (!this.drag) {
    ...
    updateSettings(e$3 = {}) {
      ...
      if (
        ...
        a$2 !== void 0 && (this._startPredicate = a$2),
        ...
        [...this._moveKeys].every((t$4, n$4) => e$4[n$4] === t$4) ||
          ((this._moveKeys = new Set(e$4)),
          this._moveKeyTimestamps.clear(),
  ...
  //#endregion
  //#region examples/004-draggable-locked-axis/index.ts
  let zIndex = 0;
  [...document.querySelectorAll('.draggable')].forEach((element) => {
    new z([new u(element), new a(element)], {
      ...
      positionModifiers: [
        (change, { item }) => {
          const { element: element$1 } = item;
          const allowX = element$1.classList.contains('axis-x');
          const allowY = element$1.classList.contains('axis-y');
