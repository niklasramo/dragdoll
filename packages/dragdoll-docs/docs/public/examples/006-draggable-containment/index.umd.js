...
function g(e$4, t$3 = {
	...
	let { x: r$3, y: i$4 } = e$4.getBoundingClientRect(), a$3 = t$2(e$4);
	return t$3.x = r$3 + (parseFloat(a$3.borderLeftWidth) || 0), t$3.y = i$4 + (parseFloat(a$3.borderTopWidth) || 0), t$3;
}
function _(e$4) {
...
function y(e$4, t$3 = !1) {
	let { translate: r$3, rotate: i$4, scale: a$3, transform: o$3 } = t$2(e$4), s$2 = ``;
	if (r$3 && r$3 !== `none`) {
		let [t$4 = `0px`, n$5 = `0px`, i$5] = r$3.split(` `);
		t$4.includes(`%`) && (t$4 = `${parseFloat(t$4) / 100 * v$1(e$4)}px`), n$5.includes(`%`) && (n$5 = `${parseFloat(n$5) / 100 * _(e$4)}px`), i$5 ? s$2 += `translate3d(${t$4},${n$5},${i$5})` : s$2 += `translate(${t$4},${n$5})`;
	}
	if (i$4 && i$4 !== `none`) {
		let e$5 = i$4.split(` `);
...
function E(e$4, t$3 = new DOMMatrix()) {
	...
	for (u$1(t$3); r$3;) {
		...
		if (e$5 && (T.setMatrixValue(e$5), !T.isIdentity)) {
			let { transformOrigin: e$6 } = t$2(r$3), { x: i$4, y: a$3, z: o$3 } = w(e$6);
			o$3 === 0 ? T.setMatrixValue(`translate(${i$4}px,${a$3}px) ${T} translate(${i$4 * -1}px,${a$3 * -1}px)`) : T.setMatrixValue(`translate3d(${i$4}px,${a$3}px,${o$3}px) ${T} translate3d(${i$4 * -1}px,${a$3 * -1}px,${o$3 * -1}px)`), t$3.preMultiplySelf(T);
		}
...
var O = class {
	constructor(e$4, t$3) {
		...
		let i$4 = t$2(e$4), a$3 = e$4.getBoundingClientRect(), s$2 = y(e$4, !0);
		...
		{
			let { width: e$5, height: t$4, x: n$5, y: r$4 } = a$3;
			this.clientRect = {
				width: e$5,
				height: t$4,
				x: n$5,
		...
		if (Array.isArray(d$1)) if (d$1.length) {
			let e$5 = {};
			for (let t$4 of d$1) e$5[t$4] = i$4[t$4];
...
const F = {
	...
	applyPosition: ({ item: e$4, phase: t$3 }) => {
		let n$5 = t$3 === L.End || t$3 === L.EndAlign, [r$3, i$4] = e$4.getContainerMatrix(), [a$3, o$3] = e$4.getDragContainerMatrix(), { position: s$2, alignmentOffset: c$2, containerOffset: l$3, elementTransformMatrix: d$1, elementTransformOrigin: f$1, elementOffsetMatrix: p$1 } = e$4, { x: m$1, y: h$1, z: g$1 } = f$1, _$2 = !d$1.isIdentity && (m$1 !== 0 || h$1 !== 0 || g$1 !== 0), v$2 = s$2.x + c$2.x + l$3.x, y$1 = s$2.y + c$2.y + l$3.y;
...
var B = class {
	...
	_parseSettings(e$4, t$3 = z) {
		let { container: n$5 = t$3.container, startPredicate: r$3 = t$3.startPredicate, elements: i$4 = t$3.elements, frozenStyles: a$3 = t$3.frozenStyles, positionModifiers: o$3 = t$3.positionModifiers, applyPosition: s$2 = t$3.applyPosition, computeClientRect: c$2 = t$3.computeClientRect, sensorProcessingMode: l$3 = t$3.sensorProcessingMode, group: u$3 = t$3.group, onPrepareStart: d$1 = t$3.onPrepareStart, onStart: f$1 = t$3.onStart, onPrepareMove: p$1 = t$3.onPrepareMove, onMove: m$1 = t$3.onMove, onEnd: h$1 = t$3.onEnd, onDestroy: g$1 = t$3.onDestroy } = e$4 || {};
		return {
			container: n$5,
			startPredicate: r$3,
			elements: i$4,
	...
	resolveStartPredicate(n$5, r$3) {
		...
		i$4.predicateState === P.Pending && a$3 && (this._startPhase = N.Init, i$4.predicateState = P.Resolved, i$4.predicateEvent = null, this.drag = new p(n$5, a$3), this._sensorData.forEach((e$4, t$3) => {
...
function c(n$5) {
	return n$5 === `auto` || n$5 === void 0 ? n$4 ? `pointer` : t$1 ? `touch` : `mouse` : n$5;
}
const l = {
	pointer: {
		start: `pointerdown`,
...
function o(o$3, s$2 = ({ drag: e$4 }) => e$4.sensor instanceof u) {
	return function(t$3, c$2) {
		...
		return t$3.x &&= (a$1(u$3.left, u$3.right, l$3.left, l$3.right, p$1.x, t$3.x, m$1), p$1.x = i$2.drift, i$2.change), t$3.y &&= (a$1(u$3.top, u$3.bottom, l$3.top, l$3.bottom, p$1.y, t$3.y, m$1), p$1.y = i$2.drift, i$2.change), t$3;
	};
}
