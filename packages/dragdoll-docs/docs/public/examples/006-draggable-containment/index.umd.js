...
var f = class {
	...
	set(e$4, t$2) {
		this._cache.set(e$4, t$2), this._validation.add(e$4);
	}
	get(e$4) {
...
var O = class {
	...
	constructor(e$4, t$2) {
		...
		if (Array.isArray(f$1)) if (f$1.length) {
			let e$5 = {};
			for (let t$3 of f$1) e$5[t$3] = i$4[t$3];
...
var B = class {
	...
	constructor(e$4, t$2 = {}) {
		...
		this.id = n$5, this._sensors = e$4, this.settings = this._parseSettings(r$4), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$5) => {
	...
	set sensors(e$4) {
		...
		if (e$4 === t$2) return;
		let n$5 = t$2.filter((t$3) => !e$4.includes(t$3)), r$4 = e$4.filter((e$5) => !t$2.includes(e$5));
	...
	_bindSensor(e$4) {
		this._sensorData.set(e$4, {
			...
			predicateEvent: null,
			onMove: (t$3) => this._onMove(t$3, e$4),
			onEnd: (t$3) => this._onEnd(t$3, e$4)
		});
		let { onMove: t$2, onEnd: n$5 } = this._sensorData.get(e$4);
		e$4.on(e.Start, t$2, t$2), e$4.on(e.Move, t$2, t$2), e$4.on(e.Cancel, n$5, n$5), e$4.on(e.End, n$5, n$5), e$4.on(e.Destroy, n$5, n$5);
	}
	_unbindSensor(e$4) {
		let t$2 = this._sensorData.get(e$4);
		if (!t$2) return;
		let { onMove: n$5, onEnd: r$4 } = t$2;
	...
	_prepareMove() {
		...
		t$2 !== n$5 && (this._applyModifiers(F.Move, t$2.x - n$5.x, t$2.y - n$5.y), this._emit(R.PrepareMove, e$4, this), !e$4.isEnded && (this.settings.onPrepareMove?.(e$4, this), !e$4.isEnded && (e$4.prevMoveEvent = t$2)));
	}
	_applyMove() {
		let e$4 = this.drag;
		if (!(!e$4 || e$4.isEnded)) {
	...
	_prepareAlign() {
		let { drag: e$4 } = this;
		if (!(!e$4 || e$4.isEnded)) for (let t$2 of e$4.items) {
	...
	_applyAlign() {
		let { drag: e$4 } = this;
		if (!(!e$4 || e$4.isEnded)) for (let t$2 of e$4.items) t$2._alignDiff.x = 0, t$2._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$4,
			item: t$2
	...
	stop() {
		...
		if (!(!n$5 || n$5.isEnded)) {
			...
			n$5.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$1.off(n$1.read, this._startId), r$1.off(n$1.write, this._startId), r$1.off(n$1.read, this._moveId), r$1.off(n$1.write, this._moveId), r$1.off(n$1.read, this._alignId), r$1.off(n$1.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
