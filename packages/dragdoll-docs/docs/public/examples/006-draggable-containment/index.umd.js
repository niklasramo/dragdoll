(function (factory) {
  ...
  var E$1 = {
    ...
    v = class {
      constructor(t$3 = {}) {
        ((this.dedupe = t$3.dedupe || E$1.ADD),
          (this.getId = t$3.getId || (() => Symbol())),
      ...
      on(t$3, n$5, e$4) {
        ...
        s$2 ||
          ...
          i$4.set(t$3, s$2));
        let o$3 = s$2.m;
        if (((e$4 = e$4 === r$2 ? this.getId(n$5) : e$4), o$3.has(e$4)))
          switch (this.dedupe) {
            case E$1.THROW:
      ...
      once(t$3, n$5, e$4) {
        let i$4 = 0;
        return (
          (e$4 = e$4 === r$2 ? this.getId(n$5) : e$4),
          this.on(
            t$3,
            (...s$2) => {
    ...
    o$2 = class {
      ...
      _processQueue(...e$4) {
        ...
        let s$2 = 0,
          ...
          c$2;
        for (; s$2 < r$3; s$2++)
          for (n$5 = t$3[s$2], a$3 = 0, c$2 = n$5.length; a$3 < c$2; a$3++) n$5[a$3](...e$4);
        t$3.length = 0;
      }
    };
  function u$2(i$4 = 60) {
    ...
    {
      let e$4 = 1e3 / i$4,
        t$3 = typeof performance > 'u' ? () => Date.now() : () => performance.now();
      return (r$3) => {
  ...
  let n$3 = new l$2({ phases: [t.read, t.write] });
  ...
  function t$2(t$3) {
    ...
    return (
      n$5 || ((n$5 = window.getComputedStyle(t$3, null)), e$3.set(t$3, new WeakRef(n$5))),
      n$5
    );
  }
  ...
  function isContainingBlockForFixedElement(n$5) {
    ...
    return (
      !(
        !c$2 ||
        !(
          c$2.indexOf('transform') > -1 ||
          c$2.indexOf('perspective') > -1 ||
          c$2.indexOf('contain') > -1
        )
      ) || !!(IS_SAFARI && c$2 && c$2.indexOf('filter') > -1)
    );
  }
  ...
  function getContainingBlock(e$4, t$3 = {}) {
    ...
    const n$5 = t$3.position || getStyle(e$4).position,
      { skipDisplayNone: i$4, container: o$3 } = t$3;
    switch (n$5) {
      case 'static':
      case 'relative':
      case 'sticky':
  ...
  function getOffsetContainer(n$5, t$3 = {}) {
    ...
    const e$4 = t$3.position || getStyle(n$5).position,
      { skipDisplayNone: s$2, container: r$3 } = t$3;
    switch (e$4) {
      case 'relative':
        return n$5;
      case 'fixed':
  ...
  var s$1 = class {
    ...
    c$1 = class {
      constructor(e$4, t$3) {
        ((this.sensor = e$4),
          (this.startEvent = t$3),
          (this.prevMoveEvent = t$3),
          (this.moveEvent = t$3),
          (this.endEvent = null),
          (this.items = []),
          (this.isEnded = !1),
          (this._matrixCache = new s$1()),
          (this._clientOffsetCache = new s$1()));
      }
    };
  function l$1(
    e$4,
    ...
    if (e$4 instanceof Document)
      return ((t$3.x = window.scrollX * -1), (t$3.y = window.scrollY * -1), t$3);
    let { x: n$5, y: r$3 } = e$4.getBoundingClientRect(),
      a$3 = t$2(e$4);
    return (
      (t$3.x = n$5 + (parseFloat(a$3.borderLeftWidth) || 0)),
      (t$3.y = r$3 + (parseFloat(a$3.borderTopWidth) || 0)),
      t$3
    );
  }
  function u$1(e$4) {
  ...
  function p(
    ...
    let r$3 = u$1(e$4) ? e$4 : l$1(e$4, d),
      i$4 = u$1(t$3) ? t$3 : l$1(t$3, f);
    return ((n$5.x = i$4.x - r$3.x), (n$5.y = i$4.y - r$3.y), n$5);
  }
  function m(e$4) {
    let t$3 = t$2(e$4),
      n$5 = parseFloat(t$3.height) || 0;
    return t$3.boxSizing === `border-box`
      ? n$5
      : ((n$5 += parseFloat(t$3.borderTopWidth) || 0),
        (n$5 += parseFloat(t$3.borderBottomWidth) || 0),
        (n$5 += parseFloat(t$3.paddingTop) || 0),
        (n$5 += parseFloat(t$3.paddingBottom) || 0),
        e$4 instanceof HTMLElement && (n$5 += e$4.offsetHeight - e$4.clientHeight),
        n$5);
  }
  function h(e$4) {
    let t$3 = t$2(e$4),
      n$5 = parseFloat(t$3.width) || 0;
    return t$3.boxSizing === `border-box`
      ? n$5
      : ((n$5 += parseFloat(t$3.borderLeftWidth) || 0),
        (n$5 += parseFloat(t$3.borderRightWidth) || 0),
        (n$5 += parseFloat(t$3.paddingLeft) || 0),
        (n$5 += parseFloat(t$3.paddingRight) || 0),
        e$4 instanceof HTMLElement && (n$5 += e$4.offsetWidth - e$4.clientWidth),
        n$5);
  }
  function g(e$4, t$3 = !1) {
    let { translate: n$5, rotate: r$3, scale: a$3, transform: o$3 } = t$2(e$4),
      s$2 = ``;
    if (n$5 && n$5 !== `none`) {
      let [t$4 = `0px`, r$4 = `0px`, i$4] = n$5.split(` `);
      (t$4.includes(`%`) && (t$4 = `${(parseFloat(t$4) / 100) * h(e$4)}px`),
        r$4.includes(`%`) && (r$4 = `${(parseFloat(r$4) / 100) * m(e$4)}px`),
        i$4 ? (s$2 += `translate3d(${t$4},${r$4},${i$4})`) : (s$2 += `translate(${t$4},${r$4})`));
    }
    if (r$3 && r$3 !== `none`) {
      let e$5 = r$3.split(` `);
  ...
  function b(e$4, t$3 = new DOMMatrix()) {
    let n$5 = e$4;
    for (v$1(t$3); n$5; ) {
      let e$5 = g(n$5);
      if (e$5 && (y.setMatrixValue(e$5), !y.isIdentity)) {
        let { transformOrigin: e$6 } = t$2(n$5),
          { x: r$3, y: a$3, z: o$3 } = _(e$6);
        (o$3 === 0
          ? y.setMatrixValue(
              `translate(${r$3}px,${a$3}px) ${y} translate(${r$3 * -1}px,${a$3 * -1}px)`,
            )
          : y.setMatrixValue(
              `translate3d(${r$3}px,${a$3}px,${o$3}px) ${y} translate3d(${r$3 * -1}px,${a$3 * -1}px,${o$3 * -1}px)`,
            ),
          t$3.preMultiplySelf(y));
      }
      n$5 = n$5.parentElement;
    }
    return t$3;
  }
  function x(e$4, t$3, n$5 = !1) {
    let { style: r$3 } = e$4;
  ...
  var T = class {
    constructor(e$4, t$3) {
      ...
      ((this.data = {}),
        ...
        (this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$2 + r$3.transform)),
      ...
      ((this.elementOffsetContainer = u$3),
        (this.dragOffsetContainer =
          l$3 === c$2 ? u$3 : getOffsetContainer(e$4, { container: l$3 })));
      {
    ...
    _updateContainerMatrices() {
      [this.elementContainer, this.dragContainer].forEach((e$4) => {
        if (!this._matrixCache.isValid(e$4)) {
          let t$3 = this._matrixCache.get(e$4) || [new DOMMatrix(), new DOMMatrix()],
            [n$5, r$3] = t$3;
          (b(e$4, n$5),
            r$3.setMatrixValue(n$5.toString()).invertSelf(),
            this._matrixCache.set(e$4, t$3));
        }
      });
    }
    _updateContainerOffset() {
      ...
      if (e$4 !== n$5) {
        let [s$2, c$2] = [
          ...
          if (!a$3.isValid(t$4)) {
            let r$4 = o$3.get(e$5);
            t$4 instanceof HTMLElement && r$4 && !r$4[0].isIdentity
              ? C(r$4[0])
                ? (w.style.setProperty(`transform`, r$4[1].toString(), `important`),
                  t$4.append(w),
                  l$1(w, n$6),
                  w.remove())
                : (l$1(t$4, n$6), (n$6.x -= r$4[0].m41), (n$6.y -= r$4[0].m42))
              : l$1(t$4, n$6);
          }
  ...
  function E(e$4, t$3, n$5 = null) {
    if (`moveBefore` in e$4 && e$4.isConnected === t$3.isConnected)
      try {
        e$4.moveBefore(t$3, n$5);
        return;
      } catch {}
    let r$3 = document.activeElement,
      i$4 = t$3.contains(r$3);
    (e$4.insertBefore(t$3, n$5),
      i$4 &&
  ...
  function O(e$4, t$3) {
    return e$4.isIdentity && t$3.isIdentity
      ? !0
      : e$4.is2D && t$3.is2D
        ? e$4.a === t$3.a &&
          e$4.b === t$3.b &&
  ...
  const F = {
    ...
    R = {
      ...
      applyPosition: ({ item: e$4, phase: t$3 }) => {
        let n$5 = t$3 === I.End || t$3 === I.EndAlign,
          [r$3, i$4] = e$4.getContainerMatrix(),
          [a$3, o$3] = e$4.getDragContainerMatrix(),
          {
            position: s$2,
            alignmentOffset: c$2,
            containerOffset: l$3,
            elementTransformMatrix: u$3,
            elementTransformOrigin: d$1,
            elementOffsetMatrix: f$1,
          } = e$4,
          { x: p$1, y: m$1, z: h$1 } = d$1,
          g$1 = !u$3.isIdentity && (p$1 !== 0 || m$1 !== 0 || h$1 !== 0),
          _$2 = s$2.x + c$2.x + l$3.x,
          y$1 = s$2.y + c$2.y + l$3.y;
        (v$1(j),
          g$1 && (h$1 === 0 ? j.translateSelf(-p$1, -m$1) : j.translateSelf(-p$1, -m$1, -h$1)),
          n$5 ? i$4.isIdentity || j.multiplySelf(i$4) : o$3.isIdentity || j.multiplySelf(o$3),
          v$1(M).translateSelf(_$2, y$1),
          j.multiplySelf(M),
          r$3.isIdentity || j.multiplySelf(r$3),
          g$1 && (v$1(M).translateSelf(p$1, m$1, h$1), j.multiplySelf(M)),
          u$3.isIdentity || j.multiplySelf(u$3),
  ...
  var z = class {
    constructor(t$3, n$5 = {}) {
      ...
      ((this.id = r$3),
        ...
        this.sensors.forEach((t$4) => {
          ...
          (t$4.on(e$1.Start, n$6, n$6),
            t$4.on(e$1.Move, n$6, n$6),
            t$4.on(e$1.Cancel, r$4, r$4),
            t$4.on(e$1.End, r$4, r$4),
            t$4.on(e$1.Destroy, r$4, r$4));
        }));
    }
    _parseSettings(e$4, t$3 = R) {
      let {
        container: n$5 = t$3.container,
        startPredicate: r$3 = t$3.startPredicate,
        elements: i$4 = t$3.elements,
        frozenStyles: a$3 = t$3.frozenStyles,
        positionModifiers: o$3 = t$3.positionModifiers,
        applyPosition: s$2 = t$3.applyPosition,
        computeClientRect: c$2 = t$3.computeClientRect,
        group: l$3 = t$3.group,
        onPrepareStart: u$3 = t$3.onPrepareStart,
        onStart: d$1 = t$3.onStart,
        onPrepareMove: f$1 = t$3.onPrepareMove,
        onMove: p$1 = t$3.onMove,
        onEnd: m$1 = t$3.onEnd,
        onDestroy: h$1 = t$3.onDestroy,
      } = e$4 || {};
      return {
        container: n$5,
        startPredicate: r$3,
        ...
        switch (i$4.predicateState) {
          case P.Pending: {
            ...
            t$3 === !0
              ...
              : t$3 === !1 && this.rejectStartPredicate(r$3);
            break;
          }
          case P.Resolved:
            this.drag &&
    ...
    _applyStart() {
      ...
      if (e$4) {
        ...
        for (let t$3 of e$4.items)
          (t$3.dragContainer !== t$3.elementContainer && E(t$3.dragContainer, t$3.element),
            t$3.frozenStyles && Object.assign(t$3.element.style, t$3.frozenStyles),
        ...
        for (let t$3 of e$4.items) {
          let e$5 = t$3.getContainerMatrix()[0],
            n$5 = t$3.getDragContainerMatrix()[0];
          if (O(e$5, n$5) || (!C(e$5) && !C(n$5))) continue;
          let r$3 = t$3.element.getBoundingClientRect(),
            { alignmentOffset: i$4 } = t$3;
    ...
    _prepareMove() {
      ...
      t$3 !== n$5 &&
        (this._applyModifiers(F.Move, t$3.x - n$5.x, t$3.y - n$5.y),
        this._emit(L.PrepareMove, t$3),
        !e$4.isEnded &&
          (this.settings.onPrepareMove?.(e$4, this), !e$4.isEnded && (e$4.prevMoveEvent = t$3)));
    }
    _applyMove() {
      let e$4 = this.drag;
      if (e$4) {
      ...
      if (e$4)
        for (let t$3 of e$4.items) {
          let { x: e$5, y: n$5 } = t$3.element.getBoundingClientRect(),
            r$3 = t$3.clientRect.x - t$3._moveDiff.x - e$5;
          ((t$3.alignmentOffset.x = t$3.alignmentOffset.x - t$3._alignDiff.x + r$3),
            (t$3._alignDiff.x = r$3));
          let i$4 = t$3.clientRect.y - t$3._moveDiff.y - n$5;
          ((t$3.alignmentOffset.y = t$3.alignmentOffset.y - t$3._alignDiff.y + i$4),
            (t$3._alignDiff.y = i$4));
        }
    }
    _applyAlign() {
      let { drag: e$4 } = this;
    ...
    _applyModifiers(e$4, t$3, n$5) {
      ...
      for (let a$3 of r$3.items) {
        ...
        ((a$3.position.x += o$3.x),
          ...
          e$4 === `move` && ((a$3._moveDiff.x += o$3.x), (a$3._moveDiff.y += o$3.y)));
      }
    }
    on(e$4, t$3, n$5) {
    ...
    resolveStartPredicate(e$4, r$3) {
      ...
      i$4.predicateState === P.Pending &&
        ...
        (this.drag = new c$1(e$4, a$3)),
        this._sensorData.forEach((t$3, n$5) => {
    ...
    rejectStartPredicate(e$4) {
      ...
      t$3?.predicateState === P.Pending &&
        ((t$3.predicateState = P.Rejected), (t$3.predicateEvent = null));
    }
    stop() {
      let e$4 = this.drag;
      ...
      if (
        ...
        for (let t$3 of e$4.items) {
          if (
            (t$3.elementContainer !== t$3.dragContainer &&
              (E(t$3.elementContainer, t$3.element),
              (t$3.alignmentOffset.x = 0),
              (t$3.alignmentOffset.y = 0),
              (t$3.containerOffset.x = 0),
              (t$3.containerOffset.y = 0)),
            t$3.unfrozenStyles)
          )
            for (let e$5 in t$3.unfrozenStyles)
              t$3.element.style[e$5] = t$3.unfrozenStyles[e$5] || ``;
          this.settings.applyPosition({
            phase: I.End,
            draggable: this,
            drag: e$4,
        ...
        for (let t$3 of e$4.items)
          if (t$3.elementContainer !== t$3.dragContainer) {
            let e$5 = t$3.element.getBoundingClientRect();
            ((t$3.alignmentOffset.x = D(t$3.clientRect.x - e$5.x, 3)),
              (t$3.alignmentOffset.y = D(t$3.clientRect.y - e$5.y, 3)));
          }
        for (let t$3 of e$4.items)
          t$3.elementContainer !== t$3.dragContainer &&
            (t$3.alignmentOffset.x !== 0 || t$3.alignmentOffset.y !== 0) &&
            this.settings.applyPosition({
              phase: I.EndAlign,
              draggable: this,
              drag: e$4,
        ...
        for (let t$3 of e$4.items)
          ((t$3.clientRect.x -= t$3.position.x),
            (t$3.clientRect.y -= t$3.position.y),
            (t$3.position.x = 0),
            (t$3.position.y = 0),
            t$3.elementContainer !== t$3.dragContainer &&
              ((t$3.alignmentOffset.x = 0),
    ...
    destroy() {
      this.isDestroyed ||
        ((this.isDestroyed = !0),
        this.stop(),
        this._sensorData.forEach(({ onMove: t$3, onEnd: n$5 }, r$3) => {
          (r$3.off(e$1.Start, t$3),
            r$3.off(e$1.Move, t$3),
            r$3.off(e$1.Cancel, n$5),
            r$3.off(e$1.End, n$5),
            r$3.off(e$1.Destroy, n$5));
        }),
  ...
  function i$3(e$4, t$3) {
    ...
    if (`changedTouches` in e$4) {
      let n$5 = 0;
      for (; n$5 < e$4.changedTouches.length; n$5++)
        if (e$4.changedTouches[n$5].identifier === t$3) return e$4.changedTouches[n$5];
      return null;
    }
    return e$4;
  }
  ...
  var u = class {
    constructor(e$4, t$3 = {}) {
      ...
      ((this.element = e$4),
        ...
        (this._onEnd = this._onEnd.bind(this)),
        e$4.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions));
    }
    ...
    _bindWindowListeners() {
      ...
      (window.addEventListener(e$4, this._onMove, this._listenerOptions),
        window.addEventListener(t$3, this._onEnd, this._listenerOptions),
    ...
    _unbindWindowListeners() {
      if (this._areWindowListenersBound) {
        ...
        (window.removeEventListener(e$4, this._onMove, this._listenerOptions),
          window.removeEventListener(t$3, this._onEnd, this._listenerOptions),
    ...
    updateSettings(e$4) {
      ...
      let { listenerOptions: t$3, sourceEvents: n$5, startPredicate: r$3 } = e$4,
        i$4 = c(n$5),
        a$3 = s(t$3);
      (r$3 && this._startPredicate !== r$3 && (this._startPredicate = r$3),
        ((t$3 &&
          ...
          this.cancel(),
          n$5 && (this._sourceEvents = i$4),
          t$3 && a$3 && (this._listenerOptions = a$3),
  ...
  var n$2 = class {
    ...
    _start(t$3) {
      this.isDestroyed ||
        this.drag ||
        ((this.drag = this._createDragData(t$3)), this._emitter.emit(e$1.Start, t$3));
    }
    _move(t$3) {
      this.drag && (this._updateDragData(t$3), this._emitter.emit(e$1.Move, t$3));
    }
    _end(t$3) {
      this.drag &&
        (this._updateDragData(t$3), this._emitter.emit(e$1.End, t$3), this._resetDragData());
    }
    _cancel(t$3) {
      this.drag &&
        (this._updateDragData(t$3), this._emitter.emit(e$1.Cancel, t$3), this._resetDragData());
    }
    on(e$4, t$3, n$5) {
      return this._emitter.on(e$4, t$3, n$5);
    }
  ...
  var a = class extends i$1 {
    constructor(e$4, t$3 = {}) {
      ...
      let {
        ...
        cancelOnBlur: o$3 = i$2.cancelOnBlur,
        startKeys: s$2 = i$2.startKeys,
        moveLeftKeys: c$2 = i$2.moveLeftKeys,
        moveRightKeys: l$3 = i$2.moveRightKeys,
        moveUpKeys: u$3 = i$2.moveUpKeys,
      ...
      ((this.element = e$4),
        ...
        o$3 && e$4?.addEventListener(`blur`, this._blurCancelHandler),
    ...
    _updateDirection() {
      let e$4 = r$1(this._moveLeftKeys, this._moveKeyTimestamps),
        t$3 = r$1(this._moveRightKeys, this._moveKeyTimestamps),
        n$5 = r$1(this._moveUpKeys, this._moveKeyTimestamps),
        i$4 = r$1(this._moveDownKeys, this._moveKeyTimestamps),
        a$3 = e$4 === t$3 ? 0 : e$4 < t$3 ? -1 : 1,
        o$3 = n$5 === i$4 ? 0 : n$5 < i$4 ? -1 : 1;
      if (!(a$3 === 0 || o$3 === 0)) {
    ...
    _onKeyDown(t$3) {
      ...
      if (this._moveKeys.has(t$3.key)) {
        (t$3.preventDefault(),
          this._moveKeyTimestamps.get(t$3.key) ||
            (this._moveKeyTimestamps.set(t$3.key, Date.now()), this._updateDirection()));
        return;
      }
    }
    updateSettings(e$4 = {}) {
      ...
      if (
        ...
        [...this._moveKeys].every((t$4, n$5) => e$5[n$5] === t$4) ||
  ...
  function e(
    ...
    return (
      e$4 &&
        ((t$3.width = e$4.width),
        (t$3.height = e$4.height),
        (t$3.x = e$4.x),
        (t$3.y = e$4.y),
        (t$3.left = e$4.x),
        (t$3.top = e$4.y),
        (t$3.right = e$4.x + e$4.width),
        (t$3.bottom = e$4.y + e$4.height)),
      t$3
    );
  }
  ...
  function o(o$3, s$2 = ({ drag: t$3 }) => t$3.sensor instanceof u) {
    return function (e$4, c$2) {
      ...
      return (
        (e$4.x &&=
          (a$1(u$3.left, u$3.right, l$3.left, l$3.right, p$1.x, e$4.x, m$1),
          (p$1.x = i.drift),
          i.change)),
        (e$4.y &&=
          (a$1(u$3.top, u$3.bottom, l$3.top, l$3.bottom, p$1.y, e$4.y, m$1),
          (p$1.y = i.drift),
          i.change)),
        e$4
      );
