(function (factory) {
  ...
  var E$2 = {
    ...
    v$1 = class {
      constructor(t$6 = {}) {
        ((this.dedupe = t$6.dedupe || E$2.ADD),
          (this.getId = t$6.getId || (() => Symbol())),
      ...
      on(t$6, n$5, e$5) {
        ...
        s$4 ||
          ...
          i$4.set(t$6, s$4));
        let o$4 = s$4.m;
        if (((e$5 = e$5 === r$2 ? this.getId(n$5) : e$5), o$4.has(e$5)))
          switch (this.dedupe) {
            case E$2.THROW:
      ...
      once(t$6, n$5, e$5) {
        let i$4 = 0;
        return (
          (e$5 = e$5 === r$2 ? this.getId(n$5) : e$5),
          this.on(
            t$6,
            (...s$4) => {
    ...
    o$3 = class {
      ...
      _processQueue(...e$5) {
        ...
        let s$4 = 0,
          ...
          c$4;
        for (; s$4 < r$3; s$4++)
          for (n$5 = t$6[s$4], a$3 = 0, c$4 = n$5.length; a$3 < c$4; a$3++) n$5[a$3](...e$5);
        t$6.length = 0;
      }
    };
  function u$3(i$4 = 60) {
    ...
    {
      let e$5 = 1e3 / i$4,
        t$6 = typeof performance > 'u' ? () => Date.now() : () => performance.now();
      return (r$3) => {
  ...
  const e$3 = typeof window < `u` && window.document !== void 0,
    t$4 = e$3 && `ontouchstart` in window,
    n$4 = e$3 && !!window.PointerEvent;
  e$3 &&
    navigator.vendor &&
  ...
  function t$5(t$6) {
    ...
    return (
      n$5 || ((n$5 = window.getComputedStyle(t$6, null)), e$4.set(t$6, new WeakRef(n$5))),
      n$5
    );
  }
  ...
  function getContainingBlock(e$5, t$6 = {}) {
    ...
    const n$5 = t$6.position || getStyle(e$5).position,
      { skipDisplayNone: i$4, container: o$4 } = t$6;
    switch (n$5) {
      case 'static':
      case 'relative':
      case 'sticky':
  ...
  function getOffsetContainer(n$5, t$6 = {}) {
    ...
    const e$5 = t$6.position || getStyle(n$5).position,
      { skipDisplayNone: s$4, container: r$3 } = t$6;
    switch (e$5) {
      case 'relative':
        return n$5;
      case 'fixed':
        return getContainingBlock(n$5, {
          container: r$3,
          position: e$5,
          skipDisplayNone: s$4,
        });
  ...
  var s$3 = class {
    ...
    c$3 = class {
      constructor(e$5, t$6) {
        ((this.sensor = e$5),
          (this.startEvent = t$6),
          (this.prevMoveEvent = t$6),
          (this.moveEvent = t$6),
          (this.endEvent = null),
          (this.items = []),
          (this.isEnded = !1),
          (this._matrixCache = new s$3()),
          (this._clientOffsetCache = new s$3()));
      }
    };
  function l$2(
    e$5,
    ...
    if (e$5 instanceof Document)
      return ((t$6.x = window.scrollX * -1), (t$6.y = window.scrollY * -1), t$6);
    let { x: n$5, y: r$3 } = e$5.getBoundingClientRect(),
      a$3 = t$5(e$5);
    return (
      (t$6.x = n$5 + (parseFloat(a$3.borderLeftWidth) || 0)),
      (t$6.y = r$3 + (parseFloat(a$3.borderTopWidth) || 0)),
      t$6
    );
  }
  function u$2(e$5) {
  ...
  function p$1(
    ...
    let r$3 = u$2(e$5) ? e$5 : l$2(e$5, d$1),
      i$4 = u$2(t$6) ? t$6 : l$2(t$6, f$1);
    return ((n$5.x = i$4.x - r$3.x), (n$5.y = i$4.y - r$3.y), n$5);
  }
  function m$1(e$5) {
    let t$6 = t$5(e$5),
      n$5 = parseFloat(t$6.height) || 0;
    return t$6.boxSizing === `border-box`
      ? n$5
      : ((n$5 += parseFloat(t$6.borderTopWidth) || 0),
        (n$5 += parseFloat(t$6.borderBottomWidth) || 0),
        (n$5 += parseFloat(t$6.paddingTop) || 0),
        (n$5 += parseFloat(t$6.paddingBottom) || 0),
        e$5 instanceof HTMLElement && (n$5 += e$5.offsetHeight - e$5.clientHeight),
        n$5);
  }
  function h$1(e$5) {
    let t$6 = t$5(e$5),
      n$5 = parseFloat(t$6.width) || 0;
    return t$6.boxSizing === `border-box`
      ? n$5
      : ((n$5 += parseFloat(t$6.borderLeftWidth) || 0),
        (n$5 += parseFloat(t$6.borderRightWidth) || 0),
        (n$5 += parseFloat(t$6.paddingLeft) || 0),
        (n$5 += parseFloat(t$6.paddingRight) || 0),
        e$5 instanceof HTMLElement && (n$5 += e$5.offsetWidth - e$5.clientWidth),
        n$5);
  }
  function g$1(e$5, t$6 = !1) {
    let { translate: n$5, rotate: r$3, scale: a$3, transform: o$4 } = t$5(e$5),
      s$4 = ``;
    if (n$5 && n$5 !== `none`) {
      let [t$7 = `0px`, r$4 = `0px`, i$4] = n$5.split(` `);
      (t$7.includes(`%`) && (t$7 = `${(parseFloat(t$7) / 100) * h$1(e$5)}px`),
        r$4.includes(`%`) && (r$4 = `${(parseFloat(r$4) / 100) * m$1(e$5)}px`),
        i$4 ? (s$4 += `translate3d(${t$7},${r$4},${i$4})`) : (s$4 += `translate(${t$7},${r$4})`));
    }
    if (r$3 && r$3 !== `none`) {
      let e$6 = r$3.split(` `);
  ...
  function b$1(e$5, t$6 = new DOMMatrix()) {
    ...
    for (v$2(t$6); n$5; ) {
      ...
      if (e$6 && (y$1.setMatrixValue(e$6), !y$1.isIdentity)) {
        let { transformOrigin: e$7 } = t$5(n$5),
          { x: r$3, y: a$3, z: o$4 } = _$1(e$7);
        (o$4 === 0
          ? y$1.setMatrixValue(
              `translate(${r$3}px,${a$3}px) ${y$1} translate(${r$3 * -1}px,${a$3 * -1}px)`,
            )
          : y$1.setMatrixValue(
              `translate3d(${r$3}px,${a$3}px,${o$4}px) ${y$1} translate3d(${r$3 * -1}px,${a$3 * -1}px,${o$4 * -1}px)`,
            ),
          t$6.preMultiplySelf(y$1));
      }
  ...
  var T$1 = class {
    constructor(e$5, t$6) {
      ...
      let r$3 = t$5(e$5),
        a$3 = e$5.getBoundingClientRect(),
        s$4 = g$1(e$5, !0);
      ((this.data = {}),
        (this.element = e$5),
        (this.elementTransformOrigin = _$1(r$3.transformOrigin)),
        (this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$4 + r$3.transform)),
        ...
        (this._matrixCache = n$5._matrixCache),
        (this._clientOffsetCache = n$5._clientOffsetCache));
      ...
      if (this.frozenStyles) {
        let t$7 = {};
        for (let n$6 in this.frozenStyles) t$7[n$6] = e$5.style[n$6];
    ...
    _updateContainerMatrices() {
      [this.elementContainer, this.dragContainer].forEach((e$5) => {
        if (!this._matrixCache.isValid(e$5)) {
          let t$6 = this._matrixCache.get(e$5) || [new DOMMatrix(), new DOMMatrix()],
            [n$5, r$3] = t$6;
          (b$1(e$5, n$5),
            r$3.setMatrixValue(n$5.toString()).invertSelf(),
            this._matrixCache.set(e$5, t$6));
        }
      });
    }
    _updateContainerOffset() {
      let {
        ...
        elementContainer: t$6,
        dragOffsetContainer: n$5,
        dragContainer: r$3,
        containerOffset: i$4,
      ...
      if (e$5 !== n$5) {
        let [s$4, c$4] = [
          ...
          if (!a$3.isValid(t$7)) {
            let r$4 = o$4.get(e$6);
            t$7 instanceof HTMLElement && r$4 && !r$4[0].isIdentity
              ? C$1(r$4[0])
                ? (w$1.style.setProperty(`transform`, r$4[1].toString(), `important`),
                  t$7.append(w$1),
                  l$2(w$1, n$6),
                  w$1.remove())
                : (l$2(t$7, n$6), (n$6.x -= r$4[0].m41), (n$6.y -= r$4[0].m42))
              : l$2(t$7, n$6);
          }
  ...
  function E$1(e$5, t$6, n$5 = null) {
    if (`moveBefore` in e$5 && e$5.isConnected === t$6.isConnected)
      try {
        e$5.moveBefore(t$6, n$5);
        return;
      } catch {}
    let r$3 = document.activeElement,
      i$4 = t$6.contains(r$3);
    (e$5.insertBefore(t$6, n$5),
      i$4 &&
        document.activeElement !== r$3 &&
        r$3 instanceof HTMLElement &&
        r$3.focus({ preventScroll: !0 }));
  }
  ...
  function O$1(e$5, t$6) {
    return e$5.isIdentity && t$6.isIdentity
      ? !0
      : e$5.is2D && t$6.is2D
        ? e$5.a === t$6.a &&
          e$5.b === t$6.b &&
  ...
  const F = {
    ...
    R = {
      ...
      applyPosition: ({ item: e$5, phase: t$6 }) => {
        let n$5 = t$6 === I.End || t$6 === I.EndAlign,
          [r$3, i$4] = e$5.getContainerMatrix(),
          [a$3, o$4] = e$5.getDragContainerMatrix(),
          {
            position: s$4,
            alignmentOffset: c$4,
            containerOffset: l$4,
            elementTransformMatrix: u$4,
            elementTransformOrigin: d$2,
            elementOffsetMatrix: f$2,
          } = e$5,
          { x: p$2, y: m$2, z: h$2 } = d$2,
          g$2 = !u$4.isIdentity && (p$2 !== 0 || m$2 !== 0 || h$2 !== 0),
          _$3 = s$4.x + c$4.x + l$4.x,
          y$2 = s$4.y + c$4.y + l$4.y;
        (v$2(j$1),
          g$2 && (h$2 === 0 ? j$1.translateSelf(-p$2, -m$2) : j$1.translateSelf(-p$2, -m$2, -h$2)),
          n$5 ? i$4.isIdentity || j$1.multiplySelf(i$4) : o$4.isIdentity || j$1.multiplySelf(o$4),
          v$2(M$1).translateSelf(_$3, y$2),
          j$1.multiplySelf(M$1),
          r$3.isIdentity || j$1.multiplySelf(r$3),
          g$2 && (v$2(M$1).translateSelf(p$2, m$2, h$2), j$1.multiplySelf(M$1)),
          u$4.isIdentity || j$1.multiplySelf(u$4),
          f$2.isIdentity || j$1.preMultiplySelf(f$2),
  ...
  var z = class {
    constructor(t$6, n$5 = {}) {
      ...
      ((this.id = r$3),
        (this.sensors = t$6),
        (this.settings = this._parseSettings(i$4)),
        (this.plugins = {}),
        (this.drag = null),
        (this.isDestroyed = !1),
        ...
        this.sensors.forEach((t$7) => {
          ...
          (t$7.on(e$2.Start, n$6, n$6),
            t$7.on(e$2.Move, n$6, n$6),
            t$7.on(e$2.Cancel, r$4, r$4),
            t$7.on(e$2.End, r$4, r$4),
            t$7.on(e$2.Destroy, r$4, r$4));
        }));
    }
    _parseSettings(e$5, t$6 = R) {
      let {
        container: n$5 = t$6.container,
        startPredicate: r$3 = t$6.startPredicate,
        elements: i$4 = t$6.elements,
        frozenStyles: a$3 = t$6.frozenStyles,
        positionModifiers: o$4 = t$6.positionModifiers,
        applyPosition: s$4 = t$6.applyPosition,
        computeClientRect: c$4 = t$6.computeClientRect,
        group: l$4 = t$6.group,
        onPrepareStart: u$4 = t$6.onPrepareStart,
        onStart: d$2 = t$6.onStart,
        onPrepareMove: f$2 = t$6.onPrepareMove,
        onMove: p$2 = t$6.onMove,
        onEnd: m$2 = t$6.onEnd,
        onDestroy: h$2 = t$6.onDestroy,
      } = e$5 || {};
      return {
        container: n$5,
        startPredicate: r$3,
      ...
      if (i$4)
        switch (i$4.predicateState) {
          case P.Pending: {
            ...
            t$6 === !0
              ? this.resolveStartPredicate(r$3)
              : t$6 === !1 && this.rejectStartPredicate(r$3);
            break;
          }
          case P.Resolved:
            this.drag &&
              ((this.drag.moveEvent = e$5),
              n.once(t$1.read, this._prepareMove, this._moveId),
              n.once(t$1.write, this._applyMove, this._moveId));
            break;
        }
    }
    _onScroll() {
    ...
    _prepareStart() {
      ...
      e$5 &&
        ...
        ).map((e$6) => new T$1(e$6, this))),
        this._applyModifiers(F.Start, 0, 0),
        this._emit(L.PrepareStart, e$5.startEvent),
    ...
    _applyStart() {
      ...
      if (e$5) {
        ...
        for (let t$6 of e$5.items)
          (t$6.dragContainer !== t$6.elementContainer && E$1(t$6.dragContainer, t$6.element),
            t$6.frozenStyles && Object.assign(t$6.element.style, t$6.frozenStyles),
        ...
        for (let t$6 of e$5.items) {
          let e$6 = t$6.getContainerMatrix()[0],
            n$5 = t$6.getDragContainerMatrix()[0];
          if (O$1(e$6, n$5) || (!C$1(e$6) && !C$1(n$5))) continue;
          let r$3 = t$6.element.getBoundingClientRect(),
            { alignmentOffset: i$4 } = t$6;
          ((i$4.x += D$1(t$6.clientRect.x - r$3.x, 3)),
            (i$4.y += D$1(t$6.clientRect.y - r$3.y, 3)));
        }
        for (let t$6 of e$5.items) {
        ...
        (window.addEventListener(`scroll`, this._onScroll, k$1),
          this._emit(L.Start, e$5.startEvent),
    ...
    _prepareMove() {
      ...
      t$6 !== n$5 &&
        (this._applyModifiers(F.Move, t$6.x - n$5.x, t$6.y - n$5.y),
        this._emit(L.PrepareMove, t$6),
        !e$5.isEnded &&
          (this.settings.onPrepareMove?.(e$5, this), !e$5.isEnded && (e$5.prevMoveEvent = t$6)));
    }
    _applyMove() {
      let e$5 = this.drag;
      if (e$5) {
    ...
    _prepareAlign() {
      ...
      if (e$5)
        for (let t$6 of e$5.items) {
          let { x: e$6, y: n$5 } = t$6.element.getBoundingClientRect(),
            r$3 = t$6.clientRect.x - t$6._moveDiff.x - e$6;
          ((t$6.alignmentOffset.x = t$6.alignmentOffset.x - t$6._alignDiff.x + r$3),
            (t$6._alignDiff.x = r$3));
          let i$4 = t$6.clientRect.y - t$6._moveDiff.y - n$5;
          ((t$6.alignmentOffset.y = t$6.alignmentOffset.y - t$6._alignDiff.y + i$4),
            (t$6._alignDiff.y = i$4));
        }
    }
    _applyAlign() {
      let { drag: e$5 } = this;
    ...
    _applyModifiers(e$5, t$6, n$5) {
      ...
      for (let a$3 of r$3.items) {
        ...
        ((a$3.position.x += o$4.x),
          (a$3.position.y += o$4.y),
          (a$3.clientRect.x += o$4.x),
          (a$3.clientRect.y += o$4.y),
          e$5 === `move` && ((a$3._moveDiff.x += o$4.x), (a$3._moveDiff.y += o$4.y)));
      }
    }
    on(e$5, t$6, n$5) {
    ...
    resolveStartPredicate(e$5, r$3) {
      ...
      i$4.predicateState === P.Pending &&
        a$3 &&
        ((this._startPhase = N$1.Init),
        (i$4.predicateState = P.Resolved),
        (i$4.predicateEvent = null),
        (this.drag = new c$3(e$5, a$3)),
        this._sensorData.forEach((t$6, n$5) => {
          n$5 !== e$5 && ((t$6.predicateState = P.Rejected), (t$6.predicateEvent = null));
        }),
        n.once(t$1.read, this._prepareStart, this._startId),
        n.once(t$1.write, this._applyStart, this._startId));
    }
    rejectStartPredicate(e$5) {
      let t$6 = this._sensorData.get(e$5);
      t$6?.predicateState === P.Pending &&
        ((t$6.predicateState = P.Rejected), (t$6.predicateEvent = null));
    }
    stop() {
      let e$5 = this.drag;
      if (!e$5 || e$5.isEnded) return;
      let r$3 = this._startPhase;
      if (r$3 === N$1.Prepare || r$3 === N$1.Apply)
        throw Error(`Cannot stop drag start process at this point`);
      if (
        ((this._startPhase = N$1.None),
        (e$5.isEnded = !0),
        n.off(t$1.read, this._startId),
        n.off(t$1.write, this._startId),
        n.off(t$1.read, this._moveId),
        n.off(t$1.write, this._moveId),
        n.off(t$1.read, this._alignId),
        n.off(t$1.write, this._alignId),
        window.removeEventListener(`scroll`, this._onScroll, k$1),
        r$3 > N$1.Init && this._applyModifiers(F.End, 0, 0),
        r$3 === N$1.FinishApply)
      ) {
        for (let t$6 of e$5.items) {
          if (
            (t$6.elementContainer !== t$6.dragContainer &&
              (E$1(t$6.elementContainer, t$6.element),
              (t$6.alignmentOffset.x = 0),
              (t$6.alignmentOffset.y = 0),
              (t$6.containerOffset.x = 0),
              (t$6.containerOffset.y = 0)),
            t$6.unfrozenStyles)
          )
            for (let e$6 in t$6.unfrozenStyles)
              t$6.element.style[e$6] = t$6.unfrozenStyles[e$6] || ``;
          this.settings.applyPosition({
            phase: I.End,
            draggable: this,
            drag: e$5,
        ...
        for (let t$6 of e$5.items)
          if (t$6.elementContainer !== t$6.dragContainer) {
            let e$6 = t$6.element.getBoundingClientRect();
            ((t$6.alignmentOffset.x = D$1(t$6.clientRect.x - e$6.x, 3)),
              (t$6.alignmentOffset.y = D$1(t$6.clientRect.y - e$6.y, 3)));
          }
        for (let t$6 of e$5.items)
          t$6.elementContainer !== t$6.dragContainer &&
            (t$6.alignmentOffset.x !== 0 || t$6.alignmentOffset.y !== 0) &&
            this.settings.applyPosition({
              phase: I.EndAlign,
              draggable: this,
              drag: e$5,
      ...
      } else if (r$3 === N$1.FinishPrepare)
        for (let t$6 of e$5.items)
          ((t$6.clientRect.x -= t$6.position.x),
            (t$6.clientRect.y -= t$6.position.y),
            (t$6.position.x = 0),
            (t$6.position.y = 0),
            t$6.elementContainer !== t$6.dragContainer &&
              ((t$6.alignmentOffset.x = 0),
    ...
    align(e$5 = !1) {
      this.drag &&
        (e$5
          ...
          : (n.once(t$1.read, this._prepareAlign, this._alignId),
            n.once(t$1.write, this._applyAlign, this._alignId)));
    }
    getClientRect() {
      let { drag: e$5, settings: t$6 } = this;
      return (
        (e$5 &&
          t$6.computeClientRect?.({
            draggable: this,
            drag: e$5,
          })) ||
        null
    ...
    destroy() {
      this.isDestroyed ||
        ((this.isDestroyed = !0),
        this.stop(),
        this._sensorData.forEach(({ onMove: t$6, onEnd: n$5 }, r$3) => {
          (r$3.off(e$2.Start, t$6),
            r$3.off(e$2.Move, t$6),
            r$3.off(e$2.Cancel, n$5),
            r$3.off(e$2.End, n$5),
            r$3.off(e$2.Destroy, n$5));
        }),
  ...
  function i$3(e$5, t$6) {
    ...
    if (`changedTouches` in e$5) {
      let n$5 = 0;
      for (; n$5 < e$5.changedTouches.length; n$5++)
        if (e$5.changedTouches[n$5].identifier === t$6) return e$5.changedTouches[n$5];
      return null;
    }
    return e$5;
  }
  ...
  var u = class {
    constructor(e$5, t$6 = {}) {
      let {
        listenerOptions: n$5 = {},
        sourceEvents: i$4 = `auto`,
        startPredicate: a$3 = (e$6) => !(`button` in e$6 && e$6.button > 0),
      } = t$6;
      ((this.element = e$5),
        (this.drag = null),
        (this.isDestroyed = !1),
        ...
        (this._listenerOptions = s$2(n$5)),
        (this._sourceEvents = c$2(i$4)),
        (this._emitter = new v$1()),
    ...
    _bindWindowListeners() {
      ...
      (window.addEventListener(e$5, this._onMove, this._listenerOptions),
        window.addEventListener(t$6, this._onEnd, this._listenerOptions),
        n$5 && window.addEventListener(n$5, this._onCancel, this._listenerOptions),
    ...
    _unbindWindowListeners() {
      if (this._areWindowListenersBound) {
        ...
        (window.removeEventListener(e$5, this._onMove, this._listenerOptions),
          window.removeEventListener(t$6, this._onEnd, this._listenerOptions),
          n$5 && window.removeEventListener(n$5, this._onCancel, this._listenerOptions),
          (this._areWindowListenersBound = !1));
      }
    }
    _resetDrag() {
    ...
    updateSettings(e$5) {
      ...
      let { listenerOptions: t$6, sourceEvents: n$5, startPredicate: r$3 } = e$5,
        i$4 = c$2(n$5),
        a$3 = s$2(t$6);
      (r$3 && this._startPredicate !== r$3 && (this._startPredicate = r$3),
        ((t$6 &&
          (this._listenerOptions.capture !== a$3.capture ||
            this._listenerOptions.passive === a$3.passive)) ||
          (n$5 && this._sourceEvents !== i$4)) &&
          ...
          this.cancel(),
          n$5 && (this._sourceEvents = i$4),
          t$6 && a$3 && (this._listenerOptions = a$3),
    ...
    destroy() {
      this.isDestroyed ||
        ((this.isDestroyed = !0),
        this.cancel(),
        this._emitter.emit(e$2.Destroy, { type: e$2.Destroy }),
        this._emitter.off(),
        this.element.removeEventListener(
          l$1[this._sourceEvents].start,
          this._onStart,
  ...
  var n$3 = class {
    ...
    _start(t$6) {
      this.isDestroyed ||
        this.drag ||
        ((this.drag = this._createDragData(t$6)), this._emitter.emit(e$2.Start, t$6));
    }
    _move(t$6) {
    ...
    _end(t$6) {
      this.drag &&
        (this._updateDragData(t$6), this._emitter.emit(e$2.End, t$6), this._resetDragData());
    }
    _cancel(t$6) {
      this.drag &&
        (this._updateDragData(t$6), this._emitter.emit(e$2.Cancel, t$6), this._resetDragData());
    }
    on(e$5, t$6, n$5) {
      return this._emitter.on(e$5, t$6, n$5);
    }
    ...
    _tick(t$6) {
      if (this.drag)
        if (t$6 && this.drag.time) {
          ...
          let r$3 = this._speed * (this.drag.deltaTime / 1e3),
            i$4 = this._direction.x * r$3,
            a$3 = this._direction.y * r$3;
          (i$4 || a$3) &&
            this._move({
              type: e$2.Move,
              x: this.drag.x + i$4,
  ...
  var a = class extends i$1 {
    constructor(e$5, t$6 = {}) {
      super();
      let {
        startPredicate: n$5 = i$2.startPredicate,
        computeSpeed: r$3 = i$2.computeSpeed,
        cancelOnVisibilityChange: a$3 = i$2.cancelOnVisibilityChange,
        cancelOnBlur: o$4 = i$2.cancelOnBlur,
        startKeys: s$4 = i$2.startKeys,
        moveLeftKeys: c$4 = i$2.moveLeftKeys,
        moveRightKeys: l$4 = i$2.moveRightKeys,
        moveUpKeys: u$4 = i$2.moveUpKeys,
        moveDownKeys: d$2 = i$2.moveDownKeys,
        cancelKeys: f$2 = i$2.cancelKeys,
        endKeys: p$2 = i$2.endKeys,
      } = t$6;
      ((this.element = e$5),
        (this._startKeys = new Set(s$4)),
        (this._cancelKeys = new Set(f$2)),
        (this._endKeys = new Set(p$2)),
        (this._moveLeftKeys = new Set(c$4)),
        (this._moveRightKeys = new Set(l$4)),
        (this._moveUpKeys = new Set(u$4)),
        (this._moveDownKeys = new Set(d$2)),
        (this._moveKeys = new Set([...c$4, ...l$4, ...u$4, ...d$2])),
        (this._moveKeyTimestamps = /* @__PURE__ */ new Map()),
        (this._cancelOnBlur = o$4),
        (this._cancelOnVisibilityChange = a$3),
        (this._computeSpeed = r$3),
        (this._startPredicate = n$5),
    ...
    _updateDirection() {
      let e$5 = r$1(this._moveLeftKeys, this._moveKeyTimestamps),
        t$6 = r$1(this._moveRightKeys, this._moveKeyTimestamps),
        n$5 = r$1(this._moveUpKeys, this._moveKeyTimestamps),
        i$4 = r$1(this._moveDownKeys, this._moveKeyTimestamps),
        a$3 = e$5 === t$6 ? 0 : e$5 < t$6 ? -1 : 1,
        o$4 = n$5 === i$4 ? 0 : n$5 < i$4 ? -1 : 1;
      if (!(a$3 === 0 || o$4 === 0)) {
    ...
    _onKeyDown(t$6) {
      ...
      if (this._moveKeys.has(t$6.key)) {
        (t$6.preventDefault(),
          this._moveKeyTimestamps.get(t$6.key) ||
            (this._moveKeyTimestamps.set(t$6.key, Date.now()), this._updateDirection()));
        return;
      }
    }
    updateSettings(e$5 = {}) {
      ...
      if (
        ...
        [...this._moveKeys].every((t$7, n$5) => e$6[n$5] === t$7) ||
  ...
  function e(
    ...
    return (
      e$5 &&
        ((t$6.width = e$5.width),
        (t$6.height = e$5.height),
        (t$6.x = e$5.x),
        (t$6.y = e$5.y),
        (t$6.left = e$5.x),
        (t$6.top = e$5.y),
        (t$6.right = e$5.x + e$5.width),
        (t$6.bottom = e$5.y + e$5.height)),
      t$6
    );
  }
  ...
  function e$1(
    ...
    let r$3 = Math.max(e$5.x, t$6.x),
      i$4 = Math.min(e$5.x + e$5.width, t$6.x + t$6.width);
    if (i$4 <= r$3) return null;
    let a$3 = Math.max(e$5.y, t$6.y),
      o$4 = Math.min(e$5.y + e$5.height, t$6.y + t$6.height);
    return o$4 <= a$3
      ? null
      : ((n$5.x = r$3), (n$5.y = a$3), (n$5.width = i$4 - r$3), (n$5.height = o$4 - a$3), n$5);
  }
  const t$3 = {
    width: 0,
    height: 0,
  ...
  function n$1(n$5, r$3, i$4) {
    ...
    return a$3
      ? (a$3 / (Math.min(n$5.width, r$3.width) * Math.min(n$5.height, r$3.height))) * 100
      : 0;
  }
  ...
  function getPreciseScrollbarSize(t$6, e$5, n$5) {
    if (n$5 <= 0) return 0;
    if (IS_CHROMIUM) {
      const n$6 = getStyle(t$6, '::-webkit-scrollbar'),
        l$4 = 'x' === e$5 ? n$6.height : n$6.width,
        i$4 = parseFloat(l$4);
  ...
  function getWindowWidth(e$5, r$3 = !1) {
    ...
    const { innerWidth: t$6, document: i$4 } = e$5,
      { documentElement: n$5 } = i$4,
      { clientWidth: c$4 } = n$5;
  ...
  function getElementWidth(t$6, e$5 = BOX_EDGE.border) {
    ...
    return e$5 === BOX_EDGE.margin
      ? ((r$3 += Math.max(0, parseFloat(o$4.marginLeft) || 0)),
        (r$3 += Math.max(0, parseFloat(o$4.marginRight) || 0)),
        r$3)
      : ((r$3 -= parseFloat(o$4.borderLeftWidth) || 0),
        (r$3 -= parseFloat(o$4.borderRightWidth) || 0),
        e$5 === BOX_EDGE.scrollbar
          ? r$3
          : (!isDocumentElement(t$6) &&
              SCROLLABLE_OVERFLOWS.has(o$4.overflowY) &&
              (r$3 -= getPreciseScrollbarSize(t$6, 'y', Math.round(r$3) - t$6.clientWidth)),
            e$5 === BOX_EDGE.padding ||
              ((r$3 -= parseFloat(o$4.paddingLeft) || 0),
              (r$3 -= parseFloat(o$4.paddingRight) || 0)),
            r$3));
  }
  ...
  function getWidth(t$6, i$4 = BOX_EDGE.border) {
    return isWindow(t$6)
      ? getWindowWidth(t$6, INCLUDE_WINDOW_SCROLLBAR[i$4])
      : isDocument(t$6)
        ? getDocumentWidth(t$6)
        : getElementWidth(t$6, i$4);
  }
  ...
  function getWindowHeight(e$5, r$3 = !1) {
    ...
    const { innerHeight: t$6, document: i$4 } = e$5,
      { documentElement: n$5 } = i$4,
      { clientHeight: c$4 } = n$5;
  ...
  function getElementHeight(t$6, e$5 = BOX_EDGE.border) {
    ...
    const o$4 = getStyle(t$6);
    return e$5 === BOX_EDGE.margin
      ? ((r$3 += Math.max(0, parseFloat(o$4.marginTop) || 0)),
        (r$3 += Math.max(0, parseFloat(o$4.marginBottom) || 0)),
        r$3)
      : ((r$3 -= parseFloat(o$4.borderTopWidth) || 0),
        (r$3 -= parseFloat(o$4.borderBottomWidth) || 0),
        e$5 === BOX_EDGE.scrollbar
          ? r$3
          : (!isDocumentElement(t$6) &&
              SCROLLABLE_OVERFLOWS.has(o$4.overflowX) &&
              (r$3 -= getPreciseScrollbarSize(t$6, 'x', Math.round(r$3) - t$6.clientHeight)),
            e$5 === BOX_EDGE.padding ||
              ((r$3 -= parseFloat(o$4.paddingTop) || 0),
              (r$3 -= parseFloat(o$4.paddingBottom) || 0)),
            r$3));
  }
  ...
  function getHeight(t$6, e$5 = BOX_EDGE.border) {
    return isWindow(t$6)
      ? getWindowHeight(t$6, INCLUDE_WINDOW_SCROLLBAR[e$5])
      : isDocument(t$6)
        ? getDocumentHeight(t$6)
        : getElementHeight(t$6, e$5);
  }
  ...
  function getOffsetFromDocument(t$6, o$4 = BOX_EDGE.border) {
    ...
    return o$4 === BOX_EDGE.margin
      ? ((e$5.left -= Math.max(0, parseFloat(l$4.marginLeft) || 0)),
        (e$5.top -= Math.max(0, parseFloat(l$4.marginTop) || 0)),
        e$5)
      : ((e$5.left += parseFloat(l$4.borderLeftWidth) || 0),
        (e$5.top += parseFloat(l$4.borderTopWidth) || 0),
        o$4 === BOX_EDGE.scrollbar ||
          o$4 === BOX_EDGE.padding ||
          ((e$5.left += parseFloat(l$4.paddingLeft) || 0),
          (e$5.top += parseFloat(l$4.paddingTop) || 0)),
        e$5);
  }
  ...
  function getOffset(t$6, e$5) {
    const o$4 = isRectObject(t$6)
      ...
      : Array.isArray(t$6)
        ? getOffsetFromDocument(...t$6)
        : getOffsetFromDocument(t$6);
    if (e$5 && !isDocument(e$5)) {
      const t$7 = isRectObject(e$5)
        ? e$5
        : Array.isArray(e$5)
          ? getOffsetFromDocument(e$5[0], e$5[1])
          : getOffsetFromDocument(e$5);
  ...
  function getRect(t$6, e$5) {
    let i$4 = 0,
      g$2 = 0;
    isRectObject(t$6)
      ? ((i$4 = t$6.width), (g$2 = t$6.height))
      : Array.isArray(t$6)
        ? ((i$4 = getWidth(...t$6)), (g$2 = getHeight(...t$6)))
        : ((i$4 = getWidth(t$6)), (g$2 = getHeight(t$6)));
  ...
  function isIntersecting(t$6, e$5) {
    return !(
      t$6.left + t$6.width <= e$5.left ||
      e$5.left + e$5.width <= t$6.left ||
      t$6.top + t$6.height <= e$5.top ||
      e$5.top + e$5.height <= t$6.top
    );
  }
  ...
  function getDistanceBetweenRects(t$6, e$5) {
    ...
    const n$5 = t$6.left + t$6.width,
      i$4 = t$6.top + t$6.height,
      o$4 = e$5.left + e$5.width,
      s$4 = e$5.top + e$5.height;
    return n$5 <= e$5.left
      ? i$4 <= e$5.top
        ? getDistanceBetweenPoints(n$5, i$4, e$5.left, e$5.top)
        : t$6.top >= s$4
          ? getDistanceBetweenPoints(n$5, t$6.top, e$5.left, s$4)
          : e$5.left - n$5
      : t$6.left >= o$4
        ? i$4 <= e$5.top
          ? getDistanceBetweenPoints(t$6.left, i$4, o$4, e$5.top)
          : t$6.top >= s$4
            ? getDistanceBetweenPoints(t$6.left, t$6.top, o$4, s$4)
            : t$6.left - o$4
        : i$4 <= e$5.top
          ? e$5.top - i$4
          : t$6.top - s$4;
  ...
  var o$1 = class {
    constructor(
      e$5,
      {
        batchSize: t$6 = 100,
        minBatchCount: n$5 = 0,
        maxBatchCount: r$3 = 2 ** 53 - 1,
        initialBatchCount: i$4 = 0,
        shrinkThreshold: a$3 = 2,
        onRelease: o$4,
      } = {},
    ) {
      ((this._batchSize = Math.floor(Math.max(t$6, 1))),
        (this._minSize = Math.floor(Math.max(n$5, 0)) * this._batchSize),
        (this._maxSize = Math.floor(
          Math.min(Math.max(r$3 * this._batchSize, this._batchSize), 2 ** 53 - 1),
        )),
        (this._shrinkThreshold = Math.floor(Math.max(a$3, 1) * this._batchSize)),
        (this._data = Array(Math.floor(Math.max(Math.max(i$4, n$5) * this._batchSize, 0)))),
        (this._index = 0),
        (this._getItem = e$5),
        (this._onRelease = o$4));
    }
    get(...e$5) {
      ...
      if (this._index === 0) {
        let e$6 = this._data.length,
          t$6 = Math.min(this._batchSize, this._maxSize - e$6);
    ...
    release(e$5) {
      if (
        ...
        (this._onRelease && this._onRelease(e$5),
        (this._data[this._index++] = e$5),
  ...
  function g(e$5, t$6) {
    return !(
      e$5.x + e$5.width <= t$6.x ||
      t$6.x + t$6.width <= e$5.x ||
      e$5.y + e$5.height <= t$6.y ||
      t$6.y + t$6.height <= e$5.y
    );
  }
  const _ = {
      width: 0,
  ...
  function w(e$5) {
    switch (e$5) {
      ...
      case S.down:
        return `down`;
      default:
        throw Error(`Unknown direction value: ${e$5}`);
    }
  }
  function T(e$5, t$6, n$5) {
    ...
    return (
      ...
      (a$3 = Math.max(0, a$3)),
      (o$4 = Math.max(0, o$4)),
      (n$5.width = e$5.width + r$3 + i$4),
      (n$5.height = e$5.height + a$3 + o$4),
      (n$5.x = e$5.x - r$3),
      (n$5.y = e$5.y - a$3),
      n$5
    );
  ...
  var k = class {
    ...
    A = class {
      ...
      addRequest(e$5) {
        (y.x & e$5.direction
          ? (this.requestX && this.removeRequest(this.requestX), (this.requestX = e$5))
          : (this.requestY && this.removeRequest(this.requestY), (this.requestY = e$5)),
          (e$5.action = this));
      }
      removeRequest(e$5) {
        this.requestX === e$5
          ? ((this.requestX = null), (e$5.action = null))
          : this.requestY === e$5 && ((this.requestY = null), (e$5.action = null));
      }
      computeScrollValues() {
        this.element &&
    ...
    j = class {
      ...
      computeNextScrollValue() {
        let e$5 = this.speed * (this.deltaTime / 1e3),
          t$6 = b.forward & this.direction ? this.value + e$5 : this.value - e$5;
        return Math.max(0, Math.min(t$6, this.maxValue));
      }
      computeSpeed() {
        if (!this.item || !this.element) return 0;
        let { speed: e$5 } = this.item;
        return typeof e$5 == `function`
  ...
  function M(e$5 = 500, t$6 = 0.5, n$5 = 0.25) {
    let r$3 = e$5 * (t$6 > 0 ? 1 / t$6 : Infinity),
      i$4 = e$5 * (n$5 > 0 ? 1 / n$5 : Infinity);
    return function (t$7, n$6) {
      ...
      let s$4 = a$3;
      return o$4 < a$3
        ? ((s$4 = o$4 + r$3 * (n$6.deltaTime / 1e3)), Math.min(a$3, s$4))
        : ((s$4 = o$4 - i$4 * (n$6.deltaTime / 1e3)), Math.max(a$3, s$4));
    };
  }
  var N = class {
    constructor(e$5 = {}) {
      ...
      ((this.items = []),
        ...
        (this._requestPool = new o$1((e$6) => e$6 || new j(), {
          initialBatchCount: 1,
          minBatchCount: 1,
    ...
    _frameRead(e$5) {
      this._isDestroyed ||
        (e$5 && this._tickTime
          ? ((this._tickDeltaTime = e$5 - this._tickTime),
            (this._tickTime = e$5),
            this._updateItems(),
            this._updateRequests(),
            this._updateActions())
          : ((this._tickTime = e$5), (this._tickDeltaTime = 0)));
    }
    _frameWrite() {
    ...
    _startTicking() {
      this._isTicking ||
        ((this._isTicking = !0),
        n.on(t$1.read, this._frameRead, this._frameRead),
        n.on(t$1.write, this._frameWrite, this._frameWrite));
    }
    _stopTicking() {
      this._isTicking &&
        ((this._isTicking = !1),
        (this._tickTime = 0),
        (this._tickDeltaTime = 0),
        n.off(t$1.read, this._frameRead),
        n.off(t$1.write, this._frameWrite));
    }
    _requestItemScroll(e$5, t$6, n$5, r$3, i$4, a$3, o$4) {
      let s$4 = this._requests[t$6],
        c$4 = s$4.get(e$5);
      (c$4
        ? (c$4.element !== n$5 || c$4.direction !== r$3) && c$4.reset()
        : ((c$4 = this._requestPool.get()), s$4.set(e$5, c$4)),
        (c$4.item = e$5),
        (c$4.element = n$5),
        (c$4.direction = r$3),
        (c$4.threshold = i$4),
    ...
    _cancelItemScroll(e$5, t$6) {
      let n$5 = this._requests[t$6],
        r$3 = n$5.get(e$5);
      r$3 &&
        (r$3.action && r$3.action.removeRequest(r$3),
        this._requestPool.release(r$3),
        n$5.delete(e$5));
    }
    _checkItemOverlap(e$5, t$6, n$5) {
      ...
      let c$4 = this._itemData.get(e$5),
        u$4 = c$4?.directionX,
        v$3 = c$4?.directionY;
      if (!u$4 && !v$3) {
        (t$6 && this._cancelItemScroll(e$5, y.x), n$5 && this._cancelItemScroll(e$5, y.y));
      ...
      for (; B < o$4.length; B++) {
        let e$6 = o$4[B],
          c$5 = typeof e$6.threshold == `number` ? e$6.threshold : 50,
          y$2 = !!(t$6 && u$4 && e$6.axis !== `y`),
          V = !!(n$5 && v$3 && e$6.axis !== `x`),
          H = e$6.priority || 0;
        if ((!y$2 || H < x$2) && (!V || H < P$1)) continue;
        let U = d(e$6.element || e$6),
          W = y$2 ? p(U) : -1,
          G = V ? h(U) : -1;
        if (W <= 0 && G <= 0) continue;
        let K = t$2([U, `padding`], window),
          q = n$1(s$4, K) || -Infinity;
        if (q === -Infinity)
          if (e$6.padding && g(s$4, T(K, e$6.padding, _))) q = -(l(s$4, K) || 0);
          else continue;
        if (y$2 && H >= x$2 && W > 0 && (H > x$2 || q > k$2)) {
          let e$7 = 0,
            t$7 = C.none,
            n$6 = D(c$5, K.width),
            r$3 = O(n$6, a$3, s$4.width, K.width);
          (u$4 === C.right
            ? ((e$7 = K.x + K.width + r$3 - (s$4.x + s$4.width)),
              e$7 <= n$6 && !E(f(U), W) && (t$7 = C.right))
            : u$4 === C.left &&
              ((e$7 = s$4.x - (K.x - r$3)), e$7 <= n$6 && f(U) > 0 && (t$7 = C.left)),
            t$7 &&
              ((b$2 = U), (x$2 = H), (w$2 = n$6), (k$2 = q), (A$2 = t$7), (j$2 = e$7), (M$2 = W)));
        }
        if (V && H >= P$1 && G > 0 && (H > P$1 || q > I$1)) {
          let e$7 = 0,
            t$7 = S.none,
            n$6 = D(c$5, K.height),
            r$3 = O(n$6, a$3, s$4.height, K.height);
          (v$3 === C.down
            ? ((e$7 = K.y + K.height + r$3 - (s$4.y + s$4.height)),
              e$7 <= n$6 && !E(m(U), G) && (t$7 = C.down))
            : v$3 === C.up && ((e$7 = s$4.y - (K.y - r$3)), e$7 <= n$6 && m(U) > 0 && (t$7 = C.up)),
            t$7 &&
              ((N$2 = U), (P$1 = H), (F$1 = n$6), (I$1 = q), (L$1 = t$7), (R$1 = e$7), (z$1 = G)));
        }
      }
      (t$6 &&
        (b$2 && A$2
          ? this._requestItemScroll(e$5, y.x, b$2, A$2, w$2, j$2, M$2)
          : this._cancelItemScroll(e$5, y.x)),
        n$5 &&
          (N$2 && L$1
            ? this._requestItemScroll(e$5, y.y, N$2, L$1, F$1, R$1, z$1)
            : this._cancelItemScroll(e$5, y.y)));
    }
    _updateScrollRequest(e$5) {
      let { inertAreaSize: t$6, smoothStop: n$5, targets: a$3, clientRect: o$4 } = e$5.item,
        s$4 = null,
        c$4 = 0;
      for (; c$4 < a$3.length; c$4++) {
        let n$6 = a$3[c$4],
          l$4 = d(n$6.element || n$6);
        ...
        let S$2 = D(
            typeof n$6.threshold == `number` ? n$6.threshold : 50,
            u$4 ? x$2.width : x$2.height,
          ),
          w$2 = O(S$2, t$6, u$4 ? o$4.width : o$4.height, u$4 ? x$2.width : x$2.height),
          k$2 = 0;
        if (
          ((k$2 =
            e$5.direction === C.left
              ? o$4.x - (x$2.x - w$2)
              : e$5.direction === C.right
      ...
      return (
        n$5 === !0 && e$5.speed > 0
          ? (s$4 === null && (s$4 = e$5.hasReachedEnd()), (e$5.isEnding = !s$4))
          : (e$5.isEnding = !1),
        e$5.isEnding
      );
    }
    _updateItems() {
      for (let e$5 = 0; e$5 < this.items.length; e$5++) {
        let t$6 = this.items[e$5],
          n$5 = this._itemData.get(t$6),
          { x: r$3, y: i$4 } = t$6.position,
          a$3 = n$5.positionX,
          o$4 = n$5.positionY;
        (r$3 === a$3 && i$4 === o$4) ||
          ((n$5.directionX = r$3 > a$3 ? C.right : r$3 < a$3 ? C.left : n$5.directionX),
          (n$5.directionY = i$4 > o$4 ? C.down : i$4 < o$4 ? C.up : n$5.directionY),
          (n$5.positionX = r$3),
          (n$5.positionY = i$4),
          n$5.overlapCheckRequestTime === 0 && (n$5.overlapCheckRequestTime = this._tickTime));
      }
    }
    _updateRequests() {
      let e$5 = this.items,
        t$6 = this._requests[y.x],
        n$5 = this._requests[y.y],
        r$3 = 0;
      for (; r$3 < e$5.length; r$3++) {
        let i$4 = e$5[r$3],
          a$3 = this._itemData.get(i$4),
          o$4 = a$3.overlapCheckRequestTime,
          s$4 = o$4 > 0 && this._tickTime - o$4 > this.settings.overlapCheckInterval,
          c$4 = !0,
          l$4 = t$6.get(i$4);
        l$4 &&
          l$4.isActive &&
          ((c$4 = !this._updateScrollRequest(l$4)),
          c$4 && ((s$4 = !0), this._cancelItemScroll(i$4, y.x)));
        let u$4 = !0,
          d$2 = n$5.get(i$4);
        (d$2 &&
          d$2.isActive &&
          ((u$4 = !this._updateScrollRequest(d$2)),
          u$4 && ((s$4 = !0), this._cancelItemScroll(i$4, y.y))),
          s$4 && ((a$3.overlapCheckRequestTime = 0), this._checkItemOverlap(i$4, c$4, u$4)));
      }
    }
    _requestAction(e$5, t$6) {
      ...
      ((r$3 ||= this._actionPool.get()),
        (r$3.element = e$5.element),
        r$3.addRequest(e$5),
        e$5.tick(this._tickDeltaTime),
        this._actions.push(r$3));
    }
    _updateActions() {
      let e$5 = 0;
      for (e$5 = 0; e$5 < this.items.length; e$5++) {
        let t$6 = this.items[e$5],
          n$5 = this._requests[y.x].get(t$6),
          r$3 = this._requests[y.y].get(t$6);
    ...
    _applyActions() {
      ...
      let e$5 = 0;
      for (e$5 = 0; e$5 < this._actions.length; e$5++)
        (this._actions[e$5].scroll(), this._actionPool.release(this._actions[e$5]));
      this._actions.length = 0;
    }
    addItem(e$5) {
      if (this._isDestroyed || this._itemData.has(e$5)) return;
      let { x: t$6, y: n$5 } = e$5.position,
        r$3 = new k();
      ((r$3.positionX = t$6),
        (r$3.positionY = n$5),
        (r$3.directionX = C.none),
        (r$3.directionY = C.none),
        (r$3.overlapCheckRequestTime = this._tickTime),
        this._itemData.set(e$5, r$3),
        this.items.push(e$5),
    ...
    removeItem(e$5) {
      ...
      t$6 !== -1 &&
        (this._requests[y.x].get(e$5) &&
          (this._cancelItemScroll(e$5, y.x), this._requests[y.x].delete(e$5)),
        this._requests[y.y].get(e$5) &&
          (this._cancelItemScroll(e$5, y.y), this._requests[y.y].delete(e$5)),
        this._itemData.delete(e$5),
        this.items.splice(t$6, 1),
    ...
    destroy() {
      this._isDestroyed ||=
        (this.items.forEach((e$5) => this.removeItem(e$5)),
  ...
  var o = class {
      ...
      get position() {
        let e$5 = this._position,
          { getPosition: t$6 } = this._getSettings();
        return (
          typeof t$6 == `function`
            ? Object.assign(e$5, t$6(this._draggable))
            : ((e$5.x = 0), (e$5.y = 0)),
          e$5
        );
      }
      get clientRect() {
        let e$5 = this._clientRect,
          { getClientRect: t$6 } = this._getSettings();
        return (
          typeof t$6 == `function`
            ? Object.assign(e$5, t$6(this._draggable))
            : ((e$5.width = 0), (e$5.height = 0), (e$5.x = 0), (e$5.y = 0)),
          e$5
        );
      }
      get inertAreaSize() {
    ...
    s = class {
      constructor(t$6, r$3 = {}) {
        ((this.name = `autoscroll`),
          (this.version = `0.0.3`),
          (this.settings = this._parseSettings(r$3)),
          (this._autoScrollProxy = null),
          t$6.on(L.Start, () => {
            this._autoScrollProxy ||
              ((this._autoScrollProxy = new o(this, t$6)), t.addItem(this._autoScrollProxy));
          }),
          t$6.on(L.End, () => {
      ...
      _parseSettings(e$5, t$6 = a$1()) {
        let {
          targets: n$5 = t$6.targets,
          inertAreaSize: r$3 = t$6.inertAreaSize,
          speed: i$4 = t$6.speed,
          smoothStop: o$4 = t$6.smoothStop,
          getPosition: s$4 = t$6.getPosition,
          getClientRect: c$4 = t$6.getClientRect,
          onStart: l$4 = t$6.onStart,
          onStop: u$4 = t$6.onStop,
        } = e$5 || {};
        return {
          targets: n$5,
          inertAreaSize: r$3,
