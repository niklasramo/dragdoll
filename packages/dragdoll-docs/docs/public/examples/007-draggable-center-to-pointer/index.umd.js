...
var f = class {
	...
	set(e$3, t$2) {
		this._cache.set(e$3, t$2), this._validation.add(e$3);
	}
	get(e$3) {
...
var O = class {
	...
	constructor(e$3, t$2) {
		...
		let l$3 = t$2.settings.container, u$3 = (typeof l$3 == `function` ? l$3({
			draggable: t$2,
			drag: r$3,
			element: e$3
		}) : l$3) || c$2;
		...
		let d$2 = getOffsetContainer(e$3) || e$3;
		this.elementOffsetContainer = d$2, this.dragOffsetContainer = u$3 === c$2 ? d$2 : getOffsetContainer(e$3, { container: u$3 });
		{
		...
		let f$1 = t$2.settings.frozenStyles({
			draggable: t$2,
			drag: r$3,
			item: this,
			style: i$3
		...
		if (Array.isArray(f$1)) if (f$1.length) {
			let e$4 = {};
			for (let t$3 of f$1) e$4[t$3] = i$3[t$3];
...
const F = {
	...
	applyPosition: ({ item: e$3, phase: t$2 }) => {
		let n$4 = t$2 === L.End || t$2 === L.EndAlign, [r$3, i$3] = e$3.getContainerMatrix(), [a$2, o$2] = e$3.getDragContainerMatrix(), { position: s$2, alignmentOffset: c$2, containerOffset: l$3, elementTransformMatrix: d$2, elementTransformOrigin: f$1, elementOffsetMatrix: p$1 } = e$3, { x: m$1, y: h$1, z: g$1 } = f$1, _$2 = !d$2.isIdentity && (m$1 !== 0 || h$1 !== 0 || g$1 !== 0), v$2 = s$2.x + c$2.x + l$3.x, y$1 = s$2.y + c$2.y + l$3.y;
...
var B = class {
	...
	constructor(e$3, t$2 = {}) {
		...
		this.id = n$4, this._sensors = e$3, this.settings = this._parseSettings(r$3), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$4) => {
			this._bindSensor(e$4);
		});
	}
	get sensors() {
	...
	set sensors(e$3) {
		let t$2 = this._sensors;
		if (e$3 === t$2) return;
		let n$4 = t$2.filter((t$3) => !e$3.includes(t$3)), r$3 = e$3.filter((e$4) => !t$2.includes(e$4));
		this._sensors = e$3, n$4.forEach((e$4) => {
			this._unbindSensor(e$4);
		}), r$3.forEach((e$4) => {
			this._bindSensor(e$4);
		});
		let i$3 = this.drag?.sensor;
		i$3 && n$4.includes(i$3) && this.stop();
	}
	_bindSensor(e$3) {
		this._sensorData.set(e$3, {
			predicateState: P.Pending,
			predicateEvent: null,
			onMove: (t$3) => this._onMove(t$3, e$3),
			onEnd: (t$3) => this._onEnd(t$3, e$3)
		});
		let { onMove: t$2, onEnd: n$4 } = this._sensorData.get(e$3);
		e$3.on(e.Start, t$2, t$2), e$3.on(e.Move, t$2, t$2), e$3.on(e.Cancel, n$4, n$4), e$3.on(e.End, n$4, n$4), e$3.on(e.Destroy, n$4, n$4);
	}
	_unbindSensor(e$3) {
		let t$2 = this._sensorData.get(e$3);
		if (!t$2) return;
		let { onMove: n$4, onEnd: r$3 } = t$2;
		e$3.off(e.Start, n$4), e$3.off(e.Move, n$4), e$3.off(e.Cancel, r$3), e$3.off(e.End, r$3), e$3.off(e.Destroy, r$3), this._sensorData.delete(e$3);
	}
	_parseSettings(e$3, t$2 = z) {
		let { container: n$4 = t$2.container, startPredicate: r$3 = t$2.startPredicate, elements: i$3 = t$2.elements, frozenStyles: a$2 = t$2.frozenStyles, positionModifiers: o$2 = t$2.positionModifiers, applyPosition: s$2 = t$2.applyPosition, computeClientRect: c$2 = t$2.computeClientRect, sensorProcessingMode: l$3 = t$2.sensorProcessingMode, dndGroups: u$3 = t$2.dndGroups, onPrepareStart: d$2 = t$2.onPrepareStart, onStart: f$1 = t$2.onStart, onPrepareMove: p$1 = t$2.onPrepareMove, onMove: m$1 = t$2.onMove, onEnd: h$1 = t$2.onEnd, onDestroy: g$1 = t$2.onDestroy } = e$3 || {};
		return {
			container: n$4,
			startPredicate: r$3,
			elements: i$3,
	...
	_applyStart() {
		let e$3 = this.drag;
		if (!(!e$3 || this._startPhase !== N.FinishPrepare)) {
			...
			for (let t$2 of e$3.items) {
				...
				i$3.x += d$1(t$2.clientRect.x - r$3.x, 3), i$3.y += d$1(t$2.clientRect.y - r$3.y, 3);
			}
			for (let t$2 of e$3.items) {
	...
	_prepareAlign() {
		let { drag: e$3 } = this;
		if (!(!e$3 || e$3.isEnded)) for (let t$2 of e$3.items) {
	...
	_applyAlign() {
		let { drag: e$3 } = this;
		if (!(!e$3 || e$3.isEnded)) for (let t$2 of e$3.items) t$2._alignDiff.x = 0, t$2._alignDiff.y = 0, this.settings.applyPosition({
			phase: L.Align,
			draggable: this,
			drag: e$3,
			item: t$2
	...
	stop() {
		...
		if (!(!n$4 || n$4.isEnded)) {
			...
			n$4.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N.None, r$1.off(n$1.read, this._startId), r$1.off(n$1.write, this._startId), r$1.off(n$1.read, this._moveId), r$1.off(n$1.write, this._moveId), r$1.off(n$1.read, this._alignId), r$1.off(n$1.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
			...
			for (let e$3 of n$4.items) if (e$3.elementContainer !== e$3.dragContainer) {
				...
				e$3.alignmentOffset.x = d$1(e$3.clientRect.x - t$2.x, 3), e$3.alignmentOffset.y = d$1(e$3.clientRect.y - t$2.y, 3);
			}
	...
	align(n$4 = !1) {
		!this.drag || this.drag.isEnded || (n$4 || this.settings.sensorProcessingMode === I.Immediate ? (this._prepareAlign(), this._applyAlign()) : (r$1.once(n$1.read, this._prepareAlign, this._alignId), r$1.once(n$1.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensors.forEach((e$3) => {
			this._unbindSensor(e$3);
...
const l = {
	...
	listenerOptions: {},
	sourceEvents: `auto`,
	startPredicate: (e$3) => !(`button` in e$3 && e$3.button > 0)
};
var d = class {
	element;
	drag;
	...
	_emitter;
	constructor(e$3, t$2 = {}) {
		let { listenerOptions: n$4 = u.listenerOptions, sourceEvents: i$3 = u.sourceEvents, startPredicate: a$2 = u.startPredicate } = t$2;
	...
	updateElement(e$3) {
		this.isDestroyed || this.element === e$3 || (this.element.removeEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), e$3.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions), this.element = e$3);
	}
	updateSettings(e$3) {
...
var a = class extends i {
	...
	constructor(e$3, t$2 = {}) {
		...
		this.element = e$3, this._startKeys = new Set(s$2), this._cancelKeys = new Set(f$1), this._endKeys = new Set(p$1), this._moveLeftKeys = new Set(c$2), this._moveRightKeys = new Set(l$3), this._moveUpKeys = new Set(u$3), this._moveDownKeys = new Set(d$2), this._moveKeys = new Set([
			...c$2,
			...l$3,
			...u$3,
			...d$2
	...
	updateElement(e$3) {
		this.isDestroyed || this.element === e$3 || (this._cancelOnBlur && (this.element?.removeEventListener(`blur`, this._blurCancelHandler), e$3?.addEventListener(`blur`, this._blurCancelHandler)), this.element = e$3);
	}
	updateSettings(e$3) {
		if (this.isDestroyed) return;
...
new B([new d(element), new a(element)], {
	...
	positionModifiers: [(change, { drag, item, phase }) => {
		if (phase === "start" && drag.sensor instanceof d && drag.items[0].element === item.element) {
