...
let n$2 = new l$5({ phases: [t.read, t.write] });

//#endregion
//#region ../dragdoll/dist/create-full-rect-ABJfaR4O.js
function e$5(e$6, t$7 = {
	width: 0,
	height: 0,
	x: 0,
	y: 0,
...
function n$5(n$7, r$4, i$5) {
	if (i$5 ||= e$2(n$7, r$4, t$6), !i$5) return 0;
...
function l$4(e$6, t$7) {
	return getDistance(e$5(e$6, s$5), e$5(t$7, c$5));
}
function u$4(e$6) {
...
function E$1(e$6, t$7) {
	return Math.ceil(e$6) >= Math.floor(t$7);
}
function D$1(e$6, t$7) {
	return Math.min(t$7 / 2, e$6);
}
function O$1(e$6, t$7, n$7, r$4) {
...
var k$1 = class {
	...
	computeNextScrollValue() {
		let e$6 = this.speed * (this.deltaTime / 1e3), t$7 = b$1.forward & this.direction ? this.value + e$6 : this.value - e$6;
...
var N = class {
	...
	_startTicking() {
		this._isTicking || (this._isTicking = !0, n$2.on(t.read, this._frameRead, this._frameRead), n$2.on(t.write, this._frameWrite, this._frameWrite));
	}
	_stopTicking() {
		this._isTicking && (this._isTicking = !1, this._tickTime = 0, this._tickDeltaTime = 0, n$2.off(t.read, this._frameRead), n$2.off(t.write, this._frameWrite));
	}
	...
	_checkItemOverlap(e$6, t$7, n$7) {
		...
		if (!o$4.length) {
			t$7 && this._cancelItemScroll(e$6, y$2.x), n$7 && this._cancelItemScroll(e$6, y$2.y);
			return;
		}
		...
		for (; B$1 < o$4.length; B$1++) {
			let e$7 = o$4[B$1], c$7 = typeof e$7.threshold == `number` ? e$7.threshold : 50, y$3 = !!(t$7 && u$6 && e$7.axis !== `y`), V = !!(n$7 && v$4 && e$7.axis !== `x`), H = e$7.priority || 0;
			if ((!y$3 || H < x$2) && (!V || H < P$1)) continue;
			let U = d$2(e$7.element || e$7), W = y$3 ? p$2(U) : -1, G = V ? h$2(U) : -1;
			if (W <= 0 && G <= 0) continue;
			let K = t$5([U, `padding`], window), q = n$5(s$6, K) || -Infinity;
			if (q === -Infinity) if (e$7.padding && g$2(s$6, T$1(K, e$7.padding, _$2))) q = -(l$4(s$6, K) || 0);
			else continue;
			if (y$3 && H >= x$2 && W > 0 && (H > x$2 || q > k$2)) {
				let e$8 = 0, t$8 = C$1.none, n$8 = D$1(c$7, K.width), r$4 = O$1(n$8, a$4, s$6.width, K.width);
				u$6 === C$1.right ? (e$8 = K.x + K.width + r$4 - (s$6.x + s$6.width), e$8 <= n$8 && !E$1(f$2(U), W) && (t$8 = C$1.right)) : u$6 === C$1.left && (e$8 = s$6.x - (K.x - r$4), e$8 <= n$8 && f$2(U) > 0 && (t$8 = C$1.left)), t$8 && (b$2 = U, x$2 = H, w$2 = n$8, k$2 = q, A$2 = t$8, j$2 = e$8, M$2 = W);
			}
			if (V && H >= P$1 && G > 0 && (H > P$1 || q > I$1)) {
				let e$8 = 0, t$8 = S$1.none, n$8 = D$1(c$7, K.height), r$4 = O$1(n$8, a$4, s$6.height, K.height);
				v$4 === C$1.down ? (e$8 = K.y + K.height + r$4 - (s$6.y + s$6.height), e$8 <= n$8 && !E$1(m$2(U), G) && (t$8 = C$1.down)) : v$4 === C$1.up && (e$8 = s$6.y - (K.y - r$4), e$8 <= n$8 && m$2(U) > 0 && (t$8 = C$1.up)), t$8 && (N$2 = U, P$1 = H, F$1 = n$8, I$1 = q, L$1 = t$8, R$1 = e$8, z$1 = G);
			}
		}
		t$7 && (b$2 && A$2 ? this._requestItemScroll(e$6, y$2.x, b$2, A$2, w$2, j$2, M$2) : this._cancelItemScroll(e$6, y$2.x)), n$7 && (N$2 && L$1 ? this._requestItemScroll(e$6, y$2.y, N$2, L$1, F$1, R$1, z$1) : this._cancelItemScroll(e$6, y$2.y));
	}
	_updateScrollRequest(e$6) {
		...
		for (; c$6 < a$4.length; c$6++) {
			...
			if (v$4 <= 0) break;
			let x$2 = t$5([l$6, `padding`], window);
			if ((n$5(o$4, x$2) || -Infinity) === -Infinity) {
				let e$7 = n$8.scrollPadding || n$8.padding;
				if (!(e$7 && g$2(o$4, T$1(x$2, e$7, _$2)))) break;
			}
			let S$2 = D$1(typeof n$8.threshold == `number` ? n$8.threshold : 50, u$6 ? x$2.width : x$2.height), w$2 = O$1(S$2, t$7, u$6 ? o$4.width : o$4.height, u$6 ? x$2.width : x$2.height), k$2 = 0;
	...
	_updateItems() {
		for (let e$6 = 0; e$6 < this.items.length; e$6++) {
			...
			r$4 === a$4 && i$5 === o$4 || (n$7.directionX = r$4 > a$4 ? C$1.right : r$4 < a$4 ? C$1.left : n$7.directionX, n$7.directionY = i$5 > o$4 ? C$1.down : i$5 < o$4 ? C$1.up : n$7.directionY, n$7.positionX = r$4, n$7.positionY = i$5, n$7.overlapCheckRequestTime === 0 && (n$7.overlapCheckRequestTime = this._tickTime));
		}
	}
	_updateRequests() {
		let e$6 = this.items, t$7 = this._requests[y$2.x], n$7 = this._requests[y$2.y], r$4 = 0;
	...
	_requestAction(e$6, t$7) {
		let n$7 = t$7 === y$2.x, r$4 = null, i$5 = 0;
	...
	_updateActions() {
		...
		for (e$6 = 0; e$6 < this.items.length; e$6++) {
			let t$7 = this.items[e$6], n$7 = this._requests[y$2.x].get(t$7), r$4 = this._requests[y$2.y].get(t$7);
			n$7 && this._requestAction(n$7, y$2.x), r$4 && this._requestAction(r$4, y$2.y);
		}
	...
	addItem(e$6) {
		...
		let { x: t$7, y: n$7 } = e$6.position, r$4 = new k$1();
		r$4.positionX = t$7, r$4.positionY = n$7, r$4.directionX = C$1.none, r$4.directionY = C$1.none, r$4.overlapCheckRequestTime = this._tickTime, this._itemData.set(e$6, r$4), this.items.push(e$6), this._isTicking || this._startTicking();
	}
	removeItem(e$6) {
		if (this._isDestroyed) return;
		let t$7 = this.items.indexOf(e$6);
		t$7 !== -1 && (this._requests[y$2.x].get(e$6) && (this._cancelItemScroll(e$6, y$2.x), this._requests[y$2.x].delete(e$6)), this._requests[y$2.y].get(e$6) && (this._cancelItemScroll(e$6, y$2.y), this._requests[y$2.y].delete(e$6)), this._itemData.delete(e$6), this.items.splice(t$7, 1), this._isTicking && !this.items.length && this._stopTicking());
	}
	isDestroyed() {
...
var a$3 = class {
	...
	_checkCollision(r$4, i$5, a$4) {
		let o$4 = r$4.getClientRect(), s$6 = i$5.getClientRect();
		if (!o$4) return null;
	...
	getCollisionDataPool(e$6) {
		...
		return t$7 || (t$7 = this._collisionDataPoolCache.pop() || new r$2((e$7) => e$7 || this._createCollisionData()), this._collisionDataPoolMap.set(e$6, t$7)), t$7;
	}
...
function t$4(t$7) {
	let n$7 = e$4.get(t$7)?.deref();
	return n$7 || (n$7 = window.getComputedStyle(t$7, null), e$4.set(t$7, new WeakRef(n$7))), n$7;
}
...
const s$4 = `visible`;
function c$4(e$6, t$7, n$7 = []) {
	let r$4 = t$7 ? e$6 : e$6?.parentNode;
	for (n$7.length = 0; r$4 && !e$3(r$4);) if (r$4 instanceof Element) {
		let e$7 = t$4(r$4);
		e$7.overflowY === s$4 || e$7.overflowX === s$4 || n$7.push(r$4), r$4 = r$4.parentNode;
...
function g$1(e$6) {
	if (!f$1.length) {
		...
		t$7 ? c$4(t$7, !0, f$1) : f$1.push(window);
	}
}
function _$1(e$6) {
	p$1.length || c$4(e$6.element, !1, p$1);
}
function v$2(t$7, r$4 = n$6()) {
	n$6(t$7.length ? t$5([t$7[0], `padding`], window) : d$1, r$4);
	for (let a$4 = 1; a$4 < t$7.length; a$4++) {
		let o$4 = t$7[a$4];
		if (!e$2(r$4, t$5([o$4, `padding`], window), r$4)) {
			n$6(u$3, r$4);
			break;
		}
	}
...
var y = class extends a$3 {
	...
	_checkCollision(n$7, r$4, a$4) {
		let o$4 = this._dragStates.get(n$7);
		if (!o$4) return null;
		let s$6 = n$7.getClientRect(), c$6 = r$4.getClientRect();
		if (!s$6 || !c$6) return null;
		let u$6 = o$4.clipMaskKeyMap.get(r$4);
		if (!u$6) {
			let e$6 = this._visibilityLogic === `relative`;
			if (p$1.length = 0, m$1.length = 0, h$1.length = 0, _$1(r$4), u$6 = p$1[0] || window, o$4.clipMaskKeyMap.set(r$4, u$6), !o$4.clipMaskMap.has(u$6)) {
				if (g$1(n$7), e$6) {
					let e$7 = window;
					for (let t$8 of p$1) if (f$1.includes(t$8)) {
						e$7 = t$8;
						break;
					}
					for (let t$8 of f$1) {
				...
				let t$7 = e$6 || !l$3 ? v$2(m$1) : n$6(l$3), r$5 = v$2(h$1);
				!e$6 && !l$3 && (l$3 = t$7), o$4.clipMaskMap.set(u$6, [t$7, r$5]);
			}
		...
		return b$2 <= 0 ? null : (a$4.droppableId = r$4.id, n$6(c$6, a$4.droppableRect), n$6(s$6, a$4.draggableRect), a$4.intersectionScore = b$2, a$4);
	}
	_sortCollisions(e$6, t$7) {
		return t$7.sort((e$7, t$8) => {
			let n$7 = t$8.intersectionScore - e$7.intersectionScore;
...
const e$1 = typeof window < `u` && window.document !== void 0, t$2 = e$1 && `ontouchstart` in window, n$4 = e$1 && !!window.PointerEvent;
...
var f = class {
	...
	constructor(e$6, t$7) {
		this.sensor = e$6, this.startEvent = t$7, this.prevMoveEvent = t$7, this.moveEvent = t$7, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f(), this._clientOffsetCache = new f();
	}
};
function m(e$6, t$7, n$7 = !1) {
	let { style: r$4 } = e$6;
...
function g(e$6, t$7 = {
	...
	let { x: r$4, y: i$5 } = e$6.getBoundingClientRect(), a$4 = t$4(e$6);
	return t$7.x = r$4 + (parseFloat(a$4.borderLeftWidth) || 0), t$7.y = i$5 + (parseFloat(a$4.borderTopWidth) || 0), t$7;
}
function _(e$6) {
	let t$7 = t$4(e$6), r$4 = parseFloat(t$7.height) || 0;
	return t$7.boxSizing === `border-box` ? r$4 : (r$4 += parseFloat(t$7.borderTopWidth) || 0, r$4 += parseFloat(t$7.borderBottomWidth) || 0, r$4 += parseFloat(t$7.paddingTop) || 0, r$4 += parseFloat(t$7.paddingBottom) || 0, e$6 instanceof HTMLElement && (r$4 += e$6.offsetHeight - e$6.clientHeight), r$4);
}
function v$1(e$6) {
	let t$7 = t$4(e$6), r$4 = parseFloat(t$7.width) || 0;
	return t$7.boxSizing === `border-box` ? r$4 : (r$4 += parseFloat(t$7.borderLeftWidth) || 0, r$4 += parseFloat(t$7.borderRightWidth) || 0, r$4 += parseFloat(t$7.paddingLeft) || 0, r$4 += parseFloat(t$7.paddingRight) || 0, e$6 instanceof HTMLElement && (r$4 += e$6.offsetWidth - e$6.clientWidth), r$4);
}
function y$1(e$6, t$7 = !1) {
	let { translate: r$4, rotate: i$5, scale: a$4, transform: o$4 } = t$4(e$6), s$6 = ``;
	if (r$4 && r$4 !== `none`) {
		let [t$8 = `0px`, n$7 = `0px`, i$6] = r$4.split(` `);
		t$8.includes(`%`) && (t$8 = `${parseFloat(t$8) / 100 * v$1(e$6)}px`), n$7.includes(`%`) && (n$7 = `${parseFloat(n$7) / 100 * _(e$6)}px`), i$6 ? s$6 += `translate3d(${t$8},${n$7},${i$6})` : s$6 += `translate(${t$8},${n$7})`;
	}
	if (i$5 && i$5 !== `none`) {
		let e$7 = i$5.split(` `);
...
function C(e$6, t$7, n$7 = {
	x: 0,
	y: 0
}) {
	let r$4 = b(e$6) ? e$6 : g(e$6, x), i$5 = b(t$7) ? t$7 : g(t$7, S);
...
function E(e$6, t$7 = new DOMMatrix()) {
	let r$4 = e$6;
	for (u$2(t$7); r$4;) {
		let e$7 = y$1(r$4);
		if (e$7 && (T.setMatrixValue(e$7), !T.isIdentity)) {
			let { transformOrigin: e$8 } = t$4(r$4), { x: i$5, y: a$4, z: o$4 } = w(e$8);
			o$4 === 0 ? T.setMatrixValue(`translate(${i$5}px,${a$4}px) ${T} translate(${i$5 * -1}px,${a$4 * -1}px)`) : T.setMatrixValue(`translate3d(${i$5}px,${a$4}px,${o$4}px) ${T} translate3d(${i$5 * -1}px,${a$4 * -1}px,${o$4 * -1}px)`), t$7.preMultiplySelf(T);
		}
...
var O = class {
	constructor(e$6, t$7) {
		...
		let i$5 = t$4(e$6), a$4 = e$6.getBoundingClientRect(), s$6 = y$1(e$6, !0);
		...
		{
			let { width: e$7, height: t$8, x: n$7, y: r$5 } = a$4;
			this.clientRect = {
				width: e$7,
				height: t$8,
				x: n$7,
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$6) => {
			if (!this._matrixCache.isValid(e$6)) {
				...
				E(e$6, n$7), r$4.setMatrixValue(n$7.toString()).invertSelf(), this._matrixCache.set(e$6, t$7);
			}
		});
	}
	_updateContainerOffset() {
		...
		if (e$6 !== n$7) {
			let [s$6, l$6] = [[r$4, n$7], [t$7, e$6]].map(([e$7, t$8]) => {
				let n$8 = a$4.get(t$8) || {
					x: 0,
					y: 0
				};
				if (!a$4.isValid(t$8)) {
					let r$5 = o$4.get(e$7);
					t$8 instanceof HTMLElement && r$5 && !r$5[0].isIdentity ? c$3(r$5[0]) ? (D.style.setProperty(`transform`, r$5[1].toString(), `important`), t$8.append(D), g(D, n$8), D.remove()) : (g(t$8, n$8), n$8.x -= r$5[0].m41, n$8.y -= r$5[0].m42) : g(t$8, n$8);
				}
...
const F = {
	...
	applyPosition: ({ item: e$6, phase: t$7 }) => {
		let n$7 = t$7 === L.End || t$7 === L.EndAlign, [r$4, i$5] = e$6.getContainerMatrix(), [a$4, o$4] = e$6.getDragContainerMatrix(), { position: s$6, alignmentOffset: c$6, containerOffset: l$6, elementTransformMatrix: d$3, elementTransformOrigin: f$3, elementOffsetMatrix: p$3 } = e$6, { x: m$3, y: h$3, z: g$3 } = f$3, _$4 = !d$3.isIdentity && (m$3 !== 0 || h$3 !== 0 || g$3 !== 0), v$4 = s$6.x + c$6.x + l$6.x, y$3 = s$6.y + c$6.y + l$6.y;
		u$2(j), _$4 && (g$3 === 0 ? j.translateSelf(-m$3, -h$3) : j.translateSelf(-m$3, -h$3, -g$3)), n$7 ? i$5.isIdentity || j.multiplySelf(i$5) : o$4.isIdentity || j.multiplySelf(o$4), u$2(M$1).translateSelf(v$4, y$3), j.multiplySelf(M$1), r$4.isIdentity || j.multiplySelf(r$4), _$4 && (u$2(M$1).translateSelf(m$3, h$3, g$3), j.multiplySelf(M$1)), d$3.isIdentity || j.multiplySelf(d$3), p$3.isIdentity || j.preMultiplySelf(p$3), e$6.element.style.transform = `${j}`;
	},
...
var B = class {
	constructor(e$6, t$7 = {}) {
		let { id: n$7 = Symbol(),...r$4 } = t$7;
		this.id = n$7, this.sensors = e$6, this.settings = this._parseSettings(r$4), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N$1.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this.sensors.forEach((e$7) => {
			this._sensorData.set(e$7, {
				predicateState: P.Pending,
				predicateEvent: null,
				onMove: (t$9) => this._onMove(t$9, e$7),
				onEnd: (t$9) => this._onEnd(t$9, e$7)
			});
			let { onMove: t$8, onEnd: n$8 } = this._sensorData.get(e$7);
			e$7.on(e.Start, t$8, t$8), e$7.on(e.Move, t$8, t$8), e$7.on(e.Cancel, n$8, n$8), e$7.on(e.End, n$8, n$8), e$7.on(e.Destroy, n$8, n$8);
		});
	}
	_parseSettings(e$6, t$7 = z) {
		let { container: n$7 = t$7.container, startPredicate: r$4 = t$7.startPredicate, elements: i$5 = t$7.elements, frozenStyles: a$4 = t$7.frozenStyles, positionModifiers: o$4 = t$7.positionModifiers, applyPosition: s$6 = t$7.applyPosition, computeClientRect: c$6 = t$7.computeClientRect, sensorProcessingMode: l$6 = t$7.sensorProcessingMode, dndGroups: u$6 = t$7.dndGroups, onPrepareStart: d$3 = t$7.onPrepareStart, onStart: f$3 = t$7.onStart, onPrepareMove: p$3 = t$7.onPrepareMove, onMove: m$3 = t$7.onMove, onEnd: h$3 = t$7.onEnd, onDestroy: g$3 = t$7.onDestroy } = e$6 || {};
		return {
			container: n$7,
			startPredicate: r$4,
			elements: i$5,
	...
	_onMove(n$7, r$4) {
		...
		if (i$5) switch (i$5.predicateState) {
			case P.Pending: {
				...
				e$6 === !0 ? this.resolveStartPredicate(r$4) : e$6 === !1 && this.rejectStartPredicate(r$4);
				break;
			}
			case P.Resolved:
	...
	_applyStart() {
		...
		if (e$6) {
			...
			for (let t$7 of e$6.items) t$7.dragContainer !== t$7.elementContainer && l$2(t$7.dragContainer, t$7.element), t$7.frozenStyles && Object.assign(t$7.element.style, t$7.frozenStyles), this.settings.applyPosition({
				phase: L.Start,
				draggable: this,
				drag: e$6,
				item: t$7
			...
			for (let t$7 of e$6.items) {
				...
				i$5.x += d(t$7.clientRect.x - r$4.x, 3), i$5.y += d(t$7.clientRect.y - r$4.y, 3);
			}
			for (let t$7 of e$6.items) {
	...
	_prepareMove() {
		...
		t$7 !== n$7 && (this._applyModifiers(F.Move, t$7.x - n$7.x, t$7.y - n$7.y), this._emit(R.PrepareMove, t$7), !e$6.isEnded && (this.settings.onPrepareMove?.(e$6, this), !e$6.isEnded && (e$6.prevMoveEvent = t$7)));
	}
	_applyMove() {
		let e$6 = this.drag;
		if (e$6) {
	...
	resolveStartPredicate(n$7, r$4) {
		...
		i$5.predicateState === P.Pending && a$4 && (this._startPhase = N$1.Init, i$5.predicateState = P.Resolved, i$5.predicateEvent = null, this.drag = new p(n$7, a$4), this._sensorData.forEach((e$6, t$7) => {
			t$7 !== n$7 && (e$6.predicateState = P.Rejected, e$6.predicateEvent = null);
	...
	stop() {
		...
		if (!(!n$7 || n$7.isEnded)) {
			...
			n$7.isEnded = !0, this._startPhase === N$1.Init && this._prepareStart(), this._startPhase === N$1.FinishPrepare && this._applyStart(), this._startPhase = N$1.None, n$2.off(t.read, this._startId), n$2.off(t.write, this._startId), n$2.off(t.read, this._moveId), n$2.off(t.write, this._moveId), n$2.off(t.read, this._alignId), n$2.off(t.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
			for (let e$6 of n$7.items) {
				if (e$6.elementContainer !== e$6.dragContainer && (l$2(e$6.elementContainer, e$6.element), e$6.alignmentOffset.x = 0, e$6.alignmentOffset.y = 0, e$6.containerOffset.x = 0, e$6.containerOffset.y = 0), e$6.unfrozenStyles) for (let t$7 in e$6.unfrozenStyles) e$6.element.style[t$7] = e$6.unfrozenStyles[t$7] || ``;
			...
			for (let e$6 of n$7.items) if (e$6.elementContainer !== e$6.dragContainer) {
				let t$7 = e$6.element.getBoundingClientRect();
				e$6.alignmentOffset.x = d(e$6.clientRect.x - t$7.x, 3), e$6.alignmentOffset.y = d(e$6.clientRect.y - t$7.y, 3);
			}
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensorData.forEach(({ onMove: e$6, onEnd: t$7 }, n$7) => {
			n$7.off(e.Start, e$6), n$7.off(e.Move, e$6), n$7.off(e.Cancel, t$7), n$7.off(e.End, t$7), n$7.off(e.Destroy, t$7);
...
var u = class {
	...
	_isMatch(e$6, t$7) {
		let n$7 = !1;
		if (typeof t$7.accept == `function`) n$7 = t$7.accept(e$6);
		else {
			let r$4 = e$6.settings.dndGroups, i$5 = t$7.accept;
			if (!r$4 || r$4.size === 0 || i$5.size === 0) return !1;
			let a$4 = i$5.size < r$4.size, o$4 = a$4 ? i$5 : r$4, s$6 = a$4 ? r$4 : i$5;
	...
	_stopDrag(e$6, t$7 = !1) {
		...
		n$7.isEnded = !0;
		let r$4 = n$7._cd.phase === s$2.Emitting;
	...
	_finalizeStopDrag(n$7) {
		...
		!r$4 || !r$4.isEnded || (this._drags.delete(n$7), this._collisionDetector.removeCollisionDataPool(n$7), n$2.off(t.read, r$4._cd.tickerId), n$2.off(t.write, r$4._cd.tickerId), this._drags.size || (n$2.off(t.read, this._listenerId), window.removeEventListener(`scroll`, this._onScroll, c$2)));
	}
	_computeCollisions(e$6, t$7 = !1) {
		...
		r$4.phase = s$2.Computing, r$4.targets = this._getTargets(e$6), this._collisionDetector.detectCollisions(e$6, r$4.targets, r$4.collisions), r$4.phase = s$2.Computed;
	}
	_emitCollisions(e$6, t$7 = !1) {
		...
		}), c$6.clear(), u$6.clear(), d$3.clear(), r$4.phase = s$2.Idle;
	}
	on(e$6, t$7, n$7) {
		return this._emitter.on(e$6, t$7, n$7);
	}
	...
	detectCollisions(n$7) {
		if (!this.isDestroyed) if (n$7) {
			...
			n$2.once(t.read, () => this._computeCollisions(n$7), r$4._cd.tickerId), n$2.once(t.write, () => this._emitCollisions(n$7), r$4._cd.tickerId);
		} else for (let [n$8, r$4] of this._drags) r$4.isEnded || (n$2.once(t.read, () => this._computeCollisions(n$8), r$4._cd.tickerId), n$2.once(t.write, () => this._emitCollisions(n$8), r$4._cd.tickerId));
	}
	addDraggables(e$6) {
		if (this.isDestroyed) return;
		let t$7 = /* @__PURE__ */ new Set();
		for (let n$7 of e$6) this.draggables.has(n$7.id) || (t$7.add(n$7), this.draggables.set(n$7.id, n$7), n$7.on(R.PrepareStart, () => {
		...
		if (t$7.size) {
			this._emitter.listenerCount(l.AddDraggables) && this._emitter.emit(l.AddDraggables, { draggables: t$7 });
			for (let e$7 of t$7) if (!this.isDestroyed && e$7.drag && !e$7.drag.isEnded) {
				let t$8 = e$7._startPhase;
				t$8 >= 2 && this._onDragPrepareStart(e$7), t$8 >= 4 && this._onDragStart(e$7);
			}
		}
	}
	removeDraggables(e$6) {
		if (this.isDestroyed) return;
		let t$7 = /* @__PURE__ */ new Set();
		for (let n$7 of e$6) this.draggables.has(n$7.id) && (t$7.add(n$7), this.draggables.delete(n$7.id), n$7.off(R.PrepareStart, this._listenerId), n$7.off(R.Start, this._listenerId), n$7.off(R.PrepareMove, this._listenerId), n$7.off(R.Move, this._listenerId), n$7.off(R.End, this._listenerId), n$7.off(R.Destroy, this._listenerId));
	...
	addDroppables(e$6) {
		if (this.isDestroyed) return;
		let t$7 = /* @__PURE__ */ new Set();
		for (let n$7 of e$6) this.droppables.has(n$7.id) || (t$7.add(n$7), this.droppables.set(n$7.id, n$7), n$7.on(t$3.Destroy, () => {
	...
	removeDroppables(e$6) {
		if (this.isDestroyed) return;
		let t$7 = /* @__PURE__ */ new Set();
		for (let n$7 of e$6) this.droppables.has(n$7.id) && (this.droppables.delete(n$7.id), t$7.add(n$7), n$7.off(t$3.Destroy, this._listenerId), this._drags.forEach(({ _targets: e$7 }, t$8) => {
	...
	destroy() {
		...
		this.isDestroyed = !0, this.draggables.forEach((e$7) => {
			...
			e$7.off(t$3.Destroy, this._listenerId);
		});
...
function c$1(n$7) {
	return n$7 === `auto` || n$7 === void 0 ? n$4 ? `pointer` : t$2 ? `touch` : `mouse` : n$7;
}
const l$1 = {
	pointer: {
		start: `pointerdown`,
...
var u$1 = class {
	...
	_onMove(e$6) {
		if (!this.drag) return;
		let t$7 = this._getTrackedPointerEventData(e$6);
		if (!t$7) return;
	...
	_bindWindowListeners() {
		...
		let { move: e$6, end: t$7, cancel: n$7 } = l$1[this._sourceEvents];
	...
	updateSettings(e$6) {
		if (this.isDestroyed) return;
		let { listenerOptions: t$7, sourceEvents: n$7, startPredicate: r$4 } = e$6, i$5 = c$1(n$7), a$4 = s$1(t$7);
		r$4 && this._startPredicate !== r$4 && (this._startPredicate = r$4), (t$7 && (this._listenerOptions.capture !== a$4.capture || this._listenerOptions.passive === a$4.passive) || n$7 && this._sourceEvents !== i$5) && (this.element.removeEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions), this._unbindWindowListeners(), this.cancel(), n$7 && (this._sourceEvents = i$5), t$7 && a$4 && (this._listenerOptions = a$4), this.element.addEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions));
	}
	on(e$6, t$7, n$7) {
		return this._emitter.on(e$6, t$7, n$7);
	}
...
//#endregion
//#region ../dragdoll/dist/auto-scroll-plugin-SoOS2_pz.js
const r$1 = {
	x: 0,
	y: 0
}, i$2 = {
...
function a$1() {
	return {
		...
		getPosition: (e$6) => {
			...
			return r$1.x = i$5 ? i$5.x : 0, r$1.y = i$5 ? i$5.y : 0, r$1;
		},
		getClientRect: (e$6) => {
...
var o = class {
	...
	constructor(e$6, r$4 = {}) {
		this.name = `autoscroll`, this.version = `0.0.3`, this.settings = this._parseSettings(r$4), this._autoScrollProxy = null, e$6.on(R.Start, () => {
			this._autoScrollProxy || (this._autoScrollProxy = new o(this, e$6), t$1.addItem(this._autoScrollProxy));
		}), e$6.on(R.End, () => {
...
var a = class extends i {
	...
	_updateDirection() {
		let e$6 = r(this._moveLeftKeys, this._moveKeyTimestamps), t$7 = r(this._moveRightKeys, this._moveKeyTimestamps), n$7 = r(this._moveUpKeys, this._moveKeyTimestamps), i$5 = r(this._moveDownKeys, this._moveKeyTimestamps), a$4 = e$6 === t$7 ? 0 : e$6 < t$7 ? -1 : 1, o$4 = n$7 === i$5 ? 0 : n$7 < i$5 ? -1 : 1;
		if (!(a$4 === 0 || o$4 === 0)) {
