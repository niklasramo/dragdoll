(function (factory) {
  ...
  function getStyle(e$6, t$7) {
    ...
    return (
      C$2 ||
        ((C$2 = window.getComputedStyle(e$6, null)),
        STYLE_DECLARATION_CACHE.set(e$6, new WeakRef(C$2))),
      C$2
    );
  }
  ...
  function isContainingBlockForFixedElement(n$7) {
    ...
    return (
      !(
        !c$6 ||
        !(
          c$6.indexOf('transform') > -1 ||
          c$6.indexOf('perspective') > -1 ||
          c$6.indexOf('contain') > -1
        )
      ) || !!(IS_SAFARI && c$6 && c$6.indexOf('filter') > -1)
    );
  }
  ...
  function getContainingBlock(e$6, t$7 = {}) {
    ...
    const n$7 = t$7.position || getStyle(e$6).position,
      { skipDisplayNone: i$5, container: o$4 } = t$7;
    switch (n$7) {
      case 'static':
      case 'relative':
      case 'sticky':
      ...
      case 'fixed': {
        ...
        for (; l$6; ) {
          const e$7 = t$8
            ...
            : isContainingBlockForAbsoluteElement(l$6);
          if (!0 === e$7) return l$6;
          if (null === e$7 && !i$5) return null;
  ...
  function isIntersecting(t$7, e$6) {
    return !(
      t$7.left + t$7.width <= e$6.left ||
      e$6.left + e$6.width <= t$7.left ||
      t$7.top + t$7.height <= e$6.top ||
      e$6.top + e$6.height <= t$7.top
    );
  }
  ...
  function getDistanceBetweenRects(t$7, e$6) {
    ...
    const n$7 = t$7.left + t$7.width,
      i$5 = t$7.top + t$7.height,
      o$4 = e$6.left + e$6.width,
      s$6 = e$6.top + e$6.height;
    return n$7 <= e$6.left
      ? i$5 <= e$6.top
        ? getDistanceBetweenPoints(n$7, i$5, e$6.left, e$6.top)
        : t$7.top >= s$6
          ? getDistanceBetweenPoints(n$7, t$7.top, e$6.left, s$6)
          : e$6.left - n$7
      : t$7.left >= o$4
        ? i$5 <= e$6.top
          ? getDistanceBetweenPoints(t$7.left, i$5, o$4, e$6.top)
          : t$7.top >= s$6
            ? getDistanceBetweenPoints(t$7.left, t$7.top, o$4, s$6)
            : t$7.left - o$4
        : i$5 <= e$6.top
          ? e$6.top - i$5
          : t$7.top - s$6;
  ...
  function getPreciseScrollbarSize(t$7, e$6, n$7) {
    if (n$7 <= 0) return 0;
    if (IS_CHROMIUM) {
      const n$8 = getStyle(t$7, '::-webkit-scrollbar'),
        l$6 = 'x' === e$6 ? n$8.height : n$8.width,
        i$5 = parseFloat(l$6);
  ...
  function getWindowWidth(e$6, r$4 = !1) {
    ...
    const { innerWidth: t$7, document: i$5 } = e$6,
      { documentElement: n$7 } = i$5,
      { clientWidth: c$6 } = n$7;
  ...
  function getElementWidth(t$7, e$6 = BOX_EDGE.border) {
    ...
    return e$6 === BOX_EDGE.margin
      ? ((r$4 += Math.max(0, parseFloat(o$4.marginLeft) || 0)),
        (r$4 += Math.max(0, parseFloat(o$4.marginRight) || 0)),
        r$4)
      : ((r$4 -= parseFloat(o$4.borderLeftWidth) || 0),
        (r$4 -= parseFloat(o$4.borderRightWidth) || 0),
        e$6 === BOX_EDGE.scrollbar
          ? r$4
          : (!isDocumentElement(t$7) &&
              SCROLLABLE_OVERFLOWS.has(o$4.overflowY) &&
              (r$4 -= getPreciseScrollbarSize(t$7, 'y', Math.round(r$4) - t$7.clientWidth)),
            e$6 === BOX_EDGE.padding ||
              ((r$4 -= parseFloat(o$4.paddingLeft) || 0),
              (r$4 -= parseFloat(o$4.paddingRight) || 0)),
            r$4));
  }
  ...
  function getWidth(t$7, i$5 = BOX_EDGE.border) {
    return isWindow(t$7)
      ? getWindowWidth(t$7, INCLUDE_WINDOW_SCROLLBAR[i$5])
      : isDocument(t$7)
        ? getDocumentWidth(t$7)
        : getElementWidth(t$7, i$5);
  }
  ...
  function getWindowHeight(e$6, r$4 = !1) {
    ...
    const { innerHeight: t$7, document: i$5 } = e$6,
      { documentElement: n$7 } = i$5,
      { clientHeight: c$6 } = n$7;
  ...
  function getElementHeight(t$7, e$6 = BOX_EDGE.border) {
    ...
    const o$4 = getStyle(t$7);
    return e$6 === BOX_EDGE.margin
      ? ((r$4 += Math.max(0, parseFloat(o$4.marginTop) || 0)),
        (r$4 += Math.max(0, parseFloat(o$4.marginBottom) || 0)),
        r$4)
      : ((r$4 -= parseFloat(o$4.borderTopWidth) || 0),
        (r$4 -= parseFloat(o$4.borderBottomWidth) || 0),
        e$6 === BOX_EDGE.scrollbar
          ? r$4
          : (!isDocumentElement(t$7) &&
              SCROLLABLE_OVERFLOWS.has(o$4.overflowX) &&
              (r$4 -= getPreciseScrollbarSize(t$7, 'x', Math.round(r$4) - t$7.clientHeight)),
            e$6 === BOX_EDGE.padding ||
              ((r$4 -= parseFloat(o$4.paddingTop) || 0),
              (r$4 -= parseFloat(o$4.paddingBottom) || 0)),
            r$4));
  }
  ...
  function getHeight(t$7, e$6 = BOX_EDGE.border) {
    return isWindow(t$7)
      ? getWindowHeight(t$7, INCLUDE_WINDOW_SCROLLBAR[e$6])
      : isDocument(t$7)
        ? getDocumentHeight(t$7)
        : getElementHeight(t$7, e$6);
  }
  ...
  function getOffsetFromDocument(t$7, o$4 = BOX_EDGE.border) {
    ...
    return o$4 === BOX_EDGE.margin
      ? ((e$6.left -= Math.max(0, parseFloat(l$6.marginLeft) || 0)),
        (e$6.top -= Math.max(0, parseFloat(l$6.marginTop) || 0)),
        e$6)
      : ((e$6.left += parseFloat(l$6.borderLeftWidth) || 0),
        (e$6.top += parseFloat(l$6.borderTopWidth) || 0),
        o$4 === BOX_EDGE.scrollbar ||
          o$4 === BOX_EDGE.padding ||
          ((e$6.left += parseFloat(l$6.paddingLeft) || 0),
          (e$6.top += parseFloat(l$6.paddingTop) || 0)),
        e$6);
  }
  ...
  function getOffset(t$7, e$6) {
    const o$4 = isRectObject(t$7)
      ...
      : Array.isArray(t$7)
        ? getOffsetFromDocument(...t$7)
        : getOffsetFromDocument(t$7);
    if (e$6 && !isDocument(e$6)) {
      const t$8 = isRectObject(e$6)
        ? e$6
        : Array.isArray(e$6)
          ? getOffsetFromDocument(e$6[0], e$6[1])
          : getOffsetFromDocument(e$6);
  ...
  function getRect(t$7, e$6) {
    let i$5 = 0,
      g$3 = 0;
    isRectObject(t$7)
      ? ((i$5 = t$7.width), (g$3 = t$7.height))
      : Array.isArray(t$7)
        ? ((i$5 = getWidth(...t$7)), (g$3 = getHeight(...t$7)))
        : ((i$5 = getWidth(t$7)), (g$3 = getHeight(t$7)));
  ...
  function getOffsetContainer(n$7, t$7 = {}) {
    ...
    const e$6 = t$7.position || getStyle(n$7).position,
      { skipDisplayNone: s$6, container: r$4 } = t$7;
    switch (e$6) {
      case 'relative':
        return n$7;
      case 'fixed':
  ...
  var E$2 = {
    ...
    v$1 = class {
      constructor(t$7 = {}) {
        ((this.dedupe = t$7.dedupe || E$2.ADD),
          (this.getId = t$7.getId || (() => Symbol())),
      ...
      on(t$7, n$7, e$6) {
        ...
        s$6 ||
          ...
          i$5.set(t$7, s$6));
        let o$4 = s$6.m;
        if (((e$6 = e$6 === r$3 ? this.getId(n$7) : e$6), o$4.has(e$6)))
          switch (this.dedupe) {
            case E$2.THROW:
      ...
      once(t$7, n$7, e$6) {
        let i$5 = 0;
        return (
          (e$6 = e$6 === r$3 ? this.getId(n$7) : e$6),
          this.on(
            t$7,
            (...s$6) => {
    ...
    o$3 = class {
      ...
      _processQueue(...e$6) {
        ...
        let s$6 = 0,
          ...
          c$6;
        for (; s$6 < r$4; s$6++)
          for (n$7 = t$7[s$6], a$4 = 0, c$6 = n$7.length; a$4 < c$6; a$4++) n$7[a$4](...e$6);
        t$7.length = 0;
      }
    };
  function u$5(i$5 = 60) {
  ...
  var l$5 = class extends o$3 {
    constructor(e$6 = {}) {
      ...
      (super(a$4),
        (this._paused = t$7),
        (this._onDemand = r$4),
        (this._requestFrame = s$6),
        (this._cancelFrame = null),
        (this._empty = !0),
        !t$7 && !r$4 && this._request());
    }
    get phases() {
      return this._phases;
    }
    set phases(e$6) {
      ((this._phases = e$6),
        e$6.length ? ((this._empty = !1), this._request()) : (this._empty = !0));
    }
    get paused() {
      return this._paused;
    }
    ...
    set requestFrame(e$6) {
      this._requestFrame !== e$6 &&
        ((this._requestFrame = e$6), this._cancelFrame && (this._cancel(), this._request()));
    }
    tick(...e$6) {
      if (
  ...
  const e$4 = typeof window < `u` && window.document !== void 0,
    t$3 = e$4 && `ontouchstart` in window,
    n$5 = e$4 && !!window.PointerEvent;
  e$4 &&
    navigator.vendor &&
    navigator.vendor.indexOf(`Apple`) > -1 &&
    navigator.userAgent &&
  ...
  function t$4(t$7) {
    ...
    return (
      n$7 || ((n$7 = window.getComputedStyle(t$7, null)), e$5.set(t$7, new WeakRef(n$7))),
      n$7
    );
  }
  ...
  var s$5 = class {
    ...
    c$5 = class {
      constructor(e$6, t$7) {
        ((this.sensor = e$6),
          (this.startEvent = t$7),
          (this.prevMoveEvent = t$7),
          (this.moveEvent = t$7),
          (this.endEvent = null),
          (this.items = []),
          (this.isEnded = !1),
          (this._matrixCache = new s$5()),
          (this._clientOffsetCache = new s$5()));
      }
    };
  function l$4(
    e$6,
    ...
    if (e$6 instanceof Document)
      return ((t$7.x = window.scrollX * -1), (t$7.y = window.scrollY * -1), t$7);
    let { x: n$7, y: r$4 } = e$6.getBoundingClientRect(),
      a$4 = t$4(e$6);
    return (
      (t$7.x = n$7 + (parseFloat(a$4.borderLeftWidth) || 0)),
      (t$7.y = r$4 + (parseFloat(a$4.borderTopWidth) || 0)),
      t$7
    );
  }
  function u$4(e$6) {
  ...
  function p$2(
    ...
    let r$4 = u$4(e$6) ? e$6 : l$4(e$6, d$2),
      i$5 = u$4(t$7) ? t$7 : l$4(t$7, f$2);
    return ((n$7.x = i$5.x - r$4.x), (n$7.y = i$5.y - r$4.y), n$7);
  }
  function m$2(e$6) {
    let t$7 = t$4(e$6),
      n$7 = parseFloat(t$7.height) || 0;
    return t$7.boxSizing === `border-box`
      ? n$7
      : ((n$7 += parseFloat(t$7.borderTopWidth) || 0),
        (n$7 += parseFloat(t$7.borderBottomWidth) || 0),
        (n$7 += parseFloat(t$7.paddingTop) || 0),
        (n$7 += parseFloat(t$7.paddingBottom) || 0),
        e$6 instanceof HTMLElement && (n$7 += e$6.offsetHeight - e$6.clientHeight),
        n$7);
  }
  function h$2(e$6) {
    let t$7 = t$4(e$6),
      n$7 = parseFloat(t$7.width) || 0;
    return t$7.boxSizing === `border-box`
      ? n$7
      : ((n$7 += parseFloat(t$7.borderLeftWidth) || 0),
        (n$7 += parseFloat(t$7.borderRightWidth) || 0),
        (n$7 += parseFloat(t$7.paddingLeft) || 0),
        (n$7 += parseFloat(t$7.paddingRight) || 0),
        e$6 instanceof HTMLElement && (n$7 += e$6.offsetWidth - e$6.clientWidth),
        n$7);
  }
  function g$2(e$6, t$7 = !1) {
    let { translate: n$7, rotate: r$4, scale: a$4, transform: o$4 } = t$4(e$6),
      s$6 = ``;
    if (n$7 && n$7 !== `none`) {
      let [t$8 = `0px`, r$5 = `0px`, i$5] = n$7.split(` `);
      (t$8.includes(`%`) && (t$8 = `${(parseFloat(t$8) / 100) * h$2(e$6)}px`),
        r$5.includes(`%`) && (r$5 = `${(parseFloat(r$5) / 100) * m$2(e$6)}px`),
        i$5 ? (s$6 += `translate3d(${t$8},${r$5},${i$5})`) : (s$6 += `translate(${t$8},${r$5})`));
    }
    if (r$4 && r$4 !== `none`) {
      let e$7 = r$4.split(` `);
  ...
  function b$1(e$6, t$7 = new DOMMatrix()) {
    ...
    for (v$3(t$7); n$7; ) {
      ...
      if (e$7 && (y$2.setMatrixValue(e$7), !y$2.isIdentity)) {
        let { transformOrigin: e$8 } = t$4(n$7),
          { x: r$4, y: a$4, z: o$4 } = _$2(e$8);
        (o$4 === 0
          ? y$2.setMatrixValue(
              `translate(${r$4}px,${a$4}px) ${y$2} translate(${r$4 * -1}px,${a$4 * -1}px)`,
            )
          : y$2.setMatrixValue(
              `translate3d(${r$4}px,${a$4}px,${o$4}px) ${y$2} translate3d(${r$4 * -1}px,${a$4 * -1}px,${o$4 * -1}px)`,
            ),
          t$7.preMultiplySelf(y$2));
      }
  ...
  function S$1() {
    ...
    return (
      e$6.classList.add(`dragdoll-measure`),
      x$1(
        e$6,
        {
          display: `block`,
  ...
  var T$1 = class {
    constructor(e$6, t$7) {
      ...
      let r$4 = t$4(e$6),
        a$4 = e$6.getBoundingClientRect(),
        s$6 = g$2(e$6, !0);
      ((this.data = {}),
        (this.element = e$6),
        (this.elementTransformOrigin = _$2(r$4.transformOrigin)),
        (this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$6 + r$4.transform)),
        (this.elementOffsetMatrix = new DOMMatrix(s$6).invertSelf()),
        ...
        (this._matrixCache = n$7._matrixCache),
        (this._clientOffsetCache = n$7._clientOffsetCache));
      ...
      if (((this.dragContainer = l$6), c$6 !== l$6)) {
        ...
        if (e$7 !== `fixed` && e$7 !== `absolute`)
          throw Error(
            `Dragged element has "${e$7}" position, but only "fixed" or "absolute" are allowed when using a custom drag container.`,
          );
      }
      let u$6 = getOffsetContainer(e$6) || e$6;
      ((this.elementOffsetContainer = u$6),
        (this.dragOffsetContainer =
          l$6 === c$6 ? u$6 : getOffsetContainer(e$6, { container: l$6 })));
      {
      ...
      if (this.frozenStyles) {
        let t$8 = {};
        for (let n$8 in this.frozenStyles) t$8[n$8] = e$6.style[n$8];
    ...
    _updateContainerMatrices() {
      [this.elementContainer, this.dragContainer].forEach((e$6) => {
        if (!this._matrixCache.isValid(e$6)) {
          let t$7 = this._matrixCache.get(e$6) || [new DOMMatrix(), new DOMMatrix()],
            [n$7, r$4] = t$7;
          (b$1(e$6, n$7),
            r$4.setMatrixValue(n$7.toString()).invertSelf(),
            this._matrixCache.set(e$6, t$7));
        }
      });
    }
    _updateContainerOffset() {
      let {
        elementOffsetContainer: e$6,
        elementContainer: t$7,
      ...
      if (e$6 !== n$7) {
        let [s$6, c$6] = [
          ...
          if (!a$4.isValid(t$8)) {
            let r$5 = o$4.get(e$7);
            t$8 instanceof HTMLElement && r$5 && !r$5[0].isIdentity
              ? C$1(r$5[0])
                ? (w$1.style.setProperty(`transform`, r$5[1].toString(), `important`),
                  t$8.append(w$1),
                  l$4(w$1, n$8),
                  w$1.remove())
                : (l$4(t$8, n$8), (n$8.x -= r$5[0].m41), (n$8.y -= r$5[0].m42))
              : l$4(t$8, n$8);
          }
  ...
  function E$1(e$6, t$7, n$7 = null) {
    if (`moveBefore` in e$6 && e$6.isConnected === t$7.isConnected)
      try {
        e$6.moveBefore(t$7, n$7);
        return;
      } catch {}
    let r$4 = document.activeElement,
      i$5 = t$7.contains(r$4);
    (e$6.insertBefore(t$7, n$7),
      i$5 &&
        document.activeElement !== r$4 &&
        r$4 instanceof HTMLElement &&
        r$4.focus({ preventScroll: !0 }));
  }
  ...
  const k$1 = {
    ...
    j$1 = e$4 ? new DOMMatrix() : null,
    M$1 = e$4 ? new DOMMatrix() : null;
  var N$1 = (function (e$6) {
      return (
        (e$6[(e$6.None = 0)] = `None`),
        (e$6[(e$6.Init = 1)] = `Init`),
        (e$6[(e$6.Prepare = 2)] = `Prepare`),
        (e$6[(e$6.FinishPrepare = 3)] = `FinishPrepare`),
        (e$6[(e$6.Apply = 4)] = `Apply`),
        (e$6[(e$6.FinishApply = 5)] = `FinishApply`),
        e$6
      );
    })(N$1 || {}),
    P = (function (e$6) {
      return (
        (e$6[(e$6.Pending = 0)] = `Pending`),
        (e$6[(e$6.Resolved = 1)] = `Resolved`),
        (e$6[(e$6.Rejected = 2)] = `Rejected`),
        e$6
      );
    })(P || {});
  const F = {
    ...
    R = {
      ...
      applyPosition: ({ item: e$6, phase: t$7 }) => {
        let n$7 = t$7 === I.End || t$7 === I.EndAlign,
          [r$4, i$5] = e$6.getContainerMatrix(),
          [a$4, o$4] = e$6.getDragContainerMatrix(),
          {
            position: s$6,
            alignmentOffset: c$6,
            containerOffset: l$6,
            elementTransformMatrix: u$6,
            elementTransformOrigin: d$3,
            elementOffsetMatrix: f$3,
          } = e$6,
          { x: p$3, y: m$3, z: h$3 } = d$3,
          g$3 = !u$6.isIdentity && (p$3 !== 0 || m$3 !== 0 || h$3 !== 0),
          _$4 = s$6.x + c$6.x + l$6.x,
          y$3 = s$6.y + c$6.y + l$6.y;
        (v$3(j$1),
          g$3 && (h$3 === 0 ? j$1.translateSelf(-p$3, -m$3) : j$1.translateSelf(-p$3, -m$3, -h$3)),
          n$7 ? i$5.isIdentity || j$1.multiplySelf(i$5) : o$4.isIdentity || j$1.multiplySelf(o$4),
          v$3(M$1).translateSelf(_$4, y$3),
          j$1.multiplySelf(M$1),
          r$4.isIdentity || j$1.multiplySelf(r$4),
          g$3 && (v$3(M$1).translateSelf(p$3, m$3, h$3), j$1.multiplySelf(M$1)),
          u$6.isIdentity || j$1.multiplySelf(u$6),
          f$3.isIdentity || j$1.preMultiplySelf(f$3),
          (e$6.element.style.transform = `${j$1}`));
      },
  ...
  var z = class {
    constructor(t$7, n$7 = {}) {
      ...
      ((this.id = r$4),
        (this.sensors = t$7),
        (this.settings = this._parseSettings(i$5)),
        (this.plugins = {}),
        (this.drag = null),
        (this.isDestroyed = !1),
        ...
        this.sensors.forEach((t$8) => {
          ...
          (t$8.on(e$1.Start, n$8, n$8),
            t$8.on(e$1.Move, n$8, n$8),
            t$8.on(e$1.Cancel, r$5, r$5),
            t$8.on(e$1.End, r$5, r$5),
            t$8.on(e$1.Destroy, r$5, r$5));
        }));
    }
    _parseSettings(e$6, t$7 = R) {
      let {
        container: n$7 = t$7.container,
        startPredicate: r$4 = t$7.startPredicate,
        elements: i$5 = t$7.elements,
        frozenStyles: a$4 = t$7.frozenStyles,
        positionModifiers: o$4 = t$7.positionModifiers,
        applyPosition: s$6 = t$7.applyPosition,
        computeClientRect: c$6 = t$7.computeClientRect,
        group: l$6 = t$7.group,
        onPrepareStart: u$6 = t$7.onPrepareStart,
        onStart: d$3 = t$7.onStart,
        onPrepareMove: f$3 = t$7.onPrepareMove,
        onMove: p$3 = t$7.onMove,
        onEnd: m$3 = t$7.onEnd,
        onDestroy: h$3 = t$7.onDestroy,
      } = e$6 || {};
      return {
        container: n$7,
        startPredicate: r$4,
      ...
      if (i$5)
        switch (i$5.predicateState) {
          case P.Pending: {
            ...
            t$7 === !0
              ? this.resolveStartPredicate(r$4)
              : t$7 === !1 && this.rejectStartPredicate(r$4);
            break;
          }
          case P.Resolved:
            this.drag &&
              ((this.drag.moveEvent = e$6),
              n$1.once(t$1.read, this._prepareMove, this._moveId),
              n$1.once(t$1.write, this._applyMove, this._moveId));
            break;
        }
    }
    _onScroll() {
      ...
      n$7 &&
        (this.drag
          ? n$7.predicateState === P.Resolved &&
            ((this.drag.endEvent = e$6),
            this._sensorData.forEach((e$7) => {
    ...
    _prepareStart() {
      ...
      e$6 &&
        ...
        ).map((e$7) => new T$1(e$7, this))),
        this._applyModifiers(F.Start, 0, 0),
        this._emit(L.PrepareStart, e$6.startEvent),
        this.settings.onPrepareStart?.(e$6, this),
    ...
    _applyStart() {
      ...
      if (e$6) {
        ...
        for (let t$7 of e$6.items)
          (t$7.dragContainer !== t$7.elementContainer && E$1(t$7.dragContainer, t$7.element),
            t$7.frozenStyles && Object.assign(t$7.element.style, t$7.frozenStyles),
        ...
        for (let t$7 of e$6.items) {
          let e$7 = t$7.getContainerMatrix()[0],
            n$7 = t$7.getDragContainerMatrix()[0];
          if (O$1(e$7, n$7) || (!C$1(e$7) && !C$1(n$7))) continue;
          let r$4 = t$7.element.getBoundingClientRect(),
            { alignmentOffset: i$5 } = t$7;
          ((i$5.x += D$1(t$7.clientRect.x - r$4.x, 3)),
            (i$5.y += D$1(t$7.clientRect.y - r$4.y, 3)));
        }
        for (let t$7 of e$6.items) {
        ...
        (window.addEventListener(`scroll`, this._onScroll, k$1),
          this._emit(L.Start, e$6.startEvent),
          this.settings.onStart?.(e$6, this),
    ...
    _prepareMove() {
      ...
      t$7 !== n$7 &&
        (this._applyModifiers(F.Move, t$7.x - n$7.x, t$7.y - n$7.y),
        this._emit(L.PrepareMove, t$7),
        !e$6.isEnded &&
          (this.settings.onPrepareMove?.(e$6, this), !e$6.isEnded && (e$6.prevMoveEvent = t$7)));
    }
    _applyMove() {
      let e$6 = this.drag;
      if (e$6) {
    ...
    _prepareAlign() {
      ...
      if (e$6)
        for (let t$7 of e$6.items) {
          let { x: e$7, y: n$7 } = t$7.element.getBoundingClientRect(),
            r$4 = t$7.clientRect.x - t$7._moveDiff.x - e$7;
          ((t$7.alignmentOffset.x = t$7.alignmentOffset.x - t$7._alignDiff.x + r$4),
            (t$7._alignDiff.x = r$4));
          let i$5 = t$7.clientRect.y - t$7._moveDiff.y - n$7;
          ((t$7.alignmentOffset.y = t$7.alignmentOffset.y - t$7._alignDiff.y + i$5),
            (t$7._alignDiff.y = i$5));
        }
    }
    _applyAlign() {
      let { drag: e$6 } = this;
    ...
    _applyModifiers(e$6, t$7, n$7) {
      ...
      for (let a$4 of r$4.items) {
        ...
        ((a$4.position.x += o$4.x),
          ...
          e$6 === `move` && ((a$4._moveDiff.x += o$4.x), (a$4._moveDiff.y += o$4.y)));
      }
    }
    on(e$6, t$7, n$7) {
    ...
    resolveStartPredicate(e$6, r$4) {
      ...
      i$5.predicateState === P.Pending &&
        ...
        (this.drag = new c$5(e$6, a$4)),
        this._sensorData.forEach((t$7, n$7) => {
          n$7 !== e$6 && ((t$7.predicateState = P.Rejected), (t$7.predicateEvent = null));
        }),
        n$1.once(t$1.read, this._prepareStart, this._startId),
        n$1.once(t$1.write, this._applyStart, this._startId));
    }
    rejectStartPredicate(e$6) {
      let t$7 = this._sensorData.get(e$6);
      t$7?.predicateState === P.Pending &&
        ((t$7.predicateState = P.Rejected), (t$7.predicateEvent = null));
    }
    stop() {
      let e$6 = this.drag;
      if (!e$6 || e$6.isEnded) return;
      let r$4 = this._startPhase;
      if (r$4 === N$1.Prepare || r$4 === N$1.Apply)
        throw Error(`Cannot stop drag start process at this point`);
      if (
        ((this._startPhase = N$1.None),
        (e$6.isEnded = !0),
        n$1.off(t$1.read, this._startId),
        n$1.off(t$1.write, this._startId),
        n$1.off(t$1.read, this._moveId),
        n$1.off(t$1.write, this._moveId),
        n$1.off(t$1.read, this._alignId),
        n$1.off(t$1.write, this._alignId),
        window.removeEventListener(`scroll`, this._onScroll, k$1),
        r$4 > N$1.Init && this._applyModifiers(F.End, 0, 0),
        r$4 === N$1.FinishApply)
      ) {
        for (let t$7 of e$6.items) {
          if (
            (t$7.elementContainer !== t$7.dragContainer &&
              (E$1(t$7.elementContainer, t$7.element),
              (t$7.alignmentOffset.x = 0),
              (t$7.alignmentOffset.y = 0),
              (t$7.containerOffset.x = 0),
              (t$7.containerOffset.y = 0)),
            t$7.unfrozenStyles)
          )
            for (let e$7 in t$7.unfrozenStyles)
              t$7.element.style[e$7] = t$7.unfrozenStyles[e$7] || ``;
          this.settings.applyPosition({
            phase: I.End,
            draggable: this,
            drag: e$6,
        ...
        for (let t$7 of e$6.items)
          if (t$7.elementContainer !== t$7.dragContainer) {
            let e$7 = t$7.element.getBoundingClientRect();
            ((t$7.alignmentOffset.x = D$1(t$7.clientRect.x - e$7.x, 3)),
              (t$7.alignmentOffset.y = D$1(t$7.clientRect.y - e$7.y, 3)));
          }
        for (let t$7 of e$6.items)
          t$7.elementContainer !== t$7.dragContainer &&
            (t$7.alignmentOffset.x !== 0 || t$7.alignmentOffset.y !== 0) &&
            this.settings.applyPosition({
              phase: I.EndAlign,
              draggable: this,
              drag: e$6,
      ...
      } else if (r$4 === N$1.FinishPrepare)
        for (let t$7 of e$6.items)
          ((t$7.clientRect.x -= t$7.position.x),
            (t$7.clientRect.y -= t$7.position.y),
            (t$7.position.x = 0),
            (t$7.position.y = 0),
            t$7.elementContainer !== t$7.dragContainer &&
              ((t$7.alignmentOffset.x = 0),
    ...
    align(e$6 = !1) {
      this.drag &&
        (e$6
          ...
          : (n$1.once(t$1.read, this._prepareAlign, this._alignId),
            n$1.once(t$1.write, this._applyAlign, this._alignId)));
    }
    getClientRect() {
      let { drag: e$6, settings: t$7 } = this;
      return (
        (e$6 &&
          t$7.computeClientRect?.({
            draggable: this,
            drag: e$6,
          })) ||
        null
    ...
    destroy() {
      this.isDestroyed ||
        ((this.isDestroyed = !0),
        this.stop(),
        this._sensorData.forEach(({ onMove: t$7, onEnd: n$7 }, r$4) => {
          (r$4.off(e$1.Start, t$7),
            r$4.off(e$1.Move, t$7),
            r$4.off(e$1.Cancel, n$7),
            r$4.off(e$1.End, n$7),
            r$4.off(e$1.Destroy, n$7));
        }),
  ...
  function e$3(
    ...
    let r$4 = Math.max(e$6.x, t$7.x),
      i$5 = Math.min(e$6.x + e$6.width, t$7.x + t$7.width);
    if (i$5 <= r$4) return null;
    let a$4 = Math.max(e$6.y, t$7.y),
      o$4 = Math.min(e$6.y + e$6.height, t$7.y + t$7.height);
    return o$4 <= a$4
      ? null
      : ((n$7.x = r$4), (n$7.y = a$4), (n$7.width = i$5 - r$4), (n$7.height = o$4 - a$4), n$7);
  }
  const t$6 = {
    width: 0,
    height: 0,
  ...
  function n$2(n$7, r$4, i$5) {
    ...
    return a$4
      ? (a$4 / (Math.min(n$7.width, r$4.width) * Math.min(n$7.height, r$4.height))) * 100
      : 0;
  }

  //#endregion
  //#region ../dragdoll/dist/droppable-BAFZw0DQ.js
  ...
  var n = class {
    ...
    updateClientRect(e$6) {
      let t$7 = e$6 || this.element.getBoundingClientRect(),
        { _clientRect: n$7 } = this;
      ((n$7.x = t$7.x), (n$7.y = t$7.y), (n$7.width = t$7.width), (n$7.height = t$7.height));
    }
    destroy() {
      this.isDestroyed ||
        ((this.isDestroyed = !0), this._emitter.emit(t$5.Destroy), this._emitter.off());
    }
  };
  ...
  var n$6 = class {
    ...
    get(...e$6) {
      return this._index >= this._items.length
        ? (this._items[this._index++] = this._getItem(void 0, ...e$6))
        : this._getItem(this._items[this._index++], ...e$6);
    }
    resetPointer() {
      this._index = 0;
    }
  ...
  function r$2(
    ...
    return (
      e$6 && ((t$7.width = e$6.width), (t$7.height = e$6.height), (t$7.x = e$6.x), (t$7.y = e$6.y)),
      t$7
    );
  }
  const i$4 = Symbol();
  var a$3 = class {
    ...
    _checkCollision(n$7, i$5, a$4) {
      ...
      return l$6 <= 0
        ? null
        : ((a$4.droppableId = i$5.id),
          r$2(s$6, a$4.droppableRect),
          r$2(o$4, a$4.draggableRect),
          (a$4.intersectionScore = l$6),
          a$4);
    }
    _sortCollisions(e$6, t$7) {
      return t$7.sort((e$7, t$8) => {
        ...
        return n$7 === 0
          ? e$7.droppableRect.width * e$7.droppableRect.height -
              t$8.droppableRect.width * t$8.droppableRect.height
          : n$7;
      });
    }
      ...
      return (
        t$7 ||
          ((t$7 =
            ...
            new n$6((e$7) => e$7 || this._createCollisionData())),
          this._collisionDataPoolMap.set(e$6, t$7)),
        t$7
      );
    }
    removeCollisionDataPool(e$6) {
      ...
      t$7 &&
        (t$7.resetItems(20),
        t$7.resetPointer(),
        this._collisionDataPoolCache.push(t$7),
        this._collisionDataPoolMap.delete(e$6));
    }
    detectCollisions(e$6, t$7, n$7) {
      if (((n$7.length = 0), !t$7.size)) return;
      let r$4 = this.getCollisionDataPool(e$6),
        i$5 = null,
        a$4 = t$7.values();
      for (let t$8 of a$4)
        ((i$5 ||= r$4.get()), this._checkCollision(e$6, t$8, i$5) && (n$7.push(i$5), (i$5 = null)));
  ...
  //#endregion
  //#region ../dragdoll/dist/dnd-context.js
  var s$4 = (function (e$6) {
    return (
      (e$6[(e$6.Idle = 0)] = `Idle`),
      (e$6[(e$6.Computing = 1)] = `Computing`),
      (e$6[(e$6.Computed = 2)] = `Computed`),
      (e$6[(e$6.Emitting = 3)] = `Emitting`),
      e$6
    );
  })(s$4 || {});
  const c$4 = {
  ...
  var u = class {
    constructor(e$6 = {}) {
      ...
      ((this.draggables = /* @__PURE__ */ new Map()),
        ...
        (this._emitter = new v$1()),
        (this._onScroll = this._onScroll.bind(this)),
        (this._collisionDetector = r$4 ? r$4(this) : new a$3(this)));
    }
    get drags() {
      return this._drags;
    }
    _isMatch(e$6, t$7) {
      let n$7 =
        typeof t$7.accept == `function` ? t$7.accept(e$6) : t$7.accept.includes(e$6.settings.group);
      if (n$7 && e$6.drag) {
    ...
    _onDragPrepareStart(e$6) {
      this.draggables.has(e$6.id) &&
        (this._drags.get(e$6) ||
          ...
          this._computeCollisions(e$6),
          this._drags.size === 1 && window.addEventListener(`scroll`, this._onScroll, c$4)));
    }
    _onDragStart(e$6) {
      let t$7 = this._drags.get(e$6);
      if (!(!t$7 || t$7.isEnded)) {
    ...
    _finalizeStopDrag(e$6) {
      ...
      !r$4 ||
        !r$4.isEnded ||
        (this._drags.delete(e$6),
        this._collisionDetector.removeCollisionDataPool(e$6),
        n$1.off(t$1.read, r$4._cd.tickerId),
        n$1.off(t$1.write, r$4._cd.tickerId),
        this._drags.size ||
          (n$1.off(t$1.read, this._listenerId),
          window.removeEventListener(`scroll`, this._onScroll, c$4)));
    }
    _computeCollisions(e$6, t$7 = !1) {
      ...
      ((r$4.phase = s$4.Computing),
        (r$4.targets = this._getTargets(e$6)),
        this._collisionDetector.detectCollisions(e$6, r$4.targets, r$4.collisions),
        (r$4.phase = s$4.Computed));
    }
    _emitCollisions(e$6, t$7 = !1) {
      ...
      let i$5 = this._emitter,
        a$4 = r$4.collisions,
        o$4 = r$4.targets,
        c$6 = r$4.addedContacts,
        u$6 = r$4.persistedContacts,
        d$3 = r$4.contacts,
        f$3 = r$4.prevContacts;
    ...
    detectCollisions(e$6) {
      if (!this.isDestroyed)
        if (e$6) {
          ...
          (n$1.once(t$1.read, () => this._computeCollisions(e$6), r$4._cd.tickerId),
            n$1.once(t$1.write, () => this._emitCollisions(e$6), r$4._cd.tickerId));
        } else
          for (let [e$7, r$4] of this._drags)
            r$4.isEnded ||
              (n$1.once(t$1.read, () => this._computeCollisions(e$7), r$4._cd.tickerId),
              n$1.once(t$1.write, () => this._emitCollisions(e$7), r$4._cd.tickerId));
    }
    addDraggables(t$7) {
      if (this.isDestroyed) return;
      let n$7 = /* @__PURE__ */ new Set();
      for (let i$5 of t$7)
        this.draggables.has(i$5.id) ||
          (n$7.add(i$5),
          this.draggables.set(i$5.id, i$5),
          i$5.on(
            L.PrepareStart,
            () => {
          ...
          i$5.on(
            ...
            (t$8) => {
              t$8?.type === e$1.End
                ? this._onDragEnd(i$5)
                : t$8?.type === e$1.Cancel && this._onDragCancel(i$5);
            },
            this._listenerId,
          ),
          i$5.on(
      ...
      if (n$7.size) {
        this._emitter.listenerCount(l.AddDraggables) &&
          this._emitter.emit(l.AddDraggables, { draggables: n$7 });
        for (let e$6 of n$7)
          if (!this.isDestroyed && e$6.drag && !e$6.drag.isEnded) {
    ...
    removeDraggables(e$6) {
      ...
      for (let n$7 of e$6)
        this.draggables.has(n$7.id) &&
          (t$7.add(n$7),
          this.draggables.delete(n$7.id),
          n$7.off(L.PrepareStart, this._listenerId),
          n$7.off(L.Start, this._listenerId),
          n$7.off(L.PrepareMove, this._listenerId),
          n$7.off(L.Move, this._listenerId),
          n$7.off(L.End, this._listenerId),
          n$7.off(L.Destroy, this._listenerId));
      for (let e$7 of t$7) this._stopDrag(e$7, !0);
      this._emitter.listenerCount(l.RemoveDraggables) &&
        this._emitter.emit(l.RemoveDraggables, { draggables: t$7 });
    }
    addDroppables(e$6) {
      if (this.isDestroyed) return;
      let t$7 = /* @__PURE__ */ new Set();
      for (let n$7 of e$6)
        this.droppables.has(n$7.id) ||
          (t$7.add(n$7),
          this.droppables.set(n$7.id, n$7),
          n$7.on(
            t$5.Destroy,
            () => {
          ...
          this._drags.forEach(({ _targets: e$7 }, t$8) => {
            e$7 && this._isMatch(t$8, n$7) && (e$7.set(n$7.id, n$7), this.detectCollisions(t$8));
          }));
      t$7.size &&
        this._emitter.listenerCount(l.AddDroppables) &&
        this._emitter.emit(l.AddDroppables, { droppables: t$7 });
    }
    removeDroppables(e$6) {
      ...
      for (let n$7 of e$6)
        this.droppables.has(n$7.id) &&
          (this.droppables.delete(n$7.id),
          t$7.add(n$7),
          n$7.off(t$5.Destroy, this._listenerId),
          this._drags.forEach(({ _targets: e$7 }, t$8) => {
            e$7 && e$7.has(n$7.id) && (e$7.delete(n$7.id), this.detectCollisions(t$8));
          }));
      t$7.size &&
        this._emitter.listenerCount(l.RemoveDroppables) &&
        this._emitter.emit(l.RemoveDroppables, { droppables: t$7 });
    }
    destroy() {
      if (this.isDestroyed) return;
      ((this.isDestroyed = !0),
        this.draggables.forEach((e$7) => {
          (e$7.off(L.PrepareStart, this._listenerId),
            e$7.off(L.Start, this._listenerId),
            e$7.off(L.PrepareMove, this._listenerId),
            e$7.off(L.Move, this._listenerId),
            e$7.off(L.End, this._listenerId),
            e$7.off(L.Destroy, this._listenerId));
        }),
  ...
  function c$3(n$7, r$4, i$5 = []) {
    ...
    for (i$5.length = 0; a$4 && !e$2(a$4); )
      if (a$4 instanceof Element) {
        let t$7 = t$4(a$4);
  ...
  var y = class extends a$3 {
    constructor(e$6, t$7) {
      (super(e$6),
        ...
        (this._visibilityLogic = t$7?.visibilityLogic || `relative`),
    ...
    _checkCollision(e$6, t$7, i$5) {
      ...
      if (!a$4) return null;
      let s$6 = e$6.getClientRect(),
        c$6 = t$7.getClientRect();
      ...
      if (!u$6) {
        ...
        if (
          ...
          _$1(t$7),
          (u$6 = p$1[0] || window),
          a$4.clipMaskKeyMap.set(t$7, u$6),
          !a$4.clipMaskMap.has(u$6))
        ) {
          if ((g$1(e$6), n$7)) {
            let e$7 = window;
            for (let t$9 of p$1)
          ...
          let t$8 = n$7 || !l$3 ? v$2(m$1) : r$2(l$3),
            r$4 = v$2(h$1);
      ...
      if (
        !d$3 ||
        !y$3 ||
        !e$3(s$6, d$3, i$5.draggableVisibleRect) ||
        !e$3(c$6, y$3, i$5.droppableVisibleRect) ||
        !e$3(i$5.draggableVisibleRect, i$5.droppableVisibleRect, i$5.intersectionRect)
      )
        return null;
      let b$2 = n$2(i$5.draggableVisibleRect, i$5.droppableVisibleRect, i$5.intersectionRect);
      return b$2 <= 0
        ? null
        : ((i$5.droppableId = t$7.id),
          r$2(c$6, i$5.droppableRect),
          r$2(s$6, i$5.draggableRect),
          (i$5.intersectionScore = b$2),
          i$5);
    }
    _sortCollisions(e$6, t$7) {
      return t$7.sort((e$7, t$8) => {
        let n$7 = t$8.intersectionScore - e$7.intersectionScore;
        return n$7 === 0
          ? e$7.droppableVisibleRect.width * e$7.droppableVisibleRect.height -
              t$8.droppableVisibleRect.width * t$8.droppableVisibleRect.height
          : n$7;
      });
    }
    _createCollisionData() {
    ...
    removeCollisionDataPool(e$6) {
      (this._dragStates.delete(e$6) &&
        this._dndContext.drags.size <= 0 &&
        (this._listenersAttached &&=
          (window.removeEventListener(`scroll`, this._clearCache, { capture: !0 }),
          window.removeEventListener(`resize`, this._clearCache),
          !1)),
        super.removeCollisionDataPool(e$6));
    }
    detectCollisions(e$6, t$7, n$7) {
      ((f$1.length = 0), (l$3 = null));
      let r$4 = this._getDragState(e$6);
      ((r$4.cacheDirty &&= (r$4.clipMaskKeyMap.clear(), r$4.clipMaskMap.clear(), !1)),
        super.detectCollisions(e$6, t$7, n$7),
        (f$1.length = 0),
        (l$3 = null));
    }
    clearCache(e$6) {
  ...
  function i$3(e$6, t$7) {
    ...
    if (`changedTouches` in e$6) {
      let n$7 = 0;
      for (; n$7 < e$6.changedTouches.length; n$7++)
        if (e$6.changedTouches[n$7].identifier === t$7) return e$6.changedTouches[n$7];
      return null;
    }
    return e$6;
  }
  ...
  function o$2(e$6) {
    return `pointerId` in e$6
      ? e$6.pointerId
      : `changedTouches` in e$6
        ? e$6.changedTouches[0]
          ? e$6.changedTouches[0].identifier
          : null
        : -1;
  }
  function s$2(e$6 = {}) {
  ...
  var u$1 = class {
    constructor(e$6, t$7 = {}) {
      let {
        ...
        startPredicate: a$4 = (e$7) => !(`button` in e$7 && e$7.button > 0),
      } = t$7;
      ((this.element = e$6),
        (this.drag = null),
        (this.isDestroyed = !1),
        ...
        (this._onEnd = this._onEnd.bind(this)),
        e$6.addEventListener(l$2[this._sourceEvents].start, this._onStart, this._listenerOptions));
    }
    ...
    _bindWindowListeners() {
      ...
      (window.addEventListener(e$6, this._onMove, this._listenerOptions),
        window.addEventListener(t$7, this._onEnd, this._listenerOptions),
    ...
    _unbindWindowListeners() {
      if (this._areWindowListenersBound) {
        let { move: e$6, end: t$7, cancel: n$7 } = l$2[this._sourceEvents];
        (window.removeEventListener(e$6, this._onMove, this._listenerOptions),
          window.removeEventListener(t$7, this._onEnd, this._listenerOptions),
    ...
    updateSettings(e$6) {
      if (this.isDestroyed) return;
      let { listenerOptions: t$7, sourceEvents: n$7, startPredicate: r$4 } = e$6,
        i$5 = c$2(n$7),
        a$4 = s$2(t$7);
      (r$4 && this._startPredicate !== r$4 && (this._startPredicate = r$4),
        ((t$7 &&
          (this._listenerOptions.capture !== a$4.capture ||
            this._listenerOptions.passive === a$4.passive)) ||
          (n$7 && this._sourceEvents !== i$5)) &&
          (this.element.removeEventListener(
            l$2[this._sourceEvents].start,
            this._onStart,
          ...
          this.cancel(),
          n$7 && (this._sourceEvents = i$5),
          t$7 && a$4 && (this._listenerOptions = a$4),
  ...
  var n$4 = class {
    ...
    _start(t$7) {
      this.isDestroyed ||
        this.drag ||
        ((this.drag = this._createDragData(t$7)), this._emitter.emit(e$1.Start, t$7));
    }
    _move(t$7) {
    ...
    _end(t$7) {
      this.drag &&
        (this._updateDragData(t$7), this._emitter.emit(e$1.End, t$7), this._resetDragData());
    }
    _cancel(t$7) {
      this.drag &&
        (this._updateDragData(t$7), this._emitter.emit(e$1.Cancel, t$7), this._resetDragData());
    }
    on(e$6, t$7, n$7) {
      return this._emitter.on(e$6, t$7, n$7);
    }
  ...
  var i$1 = class extends n$4 {
    ...
    _start(e$6) {
      this.isDestroyed ||
        this.drag ||
        (super._start(e$6), n$1.on(t$1.read, this._tick, this._tick));
    }
    _end(e$6) {
    ...
    _tick(t$7) {
      if (this.drag)
        if (t$7 && this.drag.time) {
          ...
          let r$4 = this._speed * (this.drag.deltaTime / 1e3),
            i$5 = this._direction.x * r$4,
            a$4 = this._direction.y * r$4;
          (i$5 || a$4) &&
            this._move({
              type: e$1.Move,
              x: this.drag.x + i$5,
  ...
  var a = class extends i$1 {
    constructor(e$6, t$7 = {}) {
      ...
      let {
        ...
        computeSpeed: r$4 = i$2.computeSpeed,
        cancelOnVisibilityChange: a$4 = i$2.cancelOnVisibilityChange,
        cancelOnBlur: o$4 = i$2.cancelOnBlur,
        startKeys: s$6 = i$2.startKeys,
        moveLeftKeys: c$6 = i$2.moveLeftKeys,
        moveRightKeys: l$6 = i$2.moveRightKeys,
        moveUpKeys: u$6 = i$2.moveUpKeys,
        moveDownKeys: d$3 = i$2.moveDownKeys,
        cancelKeys: f$3 = i$2.cancelKeys,
        endKeys: p$3 = i$2.endKeys,
      } = t$7;
      ((this.element = e$6),
        (this._startKeys = new Set(s$6)),
        (this._cancelKeys = new Set(f$3)),
        (this._endKeys = new Set(p$3)),
        (this._moveLeftKeys = new Set(c$6)),
        (this._moveRightKeys = new Set(l$6)),
        (this._moveUpKeys = new Set(u$6)),
        (this._moveDownKeys = new Set(d$3)),
        (this._moveKeys = new Set([...c$6, ...l$6, ...u$6, ...d$3])),
        (this._moveKeyTimestamps = /* @__PURE__ */ new Map()),
        (this._cancelOnBlur = o$4),
        (this._cancelOnVisibilityChange = a$4),
        (this._computeSpeed = r$4),
        ...
        o$4 && e$6?.addEventListener(`blur`, this._blurCancelHandler),
    ...
    _updateDirection() {
      let e$6 = r$1(this._moveLeftKeys, this._moveKeyTimestamps),
        t$7 = r$1(this._moveRightKeys, this._moveKeyTimestamps),
        n$7 = r$1(this._moveUpKeys, this._moveKeyTimestamps),
        i$5 = r$1(this._moveDownKeys, this._moveKeyTimestamps),
        a$4 = e$6 === t$7 ? 0 : e$6 < t$7 ? -1 : 1,
    ...
    _onKeyUp(e$6) {
      this._moveKeyTimestamps.get(e$6.key) &&
        (this._moveKeyTimestamps.delete(e$6.key), this._updateDirection());
    }
    _onKeyDown(t$7) {
      if (!this.drag) {
      ...
      if (this._moveKeys.has(t$7.key)) {
        (t$7.preventDefault(),
          this._moveKeyTimestamps.get(t$7.key) ||
            (this._moveKeyTimestamps.set(t$7.key, Date.now()), this._updateDirection()));
        return;
      }
    }
    updateSettings(e$6 = {}) {
      ...
      if (
        ...
        [...this._moveKeys].every((t$8, n$7) => e$7[n$7] === t$8) ||
          ((this._moveKeys = new Set(e$7)),
          this._moveKeyTimestamps.clear(),
  ...
  function e(
    ...
    return (
      e$6 &&
        ((t$7.width = e$6.width),
        (t$7.height = e$6.height),
        (t$7.x = e$6.x),
        (t$7.y = e$6.y),
        (t$7.left = e$6.x),
        (t$7.top = e$6.y),
        (t$7.right = e$6.x + e$6.width),
        (t$7.bottom = e$6.y + e$6.height)),
      t$7
    );
  }

  //#endregion
  //#region ../dragdoll/dist/auto-scroll-Drw3BB1r.js
  var o$1 = class {
    constructor(
      e$6,
      {
        batchSize: t$7 = 100,
        minBatchCount: n$7 = 0,
        maxBatchCount: r$4 = 2 ** 53 - 1,
        initialBatchCount: i$5 = 0,
        shrinkThreshold: a$4 = 2,
        onRelease: o$4,
      } = {},
    ) {
      ((this._batchSize = Math.floor(Math.max(t$7, 1))),
        (this._minSize = Math.floor(Math.max(n$7, 0)) * this._batchSize),
        (this._maxSize = Math.floor(
          Math.min(Math.max(r$4 * this._batchSize, this._batchSize), 2 ** 53 - 1),
        )),
        (this._shrinkThreshold = Math.floor(Math.max(a$4, 1) * this._batchSize)),
        (this._data = Array(Math.floor(Math.max(Math.max(i$5, n$7) * this._batchSize, 0)))),
        (this._index = 0),
        (this._getItem = e$6),
        (this._onRelease = o$4));
    }
    get(...e$6) {
      ...
      if (this._index === 0) {
        let e$7 = this._data.length,
          t$7 = Math.min(this._batchSize, this._maxSize - e$7);
    ...
    release(e$6) {
      if (
        ...
        (this._onRelease && this._onRelease(e$6),
        (this._data[this._index++] = e$6),
  ...
  function g(e$6, t$7) {
    return !(
      e$6.x + e$6.width <= t$7.x ||
      t$7.x + t$7.width <= e$6.x ||
      e$6.y + e$6.height <= t$7.y ||
      t$7.y + t$7.height <= e$6.y
    );
  }
  const _ = {
      width: 0,
  ...
  function w(e$6) {
    switch (e$6) {
      ...
      case S.down:
        return `down`;
      default:
        throw Error(`Unknown direction value: ${e$6}`);
    }
  }
  function T(e$6, t$7, n$7) {
    ...
    return (
      ...
      (a$4 = Math.max(0, a$4)),
      (o$4 = Math.max(0, o$4)),
      (n$7.width = e$6.width + r$4 + i$5),
      (n$7.height = e$6.height + a$4 + o$4),
      (n$7.x = e$6.x - r$4),
      (n$7.y = e$6.y - a$4),
      n$7
    );
  ...
  var k = class {
      constructor() {
        ((this.positionX = 0),
          (this.positionY = 0),
          (this.directionX = C.none),
          (this.directionY = C.none),
    ...
    A = class {
      ...
      addRequest(e$6) {
        (y$1.x & e$6.direction
          ? (this.requestX && this.removeRequest(this.requestX), (this.requestX = e$6))
          : (this.requestY && this.removeRequest(this.requestY), (this.requestY = e$6)),
          (e$6.action = this));
      }
      removeRequest(e$6) {
        this.requestX === e$6
          ? ((this.requestX = null), (e$6.action = null))
          : this.requestY === e$6 && ((this.requestY = null), (e$6.action = null));
      }
      computeScrollValues() {
        this.element &&
          ((this.scrollLeft = this.requestX ? this.requestX.value : f(this.element)),
          (this.scrollTop = this.requestY ? this.requestY.value : m(this.element)));
      }
      scroll() {
        this.element &&
      ...
      computeCurrentScrollValue() {
        return this.element
          ? this.value === this.value
            ...
            : y$1.x & this.direction
              ? f(this.element)
              : m(this.element)
          : 0;
      }
      computeNextScrollValue() {
        let e$6 = this.speed * (this.deltaTime / 1e3),
          t$7 = b.forward & this.direction ? this.value + e$6 : this.value - e$6;
        return Math.max(0, Math.min(t$7, this.maxValue));
      }
      computeSpeed() {
        if (!this.item || !this.element) return 0;
        let { speed: e$6 } = this.item;
        return typeof e$6 == `function`
          ? ((v.direction = w(this.direction)),
            (v.threshold = this.threshold),
            (v.distance = this.distance),
            (v.value = this.value),
            (v.maxValue = this.maxValue),
            (v.duration = this.duration),
            (v.speed = this.speed),
            (v.deltaTime = this.deltaTime),
            (v.isEnding = this.isEnding),
            e$6(this.element, v))
          : e$6;
      }
      tick(e$6) {
  ...
  function M(e$6 = 500, t$7 = 0.5, n$7 = 0.25) {
    let r$4 = e$6 * (t$7 > 0 ? 1 / t$7 : Infinity),
      i$5 = e$6 * (n$7 > 0 ? 1 / n$7 : Infinity);
    return function (t$8, n$8) {
      ...
      let s$6 = a$4;
      return o$4 < a$4
        ? ((s$6 = o$4 + r$4 * (n$8.deltaTime / 1e3)), Math.min(a$4, s$6))
        : ((s$6 = o$4 - i$5 * (n$8.deltaTime / 1e3)), Math.max(a$4, s$6));
    };
  }
  var N = class {
    constructor(e$6 = {}) {
      ...
      ((this.items = []),
        ...
        (this._requestPool = new o$1((e$7) => e$7 || new j(), {
          initialBatchCount: 1,
          minBatchCount: 1,
    ...
    _frameRead(e$6) {
      this._isDestroyed ||
        (e$6 && this._tickTime
          ? ((this._tickDeltaTime = e$6 - this._tickTime),
            (this._tickTime = e$6),
            this._updateItems(),
            this._updateRequests(),
            this._updateActions())
          : ((this._tickTime = e$6), (this._tickDeltaTime = 0)));
    }
    _frameWrite() {
    ...
    _startTicking() {
      this._isTicking ||
        ((this._isTicking = !0),
        n$1.on(t$1.read, this._frameRead, this._frameRead),
        n$1.on(t$1.write, this._frameWrite, this._frameWrite));
    }
    _stopTicking() {
      this._isTicking &&
        ((this._isTicking = !1),
        (this._tickTime = 0),
        (this._tickDeltaTime = 0),
        n$1.off(t$1.read, this._frameRead),
        n$1.off(t$1.write, this._frameWrite));
    }
    _requestItemScroll(e$6, t$7, n$7, r$4, i$5, a$4, o$4) {
      let s$6 = this._requests[t$7],
        c$6 = s$6.get(e$6);
      (c$6
        ? (c$6.element !== n$7 || c$6.direction !== r$4) && c$6.reset()
        : ((c$6 = this._requestPool.get()), s$6.set(e$6, c$6)),
        (c$6.item = e$6),
        (c$6.element = n$7),
        (c$6.direction = r$4),
        (c$6.threshold = i$5),
    ...
    _cancelItemScroll(e$6, t$7) {
      let n$7 = this._requests[t$7],
        r$4 = n$7.get(e$6);
      r$4 &&
        (r$4.action && r$4.action.removeRequest(r$4),
        this._requestPool.release(r$4),
        n$7.delete(e$6));
    }
    _checkItemOverlap(e$6, t$7, n$7) {
      ...
      let c$6 = this._itemData.get(e$6),
        u$6 = c$6?.directionX,
        v$4 = c$6?.directionY;
      if (!u$6 && !v$4) {
        (t$7 && this._cancelItemScroll(e$6, y$1.x), n$7 && this._cancelItemScroll(e$6, y$1.y));
      ...
      for (; B < o$4.length; B++) {
        let e$7 = o$4[B],
          c$7 = typeof e$7.threshold == `number` ? e$7.threshold : 50,
          y$3 = !!(t$7 && u$6 && e$7.axis !== `y`),
          V = !!(n$7 && v$4 && e$7.axis !== `x`),
          H = e$7.priority || 0;
        if ((!y$3 || H < x$2) && (!V || H < P$1)) continue;
        let U = d(e$7.element || e$7),
          W = y$3 ? p(U) : -1,
          G = V ? h(U) : -1;
        if (W <= 0 && G <= 0) continue;
        let K = t$2([U, `padding`], window),
          q = n$2(s$6, K) || -Infinity;
        if (q === -Infinity)
          if (e$7.padding && g(s$6, T(K, e$7.padding, _))) q = -(l$1(s$6, K) || 0);
          else continue;
        if (y$3 && H >= x$2 && W > 0 && (H > x$2 || q > k$2)) {
          let e$8 = 0,
            t$8 = C.none,
            n$8 = D(c$7, K.width),
            r$4 = O(n$8, a$4, s$6.width, K.width);
          (u$6 === C.right
            ? ((e$8 = K.x + K.width + r$4 - (s$6.x + s$6.width)),
              e$8 <= n$8 && !E(f(U), W) && (t$8 = C.right))
            : u$6 === C.left &&
              ((e$8 = s$6.x - (K.x - r$4)), e$8 <= n$8 && f(U) > 0 && (t$8 = C.left)),
            t$8 &&
              ((b$2 = U), (x$2 = H), (w$2 = n$8), (k$2 = q), (A$2 = t$8), (j$2 = e$8), (M$2 = W)));
        }
        if (V && H >= P$1 && G > 0 && (H > P$1 || q > I$1)) {
          let e$8 = 0,
            t$8 = S.none,
            n$8 = D(c$7, K.height),
            r$4 = O(n$8, a$4, s$6.height, K.height);
          (v$4 === C.down
            ? ((e$8 = K.y + K.height + r$4 - (s$6.y + s$6.height)),
              e$8 <= n$8 && !E(m(U), G) && (t$8 = C.down))
            : v$4 === C.up && ((e$8 = s$6.y - (K.y - r$4)), e$8 <= n$8 && m(U) > 0 && (t$8 = C.up)),
            t$8 &&
              ((N$2 = U), (P$1 = H), (F$1 = n$8), (I$1 = q), (L$1 = t$8), (R$1 = e$8), (z$1 = G)));
        }
      }
      (t$7 &&
        (b$2 && A$2
          ? this._requestItemScroll(e$6, y$1.x, b$2, A$2, w$2, j$2, M$2)
          : this._cancelItemScroll(e$6, y$1.x)),
        n$7 &&
          (N$2 && L$1
            ? this._requestItemScroll(e$6, y$1.y, N$2, L$1, F$1, R$1, z$1)
            : this._cancelItemScroll(e$6, y$1.y)));
    }
    _updateScrollRequest(e$6) {
      let { inertAreaSize: t$7, smoothStop: n$7, targets: a$4, clientRect: o$4 } = e$6.item,
        s$6 = null,
        c$6 = 0;
      for (; c$6 < a$4.length; c$6++) {
        let n$8 = a$4[c$6],
          l$6 = d(n$8.element || n$8);
        ...
        let S$2 = D(
            typeof n$8.threshold == `number` ? n$8.threshold : 50,
            u$6 ? x$2.width : x$2.height,
          ),
          w$2 = O(S$2, t$7, u$6 ? o$4.width : o$4.height, u$6 ? x$2.width : x$2.height),
          k$2 = 0;
        if (
          ((k$2 =
            e$6.direction === C.left
              ? o$4.x - (x$2.x - w$2)
              : e$6.direction === C.right
                ? x$2.x + x$2.width + w$2 - (o$4.x + o$4.width)
                : e$6.direction === C.up
                  ? o$4.y - (x$2.y - w$2)
                  : x$2.y + x$2.height + w$2 - (o$4.y + o$4.height)),
          k$2 > S$2)
        )
          break;
      ...
      return (
        n$7 === !0 && e$6.speed > 0
          ? (s$6 === null && (s$6 = e$6.hasReachedEnd()), (e$6.isEnding = !s$6))
          : (e$6.isEnding = !1),
        e$6.isEnding
      );
    }
    _updateItems() {
      for (let e$6 = 0; e$6 < this.items.length; e$6++) {
        let t$7 = this.items[e$6],
          n$7 = this._itemData.get(t$7),
          { x: r$4, y: i$5 } = t$7.position,
          a$4 = n$7.positionX,
          o$4 = n$7.positionY;
        (r$4 === a$4 && i$5 === o$4) ||
          ((n$7.directionX = r$4 > a$4 ? C.right : r$4 < a$4 ? C.left : n$7.directionX),
          (n$7.directionY = i$5 > o$4 ? C.down : i$5 < o$4 ? C.up : n$7.directionY),
          (n$7.positionX = r$4),
          (n$7.positionY = i$5),
          n$7.overlapCheckRequestTime === 0 && (n$7.overlapCheckRequestTime = this._tickTime));
      }
    }
    _updateRequests() {
      let e$6 = this.items,
        t$7 = this._requests[y$1.x],
        n$7 = this._requests[y$1.y],
        r$4 = 0;
      for (; r$4 < e$6.length; r$4++) {
        let i$5 = e$6[r$4],
          a$4 = this._itemData.get(i$5),
          o$4 = a$4.overlapCheckRequestTime,
          s$6 = o$4 > 0 && this._tickTime - o$4 > this.settings.overlapCheckInterval,
          c$6 = !0,
          l$6 = t$7.get(i$5);
        l$6 &&
          l$6.isActive &&
          ((c$6 = !this._updateScrollRequest(l$6)),
          c$6 && ((s$6 = !0), this._cancelItemScroll(i$5, y$1.x)));
        let u$6 = !0,
          d$3 = n$7.get(i$5);
        (d$3 &&
          d$3.isActive &&
          ((u$6 = !this._updateScrollRequest(d$3)),
          u$6 && ((s$6 = !0), this._cancelItemScroll(i$5, y$1.y))),
          s$6 && ((a$4.overlapCheckRequestTime = 0), this._checkItemOverlap(i$5, c$6, u$6)));
      }
    }
    _requestAction(e$6, t$7) {
      ...
      ((r$4 ||= this._actionPool.get()),
        (r$4.element = e$6.element),
        r$4.addRequest(e$6),
        e$6.tick(this._tickDeltaTime),
        this._actions.push(r$4));
    }
    _updateActions() {
      let e$6 = 0;
      for (e$6 = 0; e$6 < this.items.length; e$6++) {
        let t$7 = this.items[e$6],
          n$7 = this._requests[y$1.x].get(t$7),
          r$4 = this._requests[y$1.y].get(t$7);
    ...
    _applyActions() {
      ...
      let e$6 = 0;
      for (e$6 = 0; e$6 < this._actions.length; e$6++)
        (this._actions[e$6].scroll(), this._actionPool.release(this._actions[e$6]));
      this._actions.length = 0;
    }
    addItem(e$6) {
      if (this._isDestroyed || this._itemData.has(e$6)) return;
      let { x: t$7, y: n$7 } = e$6.position,
        r$4 = new k();
      ((r$4.positionX = t$7),
        (r$4.positionY = n$7),
        (r$4.directionX = C.none),
        (r$4.directionY = C.none),
        (r$4.overlapCheckRequestTime = this._tickTime),
        this._itemData.set(e$6, r$4),
        this.items.push(e$6),
    ...
    removeItem(e$6) {
      ...
      t$7 !== -1 &&
        (this._requests[y$1.x].get(e$6) &&
          (this._cancelItemScroll(e$6, y$1.x), this._requests[y$1.x].delete(e$6)),
        this._requests[y$1.y].get(e$6) &&
          (this._cancelItemScroll(e$6, y$1.y), this._requests[y$1.y].delete(e$6)),
        this._itemData.delete(e$6),
        this.items.splice(t$7, 1),
    ...
    destroy() {
      this._isDestroyed ||=
        (this.items.forEach((e$6) => this.removeItem(e$6)),
  ...
  //#endregion
  //#region ../dragdoll/dist/auto-scroll-JoquSmSR.js
  const t = new N();
  ...
  var o = class {
      ...
      get position() {
        let e$6 = this._position,
          { getPosition: t$7 } = this._getSettings();
        return (
          typeof t$7 == `function`
            ? Object.assign(e$6, t$7(this._draggable))
            : ((e$6.x = 0), (e$6.y = 0)),
          e$6
        );
      }
      get clientRect() {
        let e$6 = this._clientRect,
          { getClientRect: t$7 } = this._getSettings();
        return (
          typeof t$7 == `function`
            ? Object.assign(e$6, t$7(this._draggable))
            : ((e$6.width = 0), (e$6.height = 0), (e$6.x = 0), (e$6.y = 0)),
          e$6
        );
      }
      get inertAreaSize() {
    ...
    s = class {
      constructor(t$7, r$4 = {}) {
        ((this.name = `autoscroll`),
          (this.version = `0.0.3`),
          (this.settings = this._parseSettings(r$4)),
          (this._autoScrollProxy = null),
          t$7.on(L.Start, () => {
            this._autoScrollProxy ||
              ((this._autoScrollProxy = new o(this, t$7)), t.addItem(this._autoScrollProxy));
          }),
          t$7.on(L.End, () => {
      ...
      _parseSettings(e$6, t$7 = a$1()) {
        let {
          targets: n$7 = t$7.targets,
          inertAreaSize: r$4 = t$7.inertAreaSize,
          speed: i$5 = t$7.speed,
          smoothStop: o$4 = t$7.smoothStop,
          getPosition: s$6 = t$7.getPosition,
          getClientRect: c$6 = t$7.getClientRect,
          onStart: l$6 = t$7.onStart,
          onStop: u$6 = t$7.onStop,
        } = e$6 || {};
        return {
          targets: n$7,
          inertAreaSize: r$4,
