	...
	_checkItemOverlap(e$6, t$6, n$7) {
		...
		for (; B$1 < o$4.length; B$1++) {
			...
			if (y$3 && H >= x$2 && W > 0 && (H > x$2 || q > k$2)) {
				let e$8 = 0, t$7 = C$1.none, n$8 = D$1(l$7, K.width), r$5 = O$1(n$8, a$4, s$6.width, K.width);
				g$3 === C$1.right ? (e$8 = K.x + K.width + r$5 - (s$6.x + s$6.width), e$8 <= n$8 && !E$1(d$3(U), W) && (t$7 = C$1.right)) : g$3 === C$1.left && (e$8 = s$6.x - (K.x - r$5), e$8 <= n$8 && d$3(U) > 0 && (t$7 = C$1.left)), t$7 && (b$2 = U, x$2 = H, w$2 = n$8, k$2 = q, A$2 = t$7, j$2 = e$8, M$2 = W);
			}
			if (V && H >= P$1 && G > 0 && (H > P$1 || q > I$1)) {
				let e$8 = 0, t$7 = S$1.none, n$8 = D$1(l$7, K.height), r$5 = O$1(n$8, a$4, s$6.height, K.height);
				v$4 === C$1.down ? (e$8 = K.y + K.height + r$5 - (s$6.y + s$6.height), e$8 <= n$8 && !E$1(p$2(U), G) && (t$7 = C$1.down)) : v$4 === C$1.up && (e$8 = s$6.y - (K.y - r$5), e$8 <= n$8 && p$2(U) > 0 && (t$7 = C$1.up)), t$7 && (N$2 = U, P$1 = H, F$1 = n$8, I$1 = q, L$1 = t$7, R$1 = e$8, z$1 = G);
			}
		}
...
var r$3 = class {
	...
	allocate(...e$6) {
		let t$6 = this._index, n$7 = this._items, r$5 = this._initItem(n$7[t$6], ...e$6);
		return n$7[t$6] = r$5, ++this._index, r$5;
	}
	reset() {
		this._index = 0;
	}
...
var a$3 = class {
	...
	_getCollisionDataArena(e$6) {
		...
		return t$6 || (t$6 = this._cdArenaPool.pop() || new r$3((e$7) => e$7 || this._createCollisionData()), this._cdArenaMap.set(e$6, t$6)), t$6;
	}
	...
	detectCollisions(e$6, t$6, n$7) {
		...
		let r$5 = this._getCollisionDataArena(e$6), i$5 = null, a$4 = t$6.values();
		for (let t$7 of a$4) i$5 ||= r$5.allocate(), this._checkCollision(e$6, t$7, i$5) && (n$7.push(i$5), i$5 = null);
		n$7.length > 1 && this._sortCollisions(e$6, n$7), r$5.reset();
	}
	destroy() {
...
const F = {
	...
	applyPosition: ({ item: e$6, phase: t$6 }) => {
		let n$7 = t$6 === L.End || t$6 === L.EndAlign, [r$5, i$5] = e$6.getContainerMatrix(), [a$4, o$4] = e$6.getDragContainerMatrix(), { position: s$6, alignmentOffset: c$6, containerOffset: l$6, elementTransformMatrix: d$4, elementTransformOrigin: f$3, elementOffsetMatrix: p$3 } = e$6, { x: m$3, y: h$3, z: g$3 } = f$3, _$4 = !d$4.isIdentity && (m$3 !== 0 || h$3 !== 0 || g$3 !== 0), v$4 = s$6.x + c$6.x + l$6.x, y$3 = s$6.y + c$6.y + l$6.y;
...
var B = class {
	...
	constructor(e$6, t$6 = {}) {
		...
		this.id = n$7, this._sensors = e$6, this.settings = this._parseSettings(r$5), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N$1.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this._sensors.forEach((e$7) => {
	...
	set sensors(e$6) {
		...
		if (e$6 === t$6) return;
		let n$7 = t$6.filter((t$7) => !e$6.includes(t$7)), r$5 = e$6.filter((e$7) => !t$6.includes(e$7));
	...
	_unbindSensor(e$6) {
		...
		if (!t$6) return;
		let { onMove: n$7, onEnd: r$5 } = t$6;
		e$6.off(e.Start, n$7), e$6.off(e.Move, n$7), e$6.off(e.Cancel, r$5), e$6.off(e.End, r$5), e$6.off(e.Destroy, r$5), this._sensorData.delete(e$6);
	}
	...
	_applyStart() {
		...
		if (!(!e$6 || this._startPhase !== N$1.FinishPrepare)) {
			...
			for (let t$6 of e$6.items) {
				...
				i$5.x += d$1(t$6.clientRect.x - r$5.x, 3), i$5.y += d$1(t$6.clientRect.y - r$5.y, 3);
			}
			for (let t$6 of e$6.items) {
	...
	stop() {
		...
		if (!(!n$7 || n$7.isEnded)) {
			...
			n$7.isEnded = !0, this._prepareStart(), this._applyStart(), this._startPhase = N$1.None, r$1.off(n$2.read, this._startId), r$1.off(n$2.write, this._startId), r$1.off(n$2.read, this._moveId), r$1.off(n$2.write, this._moveId), r$1.off(n$2.read, this._alignId), r$1.off(n$2.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k), this._applyModifiers(F.End, 0, 0);
...
var n = class {
	...
	constructor(t$6, n$7 = {}) {
		...
		this.id = r$5, this.element = t$6, this.isDestroyed = !1, this.accept = i$5, this.data = a$4, this._clientRect = {
			x: 0,
			y: 0,
			width: 0,
			height: 0
...
var u = class {
	...
	_stopDrag(n$7, r$5 = !1) {
		...
		this._emitter.listenerCount(l.End) && this._emitter.emit(l.End, {
			...
			collisions: o$4,
			contacts: u$6
		}), this._drags.delete(n$7), this._collisionDetector._removeCollisionDataArena(n$7), r$1.off(n$2.read, i$5._cd.tickerId), r$1.off(n$2.write, i$5._cd.tickerId), this._drags.size || (r$1.off(n$2.read, this._listenerId), window.removeEventListener(`scroll`, this._onScroll, c$2));
	}
	...
	_emitCollisions(e$6, t$6 = !1) {
		...
		let i$5 = this._emitter, a$4 = r$5.collisions, o$4 = r$5.targets, c$6 = r$5.addedContacts, u$6 = r$5.persistedContacts, d$4 = r$5.contacts, f$3 = r$5.prevContacts;
		r$5.prevContacts = d$4, r$5.contacts = f$3;
		let p$3 = d$4;
		...
		}), c$6.clear(), u$6.clear(), d$4.clear(), r$5.phase = s$2.Idle;
	}
	on(e$6, t$6, n$7) {
		return this._emitter.on(e$6, t$6, n$7);
	}
