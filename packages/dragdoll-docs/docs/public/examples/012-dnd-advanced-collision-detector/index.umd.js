...
let n$4 = new l$5({ phases: [t$1.read, t$1.write] });

//#endregion
//#region ../dragdoll/dist/constants-BG0DGMmK.js
const e$4 = typeof window < `u` && window.document !== void 0, t = e$4 && `ontouchstart` in window, n$1 = e$4 && !!window.PointerEvent;
...
var f$2 = class {
	...
	constructor(e$6, t$7) {
		this.sensor = e$6, this.startEvent = t$7, this.prevMoveEvent = t$7, this.moveEvent = t$7, this.endEvent = null, this.items = [], this.isEnded = !1, this._matrixCache = new f$2(), this._clientOffsetCache = new f$2();
	}
};
function m$2(e$6, t$7, n$7 = !1) {
	let { style: r$4 } = e$6;
	for (let e$7 in t$7) r$4.setProperty(e$7, t$7[e$7], n$7 ? `important` : ``);
}
function h$2() {
	let e$6 = document.createElement(`div`);
	return e$6.classList.add(`dragdoll-measure`), m$2(e$6, {
		display: `block`,
		position: `absolute`,
		inset: `0px`,
		padding: `0px`,
...
function y$2(e$6, t$7 = !1) {
	let { translate: n$7, rotate: r$4, scale: a$4, transform: o$4 } = t$4(e$6), s$6 = ``;
	if (n$7 && n$7 !== `none`) {
		let [t$8 = `0px`, r$5 = `0px`, i$5] = n$7.split(` `);
		t$8.includes(`%`) && (t$8 = `${parseFloat(t$8) / 100 * v$3(e$6)}px`), r$5.includes(`%`) && (r$5 = `${parseFloat(r$5) / 100 * _$2(e$6)}px`), i$5 ? s$6 += `translate3d(${t$8},${r$5},${i$5})` : s$6 += `translate(${t$8},${r$5})`;
	}
	if (r$4 && r$4 !== `none`) {
		let e$7 = r$4.split(` `);
...
function C$1(e$6, t$7, n$7 = {
	x: 0,
	y: 0
}) {
	let r$4 = b$1(e$6) ? e$6 : g$2(e$6, x$1), i$5 = b$1(t$7) ? t$7 : g$2(t$7, S$1);
...
function E$1(e$6, t$7 = new DOMMatrix()) {
	let n$7 = e$6;
	for (u$4(t$7); n$7;) {
		let e$7 = y$2(n$7);
		if (e$7 && (T$1.setMatrixValue(e$7), !T$1.isIdentity)) {
			let { transformOrigin: e$8 } = t$4(n$7), { x: r$4, y: a$4, z: o$4 } = w$1(e$8);
			o$4 === 0 ? T$1.setMatrixValue(`translate(${r$4}px,${a$4}px) ${T$1} translate(${r$4 * -1}px,${a$4 * -1}px)`) : T$1.setMatrixValue(`translate3d(${r$4}px,${a$4}px,${o$4}px) ${T$1} translate3d(${r$4 * -1}px,${a$4 * -1}px,${o$4 * -1}px)`), t$7.preMultiplySelf(T$1);
		}
		n$7 = n$7.parentElement;
	}
	return t$7;
}
const D$1 = e$4 ? h$2() : null;
var O$1 = class {
	constructor(e$6, t$7) {
		if (!e$6.isConnected) throw Error(`Element is not connected`);
		let { drag: n$7 } = t$7;
		if (!n$7) throw Error(`Drag is not defined`);
		let r$4 = t$4(e$6), a$4 = e$6.getBoundingClientRect(), s$6 = y$2(e$6, !0);
		this.data = {}, this.element = e$6, this.elementTransformOrigin = w$1(r$4.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$6 + r$4.transform), this.elementOffsetMatrix = new DOMMatrix(s$6).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$6) => {
			if (!this._matrixCache.isValid(e$6)) {
				...
				E$1(e$6, n$7), r$4.setMatrixValue(n$7.toString()).invertSelf(), this._matrixCache.set(e$6, t$7);
			}
		});
	}
	_updateContainerOffset() {
		...
		if (e$6 !== n$7) {
			let [s$6, l$6] = [[r$4, n$7], [t$7, e$6]].map(([e$7, t$8]) => {
				...
				if (!a$4.isValid(t$8)) {
					let r$5 = o$4.get(e$7);
					t$8 instanceof HTMLElement && r$5 && !r$5[0].isIdentity ? c$5(r$5[0]) ? (D$1.style.setProperty(`transform`, r$5[1].toString(), `important`), t$8.append(D$1), g$2(D$1, n$8), D$1.remove()) : (g$2(t$8, n$8), n$8.x -= r$5[0].m41, n$8.y -= r$5[0].m42) : g$2(t$8, n$8);
				}
...
const F = {
	...
	applyPosition: ({ item: e$6, phase: t$7 }) => {
		...
		u$4(j$1), _$4 && (g$3 === 0 ? j$1.translateSelf(-m$3, -h$3) : j$1.translateSelf(-m$3, -h$3, -g$3)), n$7 ? i$5.isIdentity || j$1.multiplySelf(i$5) : o$4.isIdentity || j$1.multiplySelf(o$4), u$4(M$1).translateSelf(v$4, y$3), j$1.multiplySelf(M$1), r$4.isIdentity || j$1.multiplySelf(r$4), _$4 && (u$4(M$1).translateSelf(m$3, h$3, g$3), j$1.multiplySelf(M$1)), d$3.isIdentity || j$1.multiplySelf(d$3), p$3.isIdentity || j$1.preMultiplySelf(p$3), e$6.element.style.transform = `${j$1}`;
	},
...
var z = class {
	constructor(t$7, n$7 = {}) {
		...
		this.id = r$4, this.sensors = t$7, this.settings = this._parseSettings(i$5), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N$1.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this.sensors.forEach((t$8) => {
			...
			t$8.on(e.Start, n$8, n$8), t$8.on(e.Move, n$8, n$8), t$8.on(e.Cancel, r$5, r$5), t$8.on(e.End, r$5, r$5), t$8.on(e.Destroy, r$5, r$5);
		});
	}
	...
	_onMove(e$6, r$4) {
		...
		if (i$5) switch (i$5.predicateState) {
			...
			case P.Resolved:
				this.drag && (this.drag.moveEvent = e$6, n$4.once(t$1.read, this._prepareMove, this._moveId), n$4.once(t$1.write, this._applyMove, this._moveId));
				break;
		}
	}
	_onScroll() {
	...
	_prepareStart() {
		...
		e$6 && (this._startPhase = N$1.Prepare, e$6.items = (this.settings.elements({
			draggable: this,
			drag: e$6
		}) || []).map((e$7) => new O$1(e$7, this)), this._applyModifiers(F.Start, 0, 0), this._emit(L.PrepareStart, e$6.startEvent), this.settings.onPrepareStart?.(e$6, this), this._startPhase = N$1.FinishPrepare);
	}
	_applyStart() {
		let e$6 = this.drag;
		if (e$6) {
			this._startPhase = N$1.Apply;
			for (let t$7 of e$6.items) t$7.dragContainer !== t$7.elementContainer && l$4(t$7.dragContainer, t$7.element), t$7.frozenStyles && Object.assign(t$7.element.style, t$7.frozenStyles), this.settings.applyPosition({
				phase: I.Start,
				draggable: this,
				drag: e$6,
				item: t$7
			...
			for (let t$7 of e$6.items) {
				...
				if (s$5(e$7, n$7) || !c$5(e$7) && !c$5(n$7)) continue;
				let r$4 = t$7.element.getBoundingClientRect(), { alignmentOffset: i$5 } = t$7;
				i$5.x += d$2(t$7.clientRect.x - r$4.x, 3), i$5.y += d$2(t$7.clientRect.y - r$4.y, 3);
			}
			for (let t$7 of e$6.items) {
	...
	resolveStartPredicate(e$6, r$4) {
		...
		i$5.predicateState === P.Pending && a$4 && (this._startPhase = N$1.Init, i$5.predicateState = P.Resolved, i$5.predicateEvent = null, this.drag = new p$2(e$6, a$4), this._sensorData.forEach((t$7, n$7) => {
			n$7 !== e$6 && (t$7.predicateState = P.Rejected, t$7.predicateEvent = null);
		}), n$4.once(t$1.read, this._prepareStart, this._startId), n$4.once(t$1.write, this._applyStart, this._startId));
	}
	...
	stop() {
		...
		if (this._startPhase = N$1.None, e$6.isEnded = !0, n$4.off(t$1.read, this._startId), n$4.off(t$1.write, this._startId), n$4.off(t$1.read, this._moveId), n$4.off(t$1.write, this._moveId), n$4.off(t$1.read, this._alignId), n$4.off(t$1.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k$1), r$4 > N$1.Init && this._applyModifiers(F.End, 0, 0), r$4 === N$1.FinishApply) {
			for (let t$7 of e$6.items) {
				if (t$7.elementContainer !== t$7.dragContainer && (l$4(t$7.elementContainer, t$7.element), t$7.alignmentOffset.x = 0, t$7.alignmentOffset.y = 0, t$7.containerOffset.x = 0, t$7.containerOffset.y = 0), t$7.unfrozenStyles) for (let e$7 in t$7.unfrozenStyles) t$7.element.style[e$7] = t$7.unfrozenStyles[e$7] || ``;
			...
			for (let t$7 of e$6.items) if (t$7.elementContainer !== t$7.dragContainer) {
				...
				t$7.alignmentOffset.x = d$2(t$7.clientRect.x - e$7.x, 3), t$7.alignmentOffset.y = d$2(t$7.clientRect.y - e$7.y, 3);
			}
	...
	align(e$6 = !1) {
		this.drag && (e$6 ? (this._prepareAlign(), this._applyAlign()) : (n$4.once(t$1.read, this._prepareAlign, this._alignId), n$4.once(t$1.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensorData.forEach(({ onMove: t$7, onEnd: n$7 }, r$4) => {
			r$4.off(e.Start, t$7), r$4.off(e.Move, t$7), r$4.off(e.Cancel, n$7), r$4.off(e.End, n$7), r$4.off(e.Destroy, n$7);
...
var u = class {
	constructor(e$6 = {}) {
		this._onScroll = () => {
			this._drags.size !== 0 && (n$4.once(t$1.read, () => {
				this.updateDroppableClientRects();
			}, this._listenerId), this.detectCollisions());
		};
		let { collisionDetector: r$4 } = e$6;
		this.draggables = /* @__PURE__ */ new Map(), this.droppables = /* @__PURE__ */ new Map(), this.isDestroyed = !1, this._drags = /* @__PURE__ */ new Map(), this._listenerId = Symbol(), this._emitter = new v(), this._onScroll = this._onScroll.bind(this), this._collisionDetector = r$4 ? r$4(this) : new a$3(this);
	}
	get drags() {
		return this._drags;
	}
	...
	_finalizeStopDrag(e$6) {
		...
		!r$4 || !r$4.isEnded || (this._drags.delete(e$6), this._collisionDetector.removeCollisionDataPool(e$6), n$4.off(t$1.read, r$4._cd.tickerId), n$4.off(t$1.write, r$4._cd.tickerId), this._drags.size || (n$4.off(t$1.read, this._listenerId), window.removeEventListener(`scroll`, this._onScroll, c$4)));
	}
	...
	detectCollisions(e$6) {
		if (!this.isDestroyed) if (e$6) {
			...
			n$4.once(t$1.read, () => this._computeCollisions(e$6), r$4._cd.tickerId), n$4.once(t$1.write, () => this._emitCollisions(e$6), r$4._cd.tickerId);
		} else for (let [e$7, r$4] of this._drags) r$4.isEnded || (n$4.once(t$1.read, () => this._computeCollisions(e$7), r$4._cd.tickerId), n$4.once(t$1.write, () => this._emitCollisions(e$7), r$4._cd.tickerId));
	}
	addDraggables(t$7) {
		...
		for (let i$5 of t$7) this.draggables.has(i$5.id) || (n$7.add(i$5), this.draggables.set(i$5.id, i$5), i$5.on(L.PrepareStart, () => {
			...
			t$8?.type === e.End ? this._onDragEnd(i$5) : t$8?.type === e.Cancel && this._onDragCancel(i$5);
...
function v$2(e$6, t$7 = n$6()) {
	n$6(e$6.length ? t$3([e$6[0], `padding`], window) : d$1, t$7);
	for (let r$4 = 1; r$4 < e$6.length; r$4++) {
		let a$4 = e$6[r$4];
		if (!e$3(t$7, t$3([a$4, `padding`], window), t$7)) {
			n$6(u$3, t$7);
			break;
		}
	}
	...
	_checkCollision(e$6, t$7, i$5) {
		...
		if (!u$6) {
			...
			if (p$1.length = 0, m$1.length = 0, h$1.length = 0, _$1(t$7), u$6 = p$1[0] || window, a$4.clipMaskKeyMap.set(t$7, u$6), !a$4.clipMaskMap.has(u$6)) {
				...
				let t$8 = n$7 || !l$3 ? v$2(m$1) : n$6(l$3), r$4 = v$2(h$1);
		...
		let b$2 = n$5(i$5.draggableVisibleRect, i$5.droppableVisibleRect, i$5.intersectionRect);
		return b$2 <= 0 ? null : (i$5.droppableId = t$7.id, n$6(c$6, i$5.droppableRect), n$6(s$6, i$5.draggableRect), i$5.intersectionScore = b$2, i$5);
	}
	_sortCollisions(e$6, t$7) {
		return t$7.sort((e$7, t$8) => {
			let n$7 = t$8.intersectionScore - e$7.intersectionScore;
...
const s$2 = e$1(), c$2 = e$1();
function l$2(e$6, t$7) {
	return getDistance(e$1(e$6, s$2), e$1(t$7, c$2));
}
function u$2(e$6) {
...
var k = class {
	...
	computeSpeed() {
		...
		return typeof e$6 == `function` ? (v$1.direction = w(this.direction), v$1.threshold = this.threshold, v$1.distance = this.distance, v$1.value = this.value, v$1.maxValue = this.maxValue, v$1.duration = this.duration, v$1.speed = this.speed, v$1.deltaTime = this.deltaTime, v$1.isEnding = this.isEnding, e$6(this.element, v$1)) : e$6;
	}
	tick(e$6) {
...
var N = class {
	constructor(e$6 = {}) {
		...
		}, this._itemData = /* @__PURE__ */ new Map(), this._requestPool = new o$2((e$7) => e$7 || new j(), {
			initialBatchCount: 1,
			minBatchCount: 1,
			onRelease: (e$7) => e$7.reset()
		}), this._actionPool = new o$2((e$7) => e$7 || new A(), {
			batchSize: 10,
			initialBatchCount: 1,
			minBatchCount: 1,
			onRelease: (e$7) => e$7.reset()
	...
	_startTicking() {
		this._isTicking || (this._isTicking = !0, n$4.on(t$1.read, this._frameRead, this._frameRead), n$4.on(t$1.write, this._frameWrite, this._frameWrite));
	}
	_stopTicking() {
		this._isTicking && (this._isTicking = !1, this._tickTime = 0, this._tickDeltaTime = 0, n$4.off(t$1.read, this._frameRead), n$4.off(t$1.write, this._frameWrite));
	}
	...
	_checkItemOverlap(e$6, t$7, n$7) {
		...
		for (; B < o$4.length; B++) {
			...
			if (W <= 0 && G <= 0) continue;
			let K = t$3([U, `padding`], window), q = n$5(s$6, K) || -Infinity;
			if (q === -Infinity) if (e$7.padding && g(s$6, T(K, e$7.padding, _))) q = -(l$2(s$6, K) || 0);
			else continue;
	...
	_updateScrollRequest(e$6) {
		...
		for (; c$6 < a$4.length; c$6++) {
			...
			if (v$4 <= 0) break;
			let x$2 = t$3([l$6, `padding`], window);
...
function a$2() {
	return {
		...
		getClientRect: (e$6) => {
			...
			return i$3.width = r$4 ? 50 : 0, i$3.height = r$4 ? 50 : 0, i$3.x = r$4 ? r$4.x - 25 : 0, i$3.y = r$4 ? r$4.y - 25 : 0, i$3;
		},
		onStart: null,
		onStop: null
	};
...
var o$1 = class {
	...
	constructor(t$7, r$4 = {}) {
		this.name = `autoscroll`, this.version = `0.0.3`, this.settings = this._parseSettings(r$4), this._autoScrollProxy = null, t$7.on(L.Start, () => {
			this._autoScrollProxy || (this._autoScrollProxy = new o$1(this, t$7), t$2.addItem(this._autoScrollProxy));
		}), t$7.on(L.End, () => {
			this._autoScrollProxy &&= (t$2.removeItem(this._autoScrollProxy), null);
		});
	}
	_parseSettings(e$6, t$7 = a$2()) {
...
function c(e$6) {
	return (t$7) => {
		let n$7 = new s$1(t$7, e$6), r$4 = t$7;
...
var i$1 = class extends n$3 {
	...
	_start(e$6) {
		this.isDestroyed || this.drag || (super._start(e$6), n$4.on(t$1.read, this._tick, this._tick));
	}
	_end(e$6) {
		this.drag && (n$4.off(t$1.read, this._tick), super._end(e$6));
	}
	_cancel(e$6) {
		this.drag && (n$4.off(t$1.read, this._tick), super._cancel(e$6));
	}
	_tick(t$7) {
...
function c$1(e$6) {
	return e$6 === `auto` || e$6 === void 0 ? n$1 ? `pointer` : t ? `touch` : `mouse` : e$6;
}
const l$1 = {
	pointer: {
		start: `pointerdown`,
...
var u$1 = class {
	constructor(e$6, t$7 = {}) {
		...
		this.element = e$6, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$4, this._listenerOptions = s(n$7), this._sourceEvents = c$1(i$5), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$6.addEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	_getTrackedPointerEventData(e$6) {
		return this.drag ? i(e$6, this.drag.pointerId) : null;
	}
	_onStart(t$7) {
	...
	updateSettings(e$6) {
		if (this.isDestroyed) return;
		let { listenerOptions: t$7, sourceEvents: n$7, startPredicate: r$4 } = e$6, i$5 = c$1(n$7), a$4 = s(t$7);
