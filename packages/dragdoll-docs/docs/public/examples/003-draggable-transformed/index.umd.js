...
let n$3 = new l$3({ phases: [t$1.read, t$1.write] });

//#endregion
//#region ../dragdoll/dist/constants-BG0DGMmK.js
const e$3 = typeof window < `u` && window.document !== void 0, t = e$3 && `ontouchstart` in window, n = e$3 && !!window.PointerEvent;
...
function y$1(e$5, t$6 = !1) {
	...
	if (n$5 && n$5 !== `none`) {
		...
		t$7.includes(`%`) && (t$7 = `${parseFloat(t$7) / 100 * v$2(e$5)}px`), r$4.includes(`%`) && (r$4 = `${parseFloat(r$4) / 100 * _$1(e$5)}px`), i$4 ? s$4 += `translate3d(${t$7},${r$4},${i$4})` : s$4 += `translate(${t$7},${r$4})`;
	}
	if (r$3 && r$3 !== `none`) {
		let e$6 = r$3.split(` `);
...
function C$1(e$5, t$6, n$5 = {
	x: 0,
	y: 0
}) {
	let r$3 = b$1(e$5) ? e$5 : g$1(e$5, x$1), i$4 = b$1(t$6) ? t$6 : g$1(t$6, S$1);
...
function E$1(e$5, t$6 = new DOMMatrix()) {
	let n$5 = e$5;
	for (u$2(t$6); n$5;) {
		let e$6 = y$1(n$5);
		if (e$6 && (T$1.setMatrixValue(e$6), !T$1.isIdentity)) {
			let { transformOrigin: e$7 } = t$5(n$5), { x: r$3, y: a$3, z: o$4 } = w$1(e$7);
			o$4 === 0 ? T$1.setMatrixValue(`translate(${r$3}px,${a$3}px) ${T$1} translate(${r$3 * -1}px,${a$3 * -1}px)`) : T$1.setMatrixValue(`translate3d(${r$3}px,${a$3}px,${o$4}px) ${T$1} translate3d(${r$3 * -1}px,${a$3 * -1}px,${o$4 * -1}px)`), t$6.preMultiplySelf(T$1);
		}
		n$5 = n$5.parentElement;
	}
	return t$6;
}
const D$1 = e$3 ? h$1() : null;
var O$1 = class {
	constructor(e$5, t$6) {
		if (!e$5.isConnected) throw Error(`Element is not connected`);
		let { drag: n$5 } = t$6;
		if (!n$5) throw Error(`Drag is not defined`);
		let r$3 = t$5(e$5), a$3 = e$5.getBoundingClientRect(), s$4 = y$1(e$5, !0);
		this.data = {}, this.element = e$5, this.elementTransformOrigin = w$1(r$3.transformOrigin), this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$4 + r$3.transform), this.elementOffsetMatrix = new DOMMatrix(s$4).invertSelf(), this.frozenStyles = null, this.unfrozenStyles = null, this.position = {
			x: 0,
			y: 0
	...
	_updateContainerMatrices() {
		[this.elementContainer, this.dragContainer].forEach((e$5) => {
			if (!this._matrixCache.isValid(e$5)) {
				...
				E$1(e$5, n$5), r$3.setMatrixValue(n$5.toString()).invertSelf(), this._matrixCache.set(e$5, t$6);
			}
		});
	}
	_updateContainerOffset() {
		...
		if (e$5 !== n$5) {
			let [s$4, l$4] = [[r$3, n$5], [t$6, e$5]].map(([e$6, t$7]) => {
				...
				if (!a$3.isValid(t$7)) {
					let r$4 = o$4.get(e$6);
					t$7 instanceof HTMLElement && r$4 && !r$4[0].isIdentity ? c$3(r$4[0]) ? (D$1.style.setProperty(`transform`, r$4[1].toString(), `important`), t$7.append(D$1), g$1(D$1, n$6), D$1.remove()) : (g$1(t$7, n$6), n$6.x -= r$4[0].m41, n$6.y -= r$4[0].m42) : g$1(t$7, n$6);
				}
...
const F = {
	...
	applyPosition: ({ item: e$5, phase: t$6 }) => {
		...
		u$2(j$1), _$3 && (g$2 === 0 ? j$1.translateSelf(-m$2, -h$2) : j$1.translateSelf(-m$2, -h$2, -g$2)), n$5 ? i$4.isIdentity || j$1.multiplySelf(i$4) : o$4.isIdentity || j$1.multiplySelf(o$4), u$2(M$1).translateSelf(v$3, y$2), j$1.multiplySelf(M$1), r$3.isIdentity || j$1.multiplySelf(r$3), _$3 && (u$2(M$1).translateSelf(m$2, h$2, g$2), j$1.multiplySelf(M$1)), d$2.isIdentity || j$1.multiplySelf(d$2), p$2.isIdentity || j$1.preMultiplySelf(p$2), e$5.element.style.transform = `${j$1}`;
	},
...
var z = class {
	constructor(t$6, n$5 = {}) {
		...
		this.id = r$3, this.sensors = t$6, this.settings = this._parseSettings(i$4), this.plugins = {}, this.drag = null, this.isDestroyed = !1, this._sensorData = /* @__PURE__ */ new Map(), this._emitter = new v(), this._startPhase = N$1.None, this._startId = Symbol(), this._moveId = Symbol(), this._alignId = Symbol(), this._onMove = this._onMove.bind(this), this._onScroll = this._onScroll.bind(this), this._onEnd = this._onEnd.bind(this), this._prepareStart = this._prepareStart.bind(this), this._applyStart = this._applyStart.bind(this), this._prepareMove = this._prepareMove.bind(this), this._applyMove = this._applyMove.bind(this), this._prepareAlign = this._prepareAlign.bind(this), this._applyAlign = this._applyAlign.bind(this), this.sensors.forEach((t$7) => {
			...
			t$7.on(e.Start, n$6, n$6), t$7.on(e.Move, n$6, n$6), t$7.on(e.Cancel, r$4, r$4), t$7.on(e.End, r$4, r$4), t$7.on(e.Destroy, r$4, r$4);
		});
	}
	...
	_onMove(e$5, r$3) {
		...
		if (i$4) switch (i$4.predicateState) {
			...
			case P.Resolved:
				this.drag && (this.drag.moveEvent = e$5, n$3.once(t$1.read, this._prepareMove, this._moveId), n$3.once(t$1.write, this._applyMove, this._moveId));
				break;
		}
	}
	_onScroll() {
	...
	_prepareStart() {
		...
		e$5 && (this._startPhase = N$1.Prepare, e$5.items = (this.settings.elements({
			draggable: this,
			drag: e$5
		}) || []).map((e$6) => new O$1(e$6, this)), this._applyModifiers(F.Start, 0, 0), this._emit(L.PrepareStart, e$5.startEvent), this.settings.onPrepareStart?.(e$5, this), this._startPhase = N$1.FinishPrepare);
	}
	_applyStart() {
		let e$5 = this.drag;
		if (e$5) {
			this._startPhase = N$1.Apply;
			for (let t$6 of e$5.items) t$6.dragContainer !== t$6.elementContainer && l$2(t$6.dragContainer, t$6.element), t$6.frozenStyles && Object.assign(t$6.element.style, t$6.frozenStyles), this.settings.applyPosition({
				phase: I.Start,
				draggable: this,
				drag: e$5,
				item: t$6
			...
			for (let t$6 of e$5.items) {
				...
				if (s$3(e$6, n$5) || !c$3(e$6) && !c$3(n$5)) continue;
	...
	resolveStartPredicate(e$5, r$3) {
		...
		i$4.predicateState === P.Pending && a$3 && (this._startPhase = N$1.Init, i$4.predicateState = P.Resolved, i$4.predicateEvent = null, this.drag = new p$1(e$5, a$3), this._sensorData.forEach((t$6, n$5) => {
			n$5 !== e$5 && (t$6.predicateState = P.Rejected, t$6.predicateEvent = null);
		}), n$3.once(t$1.read, this._prepareStart, this._startId), n$3.once(t$1.write, this._applyStart, this._startId));
	}
	...
	stop() {
		...
		if (this._startPhase = N$1.None, e$5.isEnded = !0, n$3.off(t$1.read, this._startId), n$3.off(t$1.write, this._startId), n$3.off(t$1.read, this._moveId), n$3.off(t$1.write, this._moveId), n$3.off(t$1.read, this._alignId), n$3.off(t$1.write, this._alignId), window.removeEventListener(`scroll`, this._onScroll, k$1), r$3 > N$1.Init && this._applyModifiers(F.End, 0, 0), r$3 === N$1.FinishApply) {
			for (let t$6 of e$5.items) {
				if (t$6.elementContainer !== t$6.dragContainer && (l$2(t$6.elementContainer, t$6.element), t$6.alignmentOffset.x = 0, t$6.alignmentOffset.y = 0, t$6.containerOffset.x = 0, t$6.containerOffset.y = 0), t$6.unfrozenStyles) for (let e$6 in t$6.unfrozenStyles) t$6.element.style[e$6] = t$6.unfrozenStyles[e$6] || ``;
	...
	align(e$5 = !1) {
		this.drag && (e$5 ? (this._prepareAlign(), this._applyAlign()) : (n$3.once(t$1.read, this._prepareAlign, this._alignId), n$3.once(t$1.write, this._applyAlign, this._alignId)));
	}
	getClientRect() {
	...
	destroy() {
		this.isDestroyed || (this.isDestroyed = !0, this.stop(), this._sensorData.forEach(({ onMove: t$6, onEnd: n$5 }, r$3) => {
			r$3.off(e.Start, t$6), r$3.off(e.Move, t$6), r$3.off(e.Cancel, n$5), r$3.off(e.End, n$5), r$3.off(e.Destroy, n$5);
...
function n$4(n$5, r$3, i$4) {
	if (i$4 ||= e$2(n$5, r$3, t$4), !i$4) return 0;
...
function l$1(e$5, t$6) {
	return getDistance(e$1(e$5, s$2), e$1(t$6, c$2));
}
function u$1(e$5) {
...
var k = class {
	...
	computeSpeed() {
		...
		return typeof e$5 == `function` ? (v$1.direction = w(this.direction), v$1.threshold = this.threshold, v$1.distance = this.distance, v$1.value = this.value, v$1.maxValue = this.maxValue, v$1.duration = this.duration, v$1.speed = this.speed, v$1.deltaTime = this.deltaTime, v$1.isEnding = this.isEnding, e$5(this.element, v$1)) : e$5;
	}
	tick(e$5) {
...
var N = class {
	constructor(e$5 = {}) {
		...
		}, this._itemData = /* @__PURE__ */ new Map(), this._requestPool = new o$2((e$6) => e$6 || new j(), {
			initialBatchCount: 1,
			minBatchCount: 1,
			onRelease: (e$6) => e$6.reset()
		}), this._actionPool = new o$2((e$6) => e$6 || new A(), {
			batchSize: 10,
			initialBatchCount: 1,
			minBatchCount: 1,
			onRelease: (e$6) => e$6.reset()
	...
	_startTicking() {
		this._isTicking || (this._isTicking = !0, n$3.on(t$1.read, this._frameRead, this._frameRead), n$3.on(t$1.write, this._frameWrite, this._frameWrite));
	}
	_stopTicking() {
		this._isTicking && (this._isTicking = !1, this._tickTime = 0, this._tickDeltaTime = 0, n$3.off(t$1.read, this._frameRead), n$3.off(t$1.write, this._frameWrite));
	}
	...
	_checkItemOverlap(e$5, t$6, n$5) {
		...
		for (; B < o$4.length; B++) {
			...
			if (q === -Infinity) if (e$6.padding && g(s$4, T(K, e$6.padding, _))) q = -(l$1(s$4, K) || 0);
			else continue;
...
function a$2() {
	return {
		...
		getClientRect: (e$5) => {
			...
			return i$3.width = r$3 ? 50 : 0, i$3.height = r$3 ? 50 : 0, i$3.x = r$3 ? r$3.x - 25 : 0, i$3.y = r$3 ? r$3.y - 25 : 0, i$3;
		},
		onStart: null,
		onStop: null
	};
...
var o$1 = class {
	...
	constructor(t$6, r$3 = {}) {
		this.name = `autoscroll`, this.version = `0.0.3`, this.settings = this._parseSettings(r$3), this._autoScrollProxy = null, t$6.on(L.Start, () => {
			this._autoScrollProxy || (this._autoScrollProxy = new o$1(this, t$6), t$2.addItem(this._autoScrollProxy));
		}), t$6.on(L.End, () => {
			this._autoScrollProxy &&= (t$2.removeItem(this._autoScrollProxy), null);
		});
	}
	_parseSettings(e$5, t$6 = a$2()) {
...
function c(e$5) {
	return (t$6) => {
		let n$5 = new s$1(t$6, e$5), r$3 = t$6;
...
var i$1 = class extends n$2 {
	...
	_start(e$5) {
		this.isDestroyed || this.drag || (super._start(e$5), n$3.on(t$1.read, this._tick, this._tick));
	}
	_end(e$5) {
		this.drag && (n$3.off(t$1.read, this._tick), super._end(e$5));
	}
	_cancel(e$5) {
		this.drag && (n$3.off(t$1.read, this._tick), super._cancel(e$5));
	}
	_tick(t$6) {
...
function c$1(e$5) {
	return e$5 === `auto` || e$5 === void 0 ? n ? `pointer` : t ? `touch` : `mouse` : e$5;
}
const l = {
	pointer: {
		start: `pointerdown`,
...
var u = class {
	constructor(e$5, t$6 = {}) {
		...
		this.element = e$5, this.drag = null, this.isDestroyed = !1, this._areWindowListenersBound = !1, this._startPredicate = a$3, this._listenerOptions = s(n$5), this._sourceEvents = c$1(i$4), this._emitter = new v(), this._onStart = this._onStart.bind(this), this._onMove = this._onMove.bind(this), this._onCancel = this._onCancel.bind(this), this._onEnd = this._onEnd.bind(this), e$5.addEventListener(l[this._sourceEvents].start, this._onStart, this._listenerOptions);
	}
	_getTrackedPointerEventData(e$5) {
		return this.drag ? i(e$5, this.drag.pointerId) : null;
	}
	_onStart(t$6) {
	...
	updateSettings(e$5) {
		...
		let { listenerOptions: t$6, sourceEvents: n$5, startPredicate: r$3 } = e$5, i$4 = c$1(n$5), a$3 = s(t$6);
