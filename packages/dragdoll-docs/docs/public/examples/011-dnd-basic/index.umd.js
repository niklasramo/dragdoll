(function (factory) {
  ...
  var E$1 = {
    ...
    v = class {
      constructor(t$5 = {}) {
        ((this.dedupe = t$5.dedupe || E$1.ADD),
          (this.getId = t$5.getId || (() => Symbol())),
      ...
      on(t$5, n$7, e$4) {
        ...
        s$3 ||
          ...
          i$4.set(t$5, s$3));
        let o$2 = s$3.m;
        if (((e$4 = e$4 === r$2 ? this.getId(n$7) : e$4), o$2.has(e$4)))
          switch (this.dedupe) {
            case E$1.THROW:
      ...
      once(t$5, n$7, e$4) {
        let i$4 = 0;
        return (
          (e$4 = e$4 === r$2 ? this.getId(n$7) : e$4),
          this.on(
            t$5,
            (...s$3) => {
    ...
    o$1 = class {
      ...
      _processQueue(...e$4) {
        ...
        let s$3 = 0,
          ...
          c$3;
        for (; s$3 < r$3; s$3++)
          for (n$7 = t$5[s$3], a$3 = 0, c$3 = n$7.length; a$3 < c$3; a$3++) n$7[a$3](...e$4);
        t$5.length = 0;
      }
    };
  function u$3(i$4 = 60) {
    ...
    {
      let e$4 = 1e3 / i$4,
        t$5 = typeof performance > 'u' ? () => Date.now() : () => performance.now();
      return (r$3) => {
  ...
  var l$3 = class extends o$1 {
    ...
    set phases(e$4) {
      ((this._phases = e$4),
        e$4.length ? ((this._empty = !1), this._request()) : (this._empty = !0));
    }
    get paused() {
      return this._paused;
    }
    ...
    set requestFrame(e$4) {
      this._requestFrame !== e$4 &&
        ((this._requestFrame = e$4), this._cancelFrame && (this._cancel(), this._request()));
    }
    tick(...e$4) {
      if (
  ...
  let n$3 = new l$3({ phases: [t.read, t.write] });

  //#endregion
  //#region ../dragdoll/dist/constants-BG0DGMmK.js
  const e$2 = typeof window < `u` && window.document !== void 0,
    t$1 = e$2 && `ontouchstart` in window,
    n$4 = e$2 && !!window.PointerEvent;
  e$2 &&
    navigator.vendor &&
  ...
  function t$4(t$5) {
    let n$7 = e$3.get(t$5)?.deref();
    return (
      n$7 || ((n$7 = window.getComputedStyle(t$5, null)), e$3.set(t$5, new WeakRef(n$7))),
      n$7
    );
  }
  ...
  function getStyle(e$4, t$5) {
    ...
    return (
      C$1 ||
        ((C$1 = window.getComputedStyle(e$4, null)),
        STYLE_DECLARATION_CACHE.set(e$4, new WeakRef(C$1))),
      C$1
    );
  }
  ...
  function getContainingBlock(e$4, t$5 = {}) {
    ...
    const n$7 = t$5.position || getStyle(e$4).position,
      { skipDisplayNone: i$4, container: o$2 } = t$5;
    switch (n$7) {
      case 'static':
      case 'relative':
      case 'sticky':
  ...
  function getOffsetContainer(n$7, t$5 = {}) {
    ...
    const e$4 = t$5.position || getStyle(n$7).position,
      { skipDisplayNone: s$3, container: r$3 } = t$5;
    switch (e$4) {
      case 'relative':
        return n$7;
      case 'fixed':
  ...
  var s$2 = class {
    ...
    c$2 = class {
      constructor(e$4, t$5) {
        ((this.sensor = e$4),
          (this.startEvent = t$5),
          (this.prevMoveEvent = t$5),
          (this.moveEvent = t$5),
          (this.endEvent = null),
          (this.items = []),
          (this.isEnded = !1),
          (this._matrixCache = new s$2()),
          (this._clientOffsetCache = new s$2()));
      }
    };
  function l$2(
    e$4,
    ...
    if (e$4 instanceof Document)
      return ((t$5.x = window.scrollX * -1), (t$5.y = window.scrollY * -1), t$5);
    let { x: n$7, y: r$3 } = e$4.getBoundingClientRect(),
      a$3 = t$4(e$4);
    return (
      (t$5.x = n$7 + (parseFloat(a$3.borderLeftWidth) || 0)),
      (t$5.y = r$3 + (parseFloat(a$3.borderTopWidth) || 0)),
      t$5
    );
  }
  function u$2(e$4) {
  ...
  function p(
    ...
    let r$3 = u$2(e$4) ? e$4 : l$2(e$4, d),
      i$4 = u$2(t$5) ? t$5 : l$2(t$5, f);
    return ((n$7.x = i$4.x - r$3.x), (n$7.y = i$4.y - r$3.y), n$7);
  }
  function m(e$4) {
    let t$5 = t$4(e$4),
      n$7 = parseFloat(t$5.height) || 0;
    return t$5.boxSizing === `border-box`
      ? n$7
      : ((n$7 += parseFloat(t$5.borderTopWidth) || 0),
        (n$7 += parseFloat(t$5.borderBottomWidth) || 0),
        (n$7 += parseFloat(t$5.paddingTop) || 0),
        (n$7 += parseFloat(t$5.paddingBottom) || 0),
        e$4 instanceof HTMLElement && (n$7 += e$4.offsetHeight - e$4.clientHeight),
        n$7);
  }
  function h(e$4) {
    let t$5 = t$4(e$4),
      n$7 = parseFloat(t$5.width) || 0;
    return t$5.boxSizing === `border-box`
      ? n$7
      : ((n$7 += parseFloat(t$5.borderLeftWidth) || 0),
        (n$7 += parseFloat(t$5.borderRightWidth) || 0),
        (n$7 += parseFloat(t$5.paddingLeft) || 0),
        (n$7 += parseFloat(t$5.paddingRight) || 0),
        e$4 instanceof HTMLElement && (n$7 += e$4.offsetWidth - e$4.clientWidth),
        n$7);
  }
  function g(e$4, t$5 = !1) {
    let { translate: n$7, rotate: r$3, scale: a$3, transform: o$2 } = t$4(e$4),
      s$3 = ``;
    if (n$7 && n$7 !== `none`) {
      let [t$6 = `0px`, r$4 = `0px`, i$4] = n$7.split(` `);
      (t$6.includes(`%`) && (t$6 = `${(parseFloat(t$6) / 100) * h(e$4)}px`),
        r$4.includes(`%`) && (r$4 = `${(parseFloat(r$4) / 100) * m(e$4)}px`),
        i$4 ? (s$3 += `translate3d(${t$6},${r$4},${i$4})`) : (s$3 += `translate(${t$6},${r$4})`));
    }
    if (r$3 && r$3 !== `none`) {
      let e$5 = r$3.split(` `);
  ...
  const y = e$2 ? new DOMMatrix() : null;
  function b(e$4, t$5 = new DOMMatrix()) {
    let n$7 = e$4;
    for (v$1(t$5); n$7; ) {
      let e$5 = g(n$7);
      if (e$5 && (y.setMatrixValue(e$5), !y.isIdentity)) {
        let { transformOrigin: e$6 } = t$4(n$7),
          { x: r$3, y: a$3, z: o$2 } = _(e$6);
        (o$2 === 0
          ? y.setMatrixValue(
              `translate(${r$3}px,${a$3}px) ${y} translate(${r$3 * -1}px,${a$3 * -1}px)`,
            )
          : y.setMatrixValue(
              `translate3d(${r$3}px,${a$3}px,${o$2}px) ${y} translate3d(${r$3 * -1}px,${a$3 * -1}px,${o$2 * -1}px)`,
            ),
          t$5.preMultiplySelf(y));
      }
      n$7 = n$7.parentElement;
    }
    return t$5;
  }
  function x(e$4, t$5, n$7 = !1) {
    let { style: r$3 } = e$4;
  ...
  function S() {
    ...
    return (
      e$4.classList.add(`dragdoll-measure`),
      x(
        e$4,
        {
          display: `block`,
  ...
  var T = class {
    constructor(e$4, t$5) {
      ...
      let r$3 = t$4(e$4),
        a$3 = e$4.getBoundingClientRect(),
        s$3 = g(e$4, !0);
      ((this.data = {}),
        (this.element = e$4),
        (this.elementTransformOrigin = _(r$3.transformOrigin)),
        (this.elementTransformMatrix = new DOMMatrix().setMatrixValue(s$3 + r$3.transform)),
      ...
      if (((this.dragContainer = l$4), c$3 !== l$4)) {
        ...
        if (e$5 !== `fixed` && e$5 !== `absolute`)
          throw Error(
            `Dragged element has "${e$5}" position, but only "fixed" or "absolute" are allowed when using a custom drag container.`,
          );
      }
      let u$4 = getOffsetContainer(e$4) || e$4;
      ((this.elementOffsetContainer = u$4),
        (this.dragOffsetContainer =
          l$4 === c$3 ? u$4 : getOffsetContainer(e$4, { container: l$4 })));
      {
        let { width: e$5, height: t$6, x: n$8, y: r$4 } = a$3;
        this.clientRect = {
          width: e$5,
          height: t$6,
          x: n$8,
    ...
    _updateContainerMatrices() {
      [this.elementContainer, this.dragContainer].forEach((e$4) => {
        if (!this._matrixCache.isValid(e$4)) {
          let t$5 = this._matrixCache.get(e$4) || [new DOMMatrix(), new DOMMatrix()],
            [n$7, r$3] = t$5;
          (b(e$4, n$7),
            r$3.setMatrixValue(n$7.toString()).invertSelf(),
            this._matrixCache.set(e$4, t$5));
        }
      });
    }
    _updateContainerOffset() {
      let {
        elementOffsetContainer: e$4,
        elementContainer: t$5,
      ...
      if (e$4 !== n$7) {
        let [s$3, c$3] = [
          ...
          if (!a$3.isValid(t$6)) {
            let r$4 = o$2.get(e$5);
            t$6 instanceof HTMLElement && r$4 && !r$4[0].isIdentity
              ? C(r$4[0])
                ? (w.style.setProperty(`transform`, r$4[1].toString(), `important`),
                  t$6.append(w),
                  l$2(w, n$8),
                  w.remove())
                : (l$2(t$6, n$8), (n$8.x -= r$4[0].m41), (n$8.y -= r$4[0].m42))
              : l$2(t$6, n$8);
          }
  ...
  function E(e$4, t$5, n$7 = null) {
    if (`moveBefore` in e$4 && e$4.isConnected === t$5.isConnected)
      try {
        e$4.moveBefore(t$5, n$7);
        return;
      } catch {}
    let r$3 = document.activeElement,
      i$4 = t$5.contains(r$3);
    (e$4.insertBefore(t$5, n$7),
      i$4 &&
  ...
  function O(e$4, t$5) {
    return e$4.isIdentity && t$5.isIdentity
      ? !0
      : e$4.is2D && t$5.is2D
        ? e$4.a === t$5.a &&
          e$4.b === t$5.b &&
  ...
  const k = {
    ...
    j = e$2 ? new DOMMatrix() : null,
    M = e$2 ? new DOMMatrix() : null;
  var N = (function (e$4) {
      return (
        (e$4[(e$4.None = 0)] = `None`),
        (e$4[(e$4.Init = 1)] = `Init`),
        (e$4[(e$4.Prepare = 2)] = `Prepare`),
        (e$4[(e$4.FinishPrepare = 3)] = `FinishPrepare`),
        (e$4[(e$4.Apply = 4)] = `Apply`),
        (e$4[(e$4.FinishApply = 5)] = `FinishApply`),
        e$4
      );
    })(N || {}),
    P = (function (e$4) {
      return (
        (e$4[(e$4.Pending = 0)] = `Pending`),
        (e$4[(e$4.Resolved = 1)] = `Resolved`),
        (e$4[(e$4.Rejected = 2)] = `Rejected`),
        e$4
      );
    })(P || {});
  const F = {
    ...
    R = {
      ...
      applyPosition: ({ item: e$4, phase: t$5 }) => {
        let n$7 = t$5 === I.End || t$5 === I.EndAlign,
          [r$3, i$4] = e$4.getContainerMatrix(),
          [a$3, o$2] = e$4.getDragContainerMatrix(),
          {
            position: s$3,
            alignmentOffset: c$3,
            containerOffset: l$4,
            elementTransformMatrix: u$4,
            elementTransformOrigin: d$1,
            elementOffsetMatrix: f$1,
          } = e$4,
          { x: p$1, y: m$1, z: h$1 } = d$1,
          g$1 = !u$4.isIdentity && (p$1 !== 0 || m$1 !== 0 || h$1 !== 0),
          _$2 = s$3.x + c$3.x + l$4.x,
          y$1 = s$3.y + c$3.y + l$4.y;
        (v$1(j),
          g$1 && (h$1 === 0 ? j.translateSelf(-p$1, -m$1) : j.translateSelf(-p$1, -m$1, -h$1)),
          n$7 ? i$4.isIdentity || j.multiplySelf(i$4) : o$2.isIdentity || j.multiplySelf(o$2),
          v$1(M).translateSelf(_$2, y$1),
          j.multiplySelf(M),
          r$3.isIdentity || j.multiplySelf(r$3),
          g$1 && (v$1(M).translateSelf(p$1, m$1, h$1), j.multiplySelf(M)),
          u$4.isIdentity || j.multiplySelf(u$4),
          f$1.isIdentity || j.preMultiplySelf(f$1),
          (e$4.element.style.transform = `${j}`));
      },
  ...
  var z = class {
    constructor(t$5, n$7 = {}) {
      ...
      ((this.id = r$3),
        ...
        this.sensors.forEach((t$6) => {
          this._sensorData.set(t$6, {
            predicateState: P.Pending,
            predicateEvent: null,
            onMove: (e$4) => this._onMove(e$4, t$6),
            onEnd: (e$4) => this._onEnd(e$4, t$6),
          });
          let { onMove: n$8, onEnd: r$4 } = this._sensorData.get(t$6);
          (t$6.on(e.Start, n$8, n$8),
            t$6.on(e.Move, n$8, n$8),
            t$6.on(e.Cancel, r$4, r$4),
            t$6.on(e.End, r$4, r$4),
            t$6.on(e.Destroy, r$4, r$4));
        }));
    }
    _parseSettings(e$4, t$5 = R) {
      let {
        container: n$7 = t$5.container,
        startPredicate: r$3 = t$5.startPredicate,
        elements: i$4 = t$5.elements,
        frozenStyles: a$3 = t$5.frozenStyles,
        positionModifiers: o$2 = t$5.positionModifiers,
        applyPosition: s$3 = t$5.applyPosition,
        computeClientRect: c$3 = t$5.computeClientRect,
        group: l$4 = t$5.group,
        onPrepareStart: u$4 = t$5.onPrepareStart,
        onStart: d$1 = t$5.onStart,
        onPrepareMove: f$1 = t$5.onPrepareMove,
        onMove: p$1 = t$5.onMove,
        onEnd: m$1 = t$5.onEnd,
        onDestroy: h$1 = t$5.onDestroy,
      } = e$4 || {};
      return {
        container: n$7,
        startPredicate: r$3,
      ...
      if (i$4)
        switch (i$4.predicateState) {
          case P.Pending: {
            ...
            let t$5 = this.settings.startPredicate({
              draggable: this,
              sensor: r$3,
              event: e$4,
            });
            t$5 === !0
              ...
              : t$5 === !1 && this.rejectStartPredicate(r$3);
            break;
          }
          case P.Resolved:
            this.drag &&
              ((this.drag.moveEvent = e$4),
              n$3.once(t.read, this._prepareMove, this._moveId),
              n$3.once(t.write, this._applyMove, this._moveId));
            break;
        }
    }
    _onScroll() {
      ...
      n$7 &&
        (this.drag
          ? n$7.predicateState === P.Resolved &&
            ((this.drag.endEvent = e$4),
            this._sensorData.forEach((e$5) => {
    ...
    _prepareStart() {
      ...
      e$4 &&
        ...
        ).map((e$5) => new T(e$5, this))),
        this._applyModifiers(F.Start, 0, 0),
        this._emit(L.PrepareStart, e$4.startEvent),
        this.settings.onPrepareStart?.(e$4, this),
    ...
    _applyStart() {
      ...
      if (e$4) {
        ...
        for (let t$5 of e$4.items)
          (t$5.dragContainer !== t$5.elementContainer && E(t$5.dragContainer, t$5.element),
            t$5.frozenStyles && Object.assign(t$5.element.style, t$5.frozenStyles),
        ...
        for (let t$5 of e$4.items) {
          let e$5 = t$5.getContainerMatrix()[0],
            n$7 = t$5.getDragContainerMatrix()[0];
          if (O(e$5, n$7) || (!C(e$5) && !C(n$7))) continue;
          let r$3 = t$5.element.getBoundingClientRect(),
            { alignmentOffset: i$4 } = t$5;
        ...
        (window.addEventListener(`scroll`, this._onScroll, k),
          this._emit(L.Start, e$4.startEvent),
          this.settings.onStart?.(e$4, this),
    ...
    _prepareMove() {
      ...
      t$5 !== n$7 &&
        (this._applyModifiers(F.Move, t$5.x - n$7.x, t$5.y - n$7.y),
        this._emit(L.PrepareMove, t$5),
        !e$4.isEnded &&
          (this.settings.onPrepareMove?.(e$4, this), !e$4.isEnded && (e$4.prevMoveEvent = t$5)));
    }
    _applyMove() {
      let e$4 = this.drag;
      if (e$4) {
    ...
    _prepareAlign() {
      ...
      if (e$4)
        for (let t$5 of e$4.items) {
          let { x: e$5, y: n$7 } = t$5.element.getBoundingClientRect(),
            r$3 = t$5.clientRect.x - t$5._moveDiff.x - e$5;
          ((t$5.alignmentOffset.x = t$5.alignmentOffset.x - t$5._alignDiff.x + r$3),
            (t$5._alignDiff.x = r$3));
          let i$4 = t$5.clientRect.y - t$5._moveDiff.y - n$7;
          ((t$5.alignmentOffset.y = t$5.alignmentOffset.y - t$5._alignDiff.y + i$4),
            (t$5._alignDiff.y = i$4));
        }
    }
    _applyAlign() {
      let { drag: e$4 } = this;
    ...
    _applyModifiers(e$4, t$5, n$7) {
      ...
      for (let a$3 of r$3.items) {
        ...
        ((a$3.position.x += o$2.x),
          (a$3.position.y += o$2.y),
          (a$3.clientRect.x += o$2.x),
          (a$3.clientRect.y += o$2.y),
          e$4 === `move` && ((a$3._moveDiff.x += o$2.x), (a$3._moveDiff.y += o$2.y)));
      }
    }
    on(e$4, t$5, n$7) {
    ...
    resolveStartPredicate(e$4, r$3) {
      ...
      i$4.predicateState === P.Pending &&
        ...
        (this.drag = new c$2(e$4, a$3)),
        this._sensorData.forEach((t$5, n$7) => {
          n$7 !== e$4 && ((t$5.predicateState = P.Rejected), (t$5.predicateEvent = null));
        }),
        n$3.once(t.read, this._prepareStart, this._startId),
        n$3.once(t.write, this._applyStart, this._startId));
    }
    rejectStartPredicate(e$4) {
      let t$5 = this._sensorData.get(e$4);
      t$5?.predicateState === P.Pending &&
        ((t$5.predicateState = P.Rejected), (t$5.predicateEvent = null));
    }
    stop() {
      let e$4 = this.drag;
      if (!e$4 || e$4.isEnded) return;
      let r$3 = this._startPhase;
      if (r$3 === N.Prepare || r$3 === N.Apply)
        throw Error(`Cannot stop drag start process at this point`);
      if (
        ((this._startPhase = N.None),
        (e$4.isEnded = !0),
        n$3.off(t.read, this._startId),
        n$3.off(t.write, this._startId),
        n$3.off(t.read, this._moveId),
        n$3.off(t.write, this._moveId),
        n$3.off(t.read, this._alignId),
        n$3.off(t.write, this._alignId),
        window.removeEventListener(`scroll`, this._onScroll, k),
        r$3 > N.Init && this._applyModifiers(F.End, 0, 0),
        r$3 === N.FinishApply)
      ) {
        for (let t$5 of e$4.items) {
          if (
            (t$5.elementContainer !== t$5.dragContainer &&
              (E(t$5.elementContainer, t$5.element),
              (t$5.alignmentOffset.x = 0),
              (t$5.alignmentOffset.y = 0),
              (t$5.containerOffset.x = 0),
              (t$5.containerOffset.y = 0)),
            t$5.unfrozenStyles)
          )
            for (let e$5 in t$5.unfrozenStyles)
              t$5.element.style[e$5] = t$5.unfrozenStyles[e$5] || ``;
          this.settings.applyPosition({
            phase: I.End,
            draggable: this,
            drag: e$4,
        ...
        for (let t$5 of e$4.items)
          if (t$5.elementContainer !== t$5.dragContainer) {
            let e$5 = t$5.element.getBoundingClientRect();
            ((t$5.alignmentOffset.x = D(t$5.clientRect.x - e$5.x, 3)),
              (t$5.alignmentOffset.y = D(t$5.clientRect.y - e$5.y, 3)));
          }
        for (let t$5 of e$4.items)
          t$5.elementContainer !== t$5.dragContainer &&
            (t$5.alignmentOffset.x !== 0 || t$5.alignmentOffset.y !== 0) &&
            this.settings.applyPosition({
              phase: I.EndAlign,
              draggable: this,
              drag: e$4,
      ...
      } else if (r$3 === N.FinishPrepare)
        for (let t$5 of e$4.items)
          ((t$5.clientRect.x -= t$5.position.x),
            (t$5.clientRect.y -= t$5.position.y),
            (t$5.position.x = 0),
            (t$5.position.y = 0),
            t$5.elementContainer !== t$5.dragContainer &&
              ((t$5.alignmentOffset.x = 0),
    ...
    align(e$4 = !1) {
      this.drag &&
        (e$4
          ...
          : (n$3.once(t.read, this._prepareAlign, this._alignId),
            n$3.once(t.write, this._applyAlign, this._alignId)));
    }
    getClientRect() {
      let { drag: e$4, settings: t$5 } = this;
      return (
        (e$4 &&
          t$5.computeClientRect?.({
            draggable: this,
            drag: e$4,
          })) ||
        null
    ...
    destroy() {
      this.isDestroyed ||
        ((this.isDestroyed = !0),
        this.stop(),
        this._sensorData.forEach(({ onMove: t$5, onEnd: n$7 }, r$3) => {
          (r$3.off(e.Start, t$5),
            r$3.off(e.Move, t$5),
            r$3.off(e.Cancel, n$7),
            r$3.off(e.End, n$7),
            r$3.off(e.Destroy, n$7));
        }),
  ...
  function e$1(
    ...
    let r$3 = Math.max(e$4.x, t$5.x),
      i$4 = Math.min(e$4.x + e$4.width, t$5.x + t$5.width);
    if (i$4 <= r$3) return null;
    let a$3 = Math.max(e$4.y, t$5.y),
      o$2 = Math.min(e$4.y + e$4.height, t$5.y + t$5.height);
    return o$2 <= a$3
      ? null
      : ((n$7.x = r$3), (n$7.y = a$3), (n$7.width = i$4 - r$3), (n$7.height = o$2 - a$3), n$7);
  }
  const t$3 = {
    width: 0,
    height: 0,
  ...
  function n$5(n$7, r$3, i$4) {
    if (((i$4 ||= e$1(n$7, r$3, t$3)), !i$4)) return 0;
    let a$3 = i$4.width * i$4.height;
    return a$3
      ? (a$3 / (Math.min(n$7.width, r$3.width) * Math.min(n$7.height, r$3.height))) * 100
      : 0;
  }
  ...
  var n = class {
    ...
    updateClientRect(e$4) {
      let t$5 = e$4 || this.element.getBoundingClientRect(),
  ...
  var n$6 = class {
    ...
    get(...e$4) {
      return this._index >= this._items.length
        ? (this._items[this._index++] = this._getItem(void 0, ...e$4))
        : this._getItem(this._items[this._index++], ...e$4);
    }
    resetPointer() {
      this._index = 0;
    }
  ...
  function r$1(
    ...
    return (
      e$4 && ((t$5.width = e$4.width), (t$5.height = e$4.height), (t$5.x = e$4.x), (t$5.y = e$4.y)),
      t$5
    );
  }
  const i$3 = Symbol();
  var a$2 = class {
    constructor(e$4) {
      ((this._listenerId = Symbol()),
        (this._dndContext = e$4),
        (this._collisionDataPoolCache = []),
        (this._collisionDataPoolMap = /* @__PURE__ */ new Map()));
    }
    _checkCollision(n$7, i$4, a$3) {
      let o$2 = n$7.getClientRect(),
        s$3 = i$4.getClientRect();
      if (!o$2) return null;
      let c$3 = e$1(o$2, s$3, a$3.intersectionRect);
      if (c$3 === null) return null;
      let l$4 = n$5(o$2, s$3, c$3);
      return l$4 <= 0
        ? null
        : ((a$3.droppableId = i$4.id),
          r$1(s$3, a$3.droppableRect),
          r$1(o$2, a$3.draggableRect),
          (a$3.intersectionScore = l$4),
          a$3);
    }
    _sortCollisions(e$4, t$5) {
      return t$5.sort((e$5, t$6) => {
        ...
        return n$7 === 0
          ? e$5.droppableRect.width * e$5.droppableRect.height -
              t$6.droppableRect.width * t$6.droppableRect.height
          : n$7;
      });
    }
      ...
      return (
        t$5 ||
          ((t$5 =
            ...
            new n$6((e$5) => e$5 || this._createCollisionData())),
          this._collisionDataPoolMap.set(e$4, t$5)),
        t$5
      );
    }
    removeCollisionDataPool(e$4) {
      ...
      t$5 &&
        (t$5.resetItems(20),
        t$5.resetPointer(),
        this._collisionDataPoolCache.push(t$5),
        this._collisionDataPoolMap.delete(e$4));
    }
    detectCollisions(e$4, t$5, n$7) {
      if (((n$7.length = 0), !t$5.size)) return;
      let r$3 = this.getCollisionDataPool(e$4),
        i$4 = null,
        a$3 = t$5.values();
      for (let t$6 of a$3)
        ((i$4 ||= r$3.get()), this._checkCollision(e$4, t$6, i$4) && (n$7.push(i$4), (i$4 = null)));
  ...
  var s$1 = (function (e$4) {
    return (
      (e$4[(e$4.Idle = 0)] = `Idle`),
      (e$4[(e$4.Computing = 1)] = `Computing`),
      (e$4[(e$4.Computed = 2)] = `Computed`),
      (e$4[(e$4.Emitting = 3)] = `Emitting`),
      e$4
    );
  })(s$1 || {});
  const c$1 = {
  ...
  var u = class {
    constructor(e$4 = {}) {
      ...
      ((this.draggables = /* @__PURE__ */ new Map()),
        ...
        (this._emitter = new v()),
        (this._onScroll = this._onScroll.bind(this)),
        (this._collisionDetector = r$3 ? r$3(this) : new a$2(this)));
    }
    get drags() {
      return this._drags;
    }
    _isMatch(e$4, t$5) {
      let n$7 =
        typeof t$5.accept == `function` ? t$5.accept(e$4) : t$5.accept.includes(e$4.settings.group);
      if (n$7 && e$4.drag) {
    ...
    _onDragPrepareStart(e$4) {
      this.draggables.has(e$4.id) &&
        (this._drags.get(e$4) ||
          ...
          this._computeCollisions(e$4),
          this._drags.size === 1 && window.addEventListener(`scroll`, this._onScroll, c$1)));
    }
    _onDragStart(e$4) {
      let t$5 = this._drags.get(e$4);
      if (!(!t$5 || t$5.isEnded)) {
      ...
      return (
        ...
        r$3
          ? (window.queueMicrotask(() => {
            ...
            !0)
          : (this._finalizeStopDrag(e$4), !1)
      );
    }
    _finalizeStopDrag(e$4) {
      let r$3 = this._drags.get(e$4);
      !r$3 ||
        !r$3.isEnded ||
        (this._drags.delete(e$4),
        this._collisionDetector.removeCollisionDataPool(e$4),
        n$3.off(t.read, r$3._cd.tickerId),
        n$3.off(t.write, r$3._cd.tickerId),
        this._drags.size ||
          (n$3.off(t.read, this._listenerId),
          window.removeEventListener(`scroll`, this._onScroll, c$1)));
    }
    _computeCollisions(e$4, t$5 = !1) {
      ...
      ((r$3.phase = s$1.Computing),
        (r$3.targets = this._getTargets(e$4)),
        this._collisionDetector.detectCollisions(e$4, r$3.targets, r$3.collisions),
        (r$3.phase = s$1.Computed));
    }
    _emitCollisions(e$4, t$5 = !1) {
      ...
      let i$4 = this._emitter,
        a$3 = r$3.collisions,
        o$2 = r$3.targets,
        c$3 = r$3.addedContacts,
        u$4 = r$3.persistedContacts,
        d$1 = r$3.contacts,
        f$1 = r$3.prevContacts;
    ...
    detectCollisions(e$4) {
      if (!this.isDestroyed)
        if (e$4) {
          let r$3 = this._drags.get(e$4);
          if (!r$3 || r$3.isEnded) return;
          (n$3.once(t.read, () => this._computeCollisions(e$4), r$3._cd.tickerId),
            n$3.once(t.write, () => this._emitCollisions(e$4), r$3._cd.tickerId));
        } else
          for (let [e$5, r$3] of this._drags)
            r$3.isEnded ||
              (n$3.once(t.read, () => this._computeCollisions(e$5), r$3._cd.tickerId),
              n$3.once(t.write, () => this._emitCollisions(e$5), r$3._cd.tickerId));
    }
    addDraggables(t$5) {
      if (this.isDestroyed) return;
      let n$7 = /* @__PURE__ */ new Set();
      for (let i$4 of t$5)
        this.draggables.has(i$4.id) ||
          (n$7.add(i$4),
          this.draggables.set(i$4.id, i$4),
          i$4.on(
            L.PrepareStart,
            () => {
              this._onDragPrepareStart(i$4);
            },
            this._listenerId,
          ),
          i$4.on(
          ...
          i$4.on(
            ...
            (t$6) => {
              t$6?.type === e.End
                ? this._onDragEnd(i$4)
                : t$6?.type === e.Cancel && this._onDragCancel(i$4);
            },
            this._listenerId,
          ),
          i$4.on(
      ...
      if (n$7.size) {
        ...
        for (let e$4 of n$7)
          if (!this.isDestroyed && e$4.drag && !e$4.drag.isEnded) {
            let t$6 = e$4._startPhase;
            (t$6 >= 2 && this._onDragPrepareStart(e$4), t$6 >= 4 && this._onDragStart(e$4));
          }
      }
    }
    removeDraggables(e$4) {
      ...
      this._emitter.listenerCount(l.RemoveDraggables) &&
        this._emitter.emit(l.RemoveDraggables, { draggables: t$5 });
    }
    addDroppables(e$4) {
      if (this.isDestroyed) return;
      let t$5 = /* @__PURE__ */ new Set();
    ...
    removeDroppables(e$4) {
      ...
      for (let n$7 of e$4)
        this.droppables.has(n$7.id) &&
          ...
          t$5.add(n$7),
          n$7.off(t$2.Destroy, this._listenerId),
          this._drags.forEach(({ _targets: e$5 }, t$6) => {
            e$5 && e$5.has(n$7.id) && (e$5.delete(n$7.id), this.detectCollisions(t$6));
          }));
      t$5.size &&
        this._emitter.listenerCount(l.RemoveDroppables) &&
        this._emitter.emit(l.RemoveDroppables, { droppables: t$5 });
    }
    destroy() {
      if (this.isDestroyed) return;
      ((this.isDestroyed = !0),
        this.draggables.forEach((e$5) => {
          (e$5.off(L.PrepareStart, this._listenerId),
            e$5.off(L.Start, this._listenerId),
            e$5.off(L.PrepareMove, this._listenerId),
            e$5.off(L.Move, this._listenerId),
            e$5.off(L.End, this._listenerId),
            e$5.off(L.Destroy, this._listenerId));
        }),
  ...
  function i$2(e$4, t$5) {
    ...
    if (`changedTouches` in e$4) {
      let n$7 = 0;
      for (; n$7 < e$4.changedTouches.length; n$7++)
        if (e$4.changedTouches[n$7].identifier === t$5) return e$4.changedTouches[n$7];
      return null;
    }
    return e$4;
  }
  ...
  function o(e$4) {
    return `pointerId` in e$4
      ? e$4.pointerId
      : `changedTouches` in e$4
        ? e$4.changedTouches[0]
          ? e$4.changedTouches[0].identifier
          : null
        : -1;
  }
  function s(e$4 = {}) {
  ...
  var u$1 = class {
    constructor(e$4, t$5 = {}) {
      let {
        ...
        startPredicate: a$3 = (e$5) => !(`button` in e$5 && e$5.button > 0),
      } = t$5;
      ((this.element = e$4),
        (this.drag = null),
        (this.isDestroyed = !1),
        ...
        (this._listenerOptions = s(n$7)),
        (this._sourceEvents = c(i$4)),
        (this._emitter = new v()),
        (this._onStart = this._onStart.bind(this)),
        (this._onMove = this._onMove.bind(this)),
        (this._onCancel = this._onCancel.bind(this)),
        (this._onEnd = this._onEnd.bind(this)),
        e$4.addEventListener(l$1[this._sourceEvents].start, this._onStart, this._listenerOptions));
    }
    _getTrackedPointerEventData(e$4) {
      return this.drag ? i$2(e$4, this.drag.pointerId) : null;
    }
    _onStart(t$5) {
      if (this.isDestroyed || this.drag || !this._startPredicate(t$5)) return;
      let n$7 = o(t$5);
      if (n$7 === null) return;
      let r$3 = i$2(t$5, n$7);
      if (r$3 === null) return;
    ...
    _onMove(t$5) {
      if (!this.drag) return;
      let n$7 = this._getTrackedPointerEventData(t$5);
      if (!n$7) return;
    ...
    _bindWindowListeners() {
      ...
      (window.addEventListener(e$4, this._onMove, this._listenerOptions),
        window.addEventListener(t$5, this._onEnd, this._listenerOptions),
    ...
    _unbindWindowListeners() {
      if (this._areWindowListenersBound) {
        let { move: e$4, end: t$5, cancel: n$7 } = l$1[this._sourceEvents];
        (window.removeEventListener(e$4, this._onMove, this._listenerOptions),
          window.removeEventListener(t$5, this._onEnd, this._listenerOptions),
    ...
    cancel() {
      ...
      (this._emitter.emit(t$5.type, t$5), this._resetDrag());
    }
    updateSettings(e$4) {
      if (this.isDestroyed) return;
      let { listenerOptions: t$5, sourceEvents: n$7, startPredicate: r$3 } = e$4,
        i$4 = c(n$7),
        a$3 = s(t$5);
      (r$3 && this._startPredicate !== r$3 && (this._startPredicate = r$3),
        ((t$5 &&
          ...
          this.cancel(),
          n$7 && (this._sourceEvents = i$4),
          t$5 && a$3 && (this._listenerOptions = a$3),
  ...
  var n$2 = class {
    ...
    _start(t$5) {
      this.isDestroyed ||
        this.drag ||
        ((this.drag = this._createDragData(t$5)), this._emitter.emit(e.Start, t$5));
    }
    _move(t$5) {
    ...
    _end(t$5) {
      this.drag &&
        (this._updateDragData(t$5), this._emitter.emit(e.End, t$5), this._resetDragData());
    }
    _cancel(t$5) {
      this.drag &&
        (this._updateDragData(t$5), this._emitter.emit(e.Cancel, t$5), this._resetDragData());
    }
    on(e$4, t$5, n$7) {
      return this._emitter.on(e$4, t$5, n$7);
    }
  ...
  var i = class extends n$2 {
    ...
    _start(e$4) {
      this.isDestroyed || this.drag || (super._start(e$4), n$3.on(t.read, this._tick, this._tick));
    }
    _end(e$4) {
      this.drag && (n$3.off(t.read, this._tick), super._end(e$4));
    }
    _cancel(e$4) {
      this.drag && (n$3.off(t.read, this._tick), super._cancel(e$4));
    }
    _tick(t$5) {
      if (this.drag)
        if (t$5 && this.drag.time) {
          ((this.drag.deltaTime = t$5 - this.drag.time), (this.drag.time = t$5));
          let n$7 = {
            type: `tick`,
            time: this.drag.time,
        ...
        } else ((this.drag.time = t$5), (this.drag.deltaTime = 0));
    }
  };

  //#endregion
  //#region ../dragdoll/dist/sensors/keyboard-motion.js
  const n$1 = [`start`, `cancel`, `end`, `moveLeft`, `moveRight`, `moveUp`, `moveDown`];
  function r(e$4, t$5) {
  ...
  var a = class extends i {
    constructor(e$4, t$5 = {}) {
      super();
      let {
        startPredicate: n$7 = i$1.startPredicate,
        computeSpeed: r$3 = i$1.computeSpeed,
        cancelOnVisibilityChange: a$3 = i$1.cancelOnVisibilityChange,
        cancelOnBlur: o$2 = i$1.cancelOnBlur,
        startKeys: s$3 = i$1.startKeys,
        moveLeftKeys: c$3 = i$1.moveLeftKeys,
        moveRightKeys: l$4 = i$1.moveRightKeys,
        moveUpKeys: u$4 = i$1.moveUpKeys,
        moveDownKeys: d$1 = i$1.moveDownKeys,
        cancelKeys: f$1 = i$1.cancelKeys,
        endKeys: p$1 = i$1.endKeys,
      } = t$5;
      ((this.element = e$4),
        ...
        (this._moveKeys = new Set([...c$3, ...l$4, ...u$4, ...d$1])),
        (this._moveKeyTimestamps = /* @__PURE__ */ new Map()),
        (this._cancelOnBlur = o$2),
        ...
        o$2 && e$4?.addEventListener(`blur`, this._blurCancelHandler),
    ...
    _updateDirection() {
      let e$4 = r(this._moveLeftKeys, this._moveKeyTimestamps),
        t$5 = r(this._moveRightKeys, this._moveKeyTimestamps),
        n$7 = r(this._moveUpKeys, this._moveKeyTimestamps),
        i$4 = r(this._moveDownKeys, this._moveKeyTimestamps),
        a$3 = e$4 === t$5 ? 0 : e$4 < t$5 ? -1 : 1,
        o$2 = n$7 === i$4 ? 0 : n$7 < i$4 ? -1 : 1;
      if (!(a$3 === 0 || o$2 === 0)) {
    ...
    _onKeyUp(e$4) {
      this._moveKeyTimestamps.get(e$4.key) &&
        (this._moveKeyTimestamps.delete(e$4.key), this._updateDirection());
    }
    _onKeyDown(t$5) {
      if (!this.drag) {
      ...
      if (this._moveKeys.has(t$5.key)) {
        (t$5.preventDefault(),
          this._moveKeyTimestamps.get(t$5.key) ||
            (this._moveKeyTimestamps.set(t$5.key, Date.now()), this._updateDirection()));
        return;
      }
    }
    updateSettings(e$4 = {}) {
      ...
      if (
        ...
        o$2 !== void 0 && (this._computeSpeed = o$2),
        n$1.forEach((n$7, r$4) => {
          let i$5 = `${n$7}Keys`,
            a$4 = e$4[i$5];
        ...
        [...this._moveKeys].every((t$6, n$7) => e$5[n$7] === t$6) ||
          ((this._moveKeys = new Set(e$5)),
          this._moveKeyTimestamps.clear(),
  ...
  draggableElements.forEach((element) => {
    const draggable = new z([new u$1(element), new a(element)], {
      elements: () => [element],
